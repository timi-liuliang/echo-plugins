...
public:
    ...
    struct Deleter {
        static void WrapIfNecessary() {
            if (TfPyIsNone(TfPyGetClassObject<Deleter>()))
                hboost::python::class_<Deleter>
                    ("Tf_PyWeakObject__Deleter", hboost::python::no_init)
    ...
    static Tf_PyWeakObjectPtr GetOrCreate(hboost::python::object const &obj) {
    ...
    hboost::python::object GetObject() const {
        return hboost::python::object
            (hboost::python::handle<>
             (hboost::python::borrowed(PyWeakref_GetObject(_weakRef.get()))));
    }
  ...
  private:
    explicit Tf_PyWeakObject(hboost::python::object const &obj) :
        _weakRef(PyWeakref_NewRef(obj.ptr(), hboost::python::
