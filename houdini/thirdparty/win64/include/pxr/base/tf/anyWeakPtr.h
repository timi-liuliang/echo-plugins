...
class TfAnyWeakPtr : hboost::totally_ordered<TfAnyWeakPtr>
{
    struct _Data {
        void* space[4];
    };
...
public:
  ...
  private:
    ...
    friend hboost::python::api::object
    Tf_GetPythonObjectFromAnyWeakPtr(This const &self);

    TF_API
    hboost::python::api::object _GetPythonObject() const;
#endif // PXR_PYTHON_SUPPORT_ENABLED
...
#ifdef PXR_PYTHON_SUPPORT_ENABLED
        virtual hboost::python::api::object GetPythonObject() const = 0;
#endif // PXR_PYTHON_SUPPORT_ENABLED
...
#ifdef PXR_PYTHON_SUPPORT_ENABLED
        TF_API virtual hboost::python::api::object GetPythonObject() const;
#endif // PXR_PYTHON_SUPPORT_ENABLED
...
#ifdef PXR_PYTHON_SUPPORT_ENABLED
        virtual hboost::python::api::object GetPythonObject() const;
#endif // PXR_PYTHON_SUPPORT_ENABLED
