...
#define _TF_TOKENS_STRUCT_NAME_PRIVATE(key) \
    HBOOST_PP_CAT(key, _PrivateStaticTokenType)
...
#define _TF_TOKENS_STRUCT_NAME(key) \
    HBOOST_PP_CAT(key, _StaticTokenType)
...
#define _TF_TOKENS_DECLARE_MEMBERS(seq) \
    HBOOST_PP_SEQ_FOR_EACH(_TF_TOKENS_DECLARE_MEMBER, ~,                     \
...
#define _TF_TOKENS_INITIALIZE_MEMBER(elem)                                  \
    elem(HBOOST_PP_STRINGIZE(elem), TfToken::Immortal)
...
#define _TF_TOKENS_BUILD_ALLTOKENS_VECTOR(seq)                              \
    HBOOST_PP_SEQ_FOR_EACH_I(_TF_TOKENS_APPEND_MEMBER, ~, seq)

// Private macros to generate the list of initialized members.
//
#define _TF_TOKENS_INITIALIZE_SEQ(seq)                                      \
    HBOOST_PP_SEQ_FOR_EACH_I(_TF_TOKENS_DEFINE_MEMBER, ~, seq)

#define _TF_TOKENS_ASSIGN_ARRAY_SEQ(seq)                                    \
    HBOOST_PP_SEQ_FOR_EACH(_TF_TOKENS_DEFINE_ARRAY_MEMBERS, ~, seq)
