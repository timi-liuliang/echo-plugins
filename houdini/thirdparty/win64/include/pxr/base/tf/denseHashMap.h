...
>
class TfDenseHashMap :
    private hboost::equality_comparable<
...
private:
    ...
    //
    // Therefore we use hboost::iterator_facade to create an iterator that uses
...
private:
    ...
    typedef
        hboost::compressed_pair<
            hboost::compressed_pair<_Vector, HashFn>,
            EqualKey>
