...
/// template parameter is a \a hboost::python::object (or a derived class, such
...
struct TfPyCall {
    ...
    /// hboost::python::object works, since those implicitly convert to \c
...
TfPyCall<Return>::operator()(Args... args)
{
    ...
    if (!PyErr_Occurred()) {
        try {
            return hboost::python::call<Return>
                (_callable.ptr(), args...);
