...
///
/// Provides a wrapper around hboost::python::object that works correctly for the
...
/// hboost::python::object.  This class only actually acquires the GIL for default
/// construction, destruction and for some (in)equality comparisons.  The other
/// operations do not require taking the GIL.
///
/// This is primarily useful in cases where a hboost::python::object might be
...
/// hboost::python::object, that type-erased object must be destroyed while the
/// GIL is held but it's unreasonable to require that the registry know that.
/// This class helps solve that problem.
///
/// This class also provides many of the operators that hboost::python::object
/// provides, by virtue of deriving from hboost::python::api::object_operators<T>.
...
{
    typedef hboost::python::object object;
...
private:
    ...
    friend class hboost::python::api::object_operators<TfPyObjWrapper>;
