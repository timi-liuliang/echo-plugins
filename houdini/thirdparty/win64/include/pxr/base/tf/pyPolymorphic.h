...
struct TfPyPolymorphic :
    ...
    public hboost::python::wrapper<Derived>
{
    ...
    Override GetOverride(char const *func) const {
        ...
        // don't use hboost::python::wrapper::get_override(), as it can return
    ...
    Ret (Cls::*defaultImpl)(Args...))
{
    ...
    if (Override o = GetOverride(fname))
        return hboost::function<Ret (Args...)>(TfPyCall<Ret>(o));
...
// Specialize has_back_reference<> so that hboost.python will pass
