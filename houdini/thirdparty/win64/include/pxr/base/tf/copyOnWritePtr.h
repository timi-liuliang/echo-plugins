...
struct Tf_CowSharedPtrHelper {
    typedef hboost::shared_ptr<Pointee> PtrType;
...
///
template<typename T>
class TfCopyOnWritePtr : hboost::equality_comparable<TfCopyOnWritePtr<T> >
{
    // Choose the helper.
    typedef typename hboost::mpl::if_<hboost::is_base_of<TfRefBase, T>,
