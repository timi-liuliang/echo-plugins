...
ARCH_EXPORT
void HBOOST_PP_CAT(init_module_, MFB_PACKAGE_NAME)() {

    Tf_PyInitWrapModule(
        WrapModule,
        HBOOST_PP_STRINGIZE(MFB_PACKAGE_MODULE),
        HBOOST_PP_STRINGIZE(MFB_ALT_PACKAGE_NAME),
        "Wrap " HBOOST_PP_STRINGIZE(MFB_ALT_PACKAGE_NAME),
        HBOOST_PP_STRINGIZE(MFB_PACKAGE_NAME)
        );
}

PXR_NAMESPACE_CLOSE_SCOPE

// In presto, when we generate hboost python bindings for a library
...
extern "C"
ARCH_EXPORT
void HBOOST_PP_CAT(init_, MFB_PACKAGE_NAME)() {
    PXR_NAMESPACE_USING_DIRECTIVE
    hboost::python::detail::init_module
        (HBOOST_PP_STRINGIZE(HBOOST_PP_CAT(_,MFB_PACKAGE_NAME)),
         HBOOST_PP_CAT(&init_module_, MFB_PACKAGE_NAME));
}
...
extern "C"
ARCH_EXPORT
void HBOOST_PP_CAT(initlib, MFB_PACKAGE_NAME)() {
    PXR_NAMESPACE_USING_DIRECTIVE
    hboost::python::detail::init_module
        (HBOOST_PP_STRINGIZE(HBOOST_PP_CAT(lib,MFB_PACKAGE_NAME)),
         HBOOST_PP_CAT(&init_module_, MFB_PACKAGE_NAME));
}
