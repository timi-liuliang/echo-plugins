...
template <class T>
struct Vt_IsOutputStreamable : hboost::has_left_shift<
    std::ostream &, /* << */ T const &, /* -> */ std::ostream &> {};

// Function used in the case that T has a stream insertion operator.
template <class T>
typename hboost::enable_if<Vt_IsOutputStreamable<T>, std::ostream &>::type
...
template <class T>
typename hboost::disable_if<Vt_IsOutputStreamable<T>, std::ostream &>::type
Vt_StreamOutImpl(T const &obj, std::ostream &stream)
{
...
/// if desired.
template <class T>
typename hboost::disable_if<hboost::is_enum<T>, std::ostream &>::type
VtStreamOut(T const &obj, std::ostream &stream)
{
    return Vt_StreamOutImpl(obj, stream);
}
template <class EnumT>
typename hboost::enable_if<hboost::is_enum<EnumT>, std::ostream &>::type
