...
public:
    ...
    class Iterator : public hboost::iterator_adaptor<Iterator<UnderlyingMapPtr,
    ...
    private:
        ...
        // hboost::iterator_adaptor will invoke these as necessary to implement
        ...
        //    hboost::iterator_adaptors' base() iterators are the same
    ...
    friend size_t hash_value(VtDictionary const &dict) {
        ...
        return hboost::hash_value(*dict._dictMap);
    }
...
#define HBOOST_PP_ITERATION_LIMITS (1, VT_DICTIONARY_MAX_ARITY)
#define HBOOST_PP_FILENAME_1 "pxr/base/vt/dictionary.h"
...
inline VtDictionary VtMakeDictionary(
    HBOOST_PP_ENUM_PARAMS(N, const VtKeyValue &keyValue))
{
    ...
    #define _VT_PARAMS_TO_LIST() \
        HBOOST_PP_TUPLE_TO_LIST(N, (HBOOST_PP_ENUM_PARAMS(N, keyValue)))
    #define _VT_ADD_TO_DICTIONARY(r, unused, elem) \
        dictionary[elem.GetKey()] = elem.GetValue();

    HBOOST_PP_LIST_FOR_EACH( _VT_ADD_TO_DICTIONARY, ~, _VT_PARAMS_TO_LIST())
