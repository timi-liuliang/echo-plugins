...
// VtCat
#define HBOOST_PP_ITERATION_PARAMS_1 (4, \
...
// real functions because they're expanded through hboost or cpp macros.
// ****************************************************************************
...
#if HBOOST_PP_ITERATION_FLAGS() == 0 // VtCat
...
template<typename T>
VtArray<T>
VtCat( HBOOST_PP_ENUM_PARAMS(N, VtArray<T> const &s) )
{
    size_t newSize = 0;

    HBOOST_PP_REPEAT( N, VtCat_SIZE, ignored )
...
#if N > 0
    size_t offset = 0;
    HBOOST_PP_REPEAT( N, VtCat_COPY, ignored )
#endif
...
#endif // HBOOST_PP_ITERATION_FLAGS
