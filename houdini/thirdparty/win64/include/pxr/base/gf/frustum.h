...
class GfFrustum {
  public:
    ...
    friend inline size_t hash_value(const GfFrustum &f) {
        size_t h = 0;
        hboost::hash_combine(h, f._position);
        hboost::hash_combine(h, f._rotation);
        hboost::hash_combine(h, f._window);
        hboost::hash_combine(h, f._nearFar);
        hboost::hash_combine(h, f._viewDistance);
        hboost::hash_combine(h, f._projectionType);
        return h;
    }
