...
typedef hboost::shared_ptr<class GlfGLContext> GlfGLContextSharedPtr;
...
///
class GlfGLContext : public hboost::noncopyable {
public:
    GLF_API
...
///
class GlfGLContextScopeHolder : hboost::noncopyable {
public:
...
/// automatically.
class GlfGLContextRegistrationInterface : hboost::noncopyable {
public:
    GLF_API
