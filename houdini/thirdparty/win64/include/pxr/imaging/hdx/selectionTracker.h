...
typedef hboost::shared_ptr<class HdxSelectionTracker> HdxSelectionTrackerSharedPtr;
typedef hboost::weak_ptr<class HdxSelectionTracker> HdxSelectionTrackerWeakPtr;
