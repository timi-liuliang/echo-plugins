...
typedef hboost::shared_ptr<class HdStRenderPassShader> HdStRenderPassShaderSharedPtr;
typedef hboost::shared_ptr<class HdRenderPassState> HdRenderPassStateSharedPtr;
typedef hboost::shared_ptr<class HdxRenderSetupTask> HdxRenderSetupTaskSharedPtr;
