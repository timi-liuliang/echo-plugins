...
typedef hboost::shared_ptr<class HdStDispatchBuffer>
    HdStDispatchBufferSharedPtr;
typedef hboost::shared_ptr<class HdStPersistentBuffer>
    HdStPersistentBufferSharedPtr;
typedef hboost::shared_ptr<class HdStResourceRegistry>
    HdStResourceRegistrySharedPtr;
typedef hboost::shared_ptr<class HdSt_GeometricShader>
    HdSt_GeometricShaderSharedPtr;
typedef hboost::shared_ptr<class HdStGLSLProgram> HdStGLSLProgramSharedPtr;
