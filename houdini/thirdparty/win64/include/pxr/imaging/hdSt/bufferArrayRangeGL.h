...
typedef hboost::shared_ptr<class HdStBufferArrayRangeGL> HdStBufferArrayRangeGLSharedPtr;

class HdStBufferResourceGL;

typedef hboost::shared_ptr<class HdStBufferResourceGL> HdStBufferResourceGLSharedPtr;
typedef std::vector<
