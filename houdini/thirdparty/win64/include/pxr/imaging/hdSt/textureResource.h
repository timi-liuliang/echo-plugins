...
typedef hboost::shared_ptr<class HdStTextureResource> HdStTextureResourceSharedPtr;
typedef hboost::shared_ptr<class HdStSimpleTextureResource> HdStSimpleTextureResourceSharedPtr;

/// HdStTextureResource is an interface to a GL-backed texture.
class HdStTextureResource : public HdTextureResource, hboost::noncopyable {
public:
    HDST_API
