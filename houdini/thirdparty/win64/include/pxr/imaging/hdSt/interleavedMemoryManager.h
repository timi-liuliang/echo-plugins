...
protected:
    ...
    typedef hboost::shared_ptr<_StripedInterleavedBuffer>
        _StripedInterleavedBufferSharedPtr;
    typedef hboost::shared_ptr<_StripedInterleavedBufferRange>
        _StripedInterleavedBufferRangeSharedPtr;
    typedef hboost::weak_ptr<_StripedInterleavedBufferRange>
    ...
    private:
        ...
        _StripedInterleavedBufferRangeSharedPtr _GetRangeSharedPtr(size_t idx) const {
            return hboost::static_pointer_cast<_StripedInterleavedBufferRange>(GetRange(idx).lock());
        }
