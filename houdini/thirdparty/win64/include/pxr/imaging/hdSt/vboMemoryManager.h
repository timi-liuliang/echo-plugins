...
protected:
    ...
    typedef hboost::shared_ptr<_StripedBufferArray>
        _StripedBufferArraySharedPtr;
    typedef hboost::shared_ptr<_StripedBufferArrayRange>
        _StripedBufferArrayRangeSharedPtr;
    typedef hboost::weak_ptr<_StripedBufferArrayRange>
    ...
    private:
        ...
        _StripedBufferArrayRangeSharedPtr _GetRangeSharedPtr(size_t idx) const {
            return hboost::static_pointer_cast<_StripedBufferArrayRange>(GetRange(idx).lock());
        }
    };
};
