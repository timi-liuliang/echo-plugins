...
typedef hboost::shared_ptr<class HdBufferArrayRange> HdBufferArrayRangeSharedPtr;
typedef hboost::shared_ptr<class HdStRenderPassState> HdStRenderPassStateSharedPtr;
typedef hboost::shared_ptr<class HdStShaderCode> HdStShaderCodeSharedPtr;
typedef hboost::shared_ptr<class HdStLightingShader> HdStLightingShaderSharedPtr;
typedef hboost::shared_ptr<class HdStRenderPassShader>
                HdStRenderPassShaderSharedPtr;
typedef hboost::shared_ptr<class HdSt_FallbackLightingShader>
