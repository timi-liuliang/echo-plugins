...
typedef hboost::shared_ptr<class HdSt_MeshTopology> HdSt_MeshTopologySharedPtr;
typedef hboost::shared_ptr<class HdBufferSource> HdBufferSourceSharedPtr;
typedef hboost::shared_ptr<class HdStResourceRegistry>
