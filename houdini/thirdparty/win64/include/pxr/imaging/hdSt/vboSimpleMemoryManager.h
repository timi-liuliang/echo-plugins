...
protected:
    ...
    typedef hboost::shared_ptr<_SimpleBufferArray>
        _SimpleBufferArraySharedPtr;
    typedef hboost::shared_ptr<_SimpleBufferArrayRange>
        _SimpleBufferArrayRangeSharedPtr;
    typedef hboost::weak_ptr<_SimpleBufferArrayRange>
    ...
    private:
        ...
        _SimpleBufferArrayRangeSharedPtr _GetRangeSharedPtr() const {
            return GetRangeCount() > 0
                ? hboost::static_pointer_cast<_SimpleBufferArrayRange>(GetRange(0).lock())
                : _SimpleBufferArrayRangeSharedPtr();
        }
    };
};
