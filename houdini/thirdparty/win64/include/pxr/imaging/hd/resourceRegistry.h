...
typedef hboost::shared_ptr<class HdBufferArray> HdBufferArraySharedPtr;
typedef hboost::shared_ptr<class HdMeshTopology> HdMeshTopologySharedPtr;
typedef hboost::shared_ptr<class HdBasisCurvesTopology> 
                                                 HdBasisCurvesTopologySharedPtr;
typedef hboost::weak_ptr<class HdBufferArrayRange> HdBufferArrayRangePtr;
typedef hboost::shared_ptr<class HdComputation> HdComputationSharedPtr;
typedef hboost::shared_ptr<class Hd_VertexAdjacency> Hd_VertexAdjacencySharedPtr;
typedef hboost::shared_ptr<class HdResourceRegistry> HdResourceRegistrySharedPtr;

/// \class HdResourceRegistry
///
/// A central registry of all GPU resources.
///
class HdResourceRegistry : public hboost::noncopyable  {
public:
