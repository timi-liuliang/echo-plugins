...
typedef hboost::shared_ptr<class HdDirtyList> HdDirtyListSharedPtr;
typedef hboost::shared_ptr<class HdTask> HdTaskSharedPtr;
...
HdRenderIndex::InsertTask(HdSceneDelegate* delegate, SdfPath const& id)
{
    ...
    HdTaskSharedPtr task = hboost::make_shared<T>(delegate, id);
