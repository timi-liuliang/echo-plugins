...
typedef hboost::shared_ptr<HdBufferSource const> HdBufferSourceConstSharedPtr;
typedef std::vector<HdBufferSourceSharedPtr> HdBufferSourceVector;
typedef hboost::weak_ptr<HdBufferSource> HdBufferSourceWeakPtr;
...
/// calls.
///
class HdBufferSource : public hboost::noncopyable {
public:
