...
typedef hboost::shared_ptr<HdBufferArrayRange> HdBufferArrayRangeSharedPtr;
typedef hboost::weak_ptr<HdBufferArrayRange> HdBufferArrayRangePtr;
...
/// aggregation.
///
class HdBufferArray : public hboost::enable_shared_from_this<HdBufferArray>,
    hboost::noncopyable {
public:
    HD_API
