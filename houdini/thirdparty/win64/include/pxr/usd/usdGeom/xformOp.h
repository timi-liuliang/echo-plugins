...
public:
    ...
    bool MightBeTimeVarying() const {
        return hboost::apply_visitor(_GetMightBeTimeVarying(), _attr);
    }
    ...
    UsdAttribute const &GetAttr() const { 
        return hboost::apply_visitor(_GetAttr(), _attr); 
    }
...
public:
    ...
    bool Get(T* value, UsdTimeCode time = UsdTimeCode::Default()) const {
        return hboost::apply_visitor(_Get<T>(value, time), _attr);
    }
    ...
    bool GetTimeSamples(std::vector<double> *times) const {
        return hboost::apply_visitor(_GetTimeSamples(times), _attr);
    }
    ...
    size_t GetNumTimeSamples() const {
        return hboost::apply_visitor(_GetNumTimeSamples(), _attr);
    }
...
private:
    ...
    // 
    mutable hboost::variant<UsdAttribute, UsdAttributeQuery> _attr;
    ...
    template <class T>
    struct _Get : public hboost::static_visitor<bool> 
    {
        _Get(T *value_, 
    ...
    struct _GetAttr : public hboost::static_visitor<const UsdAttribute &> {
    ...
    struct _GetTimeSamples : public hboost::static_visitor<bool> {
    ...
    struct _GetTimeSamplesInInterval : public hboost::static_visitor<bool> {
    ...
    struct _GetNumTimeSamples : public hboost::static_visitor<size_t> {
    ...
    struct _GetMightBeTimeVarying : public hboost::static_visitor<bool> {
