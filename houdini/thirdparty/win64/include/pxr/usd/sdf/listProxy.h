...
class SdfListProxy :
    hboost::totally_ordered<SdfListProxy<_TypePolicy>,
...
private:
    ...
    class _ItemProxy : hboost::totally_ordered<_ItemProxy> {
    public:
    ...
    class _Iterator :
        public hboost::iterator_facade<
            ...
            typename hboost::remove_cv<
                typename hboost::remove_reference<
...
public:
    ...
    SdfListProxy(const hboost::shared_ptr<Sdf_ListEditor<TypePolicy> >& editor,
                SdfListOpType op) :
        _listEditor(editor),
        _op(op)
    {
...
#if !defined(doxygen)
    typedef hboost::shared_ptr<Sdf_ListEditor<TypePolicy> >
...
private:
    hboost::shared_ptr<Sdf_ListEditor<TypePolicy> > _listEditor;
    SdfListOpType _op;
...
template <typename T>
struct Tf_ShouldIterateOverCopy<SdfListProxy<T> > : hboost::true_type
{
};
