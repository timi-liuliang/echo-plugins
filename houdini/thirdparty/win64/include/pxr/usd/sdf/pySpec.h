...
///
/// This file introduces a few hboost::python::class_ def visitors to make
...
private:
    ...
    _RegisterConverter(bp::converter::to_python_function_t f)
    {
        ...
        // registered the class.  WBN if hboost python let us do this
    ...
    public:
        static std::string Repr(const bp::object& self)
        {
            ...
            return _SpecRepr(self,
                             held ? hboost::get_pointer(held) : NULL);
        }
