...
class SdfMapEditProxy :
    hboost::totally_ordered<SdfMapEditProxy<T, _ValuePolicy>, T> {
public:
    typedef T Type;
...
private:
    ...
    class _PairProxy : hboost::totally_ordered<_PairProxy> {
    public:
    ...
    class _Iterator :
        public hboost::iterator_facade<_Iterator<Owner, I, R>, R,
...
#if !defined(doxygen)
    typedef hboost::shared_ptr<Sdf_MapEditor<Type> > This::*UnspecifiedBoolType;
#endif
...
private:
    ...
    hboost::shared_ptr<Sdf_MapEditor<T> > _editor;
};
