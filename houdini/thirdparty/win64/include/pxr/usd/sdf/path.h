...
///
class SdfPath :
    hboost::totally_ordered<SdfPath>
{
public:
...
// Overload hash_value for SdfPath.  Used by things like hboost::hash.
...
/// can use this function with hboost::transform_iterator, supplying a functor to
...
/// hboost::transform_iterator, supplying a functor to transform_iterator that
