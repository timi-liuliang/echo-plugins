...
typedef hboost::intrusive_ptr<Sdf_Identity> Sdf_IdentityRefPtr;
...
///
template <class T>
class SdfHandle : private hboost::totally_ordered<SdfHandle<T> > {
public:
    typedef SdfHandle<T> This;
    typedef T SpecType;

    typedef typename hboost::remove_const<SpecType>::type NonConstSpecType;
...
struct Sdf_SpecTypesAreDirectlyRelated
    : public hboost::mpl::or_<hboost::is_base_of<DST, SRC>,
                             hboost::is_base_of<SRC, DST> >::type
{ };
