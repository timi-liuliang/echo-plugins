...
private:
    ...
    static hboost::python::list _GetItemSlice(const Type& x,
    ...
    static void _SetItemSlice(Type& x, const hboost::python::slice& index,
    ...
    static void _DelItemSlice(Type& x, const hboost::python::slice& index)
    {
        using namespace hboost::python;
