...
public:
    ...
    public:
        ...
        hboost::optional<V> operator()(SdfListOpType op, const V& value)
        {
            ...
            return hboost::optional<V>();
        }

    private:
        const T& _owner;
        TfPyCall<hboost::python::object> _callback;
    };
...
private:
    ...
    static std::string _GetStr(const Type& x)
    {
        return x._listEditor ? 
            hboost::lexical_cast<std::string>(*x._listEditor) : std::string();
    }
    ...
    static void _ModifyEdits(Type& x, const hboost::python::object& cb)
    {
