...
private:
    ...
    // structure.
    struct _Entry : hboost::noncopyable {
...
public:
    ...
    class Iterator :
        public hboost::iterator_facade<Iterator<ValType, EntryPtr>,
                                      ValType, hboost::forward_traversal_tag>
    {
    public:
    ...
    protected:
        ...
        // hboost::iterator_facade will invoke these as necessary to implement
