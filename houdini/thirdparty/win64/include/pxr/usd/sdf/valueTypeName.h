...
///
struct SdfTupleDimensions 
    : hboost::equality_comparable<SdfTupleDimensions> {
public:
...
/// 
class SdfValueTypeName
    : hboost::equality_comparable<SdfValueTypeName, std::string
    , hboost::equality_comparable<SdfValueTypeName, TfToken
    , hboost::equality_comparable<SdfValueTypeName
    > > > {
public:
