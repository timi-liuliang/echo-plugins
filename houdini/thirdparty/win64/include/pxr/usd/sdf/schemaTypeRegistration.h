...
#define _SDF_REGISTER_FIELDS(r, unused, elem)                        \
    ...
    HBOOST_PP_SEQ_FOR_EACH(_SDF_REGISTER_FIELDS, ~, _SDF_FIELDS)
...
#define _SDF_REGISTER_TYPES(r, unused, elem)             \
    ...
    HBOOST_PP_SEQ_FOR_EACH(_SDF_REGISTER_TYPES, ~, _SDF_FIELDS)
...
#define _SDF_REGISTER_VALUE_TYPES(r, unused, elem)       \
    ...
    HBOOST_PP_SEQ_FOR_EACH(_SDF_REGISTER_VALUE_TYPES, ~, SDF_VALUE_TYPES)
