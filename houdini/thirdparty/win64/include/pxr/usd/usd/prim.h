...
// supplied predicate.
class UsdPrimSiblingIterator : public hboost::iterator_adaptor<
...
struct Tf_ShouldIterateOverCopy<
    UsdPrimSiblingRange> : hboost::true_type {};
template <>
struct Tf_ShouldIterateOverCopy<
    const UsdPrimSiblingRange> : hboost::true_type {};
...
// supplied predicate.
class UsdPrimSubtreeIterator : public hboost::iterator_adaptor<
...
template <>
struct Tf_ShouldIterateOverCopy<
    UsdPrimSubtreeRange> : hboost::true_type {};
template <>
struct Tf_ShouldIterateOverCopy<
    const UsdPrimSubtreeRange> : hboost::true_type {};
