...
class Usd_PrimDataSiblingIterator : public hboost::iterator_adaptor<
    Usd_PrimDataSiblingIterator,                  // crtp.
    Usd_PrimData *,                               // base iterator.
    Usd_PrimData *,                               // value.
    hboost::forward_traversal_tag,                 // traversal.
...
struct Tf_ShouldIterateOverCopy<
    Usd_PrimDataSiblingRange> : hboost::true_type {};
template <>
struct Tf_ShouldIterateOverCopy<
    const Usd_PrimDataSiblingRange> : hboost::true_type {};
...
// Tree iterator class.
class Usd_PrimDataSubtreeIterator : public hboost::iterator_adaptor<
...
template <>
struct Tf_ShouldIterateOverCopy<
    Usd_PrimDataSubtreeRange> : hboost::true_type {};
template <>
struct Tf_ShouldIterateOverCopy<
    const Usd_PrimDataSubtreeRange> : hboost::true_type {};
