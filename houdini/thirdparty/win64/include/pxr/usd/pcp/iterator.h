...
class PcpNodeIterator
    : public hboost::iterator_facade<
                 ...
                 /* Category =  */ hboost::random_access_traversal_tag,
                 /* RefType =   */ PcpNodeRef
             >
{
public:
...
public:
    ...
    explicit PcpNodeReverseIterator(const PcpNodeIterator& iter)
        : hboost::reverse_iterator<PcpNodeIterator>(iter) { }
};
...
public:
    ...
    explicit PcpPrimReverseIterator(const PcpPrimIterator& iter)
        : hboost::reverse_iterator<PcpPrimIterator>(iter) { }
...
///
class PcpPropertyReverseIterator
    : public hboost::reverse_iterator<PcpPropertyIterator>
{
public:
    PcpPropertyReverseIterator() { }
    explicit PcpPropertyReverseIterator(const PcpPropertyIterator& iter)
        : hboost::reverse_iterator<PcpPropertyIterator>(iter) { }
    ...
    struct Tf_IteratorInterface<const Range, true> {                    \
        ...
        static IteratorType End(Range const &c)                         \
            { return IteratorType(c.first); }                           \
                                                                        ...
                                                                        \
    template <>                                                         \
    struct Tf_ShouldIterateOverCopy<Range> : hboost::true_type {};       \
                                                                        \
    template <>                                                         \
    struct Tf_ShouldIterateOverCopy<const Range> : hboost::true_type {}
