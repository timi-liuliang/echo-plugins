...
typedef hboost::shared_ptr<UsdImagingPrimAdapter> UsdImagingPrimAdapterSharedPtr;
...
class UsdImagingAdapterRegistry : public TfSingleton<UsdImagingAdapterRegistry> 
{
    ...
    typedef hboost::unordered_map<TfToken,TfType,TfToken::HashFunctor> _TypeMap;
    _TypeMap _typeMap;
