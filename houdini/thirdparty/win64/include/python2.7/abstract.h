...
#define PyMapping_DelItem(O,K) PyObject_DelItem((O),(K))
     ...
     expression: o.keys().
       */
#define PyMapping_Keys(O) PyObject_CallMethod(O,(char*)"keys",NULL)
     ...
     expression: o.values().
       */
#define PyMapping_Values(O) PyObject_CallMethod(O,(char*)"values",NULL)
     ...
     expression: o.items().
       ...
       */
#define PyMapping_Items(O) PyObject_CallMethod(O,(char*)"items",NULL)
