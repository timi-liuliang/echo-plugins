...
#ifndef __HOM_PointGroup_h__
#define __HOM_PointGroup_h__
...
SWIGOUT(%rename(PointGroup) HOM_PointGroup;)

class HOM_API HOM_PointGroup
{
public:
    HOM_PointGroup()
    ...
    virtual bool operator==(HOM_PtrOrNull<HOM_PointGroup> point_group) = 0;
    virtual bool operator!=(HOM_PtrOrNull<HOM_PointGroup> point_group) = 0;
    ...
    virtual bool contains(HOM_Point &point) = 0;

    virtual bool isOrdered() = 0;

    virtual void add(HOM_Point &point) = 0;

    virtual void add(const std::vector<HOM_Point *> &points) = 0;

    virtual void add(HOM_PointGroup &point_group) = 0;

    virtual void remove(HOM_Point &point) = 0;

    virtual void remove(const std::vector<HOM_Point *> &points) = 0;

    virtual void remove(HOM_PointGroup &point_group) = 0;
...
%extend
{
    ...
    {
	HOM_PointGroup::OptionAutoLocks	 locks;
