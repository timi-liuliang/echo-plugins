...
#ifndef __HOM_PackedPrim_h__
#define __HOM_PackedPrim_h__
...
SWIGOUT(%rename(PackedPrim) HOM_PackedPrim;)

class HOM_API HOM_PackedPrim : virtual public HOM_Prim
{
public:
    HOM_PackedPrim()
    ...
    SWIGOUT(%newobject fullTransform;)
