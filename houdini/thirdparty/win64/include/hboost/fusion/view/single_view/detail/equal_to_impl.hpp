...
#if !defined(HBOOST_FUSION_SINGLE_VIEW_ITERATOR_JUL_07_2011_1348PM)
#define HBOOST_FUSION_SINGLE_VIEW_ITERATOR_JUL_07_2011_1348PM
...
namespace hboost { namespace fusion 
{
    ...
    namespace extension
    {
        ...
        struct equal_to_impl<single_view_iterator_tag>
        {
            ...
            {
                HBOOST_MPL_ASSERT((is_same<typename add_const<typename It1::single_view_type>::type, 
