...
==============================================================================*/
#if !defined(HBOOST_FUSION_FILTER_VIEW_ITERATOR_05062005_0849)
#define HBOOST_FUSION_FILTER_VIEW_ITERATOR_05062005_0849
...
#include <hboost/fusion/view/filter_view/detail/deref_impl.hpp>
#include <hboost/fusion/view/filter_view/detail/next_impl.hpp>
#include <hboost/fusion/view/filter_view/detail/value_of_impl.hpp>
#include <hboost/fusion/view/filter_view/detail/equal_to_impl.hpp>
#include <hboost/fusion/view/filter_view/detail/deref_data_impl.hpp>
#include <hboost/fusion/view/filter_view/detail/value_of_data_impl.hpp>
#include <hboost/fusion/view/filter_view/detail/key_of_impl.hpp>
...
{
    template <typename Category, typename First, typename Last, typename Pred>
    struct iterator_traits< ::hboost::fusion::filter_iterator<Category, First, Last, Pred> >
    { };
}
#endif
