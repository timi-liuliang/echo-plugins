...
==============================================================================*/
#if !defined(HBOOST_FUSION_DISTANCE_IMPL_20060124_2033)
#define HBOOST_FUSION_DISTANCE_IMPL_20060124_2033
...
namespace hboost { namespace fusion {
    ...
    namespace detail
    {
        ...
        struct best_distance
        {
            ...
            HBOOST_MPL_ASSERT_NOT((is_same<typename finder::type, result_of::end<typename SearchIt::iterators> >));
