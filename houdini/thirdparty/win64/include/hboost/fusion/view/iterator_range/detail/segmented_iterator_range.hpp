...
==============================================================================*/
#if !defined(HBOOST_FUSION_SEGMENTED_ITERATOR_RANGE_HPP_INCLUDED)
#define HBOOST_FUSION_SEGMENTED_ITERATOR_RANGE_HPP_INCLUDED
...
#include <hboost/fusion/container/list/detail/reverse_cons.hpp>
#include <hboost/fusion/iterator/detail/segment_sequence.hpp>
...
namespace hboost { namespace fusion { namespace detail
{
    ...
    template <
      ...
      , typename StackEnd
      , bool SameSegment
#if !(HBOOST_WORKAROUND(HBOOST_GCC, >= 40000) && HBOOST_WORKAROUND(HBOOST_GCC, < 40200))
          = result_of::equal_to<
