...
==============================================================================*/
#if !defined(HBOOST_FUSION_TRANSFORM_VIEW_07162005_1037)
#define HBOOST_FUSION_TRANSFORM_VIEW_07162005_1037
...
#include <hboost/fusion/view/transform_view/transform_view_iterator.hpp>
#include <hboost/fusion/view/transform_view/transform_view_fwd.hpp>
#include <hboost/fusion/view/transform_view/detail/begin_impl.hpp>
#include <hboost/fusion/view/transform_view/detail/end_impl.hpp>
#include <hboost/fusion/view/transform_view/detail/at_impl.hpp>
#include <hboost/fusion/view/transform_view/detail/value_at_impl.hpp>
#include <hboost/fusion/view/detail/strictest_traversal.hpp>
#include <hboost/fusion/container/vector/vector10.hpp>
...
namespace hboost { namespace fusion
{
    ...
    {
        HBOOST_STATIC_ASSERT(result_of::size<Sequence1>::value == result_of::size<Sequence2>::value);
...
#if defined(HBOOST_NO_PARTIAL_SPECIALIZATION_IMPLICIT_DEFAULT_ARGS)
