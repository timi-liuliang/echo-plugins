...
==============================================================================*/
#if !defined(HBOOST_FUSION_ADVANCE_IMPL_13122005_1906)
#define HBOOST_FUSION_ADVANCE_IMPL_13122005_1906
    ...
    namespace extension
    {
        ...
        struct advance_impl<transform_view_iterator_tag>
        {
            ...
            struct apply
            {
                ...
                {
                    return type(hboost::fusion::advance<Dist>(i.first), i.f);
                }
            };
        };
        ...
        struct advance_impl<transform_view_iterator2_tag>
        {
            ...
            struct apply
            {
                ...
                {
                    return type(
                        hboost::fusion::advance<Dist>(i.first1)
                      , hboost::fusion::advance<Dist>(i.first2), i.f);
                }
            };
        };
    }
