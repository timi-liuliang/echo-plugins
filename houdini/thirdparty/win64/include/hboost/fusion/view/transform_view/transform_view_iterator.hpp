...
==============================================================================*/
#if !defined(HBOOST_FUSION_TRANSFORM_VIEW_ITERATOR_07162005_1033)
#define HBOOST_FUSION_TRANSFORM_VIEW_ITERATOR_07162005_1033
...
#include <hboost/fusion/view/transform_view/detail/deref_impl.hpp>
#include <hboost/fusion/view/transform_view/detail/next_impl.hpp>
#include <hboost/fusion/view/transform_view/detail/prior_impl.hpp>
#include <hboost/fusion/view/transform_view/detail/value_of_impl.hpp>
#include <hboost/fusion/view/transform_view/detail/advance_impl.hpp>
#include <hboost/fusion/view/transform_view/detail/distance_impl.hpp>
#include <hboost/fusion/view/transform_view/detail/equal_to_impl.hpp>
...
{
    template <typename First, typename F>
    struct iterator_traits< ::hboost::fusion::transform_view_iterator<First, F> >
    { };
    template <typename First1, typename First2, typename F>
    struct iterator_traits< ::hboost::fusion::transform_view_iterator2<First1, First2, F> >
    { };
}
#endif
