...
==============================================================================*/
#if !defined(HBOOST_FUSION_SEGMENTED_BEGIN_HPP_INCLUDED)
#define HBOOST_FUSION_SEGMENTED_BEGIN_HPP_INCLUDED

#include <hboost/fusion/support/config.hpp>
#include <hboost/fusion/sequence/intrinsic/detail/segmented_begin_impl.hpp>
#include <hboost/fusion/iterator/segmented_iterator.hpp>
#include <hboost/fusion/view/iterator_range.hpp>
