...
==============================================================================*/
#if !defined(HBOOST_FUSION_TUPLE_10032005_0810)
#define HBOOST_FUSION_TUPLE_10032005_0810
...
#include <hboost/fusion/tuple/detail/preprocessed/tuple.hpp>
#else
...
namespace hboost { namespace fusion
{
    ...
    struct tuple : vector<HBOOST_PP_ENUM_PARAMS(FUSION_MAX_VECTOR_SIZE, T)>
    {
        typedef vector<
            HBOOST_PP_ENUM_PARAMS(FUSION_MAX_VECTOR_SIZE, T)>
        base_type;

        HBOOST_FUSION_GPU_ENABLED tuple()
            : base_type() {}

        HBOOST_FUSION_GPU_ENABLED tuple(tuple const& rhs)
        ...
        #include <hboost/fusion/tuple/detail/tuple_expand.hpp>
