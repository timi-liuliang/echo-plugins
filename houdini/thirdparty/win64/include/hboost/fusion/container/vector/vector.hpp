...
==============================================================================*/
#ifndef HBOOST_FUSION_VECTOR_11052014_1625
#define HBOOST_FUSION_VECTOR_11052014_1625
...
# include <hboost/fusion/container/vector/detail/cpp03/vector.hpp>
#else
...
namespace hboost { namespace fusion
{
    ...
    namespace vector_detail
    {
        ...
        struct is_convertible_to_first
            : hboost::is_convertible<Sequence, typename result_of::value_at_c<This, 0>::type>
        {};
        ...
        inline each_elem
        dispatch(T const&...) HBOOST_NOEXCEPT { return each_elem(); }

        template <typename This>
        HBOOST_CONSTEXPR HBOOST_FUSION_GPU_ENABLED
        inline copy_or_move
        dispatch(This const&) HBOOST_NOEXCEPT { return copy_or_move(); }
        ...
        inline from_sequence<
            ...
            >::type
        >
        dispatch(Sequence&&) HBOOST_NOEXCEPT
            ...
            , sequence_base<vector_data<detail::index_sequence<I...>, T...> >
        {
            ...
            static HBOOST_CXX14_CONSTEXPR HBOOST_FUSION_GPU_ENABLED
            ...
            template <std::size_t N, typename U>
            static HBOOST_CONSTEXPR HBOOST_FUSION_GPU_ENABLED
            ...
            template <std::size_t N, typename U>
            static HBOOST_FUSION_GPU_ENABLED
            mpl::identity<U> value_at_impl(store<N, U>*);
        };
    } // namespace hboost::fusion::vector_detail
