...
==============================================================================*/
#if !defined(HBOOST_FUSION_VECTOR10_FWD_HPP_INCLUDED)
#define HBOOST_FUSION_VECTOR10_FWD_HPP_INCLUDED
...
#include <hboost/fusion/container/vector/detail/cpp03/preprocessed/vector10_fwd.hpp>
#else
...
namespace hboost { namespace fusion
{
    ...
    #define HBOOST_PP_FILENAME_1 <hboost/fusion/container/vector/detail/cpp03/vector10_fwd.hpp>
