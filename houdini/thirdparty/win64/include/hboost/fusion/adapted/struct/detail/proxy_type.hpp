...
#ifndef HBOOST_FUSION_ADAPTED_DETAIL_STRUCT_PROXY_TYPE_HPP
#define HBOOST_FUSION_ADAPTED_DETAIL_STRUCT_PROXY_TYPE_HPP

#include <hboost/fusion/support/config.hpp>
#include <hboost/fusion/adapted/struct/detail/namespace.hpp>

#define HBOOST_FUSION_PROXY_PREFIX() obj.

#define HBOOST_FUSION_ADAPT_STRUCT_DEFINE_PROXY_TYPE_IMPL(                       \
...
#define HBOOST_FUSION_ADAPT_STRUCT_DEFINE_PROXY_TYPE(                            \
    WRAPPED_TYPE, NAMESPACE_SEQ, NAME)                                          \
                                                                                \
