...
==============================================================================*/
#if !defined(HBOOST_FUSION_CATEGORY_OF_IMPL_20060217_2141)
#define HBOOST_FUSION_CATEGORY_OF_IMPL_20060217_2141
...
namespace hboost { namespace fusion {
    ...
    namespace detail
    {
        ...
        struct mpl_sequence_category_of
        {
            ...
            HBOOST_STATIC_ASSERT(mpl::is_sequence<T>::value);
            typedef typename 
