...
==============================================================================*/
#if !defined(HBOOST_FUSION_POP_BACK_09172005_1038)
#define HBOOST_FUSION_POP_BACK_09172005_1038
...
#include <hboost/fusion/iterator/iterator_adapter.hpp>
...
namespace hboost { namespace fusion
{
    ...
    namespace result_of
    {
        ...
        struct pop_back
        {
            HBOOST_MPL_ASSERT_NOT((result_of::empty<Sequence>));
