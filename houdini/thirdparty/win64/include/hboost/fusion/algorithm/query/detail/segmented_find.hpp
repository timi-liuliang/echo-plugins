...
==============================================================================*/
#if !defined(HBOOST_FUSION_SEGMENTED_FIND_HPP_INCLUDED)
#define HBOOST_FUSION_SEGMENTED_FIND_HPP_INCLUDED

#include <hboost/fusion/support/config.hpp>
#include <hboost/mpl/eval_if.hpp>
#include <hboost/mpl/identity.hpp>
#include <hboost/fusion/algorithm/query/find_fwd.hpp>
