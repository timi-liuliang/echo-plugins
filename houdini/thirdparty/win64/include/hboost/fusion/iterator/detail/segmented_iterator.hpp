...
==============================================================================*/
#if !defined(HBOOST_FUSION_SEGMENTED_ITERATOR_SEGMENTED_ITERATOR_HPP_INCLUDED)
#define HBOOST_FUSION_SEGMENTED_ITERATOR_SEGMENTED_ITERATOR_HPP_INCLUDED
...
#include <hboost/fusion/iterator/detail/segmented_equal_to.hpp>
...
namespace hboost { namespace fusion
{
    ...
    {
        HBOOST_CONSTEXPR HBOOST_FUSION_GPU_ENABLED explicit segmented_iterator(Context const& ctx)
          : context(ctx)
        {}
