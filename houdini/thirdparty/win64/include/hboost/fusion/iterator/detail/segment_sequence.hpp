...
==============================================================================*/
#if !defined(HBOOST_FUSION_SEGMENTED_SEQUENCE_HPP_INCLUDED)
#define HBOOST_FUSION_SEGMENTED_SEQUENCE_HPP_INCLUDED
...
namespace hboost { namespace fusion { namespace detail
{
        ...
        : sequence_base<segment_sequence<Sequence> >
    {
        ...
        HBOOST_CONSTEXPR HBOOST_FUSION_GPU_ENABLED explicit segment_sequence(Sequence const & seq)
            : sequence(seq)
        {}
    };
}
