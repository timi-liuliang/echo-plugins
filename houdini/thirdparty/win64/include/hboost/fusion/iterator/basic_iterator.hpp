...
#ifndef HBOOST_FUSION_ITERATOR_BASIC_ITERATOR_HPP
#define HBOOST_FUSION_ITERATOR_BASIC_ITERATOR_HPP
...
{
    template <typename Tag, typename Category, typename Seq, int Index>
    struct iterator_traits< ::hboost::fusion::basic_iterator<Tag, Category, Seq, Index> >
    { };
}
#endif
