...
==============================================================================*/
#if !defined(HBOOST_FUSION_CATEGORY_OF_07202005_0308)
#define HBOOST_FUSION_CATEGORY_OF_07202005_0308

#include <hboost/fusion/support/config.hpp>
#include <hboost/fusion/support/detail/category_of.hpp>
...
namespace hboost { namespace fusion
{
    ...
    namespace extension
    {
        ...
        template <>
        struct category_of_impl<hboost_array_tag>;
