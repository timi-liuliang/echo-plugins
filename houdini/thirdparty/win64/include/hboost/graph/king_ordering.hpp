...
//=======================================================================//
#ifndef HBOOST_GRAPH_KING_HPP
#define HBOOST_GRAPH_KING_HPP

#include <hboost/config.hpp>
#include <hboost/graph/detail/sparse_ordering.hpp>
...
namespace hboost {
  namespace detail {
    ...
    public:
      ...
      void finish_vertex(Vertex, Graph& g) {
        ...
        std::make_heap(rbegin, rend, hboost::bind<bool>(comp, _2, _1));
        ...
        for( ; rbegin != rend; rend--){
          ...
          for (hboost::tie(ei, ei_end) = out_edges(w, g); ei != ei_end; ++ei) {
            v = target(*ei, g);
                ...
                VertexIndexMap index_map)
  {
    ...
    typedef typename hboost::sparse::sparse_ordering_queue<Vertex> queue;
