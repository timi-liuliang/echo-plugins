...
#ifndef HBOOST_GRAPH_ISOMORPHISM_HPP
#define HBOOST_GRAPH_ISOMORPHISM_HPP
...
#include <hboost/smart_ptr.hpp>
#include <hboost/graph/depth_first_search.hpp>
#include <hboost/detail/algorithm.hpp>
#include <hboost/pending/indirect_cmp.hpp> // for make_indirect_pmap
  ...
  namespace detail {
    ...
    class isomorphism_algo
    {
      ...
      typedef safe_iterator_property_map<typename std::vector<int>::iterator,
                                         IndexMap1
#ifdef HBOOST_NO_STD_ITERATOR_TRAITS
                                         , int, int&
#endif /* HBOOST_NO_STD_ITERATOR_TRAITS */
                                         > DFSNumMap;
      DFSNumMap dfs_num;
            ...
            while (fi_adj.first != fi_adj.second) {
              {
                ...
                if (invariant2(v) == invariant1(j) && in_S[v] == false) {
                  ...
                  int next_k = max HBOOST_PREVENT_MACRO_SUBSTITUTION(dfs_num_k, max HBOOST_PREVENT_MACRO_SUBSTITUTION(dfs_num[i], dfs_num[j]));
                  match_continuation new_k;
...
fi_adj_loop_k:++fi_adj.first;
  ...
  public:
    ...
    size_type max HBOOST_PREVENT_MACRO_SUBSTITUTION () const { 
...

  {
    ...
    HBOOST_CONCEPT_ASSERT(( AdaptableUnaryFunctionConcept<Invariant1,
      size_type, vertex1_t> ));
    HBOOST_CONCEPT_ASSERT(( AdaptableUnaryFunctionConcept<Invariant2,
      size_type, vertex2_t> ));
    
    // Property map requirements
    HBOOST_CONCEPT_ASSERT(( ReadWritePropertyMapConcept<IsoMapping, vertex1_t> ));
    typedef typename property_traits<IsoMapping>::value_type IsoMappingValue;
    HBOOST_STATIC_ASSERT((is_convertible<IsoMappingValue, vertex2_t>::value));
    
    HBOOST_CONCEPT_ASSERT(( ReadablePropertyMapConcept<IndexMap1, vertex1_t> ));
    typedef typename property_traits<IndexMap1>::value_type IndexMap1Value;
    HBOOST_STATIC_ASSERT((is_convertible<IndexMap1Value, size_type>::value));
    
    HBOOST_CONCEPT_ASSERT(( ReadablePropertyMapConcept<IndexMap2, vertex2_t> ));
    typedef typename property_traits<IndexMap2>::value_type IndexMap2Value;
    HBOOST_STATIC_ASSERT((is_convertible<IndexMap2Value, size_type>::value));
  ...
  namespace detail {
    ...
    struct make_degree_invariant {
      ...
      typedef typename hboost::graph_traits<G>::degree_size_type degree_size_type;
  ...
  namespace graph {
    namespace detail {
      ...
      struct isomorphism_impl {
        ...
        bool operator()(const Graph1& g1, const Graph2& g2, const ArgPack& arg_pack) const {
          ...
          typedef typename hboost::detail::override_const_property_result<ArgPack, tag::vertex_index1_map, hboost::vertex_index_t, Graph1>::type index1_map_type;
          typedef typename hboost::detail::override_const_property_result<ArgPack, tag::vertex_index2_map, hboost::vertex_index_t, Graph2>::type index2_map_type;
          index1_map_type index1_map = hboost::detail::override_const_property(arg_pack, _vertex_index1_map, g1, hboost::vertex_index);
          index2_map_type index2_map = hboost::detail::override_const_property(arg_pack, _vertex_index2_map, g2, hboost::vertex_index);
          typedef typename graph_traits<Graph2>::vertex_descriptor vertex2_t;
          typename std::vector<vertex2_t>::size_type n = (typename std::vector<vertex2_t>::size_type)num_vertices(g1);
          std::vector<vertex2_t> f(n);
          typename hboost::parameter::lazy_binding<
                     ArgPack,
                     tag::vertex_invariant1,
                     hboost::detail::make_degree_invariant<Graph1, index1_map_type> >::type
            invariant1 =
              arg_pack[_vertex_invariant1 || hboost::detail::make_degree_invariant<Graph1, index1_map_type>(g1, index1_map)];
          typename hboost::parameter::lazy_binding<
                     ArgPack,
                     tag::vertex_invariant2,
                     hboost::detail::make_degree_invariant<Graph2, index2_map_type> >::type
            invariant2 =
              arg_pack[_vertex_invariant2 || hboost::detail::make_degree_invariant<Graph2, index2_map_type>(g2, index2_map)];
          return hboost::isomorphism
                   (g1, g2,
                    choose_param(arg_pack[_isomorphism_map | hboost::param_not_found()],
    ...
    HBOOST_GRAPH_MAKE_FORWARDING_FUNCTION(isomorphism, 2, 6)
  }

  // Named parameter interface
  HBOOST_GRAPH_MAKE_OLD_STYLE_PARAMETER_FUNCTION(isomorphism, 2)
...
#endif // HBOOST_GRAPH_ISOMORPHISM_HPP
