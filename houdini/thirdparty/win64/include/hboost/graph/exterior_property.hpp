...
#ifndef HBOOST_GRAPH_EXTERIOR_PROPERTY_HPP
#define HBOOST_GRAPH_EXTERIOR_PROPERTY_HPP

#include <vector>
#include <hboost/graph/property_maps/container_property_map.hpp>
#include <hboost/graph/property_maps/matrix_property_map.hpp>
