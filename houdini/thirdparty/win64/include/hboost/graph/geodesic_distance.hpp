...
#ifndef HBOOST_GRAPH_GEODESIC_DISTANCE_HPP
#define HBOOST_GRAPH_GEODESIC_DISTANCE_HPP
    ...
    : public geodesic_measure<Graph, DistanceType, ResultType>
{
    ...
    result_type operator ()(distance_type d, const Graph& g)
    {
        ...
        HBOOST_CONCEPT_ASSERT(( AdaptableBinaryFunctionConcept<Divides,ResultType,ResultType,ResultType> ));
                    ...
                    Measure measure)
{
    ...
    HBOOST_CONCEPT_ASSERT(( WritablePropertyMapConcept<GeodesicMap,Vertex> ));
    HBOOST_CONCEPT_ASSERT(( NumericValueConcept<Result> ));
