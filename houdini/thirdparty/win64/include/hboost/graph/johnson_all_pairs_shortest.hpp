...
#ifndef HBOOST_GRAPH_JOHNSON_HPP
#define HBOOST_GRAPH_JOHNSON_HPP
...
#include <hboost/graph/bellman_ford_shortest_paths.hpp>
...
namespace hboost {
               ...
               DistanceZero zero)
  {
    ...
    HBOOST_CONCEPT_ASSERT(( BasicMatrixConcept<DistanceMatrix,
    ...
    typename Traits2::vertex_descriptor s = *vertices(g2).first;
    {
      ...
      int i = 1;
      for (hboost::tie(v, v_end) = vertices(g1); v != v_end; ++v, ++i) {
        typename Traits2::edge_descriptor e; bool z;
        hboost::tie(e, z) = add_edge(s, get(id1, *v) + 1, g2);
        put(w, e, zero);
        verts1[i] = *v;
      }
      typename Traits1::edge_iterator e, e_end;
      for (hboost::tie(e, e_end) = edges(g1); e != e_end; ++e) {
        typename Traits2::edge_descriptor e2; bool z;
        hboost::tie(e2, z) = add_edge(get(id1, source(*e, g1)) + 1, 
                                     get(id1, target(*e, g1)) + 1, g2);
        put(w, e2, get(w1, *e));
        if (is_undirected) {
          hboost::tie(e2, z) = add_edge(get(id1, target(*e, g1)) + 1, 
    ...
    for (hboost::tie(v, v_end) = vertices(g2); v != v_end; ++v)
      put(d, *v, inf);
                     ...
                     Weight w, VertexID id)
    {
      ...
      return johnson_all_pairs_shortest_paths
        ...
        choose_param(get_param(params, distance_inf_t()), 
          std::numeric_limits<WT>::max HBOOST_PREVENT_MACRO_SUBSTITUTION()),
...
#endif // HBOOST_GRAPH_JOHNSON_HPP
