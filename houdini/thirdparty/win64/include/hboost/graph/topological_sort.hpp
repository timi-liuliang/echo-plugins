...
//=======================================================================
//
#ifndef HBOOST_GRAPH_TOPOLOGICAL_SORT_HPP
#define HBOOST_GRAPH_TOPOLOGICAL_SORT_HPP
...
namespace hboost { 
  ...
  struct topo_sort_visitor : public dfs_visitor<>
  {
    ...
    void back_edge(const Edge&, Graph&) { HBOOST_THROW_EXCEPTION(not_a_dag()); }
...
#endif /*HBOOST_GRAPH_TOPOLOGICAL_SORT_H*/
