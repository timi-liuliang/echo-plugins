...
#ifndef HBOOST_GRAPH_METRIC_TSP_APPROX_HPP
#define HBOOST_GRAPH_METRIC_TSP_APPROX_HPP
...
#include <hboost/graph/graph_as_tree.hpp>
#include <hboost/graph/adjacency_list.hpp>
#include <hboost/graph/prim_minimum_spanning_tree.hpp>
...
namespace hboost
{
    ...
    public:
        ...
        HBOOST_CONCEPT_USAGE(TSPVertexVisitorConcept)
        {
                                       ...
                                       TSPVertexVisitor vis)
    {
        ...
        HBOOST_CONCEPT_ASSERT((TSPVertexVisitorConcept<TSPVertexVisitor, VertexListGraph>));
    ...
    public:
        ...
        {
            HBOOST_CONCEPT_ASSERT((OutputIterator<OutItr, Vertex>));
            *itr_++ = v;
        }
    ...
    {
        typedef typename graph_traits<Graph>::vertex_descriptor Vertex;
        HBOOST_CONCEPT_ASSERT((OutputIterator<OutIter, Vertex>));
    ...
    public:
        ...
        void visit_vertex(Vertex v, const Graph& g)
        {
            ...
            if(previous_ != null())
            {
                ...
                Edge e;
                bool found;
                hboost::tie(e, found) = lookup_edge(previous_, v, g);
                if(!found) {
                    HBOOST_THROW_EXCEPTION(not_complete());
                }
...
#endif // HBOOST_GRAPH_METRIC_TSP_APPROX_HPP
