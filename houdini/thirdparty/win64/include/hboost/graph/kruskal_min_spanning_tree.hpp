...
//=======================================================================
//
#ifndef HBOOST_GRAPH_MST_KRUSKAL_HPP
#define HBOOST_GRAPH_MST_KRUSKAL_HPP
...
namespace hboost {
  ...
  namespace detail {
                     ...
                     Rank rank, Parent parent, Weight weight)
    {
      ...
      HBOOST_CONCEPT_ASSERT(( OutputIteratorConcept<OutputIterator, Edge> ));
      HBOOST_CONCEPT_ASSERT(( ReadWritePropertyMapConcept<Rank, Vertex> ));
      HBOOST_CONCEPT_ASSERT(( ReadWritePropertyMapConcept<Parent, Vertex> ));
      HBOOST_CONCEPT_ASSERT(( ReadablePropertyMapConcept<Weight, Edge> ));
      ...
      HBOOST_CONCEPT_ASSERT(( ComparableConcept<W_value> ));
      HBOOST_CONCEPT_ASSERT(( ConvertibleConcept<P_value, Vertex> ));
      HBOOST_CONCEPT_ASSERT(( IntegerConcept<R_value> ));

      disjoint_sets<Rank, Parent>  dset(rank, parent);

      typename graph_traits<Graph>::vertex_iterator ui, uiend;
      for (hboost::tie(ui, uiend) = vertices(G); ui != uiend; ++ui)
        dset.make_set(*ui);
      ...
      for (hboost::tie(ei, eiend) = edges(G); ei != eiend; ++ei) 
        Q.push(*ei);
...
#endif // HBOOST_GRAPH_MST_KRUSKAL_HPP
