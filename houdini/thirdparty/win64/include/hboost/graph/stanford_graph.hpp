...
//=======================================================================
#ifndef HBOOST_GRAPH_SGB_GRAPH_HPP
#define HBOOST_GRAPH_SGB_GRAPH_HPP
...
namespace hboost {
  ...
  template <> struct graph_traits<sgb_graph_ptr> {
    ...
    typedef hboost::sgb_edge edge_descriptor;
...
namespace hboost {
  ...
  class sgb_out_edge_iterator
    : public hboost::forward_iterator_helper<
        sgb_out_edge_iterator, hboost::sgb_edge, 
        std::ptrdiff_t, hboost::sgb_edge*, hboost::sgb_edge>
  {
    typedef sgb_out_edge_iterator self;
  public:
    sgb_out_edge_iterator() : _src(0), _arc(0) {}
    sgb_out_edge_iterator(Vertex* s, Arc* d) : _src(s), _arc(d) {}
    hboost::sgb_edge operator*() { return hboost::sgb_edge(_arc, _src); }
...
namespace hboost {
  ...
  inline hboost::graph_traits<sgb_graph_ptr>::degree_size_type
  out_degree(Vertex* u, sgb_const_graph_ptr g)
  {
    hboost::graph_traits<sgb_graph_ptr>::out_edge_iterator i, i_end;
    hboost::tie(i, i_end) = out_edges(u, g);
  ...
  class sgb_vertex_id_map
    : public hboost::put_get_helper<long, sgb_vertex_id_map>
  {
  public:
  ...
  class sgb_vertex_name_map
    : public hboost::put_get_helper<char*, sgb_vertex_name_map>
  {
  public:
    typedef hboost::readable_property_map_tag category;
...
#define SGB_GET_UTIL_FIELD(KIND,X) \
  ...
  class sgb_vertex_util_map
    : public hboost::put_get_helper<Ref, sgb_vertex_util_map<Tag, Ref> >
  {
    Tag tag;
  public:
  ...
  class sgb_edge_util_map
    : public hboost::put_get_helper<Ref, sgb_edge_util_map<Tag, Ref> >
  {
    Tag tag;
  public:
  ...
  class sgb_edge_length_map
    : public hboost::put_get_helper<Ref, sgb_edge_length_map<Ref> >
  {
  public:
    typedef hboost::lvalue_property_map_tag category;
    typedef long value_type;
...
#endif // HBOOST_GRAPH_SGB_GRAPH_HPP
