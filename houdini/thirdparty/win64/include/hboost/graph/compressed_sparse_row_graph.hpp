...
#ifndef HBOOST_GRAPH_COMPRESSED_SPARSE_ROW_GRAPH_HPP
#define HBOOST_GRAPH_COMPRESSED_SPARSE_ROW_GRAPH_HPP
...
#include <hboost/graph/filtered_graph.hpp> // For keep_all
#include <hboost/graph/detail/indexed_properties.hpp>
#include <hboost/graph/detail/compressed_sparse_row_struct.hpp>
...
#include <hboost/graph/graph_selectors.hpp>
...
#include <hboost/property_map/transform_value_property_map.hpp>
#include <hboost/mpl/print.hpp>
 ...
 ****************************************************************************/
#define HBOOST_CSR_GRAPH_TEMPLATE_PARMS                                  \
  typename Directed, typename VertexProperty, typename EdgeProperty,    \
  typename GraphProperty, typename Vertex, typename EdgeIndex
#define HBOOST_CSR_GRAPH_TYPE                                            \
   compressed_sparse_row_graph<Directed, VertexProperty, EdgeProperty,  \
                               GraphProperty, Vertex, EdgeIndex>
#define HBOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS                              \
  typename VertexProperty, typename EdgeProperty,                       \
  typename GraphProperty, typename Vertex, typename EdgeIndex
#define HBOOST_DIR_CSR_GRAPH_TYPE                                        \
   compressed_sparse_row_graph<directedS, VertexProperty, EdgeProperty, \
                               GraphProperty, Vertex, EdgeIndex>
#define HBOOST_BIDIR_CSR_GRAPH_TEMPLATE_PARMS                            \
  typename VertexProperty, typename EdgeProperty,                       \
  typename GraphProperty, typename Vertex, typename EdgeIndex
#define HBOOST_BIDIR_CSR_GRAPH_TYPE                                      \
   compressed_sparse_row_graph<bidirectionalS, VertexProperty, EdgeProperty, \
                               GraphProperty, Vertex, EdgeIndex>

namespace detail {
  template <typename T>
  struct default_construct_iterator: public hboost::iterator_facade<default_construct_iterator<T>, T, hboost::random_access_traversal_tag, const T&> {
    typedef hboost::iterator_facade<default_construct_iterator<T>, T, std::random_access_iterator_tag, const T&> base_type;
    T saved_value;
...
class compressed_sparse_row_graph<directedS, VertexProperty, EdgeProperty, GraphProperty, Vertex, EdgeIndex>
   : public detail::indexed_vertex_properties<HBOOST_DIR_CSR_GRAPH_TYPE,
                                              VertexProperty, Vertex, typed_identity_property_map<Vertex> >
{
 public:
  ...
  HBOOST_STATIC_ASSERT((!is_same<VertexProperty, void>::value));
  HBOOST_STATIC_ASSERT((!is_same<EdgeProperty, void>::value));
  HBOOST_STATIC_ASSERT((!is_same<GraphProperty, void>::value));
 ...
 public:
   ...
   */
  // HBOOST_STATIC_ASSERT((is_same<Directed, directedS>::value));
  ...
  compressed_sparse_row_graph(construct_inplace_from_sources_and_targets_t,
    ...
    : inherited_vertex_properties(numverts), m_property(prop)
  {
    m_forward.assign_sources_and_targets_global(sources, targets, numverts, hboost::typed_identity_property_map<vertices_size_type>());
  }
  ...
  compressed_sparse_row_graph(construct_inplace_from_sources_and_targets_t,
    ...
    : inherited_vertex_properties(numverts), m_property(prop)
  {
    m_forward.assign_sources_and_targets_global(sources, targets, edge_props, numverts, hboost::typed_identity_property_map<vertices_size_type>());
  }
    ...
    : inherited_vertex_properties(numverts), m_property(prop)
  {
    ...
    hboost::graph::detail::split_into_separate_coords
  ...
  {
    std::vector<vertex_descriptor> sources, targets;
    hboost::graph::detail::split_into_separate_coords_filtered
  ...
  add_edges_internal(InputIterator first, InputIterator last,
    ...
    typedef typename hboost::graph_traits<Graph>::vertex_descriptor vertex_t;
  ...
  add_edges_internal(InputIterator first, InputIterator last,
    ...
    typedef std::vector<
              hboost::tuple<vertex_pair,
                           edge_bundled> >
      edge_vector_t;
    edge_vector_t new_edges
      (hboost::make_zip_iterator(hboost::make_tuple(first, ep_iter)),
       hboost::make_zip_iterator(hboost::make_tuple(last, ep_iter_end)));
    if (new_edges.empty()) return;
    std::sort(new_edges.begin(), new_edges.end(),
              hboost::detail::compare_first<
                std::less<vertex_pair> >());
    m_forward.add_edges_sorted_internal
      (hboost::make_transform_iterator(
         new_edges.begin(),
         hboost::detail::my_tuple_get_class<0, vertex_pair>()),
       hboost::make_transform_iterator(
         new_edges.end(),
         hboost::detail::my_tuple_get_class<0, vertex_pair>()),
       hboost::make_transform_iterator(
         new_edges.begin(),
         hboost::detail::my_tuple_get_class
           <1, edge_bundled>()),
       global_to_local);
  }
...
class compressed_sparse_row_graph<bidirectionalS, VertexProperty, EdgeProperty, GraphProperty, Vertex, EdgeIndex>
   : public detail::indexed_vertex_properties<HBOOST_BIDIR_CSR_GRAPH_TYPE,
                                              VertexProperty, Vertex, typed_identity_property_map<Vertex> >
{
 public:
  typedef detail::indexed_vertex_properties<compressed_sparse_row_graph,
 ...
 public:
  ...
  typedef detail::compressed_sparse_row_structure<EdgeProperty, Vertex, EdgeIndex> forward_type;
  typedef EdgeIndex /* typename hboost::mpl::if_c<hboost::is_same<EdgeProperty, hboost::no_property>, hboost::no_property, EdgeIndex> */ backward_edge_property;
  ...
  void set_up_backward_property_links() {
    ...
    m_backward.assign_unsorted_multi_pass_edges
      (detail::transpose_edges(
       ...
       hboost::counting_iterator<EdgeIndex>(0),
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
add_vertex(HBOOST_CSR_GRAPH_TYPE& g) {
  add_vertex(g, typename HBOOST_CSR_GRAPH_TYPE::vertex_bundled());
}

template<HBOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
add_vertex(HBOOST_DIR_CSR_GRAPH_TYPE& g,
           typename HBOOST_DIR_CSR_GRAPH_TYPE::vertex_bundled const& p) {
...
template<HBOOST_BIDIR_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
add_vertex(HBOOST_BIDIR_CSR_GRAPH_TYPE& g,
           typename HBOOST_BIDIR_CSR_GRAPH_TYPE::vertex_bundled const& p) {
  Vertex old_num_verts_plus_one = g.m_forward.m_rowstart.size();
  g.m_forward.m_rowstart.push_back(g.m_forward.m_rowstart.back());
...
template<HBOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
add_vertices(typename HBOOST_DIR_CSR_GRAPH_TYPE::vertices_size_type count, HBOOST_DIR_CSR_GRAPH_TYPE& g) {
  Vertex old_num_verts_plus_one = g.m_forward.m_rowstart.size();
  ...
  // Add edges from a sorted (smallest sources first) range of pairs and edge
  // properties
  template <HBOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS, typename BidirectionalIteratorOrig,
            typename EPIterOrig>
  void
  add_edges_sorted(
      BidirectionalIteratorOrig first_sorted,
  ...
  // Add edges from a range of (source, target) pairs that are unsorted
  template <HBOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS, typename InputIterator,
            typename GlobalToLocal>
  inline void
  add_edges_global(InputIterator first, InputIterator last,
                   const GlobalToLocal& global_to_local, HBOOST_DIR_CSR_GRAPH_TYPE& g) {
  ...
  template <HBOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS, typename InputIterator>
  inline void
  add_edges(InputIterator first, InputIterator last, HBOOST_DIR_CSR_GRAPH_TYPE& g) {
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
source(typename HBOOST_CSR_GRAPH_TYPE::edge_descriptor e,
       const HBOOST_CSR_GRAPH_TYPE&)
{
  return e.src;
}
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
target(typename HBOOST_CSR_GRAPH_TYPE::edge_descriptor e,
       const HBOOST_CSR_GRAPH_TYPE& g)
{
  return g.m_forward.m_column[e.idx];
}

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename HBOOST_CSR_GRAPH_TYPE::out_edge_iterator,
                 typename HBOOST_CSR_GRAPH_TYPE::out_edge_iterator>
out_edges(Vertex v, const HBOOST_CSR_GRAPH_TYPE& g)
{
  typedef typename HBOOST_CSR_GRAPH_TYPE::edge_descriptor ed;
  typedef typename HBOOST_CSR_GRAPH_TYPE::out_edge_iterator it;
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline EdgeIndex
out_degree(Vertex v, const HBOOST_CSR_GRAPH_TYPE& g)
{
  EdgeIndex v_row_start = g.m_forward.m_rowstart[v];
  EdgeIndex next_row_start = g.m_forward.m_rowstart[v + 1];
...
template<HBOOST_BIDIR_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename HBOOST_BIDIR_CSR_GRAPH_TYPE::in_edge_iterator,
                 typename HBOOST_BIDIR_CSR_GRAPH_TYPE::in_edge_iterator>
in_edges(Vertex v, const HBOOST_BIDIR_CSR_GRAPH_TYPE& g)
{
  typedef typename HBOOST_BIDIR_CSR_GRAPH_TYPE::in_edge_iterator it;
...
template<HBOOST_BIDIR_CSR_GRAPH_TEMPLATE_PARMS>
inline EdgeIndex
in_degree(Vertex v, const HBOOST_BIDIR_CSR_GRAPH_TYPE& g)
{
  EdgeIndex v_row_start = g.m_backward.m_rowstart[v];
  EdgeIndex next_row_start = g.m_backward.m_rowstart[v + 1];
  return next_row_start - v_row_start;
...
// From AdjacencyGraph
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename HBOOST_CSR_GRAPH_TYPE::adjacency_iterator,
                 typename HBOOST_CSR_GRAPH_TYPE::adjacency_iterator>
adjacent_vertices(Vertex v, const HBOOST_CSR_GRAPH_TYPE& g)
{
  EdgeIndex v_row_start = g.m_forward.m_rowstart[v];
  EdgeIndex next_row_start = g.m_forward.m_rowstart[v + 1];
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename graph_traits<HBOOST_CSR_GRAPH_TYPE>::vertex_descriptor
vertex(typename graph_traits<HBOOST_CSR_GRAPH_TYPE>::vertex_descriptor i,
       const HBOOST_CSR_GRAPH_TYPE&)
{
  return i;
}
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename HBOOST_CSR_GRAPH_TYPE::edge_descriptor, bool>
edge(Vertex i, Vertex j, const HBOOST_CSR_GRAPH_TYPE& g)
{
  typedef typename HBOOST_CSR_GRAPH_TYPE::out_edge_iterator out_edge_iter;
  ...
  return std::make_pair(typename HBOOST_CSR_GRAPH_TYPE::edge_descriptor(),
                        false);
}

// Find an edge given its index in the graph
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename HBOOST_CSR_GRAPH_TYPE::edge_descriptor
edge_from_index(EdgeIndex idx, const HBOOST_CSR_GRAPH_TYPE& g)
{
  typedef typename std::vector<EdgeIndex>::const_iterator row_start_iter;
  HBOOST_ASSERT (idx < num_edges(g));
  ...
  return typename HBOOST_CSR_GRAPH_TYPE::edge_descriptor(src, idx);
}

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline EdgeIndex
num_edges(const HBOOST_CSR_GRAPH_TYPE& g)
{
  return g.m_forward.m_column.size();
}

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
std::pair<typename HBOOST_CSR_GRAPH_TYPE::edge_iterator,
          typename HBOOST_CSR_GRAPH_TYPE::edge_iterator>
edges(const HBOOST_CSR_GRAPH_TYPE& g)
{
  typedef typename HBOOST_CSR_GRAPH_TYPE::edge_iterator ei;
  typedef typename HBOOST_CSR_GRAPH_TYPE::edge_descriptor edgedesc;
...
// Graph properties
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS, class Tag, class Value>
inline void
set_property(HBOOST_CSR_GRAPH_TYPE& g, Tag tag, const Value& value)
{
  get_property_value(g.m_property, tag) = value;
}

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS, class Tag>
inline
typename graph_property<HBOOST_CSR_GRAPH_TYPE, Tag>::type&
get_property(HBOOST_CSR_GRAPH_TYPE& g, Tag tag)
{
...
const
typename graph_property<HBOOST_CSR_GRAPH_TYPE, Tag>::type&
get_property(const HBOOST_CSR_GRAPH_TYPE& g, Tag tag)
{
  return get_property_value(g.m_property, tag);
}
...
template <HBOOST_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
struct csr_property_map_helper<HBOOST_CSR_GRAPH_TYPE, Tag, vertex_property_tag> {
  typedef vertex_all_t all_tag;
  typedef typename property_traits<typename property_map<HBOOST_CSR_GRAPH_TYPE, vertex_all_t>::type>::key_type key_type;
  typedef VertexProperty plist_type;
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, vertex_all_t>::type all_type;
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, vertex_all_t>::const_type all_const_type;
...
template <HBOOST_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
struct csr_property_map_helper<HBOOST_CSR_GRAPH_TYPE, Tag, edge_property_tag> {
  typedef edge_all_t all_tag;
  typedef typename property_traits<typename property_map<HBOOST_CSR_GRAPH_TYPE, edge_all_t>::type>::key_type key_type;
  typedef EdgeProperty plist_type;
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, edge_all_t>::type all_type;
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, edge_all_t>::const_type all_const_type;
  typedef transform_value_property_map<detail::lookup_one_property_f<plist_type, Tag>, all_type> type;
  typedef transform_value_property_map<detail::lookup_one_property_f<const plist_type, Tag>, all_const_type> const_type;
};

template <HBOOST_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
struct csr_property_map_helper<HBOOST_CSR_GRAPH_TYPE, Tag, graph_property_tag> {
  typedef graph_all_t all_tag;
  typedef HBOOST_CSR_GRAPH_TYPE* key_type;
  typedef GraphProperty plist_type;
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, graph_all_t>::type all_type;
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, graph_all_t>::const_type all_const_type;
  typedef transform_value_property_map<detail::lookup_one_property_f<plist_type, Tag>, all_type> type;
  typedef transform_value_property_map<detail::lookup_one_property_f<const plist_type, Tag>, all_const_type> const_type;
};
...
template <HBOOST_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
struct property_map<HBOOST_CSR_GRAPH_TYPE, Tag, typename disable_if<detail::is_distributed_selector<Vertex> >::type>:
  csr_property_map_helper<
    HBOOST_CSR_GRAPH_TYPE,
    Tag,
    typename detail::property_kind_from_graph<HBOOST_CSR_GRAPH_TYPE, Tag>
               ::type> {};

template <HBOOST_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::type
get(Tag tag, HBOOST_CSR_GRAPH_TYPE& g) {
  return typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::type(tag, get(typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::all_tag(), g));
}

template <HBOOST_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::const_type
get(Tag tag, const HBOOST_CSR_GRAPH_TYPE& g) {
  return typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::const_type(tag, get(typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::all_tag(), g));
}

template <HBOOST_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
typename property_traits<typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::type>::reference
get(Tag tag, HBOOST_CSR_GRAPH_TYPE& g, typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::key_type k) {
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::all_tag all_tag;
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, all_tag>::type outer_pm;
  return lookup_one_property<typename property_traits<outer_pm>::value_type, Tag>::lookup(get(all_tag(), g, k), tag);
}

template <HBOOST_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
typename property_traits<typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::const_type>::reference
get(Tag tag, const HBOOST_CSR_GRAPH_TYPE& g, typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::key_type k) {
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::all_tag all_tag;
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, all_tag>::const_type outer_pm;
...
void
put(Tag tag,
    HBOOST_CSR_GRAPH_TYPE& g,
    typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::key_type k,
    typename lookup_one_property<typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::plist_type, Tag>::type val) {
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::all_tag all_tag;
  lookup_one_property<typename property_map<HBOOST_CSR_GRAPH_TYPE, Tag>::plist_type, Tag>::lookup(get(all_tag(), g, k), tag) = val;
}

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
struct property_map<HBOOST_CSR_GRAPH_TYPE, vertex_index_t, typename disable_if<detail::is_distributed_selector<Vertex> >::type>
{
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
struct property_map<HBOOST_CSR_GRAPH_TYPE, edge_index_t, typename disable_if<detail::is_distributed_selector<Vertex> >::type>
{
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
struct property_map<HBOOST_CSR_GRAPH_TYPE, vertex_all_t, typename disable_if<detail::is_distributed_selector<Vertex> >::type>
{
  typedef typename HBOOST_CSR_GRAPH_TYPE::inherited_vertex_properties::vertex_map_type type;
  typedef typename HBOOST_CSR_GRAPH_TYPE::inherited_vertex_properties::const_vertex_map_type const_type;
};

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
struct property_map<HBOOST_CSR_GRAPH_TYPE, edge_all_t, typename disable_if<detail::is_distributed_selector<Vertex> >::type>
{
  typedef typename HBOOST_CSR_GRAPH_TYPE::forward_type::inherited_edge_properties::edge_map_type type;
  typedef typename HBOOST_CSR_GRAPH_TYPE::forward_type::inherited_edge_properties::const_edge_map_type const_type;
};

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
struct property_map<HBOOST_CSR_GRAPH_TYPE, graph_all_t, typename disable_if<detail::is_distributed_selector<Vertex> >::type>
{
  typedef hboost::ref_property_map<HBOOST_CSR_GRAPH_TYPE*, typename HBOOST_CSR_GRAPH_TYPE::graph_property_type> type;
  typedef hboost::ref_property_map<HBOOST_CSR_GRAPH_TYPE*, const typename HBOOST_CSR_GRAPH_TYPE::graph_property_type> const_type;
};

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typed_identity_property_map<Vertex>
get(vertex_index_t, const HBOOST_CSR_GRAPH_TYPE&)
{
...
inline Vertex
get(vertex_index_t,
    const HBOOST_CSR_GRAPH_TYPE&, Vertex v)
{
  return v;
}
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typed_identity_property_map<Vertex>
get(vertex_index_t, HBOOST_CSR_GRAPH_TYPE&)
{
  return typed_identity_property_map<Vertex>();
}
...
inline Vertex
get(vertex_index_t,
    HBOOST_CSR_GRAPH_TYPE&, Vertex v)
{
  return v;
}

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename property_map<HBOOST_CSR_GRAPH_TYPE, edge_index_t>::const_type
get(edge_index_t, const HBOOST_CSR_GRAPH_TYPE&)
{
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, edge_index_t>::const_type
    result_type;
  return result_type();
}
...
inline EdgeIndex
get(edge_index_t, const HBOOST_CSR_GRAPH_TYPE&,
    typename HBOOST_CSR_GRAPH_TYPE::edge_descriptor e)
{
  return e.idx;
}
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename property_map<HBOOST_CSR_GRAPH_TYPE, edge_index_t>::const_type
get(edge_index_t, HBOOST_CSR_GRAPH_TYPE&)
{
  typedef typename property_map<HBOOST_CSR_GRAPH_TYPE, edge_index_t>::const_type
    result_type;
  return result_type();
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename property_map<HBOOST_CSR_GRAPH_TYPE, vertex_all_t>::type
get(vertex_all_t, HBOOST_CSR_GRAPH_TYPE& g)
{
  return g.get_vertex_bundle(get(vertex_index, g));
}

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename property_map<HBOOST_CSR_GRAPH_TYPE, vertex_all_t>::const_type
get(vertex_all_t, const HBOOST_CSR_GRAPH_TYPE& g)
{
  return g.get_vertex_bundle(get(vertex_index, g));
}
...
get(vertex_all_t,
    HBOOST_CSR_GRAPH_TYPE& g, Vertex v)
{
...
get(vertex_all_t,
    const HBOOST_CSR_GRAPH_TYPE& g, Vertex v)
{
  return get(vertex_all, g)[v];
}
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename property_map<HBOOST_CSR_GRAPH_TYPE, edge_all_t>::type
get(edge_all_t, HBOOST_CSR_GRAPH_TYPE& g)
{
  return g.m_forward.get_edge_bundle(get(edge_index, g));
}

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename property_map<HBOOST_CSR_GRAPH_TYPE, edge_all_t>::const_type
get(edge_all_t, const HBOOST_CSR_GRAPH_TYPE& g)
{
  return g.m_forward.get_edge_bundle(get(edge_index, g));
}
...
get(edge_all_t,
    HBOOST_CSR_GRAPH_TYPE& g,
    const typename HBOOST_CSR_GRAPH_TYPE::edge_descriptor& e)
{
...
template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename property_map<HBOOST_CSR_GRAPH_TYPE, graph_all_t>::type
get(graph_all_t, HBOOST_CSR_GRAPH_TYPE& g)
{
  return typename property_map<HBOOST_CSR_GRAPH_TYPE, graph_all_t>::type(g.m_property);
}

template<HBOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename property_map<HBOOST_CSR_GRAPH_TYPE, graph_all_t>::const_type
get(graph_all_t, const HBOOST_CSR_GRAPH_TYPE& g)
{
  return typename property_map<HBOOST_CSR_GRAPH_TYPE, graph_all_t>::const_type(g.m_property);
}
...
#undef HBOOST_CSR_GRAPH_TYPE
#undef HBOOST_CSR_GRAPH_TEMPLATE_PARMS
#undef HBOOST_DIR_CSR_GRAPH_TYPE
#undef HBOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS
#undef HBOOST_BIDIR_CSR_GRAPH_TYPE
#undef HBOOST_BIDIR_CSR_GRAPH_TEMPLATE_PARMS

} // end namespace hboost

#endif // HBOOST_GRAPH_COMPRESSED_SPARSE_ROW_GRAPH_HPP
