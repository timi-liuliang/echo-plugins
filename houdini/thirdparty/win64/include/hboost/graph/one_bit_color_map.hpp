...
#ifndef HBOOST_ONE_BIT_COLOR_MAP_HPP
#define HBOOST_ONE_BIT_COLOR_MAP_HPP
...
{
  HBOOST_STATIC_CONSTANT(int, bits_per_char = one_bit_color_map<IndexMap>::bits_per_char);
...
#endif // HBOOST_ONE_BIT_COLOR_MAP_HPP

#ifdef HBOOST_GRAPH_USE_MPI
#  include <hboost/graph/distributed/one_bit_color_map.hpp>
#endif
