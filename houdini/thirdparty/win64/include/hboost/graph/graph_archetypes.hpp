...
#ifndef HBOOST_GRAPH_ARCHETYPES_HPP
#define HBOOST_GRAPH_ARCHETYPES_HPP
...
namespace hboost { // should use a different namespace for this
  ...
  {
    typedef typename hboost::property_map<property_graph_archetype<G, P, V>, P>::type Map;
    Map pmap = get(p, g);
    put(pmap, key, value);
  }
...
#endif // HBOOST_GRAPH_ARCHETYPES_HPP
