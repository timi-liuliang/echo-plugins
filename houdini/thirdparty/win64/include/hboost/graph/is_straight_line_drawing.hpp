...
namespace hboost
{
    ...
    if (x1 - x2 == 0)
      {
        ...
        double min_y = min HBOOST_PREVENT_MACRO_SUBSTITUTION(y1,y2);
        double max_y = max HBOOST_PREVENT_MACRO_SUBSTITUTION(y1,y2);
        double min_b = min HBOOST_PREVENT_MACRO_SUBSTITUTION(b1,b2);
        double max_b = max HBOOST_PREVENT_MACRO_SUBSTITUTION(b1,b2);
                                ...
                                )
  {
    ...
    typedef hboost::tuple<edge_t, x_coord_t, y_coord_t> edge_event_t;
