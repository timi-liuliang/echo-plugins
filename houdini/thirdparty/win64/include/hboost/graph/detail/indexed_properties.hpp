...
#ifndef HBOOST_GRAPH_INDEXED_PROPERTIES_HPP
#define HBOOST_GRAPH_INDEXED_PROPERTIES_HPP
...
: public hboost::iterator_facade<dummy_no_property_iterator, no_property, std::random_access_iterator_tag> {
...
#endif // HBOOST_GRAPH_INDEXED_PROPERTIES_HPP
