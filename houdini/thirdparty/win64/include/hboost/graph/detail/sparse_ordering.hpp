...
//=======================================================================//
#ifndef HBOOST_GRAPH_DETAIL_SPARSE_ORDERING_HPP
#define HBOOST_GRAPH_DETAIL_SPARSE_ORDERING_HPP
...
namespace hboost {
  ...
  namespace sparse {
    ...
    class sparse_ordering_queue : public hboost::queue<Tp, Sequence>{
    public:      
                         ...
                         ColorMap color, DegreeMap degree)
  {
    ...
    typename hboost::graph_traits<Graph>::vertex_iterator ui, ui_end;
