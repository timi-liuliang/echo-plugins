...
//=======================================================================
//
#ifndef HBOOST_GRAPH_DETAIL_ADJ_LIST_EDGE_ITERATOR_HPP
#define HBOOST_GRAPH_DETAIL_ADJ_LIST_EDGE_ITERATOR_HPP
...
#  define HBOOST_GRAPH_NO_OPTIONAL
#endif

#ifdef HBOOST_GRAPH_NO_OPTIONAL
#  define HBOOST_GRAPH_MEMBER .
#else 
#  define HBOOST_GRAPH_MEMBER ->
#  include <hboost/optional.hpp>
#endif // ndef HBOOST_GRAPH_NO_OPTIONAL
    ...
    public:
      ...
      */
      inline self& operator++() {
        ++edges HBOOST_GRAPH_MEMBER first;
        if (edges HBOOST_GRAPH_MEMBER first == edges HBOOST_GRAPH_MEMBER second) 
        {
          ++vCurr;
          while ( vCurr != vEnd && out_degree(*vCurr, *m_g) == 0 )
            ++vCurr;
      ...
      { return *edges HBOOST_GRAPH_MEMBER first; } 
      inline bool operator==(const self& x) const {
        return vCurr == x.vCurr 
          && (vCurr == vEnd 
              || edges HBOOST_GRAPH_MEMBER first == x.edges HBOOST_GRAPH_MEMBER first);
      }
      inline bool operator!=(const self& x) const {
        return vCurr != x.vCurr 
          || (vCurr != vEnd 
...
#else
      hboost::optional<std::pair<OutEdgeIterator, OutEdgeIterator> >
        edges;
#endif // ndef HBOOST_GRAPH_NO_OPTIONAL
      const Graph* m_g;
    };
...
#undef HBOOST_GRAPH_MEMBER

#endif // HBOOST_GRAPH_DETAIL_ADJ_LIST_EDGE_ITERATOR_HPP
