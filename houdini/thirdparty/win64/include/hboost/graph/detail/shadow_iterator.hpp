...
#ifndef HBOOST_SHADOW_ITERATOR_HPP
#define HBOOST_SHADOW_ITERATOR_HPP
...
namespace hboost {
  ...
  namespace detail {
    ...
    class shadow_proxy
      : hboost::operators< shadow_proxy<A,B,D> >
    {
...
namespace std {
  ...
  void swap(hboost::detail::shadow_proxy<A1&,B1&,D1> x,
            hboost::detail::shadow_proxy<A2&,B2&,D2> y)
  {
    std::swap(x.a, y.a);
    std::swap(x.b, y.b);
  }
...
#endif // HBOOST_SHADOW_ITERATOR_HPP
