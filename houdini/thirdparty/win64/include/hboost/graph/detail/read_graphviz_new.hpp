...
#ifndef HBOOST_READ_GRAPHVIZ_NEW_HPP
#define HBOOST_READ_GRAPHVIZ_NEW_HPP
...
namespace read_graphviz_detail {
  ...
  void translate_results_to_graph(const parser_result& r, ::hboost::detail::graph::mutate_graph* mg);

} // namespace read_graphviz_detail

namespace detail {
  namespace graph {
    HBOOST_GRAPH_DECL bool read_graphviz_new(const std::string& str, hboost::detail::graph::mutate_graph* mg);
  } // end namespace graph
} // end namespace detail

template <typename MutableGraph>
bool read_graphviz_new(const std::string& str,
                       MutableGraph& graph, hboost::dynamic_properties& dp,
                       std::string const& node_id = "node_id") {
  hboost::detail::graph::mutate_graph_impl<MutableGraph> mg(graph, dp, node_id);
  return detail::graph::read_graphviz_new(str, &mg);
}

} // namespace hboost

#endif // HBOOST_READ_GRAPHVIZ_NEW_HPP
