...
#ifndef HBOOST_GRAPH_DETAIL_GEODESIC_HPP
#define HBOOST_GRAPH_DETAIL_GEODESIC_HPP
...
namespace detail {
                        ...
                        Distance init)
    {
        ...
        HBOOST_CONCEPT_ASSERT(( AdaptableBinaryFunction<Combinator,Distance,Distance,Distance> ));
    ...
    struct maximize : public std::binary_function<T, T, T>
    {
        ...
        { HBOOST_USING_STD_MAX(); return max HBOOST_PREVENT_MACRO_SUBSTITUTION (x, y); }
    };
