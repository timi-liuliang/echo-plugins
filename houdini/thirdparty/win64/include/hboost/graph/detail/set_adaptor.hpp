...
#ifndef HBOOST_SET_ADAPTOR_HPP
#define HBOOST_SET_ADAPTOR_HPP
...
namespace hboost {
    ...
    bool set_contains(const hboost::unordered_set<K,H,C,A>& s, const T& x) {
      return s.find(x) != s.end();
    }
