...
#ifndef HBOOST_GRAPH_DETAIL_EDGE_HPP
#define HBOOST_GRAPH_DETAIL_EDGE_HPP
...
namespace std {
  ...
  operator<<(std::basic_ostream<Char, Traits>& os,
             const hboost::detail::edge_desc_impl<D,V>& e)
  {
...
namespace hboost {
  ...
  struct hash<hboost::detail::edge_desc_impl<D, V> >
  {
    std::size_t operator()(const hboost::detail::edge_desc_impl<D, V> & x) const
    { return hash_value(x.get_property()); }
  };
}


#endif // HBOOST_GRAPH_DETAIL_DETAIL_EDGE_HPP
