...
#ifndef HBOOST_GRAPH_DETAIL_INCREMENTAL_COMPONENTS_HPP
#define HBOOST_GRAPH_DETAIL_INCREMENTAL_COMPONENTS_HPP
...
namespace hboost {
  ...
  namespace detail {
    ...
    class component_index_iterator :
      hboost::forward_iterator_helper<component_index_iterator<IndexRandomAccessIterator>,
...
#endif // HBOOST_GRAPH_DETAIL_INCREMENTAL_COMPONENTS_HPP
