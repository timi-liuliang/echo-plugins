...
//=======================================================================
//
#ifndef HBOOST_ARRAY_BINARY_TREE_HPP
#define HBOOST_ARRAY_BINARY_TREE_HPP
...
public:
  ...
  struct children_type {
    struct iterator
        : hboost::iterator<std::bidirectional_iterator_tag, ArrayBinaryTreeNode,
...
#endif /* HBOOST_ARRAY_BINARY_TREE_HPP */
