...
#ifndef HBOOST_GRAPH_GRAPHML_HPP
#define HBOOST_GRAPH_GRAPHML_HPP
...
#include <hboost/graph/graphviz.hpp> // for exceptions
#include <typeinfo>
...
public:
    ...
    virtual hboost::any do_add_vertex() = 0;
    virtual std::pair<hboost::any,bool> do_add_edge(hboost::any source, hboost::any target) = 0;

    virtual void
    set_graph_property(const std::string& name, const std::string& value, const std::string& value_type) = 0;

    virtual void
    set_vertex_property(const std::string& name, hboost::any vertex, const std::string& value, const std::string& value_type) = 0;

    virtual void
    set_edge_property(const std::string& name, hboost::any edge, const std::string& value, const std::string& value_type) = 0;
};
              ...
              const dynamic_properties& dp, bool ordered_vertices=false)
{
    ...
    using hboost::property_tree::xml_parser::encode_char_entities;
    ...
    for (hboost::tie(e, e_end) = edges(g); e != e_end; ++e)
    {
...
#endif // HBOOST_GRAPH_GRAPHML_HPP
