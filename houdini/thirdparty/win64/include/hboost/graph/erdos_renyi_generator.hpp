...
//           Douglas Gregor
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_ERDOS_RENYI_GENERATOR_HPP
#define HBOOST_GRAPH_ERDOS_RENYI_GENERATOR_HPP
...
namespace hboost {
  ...
  private:
    void next()
    {
      ...
      HBOOST_ASSERT (src != (std::numeric_limits<vertices_size_type>::max)() &&
                    src != n);
      while (src != n) {
...
#endif // HBOOST_GRAPH_ERDOS_RENYI_GENERATOR_HPP
