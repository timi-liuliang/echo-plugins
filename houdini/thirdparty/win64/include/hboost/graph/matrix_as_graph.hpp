...
//=======================================================================
//
#ifndef HBOOST_GRAPH_MATRIX2GRAPH_HPP
#define HBOOST_GRAPH_MATRIX2GRAPH_HPP

#include <utility>
#include <hboost/config.hpp>
#include <hboost/operators.hpp>
#include <hboost/pending/detail/int_iterator.hpp>
...
#define HBOOST_GRAPH_ADAPT_MATRIX_TO_GRAPH(Matrix)  \
namespace hboost { \
  template <> \
  struct graph_traits< Matrix > { \
    ...
    typedef hboost::matrix_incidence_iterator<Iter, V> out_edge_iterator; \
    typedef hboost::matrix_adj_iterator<Iter, V> adjacency_iterator; \
    typedef Matrix::size_type size_type; \
    typedef hboost::int_iterator<size_type> vertex_iterator; \
    \
...
#endif /* HBOOST_GRAPH_MATRIX2GRAPH_HPP*/
