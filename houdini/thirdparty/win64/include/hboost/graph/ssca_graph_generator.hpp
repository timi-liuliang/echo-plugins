...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_SSCA_GENERATOR_HPP
#define HBOOST_GRAPH_SSCA_GENERATOR_HPP
  ...
  public:
    ...
    ssca_iterator& operator++()
    {
      ...
      while (values.empty() && verticesRemaining > 0) { // If there are no values left, generate a new clique
        ...
        vertices_size_type size = min HBOOST_PREVENT_MACRO_SUBSTITUTION (clique_size(*gen), verticesRemaining);
...
#endif // HBOOST_GRAPH_SSCA_GENERATOR_HPP
