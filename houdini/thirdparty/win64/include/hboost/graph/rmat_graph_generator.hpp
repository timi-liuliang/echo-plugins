...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_RMAT_GENERATOR_HPP
#define HBOOST_GRAPH_RMAT_GENERATOR_HPP
...
// #include <hboost/test/floating_point_comparison.hpp>

using hboost::shared_ptr;
using hboost::uniform_01;
  ...
  */
  ...
  public:
...

    {
      ...
      // HBOOST_ASSERT(hboost::test_tools::check_is_close(a + b + c + d, 1., 1.e-5));
      ...
      hboost::tie(u, v) = generate_edge(this->gen, n, SCALE, a, b, c, d);
...
#include <hboost/graph/distributed/rmat_graph_generator.hpp>
#endif // HBOOST_GRAPH_USE_MPI

#endif // HBOOST_GRAPH_RMAT_GENERATOR_HPP
