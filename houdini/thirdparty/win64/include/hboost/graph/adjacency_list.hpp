...
#ifndef HBOOST_GRAPH_ADJACENCY_LIST_HPP
#define HBOOST_GRAPH_ADJACENCY_LIST_HPP
...
namespace hboost {
  ...
  struct container_gen<slistS, ValueType> {
    typedef HBOOST_STD_EXTENSION_NAMESPACE::slist<ValueType> type;
  };
#endif
  template <class ValueType>
  ...
  struct container_gen<hash_setS, ValueType> {
    typedef hboost::unordered_set<ValueType> type;
  };
  ...
  struct container_gen<hash_multisetS, ValueType> {
    typedef hboost::unordered_multiset<ValueType> type;
  };
...
#include <hboost/graph/detail/adjacency_list.hpp>
...
#endif // HBOOST_GRAPH_ADJACENCY_LIST_HPP
