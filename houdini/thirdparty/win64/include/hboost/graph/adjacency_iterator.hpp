...
#ifndef HBOOST_ADJACENCY_ITERATOR_HPP
#define HBOOST_ADJACENCY_ITERATOR_HPP
...
namespace hboost
{
  ...
  {
    typedef typename hboost::detail::iterator_traits<OutEdgeIter>
  ...
  class inv_adjacency_iterator_generator {
    typedef typename hboost::detail::iterator_traits<InEdgeIter>
      ::difference_type difference_type;
  public:
...
#endif // HBOOST_DETAIL_ADJACENCY_ITERATOR_HPP
