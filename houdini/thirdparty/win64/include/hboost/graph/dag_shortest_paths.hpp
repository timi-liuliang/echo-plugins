...
#ifndef HBOOST_GRAPH_DAG_SHORTEST_PATHS_HPP
#define HBOOST_GRAPH_DAG_SHORTEST_PATHS_HPP

#include <hboost/graph/topological_sort.hpp>
...
namespace hboost {
     ...
     DistInf inf, DistZero zero)
  {
    ...
    for (i = rev_topo_order.rbegin(); i != rev_topo_order.rend(); ++i) {
      ...
      for (hboost::tie(e, e_end) = out_edges(u, g); e != e_end; ++e) {
...
#endif // HBOOST_GRAPH_DAG_SHORTEST_PATHS_HPP
