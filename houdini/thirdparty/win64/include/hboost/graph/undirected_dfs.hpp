...
//=======================================================================
//
#ifndef HBOOST_GRAPH_UNDIRECTED_DFS_HPP
#define HBOOST_GRAPH_UNDIRECTED_DFS_HPP
...
// comparison.
       ...
       EdgeColorMap edge_color)
    {
      ...
      HBOOST_CONCEPT_ASSERT(( ReadWritePropertyMapConcept<VertexColorMap,Vertex> ));
      HBOOST_CONCEPT_ASSERT(( ReadWritePropertyMapConcept<EdgeColorMap,Edge> ));
      ...
      HBOOST_CONCEPT_ASSERT(( ColorValueConcept<EColorValue> ));
      ...
      stack.push_back(std::make_pair(u, std::make_pair(hboost::optional<Edge>(), out_edges(u, g))));
      while (!stack.empty()) {
        VertexInfo& back = stack.back();
        u = back.first;
        hboost::optional<Edge> src_e = back.second.first;
  ...
  undirected_dfs(const Graph& g, DFSVisitor vis, 
                 ...
                 Vertex start_vertex)
  {
    HBOOST_CONCEPT_ASSERT(( DFSVisitorConcept<DFSVisitor, Graph> ));
