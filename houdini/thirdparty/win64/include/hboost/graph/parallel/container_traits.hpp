...
//
#ifndef HBOOST_GRAPH_PARALLEL_CONTAINER_TRAITS_HPP
#define HBOOST_GRAPH_PARALLEL_CONTAINER_TRAITS_HPP
...
namespace hboost { namespace graph { namespace parallel {
...
} } } // end namespace hboost::graph::parallel 

#endif // HBOOST_GRAPH_PARALLEL_CONTAINER_TRAITS_HPP
