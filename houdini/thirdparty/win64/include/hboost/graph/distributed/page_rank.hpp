...
//           Andrew Lumsdaine
//           Brian Barrett
#ifndef HBOOST_PARALLEL_GRAPH_PAGE_RANK_HPP
#define HBOOST_PARALLEL_GRAPH_PAGE_RANK_HPP
...
#include <hboost/graph/page_rank.hpp>
               ...
               RankMap2 rank_map2)
{
  ...
  HBOOST_ASSERT(sizeof(rank_type) == sizeof(double));
  ...
  synchronize(hboost::graph::parallel::process_group(g));
  ...
  rank_map.set_consistency_model(hboost::parallel::cm_flush | hboost::parallel::cm_reset);
  rank_map2.set_consistency_model(hboost::parallel::cm_flush | hboost::parallel::cm_reset);
...
remove_dangling_links(MutableGraph& g
                      HBOOST_GRAPH_ENABLE_IF_MODELS_PARM(MutableGraph, 
                                                        distributed_graph_tag))
{
  ...
  do {
    ...
    for (hboost::tie(vi, vi_end) = vertices(g); vi != vi_end; /* in loop */) {
...
#endif // HBOOST_PARALLEL_GRAPH_PAGE_RANK_HPP
