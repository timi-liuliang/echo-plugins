...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_DISTRIBUTED_ST_CONNECTED_HPP
#define HBOOST_GRAPH_DISTRIBUTED_ST_CONNECTED_HPP
             ...
             ColorMap color, OwnerMap owner)
{
  ...
  while (true) {
    ...
    std::pair<bool, bool> results = all_reduce(pg, 
            hboost::parallel::detail::make_untracked_pair(Q.empty(), found),
            detail::pair_and_or());
...
#endif // HBOOST_GRAPH_DISTRIBUTED_ST_CONNECTED_HPP
