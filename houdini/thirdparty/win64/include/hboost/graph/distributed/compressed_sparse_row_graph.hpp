...
#ifndef HBOOST_GRAPH_DISTRIBUTED_CSR_HPP
#define HBOOST_GRAPH_DISTRIBUTED_CSR_HPP
...
#include <hboost/graph/compressed_sparse_row_graph.hpp>
#include <hboost/graph/distributed/selector.hpp>
#include <hboost/mpl/if.hpp>
#include <hboost/type_traits/is_same.hpp>
#include <hboost/graph/distributed/concepts.hpp>
#include <hboost/graph/parallel/properties.hpp>
#include <hboost/graph/parallel/distribution.hpp>
         ...
         InEdgeIndex>
{
 ...
 public:
  ...
  typedef hboost::parallel::variant_distribution<process_group_type, Vertex>
    distribution_type;
  ...
  {
    typename graph_traits<base_type>::vertex_descriptor v 
      = hboost::add_vertices(count, m_base);
  ...
  { hboost::add_edges_global(first, last, get(vertex_local, *this), m_base); }
  ...
  { hboost::add_edges_global(first, last, ep_iter, ep_iter_end, 
                            get(vertex_local, *this), m_base); }

  template <typename InputIterator>
  void 
  add_edges_sorted(InputIterator first, InputIterator last)
  { hboost::add_edges_sorted_global(first, last, 
                                   get(vertex_local, *this), m_base); }
  ...
  { hboost::add_edges_sorted_global(first_sorted, last_sorted, ep_iter_sorted, 
                                   get(vertex_local, *this), m_base); }
 ...
 *  graph type.
 */
#define HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS                          \
 ...
 *  HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS). It is used to reduce
 *  the amount of typing required to declare free functions for this
 *  graph type.
 */
#define HBOOST_DISTRIB_CSR_GRAPH_TYPE                            \
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
HBOOST_DISTRIB_CSR_GRAPH_TYPE::null_vertex()
{
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
source(typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor e,
       const HBOOST_DISTRIB_CSR_GRAPH_TYPE&)
{ return e.src; }

template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
target(typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor e,
       const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{ return target(e, g.base()); }

template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator,
                 typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator>
out_edges(typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor u,
          const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type
    edges_size_type;
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor ed;
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator it;
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::degree_size_type
out_degree(typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor u,
           const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
void synchronize(const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS> 
ProcessGroup
process_group(const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
...
// Adjacency Graph concept requirements
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::adjacency_iterator,
                 typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::adjacency_iterator>
adjacent_vertices(typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor u,
                  const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_iterator
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::degree_size_type
num_vertices(const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  return num_vertices(g.base());
}

template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_iterator,
                 typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_iterator>
vertices(const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_iterator
    vertex_iterator;
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_iterator
{
 public:
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type
num_edges(const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  return g.base().m_forward.m_column.size();
}

template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
std::pair<typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_iterator,
          typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_iterator>
edges(const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor Vertex;
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_iterator ei;
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor edgedesc;
...
hboost::transform_iterator<index_to_vertex_func<Distribution, Graph>, IndexIterator>
make_index_to_vertex_iterator(IndexIterator it, const Distribution& dist, 
                              const Graph& g) {
  return hboost::make_transform_iterator(
...
compressed_sparse_row_graph(edges_are_unsorted_t,
  ...
  : m_process_group(pg),
    ...
    m_base(edges_are_unsorted_global,
           index_to_vertex_iterator<InputIterator, HBOOST_DISTRIB_CSR_GRAPH_TYPE>(edge_begin, *this),
           index_to_vertex_iterator<InputIterator, HBOOST_DISTRIB_CSR_GRAPH_TYPE>(edge_end, *this),
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>
{
 public:
  typedef csr_vertex_global_map<
            typename ProcessGroup::process_id_type,
            typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor> type;
  typedef type const_type;
};

template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>::type
get(vertex_global_t, HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>
    ::type result_type;
  return result_type();
}
...
std::pair<typename ProcessGroup::process_id_type,
          typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor>
get(vertex_global_t, HBOOST_DISTRIB_CSR_GRAPH_TYPE& g,
    typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor k)
{
  return get(vertex_global, 
             const_cast<const HBOOST_DISTRIB_CSR_GRAPH_TYPE&>(g), 
             k);
}

template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>::const_type
get(vertex_global_t, const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>
...
get(vertex_global_t, const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g,
    typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor k)
{
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
    vertex_descriptor;
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
vertex(typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertices_size_type i,
       const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
...
inline std::pair<typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator,
                 typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator>
edge_range(typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor i,
           typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor j,
           const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor Vertex;
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type EdgeIndex;
  typedef typename std::vector<Vertex>::const_iterator adj_iter;
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator out_edge_iter;
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor edge_desc;
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor, bool>
edge(typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor i,
     typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor j,
     const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator out_edge_iter;
  ...
  if (range.first == range.second)
    return std::make_pair(typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor(),
                          false);
  else
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS, typename Property>
class property_map<const HBOOST_DISTRIB_CSR_GRAPH_TYPE, Property>
{
 public:
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, Property>
    ::const_type type;
  typedef type const_type;
};
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
add_vertex(HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{ return g.add_vertex(); }

template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
add_vertex(const typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_bundled& p, 
           HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{ return g.add_vertex(p); }

template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
add_vertices(typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertices_size_type count, 
             HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{ return g.add_vertices(count); }

template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS, typename InputIterator>
void 
add_edges(InputIterator first, InputIterator last,
          HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>
{
 public:
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>::type
get(vertex_owner_t, HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>
    ::type result_type;
  return result_type();
}
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>::const_type
get(vertex_owner_t, const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>
    ::const_type result_type;
  return result_type();
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>
{
 public:
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>::type
get(vertex_local_t, HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>
    ::type result_type;
  return result_type();
}
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>::const_type
get(vertex_local_t, const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>
    ::const_type result_type;
  return result_type();
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, 
                                vertex_global_t>::const_type
    global_map;
  typedef typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::process_group_type
    process_group_type;

  typedef property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t> local;
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>::type
get(vertex_index_t, HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>
    ::type result_type;
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertices_size_type
get(vertex_index_t, HBOOST_DISTRIB_CSR_GRAPH_TYPE& g,
    typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor k)
{
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>::const_type
get(vertex_index_t, const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>
    ::const_type result_type;
  return result_type(g.process_group(), get(vertex_global, g),
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_index_t>
  : public property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t> { };

template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_index_t>::type
get(vertex_local_index_t, HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_index_t>::const_type
get(vertex_local_index_t, const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  return get(vertex_local, g);
}
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>
{
 public:
  typedef csr_edge_global_map<
            typename ProcessGroup::process_id_type,
            typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor,
            typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type> type;
  typedef type const_type;
};

template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>::type
get(edge_global_t, HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>
    ::type result_type;
  return result_type();
}
...
inline
std::pair<typename ProcessGroup::process_id_type,
          typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::base_type::edge_descriptor>
get(edge_global_t, HBOOST_DISTRIB_CSR_GRAPH_TYPE& g,
    typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor k)
{
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>::const_type
get(edge_global_t, const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>
    ::const_type result_type;
  return result_type();
    ...
    typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor k)
{
  ...
  const int local_index_bits = 
    sizeof(vertex_descriptor) * CHAR_BIT - processor_bits;
  const typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type local_index_mask =
    typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type(-1) >> processor_bits;
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>
{
   typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>
    ::type global_map;
 ...
 public:
  typedef local_property_map<
            typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::process_group_type,
            global_map,
            typename property_map<typename HBOOST_DISTRIB_CSR_GRAPH_TYPE::base_type, edge_index_t>::type
          > type;
  typedef type const_type;
};
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>::type
get(edge_index_t, HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>
    ::type result_type;
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>::const_type
get(edge_index_t, const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>
    ::const_type result_type;
  return result_type(g.process_group(), get(edge_global, g),
...
template <HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
class property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, Tag> {
  typedef HBOOST_DISTRIB_CSR_GRAPH_TYPE graph_type;
...
public:
  typedef ::hboost::parallel::distributed_property_map<
...
template <HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, Tag>::type
get(Tag tag, HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef HBOOST_DISTRIB_CSR_GRAPH_TYPE Graph;
...
template<HBOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS, typename Tag>
typename property_map<HBOOST_DISTRIB_CSR_GRAPH_TYPE, Tag>::const_type
get(Tag tag, const HBOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef HBOOST_DISTRIB_CSR_GRAPH_TYPE Graph;
...
namespace mpi {
  ...
  struct is_mpi_datatype<hboost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
    : mpl::true_ { };
}

namespace serialization {
  template<typename Vertex, typename EdgeIndex>
  struct is_bitwise_serializable<hboost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
    : mpl::true_ { };

  template<typename Vertex, typename EdgeIndex>
  struct implementation_level<hboost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
   : mpl::int_<object_serializable> {} ;

  template<typename Vertex, typename EdgeIndex>
  struct tracking_level<hboost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
...
#endif // HBOOST_GRAPH_DISTRIBUTED_CSR_HPP
