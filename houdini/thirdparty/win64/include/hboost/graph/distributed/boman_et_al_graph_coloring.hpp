...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_DISTRIBUTED_BOMAN_ET_AL_GRAPH_COLORING_HPP
#define HBOOST_GRAPH_DISTRIBUTED_BOMAN_ET_AL_GRAPH_COLORING_HPP
...
{
  using namespace hboost::graph::parallel;
  ...
  static const bool asynchronous = 
    is_convertible<communication_category, hboost::parallel::immediate_process_group_tag>::value;
  ...
  rounds = all_reduce(pg, rounds, hboost::parallel::maximum<std::size_t>());
  ...
  num_colors = 
    all_reduce(pg, num_colors, hboost::parallel::maximum<color_type>());
...
#endif // HBOOST_GRAPH_DISTRIBUTED_BOMAN_ET_AL_GRAPH_COLORING_HPP
