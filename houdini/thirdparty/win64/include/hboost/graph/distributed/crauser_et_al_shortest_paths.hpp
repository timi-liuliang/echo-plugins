 ...
 **************************************************************************/
#ifndef HBOOST_GRAPH_CRAUSER_ET_AL_SHORTEST_PATHS_HPP
#define HBOOST_GRAPH_CRAUSER_ET_AL_SHORTEST_PATHS_HPP
...
#include <hboost/property_map/property_map_iterator.hpp>
#include <hboost/type_traits/is_same.hpp>
#include <algorithm>
#include <hboost/property_map/parallel/caching_property_map.hpp>
#include <hboost/pending/indirect_cmp.hpp>
#include <hboost/graph/distributed/detail/remote_update_set.hpp>
#include <vector>
#include <hboost/graph/breadth_first_search.hpp>
#include <hboost/graph/dijkstra_shortest_paths.hpp>
...
namespace detail {
  ...
  class crauser_et_al_dijkstra_queue
    : public graph::detail::remote_update_set<
               ...
               typename hboost::graph::parallel::process_group_type<Graph>::type,
  ...
  public:
    ...
    crauser_et_al_dijkstra_queue(const Graph& g,
      ...
      : inherited(hboost::graph::parallel::process_group(g), get(vertex_owner, g)),
   ...
   DijkstraVisitor vis)
{
  ...
  ::hboost::detail::dijkstra_bfs_visitor<
      DijkstraVisitor, Queue, WeightMap,
      hboost::parallel::caching_property_map<PredecessorMap>,
      hboost::parallel::caching_property_map<DistanceMap>, Combine, Compare
    > bfs_vis(vis, Q, weight,
              hboost::parallel::make_caching_property_map(predecessor),
              hboost::parallel::make_caching_property_map(distance),
...
} } // end namespace hboost::graph

#endif // HBOOST_GRAPH_CRAUSER_ET_AL_SHORTEST_PATHS_HPP
