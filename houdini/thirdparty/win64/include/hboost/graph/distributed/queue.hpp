...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_DISTRIBUTED_QUEUE_HPP
#define HBOOST_GRAPH_DISTRIBUTED_QUEUE_HPP
...
inline void
synchronize(const HBOOST_DISTRIBUTED_QUEUE_TYPE& Q)
{ Q.do_synchronize(); }
...
#include <hboost/graph/distributed/detail/queue.ipp>

#undef HBOOST_DISTRIBUTED_QUEUE_TYPE
#undef HBOOST_DISTRIBUTED_QUEUE_PARMS

#endif // HBOOST_GRAPH_DISTRIBUTED_QUEUE_HPP
