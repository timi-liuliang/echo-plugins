 ...
 **************************************************************************/
#ifndef HBOOST_GRAPH_DELTA_STEPPING_SHORTEST_PATHS_HPP
#define HBOOST_GRAPH_DELTA_STEPPING_SHORTEST_PATHS_HPP
...
#include <hboost/graph/parallel/algorithm.hpp> // for all_reduce
#include <cassert>
...
delta_stepping_impl(const Graph& g,
    ...
    : g(g),
      ...
      weight(weight),
      delta(delta),
      pg(hboost::graph::parallel::process_group_adl(g), attach_distributed_object()),
...
#endif // HBOOST_GRAPH_DELTA_STEPPING_SHORTEST_PATHS_HPP
