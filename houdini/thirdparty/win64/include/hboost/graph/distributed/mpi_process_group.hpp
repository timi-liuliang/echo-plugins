...
//           Matthias Troyer
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_DISTRIBUTED_MPI_PROCESS_GROUP
#define HBOOST_GRAPH_DISTRIBUTED_MPI_PROCESS_GROUP
...
#include <hboost/mpi.hpp>
#include <hboost/property_map/parallel/process_group.hpp>
#include <hboost/utility/enable_if.hpp>

namespace hboost { namespace graph { namespace distributed {

// Process group tags
struct mpi_process_group_tag : virtual hboost::parallel::linear_process_group_tag { };
...
class mpi_process_group
{
 ...
 public:
  ...
  typedef hboost::mpi::packed_oprimitive::buffer_type buffer_type;
  ...
  typedef hboost::mpi::communicator communicator_type;

  /// Classification of the capabilities of this process group
  struct communication_category
    : virtual hboost::parallel::bsp_process_group_tag, 
...
private:
   ...
   */
  class trigger_base : hboost::noncopyable
  {
  public:
...
public:
  ...
  std::pair<hboost::mpi::communicator, int> 
...
private:
  ...
  void receive_batch(hboost::mpi::status& status) const;
...
send_oob(const mpi_process_group& pg, mpi_process_group::process_id_type dest,
         int tag, const T& value, int block=-1)
{
  using hboost::mpi::packed_oarchive;
...
HBOOST_IS_BITWISE_SERIALIZABLE(hboost::graph::distributed::mpi_process_group::message_header)
namespace hboost { namespace mpi {
    template<>
    struct is_mpi_datatype<hboost::graph::distributed::mpi_process_group::message_header> : mpl::true_ { };
} } // end namespace hboost::mpi

namespace std {
/// optimized swap for outgoing messages
inline void 
swap(hboost::graph::distributed::mpi_process_group::outgoing_messages& x,
     hboost::graph::distributed::mpi_process_group::outgoing_messages& y)
{
  x.swap(y);
}
...
HBOOST_CLASS_IMPLEMENTATION(hboost::graph::distributed::mpi_process_group::outgoing_messages,object_serializable)
HBOOST_CLASS_TRACKING(hboost::graph::distributed::mpi_process_group::outgoing_messages,track_never)

#include <hboost/graph/distributed/detail/mpi_process_group.ipp>

#endif // HBOOST_PARALLEL_MPI_MPI_PROCESS_GROUP_HPP
