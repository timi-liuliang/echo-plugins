...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_PARALLEL_DIJKSTRA_HPP
#define HBOOST_GRAPH_PARALLEL_DIJKSTRA_HPP
...
#include <hboost/graph/distributed/crauser_et_al_shortest_paths.hpp>
#include <hboost/graph/distributed/eager_dijkstra_shortest_paths.hpp>
...
namespace hboost {
  ...
  namespace graph { namespace detail {
    ...
    template<>
    struct parallel_dijkstra_impl2< ::hboost::param_not_found >
    {
      template<typename DistributedGraph, typename DijkstraVisitor,
               typename PredecessorMap, typename DistanceMap, 
               typename WeightMap, typename IndexMap, typename ColorMap, 
    ...
    template<>
    struct parallel_dijkstra_impl< ::hboost::param_not_found >
    {
    private:
      template<typename DistributedGraph, typename DijkstraVisitor,
               typename PredecessorMap, typename DistanceMap, 
  ...
  dijkstra_shortest_paths
    (const DistributedGraph& g,
     ...
     HBOOST_GRAPH_ENABLE_IF_MODELS_PARM(DistributedGraph,distributed_graph_tag))
  {
    typedef typename graph_traits<DistributedGraph>::vertices_size_type
      vertices_size_type;
...
#endif // HBOOST_GRAPH_PARALLEL_DIJKSTRA_HPP
