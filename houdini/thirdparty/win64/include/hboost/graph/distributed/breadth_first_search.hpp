...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_PARALLEL_BFS_HPP
#define HBOOST_GRAPH_PARALLEL_BFS_HPP
...
#include <hboost/dynamic_bitset.hpp>
...
namespace hboost {
  namespace detail {
       ...
       VertexIndexMap vertex_index)
    {
      ...
      typedef typename hboost::graph::parallel::process_group_type<DistributedGraph>::type 
        process_group_type;
      ...
      typedef hboost::graph::distributed::distributed_queue<
...
#endif // HBOOST_GRAPH_PARALLEL_BFS_HPP
