 ...
 **************************************************************************/
#ifndef HBOOST_GRAPH_EAGER_DIJKSTRA_SHORTEST_PATHS_HPP
#define HBOOST_GRAPH_EAGER_DIJKSTRA_SHORTEST_PATHS_HPP
 ...
 struct parallel_dijkstra_bfs_visitor : bfs_visitor<>
{
  ...
  void examine_edge(Edge e, Graph& g) {
    ...
    hboost::parallel::caching_property_map<PredecessorMap> c_pred(m_predecessor);
    hboost::parallel::caching_property_map<DistanceMap> c_dist(m_distance);
...
#endif // HBOOST_GRAPH_EAGER_DIJKSTRA_SHORTEST_PATHS_HPP
