...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_LOCAL_SUBGRAPH_HPP
#define HBOOST_GRAPH_LOCAL_SUBGRAPH_HPP
...
public:
  ...
  { 
    using hboost::graph::parallel::process_group;
    return hboost::graph::parallel::process_group(g); 
  }
...
#endif // HBOOST_GRAPH_LOCAL_SUBGRAPH_HPP
