...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_PARALLEL_BRANDES_BETWEENNESS_CENTRALITY_HPP
#define HBOOST_GRAPH_PARALLEL_BRANDES_BETWEENNESS_CENTRALITY_HPP
...
#include <hboost/graph/betweenness_centrality.hpp>
...
#include <hboost/graph/distributed/distributed_graph_utility.hpp>
...
#include <hboost/graph/distributed/detail/dijkstra_shortest_paths.hpp>
...
struct append_reducer {
  HBOOST_STATIC_CONSTANT(bool, non_default_resolver = true);
...
namespace hboost {
  ...
  namespace serialization {
    ...
    void serialize(Archive & ar,
                   hboost::tuple<T1,T2,T3, T4>& t,
                   const unsigned int)
    {
      ar & hboost::tuples::get<0>(t);
      ar & hboost::tuples::get<1>(t);
      ar & hboost::tuples::get<2>(t);
      ar & hboost::tuples::get<3>(t);
    }
  ...
  public:
    ...
    owner_type get_owner(Tuple t) { return get(owner, hboost::tuples::get<0>(t)); }
  ...
  class betweenness_centrality_delta_stepping_impl { 
    ...
    typedef typename hboost::graph::parallel::process_group_type<Graph>::type 
      ProcessGroup;
  ...
  private:
    ...
    void synchronize()
    {
      using hboost::parallel::synchronize;
      synchronize(pg);
    }
    ...
    void setup_triggers()
    {
      using hboost::parallel::simple_trigger;
    ...
    void handle_msg_relax(int /*source*/, int /*tag*/,
                          ...
                          hboost::parallel::trigger_receive_context)
...
#endif
      delta(delta),
      pg(hboost::graph::parallel::process_group_adl(g), hboost::parallel::attach_distributed_object()),
  ...
  run(Vertex s)
  {
    ...
    do {
      ...
      using hboost::parallel::all_reduce;
      using hboost::parallel::minimum;
      ...
      typedef hboost::queue<queue_value_type> local_queue_type;
      typedef hboost::graph::distributed::distributed_queue<process_group_type,
                                                           IndirectOwnerMap,
  ...
  private:
    ...
    set_delta(const Graph& g)
    {
      ...
      BGL_FORALL_VERTICES_T(u, g, Graph) {
        max_degree = max HBOOST_PREVENT_MACRO_SUBSTITUTION (max_degree, out_degree(u, g));
        BGL_FORALL_OUTEDGES_T(u, e, g, Graph)
          max_edge_weight = max HBOOST_PREVENT_MACRO_SUBSTITUTION (max_edge_weight, get(weight, e));
      }
  ...
  do_brandes_sssp(const Graph& g, 
                  ...
                  typename graph_traits<Graph>::vertex_descriptor s)
  {
    using hboost::detail::graph::update_centrality;      
    using hboost::graph::parallel::process_group;
    ...
    typedef hboost::tuple<vertex_descriptor, vertex_descriptor, dependency_type, path_count_type>
      queue_value_type;
    ...
    dependency_count.set_reduce(hboost::graph::distributed::additive_reducer<dependency_type>());
    ...
    BGL_FORALL_VERTICES_T(v, g, Graph) {
      if (get(distance, v) < (std::numeric_limits<distance_type>::max)()
        ...
        Q.push(hboost::make_tuple(v, v, get(dependency, v), get(path_count, v)));
    }
    ...
    while(!Q.empty()) {
      ...
      vertex_descriptor w = hboost::tuples::get<0>(x);
      vertex_descriptor source = hboost::tuples::get<1>(x);
      dependency_type dep = hboost::tuples::get<2>(x);
      path_count_type pc = hboost::tuples::get<3>(x);
      ...
      if (get(dependency_count, w) == 0) { 
        ...
        for (incoming_iterator vw = el.begin(); vw != el.end(); ++vw) {
          ...
          HBOOST_ASSERT(get(path_count, w) != 0);
        ...
        for (incoming_iterator vw = el.begin(); vw != el.end(); ++vw)
          Q.push(hboost::make_tuple(*vw, w, get(dependency, w), get(path_count, w)));
      }
    }
  }
  ...
  brandes_betweenness_centrality_impl(const Graph& g, 
                                      ...
                                      Buffer sources)
  {
    using hboost::detail::graph::init_centrality_map;
    using hboost::detail::graph::divide_centrality_by_two;       
    using hboost::graph::parallel::process_group;
    ...
    dependency.set_reduce(hboost::graph::distributed::additive_reducer<dependency_type>()); 
    distance.set_reduce(hboost::graph::distributed::choose_min_reducer<distance_type>());
    ...
    if (!sources.empty()) {
      ...
      n = hboost::parallel::all_reduce(pg, n, std::plus<vertices_size_type>());
...
brandes_betweenness_centrality(const Graph& g, 
                               ...
                               HBOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  typedef typename property_traits<DistanceMap>::value_type distance_type;
...
namespace graph { namespace parallel { namespace detail {
  ...
  struct brandes_betweenness_centrality_dispatch1
  {
    ...
    {
      hboost::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
       g, centrality, edge_centrality_map, weight_map, vertex_index, sources, delta);
    }
  };

  template<>
  struct brandes_betweenness_centrality_dispatch1<hboost::param_not_found> 
  {
    template<typename Graph, typename CentralityMap, typename EdgeCentralityMap, 
             typename VertexIndexMap, typename Buffer>
    static void 
                               ...
                               HBOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  graph::parallel::detail::brandes_betweenness_centrality_dispatch1<ew>::run(
    ...
    choose_param(get_param(params, buffer_param_t()), hboost::ref(q)),
                               ...
                               HBOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  hboost::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
    g, centrality, dummy_property_map(), get(vertex_index, g), hboost::ref(q), 0);
}
                               ...
                               HBOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  hboost::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
    g, centrality, edge_centrality_map, get(vertex_index, g), hboost::ref(q), 0);
}
                                               ...
                                               CentralityMap centrality)
{
  ...
  detail::graph::non_distributed_brandes_betweenness_centrality_dispatch2(
    pg, g, centrality, dummy_property_map(), get(vertex_index, g), hboost::ref(q));
}
                        ...
                        HBOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  typedef typename hboost::graph::parallel::process_group_type<Graph>::type 
    process_group_type;
  process_group_type pg = hboost::graph::parallel::process_group(g);
  ...
  for (hboost::tie(v, v_end) = vertices(g); v != v_end; ++v) {
    max_centrality = (max)(max_centrality, get(centrality, *v));
  }

  // All reduce to get global max centrality
  max_centrality = all_reduce(pg, max_centrality, hboost::parallel::maximum<centrality_type>());
...
#endif // HBOOST_GRAPH_PARALLEL_BRANDES_BETWEENNESS_CENTRALITY_HPP
