...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_DISTRIBUTED_DFS_HPP
#define HBOOST_GRAPH_DISTRIBUTED_DFS_HPP
...
namespace hboost {
  namespace graph { namespace distributed { namespace detail {
    ...
    class parallel_dfs
    {
       ...
       */
      typedef hboost::parallel::detail::untracked_pair<vertex_descriptor, vertex_descriptor> vertex_pair;
          ...
          case discover_msg:
            {
              ...
              if (get(color, p.first) == Color::white()) {
                ...
                for (hboost::tie(ei,ei_end) = out_edges(p.first, g); ei != ei_end; ++ei)
                {
...
#endif // HBOOST_GRAPH_DISTRIBUTED_DFS_HPP
