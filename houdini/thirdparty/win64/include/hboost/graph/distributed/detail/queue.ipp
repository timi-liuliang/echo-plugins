...
template<HBOOST_DISTRIBUTED_QUEUE_PARMS>
HBOOST_DISTRIBUTED_QUEUE_TYPE::
...
template<HBOOST_DISTRIBUTED_QUEUE_PARMS>
void
HBOOST_DISTRIBUTED_QUEUE_TYPE::push(const value_type& x)
{
...
template<HBOOST_DISTRIBUTED_QUEUE_PARMS>
bool
HBOOST_DISTRIBUTED_QUEUE_TYPE::empty() const
{
...
template<HBOOST_DISTRIBUTED_QUEUE_PARMS>
typename HBOOST_DISTRIBUTED_QUEUE_TYPE::size_type
HBOOST_DISTRIBUTED_QUEUE_TYPE::size() const
{
  empty();
  return buffer.size();
}
...
template<HBOOST_DISTRIBUTED_QUEUE_PARMS>
void HBOOST_DISTRIBUTED_QUEUE_TYPE::setup_triggers()
{
...
template<HBOOST_DISTRIBUTED_QUEUE_PARMS>
bool
HBOOST_DISTRIBUTED_QUEUE_TYPE::do_synchronize() const
{
