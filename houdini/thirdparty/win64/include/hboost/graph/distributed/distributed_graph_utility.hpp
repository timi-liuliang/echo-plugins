...
#ifndef HBOOST_GRAPH_DISTRIBUTED_GRAPH_UTILITY_INCLUDE
#define HBOOST_GRAPH_DISTRIBUTED_GRAPH_UTILITY_INCLUDE
...
namespace hboost { namespace graph {
  ...
  namespace distributed {
    ...
    protected:
      hboost::parallel::global_index_map<VertexIndexMap, VertexGlobalMap> 
      global_index_map;
    };
...
}} // namespace hboost::graph

#endif // HBOOST_GRAPH_DISTRIBUTED_GRAPH_UTILITY_INCLUDE
