...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_DISTRIBUTED_RMAT_GENERATOR_HPP
#define HBOOST_GRAPH_DISTRIBUTED_RMAT_GENERATOR_HPP
...
namespace hboost {
  ...
  public:
          ...
          : gen(), done(false)
      {
          ...
          hboost::uniform_01<RandomGenerator> prob(gen);
          ...
          do {
              ...
              tossed = all_reduce(pg, tossed, hboost::parallel::sum<vertices_size_type>());
              generated -= (tossed / 2);
          } while (generated < m);
...
#endif // HBOOST_GRAPH_DISTRIBUTED_RMAT_GENERATOR_HPP
