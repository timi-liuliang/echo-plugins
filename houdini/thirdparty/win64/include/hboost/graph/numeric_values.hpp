...
#ifndef HBOOST_GRAPH_NUMERIC_VALUES_HPP
#define HBOOST_GRAPH_NUMERIC_VALUES_HPP
...
#define HBOOST_GRAPH_SPECIALIZE_NUMERIC_FLOAT(type) \
    ...
    HBOOST_GRAPH_SPECIALIZE_NUMERIC_FLOAT(float)
    HBOOST_GRAPH_SPECIALIZE_NUMERIC_FLOAT(double)
    HBOOST_GRAPH_SPECIALIZE_NUMERIC_FLOAT(long double)

#undef HBOOST_GRAPH_SPECIALIZE_NUMERIC_VALUE
}
