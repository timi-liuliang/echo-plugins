...
#ifndef HBOOST_GRAPH_GRID_GRAPH_HPP
#define HBOOST_GRAPH_GRID_GRAPH_HPP
...
#define HBOOST_GRID_GRAPH_TEMPLATE_PARAMS \
  std::size_t DimensionsT, typename VertexIndexT, \
    typename EdgeIndexT

#define HBOOST_GRID_GRAPH_TYPE \
  grid_graph<DimensionsT, VertexIndexT, EdgeIndexT>

#define HBOOST_GRID_GRAPH_TRAITS_T \
  typename graph_traits<HBOOST_GRID_GRAPH_TYPE >

namespace hboost {

  // Class prototype for grid_graph
  template<HBOOST_GRID_GRAPH_TEMPLATE_PARAMS>
  class grid_graph;
  ...
  template<HBOOST_GRID_GRAPH_TEMPLATE_PARAMS>
  struct property_map<HBOOST_GRID_GRAPH_TYPE, vertex_index_t> {
    typedef grid_graph_index_map<HBOOST_GRID_GRAPH_TYPE,
                                 HBOOST_GRID_GRAPH_TRAITS_T::vertex_descriptor,
                                 HBOOST_GRID_GRAPH_TRAITS_T::vertices_size_type> type;
    typedef type const_type;
  };

  template<HBOOST_GRID_GRAPH_TEMPLATE_PARAMS>
  struct property_map<HBOOST_GRID_GRAPH_TYPE, edge_index_t> {
    typedef grid_graph_index_map<HBOOST_GRID_GRAPH_TYPE,
                                 HBOOST_GRID_GRAPH_TRAITS_T::edge_descriptor,
                                 HBOOST_GRID_GRAPH_TRAITS_T::edges_size_type> type;
    typedef type const_type;
  };
  ...
  template<HBOOST_GRID_GRAPH_TEMPLATE_PARAMS>
  struct property_map<HBOOST_GRID_GRAPH_TYPE, edge_reverse_t> {
    typedef grid_graph_reverse_edge_map<HBOOST_GRID_GRAPH_TRAITS_T::edge_descriptor> type;
    typedef type const_type;
  };
  ...
  private:
    typedef hboost::array<bool, Dimensions> WrapDimensionArray;
    grid_graph() { };
  ...
  public:
    ...
    // descriptors
    typedef hboost::array<VertexIndex, Dimensions> vertex_descriptor;
  ...
  protected:
    ...
    (vertices_size_type vertex_index) const {
      ...
      hboost::array<vertices_size_type, Dimensions> vertex;
    ...
    edges_size_type index_of(edge_descriptor edge) const {
      ...
      HBOOST_ASSERT (source_vertex != target_vertex);
    ...
    hboost::array<edges_size_type, Dimensions> m_edge_count;
...
#undef HBOOST_GRID_GRAPH_TYPE
#undef HBOOST_GRID_GRAPH_TEMPLATE_PARAMS
#undef HBOOST_GRID_GRAPH_TRAITS_T

#endif // HBOOST_GRAPH_GRID_GRAPH_HPP
