...
#ifndef HBOOST_GRAPH_CLOSENESS_CENTRALITY_HPP
#define HBOOST_GRAPH_CLOSENESS_CENTRALITY_HPP

#include <hboost/graph/detail/geodesic.hpp>
#include <hboost/graph/exterior_property.hpp>
    ...
    : public geodesic_measure<Graph, DistanceType, ResultType>
{
    ...
    {
        HBOOST_CONCEPT_ASSERT(( NumericValueConcept<DistanceType> ));
        HBOOST_CONCEPT_ASSERT(( NumericValueConcept<ResultType> ));
        HBOOST_CONCEPT_ASSERT(( AdaptableUnaryFunctionConcept<Reciprocal,ResultType,ResultType> ));
                     ...
                     Combinator combine)
{
    ...
    typedef typename property_traits<DistanceMap>::value_type Distance;
    HBOOST_CONCEPT_ASSERT(( NumericValueConcept<Distance> ));
    HBOOST_CONCEPT_ASSERT(( DistanceMeasureConcept<Measure,Graph> ));
                           ...
                           Measure measure)
{
    HBOOST_CONCEPT_ASSERT(( VertexListGraphConcept<Graph> ));
    typedef typename graph_traits<Graph>::vertex_descriptor Vertex;
    HBOOST_CONCEPT_ASSERT(( ReadablePropertyMapConcept<DistanceMatrixMap,Vertex> ));
    typedef typename property_traits<DistanceMatrixMap>::value_type DistanceMap;
    HBOOST_CONCEPT_ASSERT(( ReadablePropertyMapConcept<DistanceMap,Vertex> ));
    HBOOST_CONCEPT_ASSERT(( WritablePropertyMapConcept<CentralityMap,Vertex> ));
