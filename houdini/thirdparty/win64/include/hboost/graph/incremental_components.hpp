...
#ifndef HBOOST_INCREMENTAL_COMPONENTS_HPP
#define HBOOST_INCREMENTAL_COMPONENTS_HPP

#include <hboost/detail/iterator.hpp>
#include <hboost/graph/detail/incremental_components.hpp>
...
namespace hboost {
  ...
  template <class ParentIterator>
  typename hboost::detail::iterator_traits<ParentIterator>::difference_type
  ...
  public:
    ...
    component_index(ParentIterator parent_start,
      ...
      build_index_lists(parent_start, hboost::identity_property_map());
...
#endif // HBOOST_INCREMENTAL_COMPONENTS_HPP
