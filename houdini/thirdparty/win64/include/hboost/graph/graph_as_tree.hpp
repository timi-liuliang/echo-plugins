...
//=======================================================================
//
#ifndef HBOOST_GRAPH_GRAPH_AS_TREE_HPP
#define HBOOST_GRAPH_GRAPH_AS_TREE_HPP

#include <vector>
#include <hboost/config.hpp>
#include <hboost/property_map/property_map.hpp>
#include <hboost/graph/tree_traits.hpp>
...
namespace hboost {
  ...
  public:
    ...
    friend Node parent(N n, const Tree& t) { 
      return hboost::get(t.parent_pa(), n); 
    }
  ...
  public:
    ...
    graph_as_tree(Graph& g, Node root, ParentMap p) : super(g, root), _p(p) { 
      breadth_first_search(g, root, 
                   ...
                   (record_predecessors(p, hboost::on_tree_edge()))));
    }
...
#endif //  HBOOST_GRAPH_GRAPH_AS_TREE_HPP
