...
//=======================================================================
//
#ifndef HBOOST_GRAPH_CORE_NUMBERS_HPP
#define HBOOST_GRAPH_CORE_NUMBERS_HPP
...
namespace hboost {
    ...
    namespace detail {
        ...
        class constant_value_property_map
          : public hboost::put_get_helper<ValueType,
        ...
        void compute_in_degree_map(Graph& g, CoreMap d, EdgeWeightMap wm)
        {
            ...
            for (hboost::tie(vi,vi_end) = vertices(g); vi!=vi_end; ++vi) {
                for (hboost::tie(ei,ei_end) = out_edges(*vi,g); ei!=ei_end; ++ei) {
        ...
        core_numbers_impl(Graph& g, CoreMap c, PositionMap pos, Visitor vis)
        {
            ...
            std::copy(hboost::make_reverse_iterator(bin.end()-2),
                hboost::make_reverse_iterator(bin.begin()),
                hboost::make_reverse_iterator(bin.end()-1));
...
#endif // HBOOST_GRAPH_CORE_NUMBERS_HPP
