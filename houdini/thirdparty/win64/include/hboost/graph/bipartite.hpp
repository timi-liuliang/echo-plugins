...
#ifndef HBOOST_GRAPH_BIPARTITE_HPP
#define HBOOST_GRAPH_BIPARTITE_HPP
...
namespace hboost {
      ...
      OutputIterator result)
  {
    ...
    for (hboost::tie (vertex_iter, vertex_end) = vertices (graph); vertex_iter != vertex_end; ++vertex_iter)
    {
...
#endif /// HBOOST_GRAPH_BIPARTITE_HPP
