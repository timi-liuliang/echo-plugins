...
#ifndef HBOOST_GRAPH_EDGE_LIST_HPP
#define HBOOST_GRAPH_EDGE_LIST_HPP
...
namespace hboost {
  ...
  public:
    ...
    typedef V vertex_descriptor;
    typedef typename hboost::integer_range<edge_id>::iterator edge_iterator;
    typedef void out_edge_iterator;
    typedef void in_edge_iterator;
    typedef void adjacency_iterator;
    typedef void vertex_iterator;
...
#endif /* HBOOST_GRAPH_EDGE_LIST_HPP */
