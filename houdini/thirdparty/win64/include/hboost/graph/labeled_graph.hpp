...
#ifndef HBOOST_GRAPH_LABELED_GRAPH_HPP
#define HBOOST_GRAPH_LABELED_GRAPH_HPP
...
namespace graph_detail {
    ...
    { typedef hboost::unordered_map<Label, Vertex> type; };

    template <typename Label, typename Vertex>
    struct generate_label_map<hash_multimapS, Label, Vertex>
    { typedef hboost::unordered_multimap<Label, Vertex> type; };
                          ...
                          unique_associative_container_tag)
    {
        ...
        if(x.second) {
            ...
            put(hboost::vertex_all, g, x.first->second, p);
        }
...
public:
    ...
    { return hboost::remove_vertex(vertex(l), _graph); }
...
#include <hboost/graph/detail/labeled_graph_traits.hpp>

#endif // HBOOST_GRAPH_LABELED_GRAPH_HPP
