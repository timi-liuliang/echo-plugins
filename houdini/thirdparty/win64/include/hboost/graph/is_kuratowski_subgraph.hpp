...
namespace hboost
{
  ...
  namespace detail
  {
    ...
    Graph make_K_5()
    {
      ...
      Graph K_5(5);
      for(hboost::tie(vi,vi_end) = vertices(K_5); vi != vi_end; ++vi)
    ...
    Graph make_K_3_3()
    {
      ...
      for(hboost::tie(vi, vi_end) = vertices(K_3_3); vi != bipartition_start; ++vi)
                              ...
                              )
  {
    ...
    if (target_graph == detail::tg_k_5)
      {
        return hboost::isomorphism(K_5,contracted_graph);
      }
    else //target_graph == tg_k_3_3
      {
        return hboost::isomorphism(K_3_3,contracted_graph);
      }
