...
#ifndef HBOOST_GRAPH_READ_DIMACS_HPP
#define HBOOST_GRAPH_READ_DIMACS_HPP
  ...
  while (std::getline(in, in_line)) {
    ...
    case 'a':                    /* arc description */
...

      {
        ...
        bool in1, in2;
        hboost::tie(e1, in1) = add_edge(verts[tail], verts[head], g);
        hboost::tie(e2, in2) = add_edge(verts[head], verts[tail], g);
        if (!in1 || !in2) {
...
#endif // HBOOST_GRAPH_READ_DIMACS_HPP
