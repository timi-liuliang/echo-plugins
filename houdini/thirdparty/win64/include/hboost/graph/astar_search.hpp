...
#ifndef HBOOST_GRAPH_ASTAR_SEARCH_HPP
#define HBOOST_GRAPH_ASTAR_SEARCH_HPP
...
namespace hboost {
  ...
  struct AStarHeuristicConcept {
    void constraints()
    {
      HBOOST_CONCEPT_ASSERT(( CopyConstructibleConcept<Heuristic> ));
      h(u);
    }
    Heuristic h;
    ...
    struct astar_bfs_visitor
    {
      ...
      void examine_edge(Edge e, const Graph& g) {
        if (m_compare(get(m_weight, e), m_zero))
          HBOOST_THROW_EXCEPTION(negative_edge());
     ...
     CostInf /*inf*/, CostZero zero)
  {
    typedef typename graph_traits<VertexListGraph>::vertex_descriptor
      Vertex;
    typedef hboost::vector_property_map<std::size_t, VertexIndexMap> IndexInHeapMap;
     ...
     AStarHeuristic h, const bgl_named_params<P, T, R>& params)
  {
    ...
    typedef
      ...
      weight_map_type;
    typedef typename hboost::property_traits<weight_map_type>::value_type W;
    typedef
      typename detail::map_maker<VertexListGraph, arg_pack_type, tag::distance_map, W>::map_type
      distance_map_type;
    typedef typename hboost::property_traits<distance_map_type>::value_type D;
     ...
     AStarHeuristic h, const bgl_named_params<P, T, R>& params)
  {
    ...
    typedef
      typename detail::override_const_property_result<
                 arg_pack_type, tag::weight_map, edge_weight_t, VertexListGraph>::type
               weight_map_type;
    typedef typename hboost::property_traits<weight_map_type>::value_type D;
    const D inf = arg_pack[_distance_inf || detail::get_max<D>()];
    astar_search_no_init
      (g, s, h,
       arg_pack[_visitor | make_astar_visitor(null_visitor())],
...
#endif // HBOOST_GRAPH_ASTAR_SEARCH_HPP
