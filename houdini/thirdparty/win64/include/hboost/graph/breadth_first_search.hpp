...
//=======================================================================
//
#ifndef HBOOST_GRAPH_BREADTH_FIRST_SEARCH_HPP
#define HBOOST_GRAPH_BREADTH_FIRST_SEARCH_HPP
...
#include <hboost/graph/graph_concepts.hpp>
#include <hboost/graph/two_bit_color_map.hpp>
...
namespace hboost {
     ...
     Buffer& Q, BFSVisitor vis, ColorMap color)
  {
    ...
    HBOOST_CONCEPT_ASSERT(( BFSVisitorConcept<BFSVisitor, IncidenceGraph> ));
     ...
     Buffer& Q, BFSVisitor vis, ColorMap color)
  {
    ...
    typedef typename property_traits<ColorMap>::value_type ColorValue;
    typedef color_traits<ColorValue> Color;
    typename hboost::graph_traits<VertexListGraph>::vertex_iterator i, i_end;
    for (hboost::tie(i, i_end) = vertices(g); i != i_end; ++i) {
  ...
  public:
    ...
    {
      invoke_visitors(m_vis, u, g, ::hboost::on_examine_vertex());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::hboost::on_tree_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::hboost::on_non_tree_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::hboost::on_gray_target());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::hboost::on_black_target());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    HBOOST_GRAPH_EVENT_STUB(on_initialize_vertex,bfs)
    HBOOST_GRAPH_EVENT_STUB(on_discover_vertex,bfs)
    HBOOST_GRAPH_EVENT_STUB(on_examine_vertex,bfs)
    HBOOST_GRAPH_EVENT_STUB(on_examine_edge,bfs)
    HBOOST_GRAPH_EVENT_STUB(on_tree_edge,bfs)
    HBOOST_GRAPH_EVENT_STUB(on_non_tree_edge,bfs)
    HBOOST_GRAPH_EVENT_STUB(on_gray_target,bfs)
    HBOOST_GRAPH_EVENT_STUB(on_black_target,bfs)
    HBOOST_GRAPH_EVENT_STUB(on_finish_vertex,bfs)
  ...
  namespace detail {
       ...
       hboost::mpl::false_)
    {
      ...
      typedef hboost::queue<Vertex> queue_t;
      queue_t Q;
      breadth_first_search
        (g, s,
         choose_param(get_param(params, buffer_param_t()), hboost::ref(Q)).get(),
         vis, color);
    }
     ...
     const bgl_named_params<P, T, R>& params)
  {
    ...
    typedef hboost::queue<vertex_descriptor> queue_t;
    queue_t Q;
    ...
    namespace detail {
      ...
      struct breadth_first_search_impl {
        ...
        void operator()(const Graph& g, const Source& source, const ArgPack& arg_pack) {
          ...
          typename hboost::graph_traits<Graph>::vertex_descriptor sources[1] = {source};
          hboost::queue<typename hboost::graph_traits<Graph>::vertex_descriptor> Q;
          hboost::breadth_first_search(g,
                                      &sources[0],
                                      &sources[1], 
                                      hboost::unwrap_ref(arg_pack[_buffer | hboost::ref(Q)]),
                                      arg_pack[_visitor | make_bfs_visitor(null_visitor())],
                                      hboost::detail::make_color_map_from_arg_pack(g, arg_pack));
        }
      };
    }
    HBOOST_GRAPH_MAKE_FORWARDING_FUNCTION(breadth_first_search, 2, 4)
  }

#if 0
  // Named Parameter Variant
  HBOOST_GRAPH_MAKE_OLD_STYLE_PARAMETER_FUNCTION(breadth_first_search, 2)
#endif

} // namespace hboost

#ifdef HBOOST_GRAPH_USE_MPI
#  include <hboost/graph/distributed/breadth_first_search.hpp>
#endif

#endif // HBOOST_GRAPH_BREADTH_FIRST_SEARCH_HPP
