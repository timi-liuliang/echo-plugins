...
#include <hboost/graph/planar_detail/boyer_myrvold_impl.hpp>
...
namespace hboost
{
  ...
  namespace boyer_myrvold_params
  {
    ...
    HBOOST_PARAMETER_KEYWORD(tag, graph)
    HBOOST_PARAMETER_KEYWORD(tag, embedding)
    HBOOST_PARAMETER_KEYWORD(tag, kuratowski_subgraph)
    HBOOST_PARAMETER_KEYWORD(tag, vertex_index_map)
    HBOOST_PARAMETER_KEYWORD(tag, edge_index_map)
    ...
    namespace core
    {
                                    ...
                                    )
      {
        ...
        boyer_myrvold_impl
          <graph_t, 
           vertex_index_map_t,
           graph::detail::no_old_handles,
#ifdef HBOOST_GRAPH_PREFER_STD_LIB
                                    ...
                                    )
      {
        ...
        boyer_myrvold_impl
          ...
          vertex_index_map_t,
          graph::detail::store_old_handles,
#ifdef HBOOST_BGL_PREFER_STD_LIB
           graph::detail::std_list
#else
           graph::detail::recursive_lazy_list
#endif
