...
//=======================================================================
//
#ifndef HBOOST_GRAPH_NEIGHBOR_BREADTH_FIRST_SEARCH_HPP
#define HBOOST_GRAPH_NEIGHBOR_BREADTH_FIRST_SEARCH_HPP
...
namespace hboost {
  ...
  namespace detail {
    ...
    {
      HBOOST_CONCEPT_ASSERT(( BidirectionalGraphConcept<BidirectionalGraph> ));
      ...
      while (! Q.empty()) {
        ...
        for (hboost::tie(in_ei, in_ei_end) = in_edges(u, g); 
     ...
     const bgl_named_params<P, T, R>& params)
  {
    ...
    // Buffer default
    typedef hboost::queue<typename Traits::vertex_descriptor> queue_t;
    queue_t Q;
...
#endif // HBOOST_GRAPH_NEIGHBOR_BREADTH_FIRST_SEARCH_HPP
