...
#ifndef HBOOST_GRAPH_BANDWIDTH_HPP
#define HBOOST_GRAPH_BANDWIDTH_HPP
...
namespace hboost {
                ...
                VertexIndexMap index)
  {
    ...
    for (hboost::tie(e, end) = out_edges(i, g); e != end; ++e) {
      int f_i = get(index, i);
      int f_j = get(index, target(*e, g));
      b = max HBOOST_PREVENT_MACRO_SUBSTITUTION (b, vertices_size_type(abs(f_i - f_j)));
    }
    return b;
  }
...
#endif // HBOOST_GRAPH_BANDWIDTH_HPP
