...
//           Andrew Lumsdaine
#ifndef HBOOST_GRAPH_KAMADA_KAWAI_SPRING_LAYOUT_HPP
#define HBOOST_GRAPH_KAMADA_KAWAI_SPRING_LAYOUT_HPP

#include <hboost/graph/graph_traits.hpp>
#include <hboost/graph/topology.hpp>
#include <hboost/graph/iteration_macros.hpp>
#include <hboost/graph/johnson_all_pairs_shortest.hpp>
...
namespace hboost {
  ...
  struct layout_tolerance
  {
    ...
    bool 
    operator()(T delta_p, 
               typename hboost::graph_traits<Graph>::vertex_descriptor p,
               const Graph& g,
               bool global)
    {
      if (global) {
   ...
   * display area, and must be either @c hboost::edge_length(e) or @c
   * hboost::side_length(s), respectively.
   *
...
#endif // HBOOST_GRAPH_KAMADA_KAWAI_SPRING_LAYOUT_HPP
