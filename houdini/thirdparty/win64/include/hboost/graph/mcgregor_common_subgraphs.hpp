...
#ifndef HBOOST_GRAPH_MCGREGOR_COMMON_SUBGRAPHS_HPP
#define HBOOST_GRAPH_MCGREGOR_COMMON_SUBGRAPHS_HPP
...
namespace hboost {
  ...
  namespace detail {
     ...
     SubGraphInternalCallback subgraph_callback)
    {
      ...
      hboost::tie(vertex1_iter, vertex1_end) = vertices(graph1);
      hboost::tie(vertex2_begin, vertex2_end) = vertices(graph2);
...
#endif // HBOOST_GRAPH_MCGREGOR_COMMON_SUBGRAPHS_HPP
