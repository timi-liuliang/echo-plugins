...
#ifndef HBOOST_SIGNALS_CONNECTION_HPP
#define HBOOST_SIGNALS_CONNECTION_HPP
...
namespace hboost {
  namespace HBOOST_SIGNALS_NAMESPACE {
    ...
    class HBOOST_SIGNALS_DECL connection :
    ...
    public: // TBD: CHANGE THIS
      ...
      shared_ptr<HBOOST_SIGNALS_NAMESPACE::detail::basic_connection>
    ...
    private:
      ...
      void reset(HBOOST_SIGNALS_NAMESPACE::detail::basic_connection*);

      // Add a bound object to this connection (not for users)
      void add_bound_object(const HBOOST_SIGNALS_NAMESPACE::detail::bound_object& b);

      friend class HBOOST_SIGNALS_NAMESPACE::detail::bound_objects_visitor;

      // Pointer to the actual contents of the connection
      shared_ptr<HBOOST_SIGNALS_NAMESPACE::detail::basic_connection> con;
    ...
    class HBOOST_SIGNALS_DECL scoped_connection : public connection {
    public:
...
#endif // HBOOST_SIGNALS_CONNECTION_HPP
