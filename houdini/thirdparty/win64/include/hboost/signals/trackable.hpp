...
#ifndef HBOOST_SIGNALS_TRACKABLE_HPP
#define HBOOST_SIGNALS_TRACKABLE_HPP
...
namespace HBOOST_SIGNALS_NAMESPACE {
  ...
  class HBOOST_SIGNALS_DECL trackable {
  private:
    static void signal_disconnected(void* obj, void* data);

    friend class detail::signal_base_impl;
    friend class detail::slot_base;
    void signal_connected(connection, HBOOST_SIGNALS_NAMESPACE::detail::bound_object&) const;
  ...
  namespace detail {
    ...
    private:
      ...
      void maybe_get_pointer(const T& t, truth<false>) const
      {
        ...
        // trackable
        add_if_trackable(hboost::addressof(t));
      }
...
#endif // HBOOST_SIGNALS_TRACKABLE_HPP
