...
#ifndef HBOOST_SIGNALS_NAMED_SLOT_MAP_HPP
#define HBOOST_SIGNALS_NAMED_SLOT_MAP_HPP
...
namespace hboost { namespace HBOOST_SIGNALS_NAMESPACE {
...
class HBOOST_SIGNALS_DECL named_slot_map_iterator :
...
class HBOOST_SIGNALS_DECL named_slot_map
{
public:
...
#endif // HBOOST_SIGNALS_NAMED_SLOT_MAP_HPP
