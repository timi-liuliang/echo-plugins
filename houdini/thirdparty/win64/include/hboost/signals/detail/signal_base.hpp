...
#ifndef HBOOST_SIGNALS_SIGNAL_BASE_HEADER
#define HBOOST_SIGNALS_SIGNAL_BASE_HEADER

#include <hboost/signals/detail/config.hpp>
#include <hboost/signals/detail/signals_common.hpp>
#include <hboost/signals/detail/named_slot_map.hpp>
...
namespace hboost {
  namespace HBOOST_SIGNALS_NAMESPACE {
    namespace detail {
      ...
      // manages call depth
      class HBOOST_SIGNALS_DECL call_notification {
      public:
      ...
      class HBOOST_SIGNALS_DECL signal_base_impl {
      public:
      ...
      class HBOOST_SIGNALS_DECL signal_base : public noncopyable {
      public:
...
#endif // HBOOST_SIGNALS_SIGNAL_BASE_HEADER
