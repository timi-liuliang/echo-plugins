...
#ifndef HBOOST_THREAD_EXECUTORS_EXECUTOR_HPP
#define HBOOST_THREAD_EXECUTORS_EXECUTOR_HPP
...
namespace hboost
{
  ...
  public:
    ...
    HBOOST_THREAD_NO_COPYABLE(executor)
    executor() {}
     ...
     */
    virtual void submit(HBOOST_THREAD_RV_REF(work) closure) = 0;
