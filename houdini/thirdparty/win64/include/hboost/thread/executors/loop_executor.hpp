...
#ifndef HBOOST_THREAD_EXECUTORS_LOOP_EXECUTOR_HPP
#define HBOOST_THREAD_EXECUTORS_LOOP_EXECUTOR_HPP
...
namespace executors
{
  ...
  public:
    ...
    HBOOST_THREAD_NO_COPYABLE(loop_executor)
    ...
    {
      //work_queue.push(work(hboost::forward<Closure>(closure)));
