...
#ifndef HBOOST_THREAD_EXECUTORS_GENERIC_EXECUTOR_REF_HPP
#define HBOOST_THREAD_EXECUTORS_GENERIC_EXECUTOR_REF_HPP
...
namespace hboost
{
  ...
  public:
    ...
    HBOOST_THREAD_NO_COPYABLE(executor_ref)
