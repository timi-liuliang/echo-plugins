...
//   Provide implementation up to 10 parameters when HBOOST_NO_CXX11_VARIADIC_TEMPLATES is defined.
...
#ifndef HBOOST_THREAD_DETAIL_MAKE_TUPLE_INDICES_HPP
#define HBOOST_THREAD_DETAIL_MAKE_TUPLE_INDICES_HPP
...
namespace hboost
{
  namespace detail
  {
    ...
    {
      HBOOST_STATIC_ASSERT_MSG(Sp <= Ep, "make_tuple_indices input error");
