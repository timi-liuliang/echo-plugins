#ifndef HBOOST_THREAD_QUEUE_ADAPTOR_HPP
#define HBOOST_THREAD_QUEUE_ADAPTOR_HPP
...
namespace detail
{
  ...
  class queue_adaptor_copyable_only :
    public hboost::queue_base<typename Queue::value_type, typename Queue::size_type>
  {
      Queue queue;
  public:
