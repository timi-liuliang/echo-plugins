#ifndef HBOOST_THREAD_QUEUE_BASE_HPP
#define HBOOST_THREAD_QUEUE_BASE_HPP
...
namespace detail
{
  ...
  public:
    ...
    virtual void push(HBOOST_THREAD_RV_REF(value_type) x) = 0;
    virtual queue_op_status try_push(HBOOST_THREAD_RV_REF(value_type) x) = 0;
    virtual queue_op_status nonblocking_push(HBOOST_THREAD_RV_REF(value_type) x) = 0;
    virtual queue_op_status wait_push(HBOOST_THREAD_RV_REF(value_type) x) = 0;
  };
