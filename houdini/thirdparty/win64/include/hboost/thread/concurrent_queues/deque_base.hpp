#ifndef HBOOST_THREAD_CONCURRENT_DEQUE_BASE_HPP
#define HBOOST_THREAD_CONCURRENT_DEQUE_BASE_HPP
...
namespace detail
{
  ...
  public:
    ...
    virtual void push_back(HBOOST_THREAD_RV_REF(value_type) x) = 0;
    virtual queue_op_status try_push_back(HBOOST_THREAD_RV_REF(value_type) x) = 0;
    virtual queue_op_status nonblocking_push_back(HBOOST_THREAD_RV_REF(value_type) x) = 0;
    virtual queue_op_status wait_push_back(HBOOST_THREAD_RV_REF(value_type) x) = 0;
  };
