#ifndef HBOOST_THREAD_CONCURRENT_QUEUES_DETAIL_SYNC_QUEUE_BASE_HPP
#define HBOOST_THREAD_CONCURRENT_QUEUES_DETAIL_SYNC_QUEUE_BASE_HPP
...
namespace detail
{
  ...
  public:
    ...
    HBOOST_THREAD_NO_COPYABLE(sync_queue_base)
