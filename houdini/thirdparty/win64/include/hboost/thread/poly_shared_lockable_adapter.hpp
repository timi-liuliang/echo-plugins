...
#ifndef HBOOST_THREAD_POLY_SHARED_LOCKABLE_ADAPTER_HPP
#define HBOOST_THREAD_POLY_SHARED_LOCKABLE_ADAPTER_HPP

#include <hboost/thread/poly_lockable_adapter.hpp>
#include <hboost/thread/poly_shared_lockable.hpp>
