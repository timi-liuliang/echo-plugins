#ifndef HBOOST_THREAD_PTHREAD_SHARED_MUTEX_HPP
#define HBOOST_THREAD_PTHREAD_SHARED_MUTEX_HPP
...
namespace hboost
{
    ...
    private:
        ...
        public:
            ...
            {
                HBOOST_ASSERT( ! exclusive );
                HBOOST_ASSERT( ! upgrade );
                HBOOST_ASSERT( shared_count==0 );
            }
            ...
            void assert_lock_shared () const
            {
                HBOOST_ASSERT( ! exclusive );
                HBOOST_ASSERT( shared_count>0 );
                //HBOOST_ASSERT( (! upgrade) || (shared_count>1));
        ...
        state_data state;
        hboost::mutex state_change;
        hboost::condition_variable shared_cond;
        hboost::condition_variable exclusive_cond;
        hboost::condition_variable upgrade_cond;
    ...
    public:
        ...
        {
#if defined HBOOST_THREAD_PROVIDES_INTERRUPTIONS
            hboost::this_thread::disable_interruption do_not_disturb;
#endif
            hboost::unique_lock<hboost::mutex> lk(state_change);
