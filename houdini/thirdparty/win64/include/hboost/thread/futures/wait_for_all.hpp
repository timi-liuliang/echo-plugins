...
#ifndef HBOOST_THREAD_FUTURES_WAIT_FOR_ALL_HPP
#define HBOOST_THREAD_FUTURES_WAIT_FOR_ALL_HPP
...
namespace hboost
{
  ...
  typename hboost::disable_if<is_future_type<Iterator>,void>::type wait_for_all(Iterator begin,Iterator end)
  {
    ...
    typename hboost::enable_if<is_future_type<F1>,void>::type wait_for_all(F1& f1,F2& f2)
    {
        f1.wait();
        f2.wait();
    }
