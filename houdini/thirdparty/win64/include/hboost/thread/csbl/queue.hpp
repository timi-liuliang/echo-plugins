...
#ifndef HBOOST_CSBL_QUEUE_HPP
#define HBOOST_CSBL_QUEUE_HPP
...
//            _Ty=non_copyable
//        ]
#if defined HBOOST_THREAD_USES_HBOOST_QUEUE || defined HBOOST_NO_CXX11_RVALUE_REFERENCES || (defined _MSC_VER && _MSC_FULL_VER < 180020827)
#ifndef HBOOST_THREAD_USES_HBOOST_QUEUE
#define HBOOST_THREAD_USES_HBOOST_QUEUE
#endif
#include <hboost/container/queue.hpp>
#else
#include <queue>
#endif
...
namespace hboost
{
  namespace csbl
  {
#if defined HBOOST_THREAD_USES_HBOOST_QUEUE
    using ::hboost::container::queue;
