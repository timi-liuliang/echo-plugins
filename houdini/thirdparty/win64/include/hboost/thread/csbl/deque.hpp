...
#ifndef HBOOST_CSBL_DEQUE_HPP
#define HBOOST_CSBL_DEQUE_HPP
...
//            _Ty=non_copyable
//        ]
#if defined HBOOST_THREAD_USES_HBOOST_DEQUE || defined HBOOST_NO_CXX11_RVALUE_REFERENCES || (defined _MSC_VER && _MSC_FULL_VER < 180020827)
#ifndef HBOOST_THREAD_USES_HBOOST_DEQUE
#define HBOOST_THREAD_USES_HBOOST_DEQUE
#endif
#include <hboost/container/deque.hpp>
#else
#include <deque>
#endif
...
namespace hboost
{
  namespace csbl
  {
#if defined HBOOST_THREAD_USES_HBOOST_DEQUE
    using ::hboost::container::deque;
