...
#ifndef HBOOST_THREAD_POLY_LOCKABLE_ADAPTER_HPP
#define HBOOST_THREAD_POLY_LOCKABLE_ADAPTER_HPP

#include <hboost/thread/poly_lockable.hpp>
...
namespace hboost
{
  ...
  public:
    ...
    HBOOST_THREAD_NO_COPYABLE( poly_basic_lockable_adapter) /*< no copyable >*/
