...
namespace impl
{
    ...
    private:
        hboost::thread_specific_ptr<frame_ptr> tsp_frame;
...
#ifdef PHOENIX_THREADSAFE
    static hboost::thread_specific_ptr<holder_t*> &
    tsp_frame_instance()
    {
        static hboost::thread_specific_ptr<holder_t*> the_instance;
        return the_instance;
    }
...
#endif
        hboost::call_once(been_here, tsp_frame_instance_init);
        hboost::thread_specific_ptr<holder_t*> &tsp_frame = tsp_frame_instance();
        if (!tsp_frame.get())
