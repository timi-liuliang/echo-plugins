...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_ALTERNATIVE_HPP)
#define HBOOST_SPIRIT_ALTERNATIVE_HPP
...
#pragma warning(pop)
    ...
    struct alternative_parser_gen
    {
        ...
        {
            return alternative<HBOOST_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <hboost/spirit/home/classic/core/composite/impl/alternative.ipp>
