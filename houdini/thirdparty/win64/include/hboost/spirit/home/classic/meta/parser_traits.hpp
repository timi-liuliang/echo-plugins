...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_PARSER_TRAITS_HPP)
#define HBOOST_SPIRIT_PARSER_TRAITS_HPP
...
#include <hboost/spirit/home/classic/meta/impl/parser_traits.ipp>
...
struct is_parser
{
    HBOOST_STATIC_CONSTANT(bool, value =
        (::hboost::is_base_and_derived<parser<T>, T>::value));
...
struct is_unary_composite {
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (::hboost::is_convertible<
...
struct is_composite_parser {
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (
        ::HBOOST_SPIRIT_CLASSIC_NS::is_unary_composite<CompositeT>::value ||
        ::HBOOST_SPIRIT_CLASSIC_NS::is_binary_composite<CompositeT>::value));
};
...
struct is_alternative {
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (
        ::HBOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_alternative));
};
...
struct is_sequence {
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (
        ::HBOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_sequence));
};
...
struct is_sequential_or {
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (
        ::HBOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_sequential_or));
};
...
struct is_intersection {
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (
        ::HBOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_intersection));
};
...
struct is_difference {
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (
        ::HBOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_difference));
};
...
struct is_exclusive_or {
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (
        ::HBOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_exclusive_or));
};
...
struct is_optional {
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (
        ::HBOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_optional));
};
...
struct is_kleene_star {
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (
        ::HBOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_kleene_star));
};
...
struct is_positive {
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (
        ::HBOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_positive));
};
...
struct unary_subject {
    ...
    HBOOST_STATIC_ASSERT(HBOOST_SPIRIT_CLASSIC_NS::is_unary_composite<UnaryT>::value);
...
struct binary_left_subject {
    ...
    HBOOST_STATIC_ASSERT(::HBOOST_SPIRIT_CLASSIC_NS::is_binary_composite<BinaryT>::value);
...
struct action_subject {
    ...
    HBOOST_STATIC_ASSERT(::HBOOST_SPIRIT_CLASSIC_NS::is_action_parser<ActionT>::value);
...
#endif // !defined(HBOOST_SPIRIT_PARSER_TRAITS_HPP)
