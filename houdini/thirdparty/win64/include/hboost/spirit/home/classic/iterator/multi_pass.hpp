...
=============================================================================*/
#ifndef HBOOST_SPIRIT_ITERATOR_MULTI_PASS_HPP
#define HBOOST_SPIRIT_ITERATOR_MULTI_PASS_HPP
...
#include <hboost/spirit/home/classic/core/assert.hpp> // for HBOOST_SPIRIT_ASSERT
#include <hboost/spirit/home/classic/iterator/fixed_size_queue.hpp>
#include <hboost/detail/iterator.hpp> // for hboost::detail::iterator_traits

#include <hboost/spirit/home/classic/iterator/multi_pass_fwd.hpp>
...
public:
    ...
    virtual const char*
    what() const throw()
    { return "HBOOST_SPIRIT_CLASSIC_NS::illegal_backtracking"; }
};
...
class buf_id_check
{
    protected:
        ...
        void check_if_valid() const
        {
            ...
            {
                hboost::throw_exception(illegal_backtracking());
            }
        }
...
class inner
{
    ...
    protected:
        ...
        void destroy()
        {
            HBOOST_SPIRIT_ASSERT(NULL != queuedElements);
...
// HBOOST_SPIRIT_CLASSIC_NS::fixed_size_queue class) that is size N+1 and stores N elements.
...
class inner
{
    private:
        ...
        typedef HBOOST_SPIRIT_CLASSIC_NS::fixed_size_queue<ValueT, N> queue_type;
        queue_type * queuedElements;
...
class inner
{
    private:
        typedef
            typename hboost::detail::iterator_traits<InputT>::value_type
            result_type;
    ...
    public:
        typedef
            typename hboost::detail::iterator_traits<InputT>::difference_type
            difference_type;
        typedef
            typename hboost::detail::iterator_traits<InputT>::pointer
            pointer;
        typedef
            typename hboost::detail::iterator_traits<InputT>::reference
            reference;
    ...
    public:
        ...
        {
            HBOOST_SPIRIT_ASSERT(NULL != data);
            ensure_initialized();
            return data->curtok;
        }
...
// We are using hboost::iterator<> because it offers an automatic workaround
//  for broken std::iterator<> implementations.
template <typename InputPolicyT, typename InputT>
struct iterator_base_creator
{
    typedef typename InputPolicyT::HBOOST_NESTED_TEMPLATE inner<InputT> input_t;
...
#if HBOOST_WORKAROUND(__GLIBCPP__, == 20020514)
        multi_pass(int);
#endif // HBOOST_WORKAROUND(__GLIBCPP__, == 20020514)
...
namespace impl {
    ...
    {
        using std::swap;
        using HBOOST_SPIRIT_CLASSIC_NS::swap;
        swap(t1, t2);
    }
}
...
#endif // HBOOST_SPIRIT_ITERATOR_MULTI_PASS_HPP
