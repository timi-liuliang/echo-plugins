...
#endif // !defined(HBOOST_NO_INTRINSIC_WCHAR_T)
...
template <> struct rank< ::hboost::long_long_type>          { static int const value = 110; };
template <> struct rank< ::hboost::ulong_long_type> { static int const value = 120; };
#endif
