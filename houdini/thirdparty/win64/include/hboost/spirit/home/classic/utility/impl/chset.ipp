...
=============================================================================*/
#ifndef HBOOST_SPIRIT_CHSET_IPP
#define HBOOST_SPIRIT_CHSET_IPP

///////////////////////////////////////////////////////////////////////////////
#include <hboost/limits.hpp>
#include <hboost/spirit/home/classic/utility/chset.hpp>
...
namespace utility { namespace impl {
    ...
    inline void
    detach(hboost::shared_ptr<basic_chset<CharT> >& ptr)
    {
        if (!ptr.unique())
            ptr = hboost::shared_ptr<basic_chset<CharT> >
                (new basic_chset<CharT>(*ptr));
    }

    template <typename CharT>
    inline void
    detach_clear(hboost::shared_ptr<basic_chset<CharT> >& ptr)
    {
        if (ptr.unique())
            ptr->clear();
        else
