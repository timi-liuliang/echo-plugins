...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_SUBRULE_HPP)
#define HBOOST_SPIRIT_SUBRULE_HPP
...
#include <hboost/spirit/home/classic/core/non_terminal/subrule_fwd.hpp>
#include <hboost/spirit/home/classic/core/non_terminal/impl/subrule.ipp>
...
HBOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    : public parser<subrule_parser<ID, DefT, ContextT> >
    {
        ...
        HBOOST_STATIC_CONSTANT(int, id = ID);
