...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_RULE_HPP)
#define HBOOST_SPIRIT_RULE_HPP
...
//
///////////////////////////////////////////////////////////////////////////////
#if !defined(HBOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT)
#  define HBOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT 1
#endif

//  Ensure a meaningful maximum number of simultaneously usable scanner types
HBOOST_STATIC_ASSERT(HBOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT > 0);

#include <hboost/scoped_ptr.hpp>
#include <hboost/spirit/home/classic/namespace.hpp>
#include <hboost/spirit/home/classic/core/non_terminal/impl/rule.ipp>
...
HBOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    //      scanner types defined by the HBOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT
    //      constant. Example:
    //
