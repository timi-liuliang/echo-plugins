...
=============================================================================*/
#ifndef HBOOST_SPIRIT_REFACTORING_HPP
#define HBOOST_SPIRIT_REFACTORING_HPP
...
#include <hboost/spirit/home/classic/meta/impl/refactoring.ipp>
...
public:
    ...
    HBOOST_STATIC_ASSERT((
        hboost::is_convertible<typename BinaryT::parser_category_t,
...
public:
    ...
    //  parser
    HBOOST_STATIC_ASSERT((
        hboost::is_convertible<typename ActionT::parser_category_t,
...
#endif // HBOOST_SPIRIT_REFACTORING_HPP
