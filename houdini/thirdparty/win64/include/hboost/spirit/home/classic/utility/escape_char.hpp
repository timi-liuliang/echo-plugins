...
=============================================================================*/
#ifndef HBOOST_SPIRIT_ESCAPE_CHAR_HPP
#define HBOOST_SPIRIT_ESCAPE_CHAR_HPP
...
#include <hboost/spirit/home/classic/utility/escape_char_fwd.hpp>
#include <hboost/spirit/home/classic/utility/impl/escape_char.ipp>
...
struct escape_char_parser :
    ...
    HBOOST_STATIC_ASSERT(Flags == c_escapes || Flags == lex_escapes);
