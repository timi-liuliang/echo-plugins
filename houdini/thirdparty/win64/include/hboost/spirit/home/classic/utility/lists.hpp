...
=============================================================================*/
#ifndef HBOOST_SPIRIT_LISTS_HPP
#define HBOOST_SPIRIT_LISTS_HPP
...
#include <hboost/spirit/home/classic/utility/lists_fwd.hpp>
#include <hboost/spirit/home/classic/utility/impl/lists.ipp>
...
// (the operator()(...) functions)
    ...
    operator()(ItemT const &item_, DelimT const &delim_) const
    {
        ...
        typedef list_parser<item_t, delim_t, no_list_endtoken,
                HBOOST_DEDUCED_TYPENAME item_t::parser_category_t>
            return_t;
