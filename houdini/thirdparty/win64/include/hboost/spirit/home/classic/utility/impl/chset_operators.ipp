...
=============================================================================*/
#ifndef HBOOST_SPIRIT_CHSET_OPERATORS_IPP
#define HBOOST_SPIRIT_CHSET_OPERATORS_IPP
...
namespace impl {
    ...
    template <typename CharT>
    inline HBOOST_SPIRIT_CLASSIC_NS::range<CharT> const&
    full()
    {
        static HBOOST_SPIRIT_CLASSIC_NS::range<CharT> full_(
    ...
    empty()
    {
        static HBOOST_SPIRIT_CLASSIC_NS::range<CharT> empty_;
        return empty_;
    }
}
