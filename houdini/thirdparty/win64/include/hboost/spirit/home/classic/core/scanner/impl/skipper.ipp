...
============================================================================*/
#if !defined(HBOOST_SPIRIT_SKIPPER_IPP)
#define HBOOST_SPIRIT_SKIPPER_IPP
            ...
            skipper_iteration_policy<BaseT> const&)
        {
            typedef scanner_policies<
                no_skipper_iteration_policy<
                    HBOOST_DEDUCED_TYPENAME ScannerT::iteration_policy_t>,
                HBOOST_DEDUCED_TYPENAME ScannerT::match_policy_t,
                HBOOST_DEDUCED_TYPENAME ScannerT::action_policy_t
            > policies_t;

            scanner<HBOOST_DEDUCED_TYPENAME ScannerT::iterator_t, policies_t>
