...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_MATCH_HPP)
#define HBOOST_SPIRIT_MATCH_HPP
...
#include <hboost/spirit/home/classic/core/safe_bool.hpp>
#include <hboost/spirit/home/classic/core/impl/match_attr_traits.ipp>
...
HBOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    public:
        ...
        typedef typename hboost::optional<T> optional_type;
        ...
        {
            HBOOST_SPIRIT_ASSERT(*this && other);
            len += other.length();
        }
...
#endif
#include <hboost/spirit/home/classic/core/impl/match.ipp>
