...
=============================================================================*/
#ifndef HBOOST_SPIRIT_ESCAPE_CHAR_IPP
#define HBOOST_SPIRIT_ESCAPE_CHAR_IPP
...
#pragma warning(pop)
    ...
    struct escape_char_parse {
        ...
        parse(ScannerT const &scan, ParserT const &/*p*/)
        {
            ...
            HBOOST_SPIRIT_DEBUG_TRACE_NODE(p,
                (HBOOST_SPIRIT_DEBUG_FLAGS & HBOOST_SPIRIT_DEBUG_FLAGS_ESCAPE_CHAR) != 0);
