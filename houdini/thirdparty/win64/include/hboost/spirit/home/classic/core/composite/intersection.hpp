...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_INTERSECTION_HPP)
#define HBOOST_SPIRIT_INTERSECTION_HPP
...
HBOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct intersection_parser_gen
    {
        ...
        {
            return intersection<HBOOST_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <hboost/spirit/home/classic/core/composite/impl/intersection.ipp>
