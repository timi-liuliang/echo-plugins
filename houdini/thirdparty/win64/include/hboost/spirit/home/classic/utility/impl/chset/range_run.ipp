...
=============================================================================*/
#ifndef HBOOST_SPIRIT_RANGE_RUN_IPP
#define HBOOST_SPIRIT_RANGE_RUN_IPP

///////////////////////////////////////////////////////////////////////////////
#include <algorithm> // for std::lower_bound
#include <hboost/spirit/home/classic/core/assert.hpp> // for HBOOST_SPIRIT_ASSERT
#include <hboost/spirit/home/classic/utility/impl/chset/range_run.hpp>
...
HBOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    namespace utility { namespace impl {
        ...
        {
            HBOOST_SPIRIT_ASSERT(r.is_valid());
            if (!run.empty())
            {
                iterator iter =
                    std::lower_bound(
