...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_PARSER_NAMES_IPP)
#define HBOOST_SPIRIT_PARSER_NAMES_IPP
...
#include <strstream>
#define HBOOST_SPIRIT_SSTREAM std::strstream
std::string HBOOST_SPIRIT_GETSTRING(std::strstream& ss)
{
    ss << ends;
...
#else
#include <sstream>
#define HBOOST_SPIRIT_GETSTRING(ss) ss.str()
#define HBOOST_SPIRIT_SSTREAM std::stringstream
#endif
    ...
    namespace impl {
        struct node_registry
        {
            ...
            bool trace_node(void const *r)
            {
                ...
                return HBOOST_SPIRIT_DEBUG_TRACENODE;
            }
...
#undef HBOOST_SPIRIT_SSTREAM
#undef HBOOST_SPIRIT_GETSTRING

#endif // defined(HBOOST_SPIRIT_DEBUG)

#endif // !defined(HBOOST_SPIRIT_PARSER_NAMES_IPP)
