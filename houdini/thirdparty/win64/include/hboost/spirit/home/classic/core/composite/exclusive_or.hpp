...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_EXCLUSIVE_OR_HPP)
#define HBOOST_SPIRIT_EXCLUSIVE_OR_HPP
...
HBOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct exclusive_or_parser_gen
    {
        ...
        {
            return exclusive_or<HBOOST_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <hboost/spirit/home/classic/core/composite/impl/exclusive_or.ipp>
