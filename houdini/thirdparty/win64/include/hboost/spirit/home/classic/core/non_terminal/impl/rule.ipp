...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_RULE_IPP)
#define HBOOST_SPIRIT_RULE_IPP

#if HBOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT > 1
...
#include <hboost/spirit/home/classic/core/non_terminal/parser_id.hpp>
...
HBOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
        ...
        template <
            HBOOST_PP_ENUM_BINARY_PARAMS(
                HBOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT,
                typename ScannerT, = mpl::void_ HBOOST_PP_INTERCEPT
            )
        >
        struct scanner_list;

#endif // HBOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT > 1
    ...
    || HBOOST_WORKAROUND(__BORLANDC__, HBOOST_TESTED_AT(0x551))
        public: // YUCK!
#else
            template <
                typename DerivedT
...
#pragma warning(pop)
        ...
        //
        ///////////////////////////////////////////////////////////////////////
        #define HBOOST_SPIRIT_RULE_ENUM_DOPARSE_A(z, N, _)                       \
                virtual typename match_result<                                  \
                    HBOOST_PP_CAT(ScannerT, N), AttrT                            \
                >::type                                                         \
                do_parse_virtual(                                               \
                    HBOOST_PP_CAT(ScannerT, N) const& scan) const = 0;           \

        #define HBOOST_SPIRIT_ENUM_ABSTRACT_PARSERS(z, N, _)                     \
            template <                                                          \
                HBOOST_PP_ENUM_PARAMS_Z(z, HBOOST_PP_INC(N), typename ScannerT),  \
                typename AttrT                                                  \
            >                                                                   \
            struct abstract_parser<                                             \
                scanner_list<                                                   \
                    HBOOST_PP_ENUM_PARAMS_Z(z, HBOOST_PP_INC(N), ScannerT)        \
                >,                                                              \
                AttrT                                                           \
            >                                                                   \
            {                                                                   \
                ...
                virtual ~abstract_parser() {}                                   \
                                                                                \
                HBOOST_PP_REPEAT_ ## z(                                          \
                    HBOOST_PP_INC(N), HBOOST_SPIRIT_RULE_ENUM_DOPARSE_A, _)       \
                                                                                \
                virtual abstract_parser*                                        \
                clone() const = 0;                                              \
            };                                                                  \

        HBOOST_PP_REPEAT_FROM_TO(1, HBOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT,
            HBOOST_SPIRIT_ENUM_ABSTRACT_PARSERS, _)

        #undef HBOOST_SPIRIT_RULE_ENUM_DOPARSE_A
        #undef HBOOST_SPIRIT_ENUM_ABSTRACT_PARSERS
        ///////////////////////////////////////////////////////////////////////
        ...
        //
        ///////////////////////////////////////////////////////////////////////
        #define HBOOST_SPIRIT_RULE_ENUM_DOPARSE_C(z, N, _)                       \
                virtual typename match_result<                                  \
                    HBOOST_PP_CAT(ScannerT, N), AttrT                            \
                >::type                                                         \
                do_parse_virtual(                                               \
                    HBOOST_PP_CAT(ScannerT, N) const& scan) const                \
                { return p.parse(scan); }                                       \

        #define HBOOST_SPIRIT_ENUM_CONCRETE_PARSERS(z, N, _)                     \
            template <                                                          \
                typename ParserT,                                               \
                HBOOST_PP_ENUM_PARAMS_Z(z, HBOOST_PP_INC(N), typename ScannerT),  \
                typename AttrT                                                  \
            ...
            {                                                                   \
                ...
                virtual ~concrete_parser() {}                                   \
                                                                                \
                HBOOST_PP_REPEAT_ ## z(                                          \
                    HBOOST_PP_INC(N), HBOOST_SPIRIT_RULE_ENUM_DOPARSE_C, _)       \
                                                                                \
                virtual abstract_parser<                                        \
                    scanner_list<                                               \
                        HBOOST_PP_ENUM_PARAMS_Z(z, HBOOST_PP_INC(N), ScannerT)    \
        ...
        HBOOST_PP_REPEAT_FROM_TO(1, HBOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT,
            HBOOST_SPIRIT_ENUM_CONCRETE_PARSERS, _)

        #undef HBOOST_SPIRIT_ENUM_CONCRETE_PARSERS
        #undef HBOOST_SPIRIT_RULE_ENUM_DOPARSE_C
        ///////////////////////////////////////////////////////////////////////
