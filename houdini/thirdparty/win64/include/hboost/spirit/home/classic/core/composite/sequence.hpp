...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_SEQUENCE_HPP)
#define HBOOST_SPIRIT_SEQUENCE_HPP
...
#pragma warning(pop)
    ...
    struct sequence_parser_gen
    {
        ...
        {
            return sequence<HBOOST_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <hboost/spirit/home/classic/core/composite/impl/sequence.ipp>
