...
=============================================================================*/
#ifndef HBOOST_SPIRIT_EPSILON_HPP
#define HBOOST_SPIRIT_EPSILON_HPP

////////////////////////////////////////////////////////////////////////////////
#include <hboost/spirit/home/classic/namespace.hpp>
#include <hboost/spirit/home/classic/core/parser.hpp>
#include <hboost/spirit/home/classic/meta/parser_traits.hpp>
...
///////////////////////////////////////////////////////////////////////////////
    ...
    HBOOST_WORKAROUND(__SUNPRO_CC, <= 0x580)
...
// expressions of non-type template parameters in instantiations
    ...
    { return p.negate(); }
#else // HBOOST_WORKAROUND(HBOOST_MSVC, == 1310) || == 1400
    ...
    { return p.negate(); }
#endif // HBOOST_WORKAROUND(HBOOST_MSVC, == 1310) || == 1400
