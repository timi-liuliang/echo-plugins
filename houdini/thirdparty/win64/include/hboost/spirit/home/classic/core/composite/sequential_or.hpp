...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_SEQUENTIAL_OR_HPP)
#define HBOOST_SPIRIT_SEQUENTIAL_OR_HPP
...
HBOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct sequential_or_parser_gen
    {
        ...
        {
            return sequential_or<HBOOST_DEDUCED_TYPENAME as_parser<A>::type,
                HBOOST_DEDUCED_TYPENAME as_parser<B>::type>
...
#include <hboost/spirit/home/classic/core/composite/impl/sequential_or.ipp>
