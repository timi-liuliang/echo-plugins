...
=============================================================================*/
#ifndef HBOOST_SPIRIT_NUMERICS_HPP
#define HBOOST_SPIRIT_NUMERICS_HPP
...
#include <hboost/spirit/home/classic/core/primitives/numerics_fwd.hpp>
#include <hboost/spirit/home/classic/core/primitives/impl/numerics.ipp>
...
HBOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct ureal_parser_policies
    {
        ...
        HBOOST_STATIC_CONSTANT(bool, allow_leading_dot = true);
        HBOOST_STATIC_CONSTANT(bool, allow_trailing_dot = true);
        HBOOST_STATIC_CONSTANT(bool, expect_dot = false);
    ...
    {
        HBOOST_STATIC_CONSTANT(bool, expect_dot = true);
    };
