...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_PRIMITIVES_HPP)
#define HBOOST_SPIRIT_PRIMITIVES_HPP

#include <hboost/ref.hpp>
#include <hboost/spirit/home/classic/namespace.hpp>
#include <hboost/spirit/home/classic/core/assert.hpp>
#include <hboost/spirit/home/classic/core/parser.hpp>
#include <hboost/spirit/home/classic/core/composite/impl/directives.ipp>
#include <hboost/spirit/home/classic/core/primitives/impl/primitives.ipp>
...
HBOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct range : public char_parser<range<CharT> >
    {
        ...
        {
            HBOOST_SPIRIT_ASSERT(!(last < first));
        }
    ...
    public:
        ...
        parse(ScannerT const& scan) const
        {
            typedef typename hboost::unwrap_reference<IteratorT>::type striter_t;
