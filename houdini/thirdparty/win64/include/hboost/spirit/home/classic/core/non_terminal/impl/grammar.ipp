...
=============================================================================*/
#if !defined HBOOST_SPIRIT_GRAMMAR_IPP
#define HBOOST_SPIRIT_GRAMMAR_IPP

#if !defined(HBOOST_SPIRIT_SINGLE_GRAMMAR_INSTANCE)
#include <hboost/spirit/home/classic/core/non_terminal/impl/object_with_id.ipp>
#include <algorithm>
#include <functional>
...
#include <hboost/spirit/home/classic/core/non_terminal/impl/static.hpp>
...
struct grammar_definition
{
    ...
    struct grammar_helper : private grammar_helper_base<GrammarT>
    {
        ...
        typedef hboost::shared_ptr<helper_t> helper_ptr_t;
        typedef hboost::weak_ptr<helper_t>   helper_weak_ptr_t;
...
#ifdef HBOOST_SPIRIT_THREADSAFE
            hboost::unique_lock<hboost::mutex> lock(helpers.mutex());
#endif
...
#endif /* defined(HBOOST_SPIRIT_SINGLE_GRAMMAR_INSTANCE) */
...
# ifdef HBOOST_SPIRIT_THREADSAFE
        hboost::thread_specific_ptr<ptr_t> & tld_helper
            = static_<hboost::thread_specific_ptr<ptr_t>,
...
# if defined(HBOOST_INTEL_CXX_VERSION)
...
# endif
    ...
    public:
        ...
        parse(ScannerT const& scan) const
        {
            ...
            HBOOST_SPIRIT_CONTEXT_PARSE(scan, target_grammar, scanner_t,
                context_t, result_t)
        }
...
///////////////////////////////////////
#if !defined(HBOOST_SPIRIT_SINGLE_GRAMMAR_INSTANCE)
#define HBOOST_SPIRIT_GRAMMAR_ID , public impl::object_with_id<impl::grammar_tag>
#else
#define HBOOST_SPIRIT_GRAMMAR_ID
#endif

///////////////////////////////////////
#if !defined(HBOOST_SPIRIT_SINGLE_GRAMMAR_INSTANCE)
#define HBOOST_SPIRIT_GRAMMAR_STATE                            \
    private:                                                  \
