...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_PARSER_HPP)
#define HBOOST_SPIRIT_PARSER_HPP
...
HBOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    {
        typedef typename hboost::remove_reference<ParserT>::type parser_type;
...
#include <hboost/spirit/home/classic/core/impl/parser.ipp>
