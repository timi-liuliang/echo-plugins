...
=============================================================================*/
#ifndef HBOOST_SPIRIT_SWITCH_HPP
#define HBOOST_SPIRIT_SWITCH_HPP
...
//
///////////////////////////////////////////////////////////////////////////////
#if !defined(HBOOST_SPIRIT_DEFAULTCASE_MAGIC)
#define HBOOST_SPIRIT_DEFAULTCASE_MAGIC 0x15F97A7
#endif
...
//
///////////////////////////////////////////////////////////////////////////////
#if !defined(HBOOST_SPIRIT_SWITCH_CASE_LIMIT)
#define HBOOST_SPIRIT_SWITCH_CASE_LIMIT 3
#endif // !defined(HBOOST_SPIRIT_SWITCH_CASE_LIMIT)
...
///////////////////////////////////////////////////////////////////////////////
//
// Ensure   HBOOST_SPIRIT_SELECT_LIMIT > 0
//
///////////////////////////////////////////////////////////////////////////////
HBOOST_STATIC_ASSERT(HBOOST_SPIRIT_SWITCH_CASE_LIMIT > 0);
...
#include <hboost/spirit/home/classic/dynamic/impl/switch.ipp>
...
//  HBOOST_SPIRIT_SWITCH_CASE_LIMIT (this value defaults to 3 if not otherwise
//  defined).
//
///////////////////////////////////////////////////////////////////////////////
...
:   public unary<ParserT, parser<case_parser<N, ParserT, IsDefault> > >
{
    ...
    HBOOST_STATIC_CONSTANT(int, value = N);
    HBOOST_STATIC_CONSTANT(bool, is_default = IsDefault);
    HBOOST_STATIC_CONSTANT(bool, is_simple = true);
    HBOOST_STATIC_CONSTANT(bool, is_epsilon = (
        is_default && hboost::is_same<self_subject_t, epsilon_parser>::value
    ));
    ...
    operator, (case_parser<N1, ParserT1, IsDefault1> const &p) const
    {
        ...
        HBOOST_STATIC_ASSERT(!is_default || !IsDefault1);
...
:   public case_parser<HBOOST_SPIRIT_DEFAULTCASE_MAGIC, epsilon_parser, true>
{
    default_parser_gen()
    :   case_parser<HBOOST_SPIRIT_DEFAULTCASE_MAGIC, epsilon_parser, true>
            (epsilon_p)
    {}

    template <typename ParserT>
    case_parser<HBOOST_SPIRIT_DEFAULTCASE_MAGIC, ParserT, true>
    operator()(parser<ParserT> const &p) const
    {
        return case_parser<HBOOST_SPIRIT_DEFAULTCASE_MAGIC, ParserT, true>(p);
    }
};
...
#endif // HBOOST_SPIRIT_SWITCH_HPP
