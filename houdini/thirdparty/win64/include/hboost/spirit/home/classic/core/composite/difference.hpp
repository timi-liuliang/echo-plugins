...
=============================================================================*/
#if !defined(HBOOST_SPIRIT_DIFFERENCE_HPP)
#define HBOOST_SPIRIT_DIFFERENCE_HPP
...
#pragma warning(pop)
    ...
    struct difference_parser_gen
    {
        ...
        {
            return difference<HBOOST_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <hboost/spirit/home/classic/core/composite/impl/difference.ipp>
