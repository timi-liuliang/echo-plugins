 ...
 */
#ifndef HBOOST_SMART_PTR_DETAIL_ARRAY_COUNT_IMPL_HPP
#define HBOOST_SMART_PTR_DETAIL_ARRAY_COUNT_IMPL_HPP

#include <hboost/smart_ptr/detail/array_allocator.hpp>
