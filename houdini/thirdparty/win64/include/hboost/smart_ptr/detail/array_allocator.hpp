 ...
 */
#ifndef HBOOST_SMART_PTR_DETAIL_ARRAY_ALLOCATOR_HPP
#define HBOOST_SMART_PTR_DETAIL_ARRAY_ALLOCATOR_HPP

#include <hboost/align/align.hpp>
#include <hboost/smart_ptr/detail/array_traits.hpp>
#include <hboost/smart_ptr/detail/array_utility.hpp>
    ...
    namespace detail {
        ...
        public:
            ...
            pointer allocate(size_type count, const_void_pointer = 0) {
                enum {
                    M = hboost::alignment_of<type>::value
                };
                ...
                (void)hboost::alignment::align(M, n2, p2, n3);
