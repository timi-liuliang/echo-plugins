 ...
 */
#ifndef HBOOST_SMART_PTR_ALLOCATE_SHARED_ARRAY_HPP
#define HBOOST_SMART_PTR_ALLOCATE_SHARED_ARRAY_HPP
...
namespace hboost {
    ...
    allocate_shared(const A& allocator, std::size_t size) {
        ...
        typedef hboost::detail::ms_init_tag R1;
        typedef hboost::detail::as_allocator<A, T, R1> A1;
        ...
        hboost::detail::as_init(allocator, p2, n1);
#else
    ...
    allocate_shared(const A& allocator) {
        ...
        a2->set(0);
#if !defined(HBOOST_NO_CXX11_ALLOCATOR)
        hboost::detail::as_init(allocator, p2, N);
#else
    ...
    allocate_shared(const A& allocator, std::size_t size,
        ...
        a2->set(0);
#if !defined(HBOOST_NO_CXX11_ALLOCATOR)
        hboost::detail::as_init<T2, A, M>(allocator, p2, n1, p3);
#else
    ...
    allocate_shared(const A& allocator, 
        ...
        a2->set(0);
#if !defined(HBOOST_NO_CXX11_ALLOCATOR)
        hboost::detail::as_init<T2, A, M>(allocator, p2, N, p3);
#else
    ...
    allocate_shared_noinit(const A& allocator, std::size_t size) {
        typedef typename hboost::detail::array_inner<T>::type T1;
        typedef typename hboost::detail::array_base<T1>::type T2;
        typedef hboost::detail::ms_noinit_tag R1;
        typedef hboost::detail::as_allocator<A, T, R1> A1;
        typedef hboost::detail::ms_in_allocator_tag D1;
        std::size_t n1 = size * hboost::detail::array_total<T1>::size;
        T1* p1 = 0;
