...
#if !defined(HBOOST_CIRCULAR_BUFFER_DEBUG_HPP)
#define HBOOST_CIRCULAR_BUFFER_DEBUG_HPP
...
template <class T>
inline void do_fill_uninitialized_memory(T* data, std::size_t size_in_bytes) HBOOST_NOEXCEPT {
...
#endif // #if !defined(HBOOST_CIRCULAR_BUFFER_DEBUG_HPP)
