...
#ifndef HBOOST_SYSTEM_API_CONFIG_HPP                  
#define HBOOST_SYSTEM_API_CONFIG_HPP

# if defined(HBOOST_POSIX_API) || defined(HBOOST_WINDOWS_API)
#   error user defined HBOOST_POSIX_API or HBOOST_WINDOWS_API not supported
# endif

//  HBOOST_POSIX_API or HBOOST_WINDOWS_API specify which API to use
...
#   define HBOOST_WINDOWS_API
# else
#   define HBOOST_POSIX_API 
# endif
                                     
#endif  // HBOOST_SYSTEM_API_CONFIG_HPP 
