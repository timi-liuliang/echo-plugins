...
#ifndef HBOOST_VARIANT_VISITOR_PTR_HPP
#define HBOOST_VARIANT_VISITOR_PTR_HPP

#include "hboost/variant/bad_visit.hpp"
...
public: // structors
    ...
    explicit visitor_ptr_t(visitor_t visitor) HBOOST_NOEXCEPT
      : visitor_(visitor)
    {
    }
...
public: // static visitor interfaces
    ...
    {
        hboost::throw_exception(bad_visit());
    }
...
#endif// HBOOST_VISITOR_VISITOR_PTR_HPP
