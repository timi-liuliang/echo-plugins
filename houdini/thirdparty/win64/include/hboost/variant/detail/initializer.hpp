...
#ifndef HBOOST_VARIANT_DETAIL_INITIALIZER_HPP
#define HBOOST_VARIANT_DETAIL_INITIALIZER_HPP
...
struct make_initializer_node
{
    ...
    private: // helpers, for metafunction result (below)
        ...
        private: // helpers, for static functions (below)
            ...
            typedef hboost::is_reference<public_T> 
                is_reference_content_t;

            typedef typename hboost::mpl::if_<is_reference_content_t, public_T, const public_T& >::type 
                param_T;

            template <class T> struct disable_overload{};

            typedef typename hboost::mpl::if_<is_reference_content_t, disable_overload<public_T>, public_T&& >::type 
                param2_T;
#else
        ...
        public: // static functions
            ...
            {
                typedef typename hboost::detail::make_reference_content<
                      recursive_enabled_T
                    >::type internal_T;

                new(dest) internal_T(operand);
                return HBOOST_MPL_AUX_VALUE_WKND(index)::value; // which
            }
            ...
            static int initialize(void* dest, param2_T operand)
            {
                ...
                HBOOST_ASSERT(!is_reference_content_t::value);

                typedef typename hboost::mpl::if_<is_reference_content_t, param2_T, recursive_enabled_T>::type value_T;
                new(dest) value_T( hboost::detail::variant::move(operand) );
                return HBOOST_MPL_AUX_VALUE_WKND(index)::value; // which
            }
#endif
        };
...
public: // static functions
    ...
    // Obsolete. Remove.
    #define HBOOST_VARIANT_AUX_PP_INITIALIZER_TEMPLATE_PARAMS \
          HBOOST_VARIANT_ENUM_PARAMS(typename recursive_enabled_T) \
    /**/

    // Obsolete. Remove.
    #define HBOOST_VARIANT_AUX_PP_INITIALIZER_DEFINE_PARAM_T(N) \
        typedef typename unwrap_recursive< \
              HBOOST_PP_CAT(recursive_enabled_T,N) \
            >::type HBOOST_PP_CAT(public_T,N); \
        typedef typename call_traits< \
              HBOOST_PP_CAT(public_T,N) \
            >::param_type HBOOST_PP_CAT(param_T,N); \
    /**/

template < HBOOST_VARIANT_ENUM_PARAMS(typename recursive_enabled_T) >
struct preprocessor_list_initializer
{
public: // static functions

    #define HBOOST_VARIANT_AUX_PP_INITIALIZE_FUNCTION(z,N,_) \
        typedef typename unwrap_recursive< \
              HBOOST_PP_CAT(recursive_enabled_T,N) \
            >::type HBOOST_PP_CAT(public_T,N); \
        typedef typename call_traits< \
        ...
        static int initialize( \
              void* dest \
            , HBOOST_PP_CAT(param_T,N) operand \
            ) \
        { \
            typedef typename hboost::detail::make_reference_content< \
                  HBOOST_PP_CAT(recursive_enabled_T,N) \
    ...
    HBOOST_PP_REPEAT(
        ...
        , HBOOST_VARIANT_AUX_PP_INITIALIZE_FUNCTION
        , _
        )

    #undef HBOOST_VARIANT_AUX_PP_INITIALIZE_FUNCTION
...
///////////////////////////////////////////////////////////////////////////////
// macro HBOOST_VARIANT_AUX_INITIALIZER_T
//
...
#define HBOOST_VARIANT_AUX_INITIALIZER_T( mpl_seq, typename_base ) \
    ::hboost::mpl::iter_fold< \
          mpl_seq \
        , ::hboost::mpl::pair< \
              ::hboost::detail::variant::initializer_root \
            , ::hboost::mpl::int_<0> \
            > \
        , ::hboost::mpl::protect< \
              ::hboost::detail::variant::make_initializer_node \
            > \
        >::type::first \
    /**/
    ...
    // Obsolete. Remove.
    #define HBOOST_VARIANT_AUX_PP_INITIALIZER_TEMPLATE_ARGS(typename_base) \
          HBOOST_VARIANT_ENUM_PARAMS(typename_base) \
        /**/

#define HBOOST_VARIANT_AUX_INITIALIZER_T( mpl_seq, typename_base ) \
    ::hboost::detail::variant::preprocessor_list_initializer< \
          HBOOST_VARIANT_ENUM_PARAMS(typename_base) \
        > \
    /**/
...
#endif // HBOOST_VARIANT_DETAIL_INITIALIZER_HPP
