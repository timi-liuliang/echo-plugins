...
#ifndef HBOOST_VARIANT_DETAIL_APPLY_VISITOR_DELAYED_HPP
#define HBOOST_VARIANT_DETAIL_APPLY_VISITOR_DELAYED_HPP

#include "hboost/variant/detail/generic_result_type.hpp"

#include "hboost/variant/detail/apply_visitor_unary.hpp"
#include "hboost/variant/detail/apply_visitor_binary.hpp"
...
public: // structors
    ...
    explicit apply_visitor_delayed_t(Visitor& visitor) HBOOST_NOEXCEPT
      : visitor_(visitor)
    {
    }
    ...
    >::type apply_visitor(Visitor& visitor)
{
    ...
    && !defined(HBOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES)
...
public: // structors
    ...
    explicit apply_visitor_delayed_cpp14_t(Visitor& visitor) HBOOST_NOEXCEPT
      : visitor_(visitor)
    {
    }
...
template <typename Visitor>
inline  typename hboost::disable_if<
        hboost::detail::variant::has_result_type<Visitor>,
...
#endif // HBOOST_VARIANT_DETAIL_APPLY_VISITOR_DELAYED_HPP
