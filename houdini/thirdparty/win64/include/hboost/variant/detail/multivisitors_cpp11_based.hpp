...
#ifndef HBOOST_VARIANT_DETAIL_MULTIVISITORS_CPP11_BASED_HPP
#define HBOOST_VARIANT_DETAIL_MULTIVISITORS_CPP11_BASED_HPP
...
namespace detail { namespace variant {
    ...
    std::tuple<Types&...> forward_as_tuple_simple(Types&... args) HBOOST_NOEXCEPT
    {
    ...
    public: // visitor interfaces
        ...
        HBOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type) operator()(Value& value) const
        {
    ...
    public:
        ...
        HBOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type) do_call(Tuple t, index_sequence<I...>) const {
    ...
    inline HBOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(typename Visitor::result_type)
        apply_visitor(const Visitor& visitor, T1& v1, T2& v2, T3& v3, TN&... vn)
    {
        return ::hboost::apply_visitor(
            ::hboost::detail::variant::make_one_by_one_visitor_and_value_referer(
                visitor,
                ::hboost::detail::variant::forward_as_tuple_simple(v2, v3, vn...),
                std::tuple<>()
            ),
            v1
        );
...
#endif // HBOOST_VARIANT_DETAIL_MULTIVISITORS_CPP11_BASED_HPP
