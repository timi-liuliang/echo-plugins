...
#ifndef HBOOST_PTR_CONTAINER_PTR_UNORDERED_SET_HPP
#define HBOOST_PTR_CONTAINER_PTR_UNORDERED_SET_HPP
...
#include <hboost/ptr_container/ptr_set_adapter.hpp>
...
namespace hboost
{
    ...
    class ptr_unordered_set : 
        public ptr_set_adapter< Key, 
                                hboost::unordered_set<void*,void_ptr_indirect_fun<Hash,Key>,
    ...
    public:
        ...
        HBOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_unordered_set,
                                                      base_type,
                                                      this_type )
        
        HBOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS( ptr_unordered_set, 
                                                      base_type )
    ...
    class ptr_unordered_multiset : 
          public ptr_multiset_adapter< Key, 
                                hboost::unordered_multiset<void*,void_ptr_indirect_fun<Hash,Key>,
                                                                void_ptr_indirect_fun<Pred,Key>,Allocator>,
                                            CloneAllocator, false >
    {
    ...
    public:
        ...
        HBOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_unordered_multiset, 
                                                      base_type,
                                                      this_type )
         
        HBOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS( ptr_unordered_multiset, 
                                                      base_type )     
