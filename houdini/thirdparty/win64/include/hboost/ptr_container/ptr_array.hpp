...
#ifndef HBOOST_PTR_CONTAINER_PTR_ARRAY_HPP
#define HBOOST_PTR_CONTAINER_PTR_ARRAY_HPP
...
namespace hboost
{
    ...
    namespace ptr_container_detail
    {
        ...
        >
        class ptr_array_impl : public hboost::array<T,N>
        {
        public:
    ...
    private:
        ...
        typedef HBOOST_DEDUCED_TYPENAME remove_nullable<T>::type U;
    ...
    public:
        ...
        typedef HBOOST_DEDUCED_TYPENAME base_class::auto_type
                            auto_type;
    ...
    public: // compile-time interface
        ...
        auto_type replace( U* r ) // strong
        {
            ...
            return hboost::ptr_container::move(res);                // nothrow 
        }
        ...
        auto_type replace( size_t idx, U* r ) // strong
        {
            ...
            HBOOST_PTR_CONTAINER_THROW_EXCEPTION( idx >= N, bad_index,
