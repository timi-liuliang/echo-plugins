...
#ifndef HBOOST_PTR_CONTAINER_PTR_MAP_HPP
#define HBOOST_PTR_CONTAINER_PTR_MAP_HPP
...
namespace hboost
{
    ...
    public:
        ...
        HBOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_map, base_type, 
                                                      this_type )
    ...
    public:
        ...
        HBOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_multimap, 
                                                      base_type,
                                                      this_type )
