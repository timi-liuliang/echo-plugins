...
#ifndef HBOOST_PTR_CONTAINER_PTR_UNORDERED_MAP_HPP
#define HBOOST_PTR_CONTAINER_PTR_UNORDERED_MAP_HPP
...
#include <hboost/ptr_container/ptr_map_adapter.hpp>
...
namespace hboost
{
    ...
    < 
        class Key, 
        class T, 
        class Hash           = hboost::hash<Key>,
        class Pred           = std::equal_to<Key>,
        class CloneAllocator = heap_clone_allocator,
        class Allocator      = std::allocator< std::pair<const Key,void*> >
    >
    class ptr_unordered_map : 
        public ptr_map_adapter<T,hboost::unordered_map<Key,void*,Hash,Pred,Allocator>,
                               CloneAllocator,false>
    {
        typedef ptr_map_adapter<T,hboost::unordered_map<Key,void*,Hash,Pred,Allocator>,
                               CloneAllocator,false>
            base_type;
    ...
    public:
        ...
        HBOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_unordered_map, 
                                                      base_type, 
                                                      this_type )
    ...
    class ptr_unordered_multimap : 
        public ptr_multimap_adapter<T,hboost::unordered_multimap<Key,void*,Hash,Pred,Allocator>,
                                    CloneAllocator,false>
    {
        typedef ptr_multimap_adapter<T,hboost::unordered_multimap<Key,void*,Hash,Pred,Allocator>,
                                     CloneAllocator,false>
            base_type;
    ...
    public:
        ...
        HBOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_unordered_multimap, 
                                                      base_type, 
                                                      this_type )
