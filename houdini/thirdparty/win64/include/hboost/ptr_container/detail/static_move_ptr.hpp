...
// "http://aspn.activestate.com/ASPN/Mail/Message/Attachments/hboost/
...
#ifndef HBOOST_STATIC_MOVE_PTR_HPP_INCLUDED
#define HBOOST_STATIC_MOVE_PTR_HPP_INCLUDED

#include <hboost/config.hpp> // Member template friends, put size_t in std.
#include <cstddef>          // size_t
#include <hboost/compressed_pair.hpp> 
#include <hboost/ptr_container/detail/default_deleter.hpp>       
#include <hboost/ptr_container/detail/is_convertible.hpp>       
#include <hboost/ptr_container/detail/move.hpp>       
...
private:
    ...
    typedef hboost::compressed_pair<element_type*, Deleter> impl_type;
...
public:
    ...
    element_type& operator*() 
        { 
            /*HBOOST_STATIC_ASSERT(!is_array);*/ return *ptr(); 
        }
    ...
    void check(const static_move_ptr<TT, DD>& ptr)
        {
            ...
            HBOOST_STATIC_ASSERT(convertible::value);
        }   

#if defined(HBOOST_NO_FUNCTION_TEMPLATE_ORDERING) || defined(HBOOST_NO_SFINAE)
...
#endif // HBOOST_NO_FUNCTION_TEMPLATE_ORDERING || HBOOST_NO_SFINAE
...
#endif      // #ifndef HBOOST_STATIC_MOVE_PTR_HPP_INCLUDED
