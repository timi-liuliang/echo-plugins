...
#ifndef HBOOST_MOVE_PTR_ARRAYS_HPP_INCLUDED
#define HBOOST_MOVE_PTR_ARRAYS_HPP_INCLUDED
...
namespace hboost { namespace ptr_container_detail { namespace move_ptrs {
...
struct is_array_convertible {
    ...
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(2, is_array_convertible, (T, U))
};
...
#endif      // #ifndef HBOOST_MOVE_PTR_ARRAYS_HPP_INCLUDED
