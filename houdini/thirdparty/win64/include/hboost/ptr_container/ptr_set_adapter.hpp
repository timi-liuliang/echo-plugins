...
#ifndef HBOOST_PTR_CONTAINER_PTR_SET_ADAPTER_HPP
#define HBOOST_PTR_CONTAINER_PTR_SET_ADAPTER_HPP
...
namespace ptr_container_detail
{
    ...
    struct set_config
    {
       ...
       typedef HBOOST_DEDUCED_TYPENAME VoidPtrSet::allocator_type 
                    allocator_type;
       ...
       typedef void_ptr_iterator<
                       HBOOST_DEDUCED_TYPENAME VoidPtrSet::iterator, Key > 
                    iterator;

       typedef void_ptr_iterator<
                        HBOOST_DEDUCED_TYPENAME VoidPtrSet::const_iterator, const Key >
                    const_iterator;
       ...
       HBOOST_STATIC_CONSTANT(bool, allow_null = false );
    };
    ...
    public:
        ...
        bool transfer( HBOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator object, 
        ...
        template< class PtrSetAdapter >
        size_type 
        transfer( HBOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator first, 
                  HBOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator last, 
        ...
        HBOOST_DEDUCED_TYPENAME hboost::disable_if< hboost::is_same< Range,
                            HBOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator >,
                                                            size_type >::type
    ...
    public: // typedefs
        ...
        typedef HBOOST_DEDUCED_TYPENAME base_type::auto_type
                       auto_type;
        typedef HBOOST_DEDUCED_TYPENAME VoidPtrMultiSet::allocator_type
                       allocator_type;        
    private:
        template< typename II >                                               
        void set_basic_clone_and_insert( II first, II last ) // basic                 
    ...
    public:
        ...
        template< class PtrSetAdapter >
        void transfer( HBOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator object, 
                       PtrSetAdapter& from ) // strong
        {
        ...
        template< class PtrSetAdapter >
        size_type transfer( HBOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator first, 
                            HBOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator last, 
                            PtrSetAdapter& from ) // basic
        {
        ...
        template< class PtrSetAdapter, class Range >
        HBOOST_DEDUCED_TYPENAME hboost::disable_if< hboost::is_same< Range,
                       HBOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator >, size_type >::type
        transfer(  const Range& r, PtrSetAdapter& from ) // basic
        {
            return transfer( hboost::begin(r), hboost::end(r), from );
        }
