...
#ifndef HBOOST_PTR_CONTAINER_DETAIL_PTR_MAP_ADAPTER_HPP
#define HBOOST_PTR_CONTAINER_DETAIL_PTR_MAP_ADAPTER_HPP

#if defined(_MSC_VER) && (_MSC_VER >= 1200)
# pragma once
#endif

#include <hboost/ptr_container/detail/map_iterator.hpp>
#include <hboost/ptr_container/detail/associative_ptr_container.hpp>
#include <hboost/ptr_container/detail/meta_functions.hpp>
...
namespace ptr_container_detail
{
    ...
    struct map_config
    {
        ...
        typedef HBOOST_DEDUCED_TYPENAME VoidPtrMap::allocator_type
                     allocator_type;
       ...
       typedef HBOOST_DEDUCED_TYPENAME 
        ...
        typedef HBOOST_DEDUCED_TYPENAME VoidPtrMap::key_type
                     key_type;
        
        typedef U    value_type;

        typedef ptr_map_iterator< HBOOST_DEDUCED_TYPENAME VoidPtrMap::iterator, key_type, U* const >
                     iterator;
        
        typedef ptr_map_iterator< HBOOST_DEDUCED_TYPENAME VoidPtrMap::const_iterator, key_type, const U* const>
                     const_iterator;
    ...
    public:
        ...
        typedef HBOOST_DEDUCED_TYPENAME base_type::allocator_type
                    allocator_type;
        typedef HBOOST_DEDUCED_TYPENAME base_type::iterator
                    iterator;
        typedef HBOOST_DEDUCED_TYPENAME base_type::const_iterator
                    const_iterator;
        typedef HBOOST_DEDUCED_TYPENAME base_type::size_type
                    size_type;
        typedef HBOOST_DEDUCED_TYPENAME base_type::key_type
                    key_type;
        typedef HBOOST_DEDUCED_TYPENAME base_type::auto_type
                    auto_type;
        typedef HBOOST_DEDUCED_TYPENAME base_type::value_type 
                    mapped_type;
        typedef HBOOST_DEDUCED_TYPENAME base_type::reference
                    mapped_reference;
        typedef HBOOST_DEDUCED_TYPENAME base_type::const_reference
                    const_mapped_reference;
        typedef HBOOST_DEDUCED_TYPENAME iterator_value<iterator>::type
                    value_type;
        typedef value_type
                    reference;
        typedef HBOOST_DEDUCED_TYPENAME iterator_value<const_iterator>::type
                    const_reference;
        typedef value_type 
                    pointer;
    ...
    private:
        const_mapped_reference lookup( const key_type& key ) const
        {
           ...
           if( i != this->end() )
               ...
               HBOOST_PTR_CONTAINER_THROW_EXCEPTION( true, bad_ptr_container_operation,
    ...
    public:
        ...
        {                                                                            
            std::pair<HBOOST_DEDUCED_TYPENAME base_type::ptr_iterator,
                      HBOOST_DEDUCED_TYPENAME base_type::ptr_iterator>
        ...
        {                                                                            
            std::pair<HBOOST_DEDUCED_TYPENAME base_type::ptr_const_iterator,
                      HBOOST_DEDUCED_TYPENAME base_type::ptr_const_iterator> 
                p = this->base().equal_range( x ); 
        ...
        { 
            HBOOST_ASSERT( where != this->end() );

            this->enforce_null_policy( x, "Null pointer in 'replace()'" );

            auto_type ptr( x );

            HBOOST_PTR_CONTAINER_THROW_EXCEPTION( this->empty(),
            ...
            return hboost::ptr_container::move( old );
        }
    ...
    public:    
        ...
        typedef HBOOST_DEDUCED_TYPENAME VoidPtrMap::allocator_type 
                    allocator_type;
        typedef HBOOST_DEDUCED_TYPENAME base_type::mapped_type
                    mapped_type;
    private:

        void safe_insert( const key_type& key, auto_type ptr ) // strong
        {
            std::pair<HBOOST_DEDUCED_TYPENAME base_type::ptr_iterator,bool>
                res = 
    ...
    public:
        ...
        {
            insert( hboost::begin(r), hboost::end(r) );
        }
    ...
    public:
        ...
        bool transfer( HBOOST_DEDUCED_TYPENAME PtrMapAdapter::iterator object, 
        ...
        template< class PtrMapAdapter >
        size_type transfer( HBOOST_DEDUCED_TYPENAME PtrMapAdapter::iterator first, 
                            HBOOST_DEDUCED_TYPENAME PtrMapAdapter::iterator last, 
        ...
        HBOOST_DEDUCED_TYPENAME hboost::disable_if< hboost::is_same< Range,
                            HBOOST_DEDUCED_TYPENAME PtrMapAdapter::iterator >,
                                                            size_type >::type
        transfer( const Range& r, PtrMapAdapter& from ) // basic
        {
            return transfer( hboost::begin(r), hboost::end(r), from );
        }
  ...
  /////////////////////////////////////////////////////////////////////////
    ...
    public: // typedefs
        ...
        typedef HBOOST_DEDUCED_TYPENAME base_type::auto_type
                    auto_type;            
        typedef HBOOST_DEDUCED_TYPENAME VoidPtrMultiMap::allocator_type 
                    allocator_type;
    private:
    ...
    public:
        ...
        template< class PtrMapAdapter >
        void transfer( HBOOST_DEDUCED_TYPENAME PtrMapAdapter::iterator object, 
                       PtrMapAdapter& from ) // strong
        {
