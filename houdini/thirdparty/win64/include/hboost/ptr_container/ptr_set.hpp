...
#ifndef HBOOST_PTR_CONTAINER_PTR_SET_HPP
#define HBOOST_PTR_CONTAINER_PTR_SET_HPP
...
namespace hboost
{
    ...
    public:
        ...
        HBOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_set,
                                                      base_type,
                                                      this_type )
        
        HBOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS( ptr_set, base_type )
    ...
    public:
        ...
        HBOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_multiset, 
                                                      base_type,
                                                      this_type )
        
        HBOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS( ptr_multiset, 
                                                      base_type )     
