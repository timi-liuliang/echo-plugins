...
#ifndef HBOOST_PTR_CONTAINER_PTR_CIRCULAR_BUFFER_HPP
#define HBOOST_PTR_CONTAINER_PTR_CIRCULAR_BUFFER_HPP

#if defined(_MSC_VER) && (_MSC_VER >= 1200)
# pragma once
#endif

#include <hboost/circular_buffer.hpp>
#include <hboost/ptr_container/ptr_sequence_adapter.hpp>
...
namespace hboost
{
    ...
    class ptr_circular_buffer : public 
        ptr_sequence_adapter< T, 
                              hboost::circular_buffer<void*,Allocator>, 
                              CloneAllocator >
    {  
        ...
        typedef hboost::circular_buffer<void*,Allocator>         circular_buffer_type;
    ...
    public: // constructors
        ...
        HBOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_circular_buffer,
                                                      base_type, this_type )
    ...
    public: // circular buffer functions
        ...
        {
            rinsert( before, hboost::begin(r), hboost::end(r) );
        }
        ...
        {
            return rerase( hboost::begin(r), hboost::end(r) );
        }
    ...
    public: // transfer        
                       ...
                       PtrSeqAdapter& from ) // nothrow
        {
            ...
            if( from.empty() )
                return;
            for( HBOOST_DEDUCED_TYPENAME PtrSeqAdapter::iterator begin = first; 
