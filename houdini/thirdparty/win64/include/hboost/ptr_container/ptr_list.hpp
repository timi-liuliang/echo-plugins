...
#ifndef HBOOST_PTR_CONTAINER_PTR_LIST_HPP
#define HBOOST_PTR_CONTAINER_PTR_LIST_HPP
...
namespace hboost
{
    ...
    public:
        HBOOST_PTR_CONTAINER_DEFINE_SEQEUENCE_MEMBERS( ptr_list, 
                                                      base_class,
                                                      this_type )

        typedef HBOOST_DEDUCED_TYPENAME base_class::value_type value_type;
    ...
    public:
        ...
        {
            this->base().remove_if( HBOOST_DEDUCED_TYPENAME base_class:: 
                    HBOOST_NESTED_TEMPLATE void_ptr_delete_if<Pred,value_type>
                                    (pred) );
        } 
