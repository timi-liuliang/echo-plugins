...
#ifndef HBOOST_MULTI_INDEX_MEMBER_HPP
#define HBOOST_MULTI_INDEX_MEMBER_HPP
...
/* HBOOST_MULTI_INDEX_MEMBER resolves to member in the normal cases,
 * and to member_offset as a workaround in those defective compilers for
 * which HBOOST_NO_POINTER_TO_MEMBER_TEMPLATE_PARAMETERS is defined.
 */

#if defined(HBOOST_NO_POINTER_TO_MEMBER_TEMPLATE_PARAMETERS)
#define HBOOST_MULTI_INDEX_MEMBER(Class,Type,MemberName) \
::hboost::multi_index::member_offset< Class,Type,offsetof(Class,MemberName) >
#else
#define HBOOST_MULTI_INDEX_MEMBER(Class,Type,MemberName) \
::hboost::multi_index::member< Class,Type,&Class::MemberName >
#endif
