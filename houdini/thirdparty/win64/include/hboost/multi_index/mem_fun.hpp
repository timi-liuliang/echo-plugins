...
#ifndef HBOOST_MULTI_INDEX_MEM_FUN_HPP
#define HBOOST_MULTI_INDEX_MEM_FUN_HPP
...
/* HBOOST_MULTI_INDEX_CONST_MEM_FUN and HBOOST_MULTI_INDEX_MEM_FUN used to
...
#define HBOOST_MULTI_INDEX_CONST_MEM_FUN(Class,Type,MemberFunName) \
::hboost::multi_index::const_mem_fun< Class,Type,&Class::MemberFunName >
#define HBOOST_MULTI_INDEX_MEM_FUN(Class,Type,MemberFunName) \
::hboost::multi_index::mem_fun< Class,Type,&Class::MemberFunName >
