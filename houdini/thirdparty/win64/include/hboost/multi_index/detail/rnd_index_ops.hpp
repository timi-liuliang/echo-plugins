...
#ifndef HBOOST_MULTI_INDEX_DETAIL_RND_INDEX_OPS_HPP
#define HBOOST_MULTI_INDEX_DETAIL_RND_INDEX_OPS_HPP
...
void random_access_index_inplace_merge(
  ...
  HBOOST_DEDUCED_TYPENAME Node::impl_ptr_pointer first1,Compare comp)
{
  typedef typename Node::value_type       value_type;
