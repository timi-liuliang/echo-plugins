...
#ifndef HBOOST_MULTI_INDEX_DETAIL_ORD_INDEX_IMPL_HPP
#define HBOOST_MULTI_INDEX_DETAIL_ORD_INDEX_IMPL_HPP
...
#include <hboost/multi_index/detail/ord_index_node.hpp>
#include <hboost/multi_index/detail/ord_index_ops.hpp>
...
#include <hboost/multi_index/detail/value_compare.hpp>
#include <hboost/multi_index/detail/vartempl_support.hpp>
#include <hboost/multi_index/detail/ord_index_impl_fwd.hpp>
...
#include <hboost/multi_index/detail/duplicates_iterator.hpp>
#include <hboost/throw_exception.hpp> 
#endif

#if defined(HBOOST_MULTI_INDEX_ENABLE_INVARIANT_CHECKING)
#define HBOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT_OF(x)                    \
...
#define HBOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT                          \
  HBOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT_OF(*this)
#else
#define HBOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT_OF(x)
#define HBOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT
#endif
...
public:
  ...
  iterator
    begin()HBOOST_NOEXCEPT{return make_iterator(leftmost());}
  const_iterator
    begin()const HBOOST_NOEXCEPT{return make_iterator(leftmost());}
  iterator
  ...
  {
    HBOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT;
  ...
  {
    HBOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT;
    HBOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT_OF(x);
...
HBOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
   ...
   * in HBOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT. Actually,
...
public:
  ...
  ordered_index& operator=(
    std::initializer_list<HBOOST_DEDUCED_TYPENAME super::value_type> list)
  {
    this->final()=list;
    return *this;
  }
...
inline hboost::mpl::true_* hboost_foreach_is_noncopyable(
  hboost::multi_index::detail::ordered_index<
    KeyFromValue,Compare,SuperMeta,TagList,Category,AugmentPolicy>*&,
...
#undef HBOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT
#undef HBOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT_OF
