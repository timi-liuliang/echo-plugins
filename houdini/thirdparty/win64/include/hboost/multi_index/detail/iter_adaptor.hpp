...
#ifndef HBOOST_MULTI_INDEX_DETAIL_ITER_ADAPTOR_HPP
#define HBOOST_MULTI_INDEX_DETAIL_ITER_ADAPTOR_HPP
...
/* Poor man's version of hboost::iterator_adaptor. Used instead of the
