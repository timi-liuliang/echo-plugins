...
#ifndef HBOOST_MULTI_INDEX_DETAIL_HASH_INDEX_ARGS_HPP
#define HBOOST_MULTI_INDEX_DETAIL_HASH_INDEX_ARGS_HPP
 ...
 *     KeyFromValue,
 *     Hash=hboost::hash<KeyFromValue::result_type>,
...
{
  typedef ::hboost::hash<typename KeyFromValue::result_type> type;
};
...
struct hashed_index_args
{
  ...
  HBOOST_STATIC_ASSERT(is_tag<tag_list_type>::value);
  HBOOST_STATIC_ASSERT(!mpl::is_na<key_from_value_type>::value);
  HBOOST_STATIC_ASSERT(!mpl::is_na<hash_type>::value);
  HBOOST_STATIC_ASSERT(!mpl::is_na<pred_type>::value);
};
