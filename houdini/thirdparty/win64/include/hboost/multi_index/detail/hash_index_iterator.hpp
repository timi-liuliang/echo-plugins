...
#ifndef HBOOST_MULTI_INDEX_DETAIL_HASH_INDEX_ITERATOR_HPP
#define HBOOST_MULTI_INDEX_DETAIL_HASH_INDEX_ITERATOR_HPP
...
template<typename Node,typename BucketArray,typename Category>
struct version<
  hboost::multi_index::detail::hashed_index_iterator<Node,BucketArray,Category>
>
{
