...
#ifndef HBOOST_MULTI_INDEX_DETAIL_RNK_INDEX_OPS_HPP
#define HBOOST_MULTI_INDEX_DETAIL_RNK_INDEX_OPS_HPP
...
inline std::size_t ranked_index_find_rank(
  ...
  const HBOOST_DEDUCED_TYPENAME KeyFromValue::result_type& x,
