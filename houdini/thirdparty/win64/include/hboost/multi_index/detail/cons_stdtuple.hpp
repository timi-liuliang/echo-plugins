...
#ifndef HBOOST_MULTI_INDEX_DETAIL_CONS_STDTUPLE_HPP
#define HBOOST_MULTI_INDEX_DETAIL_CONS_STDTUPLE_HPP
...
/* std::tuple wrapper providing the cons-based interface of hboost::tuple for
...
{
  typedef hboost::tuples::null_type result_type;

  template<typename StdTuple>
  static result_type create(const StdTuple&)
  {
    return hboost::tuples::null_type();
  }
};
