...
#ifndef HBOOST_MULTI_INDEX_DETAIL_UINTPTR_TYPE_HPP
#define HBOOST_MULTI_INDEX_DETAIL_UINTPTR_TYPE_HPP
...
template<>struct uintptr_candidates<3> {typedef hboost::ulong_long_type type;};
#else
...
struct uintptr_aux
{
  HBOOST_STATIC_CONSTANT(int,index=
  ...
  HBOOST_STATIC_CONSTANT(bool,has_uintptr_type=(index>=0));
