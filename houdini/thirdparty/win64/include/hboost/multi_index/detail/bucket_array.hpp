...
#ifndef HBOOST_MULTI_INDEX_DETAIL_BUCKET_ARRAY_HPP
#define HBOOST_MULTI_INDEX_DETAIL_BUCKET_ARRAY_HPP
...
#include <hboost/multi_index/detail/hash_index_node.hpp>
...
#define HBOOST_MULTI_INDEX_BA_SIZES_32BIT                                  \
...
#define HBOOST_MULTI_INDEX_BA_SIZES                                         \
HBOOST_MULTI_INDEX_BA_SIZES_32BIT                                           \
(4294967291ul)
#else
...
protected:
  static const std::size_t sizes[
    HBOOST_PP_SEQ_SIZE(HBOOST_MULTI_INDEX_BA_SIZES)];
...
#define HBOOST_MULTI_INDEX_BA_POSITION_CASE(z,n,_)                    \
  case n:return hash%HBOOST_PP_SEQ_ELEM(n,HBOOST_MULTI_INDEX_BA_SIZES);
  ...
  static std::size_t position(std::size_t hash,std::size_t size_index_)
  {
    ...
    switch(size_index_){
      ...
      HBOOST_PP_REPEAT(
        HBOOST_PP_SEQ_SIZE(HBOOST_MULTI_INDEX_BA_SIZES),
        HBOOST_MULTI_INDEX_BA_POSITION_CASE,~)
    }
  }
...
const std::size_t bucket_array_base<_>::sizes[]={
  HBOOST_PP_SEQ_ENUM(HBOOST_MULTI_INDEX_BA_SIZES)
};
...
#undef HBOOST_MULTI_INDEX_BA_POSITION_CASE
#undef HBOOST_MULTI_INDEX_BA_SIZES
#undef HBOOST_MULTI_INDEX_BA_SIZES_32BIT
...
inline void load_construct_data(
  Archive&,hboost::multi_index::detail::bucket_array<Allocator>*,
  const unsigned int)
{
  throw_exception(
