...
#ifndef HBOOST_MULTI_INDEX_DETAIL_IS_TRANSPARENT_HPP
#define HBOOST_MULTI_INDEX_DETAIL_IS_TRANSPARENT_HPP
...
#if !defined(HBOOST_NO_SFINAE)&&!defined(HBOOST_NO_SFINAE_EXPR)&& \
    !defined(HBOOST_NO_CXX11_DECLTYPE)&& \
    (defined(HBOOST_NO_CXX11_FINAL)||defined(HBOOST_IS_FINAL))
