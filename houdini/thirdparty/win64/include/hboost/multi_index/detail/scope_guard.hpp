...
#ifndef HBOOST_MULTI_INDEX_DETAIL_SCOPE_GUARD_HPP
#define HBOOST_MULTI_INDEX_DETAIL_SCOPE_GUARD_HPP
 ...
 *     will work even if HBOOST_NO_MEMBER_TEMPLATES is defined. This forces
...
{
    typedef typename hboost::mpl::if_c<cond,T,null_guard>::type type;
};
