...
#ifndef HBOOST_MULTI_INDEX_DETAIL_PROMOTES_ARG_HPP
#define HBOOST_MULTI_INDEX_DETAIL_PROMOTES_ARG_HPP
...
#if !defined(HBOOST_IS_CONVERTIBLE)
...
#include <hboost/multi_index/detail/is_transparent.hpp>
...
#endif /* defined(HBOOST_IS_CONVERTIBLE) */
#endif
