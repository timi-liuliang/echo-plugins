...
#ifndef HBOOST_MULTI_INDEX_DETAIL_SEQ_INDEX_OPS_HPP
#define HBOOST_MULTI_INDEX_DETAIL_SEQ_INDEX_OPS_HPP
...
void sequenced_index_collate(
  HBOOST_DEDUCED_TYPENAME Node::impl_type* x,
  HBOOST_DEDUCED_TYPENAME Node::impl_type* y,
  Compare comp)
{
