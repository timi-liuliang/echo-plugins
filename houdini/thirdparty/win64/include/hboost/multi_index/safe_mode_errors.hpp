...
#ifndef HBOOST_MULTI_INDEX_SAFE_MODE_ERRORS_HPP
#define HBOOST_MULTI_INDEX_SAFE_MODE_ERRORS_HPP
 ...
 * HBOOST_MULTI_INDEX_SAFE_MODE_ASSERT prior to the inclusion of
