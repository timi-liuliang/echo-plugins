#ifndef HBOOST_DATE_TIME_POSIX_TIME_IO_HPP__
#define HBOOST_DATE_TIME_POSIX_TIME_IO_HPP__
...
#include <hboost/date_time/time_facet.hpp>
#include <hboost/date_time/period_formatter.hpp>
#include <hboost/date_time/posix_time/ptime.hpp>
#include <hboost/date_time/posix_time/time_period.hpp>
#include <hboost/date_time/posix_time/posix_time_duration.hpp>
#include <hboost/date_time/posix_time/conversion.hpp> // to_tm will be needed in the facets
...
namespace posix_time {
  ...
  //typedef hboost::date_time::time_facet<ptime, wchar_t> wptime_facet;
  //! ptime_facet is depricated and will be phased out. use time_facet instead
  //typedef hboost::date_time::time_facet<ptime, char>     ptime_facet;

  //! wptime_input_facet is depricated and will be phased out. use wtime_input_facet instead
  //typedef hboost::date_time::time_input_facet<ptime,wchar_t> wptime_input_facet;
  //! ptime_input_facet is depricated and will be phased out. use time_input_facet instead
  //typedef hboost::date_time::time_input_facet<ptime,char>     ptime_input_facet;

  typedef hboost::date_time::time_facet<ptime, wchar_t>     wtime_facet;
  typedef hboost::date_time::time_facet<ptime, char>         time_facet;

  typedef hboost::date_time::time_input_facet<ptime, wchar_t>     wtime_input_facet;
  typedef hboost::date_time::time_input_facet<ptime, char>         time_input_facet;
  ...
  operator<<(std::basic_ostream<CharT, TraitsT>& os,
    ...
    typedef hboost::date_time::time_facet<ptime, CharT> custom_ptime_facet;
  ...
  std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os,
             const hboost::posix_time::time_period& p) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::time_facet<ptime, CharT> custom_ptime_facet;
    std::ostreambuf_iterator<CharT> oitr(os);
    if (std::has_facet<custom_ptime_facet>(os.getloc())) {
...
#endif // HBOOST_DATE_TIME_POSIX_TIME_IO_HPP__
