#ifndef HBOOST_DATE_DURATION_OPERATORS_HPP___
#define HBOOST_DATE_DURATION_OPERATORS_HPP___
...
namespace posix_time {
  ...
  inline
  ptime 
  operator+(const ptime& t, const hboost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const hboost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+(const ptime& t, const hboost::gregorian::years& y)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const hboost::gregorian::years& y)
  {
    return t += y.get_offset(t.date());
  }
...
#endif // HBOOST_DATE_DURATION_OPERATORS_HPP___
