#ifndef HBOOST_POSIX_TIME_CONFIG_HPP___
#define HBOOST_POSIX_TIME_CONFIG_HPP___
...
#include <hboost/date_time/time_duration.hpp>
#include <hboost/date_time/time_resolution_traits.hpp>
#include <hboost/date_time/gregorian/gregorian_types.hpp>
#include <hboost/date_time/wrapping_int.hpp>
...
//#define HBOOST_GDTL_POSIX_TIME_STD_CONFIG

#ifdef HBOOST_DATE_TIME_POSIX_TIME_STD_CONFIG
  // set up conditional test compilations
#define HBOOST_DATE_TIME_HAS_MILLISECONDS
#define HBOOST_DATE_TIME_HAS_MICROSECONDS
#define HBOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<hboost::date_time::time_resolution_traits_adapted64_impl, hboost::date_time::nano,
    1000000000, 9 > time_res_traits;
#else
  // set up conditional test compilations
#define HBOOST_DATE_TIME_HAS_MILLISECONDS
#define HBOOST_DATE_TIME_HAS_MICROSECONDS
#undef  HBOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<
    hboost::date_time::time_resolution_traits_adapted64_impl, hboost::date_time::micro,
                                            1000000, 6 > time_res_traits;


// #undef HBOOST_DATE_TIME_HAS_MILLISECONDS
// #undef HBOOST_DATE_TIME_HAS_MICROSECONDS
// #undef HBOOST_DATE_TIME_HAS_NANOSECONDS
//   typedef date_time::time_resolution_traits<hboost::int64_t, hboost::date_time::tenth,
//                                              10, 0 > time_res_traits;
  ...
  public:
    ...
    time_duration(hboost::date_time::special_values sv) :
...
#if (defined(HBOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    HBOOST_STATIC_CONSTANT(hboost::int64_t, tick_per_second = 1000000000);
#endif
  };
  ...
  {
   public:
    typedef hboost::int64_t time_rep_type;
...
#if (defined(HBOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    HBOOST_STATIC_CONSTANT(hboost::int64_t, tick_per_second = 1000000);
#endif
  };
