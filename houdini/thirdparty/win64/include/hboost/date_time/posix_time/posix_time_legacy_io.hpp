#ifndef HBOOST_POSIX_TIME_PRE133_OPERATORS_HPP___
#define HBOOST_POSIX_TIME_PRE133_OPERATORS_HPP___
...
//The following code is removed for configurations with poor std::locale support (eg: MSVC6, gcc 2.9x)
  ...
  {
    typedef hboost::date_time::ostream_time_duration_formatter<time_duration, charT> duration_formatter;
  ...
  {
    typedef hboost::date_time::ostream_time_formatter<ptime, charT> time_formatter;
  ...
  {
    typedef hboost::date_time::ostream_time_period_formatter<time_period, charT> period_formatter;
...
#endif //HBOOST_DATE_TIME_NO_LOCALE

} } // namespaces

#endif // HBOOST_POSIX_TIME_PRE133_OPERATORS_HPP___
