#ifndef HBOOST_DATE_TIME_PERIOD_HPP___
#define HBOOST_DATE_TIME_PERIOD_HPP___
...
namespace date_time {
  ...
  class period : private
      hboost::less_than_comparable<period<point_rep, duration_rep> 
    , hboost::equality_comparable< period<point_rep, duration_rep> 
    > >
  {
  public:
