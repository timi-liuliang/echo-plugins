#ifndef HBOOST_DATE_TIME_HIGHRES_TIME_CLOCK_HPP___
#define HBOOST_DATE_TIME_HIGHRES_TIME_CLOCK_HPP___
...
#ifdef HBOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK
...
namespace date_time {
  ...
  private:
    ...
    {
#ifdef HBOOST_HAS_GETTIMEOFDAY
      timeval tv;
      gettimeofday(&tv, 0); //gettimeofday does not support TZ adjust on Linux.
      std::time_t t = tv.tv_sec;
      hboost::uint32_t sub_sec = tv.tv_usec;
#elif defined(HBOOST_HAS_FTIME)
      winapi::file_time ft;
      ...
      hboost::uint32_t sub_sec = static_cast<hboost::uint32_t>(micros % 1000000UL);
#else
#error Internal Boost.DateTime error: HBOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK is defined, however neither gettimeofday nor FILETIME support is detected.
#endif
...
#endif //HBOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK
