...
namespace hboost {
  namespace date_time {
    ...
    /*! This class is used to configure dst_calc_engine template typically
        as follows:
        @code
          using namespace hboost::gregorian;
          using namespace hboost::posix_time;
          typedef us_dst_trait<date> us_dst_traits;
          typedef hboost::date_time::dst_calc_engine<date, time_duration, 
                                                    us_dst_traits>  
                                                    us_dst_calc;
          ...
          if (us_dst::local_is_dst(t.date(), t.time_of_day()) 
              == hboost::date_time::is_not_in_dst) 
          {
