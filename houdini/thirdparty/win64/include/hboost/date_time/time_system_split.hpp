#ifndef HBOOST_DATE_TIME_TIME_SYSTEM_SPLIT_HPP
#define HBOOST_DATE_TIME_TIME_SYSTEM_SPLIT_HPP
...
#if (defined(HBOOST_DATE_TIME_NO_MEMBER_INIT))  
  template<typename config, hboost::int32_t ticks_per_second>
#else
...
#else
   private:
     HBOOST_STATIC_CONSTANT(int_type, ticks_per_day = INT64_C(86400) * config::tick_per_second);
   public:
