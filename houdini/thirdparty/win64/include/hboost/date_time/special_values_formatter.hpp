...
#ifndef HBOOST_DATETIME_SPECIAL_VALUE_FORMATTER_HPP___
#define HBOOST_DATETIME_SPECIAL_VALUE_FORMATTER_HPP___
...
namespace hboost { namespace date_time {
  ...
  public:
    ...
    OutItrT put_special(OutItrT next, 
                        const hboost::date_time::special_values& value) const 
    {
