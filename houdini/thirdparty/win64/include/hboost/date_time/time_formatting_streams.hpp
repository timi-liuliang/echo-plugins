#ifndef HBOOST_DATE_TIME_TIME_FORMATTING_STREAMS_HPP___
#define HBOOST_DATE_TIME_TIME_FORMATTING_STREAMS_HPP___
...
#include <iomanip>
#include <iostream>
#include <hboost/date_time/date_formatting_locales.hpp>
