#ifndef HBOOST_DATE_TIME_STRING_PARSE_TREE___HPP__
#define HBOOST_DATE_TIME_STRING_PARSE_TREE___HPP__
...
#include "hboost/lexical_cast.hpp" //error without?
...
struct string_parse_tree
{
  ...
  string_parse_tree(collection_type names, unsigned int starting_point=0)
  {
    ...
    while (index != names.size() ) {
      string_type s = hboost::algorithm::to_lower_copy(names[index]);
