#ifndef HBOOST_DATE_TIME_DATE_DURATION__
#define HBOOST_DATE_TIME_DATE_DURATION__
...
namespace date_time {
  ...
  class date_duration : private
              hboost::less_than_comparable1< date_duration< duration_rep_traits >
            , hboost::equality_comparable1< date_duration< duration_rep_traits >
            , hboost::addable1< date_duration< duration_rep_traits >
            , hboost::subtractable1< date_duration< duration_rep_traits >
            , hboost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef hboost::date_time::int_adapter<long> impl_type;
