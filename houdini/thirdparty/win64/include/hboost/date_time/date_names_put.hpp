#ifndef HBOOST_DATE_TIME_DATE_NAMES_PUT_HPP___
#define HBOOST_DATE_TIME_DATE_NAMES_PUT_HPP___
...
#include "hboost/date_time/locale_config.hpp" // set HBOOST_DATE_TIME_NO_LOCALE
...
namespace date_time {
    ...
    protected:
      ...
      {
        string_type s1(hboost::lexical_cast<string_type>(s));
