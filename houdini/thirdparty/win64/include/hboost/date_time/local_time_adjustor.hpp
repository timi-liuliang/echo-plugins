...
#include <hboost/date_time/time_defs.hpp> // hboost::date_time::dst_flags
#include <hboost/date_time/special_defs.hpp> // not_a_date_time
  ...
  namespace date_time {
    ...
    public:
      ...
      static time_duration_type utc_to_local_offset(const time_type& t)
      {
        ...
        hboost::throw_exception(std::out_of_range("Unreachable case"));
        HBOOST_DATE_TIME_UNREACHABLE_EXPRESSION(return time_duration_type(not_a_date_time)); // should never reach
      }
                                                    ...
                                                    date_time::dst_flags dst=date_time::calculate) 
      {
        ...
        hboost::throw_exception(std::out_of_range("Time label invalid"));
        HBOOST_DATE_TIME_UNREACHABLE_EXPRESSION(return time_duration_type(not_a_date_time)); // should never reach
      }
