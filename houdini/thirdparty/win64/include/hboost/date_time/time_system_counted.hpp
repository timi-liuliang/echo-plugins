#ifndef HBOOST_DATE_TIME_TIME_SYSTEM_COUNTED_HPP
#define HBOOST_DATE_TIME_TIME_SYSTEM_COUNTED_HPP
...
namespace date_time {
  ...
  struct counted_time_rep
  {
    ...
    {
      /* resolution_traits::as_number returns a hboost::int64_t & 
       * frac_sec_per_day is also a hboost::int64_t so, naturally, 
       * the division operation returns a hboost::int64_t. 
