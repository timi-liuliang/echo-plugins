#ifndef HBOOST_DATE_TIME_TIME_RESOLUTION_TRAITS_HPP
#define HBOOST_DATE_TIME_TIME_RESOLUTION_TRAITS_HPP
...
#include <hboost/date_time/int_adapter.hpp>
...
namespace date_time {
  ...
  struct time_resolution_traits_bi32_impl {
    typedef hboost::int32_t int_type;
    typedef hboost::int32_t impl_type;
  ...
  struct time_resolution_traits_adapted32_impl {
    typedef hboost::int32_t int_type;
    typedef hboost::date_time::int_adapter<hboost::int32_t> impl_type;
  ...
  struct time_resolution_traits_bi64_impl {
    typedef hboost::int64_t int_type;
    typedef hboost::int64_t impl_type;
    static int_type as_number(impl_type i){ return i;}
    //! Used to determine if implemented type is int_adapter or int
    static bool is_adapted() { return false;}
  };
  ...
  struct time_resolution_traits_adapted64_impl {
    typedef hboost::int64_t int_type;
    typedef hboost::date_time::int_adapter<hboost::int64_t> impl_type;
    static int_type as_number(impl_type i){ return i.as_number();}
    //! Used to determine if implemented type is int_adapter or int
    static bool is_adapted() { return true;}
  };
  ...
  template<typename frac_sec_type,
           ...
           hboost::int64_t resolution_adjust,
#else
           typename frac_sec_type::int_type resolution_adjust,
#endif
           unsigned short frac_digits,
           typename var_type = hboost::int32_t >
...
#if (defined(HBOOST_MSVC) && (_MSC_VER < 1300))
    HBOOST_STATIC_CONSTANT(hboost::int64_t, ticks_per_second = resolution_adjust);
#else
    HBOOST_STATIC_CONSTANT(fractional_seconds_type, ticks_per_second = resolution_adjust);
#endif
