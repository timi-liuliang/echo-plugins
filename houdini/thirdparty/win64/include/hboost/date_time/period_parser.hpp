...
#ifndef HBOOST_DATETIME_PERIOD_PARSER_HPP___
#define HBOOST_DATETIME_PERIOD_PARSER_HPP___
...
namespace hboost { namespace date_time {
  ...
  private:
                       ...
                       const string_type& delim) const
    {
      ...
      if(s != delim) {
        hboost::throw_exception(std::ios_base::failure("Parse failed. Expected '"
...
#endif // HBOOST_DATETIME_PERIOD_PARSER_HPP___
