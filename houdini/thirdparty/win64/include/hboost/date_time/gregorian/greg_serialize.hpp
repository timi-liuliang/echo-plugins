...
// NOTE: these macros define template functions in the hboost::serialization namespace.
// They must be expanded *outside* of any namespace
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::date_duration)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::date_duration::duration_rep)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::date_period)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::greg_year)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::greg_month)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::greg_day)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::greg_weekday)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::partial_date)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::nth_kday_of_month)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::first_kday_of_month)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::last_kday_of_month)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::first_kday_before)
HBOOST_SERIALIZATION_SPLIT_FREE(::hboost::gregorian::first_kday_after)
          ...
          unsigned int /*version*/)
{
  ...
  ar & make_nvp("date", ds);
  try{
    d = ::hboost::gregorian::from_undelimited_string(ds);
