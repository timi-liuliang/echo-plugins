#ifndef HBOOST_DATE_TIME_GREGORIAN_IO_HPP__
#define HBOOST_DATE_TIME_GREGORIAN_IO_HPP__
...
#include <hboost/date_time/date_facet.hpp>
#include <hboost/date_time/period_parser.hpp>
#include <hboost/date_time/period_formatter.hpp>
#include <hboost/date_time/special_values_parser.hpp>
#include <hboost/date_time/special_values_formatter.hpp>
#include <hboost/date_time/gregorian/gregorian_types.hpp>
#include <hboost/date_time/gregorian/conversion.hpp> // to_tm will be needed in the facets

namespace hboost {
namespace gregorian {


  typedef hboost::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef hboost::date_time::period_formatter<char>    period_formatter;
  
  typedef hboost::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef hboost::date_time::date_facet<date,char>    date_facet;

  typedef hboost::date_time::period_parser<date,char>       period_parser;
  typedef hboost::date_time::period_parser<date,wchar_t>    wperiod_parser;
    
  typedef hboost::date_time::special_values_formatter<char> special_values_formatter; 
  typedef hboost::date_time::special_values_formatter<wchar_t> wspecial_values_formatter; 
  
  typedef hboost::date_time::special_values_parser<date,char> special_values_parser; 
  typedef hboost::date_time::special_values_parser<date,wchar_t> wspecial_values_parser; 
  
  typedef hboost::date_time::date_input_facet<date,char>    date_input_facet;
  typedef hboost::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const hboost::gregorian::date& d) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    hboost::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const hboost::gregorian::date_duration& dd) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const hboost::gregorian::date_period& dp) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const hboost::gregorian::greg_month& gm) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const hboost::gregorian::greg_weekday& gw) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const hboost::gregorian::partial_date& pd) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const hboost::gregorian::nth_day_of_the_week_in_month& nkd) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const hboost::gregorian::first_day_of_the_week_in_month& fkd) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const hboost::gregorian::last_day_of_the_week_in_month& lkd) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const hboost::gregorian::first_day_of_the_week_after& fda) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const hboost::gregorian::first_day_of_the_week_before& fdb) {
    hboost::io::ios_flags_saver iflags(os);
    typedef hboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
...
#endif // HBOOST_DATE_TIME_GREGORIAN_IO_HPP__
