#ifndef HBOOST_GREG_DURATION_HPP___
#define HBOOST_GREG_DURATION_HPP___
...
#include <hboost/date_time/date_duration.hpp>
...
namespace gregorian {
  ...
  typedef hboost::date_time::duration_traits_adapted date_duration_rep;

  //! Durations in days for gregorian system
  /*! \ingroup date_basics
   */
  class date_duration :
    public hboost::date_time::date_duration< date_duration_rep >
  {
    typedef hboost::date_time::date_duration< date_duration_rep > base_type;
...
#include <hboost/date_time/date_duration_types.hpp>
#endif
