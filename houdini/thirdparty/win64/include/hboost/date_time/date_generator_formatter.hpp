#ifndef HBOOST__DATE_TIME_DATE_GENERATOR_FORMATTER__HPP___
#define HBOOST__DATE_TIME_DATE_GENERATOR_FORMATTER__HPP___
...
#endif // HBOOST__DATE_TIME_DATE_GENERATOR_FORMATTER__HPP___
