#ifndef HBOOST_DATE_TIME_TIME_DURATION_HPP___
#define HBOOST_DATE_TIME_TIME_DURATION_HPP___
...
#include <hboost/date_time/time_defs.hpp>
...
namespace date_time {
  ...
  */
  ...
  class time_duration : private
      hboost::less_than_comparable<T
    , hboost::equality_comparable<T
    > >
  ...
  public:
    ...
    typedef void _is_hboost_date_time_duration;
   ...
   */
  template<class base_duration, hboost::int64_t frac_of_second>
  ...
  private:
    ...
    HBOOST_STATIC_ASSERT_MSG((traits_type::ticks_per_second >= frac_of_second ? traits_type::ticks_per_second % frac_of_second : frac_of_second % traits_type::ticks_per_second) == 0,\
      "The base duration resolution must be a multiple of the subsecond duration resolution");
    HBOOST_STATIC_CONSTANT(hboost::int64_t, adjustment_ratio = (traits_type::ticks_per_second >= frac_of_second ? traits_type::ticks_per_second / frac_of_second : frac_of_second / traits_type::ticks_per_second));

  public:
    explicit subsecond_duration(hboost::int64_t ss) :
