#ifndef HBOOST_DATE_TIME_TIME_HPP___
#define HBOOST_DATE_TIME_TIME_HPP___
...
namespace date_time {
  ...
  */
  ...
  public:
    ...
    typedef void _is_hboost_date_time_time_point;
    typedef T time_type;
    ...
    //!Equality operator -- others generated by hboost::equality_comparable
    bool operator==(const time_type& rhs) const
    {
      return time_system::is_equal(time_,rhs.time_);
    }
    //!Equality operator -- others generated by hboost::less_than_comparable
    bool operator<(const time_type& rhs) const
    {
