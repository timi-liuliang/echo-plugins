#ifndef HBOOST_LOCAL_TIME_DATE_DURATION_OPERATORS_HPP___
#define HBOOST_LOCAL_TIME_DATE_DURATION_OPERATORS_HPP___
...
namespace local_time {
  ...
  inline
  local_date_time 
  operator+(const local_date_time& t, const hboost::gregorian::months& m)
  {
  ...
  inline
  local_date_time 
  operator+=(local_date_time& t, const hboost::gregorian::months& m)
  {
    return t += m.get_offset(t.utc_time().date());
  }
  ...
  inline
  local_date_time 
  operator+(const local_date_time& t, const hboost::gregorian::years& y)
  {
  ...
  inline
  local_date_time 
  operator+=(local_date_time& t, const hboost::gregorian::years& y)
  {
    return t += y.get_offset(t.utc_time().date());
  }
...
#endif // HBOOST_LOCAL_TIME_DATE_DURATION_OPERATORS_HPP___
