#ifndef HBOOST_LOCAL_TIME_DST_TRANSITION_DAY_RULES_HPP__
#define HBOOST_LOCAL_TIME_DST_TRANSITION_DAY_RULES_HPP__
...
#include "hboost/date_time/dst_transition_generators.hpp"
