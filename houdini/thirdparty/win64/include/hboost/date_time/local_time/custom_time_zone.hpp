#ifndef HBOOST_LOCAL_TIME_CUSTOM_TIME_ZONE_HPP__
#define HBOOST_LOCAL_TIME_CUSTOM_TIME_ZONE_HPP__
...
namespace local_time {
  ...
  //typedef hboost::date_time::time_zone_names time_zone_names;
  typedef hboost::date_time::dst_adjustment_offsets<hboost::posix_time::time_duration> dst_adjustment_offsets;
  //typedef hboost::date_time::time_zone_base<hboost::posix_time::ptime> time_zone;
  typedef hboost::shared_ptr<dst_calc_rule> dst_calc_rule_ptr;
  ...
  public:
    ...
    custom_time_zone_base(const time_zone_names& zone_names,
                     ...
                     hboost::shared_ptr<dst_calc_rule> calc_rule) :
