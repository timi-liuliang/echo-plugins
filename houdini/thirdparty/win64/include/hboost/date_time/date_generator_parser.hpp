...
#ifndef HBOOST_DATE_TIME_DATE_GENERATOR_PARSER_HPP__
#define HBOOST_DATE_TIME_DATE_GENERATOR_PARSER_HPP__
...
#include <hboost/date_time/string_parse_tree.hpp>
                      ...
                      const facet_type& facet) const
    {
      ...
      switch(mr.current_match) {
        ...
        default:
        {
          ...
          HBOOST_DATE_TIME_UNREACHABLE_EXPRESSION(wn = nth_kday_type::first);
        }
      }                                         // week num
...
#endif // HBOOST_DATE_TIME_DATE_GENERATOR_PARSER_HPP__
