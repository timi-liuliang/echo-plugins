#ifndef HBOOST_CONSTRAINED_VALUE_HPP___
#define HBOOST_CONSTRAINED_VALUE_HPP___
...
namespace CV {
  ...
  public:
    ...
    static value_type max HBOOST_PREVENT_MACRO_SUBSTITUTION () {return (value_policies::max)();}
    //! Return the min allowed value (traits method)
    static value_type min HBOOST_PREVENT_MACRO_SUBSTITUTION () {return (value_policies::min)();}
  ...
  class simple_exception_policy
  {
    ...
    {
      // In order to support throw_exception mechanism in the HBOOST_NO_EXCEPTIONS mode,
  ...
  public:
    ...
    static rep_type min HBOOST_PREVENT_MACRO_SUBSTITUTION () { return min_value; }
    static rep_type max HBOOST_PREVENT_MACRO_SUBSTITUTION () { return max_value; }
    static void on_error(rep_type, rep_type, violation_enum)
    {
      hboost::throw_exception(actual_exception_type());
    }
  };
