#ifndef HBOOST_DATE_TIME_FILETIME_FUNCTIONS_HPP__
#define HBOOST_DATE_TIME_FILETIME_FUNCTIONS_HPP__
 ...
 * HBOOST_HAS_FTIME defined.
 */

#include <hboost/date_time/compiler_config.hpp>

#if defined(HBOOST_HAS_FTIME) // skip this file if no FILETIME
...
#include <hboost/date_time/date_defs.hpp>
...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            hboost::uint32_t dwLowDateTime;
            hboost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            hboost::uint16_t wYear;
            hboost::uint16_t wMonth;
            hboost::uint16_t wDayOfWeek;
            hboost::uint16_t wDay;
            hboost::uint16_t wHour;
            hboost::uint16_t wMinute;
            hboost::uint16_t wSecond;
            hboost::uint16_t wMilliseconds;
        };
...
#elif defined(HBOOST_HAS_GETSYSTEMTIMEASFILETIME)
     ...
     *       hboost::date_time::winapi::file_time type.
     */
    template< typename FileTimeT >
    inline hboost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
...
TimeT time_from_ftime(const FileTimeT& ft)
{
    ...
    // https://svn.boost.org/trac/hboost/ticket/2523
...
#if !defined(HBOOST_DATE_TIME_POSIX_TIME_STD_CONFIG)
...
#endif // HBOOST_HAS_FTIME

#endif // HBOOST_DATE_TIME_FILETIME_FUNCTIONS_HPP__
