...
#ifndef HBOOST_CONTAINER_ALLOCATOR_SCOPED_ALLOCATOR_HPP
#define HBOOST_CONTAINER_ALLOCATOR_SCOPED_ALLOCATOR_HPP
...
#include <hboost/container/scoped_allocator_fwd.hpp>
   ...
   : public OuterAlloc
{
   ...
   HBOOST_COPYABLE_AND_MOVABLE(scoped_allocator_adaptor_base)
   ...
   template <class OuterA2>
   scoped_allocator_adaptor_base(HBOOST_FWD_REF(OuterA2) outerAlloc, const InnerAllocs &...args)
      : outer_allocator_type(::hboost::forward<OuterA2>(outerAlloc))
      , m_inner(args...)
      {}
   ...
   scoped_allocator_adaptor_base(HBOOST_RV_REF(scoped_allocator_adaptor_base) other)
      : outer_allocator_type(::hboost::move(other.outer_allocator()))
      , m_inner(::hboost::move(other.inner_allocator()))
      {}
   ...
   template <class OuterA2>
   scoped_allocator_adaptor_base
      (HBOOST_RV_REF_BEG scoped_allocator_adaptor_base
         <OuterA2, InnerAllocs...> HBOOST_RV_REF_END other)
      : outer_allocator_type(other.outer_allocator())
      , m_inner(other.inner_allocator())
      {}
   ...
   scoped_allocator_adaptor_base
      ( internal_type_t
      , HBOOST_FWD_REF(OuterA2) outerAlloc
   ...
   scoped_allocator_adaptor_base &operator=
      (HBOOST_COPY_ASSIGN_REF(scoped_allocator_adaptor_base) other)
   {
   ...
   scoped_allocator_adaptor_base &operator=(HBOOST_RV_REF(scoped_allocator_adaptor_base) other)
   {
      outer_allocator_type::operator=(hboost::move(other.outer_allocator()));
      m_inner = ::hboost::move(other.inner_allocator());
      return *this;
   }
   ...
   {
      hboost::adl_move_swap(this->outer_allocator(), r.outer_allocator());
      hboost::adl_move_swap(this->m_inner, r.inner_allocator());
   }

   friend void swap(scoped_allocator_adaptor_base &l, scoped_allocator_adaptor_base &r)
   {  l.swap(r);  }

   inner_allocator_type&       inner_allocator() HBOOST_NOEXCEPT_OR_NOTHROW
      { return m_inner; }

   inner_allocator_type const& inner_allocator() const HBOOST_NOEXCEPT_OR_NOTHROW
      { return m_inner; }

   outer_allocator_type      & outer_allocator() HBOOST_NOEXCEPT_OR_NOTHROW
      { return static_cast<outer_allocator_type&>(*this); }

   const outer_allocator_type &outer_allocator() const HBOOST_NOEXCEPT_OR_NOTHROW
...
template <typename OuterAlloc, bool Dummy, HBOOST_MOVE_CLASSDFLT9>
class scoped_allocator_adaptor_base;

//Specializations for the adaptor with InnerAlloc allocators

#define HBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_BASE_CODE(N)\
template <typename OuterAlloc HBOOST_MOVE_I##N HBOOST_MOVE_CLASS##N>\
class scoped_allocator_adaptor_base<OuterAlloc, true, HBOOST_MOVE_TARG##N>\
   : public OuterAlloc\
{\
   typedef allocator_traits<OuterAlloc> outer_traits_type;\
   HBOOST_COPYABLE_AND_MOVABLE(scoped_allocator_adaptor_base)\
   ...
   struct rebind_base\
   {\
      typedef scoped_allocator_adaptor_base<OuterA2, true, HBOOST_MOVE_TARG##N> other;\
   };\
   \
   typedef OuterAlloc outer_allocator_type;\
   typedef scoped_allocator_adaptor<HBOOST_MOVE_TARG##N> inner_allocator_type;\
   typedef scoped_allocator_adaptor<OuterAlloc, HBOOST_MOVE_TARG##N> scoped_allocator_type;\
   typedef allocator_traits<inner_allocator_type> inner_traits_type;\
   typedef container_detail::bool_<\
      outer_traits_type::propagate_on_container_copy_assignment::value ||\
      inner_allocator_type::propagate_on_container_copy_assignment::value\
   ...
   \
   template <class OuterA2>\
   scoped_allocator_adaptor_base(HBOOST_FWD_REF(OuterA2) outerAlloc, HBOOST_MOVE_CREF##N)\
      : outer_allocator_type(::hboost::forward<OuterA2>(outerAlloc))\
      , m_inner(HBOOST_MOVE_ARG##N)\
      {}\
   \
   scoped_allocator_adaptor_base(const scoped_allocator_adaptor_base& other)\
      : outer_allocator_type(other.outer_allocator())\
   ...
   template <class OuterA2>\
   scoped_allocator_adaptor_base\
      (const scoped_allocator_adaptor_base<OuterA2, true, HBOOST_MOVE_TARG##N>& other)\
      : outer_allocator_type(other.outer_allocator())\
      , m_inner(other.inner_allocator())\
      {}\
   \
   template <class OuterA2>\
   scoped_allocator_adaptor_base\
      (HBOOST_RV_REF_BEG scoped_allocator_adaptor_base<OuterA2, true, HBOOST_MOVE_TARG##N> HBOOST_RV_REF_END other)\
      : outer_allocator_type(other.outer_allocator())\
      , m_inner(other.inner_allocator())\
      {}\
   \
   ...
   template <class OuterA2>\
   scoped_allocator_adaptor_base\
      ( internal_type_t, HBOOST_FWD_REF(OuterA2) outerAlloc, const inner_allocator_type &inner)\
      : outer_allocator_type(::hboost::forward<OuterA2>(outerAlloc))\
      , m_inner(inner)\
   {}\
   \
...
//!
HBOOST_MOVE_ITERATE_1TO9(HBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_BASE_CODE)
#undef HBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_BASE_CODE
   ...
   #define HBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE      ,true
   #define HBOOST_CONTAINER_SCOPEDALLOC_ALLINNER       HBOOST_MOVE_TARG9
   #define HBOOST_CONTAINER_SCOPEDALLOC_ALLINNERCLASS  HBOOST_MOVE_CLASS9
#else
   #define HBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE
   #define HBOOST_CONTAINER_SCOPEDALLOC_ALLINNER       InnerAllocs...
   #define HBOOST_CONTAINER_SCOPEDALLOC_ALLINNERCLASS  typename... InnerAllocs
#endif

//Specialization for adaptor without any InnerAlloc
template <typename OuterAlloc>
class scoped_allocator_adaptor_base< OuterAlloc HBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE>
   : public OuterAlloc
{
   HBOOST_COPYABLE_AND_MOVABLE(scoped_allocator_adaptor_base)
   public:
   ...
   struct rebind_base
   {
      typedef scoped_allocator_adaptor_base
         ...
         HBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE > other;
   };
   ...
   template <class OuterA2>
   scoped_allocator_adaptor_base(HBOOST_FWD_REF(OuterA2) outerAlloc)
      : outer_allocator_type(::hboost::forward<OuterA2>(outerAlloc))
      {}
   ...
   template <class OuterA2>
   scoped_allocator_adaptor_base
      (const scoped_allocator_adaptor_base<OuterA2 HBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE>& other)
      : outer_allocator_type(other.outer_allocator())
      {}

   template <class OuterA2>
   scoped_allocator_adaptor_base
      (HBOOST_RV_REF_BEG scoped_allocator_adaptor_base<OuterA2 HBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE> HBOOST_RV_REF_END other)
      : outer_allocator_type(other.outer_allocator())
      {}
   ...
   template <class OuterA2>
   scoped_allocator_adaptor_base(internal_type_t, HBOOST_FWD_REF(OuterA2) outerAlloc, const inner_allocator_type &)
      : outer_allocator_type(::hboost::forward<OuterA2>(outerAlloc))
      {}

   public:
   scoped_allocator_adaptor_base &operator=(HBOOST_COPY_ASSIGN_REF(scoped_allocator_adaptor_base) other)
   {
      outer_allocator_type::operator=(other.outer_allocator());
      return *this;
   }
...
template <typename OuterAlloc, HBOOST_MOVE_CLASS9>
class scoped_allocator_adaptor
#endif

   : public container_detail::scoped_allocator_adaptor_base
         <OuterAlloc HBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE, HBOOST_CONTAINER_SCOPEDALLOC_ALLINNER>
{
   HBOOST_COPYABLE_AND_MOVABLE(scoped_allocator_adaptor)

   public:
   #ifndef HBOOST_CONTAINER_DOXYGEN_INVOKED
   typedef container_detail::scoped_allocator_adaptor_base
      <OuterAlloc HBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE, HBOOST_CONTAINER_SCOPEDALLOC_ALLINNER> base_type;
   ...
   struct rebind
   {
      typedef scoped_allocator_adaptor
         < typename outer_traits_type::template portable_rebind_alloc<U>::type
         , HBOOST_CONTAINER_SCOPEDALLOC_ALLINNER> other;
   };
   ...
   //! the corresponding allocator from other.
   scoped_allocator_adaptor(HBOOST_RV_REF(scoped_allocator_adaptor) other)
      : base_type(::hboost::move(other.base()))
      {}
   ...
   //!
   //! <b>Effects</b>: initializes the OuterAlloc base class with hboost::forward<OuterA2>(outerAlloc) and inner
   //! with innerAllocs...(hence recursively initializing each allocator within the adaptor with the
   //! corresponding allocator from the argument list).
   template <class OuterA2>
   scoped_allocator_adaptor(HBOOST_FWD_REF(OuterA2) outerAlloc, const InnerAllocs & ...innerAllocs)
      : base_type(::hboost::forward<OuterA2>(outerAlloc), innerAllocs...)
      {}
   #else // #if !defined(HBOOST_NO_CXX11_VARIADIC_TEMPLATES) || defined(HBOOST_CONTAINER_DOXYGEN_INVOKED)

   #define HBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_RELATED_ALLOCATOR_CONSTRUCTOR_CODE(N)\
   template <class OuterA2>\
   scoped_allocator_adaptor(HBOOST_FWD_REF(OuterA2) outerAlloc HBOOST_MOVE_I##N HBOOST_MOVE_CREF##N)\
      : base_type(::hboost::forward<OuterA2>(outerAlloc) HBOOST_MOVE_I##N HBOOST_MOVE_ARG##N)\
      {}\
   //
   HBOOST_MOVE_ITERATE_0TO9(HBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_RELATED_ALLOCATOR_CONSTRUCTOR_CODE)
   #undef HBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_RELATED_ALLOCATOR_CONSTRUCTOR_CODE
   ...
   template <class OuterA2>
   scoped_allocator_adaptor(const scoped_allocator_adaptor<OuterA2, HBOOST_CONTAINER_SCOPEDALLOC_ALLINNER> &other)
      : base_type(other.base())
      {}
   ...
   //! rvalue from other.
   template <class OuterA2>
   scoped_allocator_adaptor(HBOOST_RV_REF_BEG scoped_allocator_adaptor
      <OuterA2, HBOOST_CONTAINER_SCOPEDALLOC_ALLINNER> HBOOST_RV_REF_END other)
      : base_type(::hboost::move(other.base()))
      {}

   scoped_allocator_adaptor &operator=(HBOOST_COPY_ASSIGN_REF(scoped_allocator_adaptor) other)
   {  return static_cast<scoped_allocator_adaptor&>(base_type::operator=(static_cast<const base_type &>(other))); }

   scoped_allocator_adaptor &operator=(HBOOST_RV_REF(scoped_allocator_adaptor) other)
   {  return static_cast<scoped_allocator_adaptor&>(base_type::operator=(hboost::move(other.base()))); }
   ...
   #endif   //HBOOST_CONTAINER_DOXYGEN_INVOKED
   ...
   template <class T>
   void destroy(T* p) HBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   void construct(T* p, HBOOST_FWD_REF(Args)...args)
   {
      container_detail::dispatch_uses_allocator
         ( (get_outermost_allocator)(this->outer_allocator())
         , this->inner_allocator(), p, ::hboost::forward<Args>(args)...);
   }
   ...
   #define HBOOST_CONTAINER_SCOPED_ALLOCATOR_CONSTRUCT_CODE(N) \
   template < typename T HBOOST_MOVE_I##N HBOOST_MOVE_CLASSQ##N >\
   void construct(T* p HBOOST_MOVE_I##N HBOOST_MOVE_UREFQ##N)\
   {\
      container_detail::dispatch_uses_allocator\
         ( (get_outermost_allocator)(this->outer_allocator())\
         , this->inner_allocator(), p HBOOST_MOVE_I##N HBOOST_MOVE_FWDQ##N);\
   }\
   //
   HBOOST_MOVE_ITERATE_0TO9(HBOOST_CONTAINER_SCOPED_ALLOCATOR_CONSTRUCT_CODE)
   #undef HBOOST_CONTAINER_SCOPED_ALLOCATOR_CONSTRUCT_CODE
   ...
   //Internal function
   template <class OuterA2>
   scoped_allocator_adaptor(internal_type_t, HBOOST_FWD_REF(OuterA2) outer, const inner_allocator_type& inner)
      : base_type(internal_type_t(), ::hboost::forward<OuterA2>(outer), inner)
   {}
...
template <typename OuterA1, typename OuterA2, HBOOST_CONTAINER_SCOPEDALLOC_ALLINNERCLASS>
inline bool operator==(const scoped_allocator_adaptor<OuterA1, HBOOST_CONTAINER_SCOPEDALLOC_ALLINNER>& a
                      ,const scoped_allocator_adaptor<OuterA2, HBOOST_CONTAINER_SCOPEDALLOC_ALLINNER>& b)
{
   #if !defined(HBOOST_NO_CXX11_VARIADIC_TEMPLATES) || defined(HBOOST_CONTAINER_DOXYGEN_INVOKED)
   const bool has_zero_inner = sizeof...(InnerAllocs) == 0u;
   #else
   const bool has_zero_inner = hboost::container::container_detail::is_same<P0, void>::value;
   #endif
...
#endif //  HBOOST_CONTAINER_ALLOCATOR_SCOPED_ALLOCATOR_HPP
