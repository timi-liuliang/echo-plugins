...
//
//////////////////////////////////////////////////////////////////////////////
#ifndef HBOOST_CONTAINER_ALLOCATOR_ALLOCATOR_TRAITS_HPP
#define HBOOST_CONTAINER_ALLOCATOR_ALLOCATOR_TRAITS_HPP
...
#include <hboost/container/detail/type_traits.hpp>  //is_empty
...
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME allocate
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG namespace hboost { namespace container { namespace container_detail {
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_END   }}}
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_MIN 2
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_MAX 2
#include <hboost/intrusive/detail/has_member_function_callable_with.hpp>

#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME destroy
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG namespace hboost { namespace container { namespace container_detail {
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_END   }}}
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_MIN 1
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_MAX 1
#include <hboost/intrusive/detail/has_member_function_callable_with.hpp>

#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME construct
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG namespace hboost { namespace container { namespace container_detail {
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_END   }}}
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_MIN 1
#define HBOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_MAX 9
#include <hboost/intrusive/detail/has_member_function_callable_with.hpp>
...
HBOOST_INTRUSIVE_HAS_STATIC_MEMBER_FUNC_SIGNATURE(has_max_size, max_size)
HBOOST_INTRUSIVE_HAS_STATIC_MEMBER_FUNC_SIGNATURE(has_select_on_container_copy_construction, select_on_container_copy_construction)
...
HBOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(pointer)
HBOOST_INTRUSIVE_INSTANTIATE_EVAL_DEFAULT_TYPE_TMPLT(const_pointer)
HBOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(reference)
HBOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(const_reference)
HBOOST_INTRUSIVE_INSTANTIATE_EVAL_DEFAULT_TYPE_TMPLT(void_pointer)
HBOOST_INTRUSIVE_INSTANTIATE_EVAL_DEFAULT_TYPE_TMPLT(const_void_pointer)
HBOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(size_type)
HBOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(propagate_on_container_copy_assignment)
HBOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(propagate_on_container_move_assignment)
HBOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(propagate_on_container_swap)
HBOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(is_always_equal)
HBOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(difference_type)
HBOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(is_partially_propagable)
...
struct allocator_traits
{
   ...
   typedef typename allocator_type::value_type value_type;
   ...
   #else
      //pointer
      typedef HBOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT(hboost::container::container_detail::, Allocator,
         pointer, value_type*)
            pointer;
      //const_pointer
      typedef HBOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(hboost::container::container_detail::, Allocator,
         const_pointer, typename hboost::intrusive::pointer_traits<pointer>::template
      ...
      //void_pointer
      typedef HBOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(hboost::container::container_detail::, Allocator,
         void_pointer, typename hboost::intrusive::pointer_traits<pointer>::template
            rebind_pointer<void>)
               void_pointer;
      //const_void_pointer
      typedef HBOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(hboost::container::container_detail::, Allocator,
         const_void_pointer, typename hboost::intrusive::pointer_traits<pointer>::template
      ...
      //rebind_alloc & rebind_traits
         ...
         //C++11
         template <typename T> using rebind_alloc  = typename hboost::intrusive::pointer_rebind<Allocator, T>::type;
         template <typename T> using rebind_traits = allocator_traits< rebind_alloc<T> >;
      #else    // #if !defined(HBOOST_NO_CXX11_TEMPLATE_ALIASES)
         //Some workaround for C++03 or C++11 compilers with no template aliases
         template <typename T>
         struct rebind_alloc : hboost::intrusive::pointer_rebind<Allocator,T>::type
         {
            typedef typename hboost::intrusive::pointer_rebind<Allocator,T>::type Base;
            #if !defined(HBOOST_NO_CXX11_VARIADIC_TEMPLATES)
               template <typename... Args>
               rebind_alloc(HBOOST_FWD_REF(Args)... args) : Base(hboost::forward<Args>(args)...) {}
            #else    // #if !defined(HBOOST_NO_CXX11_VARIADIC_TEMPLATES)
               #define HBOOST_CONTAINER_ALLOCATOR_TRAITS_REBIND_ALLOC(N) \
               HBOOST_MOVE_TMPL_LT##N HBOOST_MOVE_CLASS##N HBOOST_MOVE_GT##N\
               explicit rebind_alloc(HBOOST_MOVE_UREF##N) : Base(HBOOST_MOVE_FWD##N){}\
               //
               HBOOST_MOVE_ITERATE_0TO9(HBOOST_CONTAINER_ALLOCATOR_TRAITS_REBIND_ALLOC)
               #undef HBOOST_CONTAINER_ALLOCATOR_TRAITS_REBIND_ALLOC
            #endif   // #if !defined(HBOOST_NO_CXX11_VARIADIC_TEMPLATES)
         };

         template <typename T>
         struct rebind_traits
            : allocator_traits<typename hboost::intrusive::pointer_rebind<Allocator, T>::type>
         {};
      ...
      template <class T>
      struct portable_rebind_alloc
      {  typedef typename hboost::intrusive::pointer_rebind<Allocator, T>::type type;  };
   ...
   {
      const bool value = hboost::container::container_detail::
   ...
   template<class T>
   static void destroy(Allocator &a, T*p) HBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   static size_type max_size(const Allocator &a) HBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   //! otherwise, a.
   static HBOOST_CONTAINER_DOC1ST(Allocator,
      typename container_detail::if_c
         < allocator_traits_detail::has_select_on_container_copy_construction<Allocator HBOOST_MOVE_I Allocator (Allocator::*)() const>::value
         HBOOST_MOVE_I Allocator HBOOST_MOVE_I const Allocator & >::type)
   select_on_container_copy_construction(const Allocator &a)
   {
      ...
      static void construct(Allocator & a, T* p, HBOOST_FWD_REF(Args)... args)
      {
         static const bool value = ::hboost::move_detail::and_
            < container_detail::is_not_std_allocator<Allocator>
            , hboost::container::container_detail::has_member_function_callable_with_construct
                  < Allocator, T*, Args... >
            >::value;
         container_detail::bool_<value> flag;
         allocator_traits::priv_construct(flag, a, p, ::hboost::forward<Args>(args)...);
      }
   #endif

   //! <b>Returns</b>: <code>a.storage_is_unpropagable(p)</code> if is_partially_propagable::value is true; otherwise,
   //! <code>false</code>.
   static bool storage_is_unpropagable(const Allocator &a, pointer p) HBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   //! <code>a == b</code>.
   static bool equal(const Allocator &a, const Allocator &b) HBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   template<class T>
   static void priv_destroy(container_detail::true_type, Allocator &a, T* p) HBOOST_NOEXCEPT_OR_NOTHROW
   {  a.destroy(p);  }

   template<class T>
   static void priv_destroy(container_detail::false_type, Allocator &, T* p) HBOOST_NOEXCEPT_OR_NOTHROW
   {  p->~T(); (void)p;  }

   static size_type priv_max_size(container_detail::true_type, const Allocator &a) HBOOST_NOEXCEPT_OR_NOTHROW
   {  return a.max_size();  }

   static size_type priv_max_size(container_detail::false_type, const Allocator &) HBOOST_NOEXCEPT_OR_NOTHROW
   {  return size_type(-1)/sizeof(value_type);  }

   static Allocator priv_select_on_container_copy_construction(container_detail::true_type, const Allocator &a)
   {  return a.select_on_container_copy_construction();  }

   static const Allocator &priv_select_on_container_copy_construction(container_detail::false_type, const Allocator &a) HBOOST_NOEXCEPT_OR_NOTHROW
   {  return a;  }

   #if !defined(HBOOST_NO_CXX11_VARIADIC_TEMPLATES)
      template<class T, class ...Args>
      static void priv_construct(container_detail::true_type, Allocator &a, T *p, HBOOST_FWD_REF(Args) ...args)
      {  a.construct( p, ::hboost::forward<Args>(args)...);  }

      template<class T, class ...Args>
      static void priv_construct(container_detail::false_type, Allocator &, T *p, HBOOST_FWD_REF(Args) ...args)
      {  ::new((void*)p, hboost_container_new_t()) T(::hboost::forward<Args>(args)...); }
   #else // #if !defined(HBOOST_NO_CXX11_VARIADIC_TEMPLATES)
      public:

      #define HBOOST_CONTAINER_ALLOCATOR_TRAITS_CONSTRUCT_IMPL(N) \
      template<class T HBOOST_MOVE_I##N HBOOST_MOVE_CLASS##N >\
      static void construct(Allocator &a, T *p HBOOST_MOVE_I##N HBOOST_MOVE_UREF##N)\
      {\
         static const bool value = ::hboost::move_detail::and_ \
            < container_detail::is_not_std_allocator<Allocator> \
            , hboost::container::container_detail::has_member_function_callable_with_construct \
                  < Allocator, T* HBOOST_MOVE_I##N HBOOST_MOVE_FWD_T##N > \
            >::value; \
         container_detail::bool_<value> flag;\
         (priv_construct)(flag, a, p HBOOST_MOVE_I##N HBOOST_MOVE_FWD##N);\
      }\
      //
      HBOOST_MOVE_ITERATE_0TO8(HBOOST_CONTAINER_ALLOCATOR_TRAITS_CONSTRUCT_IMPL)
      #undef HBOOST_CONTAINER_ALLOCATOR_TRAITS_CONSTRUCT_IMPL

      private:
      /////////////////////////////////
      // priv_construct
      /////////////////////////////////
      #define HBOOST_CONTAINER_ALLOCATOR_TRAITS_PRIV_CONSTRUCT_IMPL(N) \
      template<class T HBOOST_MOVE_I##N HBOOST_MOVE_CLASS##N >\
      static void priv_construct(container_detail::true_type, Allocator &a, T *p HBOOST_MOVE_I##N HBOOST_MOVE_UREF##N)\
      {  a.construct( p HBOOST_MOVE_I##N HBOOST_MOVE_FWD##N );  }\
      \
      template<class T HBOOST_MOVE_I##N HBOOST_MOVE_CLASS##N >\
      static void priv_construct(container_detail::false_type, Allocator &, T *p HBOOST_MOVE_I##N HBOOST_MOVE_UREF##N)\
      {  ::new((void*)p, hboost_container_new_t()) T(HBOOST_MOVE_FWD##N); }\
      //
      HBOOST_MOVE_ITERATE_0TO8(HBOOST_CONTAINER_ALLOCATOR_TRAITS_PRIV_CONSTRUCT_IMPL)
      #undef HBOOST_CONTAINER_ALLOCATOR_TRAITS_PRIV_CONSTRUCT_IMPL

   #endif   // #if !defined(HBOOST_NO_CXX11_VARIADIC_TEMPLATES)

   template<class T>
   static void priv_construct(container_detail::false_type, Allocator &, T *p, const ::hboost::container::default_init_t&)
   {  ::new((void*)p, hboost_container_new_t()) T; }
...
#endif // ! defined(HBOOST_CONTAINER_ALLOCATOR_ALLOCATOR_TRAITS_HPP)
