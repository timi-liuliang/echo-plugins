...
#ifndef HBOOST_CONTAINER_USES_ALLOCATOR_HPP
#define HBOOST_CONTAINER_USES_ALLOCATOR_HPP
...
//! (when HBOOST_NO_SFINAE_EXPR is NOT defined), this trait is ignored and C++11 rules will be used
...
//!       template<class ...Args>
//!       Y(allocator_arg_t, const allocator_type& a, HBOOST_FWD_REF(Args)... args);
//! };
//!
