...
#ifndef HBOOST_CONTAINER_USES_ALLOCATOR_FWD_HPP
#define HBOOST_CONTAINER_USES_ALLOCATOR_FWD_HPP

#include <hboost/container/detail/workaround.hpp>
#include <hboost/container/detail/std_fwd.hpp>

//! \file
//!   This header forward declares hboost::container::constructible_with_allocator_prefix,
//!   hboost::container::constructible_with_allocator_suffix and
//!   hboost::container::uses_allocator. Also defines the following types:
...
//! A instance of type
//! allocator_arg_t
static allocator_arg_t allocator_arg = HBOOST_CONTAINER_DOC1ST(unspecified, *std_allocator_arg_holder<>::dummy);
...
#endif   //HBOOST_CONTAINER_USES_ALLOCATOR_HPP
