...
#ifndef HBOOST_CONTAINER_DETAIL_BLOCK_SLIST_HEADER
#define HBOOST_CONTAINER_DETAIL_BLOCK_SLIST_HEADER
...
class block_slist_base
{
   ...
   void release(memory_resource &mr) HBOOST_NOEXCEPT
   {
...
#endif   //HBOOST_CONTAINER_DETAIL_BLOCK_SLIST_HEADER
