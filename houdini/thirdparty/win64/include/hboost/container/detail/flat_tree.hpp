...
#ifndef HBOOST_CONTAINER_FLAT_TREE_HPP
#define HBOOST_CONTAINER_FLAT_TREE_HPP
...
#ifdef HBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER
...
struct get_flat_tree_iterators
{
   ...
   #else //HBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER
   typedef typename hboost::container::container_detail::
...
class flat_tree
{
   typedef hboost::container::vector<Value, Allocator>    vector_t;
 ...
 private:
   ...
   {
      HBOOST_COPYABLE_AND_MOVABLE(Data)
      ...
      Data(HBOOST_RV_REF(Data) d)
         : value_compare(hboost::move(static_cast<value_compare&>(d))), m_vect(hboost::move(d.m_vect))
      {}
      ...
      Data(HBOOST_RV_REF(Data) d, const Allocator &a)
         : value_compare(hboost::move(static_cast<value_compare&>(d))), m_vect(hboost::move(d.m_vect), a)
      {}
      ...
      Data& operator=(HBOOST_COPY_ASSIGN_REF(Data) d)
      {
      ...
      Data& operator=(HBOOST_RV_REF(Data) d)
      {
         this->value_compare::operator=(hboost::move(static_cast<value_compare &>(d)));
         m_vect = hboost::move(d.m_vect);
         return *this;
      }
      ...
      void swap(Data &d)
      {
         ...
         hboost::adl_move_swap(mycomp, othercomp);
   ...
   Data m_data;
   HBOOST_COPYABLE_AND_MOVABLE(flat_tree)
   ...
   flat_tree(HBOOST_RV_REF(flat_tree) x)
      :  m_data(hboost::move(x.m_data))
   { }
   ...
   flat_tree(HBOOST_RV_REF(flat_tree) x, const allocator_type &a)
      :  m_data(hboost::move(x.m_data), a)
   { }
   ...
   flat_tree&  operator=(HBOOST_COPY_ASSIGN_REF(flat_tree) x)
   {  m_data = x.m_data;   return *this;  }

   flat_tree&  operator=(HBOOST_RV_REF(flat_tree) x)
   ...
   {  m_data = hboost::move(x.m_data); return *this;  }
   ...
   std::pair<iterator,bool> insert_unique(HBOOST_RV_REF(value_type) val)
   {
      std::pair<iterator,bool> ret;
      insert_commit_data data;
      ret.second = this->priv_insert_unique_prepare(val, data);
      ret.first = ret.second ? this->priv_insert_commit(data, hboost::move(val))
                             : iterator(vector_iterator_get_ptr(data.position));
      return ret;
   }
   ...
   iterator insert_equal(HBOOST_RV_REF(value_type) mval)
   {
      iterator i = this->upper_bound(KeyOfValue()(mval));
      i = this->m_data.m_vect.insert(i, hboost::move(mval));
      return i;
   }

   iterator insert_unique(const_iterator hint, const value_type& val)
   {
      HBOOST_ASSERT(this->priv_in_range_or_end(hint));
      std::pair<iterator,bool> ret;
      insert_commit_data data;
   ...
   iterator insert_unique(const_iterator hint, HBOOST_RV_REF(value_type) val)
   {
      HBOOST_ASSERT(this->priv_in_range_or_end(hint));
      std::pair<iterator,bool> ret;
      insert_commit_data data;
      return this->priv_insert_unique_prepare(hint, val, data)
         ? this->priv_insert_commit(data, hboost::move(val))
         : iterator(vector_iterator_get_ptr(data.position));
   }
   ...
   iterator insert_equal(const_iterator hint, HBOOST_RV_REF(value_type) mval)
   {
      HBOOST_ASSERT(this->priv_in_range_or_end(hint));
      insert_commit_data data;
      this->priv_insert_equal_prepare(hint, mval, data);
      return this->priv_insert_commit(data, hboost::move(mval));
   }
   ...
   {
      const size_type len = static_cast<size_type>(hboost::container::iterator_distance(first, last));
   ...
   std::pair<iterator, bool> emplace_unique(HBOOST_FWD_REF(Args)... args)
   {
      ...
      stored_allocator_traits::construct(a, &val, ::hboost::forward<Args>(args)... );
      value_destructor<stored_allocator_type> d(a, val);
      return this->insert_unique(::hboost::move(val));
   }
   ...
   iterator emplace_hint_unique(const_iterator hint, HBOOST_FWD_REF(Args)... args)
   {
      ...
      stored_allocator_traits::construct(a, &val, ::hboost::forward<Args>(args)... );
      value_destructor<stored_allocator_type> d(a, val);
      return this->insert_unique(hint, ::hboost::move(val));
   }
   ...
   iterator emplace_equal(HBOOST_FWD_REF(Args)... args)
   {
      ...
      stored_allocator_traits::construct(a, &val, ::hboost::forward<Args>(args)... );
      value_destructor<stored_allocator_type> d(a, val);
      return this->insert_equal(::hboost::move(val));
   }
   ...
   iterator emplace_hint_equal(const_iterator hint, HBOOST_FWD_REF(Args)... args)
   {
      ...
      stored_allocator_traits::construct(a, &val, ::hboost::forward<Args>(args)... );
      value_destructor<stored_allocator_type> d(a, val);
      return this->insert_equal(hint, ::hboost::move(val));
   }

   #else // !defined(HBOOST_NO_CXX11_VARIADIC_TEMPLATES)

   #define HBOOST_CONTAINER_FLAT_TREE_EMPLACE_CODE(N) \
   ...
   {\
      ...
      value_type &val = *static_cast<value_type *>(static_cast<void *>(&v));\
      stored_allocator_type &a = this->get_stored_allocator();\
      stored_allocator_traits::construct(a, &val HBOOST_MOVE_I##N HBOOST_MOVE_FWD##N);\
      value_destructor<stored_allocator_type> d(a, val);\
      return this->insert_unique(::hboost::move(val));\
   }\
   \
   ...
   //
   HBOOST_MOVE_ITERATE_0TO9(HBOOST_CONTAINER_FLAT_TREE_EMPLACE_CODE)
   #undef HBOOST_CONTAINER_FLAT_TREE_EMPLACE_CODE
   ...
   iterator priv_insert_commit
      (insert_commit_data &commit_data, HBOOST_FWD_REF(Convertible) convertible)
   {
      return this->m_data.m_vect.insert
         ( commit_data.position
         , hboost::forward<Convertible>(convertible));
   }
...
class Compare, class Allocator>
struct has_trivial_destructor_after_move<hboost::container::container_detail::flat_tree<Key, T, KeyOfValue, Compare, Allocator> >
{
...
#endif // HBOOST_CONTAINER_FLAT_TREE_HPP
