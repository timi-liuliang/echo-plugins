...
//
//////////////////////////////////////////////////////////////////////////////
#ifndef HBOOST_CONTAINER_DETAIL_UTILITIES_HPP
#define HBOOST_CONTAINER_DETAIL_UTILITIES_HPP
...
template<class It>
struct are_elements_contiguous< ::hboost::move_iterator<It> >
...
#endif   //HBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER
...
template<class Pointer>
struct are_elements_contiguous<hboost::container::container_detail::vector_iterator<Pointer> >
{
   static const bool value = true;
};

template<class Pointer>
struct are_elements_contiguous<hboost::container::container_detail::vector_const_iterator<Pointer> >
{
   static const bool value = true;
};
...
template <class PointedType, class DifferenceType, class OffsetType, std::size_t OffsetAlignment>
struct are_elements_contiguous< ::hboost::interprocess::offset_ptr<PointedType, DifferenceType, OffsetType, OffsetAlignment> >
{
   static const bool value = true;
};
...
struct are_contiguous_and_same
   : hboost::move_detail::and_
      ...
      , is_same< typename remove_const< typename ::hboost::container::iterator_traits<I>::value_type >::type
               , typename ::hboost::container::iterator_traits<O>::value_type
               >
      >
{};
...
struct is_memtransfer_copy_assignable
   : hboost::move_detail::and_
      ...
      , container_detail::is_trivially_copy_assignable< typename ::hboost::container::iterator_traits<I>::value_type >
      >
{};
...
struct is_memtransfer_copy_constructible
   : hboost::move_detail::and_
      < are_contiguous_and_same<I, O>
      , container_detail::is_trivially_copy_constructible< typename ::hboost::container::iterator_traits<I>::value_type >
      >
{};
...
inline F memmove(I f, I l, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{
   typedef typename hboost::container::iterator_traits<I>::value_type value_type;
   typename hboost::container::iterator_traits<I>::difference_type n = hboost::container::iterator_distance(f, l);
   if(n){
      std::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
      hboost::container::iterator_advance(r, n);
   }
   return r;
}
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
F memmove_n(I f, typename hboost::container::iterator_traits<I>::difference_type n, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{
   typedef typename hboost::container::iterator_traits<I>::value_type value_type;
   if(n){
      std::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
I memmove_n_source(I f, typename hboost::container::iterator_traits<I>::difference_type n, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{
   if(n){
      typedef typename hboost::container::iterator_traits<I>::value_type value_type;
      std::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
      hboost::container::iterator_advance(f, n);
   }
   return f;
}
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
I memmove_n_source_dest(I f, typename hboost::container::iterator_traits<I>::difference_type n, F &r) HBOOST_NOEXCEPT_OR_NOTHROW
{
   typedef typename hboost::container::iterator_traits<I>::value_type value_type;
   if(n){
      std::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
...
{
   typedef typename ::hboost::container::iterator_traits<O>::value_type value_type;
   static const bool value = are_elements_contiguous<O>::value &&
      ...
      #if defined(HBOOST_CONTAINER_MEMZEROED_POINTER_IS_NULL)
      || container_detail::is_pointer<value_type>::value
      #endif
      #if defined(HBOOST_CONTAINER_MEMZEROED_FLOATING_POINT_IS_ZERO)
      || container_detail::is_floating_point<value_type>::value
      #endif
      #if defined(HBOOST_CONTAINER_MEMZEROED_FLOATING_POINT_IS_ZERO) && defined(HBOOST_CONTAINER_MEMZEROED_POINTER_IS_NULL)
...
struct enable_if_trivially_destructible
   : enable_if_c < container_detail::is_trivially_destructible
                  <typename hboost::container::iterator_traits<I>::value_type>::value
               , R>
{};
...
//!   \code
//!   for (; f != l; ++r, ++f)
//!      allocator_traits::construct(a, &*r, hboost::move(*f));
//!   \endcode
//!
//! <b>Returns</b>: r
template
   ...
   uninitialized_move_alloc(Allocator &a, I f, I l, F r)
{
   ...
   HBOOST_TRY{
      while (f != l) {
         allocator_traits<Allocator>::construct(a, container_detail::iterator_to_raw_pointer(r), hboost::move(*f));
         ++f; ++r;
      }
   }
   HBOOST_CATCH(...){
...
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc(Allocator &, I f, I l, F r) HBOOST_NOEXCEPT_OR_NOTHROW
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc_n(Allocator &a, I f, typename hboost::container::iterator_traits<I>::difference_type n, F r)
{
   F back = r;
   HBOOST_TRY{
      while (n--) {
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc_n(Allocator &, I f, typename hboost::container::iterator_traits<I>::difference_type n, F r) HBOOST_NOEXCEPT_OR_NOTHROW
...
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_move_alloc_n_source(Allocator &a, I f, typename hboost::container::iterator_traits<I>::difference_type n, F r)
{
   F back = r;
   HBOOST_TRY{
      while (n--) {
...
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_move_alloc_n_source(Allocator &, I f, typename hboost::container::iterator_traits<I>::difference_type n, F r) HBOOST_NOEXCEPT_OR_NOTHROW
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc(Allocator &, I f, I l, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove(f, l, r); }
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc_n(Allocator &a, I f, typename hboost::container::iterator_traits<I>::difference_type n, F r)
{
   F back = r;
   HBOOST_TRY{
      while (n--) {
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc_n(Allocator &, I f, typename hboost::container::iterator_traits<I>::difference_type n, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n(f, n, r); }
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_copy_alloc_n_source(Allocator &a, I f, typename hboost::container::iterator_traits<I>::difference_type n, F r)
{
   F back = r;
   HBOOST_TRY{
      while (n--) {
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_copy_alloc_n_source(Allocator &, I f, typename hboost::container::iterator_traits<I>::difference_type n, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source(f, n, r); }
...
{
   typedef typename hboost::container::iterator_traits<F>::value_type value_type;
...
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   copy(I f, I l, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove(f, l, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, F>::type
   copy_n(I f, typename hboost::container::iterator_traits<I>::difference_type n, F r)
{
   while (n--) {
      *r = *f;
      ++f; ++r;
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   copy_n(I f, typename hboost::container::iterator_traits<I>::difference_type n, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n(f, n, r); }
...
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source(I f, typename hboost::container::iterator_traits<I>::difference_type n, F r)
{
   while (n--) {
      *r = *f;
      ++f; ++r;
...
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source(I f, typename hboost::container::iterator_traits<I>::difference_type n, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source(f, n, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source_dest(I f, typename hboost::container::iterator_traits<I>::difference_type n, F &r)
{
   while (n--) {
      *r = *f;
      ++f; ++r;
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source_dest(I f, typename hboost::container::iterator_traits<I>::difference_type n, F &r) HBOOST_NOEXCEPT_OR_NOTHROW
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   move(I f, I l, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove(f, l, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, F>::type
   move_n(I f, typename hboost::container::iterator_traits<I>::difference_type n, F r)
{
   while (n--) {
      *r = ::hboost::move(*f);
      ++f; ++r;
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   move_n(I f, typename hboost::container::iterator_traits<I>::difference_type n, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n(f, n, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   move_backward(I f, I l, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{
   typedef typename hboost::container::iterator_traits<I>::value_type value_type;
   const typename hboost::container::iterator_traits<I>::difference_type n = hboost::container::iterator_distance(f, l);
   r -= n;
...
,typename F>   // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source_dest(I f, typename hboost::container::iterator_traits<I>::difference_type n, F &r)
{
   while (n--) {
      *r = ::hboost::move(*f);
      ++f; ++r;
...
,typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source_dest(I f, typename hboost::container::iterator_traits<I>::difference_type n, F &r) HBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source_dest(f, n, r); }
...
,typename F>   // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source(I f, typename hboost::container::iterator_traits<I>::difference_type n, F r)
{
   while (n--) {
      *r = ::hboost::move(*f);
      ++f; ++r;
...
,typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source(I f, typename hboost::container::iterator_traits<I>::difference_type n, F r) HBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source(f, n, r); }
                    ...
                    , G large_range_f, typename allocator_traits<Allocator>::size_type n_j)
{
   ...
   for (; n != n_i ; ++short_range_f, ++large_range_f, ++n){
      hboost::adl_move_swap(*short_range_f, *large_range_f);
   }
   hboost::container::uninitialized_move_alloc_n(a, large_range_f, n_j - n_i, short_range_f);  // may throw
   hboost::container::destroy_alloc_n(a, large_range_f, n_j - n_i);
}
                    ...
                    , G large_range_f, typename allocator_traits<Allocator>::size_type n_j)
{
   ...
   hboost::container::iterator_advance(large_range_f, n_i);
   hboost::container::iterator_advance(short_range_f, n_i);
   hboost::container::uninitialized_move_alloc_n(a, large_range_f, n_j - n_i, short_range_f);  // may throw
   hboost::container::destroy_alloc_n(a, large_range_f, n_j - n_i);
}
...
{
   if (n_o < n_i){
      inp_start = hboost::container::copy_n_source_dest(inp_start, n_o, out_start);     // may throw
      hboost::container::uninitialized_copy_alloc_n(a, inp_start, n_i - n_o, out_start);// may throw
   }
   else{
      out_start = hboost::container::copy_n(inp_start, n_i, out_start);  // may throw
      hboost::container::destroy_alloc_n(a, out_start, n_o - n_i);
   }
}
...
{
   if (n_o < n_i){
      inp_start = hboost::container::move_n_source_dest(inp_start, n_o, out_start);  // may throw
      hboost::container::uninitialized_move_alloc_n(a, inp_start, n_i - n_o, out_start);  // may throw
   }
   else{
      out_start = hboost::container::move_n(inp_start, n_i, out_start);  // may throw
      hboost::container::destroy_alloc_n(a, out_start, n_o - n_i);
   }
}
...
#endif   //#ifndef HBOOST_CONTAINER_DETAIL_UTILITIES_HPP
