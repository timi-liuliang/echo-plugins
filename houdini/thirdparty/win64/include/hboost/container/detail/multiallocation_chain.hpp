...
#ifndef HBOOST_CONTAINER_DETAIL_MULTIALLOCATION_CHAIN_HPP
#define HBOOST_CONTAINER_DETAIL_MULTIALLOCATION_CHAIN_HPP
...
#include <hboost/container/detail/transform_iterator.hpp>
...
class basic_multiallocation_chain
{
   ...
   typedef bi::slist< node
                    , bi::linear<true>
                    , bi::cache_last<true>
                    , bi::size_type<typename hboost::container::container_detail::make_unsigned<difference_type>::type>
                    > slist_impl_t;
   ...
   basic_multiallocation_chain(HBOOST_RV_REF(basic_multiallocation_chain) other)
      :  slist_impl_(::hboost::move(other.slist_impl_))
   {}
   ...
   {
      typedef typename hboost::intrusive::pointer_traits<char_ptr> char_pointer_traits;
...
{
   private:
   HBOOST_MOVABLE_BUT_NOT_COPYABLE(transform_multiallocation_chain)
   ...
   transform_multiallocation_chain(HBOOST_RV_REF(transform_multiallocation_chain) other)
      : MultiallocationChain(::hboost::move(static_cast<MultiallocationChain&>(other)))
   {}

   transform_multiallocation_chain(HBOOST_RV_REF(MultiallocationChain) other)
      : MultiallocationChain(::hboost::move(static_cast<MultiallocationChain&>(other)))
   {}

   transform_multiallocation_chain& operator=(HBOOST_RV_REF(transform_multiallocation_chain) other)
   {
      return static_cast<MultiallocationChain&>
         (this->MultiallocationChain::operator=(::hboost::move(static_cast<MultiallocationChain&>(other))));
   }
/*
...
#endif   //HBOOST_CONTAINER_DETAIL_MULTIALLOCATION_CHAIN_HPP
