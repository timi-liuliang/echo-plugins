...
#ifndef HBOOST_CONTAINER_POOL_RESOURCE_HPP
#define HBOOST_CONTAINER_POOL_RESOURCE_HPP
...
#include <hboost/container/detail/block_list.hpp>
#include <hboost/container/pmr/pool_options.hpp>
...
class pool_resource
{
   ...
   pool_resource(const pool_options& opts, memory_resource* upstream) HBOOST_NOEXCEPT;

   //! <b>Effects</b>: Same as
   //!   `pool_resource(pool_options(), get_default_resource())`.
   pool_resource() HBOOST_NOEXCEPT;

   //! <b>Effects</b>: Same as
   //!   `pool_resource(pool_options(), upstream)`.
   explicit pool_resource(memory_resource* upstream) HBOOST_NOEXCEPT;

   //! <b>Effects</b>: Same as
   //!   `pool_resource(opts, get_default_resource())`.
   explicit pool_resource(const pool_options& opts) HBOOST_NOEXCEPT;
...
#endif   //HBOOST_CONTAINER_POOL_RESOURCE_HPP
