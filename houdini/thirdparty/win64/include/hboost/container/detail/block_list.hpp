...
#ifndef HBOOST_CONTAINER_DETAIL_BLOCK_LIST_HEADER
#define HBOOST_CONTAINER_DETAIL_BLOCK_LIST_HEADER
...
class block_list_base
{
   ...
   void deallocate(void *p, memory_resource &mr) HBOOST_NOEXCEPT
   {
...
#endif   //HBOOST_CONTAINER_DETAIL_BLOCK_LIST_HEADER
