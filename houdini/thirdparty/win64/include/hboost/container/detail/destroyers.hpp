...
#ifndef HBOOST_CONTAINER_DESTROYERS_HPP
#define HBOOST_CONTAINER_DESTROYERS_HPP
...
struct scoped_deallocator
{
   ...
   HBOOST_MOVABLE_BUT_NOT_COPYABLE(scoped_deallocator)
   ...
   scoped_deallocator(HBOOST_RV_REF(scoped_deallocator) o)
...
{
   typedef hboost::container::allocator_traits<Allocator> AllocTraits;
...
#endif   //#ifndef HBOOST_CONTAINER_DESTROYERS_HPP
