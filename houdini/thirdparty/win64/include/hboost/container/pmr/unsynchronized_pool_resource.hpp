...
#ifndef HBOOST_CONTAINER_PMR_UNSYNCHRONIZED_POOL_RESOURCE_HPP
#define HBOOST_CONTAINER_PMR_UNSYNCHRONIZED_POOL_RESOURCE_HPP
...
class HBOOST_CONTAINER_DECL unsynchronized_pool_resource
   : public memory_resource
{
   ...
   unsynchronized_pool_resource(const pool_options& opts, memory_resource* upstream) HBOOST_NOEXCEPT;

   //! <b>Effects</b>: Same as
   //!   `unsynchronized_pool_resource(pool_options(), get_default_resource())`.
   unsynchronized_pool_resource() HBOOST_NOEXCEPT;

   //! <b>Effects</b>: Same as
   //!   `unsynchronized_pool_resource(pool_options(), upstream)`.
   explicit unsynchronized_pool_resource(memory_resource* upstream) HBOOST_NOEXCEPT;

   //! <b>Effects</b>: Same as
   //!   `unsynchronized_pool_resource(opts, get_default_resource())`.
   explicit unsynchronized_pool_resource(const pool_options& opts) HBOOST_NOEXCEPT;
...
#endif   //HBOOST_CONTAINER_PMR_UNSYNCHRONIZED_POOL_RESOURCE_HPP
