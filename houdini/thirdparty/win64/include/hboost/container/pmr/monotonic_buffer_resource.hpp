...
#ifndef HBOOST_CONTAINER_PMR_MONOTONIC_BUFFER_RESOURCE_HPP
#define HBOOST_CONTAINER_PMR_MONOTONIC_BUFFER_RESOURCE_HPP
...
#include <hboost/container/detail/block_slist.hpp>
...
class HBOOST_CONTAINER_DECL monotonic_buffer_resource
   : public memory_resource
{
   ...
   explicit monotonic_buffer_resource(memory_resource* upstream = 0) HBOOST_NOEXCEPT;
   ...
   explicit monotonic_buffer_resource(std::size_t initial_size, memory_resource* upstream = 0) HBOOST_NOEXCEPT;
   ...
   monotonic_buffer_resource(void* buffer, std::size_t buffer_size, memory_resource* upstream = 0) HBOOST_NOEXCEPT;
   ...
   void release() HBOOST_NOEXCEPT;

   //! <b>Returns</b>: The value of
   //!   the internal resource.
   memory_resource* upstream_resource() const HBOOST_NOEXCEPT;
   ...
   //!
   //! <b>Note</b>: Non-standard extension.
   std::size_t remaining_storage(std::size_t alignment, std::size_t &wasted_due_to_alignment) const HBOOST_NOEXCEPT;
   
   //! <b>Returns</b>:
   //!   The number of bytes of storage available for the specified alignment.
   //!
   //! <b>Note</b>: Non-standard extension.
   std::size_t remaining_storage(std::size_t alignment = 1u) const HBOOST_NOEXCEPT;

   //! <b>Returns</b>:
   //!   The number of bytes of storage available for the specified alignment.
   //!
   //! <b>Note</b>: Non-standard extension.
   const void *current_buffer() const HBOOST_NOEXCEPT;
   ...
   //!
   //! <b>Note</b>: Non-standard extension.
   std::size_t next_buffer_size() const HBOOST_NOEXCEPT;
   ...
   virtual void do_deallocate(void* p, std::size_t bytes, std::size_t alignment) HBOOST_NOEXCEPT;
...
#endif   //HBOOST_CONTAINER_PMR_MONOTONIC_BUFFER_RESOURCE_HPP
