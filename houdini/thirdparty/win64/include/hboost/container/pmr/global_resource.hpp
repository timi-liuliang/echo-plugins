...
#ifndef HBOOST_CONTAINER_PMR_GLOBAL_RESOURCE_HPP
#define HBOOST_CONTAINER_PMR_GLOBAL_RESOURCE_HPP
...
HBOOST_CONTAINER_DECL memory_resource* new_delete_resource() HBOOST_NOEXCEPT;
...
//!   is called. For return value p and memory resource r, p->is_equal(r) returns &r == p.
HBOOST_CONTAINER_DECL memory_resource* null_memory_resource() HBOOST_NOEXCEPT;
...
HBOOST_CONTAINER_DECL memory_resource* set_default_resource(memory_resource* r) HBOOST_NOEXCEPT;

//! <b>Returns</b>: The current value of the default
//!   memory resource pointer.
HBOOST_CONTAINER_DECL memory_resource* get_default_resource() HBOOST_NOEXCEPT;
...
#endif   //HBOOST_CONTAINER_PMR_GLOBAL_RESOURCE_HPP
