...
#ifndef HBOOST_CONTAINER_CONTAINER_SMALL_VECTOR_HPP
#define HBOOST_CONTAINER_CONTAINER_SMALL_VECTOR_HPP
...
//!
//! `hboost::container::vector` supports partially propagable allocators
...
//! `hboost::container::vector< T, small_vector_allocator<Allocator> >`
   ...
   : public Allocator
{
   ...
   HBOOST_COPYABLE_AND_MOVABLE(small_vector_allocator)

   HBOOST_CONTAINER_FORCEINLINE const Allocator &as_base() const
   {  return static_cast<const Allocator&>(*this);  }

   HBOOST_CONTAINER_FORCEINLINE Allocator &as_base() 
   ...
   typedef HBOOST_CONTAINER_IMPDEF(container_detail::bool_<false>)                         is_always_equal;
   //! An integral constant with member `value == true`
   typedef HBOOST_CONTAINER_IMPDEF(container_detail::bool_<true>)                          is_partially_propagable;

   HBOOST_CONTAINER_DOCIGN(typedef container_detail::version_type<small_vector_allocator HBOOST_CONTAINER_I 1>  version;)
   ...
   struct rebind
   {
      ...
      template<class ...Args>
      HBOOST_CONTAINER_FORCEINLINE explicit small_vector_allocator(HBOOST_FWD_REF(Args) ...args)
         : Allocator(::hboost::forward<Args>(args)...)
      {}
   #else
      #define HBOOST_CONTAINER_SMALL_VECTOR_ALLOCATOR_CTOR_CODE(N) \
      HBOOST_MOVE_TMPL_LT##N HBOOST_MOVE_CLASS##N HBOOST_MOVE_GT##N \
      HBOOST_CONTAINER_FORCEINLINE explicit small_vector_allocator(HBOOST_MOVE_UREF##N)\
         : Allocator(HBOOST_MOVE_FWD##N)\
      {}\
      //
      HBOOST_MOVE_ITERATE_0TO9(HBOOST_CONTAINER_SMALL_VECTOR_ALLOCATOR_CTOR_CODE)
      #undef HBOOST_CONTAINER_SMALL_VECTOR_ALLOCATOR_CTOR_CODE
   #endif

   //!Constructor from other small_vector_allocator.
   //!Never throws
   HBOOST_CONTAINER_FORCEINLINE small_vector_allocator
      (const small_vector_allocator &other) HBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!Never throws
   HBOOST_CONTAINER_FORCEINLINE small_vector_allocator
      (HBOOST_RV_REF(small_vector_allocator) other) HBOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(::hboost::move(other.as_base()))
   {}
   ...
   HBOOST_CONTAINER_FORCEINLINE small_vector_allocator
      (const small_vector_allocator<OtherAllocator> &other) HBOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(other.as_base())
   {}
   ...
   template<class OtherAllocator>
   HBOOST_CONTAINER_FORCEINLINE small_vector_allocator
      (HBOOST_RV_REF(small_vector_allocator<OtherAllocator>) other) HBOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(::hboost::move(other.as_base()))
   {}
   ...
   //!Never throws
   HBOOST_CONTAINER_FORCEINLINE small_vector_allocator &
      operator=(HBOOST_COPY_ASSIGN_REF(small_vector_allocator) other) HBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!Never throws
   HBOOST_CONTAINER_FORCEINLINE small_vector_allocator &
      operator=(HBOOST_RV_REF(small_vector_allocator) other) HBOOST_NOEXCEPT_OR_NOTHROW
   {  return static_cast<small_vector_allocator&>(this->Allocator::operator=(::hboost::move(other.as_base())));  }

   //!Assignment from related small_vector_allocator.
   //!Never throws
   template<class OtherAllocator>
   HBOOST_CONTAINER_FORCEINLINE small_vector_allocator &
      operator=(HBOOST_COPY_ASSIGN_REF(small_vector_allocator<OtherAllocator>) other) HBOOST_NOEXCEPT_OR_NOTHROW
   {  return static_cast<small_vector_allocator&>(this->Allocator::operator=(other.as_base()));  }
   ...
   template<class OtherAllocator>
   HBOOST_CONTAINER_FORCEINLINE small_vector_allocator &
      operator=(HBOOST_RV_REF(small_vector_allocator<OtherAllocator>) other) HBOOST_NOEXCEPT_OR_NOTHROW
   {  return static_cast<small_vector_allocator&>(this->Allocator::operator=(::hboost::move(other.as_base())));  }

   //!Allocates storage from the standard-conforming allocator
   HBOOST_CONTAINER_FORCEINLINE pointer allocate(size_type count, const_void_pointer hint = const_void_pointer())
   {  return allocator_traits_type::allocate(this->as_base(), count, hint);  }

   //!Deallocates previously allocated memory.
   //!Never throws
   void deallocate(pointer ptr, size_type n) HBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   HBOOST_CONTAINER_FORCEINLINE friend void swap(small_vector_allocator &l, small_vector_allocator &r) HBOOST_NOEXCEPT_OR_NOTHROW
   {  hboost::adl_move_swap(l.as_base(), r.as_base());  }
   ...
   HBOOST_CONTAINER_FORCEINLINE friend bool operator==(const small_vector_allocator &l, const small_vector_allocator &r) HBOOST_NOEXCEPT_OR_NOTHROW
   ...
   */
   ...
   HBOOST_CONTAINER_FORCEINLINE bool is_internal_storage(pointer p) const
...
//! </pre>
//!
//! All `hboost::container:vector` member functions are inherited. See `vector` documentation for details.
//!
   ...
   : public vector<T, small_vector_allocator<SecondaryAllocator> >
{
   ...
   private: 
   HBOOST_COPYABLE_AND_MOVABLE(small_vector_base)

   friend class small_vector_allocator<SecondaryAllocator>;

   pointer internal_storage() const HBOOST_NOEXCEPT_OR_NOTHROW
   {
      return hboost::intrusive::pointer_traits<pointer>::pointer_to
   ...
   HBOOST_CONTAINER_FORCEINLINE explicit small_vector_base(initial_capacity_t, std::size_t initial_capacity)
      : base_type(initial_capacity_t(), this->internal_storage(), initial_capacity)
   {}

   template<class AllocFwd>
   HBOOST_CONTAINER_FORCEINLINE explicit small_vector_base(initial_capacity_t, std::size_t capacity, HBOOST_FWD_REF(AllocFwd) a)
      : base_type(initial_capacity_t(), this->internal_storage(), capacity, ::hboost::forward<AllocFwd>(a))
   {}
   ...
   public:
   HBOOST_CONTAINER_FORCEINLINE small_vector_base& operator=(HBOOST_COPY_ASSIGN_REF(small_vector_base) other)
   {  return static_cast<small_vector_base&>(this->base_type::operator=(static_cast<base_type const&>(other)));  }

   HBOOST_CONTAINER_FORCEINLINE small_vector_base& operator=(HBOOST_RV_REF(small_vector_base) other)
   {  return static_cast<small_vector_base&>(this->base_type::operator=(HBOOST_MOVE_BASE(base_type, other))); }

   HBOOST_CONTAINER_FORCEINLINE void swap(small_vector_base &other)
...
template <class T, std::size_t N, class Allocator HBOOST_CONTAINER_DOCONLY(= new_allocator<T>) >
   ...
   #endif
{
   ...
   HBOOST_COPYABLE_AND_MOVABLE(small_vector)
   ...
   HBOOST_CONTAINER_FORCEINLINE static std::size_t internal_capacity()
   {  return (sizeof(small_vector) - storage_test::s_start)/sizeof(T);  }

   #endif   //#ifndef HBOOST_CONTAINER_DOXYGEN_INVOKED

   public:
   HBOOST_CONTAINER_FORCEINLINE small_vector()
      : base_type(initial_capacity_t(), internal_capacity())
   {}

   HBOOST_CONTAINER_FORCEINLINE explicit small_vector(const allocator_type &a)
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {}

   HBOOST_CONTAINER_FORCEINLINE explicit small_vector(size_type n)
      : base_type(initial_capacity_t(), internal_capacity())
   {  this->resize(n); }

   HBOOST_CONTAINER_FORCEINLINE small_vector(size_type n, const allocator_type &a)
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {  this->resize(n); }

   HBOOST_CONTAINER_FORCEINLINE small_vector(size_type n, default_init_t)
      : base_type(initial_capacity_t(), internal_capacity())
   {  this->resize(n, default_init_t()); }

   HBOOST_CONTAINER_FORCEINLINE small_vector(size_type n, default_init_t, const allocator_type &a)
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {  this->resize(n, default_init_t()); }

   HBOOST_CONTAINER_FORCEINLINE small_vector(size_type n, const value_type &v)
      : base_type(initial_capacity_t(), internal_capacity())
   {  this->resize(n, v); }
   ...
   template <class InIt>
   HBOOST_CONTAINER_FORCEINLINE small_vector(InIt first, InIt last, const allocator_type& a
      HBOOST_CONTAINER_DOCIGN(HBOOST_MOVE_I typename container_detail::disable_if_c
         < container_detail::is_convertible<InIt HBOOST_MOVE_I size_type>::value
         HBOOST_MOVE_I container_detail::nat >::type * = 0)
      )
   ...
   HBOOST_CONTAINER_FORCEINLINE small_vector(const small_vector &other)
      : base_type( initial_capacity_t(), internal_capacity()
                 , allocator_traits_type::select_on_container_copy_construction(other.get_stored_allocator()))
   {  this->assign(other.cbegin(), other.cend());  }

   HBOOST_CONTAINER_FORCEINLINE small_vector(const small_vector &other, const allocator_type &a)
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {  this->assign(other.cbegin(), other.cend());  }

   HBOOST_CONTAINER_FORCEINLINE explicit small_vector(const base_type &other)
      : base_type( initial_capacity_t(), internal_capacity()
                 , allocator_traits_type::select_on_container_copy_construction(other.get_stored_allocator()))
   {  this->assign(other.cbegin(), other.cend());  }

   HBOOST_CONTAINER_FORCEINLINE explicit small_vector(HBOOST_RV_REF(base_type) other)
      : base_type(initial_capacity_t(), internal_capacity(), ::hboost::move(other.get_stored_allocator()))
   {  this->move_construct_impl(other, other.get_stored_allocator());   }

   HBOOST_CONTAINER_FORCEINLINE small_vector(HBOOST_RV_REF(small_vector) other)
      : base_type(initial_capacity_t(), internal_capacity(), ::hboost::move(other.get_stored_allocator()))
   {  this->move_construct_impl(other, other.get_stored_allocator());   }

   HBOOST_CONTAINER_FORCEINLINE small_vector(HBOOST_RV_REF(small_vector) other, const allocator_type &a)
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {  this->move_construct_impl(other, a);   }

   #if !defined(HBOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   HBOOST_CONTAINER_FORCEINLINE small_vector(std::initializer_list<value_type> il, const allocator_type& a = allocator_type())
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {
   ...
   HBOOST_CONTAINER_FORCEINLINE small_vector& operator=(HBOOST_COPY_ASSIGN_REF(small_vector) other)
   {  return static_cast<small_vector&>(this->base_type::operator=(static_cast<base_type const&>(other)));  }

   HBOOST_CONTAINER_FORCEINLINE small_vector& operator=(HBOOST_RV_REF(small_vector) other)
   {  return static_cast<small_vector&>(this->base_type::operator=(HBOOST_MOVE_BASE(base_type, other))); }

   HBOOST_CONTAINER_FORCEINLINE small_vector& operator=(const base_type &other)
   {  return static_cast<small_vector&>(this->base_type::operator=(other));  }

   HBOOST_CONTAINER_FORCEINLINE small_vector& operator=(HBOOST_RV_REF(base_type) other)
   {  return static_cast<small_vector&>(this->base_type::operator=(hboost::move(other))); }

   HBOOST_CONTAINER_FORCEINLINE void swap(small_vector &other)
   {  return this->base_type::swap(other);  }
};
...
#endif //   #ifndef  HBOOST_CONTAINER_CONTAINER_SMALL_VECTOR_HPP
