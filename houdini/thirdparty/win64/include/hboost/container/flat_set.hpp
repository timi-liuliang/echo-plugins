...
//
//////////////////////////////////////////////////////////////////////////////
#ifndef HBOOST_CONTAINER_FLAT_SET_HPP
#define HBOOST_CONTAINER_FLAT_SET_HPP
...
// container/detail
#include <hboost/container/detail/flat_tree.hpp>
   ...
   ///@endcond
{
   ...
   private:
   HBOOST_COPYABLE_AND_MOVABLE(flat_set)
   ...
   flat_set(HBOOST_RV_REF(flat_set) x)
   ...
   flat_set(HBOOST_RV_REF(flat_set) x, const allocator_type &a)
   ...
   //!
   //! <b>Complexity</b>: Linear in x.size().
   flat_set& operator=(HBOOST_COPY_ASSIGN_REF(flat_set) x)
   ...
   flat_set& operator=(HBOOST_RV_REF(flat_set) x)
   ...
   {  return static_cast<flat_set&>(this->base_t::operator=(HBOOST_MOVE_BASE(base_t, x)));  }
   ...
   #define HBOOST_CONTAINER_FLAT_SET_EMPLACE_CODE(N) \
   ...
   //
   HBOOST_MOVE_ITERATE_0TO9(HBOOST_CONTAINER_FLAT_SET_EMPLACE_CODE)
   #undef HBOOST_CONTAINER_FLAT_SET_EMPLACE_CODE
   ...
   #endif   //#ifdef HBOOST_CONTAINER_DOXYGEN_INVOKED
...
template <class Key, class Compare, class Allocator>
struct has_trivial_destructor_after_move<hboost::container::flat_set<Key, Compare, Allocator> >
{
   typedef typename ::hboost::container::allocator_traits<Allocator>::pointer pointer;
   ...
   ///@endcond
{
   #ifndef HBOOST_CONTAINER_DOXYGEN_INVOKED
   private:
   HBOOST_COPYABLE_AND_MOVABLE(flat_multiset)
   typedef container_detail::flat_tree<Key, Key, container_detail::identity<Key>, Compare, Allocator> base_t;
   #endif   //#ifndef HBOOST_CONTAINER_DOXYGEN_INVOKED
   ...
   //! @copydoc ::hboost::container::flat_set::flat_set()
   explicit flat_multiset()
      : base_t()
   {}

   //! @copydoc ::hboost::container::flat_set::flat_set(const Compare&, const allocator_type&)
   explicit flat_multiset(const Compare& comp,
                          const allocator_type& a = allocator_type())
      : base_t(comp, a)
   {}

   //! @copydoc ::hboost::container::flat_set::flat_set(const allocator_type&)
   explicit flat_multiset(const allocator_type& a)
      : base_t(a)
   {}

   //! @copydoc ::hboost::container::flat_set::flat_set(InputIterator, InputIterator, const Compare& comp, const allocator_type&)
   template <class InputIterator>
   ...
   //! @copydoc ::hboost::container::flat_set::flat_set(InputIterator, InputIterator, const allocator_type&)
   template <class InputIterator>
...
#if !defined(HBOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::hboost::container::flat_set::flat_set(std::initializer_list<value_type>, const Compare& comp, const allocator_type&)
   flat_multiset(std::initializer_list<value_type> il, const Compare& comp = Compare(),
            const allocator_type& a = allocator_type())
      : base_t(false, il.begin(), il.end(), comp, a)
   {}

   //! @copydoc ::hboost::container::flat_set::flat_set(std::initializer_list<value_type>, const allocator_type&)
   flat_multiset(std::initializer_list<value_type> il, const allocator_type& a)
      : base_t(false, il.begin(), il.end(), Compare(), a)
   {}

   //! @copydoc ::hboost::container::flat_set::flat_set(ordered_unique_range_t, std::initializer_list<value_type>, const Compare& comp, const allocator_type&)
   ...
   //! @copydoc ::hboost::container::flat_set::flat_set(const flat_set &)
   flat_multiset(const flat_multiset& x)
      : base_t(static_cast<const base_t&>(x))
   {}

   //! @copydoc ::hboost::container::flat_set::flat_set(flat_set &&)
   flat_multiset(HBOOST_RV_REF(flat_multiset) x)
      : base_t(hboost::move(static_cast<base_t&>(x)))
   {}

   //! @copydoc ::hboost::container::flat_set::flat_set(const flat_set &, const allocator_type &)
   flat_multiset(const flat_multiset& x, const allocator_type &a)
      : base_t(static_cast<const base_t&>(x), a)
   {}

   //! @copydoc ::hboost::container::flat_set::flat_set(flat_set &&, const allocator_type &)
   flat_multiset(HBOOST_RV_REF(flat_multiset) x, const allocator_type &a)
      : base_t(HBOOST_MOVE_BASE(base_t, x), a)
   {}

   //! @copydoc ::hboost::container::flat_set::operator=(const flat_set &)
   flat_multiset& operator=(HBOOST_COPY_ASSIGN_REF(flat_multiset) x)
   {  return static_cast<flat_multiset&>(this->base_t::operator=(static_cast<const base_t&>(x)));  }

   //! @copydoc ::hboost::container::flat_set::operator=(flat_set &&)
   flat_multiset& operator=(HBOOST_RV_REF(flat_multiset) x)
      HBOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && hboost::container::container_detail::is_nothrow_move_assignable<Compare>::value )
   {  return static_cast<flat_multiset&>(this->base_t::operator=(HBOOST_MOVE_BASE(base_t, x)));  }

#if !defined(HBOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::hboost::container::flat_set::operator=(std::initializer_list<value_type>)
   ...
   //! @copydoc ::hboost::container::flat_set::get_allocator()
   allocator_type get_allocator() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::get_stored_allocator()
   stored_allocator_type &get_stored_allocator() HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::get_stored_allocator() const
   const stored_allocator_type &get_stored_allocator() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::begin()
   iterator begin() HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::begin() const
   const_iterator begin() const;

   //! @copydoc ::hboost::container::flat_set::cbegin() const
   const_iterator cbegin() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::end()
   iterator end() HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::end() const
   const_iterator end() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::cend() const
   const_iterator cend() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::rbegin()
   reverse_iterator rbegin() HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::rbegin() const
   const_reverse_iterator rbegin() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::crbegin() const
   const_reverse_iterator crbegin() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::rend()
   reverse_iterator rend() HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::rend() const
   const_reverse_iterator rend() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::crend() const
   const_reverse_iterator crend() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::empty() const
   bool empty() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::size() const
   size_type size() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::max_size() const
   size_type max_size() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::capacity() const
   size_type capacity() const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::reserve(size_type)
   void reserve(size_type cnt);

   //! @copydoc ::hboost::container::flat_set::shrink_to_fit()
   void shrink_to_fit();
   ...
   #define HBOOST_CONTAINER_FLAT_MULTISET_EMPLACE_CODE(N) \
   HBOOST_MOVE_TMPL_LT##N HBOOST_MOVE_CLASS##N HBOOST_MOVE_GT##N \
   ...
   //
   HBOOST_MOVE_ITERATE_0TO9(HBOOST_CONTAINER_FLAT_MULTISET_EMPLACE_CODE)
   #undef HBOOST_CONTAINER_FLAT_MULTISET_EMPLACE_CODE
   ...
   //! @copydoc ::hboost::container::flat_set::erase(const_iterator)
   iterator erase(const_iterator p);

   //! @copydoc ::hboost::container::flat_set::erase(const key_type&)
   size_type erase(const key_type& x);

   //! @copydoc ::hboost::container::flat_set::erase(const_iterator,const_iterator)
   iterator erase(const_iterator first, const_iterator last);

   //! @copydoc ::hboost::container::flat_set::swap
   void swap(flat_multiset& x)
      HBOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && hboost::container::container_detail::is_nothrow_swappable<Compare>::value );

   //! @copydoc ::hboost::container::flat_set::clear
   void clear() HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::key_comp
   key_compare key_comp() const;

   //! @copydoc ::hboost::container::flat_set::value_comp
   value_compare value_comp() const;

   //! @copydoc ::hboost::container::flat_set::find(const key_type& )
   iterator find(const key_type& x);

   //! @copydoc ::hboost::container::flat_set::find(const key_type& ) const
   const_iterator find(const key_type& x) const;

   //! @copydoc ::hboost::container::flat_set::nth(size_type)
   iterator nth(size_type n) HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::nth(size_type) const
   const_iterator nth(size_type n) const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::index_of(iterator)
   size_type index_of(iterator p) HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::index_of(const_iterator) const
   size_type index_of(const_iterator p) const HBOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::hboost::container::flat_set::count(const key_type& ) const
   size_type count(const key_type& x) const;

   //! @copydoc ::hboost::container::flat_set::lower_bound(const key_type& )
   iterator lower_bound(const key_type& x);

   //! @copydoc ::hboost::container::flat_set::lower_bound(const key_type& ) const
   const_iterator lower_bound(const key_type& x) const;

   //! @copydoc ::hboost::container::flat_set::upper_bound(const key_type& )
   iterator upper_bound(const key_type& x);

   //! @copydoc ::hboost::container::flat_set::upper_bound(const key_type& ) const
   const_iterator upper_bound(const key_type& x) const;

   //! @copydoc ::hboost::container::flat_set::equal_range(const key_type& ) const
   std::pair<const_iterator, const_iterator> equal_range(const key_type& x) const;

   //! @copydoc ::hboost::container::flat_set::equal_range(const key_type& )
   std::pair<iterator,iterator> equal_range(const key_type& x);
...
//!specialization for optimizations
template <class Key, class Compare, class Allocator>
struct has_trivial_destructor_after_move<hboost::container::flat_multiset<Key, Compare, Allocator> >
{
   typedef typename ::hboost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::hboost::has_trivial_destructor_after_move<Allocator>::value &&
                             ::hboost::has_trivial_destructor_after_move<pointer>::value &&
...
#endif   // HBOOST_CONTAINER_FLAT_SET_HPP
