...
#ifndef HBOOST_CONTAINER_STATIC_VECTOR_HPP
#define HBOOST_CONTAINER_STATIC_VECTOR_HPP
...
class static_storage_allocator
{
   ...
   HBOOST_CONTAINER_FORCEINLINE static_storage_allocator() HBOOST_NOEXCEPT_OR_NOTHROW
   {}

   HBOOST_CONTAINER_FORCEINLINE static_storage_allocator(const static_storage_allocator &) HBOOST_NOEXCEPT_OR_NOTHROW
   {}

   HBOOST_CONTAINER_FORCEINLINE static_storage_allocator & operator=(const static_storage_allocator &) HBOOST_NOEXCEPT_OR_NOTHROW
   {  return *this;  }

   HBOOST_CONTAINER_FORCEINLINE T* internal_storage() const HBOOST_NOEXCEPT_OR_NOTHROW
   {  return const_cast<T*>(static_cast<const T*>(static_cast<const void*>(&storage)));  }

   HBOOST_CONTAINER_FORCEINLINE T* internal_storage() HBOOST_NOEXCEPT_OR_NOTHROW
   ...
   typedef hboost::container::container_detail::version_type<static_storage_allocator, 0>   version;

   HBOOST_CONTAINER_FORCEINLINE friend bool operator==(const static_storage_allocator &, const static_storage_allocator &) HBOOST_NOEXCEPT_OR_NOTHROW
   {  return false;  }
...
//!
//!static_vector is a sequence container like hboost::container::vector with contiguous storage that can
//!change in size, along with the static allocation, low overhead, and fixed capacity of hboost::array.
//!
    ...
    : public vector<Value, container_detail::static_storage_allocator<Value, Capacity> >
{
   ...
   HBOOST_COPYABLE_AND_MOVABLE(static_vector)
...
public:
    ...
    //! @par Complexity
    //!   Constant O(1).
    HBOOST_CONTAINER_FORCEINLINE static_vector() HBOOST_NOEXCEPT_OR_NOTHROW
        : base_t()
    {}
    ...
    //! @par Complexity
    //!   Linear O(N).
    HBOOST_CONTAINER_FORCEINLINE explicit static_vector(size_type count)
        : base_t(count)
    {}
    ...
    HBOOST_CONTAINER_FORCEINLINE static_vector(size_type count, default_init_t)
    ...
    //! @par Complexity
    //!   Linear O(N).
    HBOOST_CONTAINER_FORCEINLINE static_vector(size_type count, value_type const& value)
        : base_t(count, value)
    {}
    ...
    HBOOST_CONTAINER_FORCEINLINE static_vector(Iterator first, Iterator last)
        : base_t(first, last)
    {}
    ...
    //! @par Complexity
    //!   Linear O(N).
    HBOOST_CONTAINER_FORCEINLINE static_vector(std::initializer_list<value_type> il)
        : base_t(il)
    {}
#endif
    ...
    //! @par Complexity
    //!   Linear O(N).
    HBOOST_CONTAINER_FORCEINLINE static_vector(static_vector const& other)
        : base_t(other)
    {}
    ...
    HBOOST_CONTAINER_FORCEINLINE static_vector(static_vector<value_type, C> const& other)
        : base_t(other)
    {}
    ...
    //! @par Complexity
    //!   Linear O(N).
    HBOOST_CONTAINER_FORCEINLINE static_vector(HBOOST_RV_REF(static_vector) other)
    ...
    //!   Linear O(N).
    template <std::size_t C>
    HBOOST_CONTAINER_FORCEINLINE static_vector(HBOOST_RV_REF_BEG static_vector<value_type, C> HBOOST_RV_REF_END other)
        : base_t(HBOOST_MOVE_BASE(typename static_vector<value_type HBOOST_MOVE_I C>::base_t, other))
    {}
    ...
    //! @par Complexity
    //! Linear O(N).
    HBOOST_CONTAINER_FORCEINLINE static_vector & operator=(HBOOST_COPY_ASSIGN_REF(static_vector) other)
    {
    ...
    //! @par Complexity
    //! Linear O(N).
    HBOOST_CONTAINER_FORCEINLINE static_vector & operator=(std::initializer_list<value_type> il)
    ...
    //!   Linear O(N).
    template <std::size_t C>
    HBOOST_CONTAINER_FORCEINLINE static_vector & operator=(static_vector<value_type, C> const& other)
    {
    ...
    //! @par Complexity
    //!   Linear O(N).
    HBOOST_CONTAINER_FORCEINLINE static_vector & operator=(HBOOST_RV_REF(static_vector) other)
    {
        return static_cast<static_vector&>(base_t::operator=(HBOOST_MOVE_BASE(base_t, other)));
    }
    ...
    //!   Linear O(N).
    template <std::size_t C>
    HBOOST_CONTAINER_FORCEINLINE static_vector & operator=(HBOOST_RV_REF_BEG static_vector<value_type, C> HBOOST_RV_REF_END other)
    {
        return static_cast<static_vector&>(base_t::operator=
         (HBOOST_MOVE_BASE(typename static_vector<value_type HBOOST_MOVE_I C>::base_t, other)));
    }
    ...
    //! @par Complexity
    //!   Linear O(N).
    void reserve(size_type count)  HBOOST_NOEXCEPT_OR_NOTHROW;
    ...
    //! @par Complexity
    //!   Constant O(1).
    void push_back(HBOOST_RV_REF(value_type) value);
    ...
    //! @par Complexity
    //!   Constant or linear.
    iterator insert(const_iterator p, HBOOST_RV_REF(value_type) value);
    ...
    //! @par Complexity
    //!   Constant O(1).
    Value * data() HBOOST_NOEXCEPT_OR_NOTHROW;
    ...
    //! @par Complexity
    //!   Constant O(1).
    const Value * data() const HBOOST_NOEXCEPT_OR_NOTHROW;
    ...
    //! @par Complexity
    //!   Constant O(1).
    static size_type capacity() HBOOST_NOEXCEPT_OR_NOTHROW;
    ...
    //! @par Complexity
    //!   Constant O(1).
    static size_type max_size() HBOOST_NOEXCEPT_OR_NOTHROW;
   ...
   HBOOST_CONTAINER_FORCEINLINE friend void swap(static_vector &x, static_vector &y)
   {
      x.swap(y);
   }
...
#endif // HBOOST_CONTAINER_STATIC_VECTOR_HPP
