...
//
//////////////////////////////////////////////////////////////////////////////
#ifndef HBOOST_CONTAINER_FLAT_MAP_HPP
#define HBOOST_CONTAINER_FLAT_MAP_HPP
...
class flat_map
{
   #ifndef HBOOST_CONTAINER_DOXYGEN_INVOKED
   private:
   HBOOST_COPYABLE_AND_MOVABLE(flat_map)
   ...
   typedef HBOOST_CONTAINER_IMPDEF(Allocator)                                        stored_allocator_type;
   ...
   typedef HBOOST_CONTAINER_IMPDEF(reverse_iterator_impl)                            reverse_iterator;
   typedef HBOOST_CONTAINER_IMPDEF(const_reverse_iterator_impl)                      const_reverse_iterator;
   typedef HBOOST_CONTAINER_IMPDEF(impl_value_type)                                  movable_value_type;
      ...
      : m_flat_tree()
   {
      ...
      HBOOST_STATIC_ASSERT((container_detail::is_same<std::pair<Key, T>, typename Allocator::value_type>::value));
   }
   ...
   flat_map(HBOOST_RV_REF(flat_map) x)
      : m_flat_tree(hboost::move(x.m_flat_tree))
   {
      //A type must be std::pair<Key, T>
      HBOOST_STATIC_ASSERT((container_detail::is_same<std::pair<Key, T>, typename Allocator::value_type>::value));
   }
   ...
   flat_map(HBOOST_RV_REF(flat_map) x, const allocator_type &a)
      : m_flat_tree(hboost::move(x.m_flat_tree), a)
   {
      //A type must be std::pair<Key, T>
      HBOOST_STATIC_ASSERT((container_detail::is_same<std::pair<Key, T>, typename Allocator::value_type>::value));
   }
   ...
   //!
   //! <b>Complexity</b>: Linear in x.size().
   flat_map& operator=(HBOOST_COPY_ASSIGN_REF(flat_map) x)
   ...
   flat_map& operator=(HBOOST_RV_REF(flat_map) x)
   ...
   {  m_flat_tree = hboost::move(x.m_flat_tree);   return *this;  }
   ...
   {  return container_detail::force_copy< std::pair<iterator, bool> >(m_flat_tree.emplace_unique(hboost::forward<Args>(args)...)); }
   ...
   //! <b>Note</b>: If an element is inserted it might invalidate elements.
   template <class... Args>
   iterator emplace_hint(const_iterator hint, HBOOST_FWD_REF(Args)... args)
   {
   ...
   #define HBOOST_CONTAINER_FLAT_MAP_EMPLACE_CODE(N) \
   ...
   {\
      return container_detail::force_copy< std::pair<iterator, bool> >\
         (m_flat_tree.emplace_unique(HBOOST_MOVE_FWD##N));\
   }\
   \
   HBOOST_MOVE_TMPL_LT##N HBOOST_MOVE_CLASS##N HBOOST_MOVE_GT##N \
   ...
   {\
      return container_detail::force_copy<iterator>(m_flat_tree.emplace_hint_unique\
         (container_detail::force_copy<impl_const_iterator>(hint) HBOOST_MOVE_I##N HBOOST_MOVE_FWD##N));\
   }\
   //
   HBOOST_MOVE_ITERATE_0TO9(HBOOST_CONTAINER_FLAT_MAP_EMPLACE_CODE)
   #undef HBOOST_CONTAINER_FLAT_MAP_EMPLACE_CODE
   ...
   {  return container_detail::force_copy<std::pair<iterator,bool> >(
      m_flat_tree.insert_unique(hboost::move(container_detail::force<impl_value_type>(x)))); }
   ...
   {
      return container_detail::force_copy<std::pair<iterator,bool> >
      (m_flat_tree.insert_unique(hboost::move(x)));
   }
   ...
   iterator insert(const_iterator p, HBOOST_RV_REF(value_type) x)
   {
      return container_detail::force_copy<iterator>
         (m_flat_tree.insert_unique( container_detail::force_copy<impl_const_iterator>(p)
                                   , hboost::move(container_detail::force<impl_value_type>(x))));
   }
   ...
   {
      return container_detail::force_copy<iterator>(
         m_flat_tree.insert_unique(container_detail::force_copy<impl_const_iterator>(p), hboost::move(x)));
   }
   ...
   mapped_type &priv_subscript(const key_type& k)
   {
      ...
      if (i == end() || key_comp()(k, (*i).first)){
         ...
         i = insert(i, impl_value_type(k, ::hboost::move(m.m_t)));
      }
      return (*i).second;
   }
   mapped_type &priv_subscript(HBOOST_RV_REF(key_type) mk)
   {
      key_type &k = mk;
      iterator i = lower_bound(k);
      // i->first is greater than or equivalent to k.
      if (i == end() || key_comp()(k, (*i).first)){
         container_detail::value_init<mapped_type> m;
         i = insert(i, impl_value_type(hboost::move(k), ::hboost::move(m.m_t)));
      }
      return (*i).second;
   }
   #endif   //#ifndef HBOOST_CONTAINER_DOXYGEN_INVOKED
...
template <class Key, class T, class Compare, class Allocator>
struct has_trivial_destructor_after_move<hboost::container::flat_map<Key, T, Compare, Allocator> >
{
   typedef typename ::hboost::container::allocator_traits<Allocator>::pointer pointer;
...
class flat_multimap
{
   #ifndef HBOOST_CONTAINER_DOXYGEN_INVOKED
   private:
   HBOOST_COPYABLE_AND_MOVABLE(flat_multimap)
   typedef container_detail::flat_tree<Key,
                           std::pair<Key, T>,
                           container_detail::select1st< std::pair<Key, T> >,
                           Compare,
   ...
   //!
   //! <b>Postcondition</b>: x is emptied.
   flat_multimap(HBOOST_RV_REF(flat_multimap) x)
      : m_flat_tree(hboost::move(x.m_flat_tree))
   {
      //A type must be std::pair<Key, T>
      HBOOST_STATIC_ASSERT((container_detail::is_same<std::pair<Key, T>, typename Allocator::value_type>::value));
   ...
   flat_multimap(HBOOST_RV_REF(flat_multimap) x, const allocator_type &a)
      : m_flat_tree(hboost::move(x.m_flat_tree), a)
   {
      //A type must be std::pair<Key, T>
      HBOOST_STATIC_ASSERT((container_detail::is_same<std::pair<Key, T>, typename Allocator::value_type>::value));
   ...
   //!
   //! <b>Complexity</b>: Linear in x.size().
   flat_multimap& operator=(HBOOST_COPY_ASSIGN_REF(flat_multimap) x)
      {  m_flat_tree = x.m_flat_tree;   return *this;  }

   //! <b>Effects</b>: this->swap(x.get()).
   //!
   //! <b>Complexity</b>: Constant.
   flat_multimap& operator=(HBOOST_RV_REF(flat_multimap) x)
      HBOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && hboost::container::container_detail::is_nothrow_move_assignable<Compare>::value )
      {  m_flat_tree = hboost::move(x.m_flat_tree);   return *this;  }
   ...
   {  return container_detail::force_copy<iterator>(m_flat_tree.emplace_equal(hboost::forward<Args>(args)...)); }
   ...
   iterator emplace_hint(const_iterator hint, HBOOST_FWD_REF(Args)... args)
   {
      return container_detail::force_copy<iterator>(m_flat_tree.emplace_hint_equal
         (container_detail::force_copy<impl_const_iterator>(hint), hboost::forward<Args>(args)...));
   }

   #else // !defined(HBOOST_NO_CXX11_VARIADIC_TEMPLATES)

   #define HBOOST_CONTAINER_FLAT_MULTIMAP_EMPLACE_CODE(N) \
   HBOOST_MOVE_TMPL_LT##N HBOOST_MOVE_CLASS##N HBOOST_MOVE_GT##N \
   iterator emplace(HBOOST_MOVE_UREF##N)\
   {  return container_detail::force_copy<iterator>(m_flat_tree.emplace_equal(HBOOST_MOVE_FWD##N));  }\
   \
   HBOOST_MOVE_TMPL_LT##N HBOOST_MOVE_CLASS##N HBOOST_MOVE_GT##N \
   iterator emplace_hint(const_iterator hint HBOOST_MOVE_I##N HBOOST_MOVE_UREF##N)\
   {\
   ...
   //
   HBOOST_MOVE_ITERATE_0TO9(HBOOST_CONTAINER_FLAT_MULTIMAP_EMPLACE_CODE)
   #undef HBOOST_CONTAINER_FLAT_MULTIMAP_EMPLACE_CODE
   ...
   //!
   //! <b>Note</b>: If an element is inserted it might invalidate elements.
   iterator insert(HBOOST_RV_REF(value_type) x)
   { return container_detail::force_copy<iterator>(m_flat_tree.insert_equal(hboost::move(x))); }
   ...
   //!
   //! <b>Note</b>: If an element is inserted it might invalidate elements.
   iterator insert(HBOOST_RV_REF(impl_value_type) x)
      { return container_detail::force_copy<iterator>(m_flat_tree.insert_equal(hboost::move(x))); }
   ...
   //!
   //! <b>Note</b>: If an element is inserted it might invalidate elements.
   iterator insert(const_iterator p, HBOOST_RV_REF(impl_value_type) x)
   {
      return container_detail::force_copy<iterator>(
         m_flat_tree.insert_equal(container_detail::force_copy<impl_const_iterator>(p), hboost::move(x)));
   }
...
//!specialization for optimizations
template <class Key, class T, class Compare, class Allocator>
struct has_trivial_destructor_after_move< hboost::container::flat_multimap<Key, T, Compare, Allocator> >
{
   typedef typename ::hboost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::hboost::has_trivial_destructor_after_move<Allocator>::value &&
                             ::hboost::has_trivial_destructor_after_move<pointer>::value &&
...
#endif   // HBOOST_CONTAINER_FLAT_MAP_HPP
