...
#ifndef HBOOST_TYPEOF_UNSUPPORTED_HPP_INCLUDED
#define HBOOST_TYPEOF_UNSUPPORTED_HPP_INCLUDED

namespace hboost { namespace type_of {
    struct typeof_emulation_is_unsupported_on_this_compiler {};
}}

#define HBOOST_TYPEOF(expr) hboost::type_of::typeof_emulation_is_unsupported_on_this_compiler
