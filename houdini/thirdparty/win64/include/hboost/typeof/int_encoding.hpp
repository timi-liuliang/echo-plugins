...
#ifndef HBOOST_TYPEOF_INT_ENCODING_HPP_INCLUDED
#define HBOOST_TYPEOF_INT_ENCODING_HPP_INCLUDED
...
namespace hboost { namespace type_of {
    ...
    struct pack
    {
        HBOOST_STATIC_CONSTANT(std::size_t , value=((n + 1) * 2 + (Overflow ? 1 : 0)));
    };

    template<std::size_t m>
    struct unpack
    {
        HBOOST_STATIC_CONSTANT(std::size_t, value = (m / 2) - 1);
        HBOOST_STATIC_CONSTANT(std::size_t, overflow = (m % 2 == 1));
    };
    ...
    struct encode_size_t : push_back<
        V,
        hboost::mpl::size_t<pack<n, false>::value>
    >
    {};
    ...
    struct encode_size_t<V, n, true> : push_back<typename push_back<
        V,
        hboost::mpl::size_t<pack<n % 0x3ffffffe, true>::value> >::type,
        hboost::mpl::size_t<n / 0x3ffffffe>
    >
    {};
    ...
    {
        HBOOST_STATIC_CONSTANT(std::size_t,m = Iter::type::value);

        HBOOST_STATIC_CONSTANT(std::size_t,value = (std::size_t)m * 0x3ffffffe + n);
    ...
    struct decode_integral
    {
        ...
        HBOOST_STATIC_CONSTANT(std::size_t,n = unpack<m>::value);

        HBOOST_STATIC_CONSTANT(std::size_t,overflow = unpack<m>::overflow);
...
#endif//HBOOST_TYPEOF_INT_ENCODING_HPP_INCLUDED
