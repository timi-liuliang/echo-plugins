...
#ifndef HBOOST_SIGNALS2_LAST_VALUE_HPP
#define HBOOST_SIGNALS2_LAST_VALUE_HPP
...
namespace hboost {
  namespace signals2 {
    ...
    {
    public:
      virtual const char* what() const throw() {return "hboost::signals2::no_slots_error";}
    };
...
#endif // HBOOST_SIGNALS2_LAST_VALUE_HPP
