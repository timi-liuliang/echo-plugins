...
// and predestructors through the hboost::signals2::postconstructible and
// hboost::signals2::predestructible base classes.
//
...
#ifndef HBOOST_SIGNALS2_DECONSTRUCT_PTR_HPP
#define HBOOST_SIGNALS2_DECONSTRUCT_PTR_HPP

#include <hboost/assert.hpp>
#include <hboost/checked_delete.hpp>
#include <hboost/signals2/postconstructible.hpp>
#include <hboost/signals2/predestructible.hpp>
...
namespace hboost
{
  namespace signals2
  {
    ...
    shared_ptr<T> deconstruct_ptr(T *ptr)
    {
      ...
      shared_ptr<T> shared(ptr, hboost::signals2::predestructing_deleter<T>());
...
#endif // HBOOST_SIGNALS2_DECONSTRUCT_PTR_HPP
