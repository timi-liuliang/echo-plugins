...
#ifndef HBOOST_SIGNALS2_SHARED_CONNECTION_BLOCK_HPP
#define HBOOST_SIGNALS2_SHARED_CONNECTION_BLOCK_HPP
...
namespace hboost
{
  namespace signals2
  {
    ...
    public:
      ...
      {
        if(blocking()) return;
        hboost::shared_ptr<detail::connection_body_base> connection_body(_weak_connection_body.lock());
...
#endif // HBOOST_SIGNALS2_SHARED_CONNECTION_BLOCK_HPP
