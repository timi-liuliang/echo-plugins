...
#ifndef HBOOST_SIGNALS2_FOREIGN_PTR_HPP
#define HBOOST_SIGNALS2_FOREIGN_PTR_HPP
...
#ifndef HBOOST_NO_CXX11_SMART_PTR
#include <memory>
#endif
...
namespace hboost
{
  ...
  namespace signals2
  {
    ...
    {};
    template<typename T> struct weak_ptr_traits<hboost::weak_ptr<T> >
    {
      typedef hboost::shared_ptr<T> shared_type;
    };
#ifndef HBOOST_NO_CXX11_SMART_PTR
    ...
    template<typename T> struct shared_ptr_traits<hboost::shared_ptr<T> >
    {
      typedef hboost::weak_ptr<T> weak_type;
    };
#ifndef HBOOST_NO_CXX11_SMART_PTR
    ...
    namespace detail
    {
      ...
      private:
        hboost::scoped_ptr<foreign_weak_ptr_impl_base> _p;
      };
    } // namespace detail
...
#endif  // HBOOST_SIGNALS2_FOREIGN_PTR_HPP
