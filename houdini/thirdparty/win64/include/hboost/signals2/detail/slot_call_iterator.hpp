...
#ifndef HBOOST_SIGNALS2_SLOT_CALL_ITERATOR_HPP
#define HBOOST_SIGNALS2_SLOT_CALL_ITERATOR_HPP
  ...
  namespace signals2 {
    namespace detail {
      ...
      class slot_call_iterator_t
        : public hboost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
        typename Function::result_type,
        hboost::single_pass_traversal_tag,
        typename hboost::add_const<typename hboost::add_reference<typename Function::result_type>::type>::type >
      {
        typedef hboost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
          typename Function::result_type,
          hboost::single_pass_traversal_tag,
          typename hboost::add_const<typename hboost::add_reference<typename Function::result_type>::type>::type >
        inherited;
...
#endif // HBOOST_SIGNALS2_SLOT_CALL_ITERATOR_HPP
