...
#ifndef HBOOST_SIGNALS2_TRACKED_OBJECTS_VISITOR_HPP
#define HBOOST_SIGNALS2_TRACKED_OBJECTS_VISITOR_HPP

#include <hboost/mpl/bool.hpp>
#include <hboost/ref.hpp>
#include <hboost/signals2/detail/signals_common.hpp>
#include <hboost/signals2/slot_base.hpp>
#include <hboost/signals2/trackable.hpp>
  ...
  namespace signals2
  {
    namespace detail
    {
      ...
      private:
        ...
        {
            m_visit_pointer(hboost::addressof(t), mpl::bool_<true>());
        }
        template<typename T>
...
#endif // HBOOST_SIGNALS2_TRACKED_OBJECTS_VISITOR_HPP
