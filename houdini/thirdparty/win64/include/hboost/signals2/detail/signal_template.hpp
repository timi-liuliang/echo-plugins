...
#define HBOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION \
  HBOOST_SIGNALS2_SIGNATURE_TEMPLATE_INSTANTIATION(HBOOST_SIGNALS2_NUM_ARGS), \
...
namespace hboost
{
  namespace signals2
  {
    namespace detail
    {
      ...
      template<typename R>
        class HBOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_INVOKER_N(HBOOST_SIGNALS2_NUM_ARGS)
      {
      public:
        typedef R result_type;
        template<typename ExtendedSlotFunction HBOOST_SIGNALS2_PP_COMMA_IF(HBOOST_SIGNALS2_NUM_ARGS)
          ...
          result_type operator()(ExtendedSlotFunction &func, const connection &conn
            HBOOST_SIGNALS2_PP_COMMA_IF(HBOOST_SIGNALS2_NUM_ARGS)
            HBOOST_SIGNALS2_FULL_FORWARD_ARGS(HBOOST_SIGNALS2_NUM_ARGS)) const
        {
          return func(conn HBOOST_SIGNALS2_PP_COMMA_IF(HBOOST_SIGNALS2_NUM_ARGS)
            HBOOST_SIGNALS2_FORWARDED_ARGS(HBOOST_SIGNALS2_NUM_ARGS));
        }
      };
#ifdef HBOOST_NO_VOID_RETURNS
      template<>
        class HBOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_INVOKER_N(HBOOST_SIGNALS2_NUM_ARGS)<void>
      {
      public:
        ...
        template<typename ExtendedSlotFunction HBOOST_SIGNALS2_PP_COMMA_IF(HBOOST_SIGNALS2_NUM_ARGS)
          ...
          result_type operator()(ExtendedSlotFunction &func, const connection &conn
            ...
            HBOOST_SIGNALS2_FULL_FORWARD_ARGS(HBOOST_SIGNALS2_NUM_ARGS)) const
        {
          func(conn HBOOST_SIGNALS2_PP_COMMA_IF(HBOOST_SIGNALS2_NUM_ARGS)
            HBOOST_SIGNALS2_FORWARDED_ARGS(HBOOST_SIGNALS2_NUM_ARGS));
          return result_type();
        }
      };
...
// signalN::slot_function
      ...
      template<typename ExtendedSlotFunction>
        class HBOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_N(HBOOST_SIGNALS2_NUM_ARGS)
      {
      public:
        typedef typename result_type_wrapper<typename ExtendedSlotFunction::result_type>::type result_type;
        HBOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_N(HBOOST_SIGNALS2_NUM_ARGS)(const ExtendedSlotFunction &fun):
...
#if HBOOST_SIGNALS2_NUM_ARGS > 0
        template<HBOOST_SIGNALS2_ARGS_TEMPLATE_DECL(HBOOST_SIGNALS2_NUM_ARGS)>
#endif // HBOOST_SIGNALS2_NUM_ARGS > 0
          result_type operator()(HBOOST_SIGNALS2_FULL_FORWARD_ARGS(HBOOST_SIGNALS2_NUM_ARGS))
        {
          return HBOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_INVOKER_N(HBOOST_SIGNALS2_NUM_ARGS)
            <typename ExtendedSlotFunction::result_type>()
            (_fun, *_connection HBOOST_SIGNALS2_PP_COMMA_IF(HBOOST_SIGNALS2_NUM_ARGS)
              HBOOST_SIGNALS2_FORWARDED_ARGS(HBOOST_SIGNALS2_NUM_ARGS));
        }
        // const overload
#if HBOOST_SIGNALS2_NUM_ARGS > 0
        template<HBOOST_SIGNALS2_ARGS_TEMPLATE_DECL(HBOOST_SIGNALS2_NUM_ARGS)>
#endif // HBOOST_SIGNALS2_NUM_ARGS > 0
          result_type operator()(HBOOST_SIGNALS2_FULL_FORWARD_ARGS(HBOOST_SIGNALS2_NUM_ARGS)) const
        {
          return HBOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_INVOKER_N(HBOOST_SIGNALS2_NUM_ARGS)
            <typename ExtendedSlotFunction::result_type>()
            (_fun, *_connection HBOOST_SIGNALS2_PP_COMMA_IF(HBOOST_SIGNALS2_NUM_ARGS)
      ...
      private:
        HBOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_N(HBOOST_SIGNALS2_NUM_ARGS)()
        {}

        ExtendedSlotFunction _fun;
        hboost::shared_ptr<connection> _connection;
      };

      template<HBOOST_SIGNALS2_SIGNAL_TEMPLATE_DECL(HBOOST_SIGNALS2_NUM_ARGS)>
        class HBOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS);

      template<HBOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION_DECL(HBOOST_SIGNALS2_NUM_ARGS)>
      class HBOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS) HBOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION
      {
      public:
        ...
        typedef HBOOST_SIGNALS2_EXTENDED_SLOT_TYPE(HBOOST_SIGNALS2_NUM_ARGS) extended_slot_type;
      ...
      private:
        ...
        typedef HBOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_N(HBOOST_SIGNALS2_NUM_ARGS)<extended_slot_function_type>
      ...
      public:
        ...
        HBOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)(const combiner_type &combiner_arg,
        ...
        // emit signal
        result_type operator ()(HBOOST_SIGNALS2_SIGNATURE_FULL_ARGS(HBOOST_SIGNALS2_NUM_ARGS))
        {
          shared_ptr<invocation_state> local_state;
          typename connection_list_type::iterator it;
          {
          ...
          slot_invoker invoker = slot_invoker(HBOOST_SIGNALS2_SIGNATURE_ARG_NAMES(HBOOST_SIGNALS2_NUM_ARGS));
        ...
        result_type operator ()(HBOOST_SIGNALS2_SIGNATURE_FULL_ARGS(HBOOST_SIGNALS2_NUM_ARGS)) const
        {
          shared_ptr<invocation_state> local_state;
          typename connection_list_type::iterator it;
          {
...
#define HBOOST_SIGNALS2_ADD_REF_TYPE(z, n, data) \
  typename add_reference<HBOOST_PP_CAT(T, HBOOST_PP_INC(n))>::type
// typename add_reference<Tn>::type argn
#define HBOOST_SIGNALS2_ADD_REF_ARG(z, n, data) \
  HBOOST_SIGNALS2_ADD_REF_TYPE(~, n, ~) \
  HBOOST_SIGNALS2_SIGNATURE_ARG_NAME(~, n, ~)
// typename add_reference<T1>::type arg1, typename add_reference<T2>::type arg2, ..., typename add_reference<Tn>::type argn
#define HBOOST_SIGNALS2_ADD_REF_ARGS(arity) \
  HBOOST_PP_ENUM(arity, HBOOST_SIGNALS2_ADD_REF_ARG, ~)
          slot_invoker(HBOOST_SIGNALS2_ADD_REF_ARGS(HBOOST_SIGNALS2_NUM_ARGS)) HBOOST_PP_EXPR_IF(HBOOST_SIGNALS2_NUM_ARGS, :)
#undef HBOOST_SIGNALS2_ADD_REF_ARGS

// m_argn
#define HBOOST_SIGNALS2_M_ARG_NAME(z, n, data) HBOOST_PP_CAT(m_arg, HBOOST_PP_INC(n))
// m_argn ( argn )
#define HBOOST_SIGNALS2_MISC_STATEMENT(z, n, data) \
  HBOOST_SIGNALS2_M_ARG_NAME(~, n, ~) ( HBOOST_SIGNALS2_SIGNATURE_ARG_NAME(~, n, ~) )
// m_arg1(arg1), m_arg2(arg2), ..., m_argn(argn)
            HBOOST_PP_ENUM(HBOOST_SIGNALS2_NUM_ARGS, HBOOST_SIGNALS2_MISC_STATEMENT, ~)
...
#define HBOOST_SIGNALS2_ADD_REF_M_ARG_STATEMENT(z, n, data) \
  HBOOST_SIGNALS2_ADD_REF_TYPE(~, n, ~) HBOOST_SIGNALS2_M_ARG_NAME(~, n, ~) ;
          HBOOST_PP_REPEAT(HBOOST_SIGNALS2_NUM_ARGS, HBOOST_SIGNALS2_ADD_REF_M_ARG_STATEMENT, ~)
#undef HBOOST_SIGNALS2_ADD_REF_M_ARG_STATEMENT
#undef HBOOST_SIGNALS2_ADD_REF_ARG
#undef HBOOST_SIGNALS2_ADD_REF_TYPE

// m_arg1, m_arg2, ..., m_argn
#define HBOOST_SIGNALS2_M_ARG_NAMES(arity) HBOOST_PP_ENUM(arity, HBOOST_SIGNALS2_M_ARG_NAME, ~)
          template<typename SlotResultType>
          result_type m_invoke(const connection_body_type &connectionBody,
            typename hboost::enable_if<hboost::is_void<SlotResultType> >::type * = 0) const
          {
            connectionBody->slot().slot_function()(HBOOST_SIGNALS2_M_ARG_NAMES(HBOOST_SIGNALS2_NUM_ARGS));
            return void_type();
          }
          template<typename SlotResultType>
          result_type m_invoke(const connection_body_type &connectionBody, 
            typename hboost::disable_if<hboost::is_void<SlotResultType> >::type * = 0) const
          {
            return connectionBody->slot().slot_function()(HBOOST_SIGNALS2_M_ARG_NAMES(HBOOST_SIGNALS2_NUM_ARGS));
          }
        };
#undef HBOOST_SIGNALS2_M_ARG_NAMES
#undef HBOOST_SIGNALS2_M_ARG_NAME
        ...
        {
        public:
          typedef HBOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS) signal_type;
          invocation_janitor
          (
        ...
        {
          HBOOST_ASSERT(_shared_state.unique());
          typename connection_list_type::iterator it;
          unsigned i;
          for(it = begin, i = 0;
        ...
        */
        ...
        const hboost::shared_ptr<mutex_type> _mutex;
      };

      template<HBOOST_SIGNALS2_SIGNAL_TEMPLATE_DECL(HBOOST_SIGNALS2_NUM_ARGS)>
        class HBOOST_SIGNALS2_WEAK_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS);
    }

    template<HBOOST_SIGNALS2_SIGNAL_TEMPLATE_DEFAULTED_DECL(HBOOST_SIGNALS2_NUM_ARGS)>
      class HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS);

    template<HBOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION_DECL(HBOOST_SIGNALS2_NUM_ARGS)>
    class HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)
      HBOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION: public signal_base,
      public detail::HBOOST_SIGNALS2_STD_FUNCTIONAL_BASE
        (typename detail::result_type_wrapper<typename Combiner::result_type>::type)
    {
      typedef detail::HBOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)
        <HBOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION> impl_class;
    public:
      typedef detail::HBOOST_SIGNALS2_WEAK_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)
        <HBOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION> weak_signal_type;
      friend class detail::HBOOST_SIGNALS2_WEAK_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)
        <HBOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION>;
...
#undef HBOOST_SIGNALS2_MISC_STATEMENT
      ...
      HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)(const combiner_type &combiner_arg = combiner_type(),
        const group_compare_type &group_compare = group_compare_type()):
        _pimpl(new impl_class(combiner_arg, group_compare))
      {};
      virtual ~HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)()
      {
      }
      
      //move support
#if !defined(HBOOST_NO_CXX11_RVALUE_REFERENCES)
      HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)(
        HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS) && other)
      {
        using std::swap;
      ...
      HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS) & 
        operator=(HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS) && rhs)
      {
        if(this == &rhs)
        {
          return *this;
      ...
      result_type operator ()(HBOOST_SIGNALS2_SIGNATURE_FULL_ARGS(HBOOST_SIGNALS2_NUM_ARGS))
      {
        return (*_pimpl)(HBOOST_SIGNALS2_SIGNATURE_ARG_NAMES(HBOOST_SIGNALS2_NUM_ARGS));
      }
      result_type operator ()(HBOOST_SIGNALS2_SIGNATURE_FULL_ARGS(HBOOST_SIGNALS2_NUM_ARGS)) const
      {
        return (*_pimpl)(HBOOST_SIGNALS2_SIGNATURE_ARG_NAMES(HBOOST_SIGNALS2_NUM_ARGS));
      ...
      void swap(HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS) & other)
      {
        using std::swap;
        swap(_pimpl, other._pimpl);
      }
    ...
    template<HBOOST_SIGNALS2_SIGNAL_TEMPLATE_DECL(HBOOST_SIGNALS2_NUM_ARGS)>
      void swap(
        HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS) <HBOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION> &sig1,
        HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS) <HBOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION> &sig2 )
    {
      sig1.swap(sig2);
    }
#endif
    ...
    namespace detail
    {
      ...
      template<HBOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION_DECL(HBOOST_SIGNALS2_NUM_ARGS)>
        class HBOOST_SIGNALS2_WEAK_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)
        HBOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION
      {
      public:
        typedef typename HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)
          <HBOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION>::result_type
          result_type;

        HBOOST_SIGNALS2_WEAK_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)
          (const HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)
          <HBOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION>
          &signal):
        ...
        result_type operator ()(HBOOST_SIGNALS2_SIGNATURE_FULL_ARGS(HBOOST_SIGNALS2_NUM_ARGS))
        {
          shared_ptr<detail::HBOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)
            <HBOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION> >
            shared_pimpl(_weak_pimpl.lock());
          if(shared_pimpl == 0) throw expired_slot();
          return (*shared_pimpl)(HBOOST_SIGNALS2_SIGNATURE_ARG_NAMES(HBOOST_SIGNALS2_NUM_ARGS));
        }
        result_type operator ()(HBOOST_SIGNALS2_SIGNATURE_FULL_ARGS(HBOOST_SIGNALS2_NUM_ARGS)) const
        {
          shared_ptr<detail::HBOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)
      ...
      private:
        hboost::weak_ptr<detail::HBOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)
          <HBOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION> > _weak_pimpl;
      };
      ...
      template<typename Signature>
        class extended_signature<HBOOST_SIGNALS2_NUM_ARGS, Signature>
      {
      public:
// typename function_traits<Signature>::result_type (
// const hboost::signals2::connection &,
...
#define HBOOST_SIGNALS2_EXT_SIGNATURE(arity, Signature) \
  typename function_traits<Signature>::result_type ( \
  const hboost::signals2::connection & HBOOST_SIGNALS2_PP_COMMA_IF(HBOOST_SIGNALS2_NUM_ARGS) \
  HBOOST_PP_ENUM(arity, HBOOST_SIGNALS2_SIGNATURE_TO_ARGN_TYPE, Signature) )
        typedef function<HBOOST_SIGNALS2_EXT_SIGNATURE(HBOOST_SIGNALS2_NUM_ARGS, Signature)> function_type;
#undef HBOOST_SIGNALS2_EXT_SIGNATURE
      };
      ...
      template<typename Signature, typename Combiner, typename Group,
        ...
        typename ExtendedSlotFunction, typename Mutex>
      class signalN<HBOOST_SIGNALS2_NUM_ARGS, Signature, Combiner, Group,
        GroupCompare, SlotFunction, ExtendedSlotFunction, Mutex>
      {
      public:
        typedef HBOOST_SIGNALS2_SIGNAL_CLASS_NAME(HBOOST_SIGNALS2_NUM_ARGS)<
...
#undef HBOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION
