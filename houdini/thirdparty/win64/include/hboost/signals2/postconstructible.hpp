...
// The objects must inherit from hboost::signals2::postconstructible, and
// have their lifetimes managed by
// hboost::shared_ptr created with the hboost::signals2::deconstruct_ptr()
// function.
//
...
#ifndef HBOOST_SIGNALS2_POSTCONSTRUCTIBLE_HPP
#define HBOOST_SIGNALS2_POSTCONSTRUCTIBLE_HPP
...
namespace hboost
{
  ...
  namespace signals2
  {
    ...
    namespace detail
    {
      void do_postconstruct(const hboost::signals2::postconstructible_adl_barrier::postconstructible *ptr);
    } // namespace detail
...
#endif // HBOOST_SIGNALS2_POSTCONSTRUCTIBLE_HPP
