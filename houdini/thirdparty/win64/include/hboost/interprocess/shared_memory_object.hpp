...
#ifndef HBOOST_INTERPROCESS_SHARED_MEMORY_OBJECT_HPP
#define HBOOST_INTERPROCESS_SHARED_MEMORY_OBJECT_HPP
...
#if defined(HBOOST_INTERPROCESS_POSIX_SHARED_MEMORY_OBJECTS)
#  include <fcntl.h>        //O_CREAT, O_*...
#  include <sys/mman.h>     //shm_xxx
#  include <unistd.h>       //ftruncate, close
#  include <sys/stat.h>     //mode_t, S_IRWXG, S_IRWXO, S_IRWXU,
#  if defined(HBOOST_INTERPROCESS_RUNTIME_FILESYSTEM_BASED_POSIX_SHARED_MEMORY)
...
class shared_memory_object
{
   ...
   HBOOST_MOVABLE_BUT_NOT_COPYABLE(shared_memory_object)
   ...
   //!Does not throw
   shared_memory_object(HBOOST_RV_REF(shared_memory_object) moved)
   ...
   //!Does not throw
   shared_memory_object &operator=(HBOOST_RV_REF(shared_memory_object) moved)
   {
      shared_memory_object tmp(hboost::move(moved));
      this->swap(tmp);
      return *this;
   }
...
{
   hboost::adl_move_swap(m_handle, other.m_handle);
   hboost::adl_move_swap(m_mode,   other.m_mode);
...
#else //!defined(HBOOST_INTERPROCESS_POSIX_SHARED_MEMORY_OBJECTS)

namespace shared_memory_object_detail {

#ifdef HBOOST_INTERPROCESS_RUNTIME_FILESYSTEM_BASED_POSIX_SHARED_MEMORY
...
#else
#error "Not supported platform for HBOOST_INTERPROCESS_RUNTIME_FILESYSTEM_BASED_POSIX_SHARED_MEMORY"
#endif
...
{
   #if defined(HBOOST_INTERPROCESS_FILESYSTEM_BASED_POSIX_SHARED_MEMORY)
   const bool add_leading_slash = false;
   #elif defined(HBOOST_INTERPROCESS_RUNTIME_FILESYSTEM_BASED_POSIX_SHARED_MEMORY)
...
#endif   //HBOOST_INTERPROCESS_SHARED_MEMORY_OBJECT_HPP
