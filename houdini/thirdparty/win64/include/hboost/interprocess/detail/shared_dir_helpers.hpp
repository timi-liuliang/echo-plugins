...
#ifndef HBOOST_INTERPROCESS_DETAIL_SHARED_DIR_HELPERS_HPP
#define HBOOST_INTERPROCESS_DETAIL_SHARED_DIR_HELPERS_HPP
...
#if defined(HBOOST_INTERPROCESS_HAS_KERNEL_BOOTTIME) && defined(HBOOST_INTERPROCESS_WINDOWS)
...
namespace ipcdetail {
...
#if defined(HBOOST_INTERPROCESS_HAS_KERNEL_BOOTTIME)
   ...
   #elif defined(HBOOST_INTERPROCESS_HAS_BSD_KERNEL_BOOTTIME)
      inline void get_bootstamp(std::string &s, bool add = false)
      {
         ...
         hboost::uint32_t fields[2] = { hboost::uint32_t(result.tv_sec), hboost::uint32_t(result.tv_usec) };
   ...
   #else
      #error "HBOOST_INTERPROCESS_HAS_KERNEL_BOOTTIME defined with no known implementation"
   #endif
#endif   //#if defined(HBOOST_INTERPROCESS_HAS_KERNEL_BOOTTIME)
...
inline void get_shared_dir_root(std::string &dir_path)
{
   ...
   //Remove final null.
   dir_path += "/hboost_interprocess";
}

inline void get_shared_dir(std::string &shared_dir)
{
   #if defined(HBOOST_INTERPROCESS_SHARED_DIR_PATH)
      shared_dir = HBOOST_INTERPROCESS_SHARED_DIR_PATH;
   #else
...
#endif   //ifndef HBOOST_INTERPROCESS_DETAIL_SHARED_DIR_HELPERS_HPP
