...
//Thread launching functions are adapted from hboost/detail/lightweight_thread.hpp
//
//  hboost/detail/lightweight_thread.hpp
//
...
#ifndef HBOOST_INTERPROCESS_DETAIL_OS_THREAD_FUNCTIONS_HPP
#define HBOOST_INTERPROCESS_DETAIL_OS_THREAD_FUNCTIONS_HPP
...
#include <hboost/interprocess/streams/bufferstream.hpp>
...
#  include <sched.h>
#  include <time.h>
#  ifdef HBOOST_INTERPROCESS_BSD_DERIVATIVE
...
#     define HBOOST_INTERPROCESS_MATCH_ABSOLUTE_TIME
#  elif defined(CLOCK_MONOTONIC_PRECISE)   //BSD
#     define HBOOST_INTERPROCESS_CLOCK_MONOTONIC CLOCK_MONOTONIC_PRECISE
#  elif defined(CLOCK_MONOTONIC_RAW)     //Linux
#     define HBOOST_INTERPROCESS_CLOCK_MONOTONIC CLOCK_MONOTONIC_RAW
#  elif defined(CLOCK_HIGHRES)           //Solaris
#     define HBOOST_INTERPROCESS_CLOCK_MONOTONIC CLOCK_HIGHRES
#  elif defined(CLOCK_MONOTONIC)         //POSIX (AIX, BSD, Linux, Solaris)
#     define HBOOST_INTERPROCESS_CLOCK_MONOTONIC CLOCK_MONOTONIC
#  else
...
#ifndef HBOOST_INTERPROCESS_MATCH_ABSOLUTE_TIME
...
inline OS_highres_count_t get_current_system_highres_count()
{
   #if defined(HBOOST_INTERPROCESS_CLOCK_MONOTONIC)
      struct timespec count;
      ::clock_gettime(HBOOST_INTERPROCESS_CLOCK_MONOTONIC, &count);
      return count;
   #elif defined(HBOOST_INTERPROCESS_MATCH_ABSOLUTE_TIME)
...
inline unsigned int get_num_cores()
{
   ...
   #elif defined(HBOOST_INTERPROCESS_BSD_DERIVATIVE) && defined(HW_NCPU)
...
#endif   //HBOOST_INTERPROCESS_DETAIL_OS_THREAD_FUNCTIONS_HPP
