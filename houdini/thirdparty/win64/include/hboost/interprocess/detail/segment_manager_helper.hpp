...
#ifndef HBOOST_INTERPROCESS_SEGMENT_MANAGER_BASE_HPP
#define HBOOST_INTERPROCESS_SEGMENT_MANAGER_BASE_HPP
...
// container/detail
#include <hboost/container/detail/type_traits.hpp> //alignment_of
#include <hboost/container/detail/minimal_char_traits_header.hpp>
// intrusive
#include <hboost/intrusive/pointer_traits.hpp>
// move/detail
#include <hboost/move/detail/type_traits.hpp> //make_unsigned
// other boost
...
struct block_header
{
   ...
   size_type total_size_with_header() const
   {
      return get_rounded_size
            ...
            , size_type(::hboost::container::container_detail::alignment_of<block_header<size_type> >::value))
           + total_size();
   }
   ...
   {  return block_header_from_value(value, sizeof(T), ::hboost::container::container_detail::alignment_of<T>::value);  }
   ...
   static block_header<size_type> *block_header_from_value(const void *value, std::size_t sz, std::size_t algn)
   {
      ...
      (void)sz;
      //Some sanity checks
      HBOOST_ASSERT(hdr->m_value_alignment == algn);
      HBOOST_ASSERT(hdr->m_value_bytes % sz == 0);
      return hdr;
   }
   ...
   :  public Hook
{
   ...
   enum  {  BlockHdrAlignment = ::hboost::container::container_detail::alignment_of<block_header<size_type> >::value  };
...
struct index_key
{
   ...
   typedef CharT                                         char_type;
   typedef typename hboost::intrusive::pointer_traits<const_char_ptr_t>::difference_type difference_type;
...
#endif //#ifndef HBOOST_INTERPROCESS_SEGMENT_MANAGER_BASE_HPP
