...
#ifndef HBOOST_INTERPROCESS_DETAIL_OS_FILE_FUNCTIONS_HPP
#define HBOOST_INTERPROCESS_DETAIL_OS_FILE_FUNCTIONS_HPP
...
inline bool truncate_file (file_handle_t hnd, std::size_t size)
{
   ...
   typedef ::hboost::move_detail::make_unsigned<offset_t>::type uoffset_t;
...
inline bool truncate_file (file_handle_t hnd, std::size_t size)
{
   typedef hboost::move_detail::make_unsigned<off_t>::type uoff_t;
...
#endif   //HBOOST_INTERPROCESS_DETAIL_OS_FILE_FUNCTIONS_HPP
