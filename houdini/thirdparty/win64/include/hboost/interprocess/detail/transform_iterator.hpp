...
#ifndef HBOOST_INTERPROCESS_DETAIL_TRANSFORM_ITERATORS_HPP
#define HBOOST_INTERPROCESS_DETAIL_TRANSFORM_ITERATORS_HPP
...
{
   public:
   typedef typename ::hboost::container::iterator_traits<Iterator>::iterator_category         iterator_category;
   typedef typename ipcdetail::remove_reference<typename UnaryFunction::result_type>::type   value_type;
   typedef typename ::hboost::container::iterator_traits<Iterator>::difference_type           difference_type;
   ...
   {  ::hboost::container::iterator_advance(m_it, n); }

   difference_type distance_to(const transform_iterator &other)const
   {  return ::hboost::container::iterator_distance(other.m_it, m_it); }
};
...
#endif   //#ifndef HBOOST_INTERPROCESS_DETAIL_TRANSFORM_ITERATORS_HPP
