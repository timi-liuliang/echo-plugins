...
#ifndef HBOOST_INTERPROCESS_RECURSIVE_MUTEX_HPP
#define HBOOST_INTERPROCESS_RECURSIVE_MUTEX_HPP
...
#include <hboost/assert.hpp>
   ...
   (defined(HBOOST_INTERPROCESS_POSIX_PROCESS_SHARED) && defined (HBOOST_INTERPROCESS_POSIX_RECURSIVE_MUTEXES))
   #include <hboost/interprocess/sync/posix/recursive_mutex.hpp>
...
//Experimental...
   ...
   #include <hboost/interprocess/sync/windows/recursive_mutex.hpp>
   #define HBOOST_INTERPROCESS_USE_WINDOWS
#elif !defined(HBOOST_INTERPROCESS_DOXYGEN_INVOKED)
   #include <hboost/interprocess/sync/spin/recursive_mutex.hpp>
...
class interprocess_recursive_mutex
{
  ...
  ~interprocess_recursive_mutex();
   ...
   #elif defined(HBOOST_INTERPROCESS_USE_POSIX)
...
inline bool interprocess_recursive_mutex::timed_lock(const hboost::posix_time::ptime &abs_time)
...
#endif   //HBOOST_INTERPROCESS_RECURSIVE_MUTEX_HPP
