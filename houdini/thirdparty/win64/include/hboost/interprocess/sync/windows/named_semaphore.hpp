...
#ifndef HBOOST_INTERPROCESS_WINDOWS_NAMED_SEMAPHORE_HPP
#define HBOOST_INTERPROCESS_WINDOWS_NAMED_SEMAPHORE_HPP
...
inline bool windows_named_semaphore::timed_wait(const hboost::posix_time::ptime &abs_time)
{
...
#endif   //HBOOST_INTERPROCESS_WINDOWS_NAMED_SEMAPHORE_HPP
