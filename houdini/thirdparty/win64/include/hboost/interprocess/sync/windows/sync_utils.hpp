...
#ifndef HBOOST_INTERPROCESS_DETAIL_SYNC_UTILS_HPP
#define HBOOST_INTERPROCESS_DETAIL_SYNC_UTILS_HPP
...
#include <hboost/interprocess/sync/spin/mutex.hpp>
...
#include <hboost/interprocess/detail/config_external_begin.hpp>
   #include <hboost/unordered/unordered_map.hpp>
#include <hboost/interprocess/detail/config_external_end.hpp>
...
class sync_id
{
   ...
   {  return hboost::hash_value(m.rand_);  }
...
class sync_handles
{
   ...
   typedef hboost::unordered_map<sync_id, void*> umap_type;
   typedef hboost::container::map<const sync_id*, umap_type::iterator, address_less> map_type;
...
#endif   //HBOOST_INTERPROCESS_DETAIL_SYNC_UTILS_HPP
