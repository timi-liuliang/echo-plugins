...
#ifndef HBOOST_INTERPROCESS_NULL_MUTEX_HPP
#define HBOOST_INTERPROCESS_NULL_MUTEX_HPP
...
class null_mutex
{
   ...
   //!Equivalent to "return true;"
   bool timed_lock(const hboost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_lock_sharable(const hboost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_lock_upgradable(const hboost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_unlock_upgradable_and_lock(const hboost::posix_time::ptime &)
   {  return true;   }
...
#endif   //HBOOST_INTERPROCESS_NULL_MUTEX_HPP
