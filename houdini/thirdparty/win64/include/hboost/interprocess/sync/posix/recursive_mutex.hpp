...
#ifndef HBOOST_INTERPROCESS_DETAIL_POSIX_RECURSIVE_MUTEX_HPP
#define HBOOST_INTERPROCESS_DETAIL_POSIX_RECURSIVE_MUTEX_HPP
...
#include <pthread.h>
#include <errno.h>
#include <hboost/interprocess/sync/posix/pthread_helpers.hpp>
...
inline bool posix_recursive_mutex::timed_lock(const hboost::posix_time::ptime &abs_time)
{
   ...
   #else //HBOOST_INTERPROCESS_POSIX_TIMEOUTS

   return ipcdetail::try_based_timed_lock(*this, abs_time);

   #endif   //HBOOST_INTERPROCESS_POSIX_TIMEOUTS
}
...
#endif   //#ifndef HBOOST_INTERPROCESS_DETAIL_POSIX_RECURSIVE_MUTEX_HPP
