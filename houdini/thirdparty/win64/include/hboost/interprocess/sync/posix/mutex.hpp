...
#ifndef HBOOST_INTERPROCESS_DETAIL_POSIX_MUTEX_HPP
#define HBOOST_INTERPROCESS_DETAIL_POSIX_MUTEX_HPP
...
inline bool posix_mutex::timed_lock(const hboost::posix_time::ptime &abs_time)
{
...
#endif   //#ifndef HBOOST_INTERPROCESS_DETAIL_POSIX_MUTEX_HPP
