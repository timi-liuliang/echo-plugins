...
#ifndef HBOOST_INTERPROCESS_PTHREAD_HELPERS_HPP
#define HBOOST_INTERPROCESS_PTHREAD_HELPERS_HPP
...
namespace ipcdetail{
   ...
   #if defined HBOOST_INTERPROCESS_POSIX_PROCESS_SHARED
   ...
   #endif   //   #if defined HBOOST_INTERPROCESS_POSIX_PROCESS_SHARED

   #if defined(HBOOST_INTERPROCESS_POSIX_BARRIERS) && defined(HBOOST_INTERPROCESS_POSIX_PROCESS_SHARED)
   ...
   #endif   //#if defined(HBOOST_INTERPROCESS_POSIX_BARRIERS) && defined(HBOOST_INTERPROCESS_POSIX_PROCESS_SHARED)
...
#endif //ifdef HBOOST_INTERPROCESS_PTHREAD_HELPERS_HPP
