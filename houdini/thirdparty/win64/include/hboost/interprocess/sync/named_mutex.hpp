...
#ifndef HBOOST_INTERPROCESS_NAMED_MUTEX_HPP
#define HBOOST_INTERPROCESS_NAMED_MUTEX_HPP
...
#if defined(HBOOST_INTERPROCESS_NAMED_MUTEX_USES_POSIX_SEMAPHORES)
   #include <hboost/interprocess/sync/posix/named_mutex.hpp>
   #define HBOOST_INTERPROCESS_USE_POSIX_SEMAPHORES
#elif !defined(HBOOST_INTERPROCESS_FORCE_GENERIC_EMULATION) && defined (HBOOST_INTERPROCESS_WINDOWS)
   #include <hboost/interprocess/sync/windows/named_mutex.hpp>
   #define HBOOST_INTERPROCESS_USE_WINDOWS
#else
#include <hboost/interprocess/sync/shm/named_mutex.hpp>
#endif
...
class named_mutex
{
   ...
   public:
   #if defined(HBOOST_INTERPROCESS_USE_POSIX_SEMAPHORES)
      typedef ipcdetail::posix_named_mutex      internal_mutex_type;
      #undef HBOOST_INTERPROCESS_USE_POSIX_SEMAPHORES
...
inline bool named_mutex::timed_lock(const hboost::posix_time::ptime &abs_time)
...
#endif   //HBOOST_INTERPROCESS_NAMED_MUTEX_HPP
