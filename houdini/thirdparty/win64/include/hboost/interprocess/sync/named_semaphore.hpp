...
#ifndef HBOOST_INTERPROCESS_NAMED_SEMAPHORE_HPP
#define HBOOST_INTERPROCESS_NAMED_SEMAPHORE_HPP
...
#if defined(HBOOST_INTERPROCESS_NAMED_SEMAPHORE_USES_POSIX_SEMAPHORES)
...
//Experimental...
   ...
   #include <hboost/interprocess/sync/windows/named_semaphore.hpp>
   #define HBOOST_INTERPROCESS_USE_WINDOWS
#else
#include <hboost/interprocess/sync/shm/named_semaphore.hpp>
#endif
...
inline bool named_semaphore::timed_wait(const hboost::posix_time::ptime &abs_time)
...
#endif   //HBOOST_INTERPROCESS_NAMED_SEMAPHORE_HPP
