...
#ifndef HBOOST_INTERPROCESS_MUTEX_HPP
#define HBOOST_INTERPROCESS_MUTEX_HPP
...
#if !defined(HBOOST_INTERPROCESS_FORCE_GENERIC_EMULATION) && defined (HBOOST_INTERPROCESS_POSIX_PROCESS_SHARED)
   #include <hboost/interprocess/sync/posix/mutex.hpp>
...
inline bool interprocess_mutex::timed_lock(const hboost::posix_time::ptime &abs_time)
...
#endif   //HBOOST_INTERPROCESS_MUTEX_HPP
