...
#ifndef HBOOST_INTERPROCESS_SYNC_DETAIL_COMMON_ALGORITHMS_HPP
#define HBOOST_INTERPROCESS_SYNC_DETAIL_COMMON_ALGORITHMS_HPP
...
bool try_based_timed_lock(MutexType &m, const hboost::posix_time::ptime &abs_time)
{
   //Same as lock()
...
#endif   //HBOOST_INTERPROCESS_SYNC_DETAIL_COMMON_ALGORITHMS_HPP
