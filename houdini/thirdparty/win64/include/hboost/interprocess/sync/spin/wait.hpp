...
//Parts of this file come from hboost/smart_ptr/detail/yield_k.hpp
//Many thanks to Peter Dimov.

#ifndef HBOOST_INTERPROCESS_SYNC_WAIT_HPP_INCLUDED
#define HBOOST_INTERPROCESS_SYNC_WAIT_HPP_INCLUDED
...
//#define HBOOST_INTERPROCESS_SPIN_WAIT_DEBUG
#ifdef HBOOST_INTERPROCESS_SPIN_WAIT_DEBUG
#include <iostream>
#endif

// HBOOST_INTERPROCESS_SMT_PAUSE
...
#define HBOOST_INTERPROCESS_SMT_PAUSE _mm_pause();

#elif defined(__GNUC__) && ( defined(__i386__) || defined(__x86_64__) ) && !defined(_CRAYC)

#define HBOOST_INTERPROCESS_SMT_PAUSE __asm__ __volatile__( "rep; nop" : : : "memory" );
...
class spin_wait
{
   ...
   void yield()
   {
      ...
      #if defined(HBOOST_INTERPROCESS_SMT_PAUSE)
...
#endif // #ifndef HBOOST_INTERPROCESS_SYNC_WAIT_HPP_INCLUDED
