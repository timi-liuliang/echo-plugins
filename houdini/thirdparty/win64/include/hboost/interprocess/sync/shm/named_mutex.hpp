...
#ifndef HBOOST_INTERPROCESS_SHM_NAMED_MUTEX_HPP
#define HBOOST_INTERPROCESS_SHM_NAMED_MUTEX_HPP
...
inline bool shm_named_mutex::timed_lock(const hboost::posix_time::ptime &abs_time)
...
#endif   //HBOOST_INTERPROCESS_SHM_NAMED_MUTEX_HPP
