...
#ifndef HBOOST_INTERPROCESS_MANAGED_MAPPED_FILE_HPP
#define HBOOST_INTERPROCESS_MANAGED_MAPPED_FILE_HPP
...
#include <hboost/interprocess/detail/managed_memory_impl.hpp>
#include <hboost/interprocess/creation_tags.hpp>
#include <hboost/interprocess/detail/file_wrapper.hpp>
#include <hboost/move/utility_core.hpp>
#include <hboost/interprocess/file_mapping.hpp>
#include <hboost/interprocess/permissions.hpp>
//These includes needed to fulfill default template parameters of
//predeclarations in interprocess_fwd.hpp
#include <hboost/interprocess/mem_algo/rbtree_best_fit.hpp>
#include <hboost/interprocess/sync/mutex_family.hpp>
   ...
   #endif   //#ifndef HBOOST_INTERPROCESS_DOXYGEN_INVOKED
{
   ...
   HBOOST_MOVABLE_BUT_NOT_COPYABLE(basic_managed_mapped_file)
   #endif   //#ifndef HBOOST_INTERPROCESS_DOXYGEN_INVOKED
   ...
   typedef typename HBOOST_INTERPROCESS_IMPDEF(base_t::size_type) size_type;
   ...
   //!Does not throw
   basic_managed_mapped_file(HBOOST_RV_REF(basic_managed_mapped_file) moved)
   {
      this->swap(moved);
   }
   ...
   //!Moves the ownership of "moved"'s managed memory to *this.
   //!Does not throw
   basic_managed_mapped_file &operator=(HBOOST_RV_REF(basic_managed_mapped_file) moved)
   {
      basic_managed_mapped_file tmp(hboost::move(moved));
      this->swap(tmp);
      return *this;
   }
...
#ifdef HBOOST_INTERPROCESS_DOXYGEN_INVOKED
...
#endif   //#ifdef HBOOST_INTERPROCESS_DOXYGEN_INVOKED
...
#endif   //HBOOST_INTERPROCESS_MANAGED_MAPPED_FILE_HPP
