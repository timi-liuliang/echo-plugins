...
#ifndef HBOOST_INTERPROCESS_ALLOCATOR_HPP
#define HBOOST_INTERPROCESS_ALLOCATOR_HPP
...
#include <hboost/interprocess/allocators/detail/allocator_common.hpp>
#include <hboost/interprocess/detail/utilities.hpp>
#include <hboost/interprocess/containers/version_type.hpp>
...
class allocator
{
   ...
   typedef hboost::interprocess::version_type<allocator, 2>   version;
   ...
   {  hboost::adl_move_swap(alloc1.mp_mngr, alloc2.mp_mngr);   }
...
template<class T, class SegmentManager>
struct has_trivial_destructor
   <hboost::interprocess::allocator <T, SegmentManager> >
{
...
#endif   //HBOOST_INTERPROCESS_ALLOCATOR_HPP
