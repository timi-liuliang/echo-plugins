...
#ifndef HBOOST_IOSTREAMS_CHAR_TRAITS_HPP_INCLUDED
#define HBOOST_IOSTREAMS_CHAR_TRAITS_HPP_INCLUDED
...
// NOTE: Use HBOOST_WORKAROUND?
#if (defined(__QNX__) && defined(HBOOST_DINKUMWARE_STDLIB))  \
    || defined(__SUNPRO_CC)
using ::std::wint_t;
#endif
...
template<>
struct char_traits<char> : HBOOST_IOSTREAMS_CHAR_TRAITS(char) {
...
#endif // #ifndef HBOOST_IOSTREAMS_CHAR_TRAITS_HPP_INCLUDED
