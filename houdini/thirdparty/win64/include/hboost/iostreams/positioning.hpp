...
#ifndef HBOOST_IOSTREAMS_POSITIONING_HPP_INCLUDED
#define HBOOST_IOSTREAMS_POSITIONING_HPP_INCLUDED
...
#include <hboost/iostreams/detail/config/codecvt.hpp> // mbstate_t.
#include <hboost/iostreams/detail/config/fpos.hpp>
#include <hboost/iostreams/detail/ios.hpp> // streamoff, streampos.
...
typedef hboost::intmax_t stream_offset;
...
// hboost::iostreams::stream_offset by extracting the two stream offsets and
...
#endif // #ifndef HBOOST_IOSTREAMS_POSITIONING_HPP_INCLUDED
