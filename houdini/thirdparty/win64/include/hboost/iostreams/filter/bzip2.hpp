...
#ifndef HBOOST_IOSTREAMS_BZIP2_HPP_INCLUDED
#define HBOOST_IOSTREAMS_BZIP2_HPP_INCLUDED
...
#include <hboost/iostreams/detail/config/bzip2.hpp>
...
HBOOST_IOSTREAMS_DECL extern const int ok;
HBOOST_IOSTREAMS_DECL extern const int run_ok;
HBOOST_IOSTREAMS_DECL extern const int flush_ok;
HBOOST_IOSTREAMS_DECL extern const int finish_ok;
HBOOST_IOSTREAMS_DECL extern const int stream_end;    
HBOOST_IOSTREAMS_DECL extern const int sequence_error;
HBOOST_IOSTREAMS_DECL extern const int param_error;
HBOOST_IOSTREAMS_DECL extern const int mem_error;
HBOOST_IOSTREAMS_DECL extern const int data_error;
HBOOST_IOSTREAMS_DECL extern const int data_error_magic;
HBOOST_IOSTREAMS_DECL extern const int io_error;
HBOOST_IOSTREAMS_DECL extern const int unexpected_eof;
HBOOST_IOSTREAMS_DECL extern const int outbuff_full;
HBOOST_IOSTREAMS_DECL extern const int config_error;

                    // Action codes

HBOOST_IOSTREAMS_DECL extern const int finish;
HBOOST_IOSTREAMS_DECL extern const int run;
...
//
class HBOOST_IOSTREAMS_DECL bzip2_error : public HBOOST_IOSTREAMS_FAILURE {
public:
...
template< typename Alloc,
          typename Base = // VC6 workaround (C2516)
              HBOOST_DEDUCED_TYPENAME bzip2_allocator_traits<Alloc>::type >
...
class HBOOST_IOSTREAMS_DECL bzip2_base  { 
public:
...
HBOOST_IOSTREAMS_PIPABLE(basic_bzip2_compressor, 1)
...
HBOOST_IOSTREAMS_PIPABLE(basic_bzip2_decompressor, 1)
      ...
      char*& dest_begin, char* dest_end, bool flush )
{
    ...
    bzip2_error::check HBOOST_PREVENT_MACRO_SUBSTITUTION(result);
...
#endif // #ifndef HBOOST_IOSTREAMS_BZIP2_HPP_INCLUDED
