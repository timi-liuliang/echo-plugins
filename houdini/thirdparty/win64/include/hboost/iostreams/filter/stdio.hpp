...
#ifndef HBOOST_IOSTREAMS_STDIO_FILTER_HPP_INCLUDED
#define HBOOST_IOSTREAMS_STDIO_FILTER_HPP_INCLUDED
...
#include <hboost/iostreams/filter/aggregate.hpp>
...
#endif // HBOOST_IOSTREAMS_NO_WIDE_STREAMS

    struct scoped_redirector { // Thanks to Maxim Egorushkin.
        typedef HBOOST_IOSTREAMS_CHAR_TRAITS(Ch)                  traits_type;
        typedef HBOOST_IOSTREAMS_BASIC_IOS(Ch, traits_type)       ios_type;
        typedef HBOOST_IOSTREAMS_BASIC_STREAMBUF(Ch, traits_type) streambuf_type;
...
HBOOST_IOSTREAMS_PIPABLE(basic_stdio_filter, 2)
...
#endif // #ifndef HBOOST_IOSTREAMS_STDIO_FILTER_HPP_INCLUDED
