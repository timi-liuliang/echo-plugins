...
#ifndef HBOOST_IOSTREAMS_ZLIB_HPP_INCLUDED
#define HBOOST_IOSTREAMS_ZLIB_HPP_INCLUDED
...
#include <new>          
#include <hboost/config.hpp>  // MSVC, STATIC_CONSTANT, DEDUCED_TYPENAME, DINKUM.
#include <hboost/cstdint.hpp> // uint*_t
#include <hboost/detail/workaround.hpp>
#include <hboost/iostreams/constants.hpp>   // buffer size.
#include <hboost/iostreams/detail/config/auto_link.hpp>
#include <hboost/iostreams/detail/config/dyn_link.hpp>
#include <hboost/iostreams/detail/config/wide_streams.hpp>
#include <hboost/iostreams/detail/config/zlib.hpp>
#include <hboost/iostreams/detail/ios.hpp>  // failure, streamsize.
#include <hboost/iostreams/filter/symmetric.hpp>                
...
HBOOST_IOSTREAMS_DECL extern const int no_compression;
HBOOST_IOSTREAMS_DECL extern const int best_speed;
HBOOST_IOSTREAMS_DECL extern const int best_compression;
HBOOST_IOSTREAMS_DECL extern const int default_compression;

                    // Compression methods

HBOOST_IOSTREAMS_DECL extern const int deflated;

                    // Compression strategies

HBOOST_IOSTREAMS_DECL extern const int default_strategy;
HBOOST_IOSTREAMS_DECL extern const int filtered;
HBOOST_IOSTREAMS_DECL extern const int huffman_only;

                    // Status codes

HBOOST_IOSTREAMS_DECL extern const int okay;
HBOOST_IOSTREAMS_DECL extern const int stream_end;
HBOOST_IOSTREAMS_DECL extern const int stream_error;
HBOOST_IOSTREAMS_DECL extern const int version_error;
HBOOST_IOSTREAMS_DECL extern const int data_error;
HBOOST_IOSTREAMS_DECL extern const int mem_error;
HBOOST_IOSTREAMS_DECL extern const int buf_error;

                    // Flush codes

HBOOST_IOSTREAMS_DECL extern const int finish;
HBOOST_IOSTREAMS_DECL extern const int no_flush;
HBOOST_IOSTREAMS_DECL extern const int sync_flush;

                    // Code for current OS

//HBOOST_IOSTREAMS_DECL extern const int os_code;
...
//
class HBOOST_IOSTREAMS_DECL zlib_error : public HBOOST_IOSTREAMS_FAILURE {
public:
    explicit zlib_error(int error);
    int error() const { return error_; }
    static void check HBOOST_PREVENT_MACRO_SUBSTITUTION(int error);
private:
    int error_;
};
...
template< typename Alloc,
          typename Base = // VC6 workaround (C2516)
              HBOOST_DEDUCED_TYPENAME zlib_allocator_traits<Alloc>::type >
struct zlib_allocator : private Base {
private:
    typedef typename Base::size_type size_type;
public:
    HBOOST_STATIC_CONSTANT(bool, custom = 
...
class HBOOST_IOSTREAMS_DECL zlib_base { 
public:
...
HBOOST_IOSTREAMS_PIPABLE(basic_zlib_compressor, 1)
...
HBOOST_IOSTREAMS_PIPABLE(basic_zlib_decompressor, 1)
      ...
      char*& dest_begin, char* dest_end, bool flush )
{
    ...
    zlib_error::check HBOOST_PREVENT_MACRO_SUBSTITUTION(result);
...
#endif // #ifndef HBOOST_IOSTREAMS_ZLIB_HPP_INCLUDED
