...
#ifndef HBOOST_IOSTREAMS_FLUSH_HPP_INCLUDED
#define HBOOST_IOSTREAMS_FLUSH_HPP_INCLUDED
...
struct flush_device_impl<ostream_tag> {
    ...
    { return t.rdbuf()->HBOOST_IOSTREAMS_PUBSYNC() == 0; }
};
...
struct flush_device_impl<streambuf_tag> {
    template<typename T>
    static bool flush(T& t)
    { return t.HBOOST_IOSTREAMS_PUBSYNC() == 0; }
};
...
#endif // #ifndef HBOOST_IOSTREAMS_FLUSH_HPP_INCLUDED
