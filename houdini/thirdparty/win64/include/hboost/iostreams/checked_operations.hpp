...
#ifndef HBOOST_IOSTREAMS_DETAIL_CHECKED_OPERATIONS_HPP_INCLUDED
#define HBOOST_IOSTREAMS_DETAIL_CHECKED_OPERATIONS_HPP_INCLUDED
...
#include <hboost/iostreams/get.hpp>
#include <hboost/iostreams/put.hpp>
#include <hboost/iostreams/read.hpp>
#include <hboost/iostreams/seek.hpp>
#include <hboost/iostreams/traits.hpp>
#include <hboost/iostreams/write.hpp>
...
seek_if( T& t, stream_offset off, HBOOST_IOS::seekdir way, 
...
struct read_write_if_impl<input> {
    ...
    { hboost::throw_exception(cant_write());
      HBOOST_IOSTREAMS_UNREACHABLE_RETURN(false) }
...
struct seek_if_impl<any_tag> {
    template<typename T>
    static std::streampos 
    seek(T&, stream_offset, HBOOST_IOS::seekdir, HBOOST_IOS::openmode)
    { hboost::throw_exception(cant_seek());
      HBOOST_IOSTREAMS_UNREACHABLE_RETURN(std::streampos()) }
};
...
#endif // #ifndef HBOOST_IOSTREAMS_DETAIL_CHECKED_OPERATIONS_HPP_INCLUDED
