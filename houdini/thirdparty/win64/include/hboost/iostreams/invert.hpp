...
#ifndef HBOOST_IOSTREAMS_INVERT_HPP_INCLUDED
#define HBOOST_IOSTREAMS_INVERT_HPP_INCLUDED
...
#include <hboost/detail/workaround.hpp>           // default_filter_buffer_size.
#include <hboost/iostreams/char_traits.hpp>
#include <hboost/iostreams/compose.hpp>
...
#include <hboost/iostreams/detail/counted_array.hpp>
#include <hboost/iostreams/detail/execute.hpp>
#include <hboost/iostreams/detail/functional.hpp> // clear_flags, call_reset
...
private:
    filter_ref filter() { return hboost::ref(pimpl_->filter_); }
...
#endif // #ifndef HBOOST_IOSTREAMS_INVERT_HPP_INCLUDED
