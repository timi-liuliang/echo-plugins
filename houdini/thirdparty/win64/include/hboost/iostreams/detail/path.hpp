 ...
 *
 * File:        hboost/iostreams/detail/path.hpp
 * Date:        Sat Jun 21 21:24:05 MDT 2008
 * Copyright:   2008 CodeRage, LLC
 * Author:      Jonathan Turkanis
 * Contact:     turkanis at coderage dot com
 *
 * Defines the class hboost::iostreams::detail::path, for storing a 
...
#ifndef HBOOST_IOSTREAMS_DETAIL_PATH_HPP_INCLUDED
#define HBOOST_IOSTREAMS_DETAIL_PATH_HPP_INCLUDED
...
public:
    ...
    // Constructor taking a hboost::filesystem2::path or
    // hboost::filesystem2::wpath
    ...
    // Constructor taking a hboost::filesystem3::path (boost filesystem v3)
    template<typename Path>
    ...
    // Assignment operator taking a hboost::filesystem2::path or
    // hboost::filesystem2::wpath
    ...
    // Assignment operator taking a hboost::filesystem3::path
    template<typename Path>
...
private:
    ...
    // For wide-character paths, use a hboost::filesystem::wpath instead of a
    // std::wstring
...
#else // #ifndef HBOOST_IOSTREAMS_NO_WIDE_STREAMS //---------------------------//
...
#endif // #ifndef HBOOST_IOSTREAMS_NO_WIDE_STREAMS //--------------------------//

} } } // End namespaces detail, iostreams, boost.

#endif // #ifndef HBOOST_IOSTREAMS_DETAIL_PATH_HPP_INCLUDED
