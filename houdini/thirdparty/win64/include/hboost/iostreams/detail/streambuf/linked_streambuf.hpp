...
#ifndef HBOOST_IOSTREAMS_DETAIL_LINKED_STREAMBUF_HPP_INCLUDED
#define HBOOST_IOSTREAMS_DETAIL_LINKED_STREAMBUF_HPP_INCLUDED
...
#define HBOOST_IOSTREAMS_USING_PROTECTED_STREAMBUF_MEMBERS(base) \
...
template<typename Ch, typename Tr = HBOOST_IOSTREAMS_CHAR_TRAITS(Ch) >
class linked_streambuf : public HBOOST_IOSTREAMS_BASIC_STREAMBUF(Ch, Tr) {
protected:
...
protected:
...
#else
    public:
        typedef HBOOST_IOSTREAMS_BASIC_STREAMBUF(Ch, Tr) base;
        HBOOST_IOSTREAMS_USING_PROTECTED_STREAMBUF_MEMBERS(base)
#endif
    ...
    virtual void close_impl(HBOOST_IOS::openmode) = 0;
...
#endif // #ifndef HBOOST_IOSTREAMS_DETAIL_LINKED_STREAMBUF_HPP_INCLUDED
