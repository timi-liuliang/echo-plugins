...
#ifndef HBOOST_IOSTREAMS_DETAIL_RANGE_ADAPTER_HPP_INCLUDED
#define HBOOST_IOSTREAMS_DETAIL_RANGE_ADAPTER_HPP_INCLUDED
...
#include <hboost/detail/iterator.hpp>             // hboost::iterator_traits.
...
// Description: Device based on an instance of hboost::iterator_range.
// Template parameters:
//     Mode - A mode tag.
...
private:
    ...
    typedef hboost::detail::iterator_traits<iterator>  iter_traits;
...
#endif // #ifndef HBOOST_IOSTREAMS_DETAIL_RANGE_ADAPTER_HPP_INCLUDED //---------------//
