...
#ifndef HBOOST_IOSTREAMS_DETAIL_MODE_ADAPTER_HPP_INCLUDED
#define HBOOST_IOSTREAMS_DETAIL_MODE_ADAPTER_HPP_INCLUDED
...
{ return hboost::iostreams::seek(t_, off, way, which); }
    ...
    template<typename Mode, typename T>
    void mode_adapter<Mode, T>::close(HBOOST_IOS::openmode which) 
    { iostreams::close(t_, which); }
#endif

} } } // End namespaces detail, iostreams, boost.

#endif // #ifndef HBOOST_IOSTREAMS_DETAIL_MODE_ADAPTER_HPP_INCLUDED //-----//
