...
#ifndef HBOOST_IOSTREAMS_DETAIL_COUNTED_ARRAY_HPP_INCLUDED
#define HBOOST_IOSTREAMS_DETAIL_COUNTED_ARRAY_HPP_INCLUDED
...
public:
    ...
    std::streamsize read(Ch* s, std::streamsize n)
    {
        ...
        HBOOST_IOSTREAMS_CHAR_TRAITS(char_type)::copy
            (s, buf_ + ptr_, result);
        ptr_ += result;
        return result;
    }
...
#endif // #ifndef HBOOST_IOSTREAMS_DETAIL_COUNTED_ARRAY_HPP_INCLUDED
