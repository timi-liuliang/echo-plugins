...
// hboost::iostreams::detail::double_object, which is similar to compressed pair
// except that both members of the pair have the same type, and 
// compression occurs only if requested using a boolean template
// parameter.

#ifndef HBOOST_IOSTREAMS_DETAIL_DOUBLE_OBJECT_HPP_INCLUDED
#define HBOOST_IOSTREAMS_DETAIL_DOUBLE_OBJECT_HPP_INCLUDED
...
#else
    typedef hboost::call_traits<T>                  traits_type;
#endif
...
#endif // #ifndef HBOOST_IOSTREAMS_DETAIL_DOUBLE_OBJECT_HPP_INCLUDED
