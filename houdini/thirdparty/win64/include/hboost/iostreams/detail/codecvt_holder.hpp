...
#ifndef HBOOST_IOSTREAMS_DETAIL_CODECVT_HOLDER_HPP_INCLUDED
#define HBOOST_IOSTREAMS_DETAIL_CODECVT_HOLDER_HPP_INCLUDED
...
#include <hboost/config.hpp>  // HAS_MACRO_USE_FACET.
...
struct codecvt_holder<default_codecvt> {
    ...
    {
        using namespace std;
        #ifndef HBOOST_HAS_MACRO_USE_FACET
...
#endif // #ifndef HBOOST_IOSTREAMS_DETAIL_CODECVT_HOLDER_HPP_INCLUDED
