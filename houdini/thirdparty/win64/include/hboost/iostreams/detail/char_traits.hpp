...
// be confused with <hboost/iostreams/char_traits.hpp>, which defines the
// template hboost::iostreams::char_traits.

// See http://www.boost.org/libs/iostreams for documentation.

#ifndef HBOOST_IOSTREAMS_DETAIL_CHAR_TRAITS_HPP_INCLUDED
#define HBOOST_IOSTREAMS_DETAIL_CHAR_TRAITS_HPP_INCLUDED
...
# define HBOOST_IOSTREAMS_CHAR_TRAITS(ch) std::char_traits< ch >
#else
# define HBOOST_IOSTREAMS_CHAR_TRAITS(ch) hboost::iostreams::detail::char_traits
...
#endif // #ifdef HBOOST_IOSTREAMS_NO_STREAM_TEMPLATES //-----------------------//

#endif // #ifndef HBOOST_IOSTREAMS_DETAIL_CHAR_TRAITS_HPP_INCLUDED
