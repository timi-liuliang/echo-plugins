...
#ifndef HBOOST_IOSTREAMS_DETAIL_SYSTEM_FAILURE_HPP_INCLUDED
#define HBOOST_IOSTREAMS_DETAIL_SYSTEM_FAILURE_HPP_INCLUDED
...
inline HBOOST_IOSTREAMS_FAILURE system_failure(const char* msg)
{
    std::string result;
#ifdef HBOOST_IOSTREAMS_WINDOWS
    DWORD err;
...
#endif
    return HBOOST_IOSTREAMS_FAILURE(result);
}

inline HBOOST_IOSTREAMS_FAILURE system_failure(const std::string& msg)
{ return system_failure(msg.c_str()); }

inline void throw_system_failure(const char* msg)
{ hboost::throw_exception(system_failure(msg)); }
...
#endif // #ifndef HBOOST_IOSTREAMS_DETAIL_SYSTEM_FAILURE_HPP_INCLUDED
