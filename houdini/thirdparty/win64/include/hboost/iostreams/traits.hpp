...
#ifndef HBOOST_IOSTREAMS_IO_TRAITS_HPP_INCLUDED
#define HBOOST_IOSTREAMS_IO_TRAITS_HPP_INCLUDED
...
#include <hboost/config.hpp>  // partial spec, deduced typename.
#include <hboost/detail/workaround.hpp>
#include <hboost/iostreams/categories.hpp>
#include <hboost/iostreams/detail/bool_trait_def.hpp> 
#include <hboost/iostreams/detail/config/wide_streams.hpp>
#include <hboost/iostreams/detail/is_iterator_range.hpp>    
#include <hboost/iostreams/detail/select.hpp>        
#include <hboost/iostreams/detail/select_by_size.hpp>      
#include <hboost/iostreams/detail/wrap_unwrap.hpp>       
#include <hboost/iostreams/traits_fwd.hpp> 
...
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istream, std::basic_istream, 2)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostream, std::basic_ostream, 2)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_iostream, std::basic_iostream, 2)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_streambuf, std::basic_streambuf, 2)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ifstream, std::basic_ifstream, 2)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ofstream, std::basic_ofstream, 2)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_fstream, std::basic_fstream, 2)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_filebuf, std::basic_filebuf, 2)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istringstream, std::basic_istringstream, 3)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostringstream, std::basic_ostringstream, 3)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_stringstream, std::basic_stringstream, 3)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_stringbuf, std::basic_stringbuf, 3)

#else // #ifndef HBOOST_IOSTREAMS_NO_STREAM_TEMPLATES //-----------------------//

HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istream, std::istream, 0)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostream, std::ostream, 0)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_iostream, std::iostream, 0)
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_streambuf, std::streambuf, 0)
...
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_hboost_stream,
                                hboost::iostreams::stream,
                                3 )
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_hboost_stream_buffer,
                                hboost::iostreams::stream_buffer,
                                4 )
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_stream_impl,
                                hboost::iostreams::filtering_stream,
                                5 )
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_wstream_impl,
                                hboost::iostreams::wfiltering_stream,
                                5 )
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_streambuf_impl,
                                hboost::iostreams::filtering_streambuf,
                                5 )
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_wstreambuf_impl,
                                hboost::iostreams::filtering_wstreambuf,
                                5 )
HBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_linked, linked_streambuf, 2)
...
#else // #ifndef HBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION //------------------//
...
struct char_type_of {
    ...
    typedef typename 
            mpl::eval_if<
                ...
                get_value_type<T>,
                detail::member_char_type<
                    HBOOST_DEDUCED_TYPENAME detail::unwrapped_type<T>::type
                >
            >::type type;
};

#endif // #ifndef HBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION //-----------------//
...
#define HBOOST_IOSTREAMS_MODE_HELPER(tag_, id_) \
    case_<id_> io_mode_impl_helper(tag_); \
    template<> struct io_mode_impl<id_> { typedef tag_ type; }; \
    /**/
HBOOST_IOSTREAMS_MODE_HELPER(input, 1)
HBOOST_IOSTREAMS_MODE_HELPER(output, 2)
HBOOST_IOSTREAMS_MODE_HELPER(bidirectional, 3)
HBOOST_IOSTREAMS_MODE_HELPER(input_seekable, 4)
HBOOST_IOSTREAMS_MODE_HELPER(output_seekable, 5)
HBOOST_IOSTREAMS_MODE_HELPER(seekable, 6)
HBOOST_IOSTREAMS_MODE_HELPER(dual_seekable, 7)
HBOOST_IOSTREAMS_MODE_HELPER(bidirectional_seekable, 8)
HBOOST_IOSTREAMS_MODE_HELPER(dual_use, 9)
#undef HBOOST_IOSTREAMS_MODE_HELPER

template<typename T>
struct io_mode_id {
    typedef typename category_of<T>::type category;
    HBOOST_SELECT_BY_SIZE(int, value, detail::io_mode_impl_helper(category()));
};
...
struct has_trait_impl {
    typedef typename category_of<T>::type category;
    HBOOST_STATIC_CONSTANT(bool, value = (is_convertible<category, Tag>::value));
};
...
//------------------Definition of HBOOST_IOSTREAMS_STREAMBUF_TYPEDEFS----------//

#define HBOOST_IOSTREAMS_STREAMBUF_TYPEDEFS(Tr) \
...
#endif // #ifndef HBOOST_IOSTREAMS_IO_TRAITS_HPP_INCLUDED
