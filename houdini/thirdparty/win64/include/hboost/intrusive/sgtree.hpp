...
#ifndef HBOOST_INTRUSIVE_SGTREE_HPP
#define HBOOST_INTRUSIVE_SGTREE_HPP

#include <hboost/intrusive/detail/config_begin.hpp>
#include <hboost/intrusive/intrusive_fwd.hpp>
#include <hboost/intrusive/detail/assert.hpp>
#include <hboost/static_assert.hpp>
#include <hboost/intrusive/bs_set_hook.hpp>
#include <hboost/intrusive/bstree.hpp>
#include <hboost/intrusive/detail/tree_node.hpp>
#include <hboost/intrusive/pointer_traits.hpp>
#include <hboost/intrusive/detail/mpl.hpp>
#include <hboost/intrusive/detail/math.hpp>
#include <hboost/intrusive/detail/get_value_traits.hpp>
#include <hboost/intrusive/sgtree_algorithms.hpp>
#include <hboost/intrusive/detail/key_nodeptr_comp.hpp>
...
#include <cstddef>
#include <hboost/intrusive/detail/minimal_less_equal_header.hpp>
...
struct alpha_holder
{
   typedef hboost::intrusive::detail::h_alpha_t           h_alpha_t;
   typedef hboost::intrusive::detail::alpha_by_max_size_t multiply_by_alpha_t;
...
struct alpha_holder<false, SizeType>
{
   ...
   typedef hboost::intrusive::detail::h_alpha_sqrt2_t           h_alpha_t;
   typedef hboost::intrusive::detail::alpha_0_75_by_max_size_t  multiply_by_alpha_t;
   ...
   {  //alpha CAN't be changed.
      HBOOST_INTRUSIVE_INVARIANT_ASSERT(0);
   }
   ...
   /// @endcond
{
   ...
   typedef HBOOST_INTRUSIVE_IMPDEF(sgtree_algorithms<node_traits>)    node_algorithms;
   ...
   HBOOST_MOVABLE_BUT_NOT_COPYABLE(sgtree_impl)
   HBOOST_STATIC_ASSERT(((int)value_traits::link_mode != (int)auto_unlink));
   ...
   typedef HBOOST_INTRUSIVE_IMPDEF(typename node_algorithms::insert_commit_data) insert_commit_data;

   //! @copydoc ::hboost::intrusive::bstree::bstree()
   sgtree_impl()
      :  tree_type()
   {}

   //! @copydoc ::hboost::intrusive::bstree::bstree(const key_compare &,const value_traits &)
   explicit sgtree_impl( const key_compare &cmp, const value_traits &v_traits = value_traits())
      :  tree_type(cmp, v_traits)
   {}

   //! @copydoc ::hboost::intrusive::bstree::bstree(bool,Iterator,Iterator,const key_compare &,const value_traits &)
   ...
   //! @copydoc ::hboost::intrusive::bstree::bstree(bstree &&)
   sgtree_impl(HBOOST_RV_REF(sgtree_impl) x)
      :  tree_type(HBOOST_MOVE_BASE(tree_type, x)), alpha_traits(x.get_alpha_traits())
   {  ::hboost::adl_move_swap(this->get_alpha_traits(), x.get_alpha_traits());   }

   //! @copydoc ::hboost::intrusive::bstree::operator=(bstree &&)
   sgtree_impl& operator=(HBOOST_RV_REF(sgtree_impl) x)
   {
      this->get_alpha_traits() = x.get_alpha_traits();
      return static_cast<sgtree_impl&>(tree_type::operator=(HBOOST_MOVE_BASE(tree_type, x)));
   }
   ...
   //! @copydoc ::hboost::intrusive::bstree::begin()
   iterator begin();

   //! @copydoc ::hboost::intrusive::bstree::begin()const
   const_iterator begin() const;

   //! @copydoc ::hboost::intrusive::bstree::cbegin()const
   const_iterator cbegin() const;

   //! @copydoc ::hboost::intrusive::bstree::end()
   iterator end();

   //! @copydoc ::hboost::intrusive::bstree::end()const
   const_iterator end() const;

   //! @copydoc ::hboost::intrusive::bstree::cend()const
   const_iterator cend() const;

   //! @copydoc ::hboost::intrusive::bstree::rbegin()
   reverse_iterator rbegin();

   //! @copydoc ::hboost::intrusive::bstree::rbegin()const
   const_reverse_iterator rbegin() const;

   //! @copydoc ::hboost::intrusive::bstree::crbegin()const
   const_reverse_iterator crbegin() const;

   //! @copydoc ::hboost::intrusive::bstree::rend()
   reverse_iterator rend();

   //! @copydoc ::hboost::intrusive::bstree::rend()const
   const_reverse_iterator rend() const;

   //! @copydoc ::hboost::intrusive::bstree::crend()const
   const_reverse_iterator crend() const;

   //! @copydoc ::hboost::intrusive::bstree::container_from_end_iterator(iterator)
   static sgtree_impl &container_from_end_iterator(iterator end_iterator);

   //! @copydoc ::hboost::intrusive::bstree::container_from_end_iterator(const_iterator)
   static const sgtree_impl &container_from_end_iterator(const_iterator end_iterator);

   //! @copydoc ::hboost::intrusive::bstree::container_from_iterator(iterator)
   static sgtree_impl &container_from_iterator(iterator it);

   //! @copydoc ::hboost::intrusive::bstree::container_from_iterator(const_iterator)
   static const sgtree_impl &container_from_iterator(const_iterator it);

   //! @copydoc ::hboost::intrusive::bstree::key_comp()const
   key_compare key_comp() const;

   //! @copydoc ::hboost::intrusive::bstree::value_comp()const
   value_compare value_comp() const;

   //! @copydoc ::hboost::intrusive::bstree::empty()const
   bool empty() const;

   //! @copydoc ::hboost::intrusive::bstree::size()const
   size_type size() const;

   #endif   //#ifdef HBOOST_INTRUSIVE_DOXYGEN_INVOKED

   //! @copydoc ::hboost::intrusive::bstree::swap
   void swap(sgtree_impl& other)
   {
      //This can throw
      this->tree_type::swap(static_cast<tree_type&>(other));
      ::hboost::adl_move_swap(this->get_alpha_traits(), other.get_alpha_traits());
   }

   //! @copydoc ::hboost::intrusive::bstree::clone_from(const bstree&,Cloner,Disposer)
   ...
   //! @copydoc ::hboost::intrusive::bstree::clone_from(bstree&&,Cloner,Disposer)
   //! Additional notes: it also copies the alpha factor from the source container.
   template <class Cloner, class Disposer>
   void clone_from(HBOOST_RV_REF(sgtree_impl) src, Cloner cloner, Disposer disposer)
   {
      tree_type::clone_from(HBOOST_MOVE_BASE(tree_type, src), cloner, disposer);
      this->get_alpha_traits() = ::hboost::move(src.get_alpha_traits());
   }

   //! @copydoc ::hboost::intrusive::bstree::insert_equal(reference)
   iterator insert_equal(reference value)
   {
      node_ptr to_insert(this->get_value_traits().to_node_ptr(value));
      if(safemode_or_autounlink)
         HBOOST_INTRUSIVE_SAFE_HOOK_DEFAULT_ASSERT(node_algorithms::unique(to_insert));
   ...
   //! @copydoc ::hboost::intrusive::bstree::insert_equal(const_iterator,reference)
   ...
   //! @copydoc ::hboost::intrusive::bstree::insert_equal(Iterator,Iterator)
   template<class Iterator>
   ...
   //! @copydoc ::hboost::intrusive::bstree::insert_unique(reference)
   ...
   //! @copydoc ::hboost::intrusive::bstree::insert_unique(const_iterator,reference)
   ...
   //! @copydoc ::hboost::intrusive::bstree::insert_unique_check(const KeyType&,KeyTypeKeyCompare,insert_commit_data&)
   template<class KeyType, class KeyTypeKeyCompare>
   HBOOST_INTRUSIVE_DOC1ST(std::pair<iterator HBOOST_INTRUSIVE_I bool>
      , typename detail::disable_if_convertible
         <KeyType HBOOST_INTRUSIVE_I const_iterator HBOOST_INTRUSIVE_I 
         std::pair<iterator HBOOST_INTRUSIVE_I bool> >::type)
      insert_unique_check
   ...
   //! @copydoc ::hboost::intrusive::bstree::insert_unique_check(const_iterator,const KeyType&,KeyTypeKeyCompare,insert_commit_data&)
   template<class KeyType, class KeyTypeKeyCompare>
   ...
   //! @copydoc ::hboost::intrusive::bstree::insert_unique_check(const key_type&,insert_commit_data&)
   std::pair<iterator, bool> insert_unique_check
      (const key_type &key, insert_commit_data &commit_data)
   {  return this->insert_unique_check(key, this->key_comp(), commit_data);   }

   //! @copydoc ::hboost::intrusive::bstree::insert_unique_check(const_iterator,const key_type&,insert_commit_data&)
   std::pair<iterator, bool> insert_unique_check
      (const_iterator hint, const key_type &key, insert_commit_data &commit_data)
   {  return this->insert_unique_check(hint, key, this->key_comp(), commit_data);   }

   //! @copydoc ::hboost::intrusive::bstree::insert_unique_commit
   ...
   //! @copydoc ::hboost::intrusive::bstree::insert_unique(Iterator,Iterator)
   template<class Iterator>
   ...
   //! @copydoc ::hboost::intrusive::bstree::insert_before
   ...
   //! @copydoc ::hboost::intrusive::bstree::push_back
   ...
   //! @copydoc ::hboost::intrusive::bstree::push_front
   ...
   //! @copydoc ::hboost::intrusive::bstree::erase(const_iterator)
   iterator erase(const_iterator i)
   {
      ...
      if(safemode_or_autounlink)
         HBOOST_INTRUSIVE_SAFE_HOOK_DEFAULT_ASSERT(!node_algorithms::unique(to_erase));
   ...
   //! @copydoc ::hboost::intrusive::bstree::erase(const_iterator,const_iterator)
   iterator erase(const_iterator b, const_iterator e)
   {  size_type n;   return private_erase(b, e, n);   }

   //! @copydoc ::hboost::intrusive::bstree::erase(const key_type &)
   size_type erase(const key_type &key)
   {  return this->erase(key, this->key_comp());   }

   //! @copydoc ::hboost::intrusive::bstree::erase(const KeyType&,KeyTypeKeyCompare)
   template<class KeyType, class KeyTypeKeyCompare>
   HBOOST_INTRUSIVE_DOC1ST(size_type
      , typename detail::disable_if_convertible<KeyTypeKeyCompare HBOOST_INTRUSIVE_I const_iterator HBOOST_INTRUSIVE_I size_type>::type)
   ...
   //! @copydoc ::hboost::intrusive::bstree::erase_and_dispose(const_iterator,Disposer)
   ...
   //! @copydoc ::hboost::intrusive::bstree::erase_and_dispose(const_iterator,const_iterator,Disposer)
   template<class Disposer>
   iterator erase_and_dispose(const_iterator b, const_iterator e, Disposer disposer)
   {  size_type n;   return private_erase(b, e, n, disposer);   }

   //! @copydoc ::hboost::intrusive::bstree::erase_and_dispose(const key_type &, Disposer)
   template<class Disposer>
   ...
   //! @copydoc ::hboost::intrusive::bstree::erase_and_dispose(const KeyType&,KeyTypeKeyCompare,Disposer)
   ...
   //! @copydoc ::hboost::intrusive::bstree::clear
   void clear()
   {
      tree_type::clear();
   ...
   //! @copydoc ::hboost::intrusive::bstree::clear_and_dispose
   template<class Disposer>
   ...
   #ifdef HBOOST_INTRUSIVE_DOXYGEN_INVOKED
   //! @copydoc ::hboost::intrusive::bstree::count(const key_type &)const
   size_type count(const key_type &key) const;

   //! @copydoc ::hboost::intrusive::bstree::count(const KeyType&,KeyTypeKeyCompare)const
   template<class KeyType, class KeyTypeKeyCompare>
   size_type count(const KeyType& key, KeyTypeKeyCompare comp) const;

   //! @copydoc ::hboost::intrusive::bstree::lower_bound(const key_type &)
   iterator lower_bound(const key_type &key);

   //! @copydoc ::hboost::intrusive::bstree::lower_bound(const KeyType&,KeyTypeKeyCompare)
   template<class KeyType, class KeyTypeKeyCompare>
   iterator lower_bound(const KeyType& key, KeyTypeKeyCompare comp);

   //! @copydoc ::hboost::intrusive::bstree::lower_bound(const key_type &)const
   const_iterator lower_bound(const key_type &key) const;

   //! @copydoc ::hboost::intrusive::bstree::lower_bound(const KeyType&,KeyTypeKeyCompare)const
   template<class KeyType, class KeyTypeKeyCompare>
   const_iterator lower_bound(const KeyType& key, KeyTypeKeyCompare comp) const;

   //! @copydoc ::hboost::intrusive::bstree::upper_bound(const key_type &)
   iterator upper_bound(const key_type &key);

   //! @copydoc ::hboost::intrusive::bstree::upper_bound(const KeyType&,KeyTypeKeyCompare)
   template<class KeyType, class KeyTypeKeyCompare>
   iterator upper_bound(const KeyType& key, KeyTypeKeyCompare comp);

   //! @copydoc ::hboost::intrusive::bstree::upper_bound(const key_type &)const
   const_iterator upper_bound(const key_type &key) const;

   //! @copydoc ::hboost::intrusive::bstree::upper_bound(const KeyType&,KeyTypeKeyCompare)const
   template<class KeyType, class KeyTypeKeyCompare>
   const_iterator upper_bound(const KeyType& key, KeyTypeKeyCompare comp) const;

   //! @copydoc ::hboost::intrusive::bstree::find(const key_type &)
   iterator find(const key_type &key);

   //! @copydoc ::hboost::intrusive::bstree::find(const KeyType&,KeyTypeKeyCompare)
   template<class KeyType, class KeyTypeKeyCompare>
   iterator find(const KeyType& key, KeyTypeKeyCompare comp);

   //! @copydoc ::hboost::intrusive::bstree::find(const key_type &)const
   const_iterator find(const key_type &key) const;

   //! @copydoc ::hboost::intrusive::bstree::find(const KeyType&,KeyTypeKeyCompare)const
   template<class KeyType, class KeyTypeKeyCompare>
   const_iterator find(const KeyType& key, KeyTypeKeyCompare comp) const;

   //! @copydoc ::hboost::intrusive::bstree::equal_range(const key_type &)
   std::pair<iterator,iterator> equal_range(const key_type &key);

   //! @copydoc ::hboost::intrusive::bstree::equal_range(const KeyType&,KeyTypeKeyCompare)
   template<class KeyType, class KeyTypeKeyCompare>
   std::pair<iterator,iterator> equal_range(const KeyType& key, KeyTypeKeyCompare comp);

   //! @copydoc ::hboost::intrusive::bstree::equal_range(const key_type &)const
   std::pair<const_iterator, const_iterator>
      equal_range(const key_type &key) const;

   //! @copydoc ::hboost::intrusive::bstree::equal_range(const KeyType&,KeyTypeKeyCompare)const
   template<class KeyType, class KeyTypeKeyCompare>
   std::pair<const_iterator, const_iterator>
      equal_range(const KeyType& key, KeyTypeKeyCompare comp) const;

   //! @copydoc ::hboost::intrusive::bstree::bounded_range(const key_type &,const key_type &,bool,bool)
   std::pair<iterator,iterator> bounded_range
      (const key_type &lower_key, const key_type &upper_key, bool left_closed, bool right_closed);

   //! @copydoc ::hboost::intrusive::bstree::bounded_range(const KeyType&,const KeyType&,KeyTypeKeyCompare,bool,bool)
   template<class KeyType, class KeyTypeKeyCompare>
   std::pair<iterator,iterator> bounded_range
      (const KeyType& lower_key, const KeyType& upper_key, KeyTypeKeyCompare comp, bool left_closed, bool right_closed);

   //! @copydoc ::hboost::intrusive::bstree::bounded_range(const key_type &,const key_type &,bool,bool)const
   std::pair<const_iterator, const_iterator>
      bounded_range(const key_type &lower_key, const key_type &upper_key, bool left_closed, bool right_closed) const;

   //! @copydoc ::hboost::intrusive::bstree::bounded_range(const KeyType&,const KeyType&,KeyTypeKeyCompare,bool,bool)const
   template<class KeyType, class KeyTypeKeyCompare>
   std::pair<const_iterator, const_iterator> bounded_range
         (const KeyType& lower_key, const KeyType& upper_key, KeyTypeKeyCompare comp, bool left_closed, bool right_closed) const;

   //! @copydoc ::hboost::intrusive::bstree::s_iterator_to(reference)
   static iterator s_iterator_to(reference value);

   //! @copydoc ::hboost::intrusive::bstree::s_iterator_to(const_reference)
   static const_iterator s_iterator_to(const_reference value);

   //! @copydoc ::hboost::intrusive::bstree::iterator_to(reference)
   iterator iterator_to(reference value);

   //! @copydoc ::hboost::intrusive::bstree::iterator_to(const_reference)const
   const_iterator iterator_to(const_reference value) const;

   //! @copydoc ::hboost::intrusive::bstree::init_node(reference)
   static void init_node(reference value);

   //! @copydoc ::hboost::intrusive::bstree::unlink_leftmost_without_rebalance
   pointer unlink_leftmost_without_rebalance();

   //! @copydoc ::hboost::intrusive::bstree::replace_node
   void replace_node(iterator replace_this, reference with_this);

   //! @copydoc ::hboost::intrusive::bstree::remove_node
   void remove_node(reference value);

   //! @copydoc ::hboost::intrusive::bstree::rebalance
   void rebalance();

   //! @copydoc ::hboost::intrusive::bstree::rebalance_subtree
   ...
   void balance_factor(float new_alpha)
   {
      ...
      HBOOST_STATIC_ASSERT((floating_point));
      HBOOST_INTRUSIVE_INVARIANT_ASSERT((new_alpha > 0.5f && new_alpha < 1.0f));
...
#if defined(HBOOST_INTRUSIVE_DOXYGEN_INVOKED) || defined(HBOOST_INTRUSIVE_VARIADIC_TEMPLATES)
template<class T, class ...Options>
#else
      ...
      >::type
{
   typedef typename make_sgtree
      ...
      #endif
      >::type   Base;
   HBOOST_MOVABLE_BUT_NOT_COPYABLE(sgtree)
   ...
   HBOOST_STATIC_ASSERT((detail::is_same<typename value_traits::value_type, T>::value));
   ...
   sgtree(HBOOST_RV_REF(sgtree) x)
      :  Base(HBOOST_MOVE_BASE(Base, x))
   {}

   sgtree& operator=(HBOOST_RV_REF(sgtree) x)
   {  return static_cast<sgtree &>(this->Base::operator=(HBOOST_MOVE_BASE(Base, x)));  }
   ...
   template <class Cloner, class Disposer>
   void clone_from(HBOOST_RV_REF(sgtree) src, Cloner cloner, Disposer disposer)
   {  Base::clone_from(HBOOST_MOVE_BASE(Base, src), cloner, disposer);  }
...
#endif //HBOOST_INTRUSIVE_SGTREE_HPP
