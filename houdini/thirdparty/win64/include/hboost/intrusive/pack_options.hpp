...
#ifndef HBOOST_INTRUSIVE_PACK_OPTIONS_HPP
#define HBOOST_INTRUSIVE_PACK_OPTIONS_HPP
...
#endif   //!defined(HBOOST_INTRUSIVE_VARIADIC_TEMPLATES)

#define HBOOST_INTRUSIVE_OPTION_TYPE(OPTION_NAME, TYPE, TYPEDEF_EXPR, TYPEDEF_NAME) \
template< class TYPE> \
struct OPTION_NAME \
{ \
   template<class Base> \
...
#define HBOOST_INTRUSIVE_OPTION_CONSTANT(OPTION_NAME, TYPE, VALUE, CONSTANT_NAME) \
template< TYPE VALUE> \
struct OPTION_NAME \
{ \
   template<class Base> \
...
#else    //#ifndef HBOOST_INTRUSIVE_DOXYGEN_INVOKED

//! This class is a utility that takes:
//!   - a default options class defining initial static constant
//!   and typedefs
//!   - several options defined with HBOOST_INTRUSIVE_OPTION_CONSTANT and
//! HBOOST_INTRUSIVE_OPTION_TYPE
//!
...
//!
//! \code
//!   HBOOST_INTRUSIVE_OPTION_TYPE(my_pointer, VoidPointer, VoidPointer, my_pointer_type)
//!   HBOOST_INTRUSIVE_OPTION_CONSTANT(incremental, bool, Enabled, is_incremental)
//! \endcode
//!
...
//! <code>hboost::intrusive::pack_options</code>,
...
//!   //    struct my_pointer
//!   //    { unspecified_content };
//!   HBOOST_INTRUSIVE_OPTION_TYPE(my_pointer, VoidPointer, hboost::remove_pointer<VoidPointer>::type, my_pointer_type)
//!
//!   struct empty_default{};
//!
//!   typedef pack_options< empty_default, typename my_pointer<void*> >::type::my_pointer_type type;
//!
//!   HBOOST_STATIC_ASSERT(( hboost::is_same<type, void>::value ));
//!
//! \endcode
#define HBOOST_INTRUSIVE_OPTION_TYPE(OPTION_NAME, TYPE, TYPEDEF_EXPR, TYPEDEF_NAME)
...
//!
//!   HBOOST_STATIC_ASSERT(( is_incremental == true ));
//!
//! \endcode
#define HBOOST_INTRUSIVE_OPTION_CONSTANT(OPTION_NAME, TYPE, VALUE, CONSTANT_NAME)
...
#endif   //#ifndef HBOOST_INTRUSIVE_PACK_OPTIONS_HPP
