...
#ifndef HBOOST_INTRUSIVE_DETAIL_HOOK_TRAITS_HPP
#define HBOOST_INTRUSIVE_DETAIL_HOOK_TRAITS_HPP
...
#include <hboost/intrusive/detail/node_holder.hpp>
...
struct bhtraits_base
{
   ...
   HBOOST_INTRUSIVE_FORCEINLINE static pointer to_value_ptr(const node_ptr & n)
   {
      return pointer_traits<pointer>::pointer_to
         (static_cast<reference>(static_cast<node_holder_reference>(*n)));
   }

   HBOOST_INTRUSIVE_FORCEINLINE static const_pointer to_value_ptr(const const_node_ptr & n)
   {
      return pointer_traits<const_pointer>::pointer_to
         (static_cast<const_reference>(static_cast<const_node_holder_reference>(*n)));
   }

   HBOOST_INTRUSIVE_FORCEINLINE static node_ptr to_node_ptr(reference value)
   {
      return pointer_traits<node_ptr>::pointer_to
         (static_cast<node_reference>(static_cast<node_holder_reference>(value)));
   }

   HBOOST_INTRUSIVE_FORCEINLINE static const_node_ptr to_node_ptr(const_reference value)
   {
...
struct mhtraits
{
   ...
   HBOOST_INTRUSIVE_FORCEINLINE static pointer to_value_ptr(const node_ptr & n)
   {
      return pointer_traits<pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<Hook*>(hboost::intrusive::detail::to_raw_pointer(n)), P));
   }
   ...
   HBOOST_INTRUSIVE_FORCEINLINE static const_pointer to_value_ptr(const const_node_ptr & n)
   {
      return pointer_traits<const_pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<const Hook*>(hboost::intrusive::detail::to_raw_pointer(n)), P));
   }
};
...
struct fhtraits
{
   ...
   {  return static_cast<node*>(hboost::intrusive::detail::to_raw_pointer(Functor::to_hook_ptr(value)));  }

   static const_node_ptr to_node_ptr(const_reference value)
   {  return static_cast<const node*>(hboost::intrusive::detail::to_raw_pointer(Functor::to_hook_ptr(value)));  }
...
#endif //HBOOST_INTRUSIVE_DETAIL_HOOK_TRAITS_HPP
