...
#ifndef HBOOST_INTRUSIVE_DETAIL_GET_VALUE_TRAITS_HPP
#define HBOOST_INTRUSIVE_DETAIL_GET_VALUE_TRAITS_HPP
...
#include <hboost/intrusive/detail/hook_traits.hpp>
...
HBOOST_INTRUSIVE_INTERNAL_STATIC_BOOL_IS_TRUE(internal_any_hook, is_any_hook)
HBOOST_INTRUSIVE_INTERNAL_STATIC_BOOL_IS_TRUE(internal_base_hook, hooktags::is_base_hook)
...
#endif   //HBOOST_INTRUSIVE_DOXYGEN_INVOKED
...
#endif   //#ifndef HBOOST_INTRUSIVE_DETAIL_GET_VALUE_TRAITS_HPP
