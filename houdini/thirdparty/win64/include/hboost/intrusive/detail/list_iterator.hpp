...
#ifndef HBOOST_INTRUSIVE_LIST_ITERATOR_HPP
#define HBOOST_INTRUSIVE_LIST_ITERATOR_HPP
...
class list_iterator
{
   ...
   HBOOST_INTRUSIVE_FORCEINLINE list_iterator()
   {}

   HBOOST_INTRUSIVE_FORCEINLINE explicit list_iterator(const node_ptr & nodeptr, const const_value_traits_ptr &traits_ptr)
      : members_(nodeptr, traits_ptr)
   {}

   HBOOST_INTRUSIVE_FORCEINLINE list_iterator(list_iterator<ValueTraits, false> const& other)
   ...
   HBOOST_INTRUSIVE_FORCEINLINE list_iterator &operator=(const node_ptr &node)
   ...
   public:
   HBOOST_INTRUSIVE_FORCEINLINE list_iterator& operator++()
   {
   ...
   HBOOST_INTRUSIVE_FORCEINLINE list_iterator operator++(int)
   {
   ...
   HBOOST_INTRUSIVE_FORCEINLINE friend bool operator== (const list_iterator& l, const list_iterator& r)
...
#endif //HBOOST_INTRUSIVE_LIST_ITERATOR_HPP
