...
//
/////////////////////////////////////////////////////////////////////////////
#ifndef HBOOST_INTRUSIVE_DETAIL_PARENT_FROM_MEMBER_HPP
#define HBOOST_INTRUSIVE_DETAIL_PARENT_FROM_MEMBER_HPP
...
#if defined(_MSC_VER)
   #define HBOOST_INTRUSIVE_MSVC_ABI_PTR_TO_MEMBER
...
HBOOST_INTRUSIVE_FORCEINLINE std::ptrdiff_t offset_from_pointer_to_member(const Member Parent::* ptr_to_member)
{
   //The implementation of a pointer to member is compiler dependent.
   #if defined(HBOOST_INTRUSIVE_MSVC_ABI_PTR_TO_MEMBER)
   ...
   HBOOST_STATIC_ASSERT( sizeof(caster) == sizeof(int) );
   ...
   #elif defined(__GNUC__)   || defined(__HP_aCC) || defined(HBOOST_INTEL) || \
...
template<class Parent, class Member>
HBOOST_INTRUSIVE_FORCEINLINE Parent *parent_from_member(Member *member, const Member Parent::* ptr_to_member)
{
...
template<class Parent, class Member>
HBOOST_INTRUSIVE_FORCEINLINE const Parent *parent_from_member(const Member *member, const Member Parent::* ptr_to_member)
{
...
#endif   //#ifndef HBOOST_INTRUSIVE_DETAIL_PARENT_FROM_MEMBER_HPP
