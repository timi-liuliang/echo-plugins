...
#ifndef HBOOST_INTRUSIVE_GENERIC_HOOK_HPP
#define HBOOST_INTRUSIVE_GENERIC_HOOK_HPP
...
{  //If this assertion raises, you might have destroyed an object
   ...
   (void)hook; HBOOST_INTRUSIVE_SAFE_HOOK_DESTRUCTOR_ASSERT(!hook.is_linked());
}
   ...
   /// @endcond
{
   ...
   bool is_linked() const
   {
      ...
      HBOOST_STATIC_ASSERT(( hooktags::safemode_or_autounlink ));
      return !node_algorithms::unique(this->this_ptr());
   }

   void unlink()
   {
      HBOOST_STATIC_ASSERT(( (int)hooktags::link_mode == (int)auto_unlink ));
...
#endif //HBOOST_INTRUSIVE_GENERIC_HOOK_HPP
