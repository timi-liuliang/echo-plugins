...
#ifndef HBOOST_INTRUSIVE_RBTREE_NODE_HPP
#define HBOOST_INTRUSIVE_RBTREE_NODE_HPP
...
struct default_rbtree_node_traits_impl
{
   ...
   HBOOST_INTRUSIVE_FORCEINLINE static color get_color(const const_node_ptr & n)
   {  return n->color_;  }

   HBOOST_INTRUSIVE_FORCEINLINE static color get_color(const node_ptr & n)
   {  return n->color_;  }

   HBOOST_INTRUSIVE_FORCEINLINE static void set_color(const node_ptr & n, color c)
   {  n->color_ = c;  }

   HBOOST_INTRUSIVE_FORCEINLINE static color black()
   {  return node::black_t;  }

   HBOOST_INTRUSIVE_FORCEINLINE static color red()
   {  return node::red_t;  }
};
...
#endif //HBOOST_INTRUSIVE_RBTREE_NODE_HPP
