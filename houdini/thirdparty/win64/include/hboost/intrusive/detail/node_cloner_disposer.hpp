...
#ifndef HBOOST_INTRUSIVE_DETAIL_NODE_CLONER_DISPOSER_HPP
#define HBOOST_INTRUSIVE_DETAIL_NODE_CLONER_DISPOSER_HPP
   ...
   :  public ebo_functor_holder<F>
{
   ...
   node_ptr operator()(const node_ptr & p)
   {
      ...
      HBOOST_INTRUSIVE_SAFE_HOOK_DEFAULT_ASSERT(!safemode_or_autounlink || node_algorithms::unique(n));
      return n;
   }
...
#endif //HBOOST_INTRUSIVE_DETAIL_NODE_CLONER_DISPOSER_HPP
