...
#ifndef HBOOST_INTRUSIVE_DETAIL_MATH_HPP
#define HBOOST_INTRUSIVE_DETAIL_MATH_HPP
...
////////////////////////////
   ...
   //Use _BitScanReverseXX intrinsics
      ...
      #if defined(HBOOST_INTRUSIVE_BSR_INTRINSIC_64_BIT)   //64 bit target
   ...
   #ifdef HBOOST_INTRUSIVE_BSR_INTRINSIC_64_BIT
      #define HBOOST_INTRUSIVE_BSR_INTRINSIC _BitScanReverse64
      #undef HBOOST_INTRUSIVE_BSR_INTRINSIC_64_BIT
   #else
      #define HBOOST_INTRUSIVE_BSR_INTRINSIC _BitScanReverse
   #endif
   ...
   {
      unsigned long log2;
      HBOOST_INTRUSIVE_BSR_INTRINSIC( &log2, (unsigned long)x );
      return log2;
   }

   #undef HBOOST_INTRUSIVE_BSR_INTRINSIC
   ...
   template<>
   struct builtin_clz_dispatch< ::hboost::ulong_long_type >
   {
      static ::hboost::ulong_long_type call(::hboost::ulong_long_type n)
...
#endif //HBOOST_INTRUSIVE_DETAIL_MATH_HPP
