...
#include <hboost/config.hpp>
   ...
   #pragma warning (disable : 4541) //'typeid' used on polymorphic type 'hboost::exception' with /GR-
   #pragma warning (disable : 4512) //'typeid' used on polymorphic type 'hboost::exception' with /GR-
...
//#define HBOOST_INTRUSIVE_USE_ITERATOR_FACADE
//#define HBOOST_INTRUSIVE_USE_ITERATOR_ENABLE_IF_CONVERTIBLE
