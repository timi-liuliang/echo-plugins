...
#ifndef HBOOST_INTRUSIVE_DETAIL_POINTER_ELEMENT_HPP
#define HBOOST_INTRUSIVE_DETAIL_POINTER_ELEMENT_HPP
...
#endif   //HBOOST_INTRUSIVE_DETAIL_WORKAROUND_HPP
...
{
   typedef typename hboost::intrusive::detail::first_param<Ptr>::type type;
};
...
{
   typedef typename ::hboost::intrusive::detail::pointer_element_impl<Ptr>::type type;
};
...
#endif // defined(HBOOST_INTRUSIVE_DETAIL_POINTER_ELEMENT_HPP)
