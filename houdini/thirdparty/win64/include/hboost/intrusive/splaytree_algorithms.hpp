...
#ifndef HBOOST_INTRUSIVE_SPLAYTREE_ALGORITHMS_HPP
#define HBOOST_INTRUSIVE_SPLAYTREE_ALGORITHMS_HPP
   ...
   #endif
{
   ...
   //! @copydoc ::hboost::intrusive::bstree_algorithms::lower_bound_range(const const_node_ptr&,const KeyType&,KeyNodePtrCompare)
   //! Additional notes: the first node of the range is splayed.
   template<class KeyType, class KeyNodePtrCompare>
   ...
   //! @copydoc ::hboost::intrusive::bstree_algorithms::rebalance
   ...
   static void rotate(const node_ptr & n)
   {
      ...
      if(g_is_header){
         if(NodeTraits::get_parent(g) == p)
            ...
            HBOOST_INTRUSIVE_INVARIANT_ASSERT(false);
...
#endif //HBOOST_INTRUSIVE_SPLAYTREE_ALGORITHMS_HPP
