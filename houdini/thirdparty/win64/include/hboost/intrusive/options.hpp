...
#ifndef HBOOST_INTRUSIVE_OPTIONS_HPP
#define HBOOST_INTRUSIVE_OPTIONS_HPP
...
HBOOST_INTRUSIVE_OPTION_TYPE(key_of_value, KeyOfValue, KeyOfValue, key_of_value)
...
HBOOST_INTRUSIVE_OPTION_CONSTANT(floating_point, bool, Enabled, floating_point)

//!This option setter specifies the equality
//!functor for the value type
HBOOST_INTRUSIVE_OPTION_TYPE(equal, Equal, Equal, equal)

//!This option setter specifies the equality
//!functor for the value type
HBOOST_INTRUSIVE_OPTION_TYPE(priority, Priority, Priority, priority)

//!This option setter specifies the hash
//!functor for the value type
HBOOST_INTRUSIVE_OPTION_TYPE(hash, Hash, Hash, hash)
...
HBOOST_INTRUSIVE_OPTION_TYPE(value_traits, ValueTraits, ValueTraits, proto_value_traits)

//#define HBOOST_INTRUSIVE_COMMA ,
//#define HBOOST_INTRUSIVE_LESS <
//#define HBOOST_INTRUSIVE_MORE >
//HBOOST_INTRUSIVE_OPTION_TYPE (member_hook, Parent HBOOST_INTRUSIVE_COMMA class MemberHook HBOOST_INTRUSIVE_COMMA MemberHook Parent::* PtrToMember , mhtraits HBOOST_INTRUSIVE_LESS Parent HBOOST_INTRUSIVE_COMMA MemberHook HBOOST_INTRUSIVE_COMMA PtrToMember HBOOST_INTRUSIVE_MORE , proto_value_traits)
...
//};
//
//#undef HBOOST_INTRUSIVE_COMMA
//#undef HBOOST_INTRUSIVE_LESS
//#undef HBOOST_INTRUSIVE_MORE
...
HBOOST_INTRUSIVE_OPTION_TYPE(function_hook, Functor, fhtraits<Functor>, proto_value_traits)

//!This option setter specifies that the container
//!must use the specified base hook
HBOOST_INTRUSIVE_OPTION_TYPE(base_hook, BaseHook, BaseHook, proto_value_traits)

//!This option setter specifies the type of
//!a void pointer. This will instruct the hook
//!to use this type of pointer instead of the
//!default one
HBOOST_INTRUSIVE_OPTION_TYPE(void_pointer, VoidPointer, VoidPointer, void_pointer)

//!This option setter specifies the type of
//!the tag of a base hook. A type cannot have two
//!base hooks of the same type, so a tag can be used
//!to differentiate two base hooks with otherwise same type
HBOOST_INTRUSIVE_OPTION_TYPE(tag, Tag, Tag, tag)

//!This option setter specifies the link mode
//!(normal_link, safe_link or auto_unlink)
HBOOST_INTRUSIVE_OPTION_CONSTANT(link_mode, link_mode_type, LinkType, link_mode)
...
HBOOST_INTRUSIVE_OPTION_CONSTANT(linear, bool, Enabled, linear)
...
HBOOST_INTRUSIVE_OPTION_CONSTANT(cache_last, bool, Enabled, cache_last)
...
HBOOST_INTRUSIVE_OPTION_TYPE(bucket_traits, BucketTraits, BucketTraits, bucket_traits)
...
HBOOST_INTRUSIVE_OPTION_CONSTANT(store_hash, bool, Enabled, store_hash)
...
//!with the same key.
HBOOST_INTRUSIVE_OPTION_CONSTANT(optimize_multikey, bool, Enabled, optimize_multikey)
...
HBOOST_INTRUSIVE_OPTION_CONSTANT(power_2_buckets, bool, Enabled, power_2_buckets)
...
HBOOST_INTRUSIVE_OPTION_CONSTANT(cache_begin, bool, Enabled, cache_begin)
...
//!stored hash values.
HBOOST_INTRUSIVE_OPTION_CONSTANT(compare_hash, bool, Enabled, compare_hash)
...
HBOOST_INTRUSIVE_OPTION_CONSTANT(incremental, bool, Enabled, incremental)
...
#endif   //#ifndef HBOOST_INTRUSIVE_OPTIONS_HPP
