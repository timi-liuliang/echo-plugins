...
#ifndef HBOOST_INDIRECT_TRAITS_DWA2002131_HPP
# define HBOOST_INDIRECT_TRAITS_DWA2002131_HPP
...
#   if defined(HBOOST_MSVC) && _MSC_FULL_VER <= 13102140 // vc7.01 alpha workaround
template<class T>
...
{
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_reference_to_member_function_pointer,(T))
};
...
struct is_reference_to_class
    : mpl::and_<
      ...
      >
{
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_reference_to_class,(T))
};
...
struct is_pointer_to_class
    : mpl::and_<
      ...
      >
{
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_pointer_to_class,(T))
};
...
#endif // HBOOST_INDIRECT_TRAITS_DWA2002131_HPP
