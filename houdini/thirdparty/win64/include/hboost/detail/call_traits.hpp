...
#ifndef HBOOST_DETAIL_CALL_TRAITS_HPP
#define HBOOST_DETAIL_CALL_TRAITS_HPP
...
public:
   ...
   typedef typename hboost::detail::ct_imp<
      T,
      ::hboost::is_pointer<T>::value,
      ::hboost::is_arithmetic<T>::value,
      ::hboost::is_enum<T>::value
...
#endif // HBOOST_DETAIL_CALL_TRAITS_HPP
