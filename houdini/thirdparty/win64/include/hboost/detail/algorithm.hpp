...
#ifndef HBOOST_ALGORITHM_HPP
# define HBOOST_ALGORITHM_HPP
...
namespace hboost {
  ...
  {
    return any_if(hboost::begin(c), hboost::end(c), p);
  }
  ...
  {
    return container_contains(hboost::begin(c), hboost::end(c), value);
  }

} // namespace hboost

#endif // HBOOST_ALGORITHM_HPP
