...
#ifndef HBOOST_CLASS_DWA200216_HPP
# define HBOOST_CLASS_DWA200216_HPP

# include <hboost/python/detail/prefix.hpp>

# include <hboost/noncopyable.hpp>

# include <hboost/python/class_fwd.hpp>
# include <hboost/python/object/class.hpp>

# include <hboost/python/object.hpp>
# include <hboost/python/type_id.hpp>
# include <hboost/python/data_members.hpp>
...
# include <hboost/python/object/class_metadata.hpp>
# include <hboost/python/object/pickle_support.hpp>
# include <hboost/python/object/add_to_namespace.hpp>

# include <hboost/python/detail/overloads_fwd.hpp>
# include <hboost/python/detail/operator_id.hpp>
# include <hboost/python/detail/def_helper.hpp>
# include <hboost/python/detail/force_instantiate.hpp>
# include <hboost/python/detail/unwrap_type_id.hpp>
...
# if HBOOST_WORKAROUND(__MWERKS__, <= 0x3004)                        \
    /* pro9 reintroduced the bug */                                 \
    || (HBOOST_WORKAROUND(__MWERKS__, > 0x3100)                      \
        && HBOOST_WORKAROUND(__MWERKS__, HBOOST_TESTED_AT(0x3201)))

#  define HBOOST_PYTHON_NO_MEMBER_POINTER_ORDERING 1

# endif

# ifdef HBOOST_PYTHON_NO_MEMBER_POINTER_ORDERING
...
# ifdef HBOOST_PYTHON_NO_MEMBER_POINTER_ORDERING
#  define HBOOST_PYTHON_DATA_MEMBER_HELPER(D) , detail::is_data_member_pointer<D>()
#  define HBOOST_PYTHON_YES_DATA_MEMBER , mpl::true_
#  define HBOOST_PYTHON_NO_DATA_MEMBER , mpl::false_
# elif defined(HBOOST_NO_FUNCTION_TEMPLATE_ORDERING)
#  define HBOOST_PYTHON_DATA_MEMBER_HELPER(D) , 0
#  define HBOOST_PYTHON_YES_DATA_MEMBER , int
#  define HBOOST_PYTHON_NO_DATA_MEMBER , ...
# else 
#  define HBOOST_PYTHON_DATA_MEMBER_HELPER(D)
#  define HBOOST_PYTHON_YES_DATA_MEMBER
#  define HBOOST_PYTHON_NO_DATA_MEMBER
# endif
  ...
  namespace error
  {
    ...
    struct virtual_function_default
    {
        ...
        {
            // https://svn.boost.org/trac/hboost/ticket/5803
            //typedef typename assertion<mpl::not_<is_same<Default,Fn> > >::failed test0;
# if !HBOOST_WORKAROUND(__MWERKS__, <= 0x2407)
...
class class_ : public objects::class_base
{
 ...
 public: // member functions
    ...
    {
        return this->def_readonly_impl(name, d, doc HBOOST_PYTHON_DATA_MEMBER_HELPER(D));
    }

    template <class D>
    self& def_readwrite(char const* name, D const& d, char const* doc=0)
    {
        return this->def_readwrite_impl(name, d, doc HBOOST_PYTHON_DATA_MEMBER_HELPER(D));
    }
 ...
 private: // helper functions
    ...
    self& def_readonly_impl(
        char const* name, D B::*pm_, char const* doc HBOOST_PYTHON_YES_DATA_MEMBER)
    {
    ...
    template <class D>
    self& def_readonly_impl(
        char const* name, D& d, char const* HBOOST_PYTHON_NO_DATA_MEMBER)
    {
    ...
    // HBOOST_PYTHON_FUNCTION_OVERLOADS(). The final argument is used to
    // discriminate.
    //
...
# undef HBOOST_PYTHON_DATA_MEMBER_HELPER
# undef HBOOST_PYTHON_YES_DATA_MEMBER
# undef HBOOST_PYTHON_NO_DATA_MEMBER
# undef HBOOST_PYTHON_NO_MEMBER_POINTER_ORDERING

#endif // HBOOST_CLASS_DWA200216_HPP
