#ifndef HBOOST_PYTHON_SLICE_JDB20040105_HPP
#define HBOOST_PYTHON_SLICE_JDB20040105_HPP
...
namespace detail
{
  class HBOOST_PYTHON_DECL slice_base : public object
  {
   public:
      ...
      // equal to a default-constructed hboost::python::object.
   ...
   protected:
      ...
      HBOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(slice_base, object)
  };
}
...
class slice : public detail::slice_base
{
 ...
 public:
        ...
        const RandomAccessIterator& end) const
    {
        ...
        difference_type max_dist = hboost::detail::distance(begin, end);
        ...
        if (slice_start == object()) {
            ...
            if (i >= 0) {
                ...
                std::advance( ret.start, min HBOOST_PREVENT_MACRO_SUBSTITUTION(i, max_dist-1));
            }
            else {
                if (i < -max_dist && ret.step < 0)
                    throw std::invalid_argument( "Zero-length slice");
        ...
        typename iterator_difference<RandomAccessIterator>::type final_dist = 
            hboost::detail::distance( ret.start, ret.stop);
 ...
 public:
    ...
    HBOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(slice, detail::slice_base)
};
...
#endif // !defined HBOOST_PYTHON_SLICE_JDB20040105_HPP
