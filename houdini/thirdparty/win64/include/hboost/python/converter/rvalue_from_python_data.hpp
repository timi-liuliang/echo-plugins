...
#ifndef HBOOST_FROM_PYTHON_AUX_DATA_DWA2002128_HPP
# define HBOOST_FROM_PYTHON_AUX_DATA_DWA2002128_HPP

# include <hboost/python/converter/constructor_function.hpp>
# include <hboost/python/detail/referent_storage.hpp>
# include <hboost/python/detail/destroy.hpp>
...
# if (!defined(__MWERKS__) || __MWERKS__ >= 0x3000) \
        ...
        && !defined(HBOOST_PYTHON_SYNOPSIS) /* Synopsis' OpenCXX has trouble parsing this */
    // This must always be a POD struct with m_data its first member.
    HBOOST_STATIC_ASSERT(HBOOST_PYTHON_OFFSETOF(rvalue_from_python_storage<T>,stage1) == 0);
# endif
...
#endif // HBOOST_FROM_PYTHON_AUX_DATA_DWA2002128_HPP
