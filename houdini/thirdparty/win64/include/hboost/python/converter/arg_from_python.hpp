...
#ifndef HBOOST_ARG_FROM_PYTHON_DWA2002127_HPP
# define HBOOST_ARG_FROM_PYTHON_DWA2002127_HPP
...
# include <hboost/python/detail/void_ptr.hpp>
# include <hboost/python/back_reference.hpp>
# include <hboost/python/detail/referent_storage.hpp>
# include <hboost/python/converter/obj_mgr_arg_from_python.hpp>
...
struct back_reference_arg_from_python
    : hboost::python::arg_from_python<typename T::type>
{
    typedef T result_type;
    ...
    T operator()();
 private:
    typedef hboost::python::arg_from_python<typename T::type> base;
    PyObject* m_source;
};
          ...
          , if_2<
              ...
              , if_2<
                  ...
                  , if_2<
                      ...
                      , mpl::if_<
                            hboost::python::is_back_reference<T>
...
#endif // HBOOST_ARG_FROM_PYTHON_DWA2002127_HPP
