...
#ifndef HBOOST_ITERATOR_DWA2002512_HPP
# define HBOOST_ITERATOR_DWA2002512_HPP

# include <hboost/python/detail/prefix.hpp>

# include <hboost/python/detail/target.hpp>
...
# include <hboost/bind/protect.hpp>
...
namespace detail
{
  ...
  )
  {
      return objects::make_iterator_function<Target>(
          hboost::protect(hboost::bind(get_start, _1))
        , hboost::protect(hboost::bind(get_finish, _1))
        , next_policies
      );
  }
...
object range(Accessor1 start, Accessor2 finish, NextPolicies* = 0, hboost::type<Target>* = 0)
{
...
#endif // HBOOST_ITERATOR_DWA2002512_HPP
