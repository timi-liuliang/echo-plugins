...
// HBOOST_PYTHON_OPAQUE_SPECIALIZED_TYPE_ID(Pointee)
//
...
PyTypeObject opaque<Pointee>::type_object =
{
    ...
    0,
    sizeof( HBOOST_DEDUCED_TYPENAME opaque<Pointee>::python_instance ),
    0,
    ::hboost::python::detail::dealloc,
    0,          /* tp_print */
    0,          /* tp_getattr */
    0,          /* tp_setattr */
    0,          /* tp_compare */
...
#   define HBOOST_PYTHON_OPAQUE_SPECIALIZED_TYPE_ID(Pointee)                     \
    namespace hboost { namespace python {                                        \
    template<>                                                                  \
