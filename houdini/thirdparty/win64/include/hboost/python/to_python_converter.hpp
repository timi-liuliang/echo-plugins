...
#ifndef HBOOST_TO_PYTHON_CONVERTER_DWA200221_HPP
# define HBOOST_TO_PYTHON_CONVERTER_DWA200221_HPP

# include <hboost/python/detail/prefix.hpp>

# include <hboost/python/converter/registry.hpp>
# include <hboost/python/converter/as_to_python_function.hpp>
...
namespace detail
{
    ...
    {
        HBOOST_STATIC_CONSTANT(bool, value= (sizeof(detail::tester<T>(0)) == sizeof(yes_type)));
    };

    template<class T>
    struct test_get_pytype : hboost::mpl::bool_<test_get_pytype_base<T>::value> 
    {
    };
...
{
#ifndef HBOOST_PYTHON_NO_PY_SIGNATURES
    typedef hboost::mpl::bool_<has_get_pytype> HasGetPytype;

    static PyTypeObject const* get_pytype_1(hboost::mpl::true_ *)
    {
        return Conversion::get_pytype();
    }

    static PyTypeObject const* get_pytype_1(hboost::mpl::false_ *)
    {
        return 0;
    }
...
#endif // HBOOST_TO_PYTHON_CONVERTER_DWA200221_HPP
