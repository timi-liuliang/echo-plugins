...
#ifndef HBOOST_CAST_DWA200269_HPP
# define HBOOST_CAST_DWA200269_HPP
...
namespace detail
{
  ...
  template <class Target, class Source>
  inline Target* downcast(Source* p, no_convertible, hboost::type<Target>* = 0)
  {
      typedef typename base_type_traits<Source>::type base;
  ...
  template <class T>
  inline void assert_castable(hboost::type<T>* = 0)
  {
...
#endif // HBOOST_CAST_DWA200269_HPP
