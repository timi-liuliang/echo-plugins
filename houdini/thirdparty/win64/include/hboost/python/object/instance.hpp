...
#ifndef HBOOST_INSTANCE_DWA200295_HPP
# define HBOOST_INSTANCE_DWA200295_HPP
...
{
  struct HBOOST_PYTHON_DECL_FORWARD instance_holder;
...
struct instance
{
    ...
    typedef typename type_with_alignment<
        ::hboost::alignment_of<Data>::value
    >::type align_t;
...
struct additional_instance_size
{
    ...
    HBOOST_STATIC_CONSTANT(
        std::size_t, value = sizeof(instance_data)
                           - HBOOST_PYTHON_OFFSETOF(instance_char,storage));
};

}}} // namespace hboost::python::object

#endif // HBOOST_INSTANCE_DWA200295_HPP
