...
#ifndef HBOOST_INHERITANCE_DWA200216_HPP
# define HBOOST_INHERITANCE_DWA200216_HPP
...
HBOOST_PYTHON_DECL void register_dynamic_id_aux(
    class_id static_id, dynamic_id_function get_dynamic_id);

HBOOST_PYTHON_DECL void add_cast(
...
struct dynamic_id_generator
  : mpl::if_<
        hboost::is_polymorphic<T>
        , hboost::python::objects::polymorphic_id_generator<T>
        , hboost::python::objects::non_polymorphic_id_generator<T>
    >
{};
...
inline void register_conversion(
    bool is_downcast = ::hboost::is_base_and_derived<Source,Target>::value
...
#endif // HBOOST_INHERITANCE_DWA200216_HPP
