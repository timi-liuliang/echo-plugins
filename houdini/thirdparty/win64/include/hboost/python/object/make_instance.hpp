...
#ifndef HBOOST_MAKE_INSTANCE_DWA200296_HPP
# define HBOOST_MAKE_INSTANCE_DWA200296_HPP
...
# include <hboost/python/detail/decref_guard.hpp>
...
struct make_instance_impl
{
    ...
    {
        HBOOST_MPL_ASSERT((mpl::or_<is_class<T>, is_union<T> >));
...
#endif // HBOOST_MAKE_INSTANCE_DWA200296_HPP
