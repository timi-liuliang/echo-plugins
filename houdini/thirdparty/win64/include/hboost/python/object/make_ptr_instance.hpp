...
#ifndef HBOOST_MAKE_PTR_INSTANCE_DWA200296_HPP
# define HBOOST_MAKE_PTR_INSTANCE_DWA200296_HPP
 ...
 private:
    ...
    static inline PyTypeObject* get_class_object_impl(U const volatile* p)
    {
        ...
        PyTypeObject* derived = get_derived_class_object(
            HBOOST_DEDUCED_TYPENAME is_polymorphic<U>::type(), p);
...
#endif // HBOOST_MAKE_PTR_INSTANCE_DWA200296_HPP
