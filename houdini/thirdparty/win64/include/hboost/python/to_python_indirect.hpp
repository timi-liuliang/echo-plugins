...
#ifndef HBOOST_TO_PYTHON_INDIRECT_DWA200221_HPP
# define HBOOST_TO_PYTHON_INDIRECT_DWA200221_HPP
...
namespace detail
{
  struct make_owning_holder
  {
      ...
      static PyObject* execute(T* p)
      {
          ...
          // copy constructor.
# if defined(__ICL) && __ICL < 600 
          typedef hboost::shared_ptr<T> smart_pointer;
# else 
...
#endif // HBOOST_TO_PYTHON_INDIRECT_DWA200221_HPP
