...
# include <hboost/detail/binary_search.hpp>
...
#if defined(NDEBUG)
#define HBOOST_PYTHON_INDEXING_CHECK_INVARIANT
#else
#define HBOOST_PYTHON_INDEXING_CHECK_INVARIANT check_invariant()
#endif
    ...
    public:
        ...
        first_proxy(index_type i)
        {
            ...
            return hboost::detail::lower_bound(
        ...
        remove(Proxy& proxy)
        {
            ...
            HBOOST_PYTHON_INDEXING_CHECK_INVARIANT;
        }
    ...
    {                
        ...
        { 
            return base_get_item_helper(
              ...
              , is_pointer<HBOOST_DEDUCED_TYPENAME Container::value_type>()
            );
        }
            ...
            Container& container, PySliceObject* slice, Index& from_, Index& to_)
        {
            ...
            if (Py_None == slice->start) {
                ...
                if (from < 0) // Clip lower bounds to zero
                    from = 0;
                from_ = hboost::numeric_cast<Index>(from);
            ...
            if (Py_None == slice->stop) {
                ...
                if (to < 0)
                    to = 0;
                to_ = hboost::numeric_cast<Index>(to);
                if (to_ > max_index)
                    to_ = max_index;
            }
        }        
    ...
    using hboost::python::get_pointer;
