...
#ifndef HBOOST_LIST_DWA2002627_HPP
# define HBOOST_LIST_DWA2002627_HPP
...
namespace detail
{
  struct HBOOST_PYTHON_DECL list_base : object
  {
   ...
   protected:
      ...
      HBOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(list_base, object)
   private:    
...
class list : public detail::list_base
{
 ...
 public: // implementation detail -- for internal use only
    HBOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(list, base)
};
...
#endif // HBOOST_LIST_DWA2002627_HPP
