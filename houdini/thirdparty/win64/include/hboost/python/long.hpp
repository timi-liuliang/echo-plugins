...
#ifndef HBOOST_LONG_DWA2002627_HPP
# define HBOOST_LONG_DWA2002627_HPP
...
namespace detail
{
  struct HBOOST_PYTHON_DECL long_base : object
  {
   protected:
      long_base(); // new long_
      ...
      HBOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(long_base, object)
...
class long_ : public detail::long_base
{
 ...
 public: // implementation detail -- for internal use only
    HBOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(long_, base)
};
...
#endif // HBOOST_LONG_DWA2002627_HPP
