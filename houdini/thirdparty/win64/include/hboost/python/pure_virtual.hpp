...
#ifndef HBOOST_PURE_VIRTUAL_DWA2003810_HPP
# define HBOOST_PURE_VIRTUAL_DWA2003810_HPP
...
# include <hboost/python/detail/nullary_function_adaptor.hpp>
...
namespace detail
{
  ...
  // function was called.
  void HBOOST_PYTHON_DECL pure_virtual_called();
    ...
    : def_visitor<pure_virtual_visitor<PointerToMemberFunction> >
  {
   ...
   private:
      ...
      void visit(C_& c, char const* name, Options& options) const
      {
          ...
          HBOOST_STATIC_ASSERT(!Options::has_default_implementation);
          ...
          typedef HBOOST_DEDUCED_TYPENAME C_::metadata::held_type held_type;
...
#endif // HBOOST_PURE_VIRTUAL_DWA2003810_HPP
