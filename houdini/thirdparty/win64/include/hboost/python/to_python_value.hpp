...
#ifndef HBOOST_TO_PYTHON_VALUE_DWA200221_HPP
# define HBOOST_TO_PYTHON_VALUE_DWA200221_HPP
...
# include <hboost/python/converter/object_manager.hpp>
# include <hboost/python/converter/shared_ptr_to_python.hpp>

# include <hboost/python/detail/value_is_shared_ptr.hpp>
...
struct object_manager_get_pytype<true>
{
...
#ifndef HBOOST_PYTHON_NO_PY_SIGNATURES
      typedef hboost::mpl::bool_<is_handle<T>::value> is_t_handle;
      typedef hboost::detail::indirect_traits::is_reference_to_const<T> is_t_const;
  ...
  struct registry_to_python_value
  {
      ...
      // return an internal reference or not. I don't like it much,
      // but it will have to serve for now.
      HBOOST_STATIC_CONSTANT(bool, uses_registry = true);
  };
  ...
  struct shared_ptr_to_python_value
  {
      ...
      PyObject* operator()(argument_type) const;
#ifndef HBOOST_PYTHON_NO_PY_SIGNATURES
      PyTypeObject const* get_pytype() const {return get_pytype((hboost::type<argument_type>*)0);}
#endif 
      // This information helps make_getter() decide whether to try to
      // return an internal reference or not. I don't like it much,
      // but it will have to serve for now.
...
#ifndef HBOOST_PYTHON_NO_PY_SIGNATURES
      template <class U>
      PyTypeObject const* get_pytype(hboost::type<shared_ptr<U> &> *) const {return converter::registered<U>::converters.to_python_target_type();}
      template <class U>
      PyTypeObject const* get_pytype(hboost::type<const shared_ptr<U> &> *) const {return converter::registered<U>::converters.to_python_target_type();}
#endif
  };
}
...
#endif // HBOOST_TO_PYTHON_VALUE_DWA200221_HPP
