...
namespace detail
{
  struct HBOOST_PYTHON_DECL dict_base : object
  {
   ...
   protected:
      ...
      HBOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(dict_base, object)
   private:
...
class dict : public detail::dict_base
{
 ...
 public: // implementation detail -- for internal use only
    HBOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(dict, base)
};
