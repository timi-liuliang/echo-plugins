...
#include <hboost/python/detail/make_keyword_range_fn.hpp>
...
///////////////////////////////////////////////////////////////////////////////
#define HBOOST_PYTHON_OVERLOAD_TYPES_WITH_DEFAULT                                \
    HBOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(                                        \
        HBOOST_PYTHON_MAX_ARITY,                                                 \
        class T,                                                                \
        mpl::void_)                                                             \

#define HBOOST_PYTHON_OVERLOAD_TYPES                                             \
    HBOOST_PP_ENUM_PARAMS_Z(1,                                                   \
        HBOOST_PYTHON_MAX_ARITY,                                                 \
        class T)                                                                \

#define HBOOST_PYTHON_OVERLOAD_ARGS                                              \
    HBOOST_PP_ENUM_PARAMS_Z(1,                                                   \
        HBOOST_PYTHON_MAX_ARITY,                                                 \
        T)                                                                      \
...
template <HBOOST_PYTHON_OVERLOAD_TYPES_WITH_DEFAULT>
...
namespace detail
{
  ...
  //
    ...
    template <HBOOST_PYTHON_OVERLOAD_TYPES>
    struct is_optional<optional<HBOOST_PYTHON_OVERLOAD_ARGS> >
      : mpl::true_
    {};
...
template <HBOOST_PYTHON_OVERLOAD_TYPES>
class init : public init_base<init<HBOOST_PYTHON_OVERLOAD_ARGS> >
{
    typedef init_base<init<HBOOST_PYTHON_OVERLOAD_ARGS> > base;
 public:
    typedef init<HBOOST_PYTHON_OVERLOAD_ARGS> self_t;
    ...
    typedef detail::type_list<HBOOST_PYTHON_OVERLOAD_ARGS> signature_;
...
template <HBOOST_PYTHON_OVERLOAD_TYPES>
struct optional
    : detail::type_list<HBOOST_PYTHON_OVERLOAD_ARGS>
{
};
...
#undef HBOOST_PYTHON_OVERLOAD_TYPES_WITH_DEFAULT
#undef HBOOST_PYTHON_OVERLOAD_TYPES
#undef HBOOST_PYTHON_OVERLOAD_ARGS
#undef HBOOST_PYTHON_IS_OPTIONAL_VALUE
#undef HBOOST_PYTHON_APPEND_TO_INIT
