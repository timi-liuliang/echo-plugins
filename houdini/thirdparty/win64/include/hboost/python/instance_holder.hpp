...
#ifndef HBOOST_INSTANCE_HOLDER_DWA2002517_HPP
# define HBOOST_INSTANCE_HOLDER_DWA2002517_HPP
...
struct HBOOST_PYTHON_DECL instance_holder : private noncopyable
{
 public:
    instance_holder();
...
# define HBOOST_PYTHON_UNFORWARD(N,ignored) (typename unforward<A##N>::type)(a##N)
...
#endif // HBOOST_INSTANCE_HOLDER_DWA2002517_HPP
