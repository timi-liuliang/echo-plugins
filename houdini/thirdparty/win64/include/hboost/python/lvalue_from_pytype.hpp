...
#ifndef HBOOST_LVALUE_FROM_PYTYPE_DWA2002130_HPP
# define HBOOST_LVALUE_FROM_PYTYPE_DWA2002130_HPP
...
namespace detail
{
  ...
  struct normalized_extractor
  {
      ...
      {
          typedef typename hboost::add_reference<U>::type param;
          return &Extractor::execute(
              hboost::python::detail::void_ptr_to_reference(
                  op, (param(*)())0 )
              );
      }
  };
...
#endif // HBOOST_LVALUE_FROM_PYTYPE_DWA2002130_HPP
