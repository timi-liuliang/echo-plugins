...
#ifndef HBOOST_EXCEPTION_HANDLER_DWA2002810_HPP
# define HBOOST_EXCEPTION_HANDLER_DWA2002810_HPP
...
struct HBOOST_PYTHON_DECL_FORWARD exception_handler;

typedef function2<bool, exception_handler const&, function0<void> const&> handler_function;

struct HBOOST_PYTHON_DECL exception_handler
{
 private: // types
...
HBOOST_PYTHON_DECL void register_exception_handler(handler_function const& f);

}}} // namespace hboost::python::detail

#endif // HBOOST_EXCEPTION_HANDLER_DWA2002810_HPP
