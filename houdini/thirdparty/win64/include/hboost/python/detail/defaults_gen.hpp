...
#define HBOOST_PYTHON_TYPEDEF_GEN(z, index, data)                                \
    typedef typename ::hboost::mpl::next<HBOOST_PP_CAT(iter, index)>::type        \
        HBOOST_PP_CAT(iter, HBOOST_PP_INC(index));                                \
    typedef typename ::hboost::mpl::deref<HBOOST_PP_CAT(iter, index)>::type       \
        HBOOST_PP_CAT(T, index);

#define HBOOST_PYTHON_FUNC_WRAPPER_GEN(z, index, data)                   \
    static RT HBOOST_PP_CAT(func_,                                       \
        HBOOST_PP_SUB_D(1, index, HBOOST_PP_TUPLE_ELEM(3, 1, data))) (    \
...
#define HBOOST_PYTHON_GEN_FUNCTION(fname, fstubs_name, n_args, n_dflts, ret)     \
    struct fstubs_name                                                          \
    {                                                                           \
        HBOOST_STATIC_CONSTANT(int, n_funcs = HBOOST_PP_INC(n_dflts));            \
        HBOOST_STATIC_CONSTANT(int, max_args = n_funcs);                         \
                                                                                \
        template <typename SigT>                                                \
        struct gen                                                              \
        {                                                                       \
            typedef typename ::hboost::mpl::begin<SigT>::type rt_iter;           \
            typedef typename ::hboost::mpl::deref<rt_iter>::type RT;             \
            typedef typename ::hboost::mpl::next<rt_iter>::type iter0;           \
                                                                                \
            HBOOST_PP_REPEAT_2ND(                                                \
                n_args,                                                         \
                HBOOST_PYTHON_TYPEDEF_GEN,                                       \
                0)                                                              \
                                                                                \
            HBOOST_PP_REPEAT_FROM_TO_2(                                          \
                HBOOST_PP_SUB_D(1, n_args, n_dflts),                             \
                HBOOST_PP_INC(n_args),                                           \
                HBOOST_PYTHON_FUNC_WRAPPER_GEN,                                  \
                (fname, HBOOST_PP_SUB_D(1, n_args, n_dflts), ret))               \
        };                                                                      \
    };                                                                          \

///////////////////////////////////////////////////////////////////////////////
#define HBOOST_PYTHON_MEM_FUNC_WRAPPER_GEN(z, index, data)                       \
    static RT HBOOST_PP_CAT(func_,                                               \
        HBOOST_PP_SUB_D(1, index, HBOOST_PP_TUPLE_ELEM(3, 1, data))) (            \
            ClassT obj HBOOST_PP_COMMA_IF(index)                                 \
            HBOOST_PP_ENUM_BINARY_PARAMS_Z(1, index, T, arg)                     \
        )                                                                       \
    {                                                                           \
        HBOOST_PP_TUPLE_ELEM(3, 2, data) obj.HBOOST_PP_TUPLE_ELEM(3, 0, data)(    \
            HBOOST_PP_ENUM_PARAMS(index, arg)                                    \
        );                                                                      \
    }

#define HBOOST_PYTHON_GEN_MEM_FUNCTION(fname, fstubs_name, n_args, n_dflts, ret) \
    struct fstubs_name                                                          \
    {                                                                           \
        HBOOST_STATIC_CONSTANT(int, n_funcs = HBOOST_PP_INC(n_dflts));            \
        HBOOST_STATIC_CONSTANT(int, max_args = n_funcs + 1);                     \
                                                                                \
        template <typename SigT>                                                \
        struct gen                                                              \
        {                                                                       \
            ...
            typedef typename ::hboost::mpl::deref<rt_iter>::type RT;             \
                                                                                \
            typedef typename ::hboost::mpl::next<rt_iter>::type class_iter;      \
            typedef typename ::hboost::mpl::deref<class_iter>::type ClassT;      \
            typedef typename ::hboost::mpl::next<class_iter>::type iter0;        \
                                                                                \
            HBOOST_PP_REPEAT_2ND(                                                \
                n_args,                                                         \
                HBOOST_PYTHON_TYPEDEF_GEN,                                       \
            ...
            HBOOST_PP_REPEAT_FROM_TO_2(                                          \
                HBOOST_PP_SUB_D(1, n_args, n_dflts),                             \
                HBOOST_PP_INC(n_args),                                           \
                HBOOST_PYTHON_MEM_FUNC_WRAPPER_GEN,                              \
                (fname, HBOOST_PP_SUB_D(1, n_args, n_dflts), ret))               \
        };                                                                      \
    };

#define HBOOST_PYTHON_OVERLOAD_CONSTRUCTORS(fstubs_name, n_args, n_dflts)                    \
    fstubs_name(char const* doc = 0)                                                        \
        : ::hboost::python::detail::overloads_common<fstubs_name>(doc) {}                    \
    template <std::size_t N>                                                                \
    fstubs_name(char const* doc, ::hboost::python::detail::keywords<N> const& keywords)      \
        : ::hboost::python::detail::overloads_common<fstubs_name>(                           \
            doc, keywords.range())                                                          \
    {                                                                                       \
        typedef typename ::hboost::python::detail::                                          \
            error::more_keywords_than_function_arguments<                                   \
                N,n_args>::too_many_keywords assertion;                                     \
    }                                                                                       \
    template <std::size_t N>                                                                \
    fstubs_name(::hboost::python::detail::keywords<N> const& keywords, char const* doc = 0)  \
        : ::hboost::python::detail::overloads_common<fstubs_name>(                           \
            doc, keywords.range())                                                          \
    {                                                                                       \
        typedef typename ::hboost::python::detail::                                          \
...
#  define HBOOST_PYTHON_GEN_FUNCTION_STUB(fname, fstubs_name, n_args, n_dflts)   \
    struct fstubs_name                                                          \
        : public ::hboost::python::detail::overloads_common<fstubs_name>         \
    {                                                                           \
        HBOOST_PYTHON_GEN_FUNCTION(                                              \
            fname, non_void_return_type, n_args, n_dflts, return)               \
        HBOOST_PYTHON_GEN_FUNCTION(                                              \
            fname, void_return_type, n_args, n_dflts, ;)                        \
                                                                                \
        HBOOST_PYTHON_OVERLOAD_CONSTRUCTORS(fstubs_name, n_args, n_dflts)        \
    };

#  define HBOOST_PYTHON_GEN_MEM_FUNCTION_STUB(fname, fstubs_name, n_args, n_dflts)       \
    struct fstubs_name                                                                  \
        : public ::hboost::python::detail::overloads_common<fstubs_name>                 \
    {                                                                                   \
        HBOOST_PYTHON_GEN_MEM_FUNCTION(                                                  \
            fname, non_void_return_type, n_args, n_dflts, return)                       \
        HBOOST_PYTHON_GEN_MEM_FUNCTION(                                                  \
            fname, void_return_type, n_args, n_dflts, ;)                                \
                                                                                        \
        HBOOST_PYTHON_OVERLOAD_CONSTRUCTORS(fstubs_name, n_args + 1, n_dflts)            \
    };
...
# endif // !defined(HBOOST_NO_VOID_RETURNS)
...
//
//          1. HBOOST_PYTHON_FUNCTION_OVERLOADS for free functions
//          2. HBOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS for member functions.
//
...
//
//          HBOOST_PYTHON_FUNCTION_OVERLOADS(foo_stubs, foo, 1, 4)
//
//      Generates this code:
//
...
//          : public hboost::python::detail::overloads_common<foo_overloads>
//      {
...
//             : hboost::python::detail::overloads_common<foo_overloads>(doc) {}
//      };
//
...
//
///////////////////////////////////////////////////////////////////////////////
#define HBOOST_PYTHON_FUNCTION_OVERLOADS(generator_name, fname, min_args, max_args)          \
    HBOOST_PYTHON_GEN_FUNCTION_STUB(                                                         \
        fname,                                                                              \
        generator_name,                                                                     \
        max_args,                                                                           \
        HBOOST_PP_SUB_D(1, max_args, min_args))

#define HBOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(generator_name, fname, min_args, max_args)   \
    HBOOST_PYTHON_GEN_MEM_FUNCTION_STUB(                                                     \
        fname,                                                                              \
        generator_name,                                                                     \
        max_args,                                                                           \
        HBOOST_PP_SUB_D(1, max_args, min_args))
...
#define HBOOST_PYTHON_FUNCTION_GENERATOR HBOOST_PYTHON_FUNCTION_OVERLOADS
#define HBOOST_PYTHON_MEM_FUN_GENERATOR HBOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS
