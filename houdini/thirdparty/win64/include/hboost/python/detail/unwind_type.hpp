...
#ifndef HBOOST_UNWIND_TYPE_DWA200222_HPP
# define HBOOST_UNWIND_TYPE_DWA200222_HPP

# include <hboost/python/detail/cv_category.hpp>
...
template <class Generator, class U>
inline typename Generator::result_type
unwind_type(hboost::type<U>*p = 0, Generator* = 0);
...
template <class Generator, class U>
inline typename Generator::result_type
unwind_type(hboost::type<U>*, Generator*)
{
    HBOOST_STATIC_CONSTANT(int, indirection
...
#endif // HBOOST_UNWIND_TYPE_DWA200222_HPP
