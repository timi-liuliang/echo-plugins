...
#ifndef HBOOST_MSVC_TYPEINFO_DWA200222_HPP
# define HBOOST_MSVC_TYPEINFO_DWA200222_HPP
...
# if defined(HBOOST_INTEL_CXX_VERSION) && HBOOST_INTEL_CXX_VERSION <= 700
...
#   define HBOOST_PYTT_DECL __cdecl
#else
#   define HBOOST_PYTT_DECL /**/
#endif

template< typename T > T&(* is_ref_tester1(type<T>) )(type<T>) { return 0; }
inline char HBOOST_PYTT_DECL is_ref_tester1(...) { return 0; }

template <class T>
inline typeinfo msvc_typeid(hboost::type<T>*)
{
    return detail::typeid_ref(
        (hboost::type<T>*)0, detail::is_ref_tester1(type<T>())
        );
}

template <>
inline typeinfo msvc_typeid<void>(hboost::type<void>*)
{
    return typeid(void);
}
...
{
    return msvc_typeid((hboost::type<char const[3]>*)0)
        , msvc_typeid((hboost::type<char[3]>*)0);
}
#  endif

}}} // namespace hboost::python::detail

# endif // HBOOST_INTEL_CXX_VERSION
#endif // HBOOST_MSVC_TYPEINFO_DWA200222_HPP
