#ifndef HBOOST_MEMORY_ORDER_HPP_INCLUDED
#define HBOOST_MEMORY_ORDER_HPP_INCLUDED
...
//  hboost/memory_order.hpp
//
//  Defines enum hboost::memory_order per the C++0x working draft
//
...
#endif // #ifndef HBOOST_MEMORY_ORDER_HPP_INCLUDED
