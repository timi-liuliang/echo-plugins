...
#ifndef HBOOST_ZIP_ITERATOR_TMB_07_13_2003_HPP_
# define HBOOST_ZIP_ITERATOR_TMB_07_13_2003_HPP_

#include <stddef.h>
#include <hboost/iterator.hpp>
#include <hboost/iterator/iterator_traits.hpp>
#include <hboost/iterator/iterator_facade.hpp>
#include <hboost/iterator/iterator_adaptor.hpp> // for enable_if_convertible
#include <hboost/iterator/iterator_categories.hpp>

#include <hboost/iterator/minimum_category.hpp>

#include <utility> // for std::pair
#include <hboost/fusion/adapted/hboost_tuple.hpp> // for backward compatibility
...
#include <hboost/fusion/sequence/intrinsic/at_c.hpp>
#include <hboost/fusion/sequence/comparison/equal_to.hpp>
...
namespace iterators {
  ...
  private:
    ...
    void advance(typename super_t::difference_type n)
    {
        fusion::for_each(
          m_iterator_tuple,
          detail::advance_iterator<HBOOST_DEDUCED_TYPENAME super_t::difference_type>(n));
    }
