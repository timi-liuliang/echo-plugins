...
#ifndef HBOOST_TRANSFORM_ITERATOR_23022003THW_HPP
#define HBOOST_TRANSFORM_ITERATOR_23022003THW_HPP
...
namespace iterators {
  ...
  template <class UnaryFunc, class Iterator, class Reference, class Value>
  class transform_iterator
    : public hboost::iterators::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
  {
    typedef typename
    hboost::iterators::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
    super_t;
  ...
  public:
      ...
      : super_t(x)
    {
        ...
        HBOOST_STATIC_ASSERT(is_class<UnaryFunc>::value);
#endif
    }
...
#endif // HBOOST_TRANSFORM_ITERATOR_23022003THW_HPP
