...
#ifndef HBOOST_ITERATOR_CATEGORIES_HPP
# define HBOOST_ITERATOR_CATEGORIES_HPP
...
struct iterator_category_to_traversal
  : mpl::eval_if< // if already convertible to a traversal tag, we're done.
      ...
      , mpl::identity<Cat>
      , hboost::iterators::detail::old_category_to_traversal<Cat>
    >
{};
...
struct iterator_traversal
  : iterator_category_to_traversal<
        typename hboost::detail::iterator_traits<Iterator>::iterator_category
    >
{};

# ifdef HBOOST_MPL_CFG_NO_FULL_LAMBDA_SUPPORT
// Hack because HBOOST_MPL_AUX_LAMBDA_SUPPORT doesn't seem to work
...
// hboost/range/detail/demote_iterator_traversal_tag.hpp
...
#endif // HBOOST_ITERATOR_CATEGORIES_HPP
