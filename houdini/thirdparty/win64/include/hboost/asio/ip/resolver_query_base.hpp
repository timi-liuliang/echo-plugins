...
#ifndef HBOOST_ASIO_IP_RESOLVER_QUERY_BASE_HPP
#define HBOOST_ASIO_IP_RESOLVER_QUERY_BASE_HPP
...
public:
  ...
  enum flags
  {
    canonical_name = HBOOST_ASIO_OS_DEF(AI_CANONNAME),
    passive = HBOOST_ASIO_OS_DEF(AI_PASSIVE),
    numeric_host = HBOOST_ASIO_OS_DEF(AI_NUMERICHOST),
    numeric_service = HBOOST_ASIO_OS_DEF(AI_NUMERICSERV),
    v4_mapped = HBOOST_ASIO_OS_DEF(AI_V4MAPPED),
    all_matching = HBOOST_ASIO_OS_DEF(AI_ALL),
    address_configured = HBOOST_ASIO_OS_DEF(AI_ADDRCONFIG)
  };
...
#endif // HBOOST_ASIO_IP_RESOLVER_QUERY_BASE_HPP
