...
#ifndef HBOOST_ASIO_IP_RESOLVER_SERVICE_HPP
#define HBOOST_ASIO_IP_RESOLVER_SERVICE_HPP
...
# include <hboost/asio/detail/winrt_resolver_service.hpp>
#else
# include <hboost/asio/detail/resolver_service.hpp>
#endif
...
#if defined(HBOOST_ASIO_WINDOWS_RUNTIME)
  typedef hboost::asio::detail::winrt_resolver_service<InternetProtocol>
    service_impl_type;
#else
  typedef hboost::asio::detail::resolver_service<InternetProtocol>
    service_impl_type;
#endif
...
public:
  ...
  explicit resolver_service(hboost::asio::io_service& io_service)
  ...
  HBOOST_ASIO_INITFN_RESULT_TYPE(ResolveHandler,
      void (hboost::system::error_code, iterator_type))
      ...
      HBOOST_ASIO_MOVE_ARG(ResolveHandler) handler)
  {
    hboost::asio::detail::async_result_init<
      ResolveHandler, void (hboost::system::error_code, iterator_type)> init(
...
#endif // HBOOST_ASIO_IP_RESOLVER_SERVICE_HPP
