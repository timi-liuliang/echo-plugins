...
#ifndef HBOOST_ASIO_IP_IMPL_BASIC_ENDPOINT_HPP
#define HBOOST_ASIO_IP_IMPL_BASIC_ENDPOINT_HPP
...
{
  hboost::asio::ip::detail::endpoint tmp_ep(endpoint.address(), endpoint.port());
...
#endif // HBOOST_ASIO_IP_IMPL_BASIC_ENDPOINT_HPP
