...
#ifndef HBOOST_ASIO_WRITE_AT_HPP
#define HBOOST_ASIO_WRITE_AT_HPP
...
/**
 * @defgroup write_at hboost::asio::write_at
 *
 ...
 * @code hboost::asio::write_at(d, 42, hboost::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, hboost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code hboost::asio::write_at(
 *     d, offset, buffers,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code hboost::asio::write_at(d, 42,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code hboost::asio::write_at(d, 42, hboost::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write_at hboost::asio::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * hboost::asio::async_write_at(d, 42, hboost::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, hboost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code hboost::asio::async_write_at(d, 42,
...
HBOOST_ASIO_INITFN_RESULT_TYPE(WriteHandler,
    void (hboost::system::error_code, std::size_t))
async_write_at(AsyncRandomAccessWriteDevice& d, uint64_t offset,
    basic_streambuf<Allocator>& b, HBOOST_ASIO_MOVE_ARG(WriteHandler) handler);
...
#include <hboost/asio/impl/write_at.hpp>

#endif // HBOOST_ASIO_WRITE_AT_HPP
