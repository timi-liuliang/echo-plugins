...
#ifndef HBOOST_ASIO_BASIC_SOCKET_HPP
#define HBOOST_ASIO_BASIC_SOCKET_HPP
...
public:
   ...
   */
  explicit basic_socket(hboost::asio::io_service& io_service)
   ...
   */
  basic_socket(hboost::asio::io_service& io_service,
  ...
  basic_socket(basic_socket&& other)
    : basic_io_object<SocketService>(
        HBOOST_ASIO_MOVE_CAST(basic_socket)(other))
  {
  }
  ...
  {
    basic_socket tmp(HBOOST_ASIO_MOVE_CAST2(basic_socket<
            Protocol1, SocketService1>)(other));
    basic_io_object<SocketService>::operator=(
        HBOOST_ASIO_MOVE_CAST(basic_socket)(tmp));
    return *this;
  }
   ...
   * socket.open(hboost::asio::ip::tcp::v4());
   * @endcode
   */
   ...
   * hboost::asio::ip::tcp::socket socket(io_service);
   * hboost::system::error_code ec;
   * socket.open(hboost::asio::ip::tcp::v4(), ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  hboost::system::error_code assign(const protocol_type& protocol,
      const native_handle_type& native_socket, hboost::system::error_code& ec)
  {
   ...
   * with the hboost::asio::error::operation_aborted error.
   *
   * @throws hboost::system::system_error Thrown on failure. Note that, even if
   ...
   * hboost::asio::error::operation_not_supported when run on Windows XP, Windows
   * Server 2003, and earlier versions of Windows, unless
   * HBOOST_ASIO_ENABLE_CANCELIO is defined. However, the CancelIo function has
  ...
  && !defined(HBOOST_ASIO_ENABLE_CANCELIO)
  ...
  bool at_mark() const
  {
    ...
    hboost::asio::detail::throw_error(ec, "at_mark");
    return b;
  }
   ...
   * mark.
   */
  bool at_mark(hboost::system::error_code& ec) const
  {
  ...
  std::size_t available() const
  {
    ...
    hboost::asio::detail::throw_error(ec, "available");
    return s;
  }
   ...
   * error occurs.
   */
  std::size_t available(hboost::system::error_code& ec) const
  {
   ...
   * hboost::asio::ip::tcp::socket socket(io_service);
   * socket.open(hboost::asio::ip::tcp::v4());
   * socket.bind(hboost::asio::ip::tcp::endpoint(
   *       hboost::asio::ip::tcp::v4(), 12345));
   * @endcode
   */
   ...
   * hboost::system::error_code ec;
   * socket.bind(hboost::asio::ip::tcp::endpoint(
   *       hboost::asio::ip::tcp::v4(), 12345), ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   *     hboost::asio::ip::address::from_string("1.2.3.4"), 12345);
  ...
  void connect(const endpoint_type& peer_endpoint)
  {
    ...
    if (!is_open())
    {
      ...
      hboost::asio::detail::throw_error(ec, "connect");
    }
   ...
   * @endcode
   */
  hboost::system::error_code connect(const endpoint_type& peer_endpoint,
      hboost::system::error_code& ec)
  {
    if (!is_open())
    {
   ...
   * @par Example
   * @code
   * void connect_handler(const hboost::system::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Connect succeeded.
      ...
      HBOOST_ASIO_MOVE_ARG(ConnectHandler) handler)
  {
    ...
    HBOOST_ASIO_CONNECT_HANDLER_CHECK(ConnectHandler, handler) type_check;
    ...
    if (!is_open())
    {
      ...
      if (this->get_service().open(this->get_implementation(), protocol, ec))
      {
        ...
        this->get_io_service().post(
            hboost::asio::detail::bind_handler(
              HBOOST_ASIO_MOVE_CAST(HBOOST_ASIO_HANDLER_TYPE(
                ConnectHandler, void (hboost::system::error_code)))(
                  init.handler), ec));
    ...
    return this->get_service().async_connect(this->get_implementation(),
        peer_endpoint, HBOOST_ASIO_MOVE_CAST(ConnectHandler)(handler));
  }
   ...
   * hboost::asio::socket_base::broadcast @n
   * hboost::asio::socket_base::do_not_route @n
   * hboost::asio::socket_base::keep_alive @n
   * hboost::asio::socket_base::linger @n
   * hboost::asio::socket_base::receive_buffer_size @n
   * hboost::asio::socket_base::receive_low_watermark @n
   * hboost::asio::socket_base::reuse_address @n
   * hboost::asio::socket_base::send_buffer_size @n
   * hboost::asio::socket_base::send_low_watermark @n
   * hboost::asio::ip::multicast::join_group @n
   * hboost::asio::ip::multicast::leave_group @n
   * hboost::asio::ip::multicast::enable_loopback @n
   * hboost::asio::ip::multicast::outbound_interface @n
   * hboost::asio::ip::multicast::hops @n
   * hboost::asio::ip::tcp::no_delay
   *
   * @par Example
   ...
   * hboost::asio::ip::tcp::socket socket(io_service);
   * ...
   * hboost::asio::ip::tcp::socket::keep_alive option;
   ...
   * hboost::asio::socket_base::bytes_readable @n
   ...
   * hboost::asio::ip::tcp::socket socket(io_service);
   * ...
   * hboost::asio::ip::tcp::socket::bytes_readable command;
   ...
   *   void operator()(hboost::system::error_code ec, std::size_t)
   *   {
   ...
   *         ec = hboost::system::error_code(n < 0 ? errno : 0,
   ...
   *           sock_.async_write_some(hboost::asio::null_buffers(), *this);
   *           return;
   *         }
   *
   *         if (ec || n == 0)
   ...
   *   sock.async_write_some(hboost::asio::null_buffers(), op);
   * } @endcode
   */
   ...
   * hboost::asio::ip::tcp::socket socket(io_service);
   * ...
   * hboost::asio::ip::tcp::endpoint endpoint = socket.local_endpoint();
   * @endcode
   */
   ...
   * ...
   * hboost::system::error_code ec;
   * hboost::asio::ip::tcp::endpoint endpoint = socket.local_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * hboost::asio::ip::tcp::socket socket(io_service);
   * ...
   * hboost::asio::ip::tcp::endpoint endpoint = socket.remote_endpoint();
   * @endcode
   */
  endpoint_type remote_endpoint() const
  {
    ...
    endpoint_type ep = this->get_service().remote_endpoint(
        this->get_implementation(), ec);
    hboost::asio::detail::throw_error(ec, "remote_endpoint");
    return ep;
  }
   ...
   * ...
   * hboost::system::error_code ec;
   * hboost::asio::ip::tcp::endpoint endpoint = socket.remote_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  endpoint_type remote_endpoint(hboost::system::error_code& ec) const
  {
   ...
   * hboost::asio::ip::tcp::socket socket(io_service);
   * ...
   * socket.shutdown(hboost::asio::ip::tcp::socket::shutdown_send);
   * @endcode
   */
  void shutdown(shutdown_type what)
  {
    ...
    hboost::asio::detail::throw_error(ec, "shutdown");
  }
   ...
   * ...
   * hboost::system::error_code ec;
   * socket.shutdown(hboost::asio::ip::tcp::socket::shutdown_send, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  hboost::system::error_code shutdown(shutdown_type what,
      hboost::system::error_code& ec)
  {
...
#endif // HBOOST_ASIO_BASIC_SOCKET_HPP
