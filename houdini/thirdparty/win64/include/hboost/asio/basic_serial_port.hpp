...
#ifndef HBOOST_ASIO_BASIC_SERIAL_PORT_HPP
#define HBOOST_ASIO_BASIC_SERIAL_PORT_HPP
...
public:
   ...
   */
  explicit basic_serial_port(hboost::asio::io_service& io_service)
   ...
   */
  basic_serial_port(hboost::asio::io_service& io_service,
  ...
  basic_serial_port(basic_serial_port&& other)
    : basic_io_object<SerialPortService>(
        HBOOST_ASIO_MOVE_CAST(basic_serial_port)(other))
  {
  }
   ...
   */
  hboost::system::error_code open(const std::string& device,
      hboost::system::error_code& ec)
  {
   ...
   */
  hboost::system::error_code assign(const native_handle_type& native_serial_port,
      hboost::system::error_code& ec)
  {
  ...
  void send_break()
  {
    ...
    hboost::asio::detail::throw_error(ec, "send_break");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  hboost::system::error_code send_break(hboost::system::error_code& ec)
  {
   ...
   * hboost::asio::serial_port_base::baud_rate @n
   * hboost::asio::serial_port_base::flow_control @n
   * hboost::asio::serial_port_base::parity @n
   * hboost::asio::serial_port_base::stop_bits @n
   * hboost::asio::serial_port_base::character_size
   */
   ...
   */
  template <typename SettableSerialPortOption>
  hboost::system::error_code set_option(const SettableSerialPortOption& option,
      hboost::system::error_code& ec)
  {
   ...
   */
  template <typename GettableSerialPortOption>
  hboost::system::error_code get_option(GettableSerialPortOption& option,
      hboost::system::error_code& ec)
  {
   ...
   * @code
   * serial_port.write_some(hboost::asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * serial_port.async_write_some(hboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, hboost::array or
   * std::vector.
      ...
      HBOOST_ASIO_MOVE_ARG(WriteHandler) handler)
  {
    ...
    return this->get_service().async_write_some(this->get_implementation(),
        buffers, HBOOST_ASIO_MOVE_CAST(WriteHandler)(handler));
  }
   ...
   * @code
   * serial_port.read_some(hboost::asio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * serial_port.async_read_some(hboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, hboost::array or
   * std::vector.
      ...
      HBOOST_ASIO_MOVE_ARG(ReadHandler) handler)
  {
    ...
    return this->get_service().async_read_some(this->get_implementation(),
        buffers, HBOOST_ASIO_MOVE_CAST(ReadHandler)(handler));
  }
};
...
#endif // HBOOST_ASIO_BASIC_SERIAL_PORT_HPP
