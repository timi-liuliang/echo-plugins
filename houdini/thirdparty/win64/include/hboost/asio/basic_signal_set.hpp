...
#ifndef HBOOST_ASIO_BASIC_SIGNAL_SET_HPP
#define HBOOST_ASIO_BASIC_SIGNAL_SET_HPP
 ...
 *
 * Most applications will use the hboost::asio::signal_set typedef.
 *
 * @par Thread Safety
 ...
 * hboost::asio::signal_set signals(io_service, SIGINT, SIGTERM);
 *
...
public:
   ...
   */
  explicit basic_signal_set(hboost::asio::io_service& io_service)
   ...
   * @code hboost::asio::signal_set signals(io_service);
   * signals.add(signal_number_1); @endcode
   */
  basic_signal_set(hboost::asio::io_service& io_service, int signal_number_1)
    : basic_io_object<SignalSetService>(io_service)
  {
    hboost::system::error_code ec;
    this->service.add(this->implementation, signal_number_1, ec);
    hboost::asio::detail::throw_error(ec, "add");
  }
   ...
   */
  hboost::system::error_code add(int signal_number,
      hboost::system::error_code& ec)
  {
  ...
  void remove(int signal_number)
  {
    ...
    hboost::asio::detail::throw_error(ec, "remove");
  }
   ...
   * signal number.
   */
  hboost::system::error_code remove(int signal_number,
      hboost::system::error_code& ec)
  {
  ...
  void clear()
  {
    ...
    hboost::asio::detail::throw_error(ec, "clear");
  }
   ...
   * @note Removes all queued notifications.
   */
  hboost::system::error_code clear(hboost::system::error_code& ec)
  {
   ...
   * operation will be invoked with the hboost::asio::error::operation_aborted
   * error code.
   *
   ...
   * error code hboost::asio::error::operation_aborted.
   *
  ...
  HBOOST_ASIO_INITFN_RESULT_TYPE(SignalHandler,
      void (hboost::system::error_code, int))
  async_wait(HBOOST_ASIO_MOVE_ARG(SignalHandler) handler)
  {
    // If you get an error on the following line it means that your handler does
    // not meet the documented type requirements for a SignalHandler.
    HBOOST_ASIO_SIGNAL_HANDLER_CHECK(SignalHandler, handler) type_check;

    return this->service.async_wait(this->implementation,
        HBOOST_ASIO_MOVE_CAST(SignalHandler)(handler));
  }
};
...
#endif // HBOOST_ASIO_BASIC_SIGNAL_SET_HPP
