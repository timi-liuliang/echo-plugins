...
#ifndef HBOOST_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
#define HBOOST_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
...
public:
   ...
   * descriptor.
   */
  explicit basic_descriptor(hboost::asio::io_service& io_service)
   ...
   */
  basic_descriptor(hboost::asio::io_service& io_service,
  ...
  basic_descriptor(basic_descriptor&& other)
    : basic_io_object<DescriptorService>(
        HBOOST_ASIO_MOVE_CAST(basic_descriptor)(other))
  {
  }
   ...
   */
  hboost::system::error_code assign(const native_handle_type& native_descriptor,
      hboost::system::error_code& ec)
  {
   ...
   * hboost::asio::posix::descriptor_base::bytes_readable @n
   * hboost::asio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   ...
   * ...
   * hboost::asio::posix::stream_descriptor::bytes_readable command;
...
#endif // HBOOST_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
