...
#ifndef HBOOST_ASIO_LOCAL_BASIC_ENDPOINT_HPP
#define HBOOST_ASIO_LOCAL_BASIC_ENDPOINT_HPP
...
/**
 * The hboost::asio::local::basic_endpoint class template describes an endpoint
...
private:
  ...
  hboost::asio::local::detail::endpoint impl_;
};
 ...
 *
 * @relates hboost::asio::local::basic_endpoint
 */
...
#endif // HBOOST_ASIO_LOCAL_BASIC_ENDPOINT_HPP
