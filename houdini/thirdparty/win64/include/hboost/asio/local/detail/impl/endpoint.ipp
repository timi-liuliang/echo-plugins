...
#ifndef HBOOST_ASIO_LOCAL_DETAIL_IMPL_ENDPOINT_IPP
#define HBOOST_ASIO_LOCAL_DETAIL_IMPL_ENDPOINT_IPP
...
#include <hboost/asio/local/detail/endpoint.hpp>
...
{
  if (new_size > sizeof(hboost::asio::detail::sockaddr_un_type))
  {
...
void endpoint::init(const char* path_name, std::size_t path_length)
{
  if (path_length > sizeof(data_.local.sun_path) - 1)
  {
    ...
    hboost::system::error_code ec(hboost::asio::error::name_too_long);
    hboost::asio::detail::throw_error(ec);
  }

  using namespace std; // For memcpy.
  data_.local = hboost::asio::detail::sockaddr_un_type();
...
#endif // HBOOST_ASIO_LOCAL_DETAIL_IMPL_ENDPOINT_IPP
