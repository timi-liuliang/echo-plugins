...
#ifndef HBOOST_ASIO_BASIC_IO_OBJECT_HPP
#define HBOOST_ASIO_BASIC_IO_OBJECT_HPP
...
protected:
   ...
   */
  explicit basic_io_object(hboost::asio::io_service& io_service)
    : service(hboost::asio::use_service<IoObjectService>(io_service))
  {
...
protected:
  explicit basic_io_object(hboost::asio::io_service& io_service)
    : service_(&hboost::asio::use_service<IoObjectService>(io_service))
  {
...
#endif // HBOOST_ASIO_BASIC_IO_OBJECT_HPP
