...
#ifndef HBOOST_ASIO_BUFFERED_STREAM_HPP
#define HBOOST_ASIO_BUFFERED_STREAM_HPP
...
public:
  ...
  {
    return stream_impl_.async_fill(HBOOST_ASIO_MOVE_CAST(ReadHandler)(handler));
  }
...
#endif // HBOOST_ASIO_BUFFERED_STREAM_HPP
