...
#ifndef HBOOST_ASIO_IMPL_IO_SERVICE_HPP
#define HBOOST_ASIO_IMPL_IO_SERVICE_HPP
...
inline HBOOST_ASIO_INITFN_RESULT_TYPE(CompletionHandler, void ())
io_service::dispatch(HBOOST_ASIO_MOVE_ARG(CompletionHandler) handler)
{
...
template <typename CompletionHandler>
inline HBOOST_ASIO_INITFN_RESULT_TYPE(CompletionHandler, void ())
io_service::post(HBOOST_ASIO_MOVE_ARG(CompletionHandler) handler)
{
  // If you get an error on the following line it means that your handler does
  // not meet the documented type requirements for a CompletionHandler.
  HBOOST_ASIO_COMPLETION_HANDLER_CHECK(CompletionHandler, handler) type_check;
...
inline io_service::work::work(hboost::asio::io_service& io_service)
...
inline hboost::asio::io_service& io_service::work::get_io_service()
{
  return io_service_impl_.get_io_service();
}

inline hboost::asio::io_service& io_service::service::get_io_service()
{
  return owner_;
}
...
#endif // HBOOST_ASIO_IMPL_IO_SERVICE_HPP
