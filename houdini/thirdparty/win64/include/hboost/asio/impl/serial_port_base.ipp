...
#ifndef HBOOST_ASIO_IMPL_SERIAL_PORT_BASE_IPP
#define HBOOST_ASIO_IMPL_SERIAL_PORT_BASE_IPP
...
hboost::system::error_code serial_port_base::baud_rate::store(
    HBOOST_ASIO_OPTION_STORAGE& storage, hboost::system::error_code& ec) const
{
...
hboost::system::error_code serial_port_base::baud_rate::load(
    const HBOOST_ASIO_OPTION_STORAGE& storage, hboost::system::error_code& ec)
{
#if defined(HBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
hboost::system::error_code serial_port_base::flow_control::store(
    HBOOST_ASIO_OPTION_STORAGE& storage, hboost::system::error_code& ec) const
{
#if defined(HBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
hboost::system::error_code serial_port_base::flow_control::load(
    const HBOOST_ASIO_OPTION_STORAGE& storage, hboost::system::error_code& ec)
{
#if defined(HBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
hboost::system::error_code serial_port_base::parity::store(
    HBOOST_ASIO_OPTION_STORAGE& storage, hboost::system::error_code& ec) const
{
#if defined(HBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
hboost::system::error_code serial_port_base::parity::load(
    const HBOOST_ASIO_OPTION_STORAGE& storage, hboost::system::error_code& ec)
{
#if defined(HBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
hboost::system::error_code serial_port_base::stop_bits::store(
    HBOOST_ASIO_OPTION_STORAGE& storage, hboost::system::error_code& ec) const
{
#if defined(HBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
hboost::system::error_code serial_port_base::stop_bits::load(
    const HBOOST_ASIO_OPTION_STORAGE& storage, hboost::system::error_code& ec)
{
#if defined(HBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
hboost::system::error_code serial_port_base::character_size::store(
    HBOOST_ASIO_OPTION_STORAGE& storage, hboost::system::error_code& ec) const
{
#if defined(HBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
hboost::system::error_code serial_port_base::character_size::load(
    const HBOOST_ASIO_OPTION_STORAGE& storage, hboost::system::error_code& ec)
{
#if defined(HBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
#endif // HBOOST_ASIO_IMPL_SERIAL_PORT_BASE_IPP
