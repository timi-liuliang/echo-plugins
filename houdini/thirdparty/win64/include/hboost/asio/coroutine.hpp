...
#ifndef HBOOST_ASIO_COROUTINE_HPP
#define HBOOST_ASIO_COROUTINE_HPP
 ...
 *
 * @code #include <hboost/asio/yield.hpp>@endcode
 *
 * and may conversely be undefined as follows:
 *
 * @code #include <hboost/asio/unyield.hpp>@endcode
 *
 * <b>reenter</b>
 *
 ...
 *
 * @li @c HBOOST_ASIO_CORO_REENTER instead of @c reenter
 * @li @c HBOOST_ASIO_CORO_YIELD instead of @c yield
 * @li @c HBOOST_ASIO_CORO_FORK instead of @c fork
 */
class coroutine
{
public:
...
#define HBOOST_ASIO_CORO_REENTER(c) \
  switch (::hboost::asio::detail::coroutine_ref _coro_value = c) \
...
#define HBOOST_ASIO_CORO_YIELD_IMPL(n) \
  for (_coro_value = (n);;) \
    if (_coro_value == 0) \
    { \
      case (n): ; \
...
#define HBOOST_ASIO_CORO_FORK_IMPL(n) \
...
#if defined(_MSC_VER)
# define HBOOST_ASIO_CORO_YIELD HBOOST_ASIO_CORO_YIELD_IMPL(__COUNTER__ + 1)
# define HBOOST_ASIO_CORO_FORK HBOOST_ASIO_CORO_FORK_IMPL(__COUNTER__ + 1)
#else // defined(_MSC_VER)
# define HBOOST_ASIO_CORO_YIELD HBOOST_ASIO_CORO_YIELD_IMPL(__LINE__)
# define HBOOST_ASIO_CORO_FORK HBOOST_ASIO_CORO_FORK_IMPL(__LINE__)
#endif // defined(_MSC_VER)

#endif // HBOOST_ASIO_COROUTINE_HPP
