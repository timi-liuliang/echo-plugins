...
#ifndef HBOOST_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
#define HBOOST_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
...
#else
  : public hboost::asio::detail::service_base<stream_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_handle_service(hboost::asio::io_service& io_service)
    : hboost::asio::detail::service_base<stream_handle_service>(io_service),
...
#endif // HBOOST_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
