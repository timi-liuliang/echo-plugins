...
#ifndef HBOOST_ASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
#define HBOOST_ASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
...
public:
   ...
   */
  explicit basic_object_handle(hboost::asio::io_service& io_service)
   ...
   */
  basic_object_handle(hboost::asio::io_service& io_service,
  ...
  basic_object_handle(basic_object_handle&& other)
    : basic_handle<ObjectHandleService>(
        HBOOST_ASIO_MOVE_CAST(basic_object_handle)(other))
  {
  }
...
#endif // HBOOST_ASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
