...
#ifndef HBOOST_ASIO_TIME_TRAITS_HPP
#define HBOOST_ASIO_TIME_TRAITS_HPP
...
template <>
struct time_traits<hboost::posix_time::ptime>
{
  /// The time type.
  ...
  static time_type now()
  {
    ...
    return hboost::posix_time::microsec_clock::universal_time();
#else // defined(HBOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK)
    return hboost::posix_time::second_clock::universal_time();
  ...
  static hboost::posix_time::time_duration to_posix_duration(
...
#endif // HBOOST_ASIO_TIME_TRAITS_HPP
