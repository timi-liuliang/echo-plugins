...
#ifndef HBOOST_ASIO_STREAM_SOCKET_SERVICE_HPP
#define HBOOST_ASIO_STREAM_SOCKET_SERVICE_HPP
...
# include <hboost/asio/detail/winrt_ssocket_service.hpp>
...
#else
  : public hboost::asio::detail::service_base<stream_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_socket_service(hboost::asio::io_service& io_service)
  ...
  {
    if (protocol.type() == HBOOST_ASIO_OS_DEF(SOCK_STREAM))
...
#endif // HBOOST_ASIO_STREAM_SOCKET_SERVICE_HPP
