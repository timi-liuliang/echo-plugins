...
#ifndef HBOOST_ASIO_WAITABLE_TIMER_SERVICE_HPP
#define HBOOST_ASIO_WAITABLE_TIMER_SERVICE_HPP
...
public:
  ...
  explicit waitable_timer_service(hboost::asio::io_service& io_service)
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_point& expiry_time, hboost::system::error_code& ec)
  {
  ...
  std::size_t expires_from_now(implementation_type& impl,
      const duration& expiry_time, hboost::system::error_code& ec)
  {
...
#endif // HBOOST_ASIO_WAITABLE_TIMER_SERVICE_HPP
