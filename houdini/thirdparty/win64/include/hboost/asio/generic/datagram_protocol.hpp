...
#ifndef HBOOST_ASIO_GENERIC_DATAGRAM_PROTOCOL_HPP
#define HBOOST_ASIO_GENERIC_DATAGRAM_PROTOCOL_HPP
...
/**
 * The hboost::asio::generic::datagram_protocol class contains flags necessary
 ...
 * @code datagram_protocol p(hboost::asio::ip::udp::v4()); @endcode
 *
 * @par Thread Safety
...
public:
  ...
  int type() const
  {
    return HBOOST_ASIO_OS_DEF(SOCK_DGRAM);
  }
...
#endif // HBOOST_ASIO_GENERIC_DATAGRAM_PROTOCOL_HPP
