...
#ifndef HBOOST_ASIO_GENERIC_STREAM_PROTOCOL_HPP
#define HBOOST_ASIO_GENERIC_STREAM_PROTOCOL_HPP
...
/**
 * The hboost::asio::generic::stream_protocol class contains flags necessary for
 ...
 * @code stream_protocol p(hboost::asio::ip::tcp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // HBOOST_ASIO_GENERIC_STREAM_PROTOCOL_HPP
