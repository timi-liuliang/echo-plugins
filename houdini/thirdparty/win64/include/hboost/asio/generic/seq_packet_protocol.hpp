...
#ifndef HBOOST_ASIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
#define HBOOST_ASIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
...
/**
 * The hboost::asio::generic::seq_packet_protocol class contains flags necessary
...
public:
  ...
  int type() const
  {
    return HBOOST_ASIO_OS_DEF(SOCK_SEQPACKET);
  }
...
#endif // HBOOST_ASIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
