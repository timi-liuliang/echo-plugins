...
#ifndef HBOOST_ASIO_GENERIC_RAW_PROTOCOL_HPP
#define HBOOST_ASIO_GENERIC_RAW_PROTOCOL_HPP
...
/**
 * The hboost::asio::generic::raw_protocol class contains flags necessary for
 ...
 * @code raw_protocol p(hboost::asio::ip::icmp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // HBOOST_ASIO_GENERIC_RAW_PROTOCOL_HPP
