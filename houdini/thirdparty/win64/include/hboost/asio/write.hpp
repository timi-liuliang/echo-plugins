...
#ifndef HBOOST_ASIO_WRITE_HPP
#define HBOOST_ASIO_WRITE_HPP
...
/**
 * @defgroup write hboost::asio::write
 *
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code hboost::asio::write(s, hboost::asio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, hboost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code hboost::asio::write(s, hboost::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write hboost::asio::async_write
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * hboost::asio::async_write(s, hboost::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, hboost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code hboost::asio::async_write(s,
...
#include <hboost/asio/impl/write.hpp>

#endif // HBOOST_ASIO_WRITE_HPP
