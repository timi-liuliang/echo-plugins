...
#ifndef HBOOST_ASIO_RAW_SOCKET_SERVICE_HPP
#define HBOOST_ASIO_RAW_SOCKET_SERVICE_HPP
...
#else
  : public hboost::asio::detail::service_base<raw_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit raw_socket_service(hboost::asio::io_service& io_service)
  ...
  {
    if (protocol.type() == HBOOST_ASIO_OS_DEF(SOCK_RAW))
...
#endif // HBOOST_ASIO_RAW_SOCKET_SERVICE_HPP
