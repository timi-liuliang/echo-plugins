...
#ifndef HBOOST_ASIO_ASYNC_RESULT_HPP
#define HBOOST_ASIO_ASYNC_RESULT_HPP
...
{
  explicit async_result_init(HBOOST_ASIO_MOVE_ARG(Handler) orig_handler)
    : handler(HBOOST_ASIO_MOVE_CAST(Handler)(orig_handler)),
      result(handler)
  {
  }
...
# define HBOOST_ASIO_INITFN_RESULT_TYPE(h, sig) \
  void_or_deduced
#elif defined(_MSC_VER) && (_MSC_VER < 1500)
# define HBOOST_ASIO_INITFN_RESULT_TYPE(h, sig) \
  typename ::hboost::asio::detail::async_result_type_helper<h, sig>::type
#else
# define HBOOST_ASIO_INITFN_RESULT_TYPE(h, sig) \
  typename ::hboost::asio::async_result< \
    typename ::hboost::asio::handler_type<h, sig>::type>::type
#endif

#endif // HBOOST_ASIO_ASYNC_RESULT_HPP
