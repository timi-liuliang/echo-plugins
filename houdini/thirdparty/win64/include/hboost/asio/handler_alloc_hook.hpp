...
#ifndef HBOOST_ASIO_HANDLER_ALLOC_HOOK_HPP
#define HBOOST_ASIO_HANDLER_ALLOC_HOOK_HPP
 ...
 * @endcode
 */
HBOOST_ASIO_DECL void* asio_handler_allocate(
    std::size_t size, ...);
 ...
 */
HBOOST_ASIO_DECL void asio_handler_deallocate(
...
# include <hboost/asio/impl/handler_alloc_hook.ipp>
#endif // defined(HBOOST_ASIO_HEADER_ONLY)

#endif // HBOOST_ASIO_HANDLER_ALLOC_HOOK_HPP
