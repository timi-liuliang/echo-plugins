...
#ifndef HBOOST_ASIO_SERIAL_PORT_SERVICE_HPP
#define HBOOST_ASIO_SERIAL_PORT_SERVICE_HPP
...
#include <hboost/asio/detail/reactive_serial_port_service.hpp>
...
#else
  : public hboost::asio::detail::service_base<serial_port_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit serial_port_service(hboost::asio::io_service& io_service)
    : hboost::asio::detail::service_base<serial_port_service>(io_service),
...
#endif // HBOOST_ASIO_SERIAL_PORT_SERVICE_HPP
