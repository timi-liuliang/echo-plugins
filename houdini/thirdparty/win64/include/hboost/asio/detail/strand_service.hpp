...
#ifndef HBOOST_ASIO_DETAIL_STRAND_SERVICE_HPP
#define HBOOST_ASIO_DETAIL_STRAND_SERVICE_HPP
...
class strand_service
  : public hboost::asio::detail::service_base<strand_service>
{
private:
...
public:
  ...
  HBOOST_ASIO_DECL explicit strand_service(hboost::asio::io_service& io_service);
  ...
  HBOOST_ASIO_DECL bool running_in_this_thread(
      const implementation_type& impl) const;

private:
  // Helper function to dispatch a handler. Returns true if the handler should
  // be dispatched immediately.
  HBOOST_ASIO_DECL bool do_dispatch(implementation_type& impl, operation* op);

  // Helper fiunction to post a handler.
  HBOOST_ASIO_DECL void do_post(implementation_type& impl,
      operation* op, bool is_continuation);

  HBOOST_ASIO_DECL static void do_complete(io_service_impl* owner,
      operation* base, const hboost::system::error_code& ec,
...
#if defined(HBOOST_ASIO_STRAND_IMPLEMENTATIONS)
  enum { num_implementations = HBOOST_ASIO_STRAND_IMPLEMENTATIONS };
#else // defined(HBOOST_ASIO_STRAND_IMPLEMENTATIONS)
  enum { num_implementations = 193 };
#endif // defined(HBOOST_ASIO_STRAND_IMPLEMENTATIONS)
...
#include <hboost/asio/detail/impl/strand_service.hpp>
#if defined(HBOOST_ASIO_HEADER_ONLY)
# include <hboost/asio/detail/impl/strand_service.ipp>
#endif // defined(HBOOST_ASIO_HEADER_ONLY)

#endif // HBOOST_ASIO_DETAIL_STRAND_SERVICE_HPP
