...
#ifndef HBOOST_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
#define HBOOST_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
...
#include <hboost/asio/detail/descriptor_read_op.hpp>
#include <hboost/asio/detail/descriptor_write_op.hpp>
...
public:
  ...
  // Constructor.
  HBOOST_ASIO_DECL reactive_descriptor_service(
  ...
  HBOOST_ASIO_DECL native_handle_type release(implementation_type& impl);
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, hboost::system::error_code& ec)
  {
      ...
      const ConstBufferSequence& buffers, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "descriptor", &impl, "async_write_some"));
      ...
      const null_buffers&, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "descriptor",
      ...
      const MutableBufferSequence& buffers, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "descriptor", &impl, "async_read_some"));
...
private:
  ...
  HBOOST_ASIO_DECL void start_op(implementation_type& impl, int op_type,
...
# include <hboost/asio/detail/impl/reactive_descriptor_service.ipp>
...
#endif // HBOOST_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
