...
#ifndef HBOOST_ASIO_DETAIL_DESCRIPTOR_WRITE_OP_HPP
#define HBOOST_ASIO_DETAIL_DESCRIPTOR_WRITE_OP_HPP
...
{
public:
  HBOOST_ASIO_DEFINE_HANDLER_PTR(descriptor_write_op);
...
#endif // HBOOST_ASIO_DETAIL_DESCRIPTOR_WRITE_OP_HPP
