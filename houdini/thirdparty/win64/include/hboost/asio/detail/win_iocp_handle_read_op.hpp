...
#ifndef HBOOST_ASIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP
#define HBOOST_ASIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP
...
{
public:
  HBOOST_ASIO_DEFINE_HANDLER_PTR(win_iocp_handle_read_op);
...
#endif // HBOOST_ASIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP
