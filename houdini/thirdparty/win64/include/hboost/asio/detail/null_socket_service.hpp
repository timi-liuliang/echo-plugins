...
#ifndef HBOOST_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
#define HBOOST_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
...
public:
  ...
  // Constructor.
  null_socket_service(hboost::asio::io_service& io_service)
  ...
  hboost::system::error_code open(implementation_type&,
      const protocol_type&, hboost::system::error_code& ec)
  {
  ...
  hboost::system::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, hboost::system::error_code& ec)
  {
    ec = hboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  hboost::system::error_code close(implementation_type&,
  ...
  hboost::system::error_code cancel(implementation_type&,
      hboost::system::error_code& ec)
  {
    ec = hboost::asio::error::operation_not_supported;
    return ec;
  ...
  hboost::system::error_code listen(implementation_type&,
      int, hboost::system::error_code& ec)
  {
    ec = hboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  hboost::system::error_code io_control(implementation_type&,
  ...
  hboost::system::error_code non_blocking(implementation_type&,
  ...
  hboost::system::error_code native_non_blocking(implementation_type&,
      bool, hboost::system::error_code& ec)
  {
    ec = hboost::asio::error::operation_not_supported;
    return ec;
  ...
  hboost::system::error_code shutdown(implementation_type&,
  ...
  hboost::system::error_code bind(implementation_type&,
  ...
  hboost::system::error_code set_option(implementation_type&,
      const Option&, hboost::system::error_code& ec)
  {
    ec = hboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  hboost::system::error_code get_option(const implementation_type&,
      Option&, hboost::system::error_code& ec) const
  {
    ec = hboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  hboost::system::error_code accept(implementation_type&,
      Socket&, endpoint_type*, hboost::system::error_code& ec)
  {
    ec = hboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  hboost::system::error_code connect(implementation_type&,
      const endpoint_type&, hboost::system::error_code& ec)
  {
    ec = hboost::asio::error::operation_not_supported;
    return ec;
...
#endif // HBOOST_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
