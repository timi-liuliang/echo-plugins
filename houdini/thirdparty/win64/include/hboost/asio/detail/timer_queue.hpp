...
#ifndef HBOOST_ASIO_DETAIL_TIMER_QUEUE_HPP
#define HBOOST_ASIO_DETAIL_TIMER_QUEUE_HPP
...
#include <hboost/asio/detail/date_time_fwd.hpp>
...
private:
  ...
  static bool is_positive_infinity(
      const hboost::date_time::base_time<T, TimeSystem>& time)
  {
...
#endif // HBOOST_ASIO_DETAIL_TIMER_QUEUE_HPP
