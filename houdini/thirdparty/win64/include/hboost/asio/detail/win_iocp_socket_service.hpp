...
#ifndef HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_HPP
#define HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_HPP
...
#include <hboost/asio/detail/win_iocp_socket_accept_op.hpp>
#include <hboost/asio/detail/win_iocp_socket_connect_op.hpp>
#include <hboost/asio/detail/win_iocp_socket_recvfrom_op.hpp>
...
public:
  ...
  // Constructor.
  win_iocp_socket_service(hboost::asio::io_service& io_service)
  ...
  hboost::system::error_code set_option(implementation_type& impl,
      const Option& option, hboost::system::error_code& ec)
  {
  ...
  hboost::system::error_code get_option(const implementation_type& impl,
      Option& option, hboost::system::error_code& ec) const
  {
      ...
      socket_base::message_flags flags, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "socket", &impl, "async_send_to"));
      ...
      socket_base::message_flags flags, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "socket", &impl, "async_receive_from"));
  ...
  hboost::system::error_code accept(implementation_type& impl, Socket& peer,
      ...
      endpoint_type* peer_endpoint, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "socket", &impl, "async_accept"));
      ...
      const endpoint_type& peer_endpoint, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "socket", &impl, "async_connect"));
...
#endif // HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_HPP
