...
#ifndef HBOOST_ASIO_DETAIL_REACTIVE_SERIAL_PORT_SERVICE_HPP
#define HBOOST_ASIO_DETAIL_REACTIVE_SERIAL_PORT_SERVICE_HPP
...
public:
  ...
  HBOOST_ASIO_DECL reactive_serial_port_service(
  ...
  hboost::system::error_code send_break(implementation_type& impl,
      hboost::system::error_code& ec)
  {
    errno = 0;
...
# include <hboost/asio/detail/impl/reactive_serial_port_service.ipp>
...
#endif // HBOOST_ASIO_DETAIL_REACTIVE_SERIAL_PORT_SERVICE_HPP
