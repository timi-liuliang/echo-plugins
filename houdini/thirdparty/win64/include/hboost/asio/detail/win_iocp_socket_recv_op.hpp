...
#ifndef HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_RECV_OP_HPP
#define HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_RECV_OP_HPP
...
{
public:
  HBOOST_ASIO_DEFINE_HANDLER_PTR(win_iocp_socket_recv_op);
...
#endif // HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_RECV_OP_HPP
