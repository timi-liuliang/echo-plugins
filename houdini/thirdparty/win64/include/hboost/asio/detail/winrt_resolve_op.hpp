...
#ifndef HBOOST_ASIO_DETAIL_WINRT_RESOLVE_OP_HPP
#define HBOOST_ASIO_DETAIL_WINRT_RESOLVE_OP_HPP
...
{
public:
  HBOOST_ASIO_DEFINE_HANDLER_PTR(winrt_resolve_op);
      ...
      const hboost::system::error_code&, std::size_t)
  {
    ...
    if (!o->ec_)
    {
      ...
      {
        o->ec_ = hboost::system::error_code(e->HResult,
    ...
    detail::binder2<Handler, hboost::system::error_code, iterator_type>
...
#endif // HBOOST_ASIO_DETAIL_WINRT_RESOLVE_OP_HPP
