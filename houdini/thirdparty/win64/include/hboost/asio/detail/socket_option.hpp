...
#ifndef HBOOST_ASIO_DETAIL_SOCKET_OPTION_HPP
#define HBOOST_ASIO_DETAIL_SOCKET_OPTION_HPP
...
public:
  ...
  {
    enabled(e);
    timeout HBOOST_ASIO_PREVENT_MACRO_SUBSTITUTION(t);
  }
  ...
  void timeout HBOOST_ASIO_PREVENT_MACRO_SUBSTITUTION(int value)
  {
#if defined(WIN32)
  ...
  int timeout HBOOST_ASIO_PREVENT_MACRO_SUBSTITUTION() const
  {
...
#endif // HBOOST_ASIO_DETAIL_SOCKET_OPTION_HPP
