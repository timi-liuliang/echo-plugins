...
#ifndef HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP
#define HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP
...
{
public:
  HBOOST_ASIO_DEFINE_HANDLER_PTR(win_iocp_socket_accept_op);
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    if (owner)
    {
      ...
      if (ec == hboost::asio::error::connection_aborted
...
#endif // HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP
