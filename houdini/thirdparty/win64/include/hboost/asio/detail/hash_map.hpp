...
#ifndef HBOOST_ASIO_DETAIL_HASH_MAP_HPP
#define HBOOST_ASIO_DETAIL_HASH_MAP_HPP
...
public:
  ...
  {
    HBOOST_ASIO_ASSERT(it != values_.end());
    HBOOST_ASIO_ASSERT(num_buckets_ != 0);
...
private:
  ...
  static std::size_t hash_size(std::size_t num_elems)
  {
    ...
    {
#if defined(HBOOST_ASIO_HASH_MAP_BUCKETS)
      HBOOST_ASIO_HASH_MAP_BUCKETS
#else // HBOOST_ASIO_HASH_MAP_BUCKETS
      3, 13, 23, 53, 97, 193, 389, 769, 1543, 3079, 6151, 12289, 24593,
      49157, 98317, 196613, 393241, 786433, 1572869, 3145739, 6291469,
      12582917, 25165843
#endif // HBOOST_ASIO_HASH_MAP_BUCKETS
    };
...
#endif // HBOOST_ASIO_DETAIL_HASH_MAP_HPP
