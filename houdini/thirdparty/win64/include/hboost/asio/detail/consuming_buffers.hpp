...
#ifndef HBOOST_ASIO_DETAIL_CONSUMING_BUFFERS_HPP
#define HBOOST_ASIO_DETAIL_CONSUMING_BUFFERS_HPP
...
class consuming_buffers<Buffer, hboost::asio::null_buffers>
  : public hboost::asio::null_buffers
{
public:
  consuming_buffers(const hboost::asio::null_buffers&)
  {
    // No-op.
  }
...
#endif // HBOOST_ASIO_DETAIL_CONSUMING_BUFFERS_HPP
