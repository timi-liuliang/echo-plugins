...
#ifndef HBOOST_ASIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP
#define HBOOST_ASIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP
...
{
public:
  HBOOST_ASIO_DEFINE_HANDLER_PTR(resolve_endpoint_op);
...
#endif // HBOOST_ASIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP
