...
#ifndef HBOOST_ASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
#define HBOOST_ASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
...
public:
  ...
  void set(reactor_op_queue<socket_type>& operations, op_queue<operation>& ops)
  {
    ...
    while (i != operations.end())
    {
      ...
      {
        hboost::system::error_code ec(error::fd_set_failure);
...
#endif // HBOOST_ASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
