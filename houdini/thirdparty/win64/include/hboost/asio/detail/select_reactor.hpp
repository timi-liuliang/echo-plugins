...
#ifndef HBOOST_ASIO_DETAIL_SELECT_REACTOR_HPP
#define HBOOST_ASIO_DETAIL_SELECT_REACTOR_HPP
...
class select_reactor
  : public hboost::asio::detail::service_base<select_reactor>
{
public:
  ...
  // Constructor.
  HBOOST_ASIO_DECL select_reactor(hboost::asio::io_service& io_service);

  // Destructor.
  HBOOST_ASIO_DECL ~select_reactor();
...
private:
  ...
  HBOOST_ASIO_DECL static void call_run_thread(select_reactor* reactor);
#endif // defined(HBOOST_ASIO_HAS_IOCP)
  ...
  HBOOST_ASIO_DECL timeval* get_timeout(timeval& tv);
...
#include <hboost/asio/detail/impl/select_reactor.hpp>
#if defined(HBOOST_ASIO_HEADER_ONLY)
# include <hboost/asio/detail/impl/select_reactor.ipp>
...
#endif // HBOOST_ASIO_DETAIL_SELECT_REACTOR_HPP
