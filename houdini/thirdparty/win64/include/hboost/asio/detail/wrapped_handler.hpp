...
#ifndef HBOOST_ASIO_DETAIL_WRAPPED_HANDLER_HPP
#define HBOOST_ASIO_DETAIL_WRAPPED_HANDLER_HPP
...
struct is_continuation_delegated
{
  ...
  {
    return hboost_asio_handler_cont_helpers::is_continuation(handler);
  }
};
...
public:
  ...
  wrapped_handler(wrapped_handler&& other)
    : dispatcher_(other.dispatcher_),
      handler_(HBOOST_ASIO_MOVE_CAST(Handler)(other.handler_))
  {
  }
  ...
  void operator()()
  {
    dispatcher_.dispatch(HBOOST_ASIO_MOVE_CAST(Handler)(handler_));
  }
...
public:
  ...
  rewrapped_handler(rewrapped_handler&& other)
    : context_(HBOOST_ASIO_MOVE_CAST(Context)(other.context_)),
      handler_(HBOOST_ASIO_MOVE_CAST(Handler)(other.handler_))
  {
  }
#endif // defined(HBOOST_ASIO_HAS_MOVE)
...
#endif // HBOOST_ASIO_DETAIL_WRAPPED_HANDLER_HPP
