...
#ifndef HBOOST_ASIO_DETAIL_RESOLVER_SERVICE_HPP
#define HBOOST_ASIO_DETAIL_RESOLVER_SERVICE_HPP
...
#include <hboost/asio/detail/resolve_endpoint_op.hpp>
#include <hboost/asio/detail/resolve_op.hpp>
...
public:
  ...
  // Constructor.
  resolver_service(hboost::asio::io_service& io_service)
  ...
  {
    hboost::asio::detail::addrinfo_type* address_info = 0;
...
#endif // HBOOST_ASIO_DETAIL_RESOLVER_SERVICE_HPP
