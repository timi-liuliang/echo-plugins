...
#ifndef HBOOST_ASIO_DETAIL_WINRT_UTILS_HPP
#define HBOOST_ASIO_DETAIL_WINRT_UTILS_HPP
    ...
    const ConstBufferSequence& buffers)
{
  ...
  std::size_t size = hboost::asio::buffer_size(buffers);
  ...
  byte* bytes = nullptr;
  bacc->Buffer(&bytes);
  hboost::asio::buffer_copy(hboost::asio::buffer(bytes, size), buffers);
  b->Length = size;
  return b;
}
...
#endif // HBOOST_ASIO_DETAIL_WINRT_UTILS_HPP
