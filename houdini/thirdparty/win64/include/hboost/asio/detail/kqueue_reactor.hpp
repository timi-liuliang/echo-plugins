...
#ifndef HBOOST_ASIO_DETAIL_KQUEUE_REACTOR_HPP
#define HBOOST_ASIO_DETAIL_KQUEUE_REACTOR_HPP
...
class kqueue_reactor
  : public hboost::asio::detail::service_base<kqueue_reactor>
{
public:
  ...
  // Constructor.
  HBOOST_ASIO_DECL kqueue_reactor(hboost::asio::io_service& io_service);

  // Destructor.
  HBOOST_ASIO_DECL ~kqueue_reactor();
...
private:
  ...
  // cannot be created.
  HBOOST_ASIO_DECL static int do_kqueue_create();
  ...
  HBOOST_ASIO_DECL timespec* get_timeout(timespec& ts);
...
#include <hboost/asio/detail/impl/kqueue_reactor.hpp>
#if defined(HBOOST_ASIO_HEADER_ONLY)
# include <hboost/asio/detail/impl/kqueue_reactor.ipp>
#endif // defined(HBOOST_ASIO_HEADER_ONLY)

#endif // defined(HBOOST_ASIO_HAS_KQUEUE)

#endif // HBOOST_ASIO_DETAIL_KQUEUE_REACTOR_HPP
