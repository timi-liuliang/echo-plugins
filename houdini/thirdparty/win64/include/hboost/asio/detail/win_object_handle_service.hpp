...
#ifndef HBOOST_ASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP
#define HBOOST_ASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP
...
#include <hboost/asio/detail/wait_handler.hpp>
...
public:
  ...
  // Constructor.
  HBOOST_ASIO_DECL win_object_handle_service(
  ...
  HBOOST_ASIO_DECL void wait(implementation_type& impl,
      hboost::system::error_code& ec);
  ...
  void async_wait(implementation_type& impl, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "object_handle", &impl, "async_wait"));
...
private:
  ...
  HBOOST_ASIO_DECL void start_wait_op(implementation_type& impl, wait_op* op);

  // Helper function to register a wait operation.
  HBOOST_ASIO_DECL void register_wait_callback(
      implementation_type& impl, mutex::scoped_lock& lock);

  // Callback function invoked when the registered wait completes.
  static HBOOST_ASIO_DECL VOID CALLBACK wait_callback(
...
# include <hboost/asio/detail/impl/win_object_handle_service.ipp>
#endif // defined(HBOOST_ASIO_HEADER_ONLY)

#endif // defined(HBOOST_ASIO_HAS_WINDOWS_OBJECT_HANDLE)

#endif // HBOOST_ASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP
