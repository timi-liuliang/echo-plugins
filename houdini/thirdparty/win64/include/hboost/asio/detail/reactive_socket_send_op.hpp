...
#ifndef HBOOST_ASIO_DETAIL_REACTIVE_SOCKET_SEND_OP_HPP
#define HBOOST_ASIO_DETAIL_REACTIVE_SOCKET_SEND_OP_HPP
...
{
public:
  HBOOST_ASIO_DEFINE_HANDLER_PTR(reactive_socket_send_op);
...
#endif // HBOOST_ASIO_DETAIL_REACTIVE_SOCKET_SEND_OP_HPP
