...
#ifndef HBOOST_ASIO_DETAIL_RESOLVE_OP_HPP
#define HBOOST_ASIO_DETAIL_RESOLVE_OP_HPP
...
{
public:
  HBOOST_ASIO_DEFINE_HANDLER_PTR(resolve_op);
...
private:
  ...
  hboost::asio::detail::addrinfo_type* addrinfo_;
};
...
#endif // HBOOST_ASIO_DETAIL_RESOLVE_OP_HPP
