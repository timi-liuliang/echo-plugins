...
#ifndef HBOOST_ASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
#define HBOOST_ASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
...
#include <hboost/asio/detail/win_iocp_overlapped_op.hpp>
...
public:
  ...
  explicit win_iocp_overlapped_ptr(
      hboost::asio::io_service& io_service, HBOOST_ASIO_MOVE_ARG(Handler) handler)
    : ptr_(0),
      iocp_service_(0)
  {
    this->reset(io_service, HBOOST_ASIO_MOVE_CAST(Handler)(handler));
  }
  ...
  // object.
  template <typename Handler>
  void reset(hboost::asio::io_service& io_service, Handler handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "io_service",
  ...
  void complete(const hboost::system::error_code& ec,
...
#endif // HBOOST_ASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
