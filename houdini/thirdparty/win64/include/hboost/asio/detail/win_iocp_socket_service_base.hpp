...
#ifndef HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
#define HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
...
#include <hboost/asio/detail/reactor.hpp>
#include <hboost/asio/detail/reactor_op.hpp>
#include <hboost/asio/detail/socket_holder.hpp>
...
#include <hboost/asio/detail/win_iocp_null_buffers_op.hpp>
#include <hboost/asio/detail/win_iocp_socket_connect_op.hpp>
#include <hboost/asio/detail/win_iocp_socket_send_op.hpp>
#include <hboost/asio/detail/win_iocp_socket_recv_op.hpp>
#include <hboost/asio/detail/win_iocp_socket_recvmsg_op.hpp>
...
public:
...
#if defined(HBOOST_ASIO_ENABLE_CANCELIO)
    // The ID of the thread from which it is safe to cancel asynchronous
    // operations. 0 means no asynchronous operations have been started yet.
    // ~0 means asynchronous operations have been started from more than one
    // thread, and cancellation is not supported for the socket.
    DWORD safe_cancellation_thread_id_;
#endif // defined(HBOOST_ASIO_ENABLE_CANCELIO)
  ...
  // Constructor.
  HBOOST_ASIO_DECL win_iocp_socket_service_base(
  ...
  HBOOST_ASIO_DECL void construct(base_implementation_type& impl);

  // Move-construct a new socket implementation.
  HBOOST_ASIO_DECL void base_move_construct(base_implementation_type& impl,
      base_implementation_type& other_impl);

  // Move-assign from another socket implementation.
  HBOOST_ASIO_DECL void base_move_assign(base_implementation_type& impl,
      win_iocp_socket_service_base& other_service,
      base_implementation_type& other_impl);

  // Destroy a socket implementation.
  HBOOST_ASIO_DECL void destroy(base_implementation_type& impl);
  ...
  // Destroy a socket implementation.
  HBOOST_ASIO_DECL hboost::system::error_code close(
      base_implementation_type& impl, hboost::system::error_code& ec);

  // Cancel all operations associated with the socket.
  HBOOST_ASIO_DECL hboost::system::error_code cancel(
      base_implementation_type& impl, hboost::system::error_code& ec);
  ...
  hboost::system::error_code listen(base_implementation_type& impl,
  ...
  hboost::system::error_code io_control(base_implementation_type& impl,
      IO_Control_Command& command, hboost::system::error_code& ec)
  {
  ...
  hboost::system::error_code non_blocking(base_implementation_type& impl,
  ...
  hboost::system::error_code native_non_blocking(base_implementation_type& impl,
      bool mode, hboost::system::error_code& ec)
  {
  ...
  hboost::system::error_code shutdown(base_implementation_type& impl,
  ...
  size_t send(base_implementation_type& impl, const null_buffers&,
      socket_base::message_flags, hboost::system::error_code& ec)
  {
      ...
      socket_base::message_flags flags, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "socket", &impl, "async_send"));
      ...
      socket_base::message_flags, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "socket",
      ...
      socket_base::message_flags flags, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "socket", &impl, "async_receive"));
      ...
      socket_base::message_flags& out_flags, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "socket", &impl,
  ...
  HBOOST_ASIO_DECL void restart_accept_op(socket_type s,
      socket_holder& new_socket, int family, int type, int protocol,
      void* output_buffer, DWORD address_length, operation* op);

protected:
  // Open a new socket implementation.
  HBOOST_ASIO_DECL hboost::system::error_code do_open(
      base_implementation_type& impl, int family, int type,
      int protocol, hboost::system::error_code& ec);

  // Assign a native socket to a socket implementation.
  HBOOST_ASIO_DECL hboost::system::error_code do_assign(
      base_implementation_type& impl, int type,
      socket_type native_socket, hboost::system::error_code& ec);

  // Helper function to start an asynchronous send operation.
  HBOOST_ASIO_DECL void start_send_op(base_implementation_type& impl,
      WSABUF* buffers, std::size_t buffer_count,
      socket_base::message_flags flags, bool noop, operation* op);

  // Helper function to start an asynchronous send_to operation.
  HBOOST_ASIO_DECL void start_send_to_op(base_implementation_type& impl,
      WSABUF* buffers, std::size_t buffer_count,
      const socket_addr_type* addr, int addrlen,
      socket_base::message_flags flags, operation* op);

  // Helper function to start an asynchronous receive operation.
  HBOOST_ASIO_DECL void start_receive_op(base_implementation_type& impl,
      WSABUF* buffers, std::size_t buffer_count,
      socket_base::message_flags flags, bool noop, operation* op);

  // Helper function to start an asynchronous null_buffers receive operation.
  HBOOST_ASIO_DECL void start_null_buffers_receive_op(
      base_implementation_type& impl,
      socket_base::message_flags flags, reactor_op* op);

  // Helper function to start an asynchronous receive_from operation.
  HBOOST_ASIO_DECL void start_receive_from_op(base_implementation_type& impl,
      WSABUF* buffers, std::size_t buffer_count, socket_addr_type* addr,
      socket_base::message_flags flags, int* addrlen, operation* op);

  // Helper function to start an asynchronous accept operation.
  HBOOST_ASIO_DECL void start_accept_op(base_implementation_type& impl,
      bool peer_is_open, socket_holder& new_socket, int family, int type,
      int protocol, void* output_buffer, DWORD address_length, operation* op);

  // Start an asynchronous read or write operation using the reactor.
  HBOOST_ASIO_DECL void start_reactor_op(base_implementation_type& impl,
      int op_type, reactor_op* op);

  // Start the asynchronous connect operation using the reactor.
  HBOOST_ASIO_DECL void start_connect_op(base_implementation_type& impl,
  ...
  // destroyed.
  HBOOST_ASIO_DECL void close_for_destruction(base_implementation_type& impl);

  // Update the ID of the thread from which cancellation is safe.
  HBOOST_ASIO_DECL void update_cancellation_thread_id(
      base_implementation_type& impl);
  ...
  // this service.
  HBOOST_ASIO_DECL reactor& get_reactor();
  ...
  HBOOST_ASIO_DECL connect_ex_fn get_connect_ex(
      base_implementation_type& impl, int type);
  ...
  HBOOST_ASIO_DECL void* interlocked_compare_exchange_pointer(
      void** dest, void* exch, void* cmp);

  // Helper function to emulate InterlockedExchangePointer functionality for:
  // - very old Platform SDKs; and
  // - platform SDKs where MSVC's /Wp64 option causes spurious warnings.
  HBOOST_ASIO_DECL void* interlocked_exchange_pointer(void** dest, void* val);

  // The io_service used to obtain the reactor, if required.
  hboost::asio::io_service& io_service_;
...
# include <hboost/asio/detail/impl/win_iocp_socket_service_base.ipp>
#endif // defined(HBOOST_ASIO_HEADER_ONLY)

#endif // defined(HBOOST_ASIO_HAS_IOCP)

#endif // HBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
