...
#ifndef HBOOST_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
#define HBOOST_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
...
#include <hboost/asio/detail/config.hpp>
  ...
  || (!defined(HBOOST_ASIO_HAS_DEV_POLL) \
      && !defined(HBOOST_ASIO_HAS_EPOLL) \
      && !defined(HBOOST_ASIO_HAS_KQUEUE) \
      && !defined(HBOOST_ASIO_WINDOWS_RUNTIME))

#include <hboost/asio/detail/bind_handler.hpp>
#include <hboost/asio/detail/fd_set_adapter.hpp>
...
select_reactor::select_reactor(hboost::asio::io_service& io_service)
  : hboost::asio::detail::service_base<select_reactor>(io_service),
...
{
#if defined(HBOOST_ASIO_HAS_IOCP)
  hboost::asio::detail::signal_blocker sb;
  thread_ = new hboost::asio::detail::thread(
...
void select_reactor::fork_service(hboost::asio::io_service::fork_event fork_ev)
{
...
{
  hboost::asio::detail::mutex::scoped_lock lock(mutex_);
  cancel_ops_unlocked(descriptor, hboost::asio::error::operation_aborted);
}
...
#endif // HBOOST_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
