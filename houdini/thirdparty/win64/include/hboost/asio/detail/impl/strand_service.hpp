...
#ifndef HBOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
#define HBOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
    ...
    Handler& handler)
{
  ...
  HBOOST_ASIO_HANDLER_CREATION((p.p, "strand", impl, "dispatch"));
  ...
  if (dispatch_immediately)
  {
    ...
    completion_handler<Handler>::do_complete(
        &io_service_, o, hboost::system::error_code(), 0);
  }
}
    ...
    Handler& handler)
{
  ...
  HBOOST_ASIO_HANDLER_CREATION((p.p, "strand", impl, "post"));
...
#endif // HBOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
