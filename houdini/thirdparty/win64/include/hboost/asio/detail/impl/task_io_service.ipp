...
#ifndef HBOOST_ASIO_DETAIL_IMPL_TASK_IO_SERVICE_IPP
#define HBOOST_ASIO_DETAIL_IMPL_TASK_IO_SERVICE_IPP
...
task_io_service::task_io_service(
    hboost::asio::io_service& io_service, std::size_t concurrency_hint)
  : hboost::asio::detail::service_base<task_io_service>(io_service),
...
std::size_t task_io_service::run(hboost::system::error_code& ec)
{
...
std::size_t task_io_service::run_one(hboost::system::error_code& ec)
{
  ec = hboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll(hboost::system::error_code& ec)
{
  ec = hboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll_one(hboost::system::error_code& ec)
{
  ec = hboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
#else // defined(HBOOST_ASIO_HAS_THREADS)
...
#endif // HBOOST_ASIO_DETAIL_IMPL_TASK_IO_SERVICE_IPP
