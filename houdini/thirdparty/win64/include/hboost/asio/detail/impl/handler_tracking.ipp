...
#ifndef HBOOST_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
#define HBOOST_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
...
struct handler_tracking_timestamp
{
  ...
  {
#if defined(HBOOST_ASIO_HAS_HBOOST_DATE_TIME)
    hboost::posix_time::ptime epoch(hboost::gregorian::date(1970, 1, 1));
    hboost::posix_time::time_duration now =
      hboost::posix_time::microsec_clock::universal_time() - epoch;
#elif defined(HBOOST_ASIO_HAS_STD_CHRONO)
    typedef chrono_time_traits<std::chrono::system_clock,
        hboost::asio::wait_traits<std::chrono::system_clock> > traits_helper;
    traits_helper::posix_time_duration now(
        std::chrono::system_clock::now().time_since_epoch());
#elif defined(HBOOST_ASIO_HAS_HBOOST_CHRONO)
    typedef chrono_time_traits<hboost::chrono::system_clock,
        hboost::asio::wait_traits<hboost::chrono::system_clock> > traits_helper;
    traits_helper::posix_time_duration now(
        hboost::chrono::system_clock::now().time_since_epoch());
#endif
...
{
  static tracking_state state = { HBOOST_ASIO_STATIC_MUTEX_INIT, 1, 0 };
  return &state;
}
...
#endif // HBOOST_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
