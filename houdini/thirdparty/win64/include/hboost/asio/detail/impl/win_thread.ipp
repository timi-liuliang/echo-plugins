...
#ifndef HBOOST_ASIO_DETAIL_IMPL_WIN_THREAD_IPP
#define HBOOST_ASIO_DETAIL_IMPL_WIN_THREAD_IPP
...
void win_thread::start_thread(func_base* arg, unsigned int stack_size)
{
  ...
  if (!entry_event)
  {
    ...
    hboost::asio::detail::throw_error(ec, "thread.entry_event");
  }
  ...
  if (!exit_event_)
  {
    ...
    hboost::system::error_code ec(last_error,
        hboost::asio::error::get_system_category());
    hboost::asio::detail::throw_error(ec, "thread.exit_event");
  }
...
#endif // HBOOST_ASIO_DETAIL_IMPL_WIN_THREAD_IPP
