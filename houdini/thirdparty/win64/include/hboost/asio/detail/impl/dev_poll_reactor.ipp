...
#ifndef HBOOST_ASIO_DETAIL_IMPL_DEV_POLL_REACTOR_IPP
#define HBOOST_ASIO_DETAIL_IMPL_DEV_POLL_REACTOR_IPP
...
dev_poll_reactor::dev_poll_reactor(hboost::asio::io_service& io_service)
  : hboost::asio::detail::service_base<dev_poll_reactor>(io_service),
...
void dev_poll_reactor::fork_service(hboost::asio::io_service::fork_event fork_ev)
{
...
int dev_poll_reactor::do_dev_poll_create()
{
  ...
  if (fd == -1)
  {
    hboost::system::error_code ec(errno,
        hboost::asio::error::get_system_category());
    hboost::asio::detail::throw_error(ec, "/dev/poll");
  }
  return fd;
}
...
#endif // HBOOST_ASIO_DETAIL_IMPL_DEV_POLL_REACTOR_IPP
