...
#ifndef HBOOST_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
#define HBOOST_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
    ...
    reactive_descriptor_service::implementation_type& impl)
{
  if (is_open(impl))
  {
    HBOOST_ASIO_HANDLER_OPERATION(("descriptor", &impl, "close"));
...
hboost::system::error_code reactive_descriptor_service::assign(
    reactive_descriptor_service::implementation_type& impl,
    const native_handle_type& native_descriptor, hboost::system::error_code& ec)
{
  if (is_open(impl))
  {
...
hboost::system::error_code reactive_descriptor_service::close(
    reactive_descriptor_service::implementation_type& impl,
    ...
    reactive_descriptor_service::implementation_type& impl)
{
  ...
  if (is_open(impl))
  {
    HBOOST_ASIO_HANDLER_OPERATION(("descriptor", &impl, "release"));
...
hboost::system::error_code reactive_descriptor_service::cancel(
    reactive_descriptor_service::implementation_type& impl,
    hboost::system::error_code& ec)
{
  if (!is_open(impl))
  ...
  HBOOST_ASIO_HANDLER_OPERATION(("descriptor", &impl, "cancel"));
...
#endif // HBOOST_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
