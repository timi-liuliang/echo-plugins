...
#ifndef HBOOST_ASIO_DETAIL_WIN_IOCP_HANDLE_SERVICE_HPP
#define HBOOST_ASIO_DETAIL_WIN_IOCP_HANDLE_SERVICE_HPP
...
#include <hboost/asio/detail/win_iocp_handle_read_op.hpp>
#include <hboost/asio/detail/win_iocp_handle_write_op.hpp>
...
public:
  ...
  HBOOST_ASIO_DECL win_iocp_handle_service(hboost::asio::io_service& io_service);
  ...
  HBOOST_ASIO_DECL void move_construct(implementation_type& impl,
      implementation_type& other_impl);

  // Move-assign from another handle implementation.
  HBOOST_ASIO_DECL void move_assign(implementation_type& impl,
      win_iocp_handle_service& other_service,
      implementation_type& other_impl);

  // Destroy a handle implementation.
  HBOOST_ASIO_DECL void destroy(implementation_type& impl);

  // Assign a native handle to a handle implementation.
  HBOOST_ASIO_DECL hboost::system::error_code assign(implementation_type& impl,
  ...
  // Destroy a handle implementation.
  HBOOST_ASIO_DECL hboost::system::error_code close(implementation_type& impl,
  ...
  HBOOST_ASIO_DECL hboost::system::error_code cancel(implementation_type& impl,
      hboost::system::error_code& ec);
  ...
  size_t write_some_at(implementation_type& impl, uint64_t offset,
      const ConstBufferSequence& buffers, hboost::system::error_code& ec)
  {
    hboost::asio::const_buffer buffer =
      ...
      const ConstBufferSequence& buffers, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "handle", &impl, "async_write_some"));
      ...
      const ConstBufferSequence& buffers, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "handle", &impl, "async_write_some_at"));
  ...
  size_t read_some_at(implementation_type& impl, uint64_t offset,
      const MutableBufferSequence& buffers, hboost::system::error_code& ec)
  {
    hboost::asio::mutable_buffer buffer =
      ...
      const MutableBufferSequence& buffers, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "handle", &impl, "async_read_some"));
      ...
      const MutableBufferSequence& buffers, Handler& handler)
  {
    ...
    HBOOST_ASIO_HANDLER_CREATION((p.p, "handle", &impl, "async_read_some_at"));
...
private:
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers& buffers, hboost::system::error_code& ec);
  size_t write_some_at(implementation_type& impl, uint64_t offset,
      const null_buffers& buffers, hboost::system::error_code& ec);
  ...
  HBOOST_ASIO_DECL size_t do_write(implementation_type& impl,
      uint64_t offset, const hboost::asio::const_buffer& buffer,
      hboost::system::error_code& ec);

  // Helper function to start a write operation.
  HBOOST_ASIO_DECL void start_write_op(implementation_type& impl,
      uint64_t offset, const hboost::asio::const_buffer& buffer,
      operation* op);

  // Helper function to perform a synchronous write operation.
  HBOOST_ASIO_DECL size_t do_read(implementation_type& impl,
      uint64_t offset, const hboost::asio::mutable_buffer& buffer,
      hboost::system::error_code& ec);

  // Helper function to start a read operation.
  HBOOST_ASIO_DECL void start_read_op(implementation_type& impl,
      uint64_t offset, const hboost::asio::mutable_buffer& buffer,
      operation* op);

  // Update the ID of the thread from which cancellation is safe.
  HBOOST_ASIO_DECL void update_cancellation_thread_id(implementation_type& impl);

  // Helper function to close a handle when the associated object is being
  // destroyed.
  HBOOST_ASIO_DECL void close_for_destruction(implementation_type& impl);
...
# include <hboost/asio/detail/impl/win_iocp_handle_service.ipp>
#endif // defined(HBOOST_ASIO_HEADER_ONLY)

#endif // defined(HBOOST_ASIO_HAS_IOCP)

#endif // HBOOST_ASIO_DETAIL_WIN_IOCP_HANDLE_SERVICE_HPP
