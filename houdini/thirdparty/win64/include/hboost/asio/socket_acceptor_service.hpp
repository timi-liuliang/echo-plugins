...
#ifndef HBOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
#define HBOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
...
#else
  : public hboost::asio::detail::service_base<socket_acceptor_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit socket_acceptor_service(hboost::asio::io_service& io_service)
  ...
  /// connections.
  hboost::system::error_code listen(implementation_type& impl, int backlog,
      hboost::system::error_code& ec)
  {
      ...
      typename enable_if<is_convertible<Protocol, Protocol1>::value>::type* = 0)
  {
    detail::async_result_init<
      AcceptHandler, void (hboost::system::error_code)> init(
...
#endif // HBOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
