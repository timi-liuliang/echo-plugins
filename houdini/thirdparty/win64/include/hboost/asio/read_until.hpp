...
#ifndef HBOOST_ASIO_READ_UNTIL_HPP
#define HBOOST_ASIO_READ_UNTIL_HPP
...
#include <hboost/asio/detail/regex_fwd.hpp>
...
struct is_match_condition
{
  ...
  enum
  {
    value = hboost::asio::is_function<
        typename hboost::asio::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until hboost::asio::read_until
 *
 ...
 * @code hboost::asio::streambuf b;
 * hboost::asio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
 ...
 * @code hboost::asio::streambuf b;
 * hboost::asio::read_until(s, b, hboost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
 ...
 * @code typedef hboost::asio::buffers_iterator<
 *     hboost::asio::streambuf::const_buffers_type> iterator;
 *
 ...
 * }
 * ...
 * hboost::asio::streambuf b;
 * hboost::asio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 *     : public hboost::true_type {};
 * } // namespace asio
 * ...
 * hboost::asio::streambuf b;
 * hboost::asio::read_until(s, b, match_char('a'));
 * @endcode
 */
...
/*@}*/
/**
 * @defgroup async_read_until hboost::asio::async_read_until
 *
 ...
 * @code hboost::asio::streambuf b;
 * ...
 * void handler(const hboost::system::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::istream is(&b);
 ...
 * }
 * ...
 * hboost::asio::async_read_until(s, b, '\n', handler); @endcode
...
async_read_until(AsyncReadStream& s,
    hboost::asio::basic_streambuf<Allocator>& b,
    char delim, HBOOST_ASIO_MOVE_ARG(ReadHandler) handler);
 ...
 * }
 * ...
 * hboost::asio::async_read_until(s, b, hboost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * hboost::asio::streambuf b;
 * hboost::asio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * hboost::asio::streambuf b;
 * hboost::asio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 */
...
#include <hboost/asio/impl/read_until.hpp>

#endif // !defined(HBOOST_ASIO_NO_IOSTREAM)

#endif // HBOOST_ASIO_READ_UNTIL_HPP
