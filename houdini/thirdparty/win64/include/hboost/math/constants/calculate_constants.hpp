...
#ifndef HBOOST_MATH_CALCULATE_CONSTANTS_CONSTANTS_INCLUDED
#define HBOOST_MATH_CALCULATE_CONSTANTS_CONSTANTS_INCLUDED

#include <hboost/math/special_functions/trunc.hpp>

namespace hboost{ namespace math{ namespace constants{ namespace detail{

template <class T>
template<int N>
inline T constant_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   ...
   T lim;
   lim = hboost::math::tools::epsilon<T>();
   ...
   do
   {
      ...
      B = ldexp(B, 1);
      result = A - B;
      bool neg = hboost::math::sign(result) < 0;
      if(neg)
         result = -result;
      if(result <= lim)
         break;
...
template <class T>
template<int N>
inline T constant_two_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
...
template<int N>
inline T constant_two_div_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   return 2 / pi<T, policies::policy<policies::digits2<N> > >();
}
...
template <int N>
inline T constant_root_two_div_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_one_div_two_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
...
template <class T>
template<int N>
inline T constant_root_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_half_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_two_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_log_root_two_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_ln_four<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_e<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   //
...
template <class T>
template<int N>
inline T constant_half<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
...
template <class T>
template<int M>
inline T constant_euler<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<M>))
{
   HBOOST_MATH_STD_USING
   //
...
template <class T>
template<int N>
inline T constant_euler_sqr<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
  HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_one_div_euler<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
  HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_two<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_three<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_half_root_two<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_ln_two<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   //
...
template <class T>
template<int N>
inline T constant_ln_ten<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_ln_ln_two<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_third<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_twothirds<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_two_thirds<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
   return static_cast<T>(2) / static_cast<T>(3);
}
...
template <class T>
template<int N>
inline T constant_three_quarters<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_pi_minus_three<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
...
template <class T>
template<int N>
inline T constant_four_minus_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
...
//template <class T>
//template<int N>
//inline T constant_pow23_four_minus_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
//{
//   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_exp_minus_half<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_one_div_root_two<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
...
template <class T>
template<int N>
inline T constant_one_div_root_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
...
template <class T>
template<int N>
inline T constant_one_div_root_two_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
...
template <class T>
template<int N>
inline T constant_root_one_div_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_four_thirds_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_half_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_third_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
   return pi<T, policies::policy<policies::digits2<N> > >()  / static_cast<T>(3);
}
...
template <class T>
template<int N>
inline T constant_sixth_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_two_thirds_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_three_quarters_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_pi_pow_e<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_pi_sqr<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_pi_sqr_div_six<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
   return pi<T, policies::policy<policies::digits2<N> > >()
   *      pi<T, policies::policy<policies::digits2<N> > >()
...
template <class T>
template<int N>
inline T constant_pi_cubed<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
   return pi<T, policies::policy<policies::digits2<N> > >()
   *      pi<T, policies::policy<policies::digits2<N> > >()
...
template <class T>
template<int N>
inline T constant_cbrt_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_one_div_cbrt_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
   return static_cast<T>(1)
...
template <class T>
template<int N>
inline T constant_e_pow_pi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_e<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_log10_e<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_one_div_log10_e<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
   return  static_cast<T>(1) /
...
template <class T>
template<int N>
inline T constant_degree<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
   return pi<T, policies::policy<policies::digits2<N> > >()
   / static_cast<T>(180)
...
template <class T>
template<int N>
inline T constant_radian<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_sin_one<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_cos_one<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_sinh_one<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_cosh_one<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_phi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_ln_phi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_one_div_ln_phi<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
   return static_cast<T>(1) /
...
template <class T>
template<int N>
inline T constant_zeta_two<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   HBOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_zeta_three<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
...
template <class T>
template<int N>
inline T constant_catalan<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{ // http://oeis.org/A006752/constant
 ...
 //"149374281672134266498119621763019776254769479356512926115106248574");
  ...
  // 9.159655941772190150546035149323841107, 74149374281672134266498119621763019776254769479356512926115106248574422619, -01);
   ...
   return hboost::math::constants::pi<T, hboost::math::policies::policy<> >()
      * log(2 + hboost::math::constants::root_three<T, hboost::math::policies::policy<> >())
       / 8
      + 3 * sum / 8;
}
...
T khinchin(int digits)
{
   ...
   return exp(sum / hboost::math::constants::ln_two<T, hboost::math::policies::policy<> >());
}
...
template <class T>
template<int N>
inline T constant_khinchin<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
...
template <class T>
template<int N>
inline T constant_extreme_value_skewness<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
...
T zeta_series_derivative_2(unsigned digits)
{
   ...
   hboost::math::itrunc((std::numeric_limits<T>::digits10 + 1) * 1.3);
...
inline T zeta_series_derivative_lead_2()
{
   ...
   return -2 * hboost::math::constants::ln_two<T>();
}
...
template <class T>
template<int N>
inline T constant_glaisher<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{
   ...
   v *= 6;
   v /= hboost::math::constants::pi<T, forwarding_policy>() * hboost::math::constants::pi<T, forwarding_policy>();
   v -= hboost::math::constants::euler<T, forwarding_policy>();
   v -= log(2 * hboost::math::constants::pi<T, forwarding_policy>());
   v /= -12;
   return exp(v);
...
template <class T>
template<int N>
inline T constant_rayleigh_skewness<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
{  // From e_float
...
template <class T>
template<int N>
inline T constant_rayleigh_kurtosis_excess<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
...
template <class T>
template<int N>
inline T constant_rayleigh_kurtosis<T>::compute(HBOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>))
...
#endif // HBOOST_MATH_CALCULATE_CONSTANTS_CONSTANTS_INCLUDED
