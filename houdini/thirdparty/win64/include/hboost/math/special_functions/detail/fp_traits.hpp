...
#ifndef HBOOST_MATH_FP_TRAITS_HPP
#define HBOOST_MATH_FP_TRAITS_HPP
...
#   define HBOOST_FPCLASSIFY_VAX_FORMAT
#endif
...
#           define HBOOST_FPCLASSIFY_PREFIX ::__std_alias:: 
#        else
#           define HBOOST_FPCLASSIFY_PREFIX ::_STLP_VENDOR_CSTD:: 
#        endif
#     else
#        define HBOOST_FPCLASSIFY_PREFIX ::std::
#     endif
#  else
#     undef HBOOST_HAS_FPCLASSIFY
#     define HBOOST_FPCLASSIFY_PREFIX
#  endif
...
#ifndef HBOOST_FPCLASSIFY_VAX_FORMAT

template<> struct fp_traits_non_native<float, single_precision>
{
    typedef ieee_copy_all_bits_tag method;

    HBOOST_STATIC_CONSTANT(uint32_t, sign        = 0x80000000u);
    HBOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7f800000);
    HBOOST_STATIC_CONSTANT(uint32_t, flag        = 0x00000000);
    HBOOST_STATIC_CONSTANT(uint32_t, significand = 0x007fffff);
...
#if defined(HBOOST_NO_INT64_T) || defined(HBOOST_NO_INCLASS_MEMBER_INITIALIZATION) \
...
template<> struct fp_traits_non_native<double, double_precision>
{
    ...
    HBOOST_STATIC_CONSTANT(uint32_t, sign        = 0x80000000u);
    HBOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7ff00000);
    HBOOST_STATIC_CONSTANT(uint32_t, flag        = 0);
    HBOOST_STATIC_CONSTANT(uint32_t, significand = 0x000fffff);
...
#if defined(HBOOST_BIG_ENDIAN)
    HBOOST_STATIC_CONSTANT(int, offset_ = 0);
#elif defined(HBOOST_LITTLE_ENDIAN)
    HBOOST_STATIC_CONSTANT(int, offset_ = 4);
#else
    HBOOST_STATIC_ASSERT(false);
#endif
};
...
#endif  // #ifndef HBOOST_FPCLASSIFY_VAX_FORMAT
...
struct fp_traits_non_native<long double, extended_double_precision>
{
    ...
    HBOOST_STATIC_CONSTANT(uint32_t, sign        = 0x80000000u);
    HBOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7fff0000);
    HBOOST_STATIC_CONSTANT(uint32_t, flag        = 0x00008000);
    HBOOST_STATIC_CONSTANT(uint32_t, significand = 0x00007fff);
...
private:
    ...
    HBOOST_STATIC_CONSTANT(int, offset_ = 0);
#elif defined(HBOOST_LITTLE_ENDIAN)
    HBOOST_STATIC_CONSTANT(int, offset_ = 12);
#else
    HBOOST_STATIC_ASSERT(false);
#endif
};
...
struct fp_traits_non_native<long double, extended_double_precision>
{
    ...
    HBOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7fff0000);
    HBOOST_STATIC_CONSTANT(uint32_t, flag        = 0x00000000);
    HBOOST_STATIC_CONSTANT(uint32_t, significand = 0x0000ffff);
...
{
    typedef HBOOST_DEDUCED_TYPENAME size_to_precision<sizeof(T), ::hboost::is_floating_point<T>::value>::type precision;
...
#if (defined(HBOOST_MATH_USE_C99) && !(defined(__GNUC__) && (__GNUC__ < 4))) \
   && !defined(__hpux) \
   && !defined(__DECCXX)\
   && !defined(__osf__) \
   && !defined(__SGI_STL_PORT) && !defined(_STLPORT_VERSION)\
   && !defined(__FAST_MATH__)\
   && !defined(HBOOST_MATH_DISABLE_STD_FPCLASSIFY)\
   && !defined(HBOOST_INTEL)\
   && !defined(sun)
#  define HBOOST_MATH_USE_STD_FPCLASSIFY
#endif

template<class T> struct fp_traits
{
    typedef HBOOST_DEDUCED_TYPENAME size_to_precision<sizeof(T), ::hboost::is_floating_point<T>::value>::type precision;
#if defined(HBOOST_MATH_USE_STD_FPCLASSIFY) && !defined(HBOOST_MATH_DISABLE_STD_FPCLASSIFY)
