...
#ifndef HBOOST_MATH_PROMOTION_HPP
#define HBOOST_MATH_PROMOTION_HPP
...
#include <hboost/type_traits/is_floating_point.hpp> // for hboost::is_floating_point;
#include <hboost/type_traits/is_integral.hpp> // for hboost::is_integral
#include <hboost/type_traits/is_convertible.hpp> // for hboost::is_convertible
#include <hboost/type_traits/is_same.hpp>// for hboost::is_same
#include <hboost/type_traits/remove_cv.hpp>// for hboost::remove_cv
// Boost Template meta programming:
#include <hboost/mpl/if.hpp> // for hboost::mpl::if_c.
#include <hboost/mpl/and.hpp> // for hboost::mpl::if_c.
#include <hboost/mpl/or.hpp> // for hboost::mpl::if_c.
#include <hboost/mpl/not.hpp> // for hboost::mpl::if_c.
    ...
    namespace tools
    {
      ...
      { // Promote, if necessary, & pick the wider of the two floating-point types.
        ...
        typedef typename mpl::if_<
          ...
          typename mpl::if_< typename mpl::and_<mpl::not_<is_floating_point<T2P> >, ::hboost::is_convertible<T1P, T2P> >, T2P, T1P>::type>::type type;
      }; // promote_arg2
      // These full specialisations reduce mpl::if_ usage and speed up
      // compilation:
      ...
      struct promote_args
      {
         ...
         //
         HBOOST_STATIC_ASSERT_MSG((0 == ::hboost::is_same<type, long double>::value), "Sorry, but this platform does not have sufficient long double support for the special functions to be reliably implemented.");
#endif
      };
...
#endif // HBOOST_MATH_PROMOTION_HPP
