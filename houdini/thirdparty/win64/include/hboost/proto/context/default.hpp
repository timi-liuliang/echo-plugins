...
#ifndef HBOOST_PROTO_CONTEXT_DEFAULT_HPP_EAN_01_08_2007
#define HBOOST_PROTO_CONTEXT_DEFAULT_HPP_EAN_01_08_2007
...
#include <hboost/proto/traits.hpp> // for proto::child_c()
...
/// INTERNAL ONLY
///
#define UNREF(x) typename hboost::remove_reference<x>::type
    ...
    #define HBOOST_PROTO_BINARY_DEFAULT_EVAL(OP, TAG, LMAKE, RMAKE)                              \
        ...
        HBOOST_PROTO_UNARY_DEFAULT_EVAL(+, proto::tag::unary_plus, make)
        HBOOST_PROTO_UNARY_DEFAULT_EVAL(-, proto::tag::negate, make)
        HBOOST_PROTO_UNARY_DEFAULT_EVAL(*, proto::tag::dereference, make)
        HBOOST_PROTO_UNARY_DEFAULT_EVAL(~, proto::tag::complement, make)
        HBOOST_PROTO_UNARY_DEFAULT_EVAL(&, proto::tag::address_of, make)
        HBOOST_PROTO_UNARY_DEFAULT_EVAL(!, proto::tag::logical_not, make)
        HBOOST_PROTO_UNARY_DEFAULT_EVAL(++, proto::tag::pre_inc, make_mutable)
        HBOOST_PROTO_UNARY_DEFAULT_EVAL(--, proto::tag::pre_dec, make_mutable)

        HBOOST_PROTO_BINARY_DEFAULT_EVAL(<<, proto::tag::shift_left, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(>>, proto::tag::shift_right, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(*, proto::tag::multiplies, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(/, proto::tag::divides, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(%, proto::tag::modulus, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(+, proto::tag::plus, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(-, proto::tag::minus, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(<, proto::tag::less, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(>, proto::tag::greater, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(<=, proto::tag::less_equal, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(>=, proto::tag::greater_equal, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(==, proto::tag::equal_to, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(!=, proto::tag::not_equal_to, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(||, proto::tag::logical_or, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(&&, proto::tag::logical_and, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(&, proto::tag::bitwise_and, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(|, proto::tag::bitwise_or, make, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(^, proto::tag::bitwise_xor, make, make)

        HBOOST_PROTO_BINARY_DEFAULT_EVAL(=, proto::tag::assign, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(<<=, proto::tag::shift_left_assign, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(>>=, proto::tag::shift_right_assign, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(*=, proto::tag::multiplies_assign, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(/=, proto::tag::divides_assign, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(%=, proto::tag::modulus_assign, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(+=, proto::tag::plus_assign, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(-=, proto::tag::minus_assign, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(&=, proto::tag::bitwise_and_assign, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(|=, proto::tag::bitwise_or_assign, make_mutable, make)
        HBOOST_PROTO_BINARY_DEFAULT_EVAL(^=, proto::tag::bitwise_xor_assign, make_mutable, make)
    ...
    #undef HBOOST_PROTO_BINARY_DEFAULT_EVAL
        ...
        private:
            ...
            typedef typename proto::result_of::eval<UNREF(e1), Context>::type r1;
        public:
            HBOOST_PROTO_DECLTYPE_(proto::detail::make_subscriptable<r0>()[proto::detail::make<r1>()], result_type)
            result_type operator ()(Expr &expr, Context &ctx) const
            {
        ...
        struct default_eval<Expr, Context, proto::tag::function, 2>
        {
            ...
            typedef
                typename detail::result_of_<
                    function_type(HBOOST_PROTO_DEFAULT_EVAL_TYPE(~, 1, Expr))
                >::type
            result_type;
        ...
        private:
            ...
            {
                return HBOOST_PROTO_DEFAULT_EVAL(~, 0, expr)(HBOOST_PROTO_DEFAULT_EVAL(~, 1, expr));
            }
        ...
        #include <hboost/proto/context/detail/default_eval.hpp>
