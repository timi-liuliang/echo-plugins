...
#ifndef HBOOST_PROTO_FWD_HPP_EAN_04_01_2005
#define HBOOST_PROTO_FWD_HPP_EAN_04_01_2005
...
#ifndef HBOOST_PROTO_MAX_ARITY
# define HBOOST_PROTO_MAX_ARITY 10
#endif

#ifndef HBOOST_PROTO_MAX_LOGICAL_ARITY
# define HBOOST_PROTO_MAX_LOGICAL_ARITY 10
#endif

#ifndef HBOOST_PROTO_MAX_FUNCTION_CALL_ARITY
# define HBOOST_PROTO_MAX_FUNCTION_CALL_ARITY HBOOST_PROTO_MAX_ARITY
#endif

#if HBOOST_PROTO_MAX_ARITY < 3
# error HBOOST_PROTO_MAX_ARITY must be at least 3
#endif

#if HBOOST_PROTO_MAX_FUNCTION_CALL_ARITY > HBOOST_PROTO_MAX_ARITY
# error HBOOST_PROTO_MAX_FUNCTION_CALL_ARITY cannot be larger than HBOOST_PROTO_MAX_ARITY
#endif

#ifndef HBOOST_PROTO_DONT_USE_PREPROCESSED_FILES
  #if 10 < HBOOST_PROTO_MAX_ARITY ||                                                                 \
      10 < HBOOST_PROTO_MAX_LOGICAL_ARITY ||                                                         \
      10 < HBOOST_PROTO_MAX_FUNCTION_CALL_ARITY
    #define HBOOST_PROTO_DONT_USE_PREPROCESSED_FILES
  #endif
#endif

#ifndef HBOOST_PROTO_BROKEN_CONST_OVERLOADS
# if HBOOST_WORKAROUND(__GNUC__, == 3) \
  || HBOOST_WORKAROUND(__EDG_VERSION__, HBOOST_TESTED_AT(310))
#  define HBOOST_PROTO_BROKEN_CONST_OVERLOADS
# endif
#endif

#ifndef HBOOST_PROTO_BROKEN_CONST_QUALIFIED_FUNCTIONS
# if HBOOST_WORKAROUND(__GNUC__, == 3) \
  || HBOOST_WORKAROUND(__EDG_VERSION__, HBOOST_TESTED_AT(310))
#  define HBOOST_PROTO_BROKEN_CONST_QUALIFIED_FUNCTIONS
# endif
#endif

#ifdef HBOOST_PROTO_BROKEN_CONST_OVERLOADS
# include <hboost/utility/enable_if.hpp>
# include <hboost/type_traits/is_const.hpp>
# define HBOOST_PROTO_DISABLE_IF_IS_CONST(T)\
    , typename hboost::disable_if_c<hboost::is_const<T>::value, hboost::proto::detail::undefined>::type * = 0
#else
# define HBOOST_PROTO_DISABLE_IF_IS_CONST(T)
#endif

#ifdef HBOOST_PROTO_BROKEN_CONST_QUALIFIED_FUNCTIONS
# include <hboost/utility/enable_if.hpp>
# include <hboost/type_traits/is_function.hpp>
# define HBOOST_PROTO_DISABLE_IF_IS_FUNCTION(T)\
    , typename hboost::disable_if_c<hboost::is_function<T>::value, hboost::proto::detail::undefined>::type * = 0
#else
# define HBOOST_PROTO_DISABLE_IF_IS_FUNCTION(T)
#endif

#ifndef HBOOST_PROTO_BROKEN_PTS
# if HBOOST_WORKAROUND(HBOOST_MSVC, <= 1400)
#  define HBOOST_PROTO_BROKEN_PTS
# endif
#endif

#ifdef HBOOST_NO_CXX11_DECLTYPE_N3276
...
# ifndef HBOOST_PROTO_USE_NORMAL_RESULT_OF
#  define HBOOST_PROTO_USE_NORMAL_RESULT_OF
# endif
#endif

// Unless compiler support is there, use tr1_result_of instead of
// result_of to avoid the problems addressed by N3276.
#ifdef HBOOST_PROTO_USE_NORMAL_RESULT_OF
# define HBOOST_PROTO_RESULT_OF hboost::result_of
#else
# define HBOOST_PROTO_RESULT_OF hboost::tr1_result_of
#endif

// If we're using the decltype-based result_of, we need to be a bit
// stricter about the return types of some functions.
#if defined(HBOOST_RESULT_OF_USE_DECLTYPE) && defined(HBOOST_PROTO_USE_NORMAL_RESULT_OF)
# define HBOOST_PROTO_STRICT_RESULT_OF
# define HBOOST_PROTO_RETURN_TYPE_STRICT_LOOSE(X, Y) X
#else
# define HBOOST_PROTO_RETURN_TYPE_STRICT_LOOSE(X, Y) Y
#endif

#ifdef HBOOST_MPL_CFG_EXTENDED_TEMPLATE_PARAMETERS_MATCHING
# define HBOOST_PROTO_EXTENDED_TEMPLATE_PARAMETERS_MATCHING 
#endif

#if defined(_MSC_VER)
# define HBOOST_PROTO_DISABLE_MSVC_C4522 __pragma(warning(disable : 4522))  // 'class' : multiple assignment operators specified
# define HBOOST_PROTO_DISABLE_MSVC_C4714 __pragma(warning(disable : 4714))  // function 'xxx' marked as __forceinline not inlined
#else
# define HBOOST_PROTO_DISABLE_MSVC_C4522 
# define HBOOST_PROTO_DISABLE_MSVC_C4714
#endif
...
namespace hboost { namespace proto
{
    namespace detail
    {
        ...
        /// INTERNAL ONLY
        ///
        #define HBOOST_PROTO_UNCVREF(X)                                                              \
            typename hboost::proto::detail::uncvref<X>::type                                         \
            /**/
    ...
    namespace argsns_
    {
        ...
        #define M0(Z, N, DATA)                                                                      \
        template<HBOOST_PP_ENUM_PARAMS_Z(Z, N, typename Arg)> struct HBOOST_PP_CAT(list, N);          \
        /**/
        HBOOST_PP_REPEAT_FROM_TO(1, HBOOST_PP_INC(HBOOST_PROTO_MAX_ARITY), M0, ~)
        #undef M0
    }
    ...
    template<HBOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(HBOOST_PROTO_MAX_LOGICAL_ARITY, typename G, void)>
    struct or_;
    ...
    // Boost bug https://svn.boost.org/trac/hboost/ticket/4602
    //int const N = INT_MAX;
    ...
    template<typename Tag, HBOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(HBOOST_PROTO_MAX_ARITY, typename A, void)>
    struct nary_expr;
    ...
    template<HBOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(HBOOST_PROTO_MAX_ARITY, typename A, void)>
    struct function;
    ...
    #define HBOOST_PROTO_UNEXPR() typedef int proto_is_expr_;
    #define HBOOST_PROTO_CALLABLE() typedef void proto_is_callable_;
    #define HBOOST_PROTO_AGGREGATE() typedef void proto_is_aggregate_;
    #define HBOOST_PROTO_USE_BASIC_EXPR() typedef void proto_use_basic_expr_;
    ...
    #define M0(Z, N, DATA) typedef _child_c<N> HBOOST_PP_CAT(_child, N);
    HBOOST_PP_REPEAT_FROM_TO(
        2
      , HBOOST_PP_DEC(HBOOST_PROTO_MAX_ARITY)
      , M0
      , ~
    )
    #undef M0
