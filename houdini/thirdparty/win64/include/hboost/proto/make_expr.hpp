...
#ifndef HBOOST_PROTO_MAKE_EXPR_HPP_EAN_04_01_2005
#define HBOOST_PROTO_MAKE_EXPR_HPP_EAN_04_01_2005
...
#include <hboost/fusion/include/at_c.hpp>
#include <hboost/fusion/include/begin.hpp>
#include <hboost/fusion/include/next.hpp>
#include <hboost/fusion/include/value_of.hpp>
#include <hboost/fusion/include/size.hpp>
#include <hboost/proto/detail/poly_function.hpp>
#include <hboost/proto/detail/deprecated.hpp>
...
#define HBOOST_PROTO_AS_CHILD_TYPE(Z, N, DATA)                                                   \
    typename hboost::proto::detail::protoify<                                                    \
        HBOOST_PP_CAT(HBOOST_PP_TUPLE_ELEM(3, 0, DATA), N)                                        \
...
#define HBOOST_PROTO_AS_CHILD(Z, N, DATA)                                                        \
    hboost::proto::detail::protoify<                                                             \
        HBOOST_PP_CAT(HBOOST_PP_TUPLE_ELEM(3, 0, DATA), N)                                        \
      , HBOOST_PP_TUPLE_ELEM(3, 2, DATA)                                                         \
    >()(HBOOST_PP_CAT(HBOOST_PP_TUPLE_ELEM(3, 1, DATA), N))                                       \
    /**/
    ...
    namespace detail
    {
        ...
        template<typename T, typename Domain>
        struct protoify<hboost::reference_wrapper<T>, Domain>
          : Domain::template as_child<T>
        {};

        template<typename T, typename Domain>
        struct protoify<hboost::reference_wrapper<T> const, Domain>
          : Domain::template as_child<T>
        {};

        // Definition of detail::unpack_expr_
        #include <hboost/proto/detail/unpack_expr_.hpp>

        // Definition of detail::make_expr_
        #include <hboost/proto/detail/make_expr_.hpp>
    }
    ...
    namespace result_of
    {
        ...
        template<
            typename Tag
          , HBOOST_PP_ENUM_PARAMS(HBOOST_PROTO_MAX_ARITY, typename A)
          , typename Void1  // = void
          , typename Void2  // = void
        >
        struct make_expr
        {
            ...
            typedef
                typename detail::make_expr_<
                    Tag
                  , deduce_domain
                    HBOOST_PP_ENUM_TRAILING_PARAMS(HBOOST_PROTO_MAX_ARITY, A)
                >::result_type
            type;
        };
        ...
        template<
            typename Tag
          , typename Domain
            HBOOST_PP_ENUM_TRAILING_PARAMS(HBOOST_PROTO_MAX_ARITY, typename A)
        >
        struct make_expr<
            Tag
          , Domain
        ...
        >
        {
            ...
            /// typedef for <tt>hboost::result_of\<Domain(expr\<tag::terminal,
            /// term\<A0\> \>)\>::type</tt>.
            ///
            /// Otherwise, \c type is a typedef for <tt>hboost::result_of\<Domain(expr\<Tag,
            ...
            /// child type is \c A.
            /// \li If \c A is <tt>B &</tt> or <tt>cv hboost::reference_wrapper\<B\></tt>,
            /// and <tt>is_expr\<B\>::value</tt> is \c true, then the
            /// child type is <tt>B &</tt>.
            /// \li If <tt>is_expr\<A\>::value</tt> is \c false, then the
            /// child type is <tt>hboost::result_of\<Domain(expr\<tag::terminal, term\<A\> \>
            /// )\>::type</tt>.
            /// \li If \c A is <tt>B &</tt> or <tt>cv hboost::reference_wrapper\<B\></tt>,
            /// and <tt>is_expr\<B\>::value</tt> is \c false, then the
            /// child type is <tt>hboost::result_of\<Domain(expr\<tag::terminal, term\<B &\> \>
            /// )\>::type</tt>.
            typedef
                typename detail::make_expr_<
                    Tag
    ...
    namespace functional
    {
        ...
        struct make_expr
        {
            ...
            #include <hboost/proto/detail/make_expr_funop.hpp>
    ...
    /// \li If \c x is a <tt>hboost::reference_wrapper\<\></tt>,
    ...
    // Additional overloads generated by the preprocessor...
    #include <hboost/proto/detail/make_expr.hpp>
...
#endif // HBOOST_PROTO_MAKE_EXPR_HPP_EAN_04_01_2005
