...
#ifndef HBOOST_PROTO_TRANSFORM_MAKE_HPP_EAN_12_02_2007
#define HBOOST_PROTO_TRANSFORM_MAKE_HPP_EAN_12_02_2007
...
namespace hboost { namespace proto
{
    namespace detail
    {
        ...
        template<
          ...
          , typename Expr, typename State, typename Data
            HBOOST_PROTO_TEMPLATE_ARITY_PARAM(long Arity = detail::template_arity<R>::value)
        >
        struct make_
        {
            typedef R type;
        ...
        struct construct_
        {
            ...
            #include <hboost/proto/transform/detail/construct_funop.hpp>
        };
        ...
        struct construct_<Type, true>
        {
            ...
            // Other overloads generated by the preprocessor
            #include <hboost/proto/transform/detail/construct_pod_funop.hpp>
        };
    ...
    ///
    /// <tt>hboost::result_of\<make\<T\<X0,X1,...\> \>(Expr, State, Data)\>::type</tt>
    /// is evaluated as follows. For each \c X in <tt>X0,X1,...</tt>, do:
    ///
    /// \li If \c X is a template like <tt>U\<Y0,Y1,...\></tt>, then let <tt>X'</tt>
    ///     be <tt>hboost::result_of\<make\<U\<Y0,Y1,...\> \>(Expr, State, Data)\>::type</tt>
    ...
    ///     <tt>hboost::result_of\<when\<_, X\>(Expr, State, Data)\>::type</tt>.
    ...
    #include <hboost/proto/transform/detail/make.hpp>
    #include <hboost/proto/transform/detail/make_gcc_workaround.hpp>
