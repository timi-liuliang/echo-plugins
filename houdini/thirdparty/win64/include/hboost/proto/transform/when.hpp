...
#ifndef HBOOST_PROTO_TRANSFORM_WHEN_HPP_EAN_10_29_2007
#define HBOOST_PROTO_TRANSFORM_WHEN_HPP_EAN_10_29_2007
...
namespace hboost { namespace proto
{
    ...
    ///
    /// <tt>hboost::result_of\<when\<G,T\>(E,S,V)\>::type</tt> is the same as
    /// <tt>hboost::result_of\<T(E,S,V)\>::type</tt>.
    ///
    ...
    namespace envns_
    {
        ...
        HBOOST_PROTO_DEFINE_ENV_VAR(transforms_type, transforms);
    }
    ...
    /// \endcode
    template<HBOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(HBOOST_MPL_LIMIT_MAP_SIZE, typename T, mpl::na)>
    struct external_transforms
    {
        typedef mpl::map<HBOOST_PP_ENUM_PARAMS(HBOOST_MPL_LIMIT_MAP_SIZE, T)> map_type;
    ...
    #include <hboost/proto/transform/detail/when.hpp>
