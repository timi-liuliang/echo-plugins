...
#ifndef HBOOST_PROTO_TRANSFORM_CALL_HPP_EAN_11_02_2007
#define HBOOST_PROTO_TRANSFORM_CALL_HPP_EAN_11_02_2007
...
#include <hboost/proto/detail/as_lvalue.hpp>
#include <hboost/proto/detail/poly_function.hpp>
#include <hboost/proto/transform/detail/pack.hpp>
...
namespace hboost { namespace proto
{
    ...
    struct call<Fun()> : transform<call<Fun()> >
    {
        ...
        {
            typedef typename HBOOST_PROTO_RESULT_OF<Fun()>::type result_type;
        ...
        /// for <tt>hboost::result_of\<Fun()\>::type</tt>. Otherwise, it is
        /// a typedef for <tt>hboost::result_of\<Fun(Expr, State, Data)\>::type</tt>.
        template<typename Expr, typename State, typename Data>
        struct impl
    ...
    struct call<Fun(A0)> : transform<call<Fun(A0)> >
    {
        ...
        /// then \c type is a typedef for <tt>hboost::result_of\<Fun(X)\>::type</tt>.
        /// Otherwise, it is a typedef for <tt>hboost::result_of\<Fun(X, State, Data)\>::type</tt>.
    ...
    struct call<Fun(A0, A1)> : transform<call<Fun(A0, A1)> >
    {
          ...
          : transform_impl<Expr, State, Data>
        {
            ...
            /// <tt>hboost::result_of\<Fun(X, Y)\>::type</tt>. Otherwise, it is
            /// a typedef for <tt>hboost::result_of\<Fun(X, Y, Data)\>::type</tt>.
    ...
    #include <hboost/proto/transform/detail/call.hpp>
