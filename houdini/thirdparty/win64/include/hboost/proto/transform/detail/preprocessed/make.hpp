    ...
    namespace detail
    {
        ...
        struct make_<
            R<A0 , A1>
          , Expr, State, Data
            HBOOST_PROTO_TEMPLATE_ARITY_PARAM(2)
        >
          : nested_type_if<
    ...
    namespace detail
    {
        ...
        struct make_<
            R<A0 , A1 , A2>
          , Expr, State, Data
            HBOOST_PROTO_TEMPLATE_ARITY_PARAM(3)
        >
          : nested_type_if<
    ...
    namespace detail
    {
        ...
        struct make_<
            R<A0 , A1 , A2 , A3>
          , Expr, State, Data
            HBOOST_PROTO_TEMPLATE_ARITY_PARAM(4)
        >
          : nested_type_if<
    ...
    namespace detail
    {
        ...
        struct make_<
            R<A0 , A1 , A2 , A3 , A4>
          , Expr, State, Data
            HBOOST_PROTO_TEMPLATE_ARITY_PARAM(5)
        >
          : nested_type_if<
    ...
    namespace detail
    {
        ...
        struct make_<
            R<A0 , A1 , A2 , A3 , A4 , A5>
          , Expr, State, Data
            HBOOST_PROTO_TEMPLATE_ARITY_PARAM(6)
        >
          : nested_type_if<
    ...
    namespace detail
    {
        ...
        struct make_<
          ...
          , Expr, State, Data
            HBOOST_PROTO_TEMPLATE_ARITY_PARAM(7)
        >
          : nested_type_if<
    ...
    namespace detail
    {
        ...
        struct make_<
          ...
          , Expr, State, Data
            HBOOST_PROTO_TEMPLATE_ARITY_PARAM(8)
        >
          : nested_type_if<
    ...
    namespace detail
    {
        ...
        struct make_<
          ...
          , Expr, State, Data
            HBOOST_PROTO_TEMPLATE_ARITY_PARAM(9)
        >
          : nested_type_if<
    ...
    namespace detail
    {
        ...
        struct make_<
          ...
          , Expr, State, Data
            HBOOST_PROTO_TEMPLATE_ARITY_PARAM(10)
        >
          : nested_type_if<
