    ...
    #include <hboost/proto/transform/detail/preprocessed/construct_funop.hpp>
    ...
    #define HBOOST_PP_ITERATION_PARAMS_1                                                         \
        (3, (1, HBOOST_PROTO_MAX_ARITY, <hboost/proto/transform/detail/construct_funop.hpp>))
    ...
    {
        return Type(HBOOST_PP_ENUM_PARAMS(N, a));
    }
