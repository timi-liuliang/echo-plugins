    ...
    #include <hboost/proto/transform/detail/preprocessed/lazy.hpp>
    ...
    #define HBOOST_PP_ITERATION_PARAMS_1                                                             \
        (3, (0, HBOOST_PROTO_MAX_ARITY, <hboost/proto/transform/detail/lazy.hpp>))
    ...
    struct lazy<Object(HBOOST_PP_ENUM_PARAMS(N, A))>
      : transform<lazy<Object(HBOOST_PP_ENUM_PARAMS(N, A))> >
    {
