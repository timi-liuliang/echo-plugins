...
#ifndef HBOOST_PROTO_TRANSFORM_PASS_THROUGH_HPP_EAN_12_26_2006
#define HBOOST_PROTO_TRANSFORM_PASS_THROUGH_HPP_EAN_12_26_2006
...
#include <hboost/proto/detail/ignore_unused.hpp>
...
namespace hboost { namespace proto
{
    namespace detail
    {
        ...
        #include <hboost/proto/transform/detail/pass_through_impl.hpp>
          ...
          : transform_impl<Expr, State, Data>
        {
            ...
            /// \throw nothrow
            HBOOST_FORCEINLINE
            HBOOST_PROTO_RETURN_TYPE_STRICT_LOOSE(result_type, typename pass_through_impl::expr_param)
            operator()(
