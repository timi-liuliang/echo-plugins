...
#ifndef HBOOST_PROTO_DOMAIN_HPP_EAN_02_13_2007
#define HBOOST_PROTO_DOMAIN_HPP_EAN_02_13_2007

#include <hboost/ref.hpp>
#include <hboost/type_traits/is_same.hpp>
#include <hboost/proto/proto_fwd.hpp>
#include <hboost/proto/generate.hpp>
#include <hboost/proto/detail/as_expr.hpp>
#include <hboost/proto/detail/deduce_domain.hpp>
...
namespace hboost { namespace proto
{
    ...
    ///
    template<typename T>
    struct domain_of<hboost::reference_wrapper<T>, void>
    {
        typedef typename domain_of<T>::type type;
    };
    ...
    ///
    template<typename T>
    struct domain_of<hboost::reference_wrapper<T> const, void>
    {
        typedef typename domain_of<T>::type type;
    };
