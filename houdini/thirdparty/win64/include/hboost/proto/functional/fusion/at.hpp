...
#ifndef HBOOST_PROTO_FUNCTIONAL_FUSION_AT_HPP_EAN_11_27_2010
#define HBOOST_PROTO_FUNCTIONAL_FUSION_AT_HPP_EAN_11_27_2010
...
namespace hboost { namespace proto { namespace functional
{
    ...
    struct at
    {
        ...
        struct result<This(Seq, N)>
          : fusion::result_of::at<
                typename hboost::remove_reference<Seq>::type
              , typename hboost::remove_const<typename hboost::remove_reference<N>::type>::type
            >
        {};

        template<typename Seq, typename N>
        typename fusion::result_of::at<Seq, N>::type
        operator ()(Seq &seq, N const & HBOOST_PROTO_DISABLE_IF_IS_CONST(Seq)) const
        {
