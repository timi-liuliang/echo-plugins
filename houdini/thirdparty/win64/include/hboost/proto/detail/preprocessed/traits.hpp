    ...
    //  LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
        ...
        namespace detail
        {
            template<
              ...
              , typename A0
            >
            struct is_callable_<T<A0> HBOOST_PROTO_TEMPLATE_ARITY_PARAM(1)>
              : is_same<A0, callable>
            {};
        }
        namespace result_of
        ...
        namespace detail
        {
            ...
            >
            struct is_callable_<T<A0 , A1> HBOOST_PROTO_TEMPLATE_ARITY_PARAM(2)>
              : is_same<A1, callable>
            {};
        }
        namespace result_of
        ...
        namespace detail
        {
            ...
            >
            struct is_callable_<T<A0 , A1 , A2> HBOOST_PROTO_TEMPLATE_ARITY_PARAM(3)>
              : is_same<A2, callable>
            {};
        }
        namespace result_of
        ...
        namespace detail
        {
            ...
            >
            struct is_callable_<T<A0 , A1 , A2 , A3> HBOOST_PROTO_TEMPLATE_ARITY_PARAM(4)>
              : is_same<A3, callable>
            {};
        }
        namespace result_of
        ...
        namespace detail
        {
            ...
            >
            struct is_callable_<T<A0 , A1 , A2 , A3 , A4> HBOOST_PROTO_TEMPLATE_ARITY_PARAM(5)>
              : is_same<A4, callable>
            {};
        }
        namespace result_of
        ...
        namespace detail
        {
            ...
            >
            struct is_callable_<T<A0 , A1 , A2 , A3 , A4 , A5> HBOOST_PROTO_TEMPLATE_ARITY_PARAM(6)>
              : is_same<A5, callable>
            {};
        }
        namespace result_of
        ...
        namespace detail
        {
            ...
            >
            struct is_callable_<T<A0 , A1 , A2 , A3 , A4 , A5 , A6> HBOOST_PROTO_TEMPLATE_ARITY_PARAM(7)>
              : is_same<A6, callable>
            {};
        }
        namespace result_of
        ...
        namespace detail
        {
            ...
            >
            struct is_callable_<T<A0 , A1 , A2 , A3 , A4 , A5 , A6 , A7> HBOOST_PROTO_TEMPLATE_ARITY_PARAM(8)>
              : is_same<A7, callable>
            {};
        }
        namespace result_of
        ...
        namespace detail
        {
            ...
            >
            struct is_callable_<T<A0 , A1 , A2 , A3 , A4 , A5 , A6 , A7 , A8> HBOOST_PROTO_TEMPLATE_ARITY_PARAM(9)>
              : is_same<A8, callable>
            {};
        }
        namespace result_of
        ...
        namespace detail
        {
            ...
            >
            struct is_callable_<T<A0 , A1 , A2 , A3 , A4 , A5 , A6 , A7 , A8 , A9> HBOOST_PROTO_TEMPLATE_ARITY_PARAM(10)>
              : is_same<A9, callable>
            {};
        }
        namespace result_of
