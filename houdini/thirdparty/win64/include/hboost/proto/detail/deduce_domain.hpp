...
#ifndef HBOOST_PROTO_DEDUCE_DOMAIN_HPP_EAN_05_22_2010
#define HBOOST_PROTO_DEDUCE_DOMAIN_HPP_EAN_05_22_2010
...
#ifndef HBOOST_PROTO_ASSERT_VALID_DOMAIN
# define HBOOST_PROTO_ASSERT_VALID_DOMAIN(DOM) HBOOST_MPL_ASSERT_NOT((hboost::is_same<DOM, hboost::proto::detail::not_a_domain>))
#endif
...
namespace hboost
{
    namespace proto
    {
        namespace detail
        {
            ...
            #include <hboost/proto/detail/deduce_domain_n.hpp>
        }
    }
}

#endif // HBOOST_PROTO_DEDUCE_DOMAIN_HPP_EAN_05_22_2010
