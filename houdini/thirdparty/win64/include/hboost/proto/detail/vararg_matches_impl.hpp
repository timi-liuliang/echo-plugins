    ...
    #include <hboost/proto/detail/preprocessed/vararg_matches_impl.hpp>
    ...
    #define HBOOST_PP_ITERATION_PARAMS_1                                                             \
        (3, (2, HBOOST_PROTO_MAX_ARITY, <hboost/proto/detail/vararg_matches_impl.hpp>))
    ...
    struct vararg_matches_impl<Args, Back, N, To>
      : and_2<
            matches_<
                typename detail::expr_traits<typename Args::HBOOST_PP_CAT(child, HBOOST_PP_DEC(N))>::value_type::proto_derived_expr
              , typename detail::expr_traits<typename Args::HBOOST_PP_CAT(child, HBOOST_PP_DEC(N))>::value_type::proto_grammar
              , Back
            >::value
