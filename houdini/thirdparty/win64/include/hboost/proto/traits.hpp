...
#ifndef HBOOST_PROTO_ARG_TRAITS_HPP_EAN_04_01_2005
#define HBOOST_PROTO_ARG_TRAITS_HPP_EAN_04_01_2005
...
#include <hboost/proto/detail/template_arity.hpp>
...
namespace hboost { namespace proto
{
    namespace detail
    {
        ...
        template<typename T HBOOST_PROTO_TEMPLATE_ARITY_PARAM(long Arity = hboost::proto::detail::template_arity<T>::value)>
        struct is_callable_
          : is_callable2_<T>
        {};
    ...
    #if HBOOST_WORKAROUND(__GNUC__, == 3) || (HBOOST_WORKAROUND(__GNUC__, == 4) && __GNUC_MINOR__ == 0)
    // work around GCC bug
    ...
    /// <tt>HBOOST_PROTO_BASIC_EXTENDS()</tt> macro.) Otherwise,
      ...
      : proto::transform<terminal<T>, int>
    {
        ...
        struct impl : transform_impl<Expr, State, Data>
        {
            ...
            /// \throw nothrow
            HBOOST_FORCEINLINE
            HBOOST_PROTO_RETURN_TYPE_STRICT_LOOSE(result_type, typename impl::expr_param)
            operator ()(
...
#define HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(Op)                                               \
    template<typename T>                                                                        \
    struct Op                                                                                   \
...
#define HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(Op)                                              \
    ...
    HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(unary_plus)
    HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(negate)
    HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(dereference)
    HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(complement)
    HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(address_of)
    HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(logical_not)
    HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(pre_inc)
    HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(pre_dec)
    HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(post_inc)
    HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(post_dec)

    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_left)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_right)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(multiplies)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(divides)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(modulus)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(plus)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(minus)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(less)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(greater)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(less_equal)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(greater_equal)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(equal_to)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(not_equal_to)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(logical_or)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(logical_and)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_or)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_and)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_xor)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(comma)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(mem_ptr)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(assign)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_left_assign)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_right_assign)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(multiplies_assign)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(divides_assign)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(modulus_assign)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(plus_assign)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(minus_assign)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_or_assign)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_and_assign)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_xor_assign)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(subscript)
    HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(member)

    #undef HBOOST_PROTO_DEFINE_UNARY_METAFUNCTION
    #undef HBOOST_PROTO_DEFINE_BINARY_METAFUNCTION

    #include <hboost/proto/detail/traits.hpp>
    ...
    as_expr(T &t HBOOST_PROTO_DISABLE_IF_IS_CONST(T) HBOOST_PROTO_DISABLE_IF_IS_FUNCTION(T))
    {
    ...
    as_child(T &t HBOOST_PROTO_DISABLE_IF_IS_CONST(T) HBOOST_PROTO_DISABLE_IF_IS_FUNCTION(T))
    {
    ...
    HBOOST_FORCEINLINE
    typename result_of::child<Expr &, N>::type
    child(Expr &e HBOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
    {
        return result_of::child<Expr &, N>::call(e);
    }
    ...
    child(Expr2 &expr2 HBOOST_PROTO_DISABLE_IF_IS_CONST(Expr2))
    {
    ...
    HBOOST_FORCEINLINE
    typename result_of::child_c<Expr &, N>::type
    child_c(Expr &e HBOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
    {
        return result_of::child_c<Expr &, N>::call(e);
    }
    ...
    HBOOST_FORCEINLINE
    typename result_of::value<Expr &>::type
    value(Expr &e HBOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
    {
        return e.proto_base().child0;
    }
    ...
    HBOOST_FORCEINLINE
    typename result_of::left<Expr &>::type
    left(Expr &e HBOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
    {
        return e.proto_base().child0;
    }
    ...
    HBOOST_FORCEINLINE
    typename result_of::right<Expr &>::type
    right(Expr &e HBOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
    {
        return e.proto_base().child1;
    }
