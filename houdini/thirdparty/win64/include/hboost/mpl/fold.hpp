...
#ifndef HBOOST_MPL_FOLD_HPP_INCLUDED
#define HBOOST_MPL_FOLD_HPP_INCLUDED
...
#include <hboost/mpl/aux_/fold_impl.hpp>
...
struct fold
{
    ...
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(3,fold,(Sequence,State,ForwardOp))
};

HBOOST_MPL_AUX_NA_SPEC(3, fold)

}}

#endif // HBOOST_MPL_FOLD_HPP_INCLUDED
