...
#ifndef HBOOST_MPL_MAP_AUX_AT_IMPL_HPP_INCLUDED
#define HBOOST_MPL_MAP_AUX_AT_IMPL_HPP_INCLUDED
...
struct m_at
{
    ...
    typedef __typeof__( HBOOST_MPL_AUX_OVERLOAD_CALL_VALUE_BY_KEY(
          Map
        , HBOOST_MPL_AUX_STATIC_CAST(key_*, 0)
        ) ) type;
};
...
{
    typedef __typeof__( HBOOST_MPL_AUX_OVERLOAD_CALL_ITEM_BY_ORDER(
          Map 
        , HBOOST_MPL_AUX_STATIC_CAST(long_<order>*, 0)
        ) ) type;
};
...
#endif // HBOOST_MPL_SET_AUX_AT_IMPL_HPP_INCLUDED
