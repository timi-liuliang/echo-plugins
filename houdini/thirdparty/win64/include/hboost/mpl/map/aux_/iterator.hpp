...
#ifndef HBOOST_MPL_MAP_AUX_ITERATOR_HPP_INCLUDED
#define HBOOST_MPL_MAP_AUX_ITERATOR_HPP_INCLUDED
...
template< 
      typename Map
    , HBOOST_MPL_AUX_NTTP_DECL(long, order)
    , HBOOST_MPL_AUX_NTTP_DECL(long, max_order)
    >
struct next_order;
...
#endif // HBOOST_MPL_MAP_AUX_ITERATOR_HPP_INCLUDED
