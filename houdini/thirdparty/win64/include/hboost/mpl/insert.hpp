...
#ifndef HBOOST_MPL_INSERT_HPP_INCLUDED
#define HBOOST_MPL_INSERT_HPP_INCLUDED
...
#include <hboost/mpl/aux_/insert_impl.hpp>
...
template<
    ...
    , typename HBOOST_MPL_AUX_NA_PARAM(Pos_or_T)
...
{
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(3,insert,(Sequence,Pos_or_T,T))
};

HBOOST_MPL_AUX_NA_SPEC(3, insert)

}}

#endif // HBOOST_MPL_INSERT_HPP_INCLUDED
