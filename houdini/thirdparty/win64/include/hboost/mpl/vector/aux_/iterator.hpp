...
#ifndef HBOOST_MPL_AUX_VECTOR_ITERATOR_HPP_INCLUDED
#define HBOOST_MPL_AUX_VECTOR_ITERATOR_HPP_INCLUDED
...
template<
      typename Vector
    , HBOOST_MPL_AUX_NTTP_DECL(long, n_)
    >
struct v_iter
{
...
struct advance< v_iter<Vector,n_>,Distance>
{
    typedef v_iter<
          Vector
        , (n_ + HBOOST_MPL_AUX_NESTED_VALUE_WKND(long, Distance))
        > type;
};
...
template< 
      typename Vector
    , HBOOST_MPL_AUX_NTTP_DECL(long, n_)
    , HBOOST_MPL_AUX_NTTP_DECL(long, m_)
    > 
...
template<> struct distance_impl<aux::v_iter_tag>
{
    template< typename Iter1, typename Iter2 > struct apply
    {
        ...
        HBOOST_STATIC_CONSTANT(long, value = ( pos2_ - pos1_ ));
    };
};
...
#endif // HBOOST_MPL_AUX_VECTOR_ITERATOR_HPP_INCLUDED
