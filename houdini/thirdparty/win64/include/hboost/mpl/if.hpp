...
#ifndef HBOOST_MPL_IF_HPP_INCLUDED
#define HBOOST_MPL_IF_HPP_INCLUDED
...
template<
    ...
    , typename HBOOST_MPL_AUX_NA_PARAM(T3)
    >
struct if_
{
 private:
    ...
    typedef if_c<
          ...
          HBOOST_MPL_AUX_VALUE_WKND(T1)::value
#else
          HBOOST_MPL_AUX_STATIC_CAST(bool, HBOOST_MPL_AUX_VALUE_WKND(T1)::value)
#endif
        , T2
        , T3
        > almost_type_;
 ...
 public:
    ...
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(3,if_,(T1,T2,T3))
};
...
template<
      typename HBOOST_MPL_AUX_NA_PARAM(C_)
    , typename HBOOST_MPL_AUX_NA_PARAM(T1)
    , typename HBOOST_MPL_AUX_NA_PARAM(T2)
    >
struct if_
{
    enum { msvc_wknd_ = HBOOST_MPL_AUX_MSVC_VALUE_WKND(C_)::value };

    typedef typename aux::if_impl< HBOOST_MPL_AUX_STATIC_CAST(bool, msvc_wknd_) >
        ::template result_<T1,T2>::type type;

    HBOOST_MPL_AUX_LAMBDA_SUPPORT(3,if_,(C_,T1,T2))
};

#endif // HBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION

HBOOST_MPL_AUX_NA_SPEC(3, if_)

}}

#endif // HBOOST_MPL_IF_HPP_INCLUDED
