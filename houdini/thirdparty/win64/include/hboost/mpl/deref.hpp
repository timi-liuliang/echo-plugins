...
#ifndef HBOOST_MPL_DEREF_HPP_INCLUDED
#define HBOOST_MPL_DEREF_HPP_INCLUDED
...
#include <hboost/mpl/aux_/msvc_type.hpp>
...
#endif
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(1,deref,(Iterator))
};

HBOOST_MPL_AUX_NA_SPEC(1, deref)

}}

#endif // HBOOST_MPL_DEREF_HPP_INCLUDED
