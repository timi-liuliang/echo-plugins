...
#ifndef HBOOST_MPL_ZIP_VIEW_HPP_INCLUDED
#define HBOOST_MPL_ZIP_VIEW_HPP_INCLUDED
...
template<
      typename HBOOST_MPL_AUX_NA_PARAM(Sequences)
    >
struct zip_view
{
 private:
...
HBOOST_MPL_AUX_NA_SPEC(1, zip_view)

}}

#endif // HBOOST_MPL_ZIP_VIEW_HPP_INCLUDED
