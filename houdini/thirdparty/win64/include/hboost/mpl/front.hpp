...
#ifndef HBOOST_MPL_FRONT_HPP_INCLUDED
#define HBOOST_MPL_FRONT_HPP_INCLUDED
...
#include <hboost/mpl/aux_/front_impl.hpp>
...
{
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(1,front,(Sequence))
};

HBOOST_MPL_AUX_NA_SPEC(1, front)

}}

#endif // HBOOST_MPL_FRONT_HPP_INCLUDED
