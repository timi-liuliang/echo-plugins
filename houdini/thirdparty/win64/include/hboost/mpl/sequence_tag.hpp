...
#ifndef HBOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
#define HBOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
...
struct sequence_tag
    : aux::sequence_tag_impl<
          ::hboost::mpl::aux::has_tag<Sequence>::value
        , ::hboost::mpl::aux::has_begin<Sequence>::value
...
HBOOST_MPL_AUX_NA_SPEC(1, sequence_tag)

}}

#endif // HBOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
