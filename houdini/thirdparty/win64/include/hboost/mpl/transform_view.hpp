...
#ifndef HBOOST_MPL_TRANSFORM_VIEW_HPP_INCLUDED
#define HBOOST_MPL_TRANSFORM_VIEW_HPP_INCLUDED
...
#include <hboost/mpl/aux_/transform_iter.hpp>
...
template<
    ...
    , typename HBOOST_MPL_AUX_NA_PARAM(F)
    >
...
HBOOST_MPL_AUX_NA_SPEC(2, transform_view)

}}

#endif // HBOOST_MPL_TRANSFORM_VIEW_HPP_INCLUDED
