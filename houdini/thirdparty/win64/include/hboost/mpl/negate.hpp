...
#ifndef HBOOST_MPL_NEGATE_HPP_INCLUDED
#define HBOOST_MPL_NEGATE_HPP_INCLUDED
...
#endif
{
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(1, negate, (N))
};

HBOOST_MPL_AUX_NA_SPEC(1, negate)
...
{
    HBOOST_STATIC_CONSTANT(T, value = -n);
...
#endif // HBOOST_MPL_NEGATE_HPP_INCLUDED
