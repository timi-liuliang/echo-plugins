...
#ifndef HBOOST_MPL_ITER_FOLD_IF_HPP_INCLUDED
#define HBOOST_MPL_ITER_FOLD_IF_HPP_INCLUDED
...
template<
    ...
    , typename HBOOST_MPL_AUX_NA_PARAM(ForwardPredicate)
    , typename HBOOST_MPL_AUX_NA_PARAM(BackwardOp)
    , typename HBOOST_MPL_AUX_NA_PARAM(BackwardPredicate)
    >
struct iter_fold_if
{
...
#if !HBOOST_WORKAROUND(__MWERKS__, HBOOST_TESTED_AT(0x3003)) && !HBOOST_WORKAROUND(__IBMCPP__, HBOOST_TESTED_AT(600))
    struct result_ :
#else
    typedef
#endif
...
HBOOST_MPL_AUX_NA_SPEC(6, iter_fold_if)

}}

#endif // HBOOST_MPL_ITER_FOLD_IF_HPP_INCLUDED
