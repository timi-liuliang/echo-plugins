...
#ifndef HBOOST_MPL_JOINT_VIEW_HPP_INCLUDED
#define HBOOST_MPL_JOINT_VIEW_HPP_INCLUDED
...
#include <hboost/mpl/aux_/joint_iter.hpp>
...
template<
      typename HBOOST_MPL_AUX_NA_PARAM(Sequence1_)
    , typename HBOOST_MPL_AUX_NA_PARAM(Sequence2_)
    >
struct joint_view
{
...
HBOOST_MPL_AUX_NA_SPEC(2, joint_view)

}}

#endif // HBOOST_MPL_JOINT_VIEW_HPP_INCLUDED
