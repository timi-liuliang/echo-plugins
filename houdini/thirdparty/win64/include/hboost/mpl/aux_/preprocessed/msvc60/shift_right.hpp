...
// Preprocessed version of "hboost/mpl/shift_right.hpp" header
...
{
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(2, shift_right, (N1, N2))

};

HBOOST_MPL_AUX_NA_SPEC2(2, 2, shift_right)
...
{
    HBOOST_STATIC_CONSTANT(T, value  = (n >> s));
