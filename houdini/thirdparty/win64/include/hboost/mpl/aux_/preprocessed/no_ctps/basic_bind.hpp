...
// Preprocessed version of "hboost/mpl/aux_/basic_bind.hpp" header
...
HBOOST_MPL_AUX_ARITY_SPEC(1, bind0)
HBOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(1, bind0)
...
HBOOST_MPL_AUX_ARITY_SPEC(2, bind1)
HBOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(2, bind1)
...
HBOOST_MPL_AUX_ARITY_SPEC(3, bind2)
HBOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(3, bind2)
...
HBOOST_MPL_AUX_ARITY_SPEC(4, bind3)
HBOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(4, bind3)
...
HBOOST_MPL_AUX_ARITY_SPEC(5, bind4)
HBOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(5, bind4)
...
HBOOST_MPL_AUX_ARITY_SPEC(6, bind5)
HBOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(6, bind5)
