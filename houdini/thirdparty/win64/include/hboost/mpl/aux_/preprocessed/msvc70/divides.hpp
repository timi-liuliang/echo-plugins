...
// Preprocessed version of "hboost/mpl/divides.hpp" header
...
{
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(2, divides2, (N1, N2))

};

HBOOST_MPL_AUX_NA_SPEC2(2, 5, divides)
...
struct divides_wknd
{
    HBOOST_STATIC_CONSTANT(T, value  = (n1 / n2));
