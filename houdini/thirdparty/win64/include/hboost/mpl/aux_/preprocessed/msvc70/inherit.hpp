...
// Preprocessed version of "hboost/mpl/inherit.hpp" header
...
HBOOST_MPL_AUX_NA_SPEC(3, inherit3)
...
HBOOST_MPL_AUX_NA_SPEC(4, inherit4)
...
HBOOST_MPL_AUX_NA_SPEC(5, inherit5)
...
HBOOST_MPL_AUX_NA_SPEC_LAMBDA(5, inherit)
HBOOST_MPL_AUX_NA_SPEC_ARITY(5, inherit)
HBOOST_MPL_AUX_NA_SPEC_TEMPLATE_ARITY(5, 5, inherit)
}}
