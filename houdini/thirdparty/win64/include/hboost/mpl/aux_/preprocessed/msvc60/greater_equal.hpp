...
// Preprocessed version of "hboost/mpl/greater_equal.hpp" header
...
{
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(2, greater_equal, (N1, N2))

};

HBOOST_MPL_AUX_NA_SPEC2(2, 2, greater_equal)
