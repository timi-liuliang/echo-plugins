...
#   define AUX778076_COUNT_ARGS_REPEAT HBOOST_MPL_PP_REPEAT
...
#   define AUX778076_COUNT_ARGS_REPEAT HBOOST_PP_REPEAT
#   define AUX778076_COUNT_ARGS_PARAMS(param) \
    HBOOST_PP_ENUM_SHIFTED_PARAMS( \
          HBOOST_PP_INC(AUX778076_COUNT_ARGS_ARITY) \
        , param \
        ) \
    /**/
...
#define AUX778076_IS_ARG_TEMPLATE_NAME \
    HBOOST_PP_CAT(is_,HBOOST_PP_CAT(AUX778076_COUNT_ARGS_PREFIX,_arg)) \
/**/

#define AUX778076_COUNT_ARGS_FUNC(unused, i, param) \
    HBOOST_PP_EXPR_IF(i, +) \
    AUX778076_IS_ARG_TEMPLATE_NAME<HBOOST_PP_CAT(param,HBOOST_PP_INC(i))>::value \
/**/
...
template<
    ...
    >
struct HBOOST_PP_CAT(AUX778076_COUNT_ARGS_PREFIX,_count_args)
{
    HBOOST_STATIC_CONSTANT(int, value = AUX778076_COUNT_ARGS_REPEAT(
          AUX778076_COUNT_ARGS_ARITY
