...
#ifndef HBOOST_MPL_AUX_SINGLE_ELEMENT_ITER_HPP_INCLUDED
#define HBOOST_MPL_AUX_SINGLE_ELEMENT_ITER_HPP_INCLUDED
...
template< typename T, HBOOST_MPL_AUX_NTTP_DECL(int, is_last_) >
struct sel_iter;
...
template< typename T, HBOOST_MPL_AUX_NTTP_DECL(int, is_last_), typename Distance >
struct advance< aux::sel_iter<T,is_last_>,Distance>
{
    typedef aux::sel_iter<
          T
        , ( is_last_ + HBOOST_MPL_AUX_NESTED_VALUE_WKND(int, Distance) )
        > type;
};

template< 
      typename T
    , HBOOST_MPL_AUX_NTTP_DECL(int, l1)
    , HBOOST_MPL_AUX_NTTP_DECL(int, l2) 
    >
...
template<> struct distance_impl<aux::sel_iter_tag>
{
    template< typename Iter1, typename Iter2 > struct apply
    {
        ...
        HBOOST_STATIC_CONSTANT(int, value = ( pos2_ - pos1_ ));
    };
};
...
#endif // HBOOST_MPL_AUX_SINGLE_ELEMENT_ITER_HPP_INCLUDED
