...
#ifndef HBOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
#define HBOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
...
struct push_back_impl
{
    template< typename Sequence, typename T > struct apply
    {
        ...
        HBOOST_MPL_ASSERT_MSG(
              ( hboost::is_same< T, has_push_back_arg >::value )
...
HBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(2, push_back_impl)
HBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(1, has_push_back_impl)

}}

#endif // HBOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
