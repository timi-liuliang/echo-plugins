...
#ifndef HBOOST_MPL_AUX_CONFIG_DTP_HPP_INCLUDED
#define HBOOST_MPL_AUX_CONFIG_DTP_HPP_INCLUDED
...
// able to compile a definition of nested class template with DTP
    ...
    && HBOOST_WORKAROUND(__BORLANDC__, >= 0x560) \
    && HBOOST_WORKAROUND(__BORLANDC__, HBOOST_TESTED_AT(0x610))

#   define HBOOST_MPL_CFG_NO_DEFAULT_PARAMETERS_IN_NESTED_TEMPLATES
    ...
    && (   HBOOST_WORKAROUND(__MWERKS__, <= 0x3001) \
        || HBOOST_WORKAROUND(__BORLANDC__, HBOOST_TESTED_AT(0x610)) \
        || defined(HBOOST_MPL_CFG_NO_DEFAULT_PARAMETERS_IN_NESTED_TEMPLATES) \
        )
        
#   define HBOOST_MPL_CFG_BROKEN_DEFAULT_PARAMETERS_IN_NESTED_TEMPLATES

#endif

#endif // HBOOST_MPL_AUX_CONFIG_DTP_HPP_INCLUDED
