...
#ifndef HBOOST_MPL_AUX_PUSH_FRONT_IMPL_HPP_INCLUDED
#define HBOOST_MPL_AUX_PUSH_FRONT_IMPL_HPP_INCLUDED
...
struct push_front_impl
{
    template< typename Sequence, typename T > struct apply
    {
        ...
        HBOOST_MPL_ASSERT_MSG(
              ( hboost::is_same< T, has_push_front_arg >::value )
...
HBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(2, push_front_impl)
HBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(1, has_push_front_impl)

}}

#endif // HBOOST_MPL_AUX_PUSH_FRONT_IMPL_HPP_INCLUDED
