...
#ifndef HBOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
#define HBOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
...
#   define HBOOST_MPL_PREPROCESSED_HEADER advance_forward.hpp
...
// forward declaration
template< HBOOST_MPL_AUX_NTTP_DECL(long, N) > struct advance_forward;

#   define HBOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, HBOOST_MPL_LIMIT_UNROLLING, <hboost/mpl/aux_/advance_forward.hpp>))
...
struct advance_forward
{
    template< typename Iterator > struct apply
    {
        typedef typename apply_wrap1<
              advance_forward<HBOOST_MPL_LIMIT_UNROLLING>
            , Iterator
            >::type chunk_result_;
...
#endif // HBOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
...
template<>
struct advance_forward< HBOOST_PP_FRAME_ITERATION(1) >
{
    template< typename Iterator > struct apply
    {
...
#   define HBOOST_PP_ITERATION_PARAMS_2 \
    (3,(1, i_, <hboost/mpl/aux_/advance_forward.hpp>))
#   include HBOOST_PP_ITERATE()
#endif
        typedef HBOOST_PP_CAT(iter,i_) type;
    };
