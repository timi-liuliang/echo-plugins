...
#ifndef HBOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
#define HBOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
...
#include <hboost/mpl/aux_/is_msvc_eti_arg.hpp>
...
#else // !HBOOST_MPL_CFG_MSVC_70_ETI_BUG

template< typename T > struct msvc_eti_base
    : T
{
#if HBOOST_WORKAROUND(HBOOST_MPL_CFG_GCC, HBOOST_TESTED_AT(0x0304))
    msvc_eti_base();
#endif
    typedef T type;
};
...
#endif // HBOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
