...
#ifndef HBOOST_MPL_TRANSFORM_HPP_INCLUDED
#define HBOOST_MPL_TRANSFORM_HPP_INCLUDED
...
#include <hboost/mpl/pair_view.hpp>
...
HBOOST_MPL_AUX_INSERTER_ALGORITHM_DEF(3, transform1)                    
HBOOST_MPL_AUX_INSERTER_ALGORITHM_DEF(4, transform2)
    
#define AUX778076_TRANSFORM_DEF(name)                                   \
template<                                                               \
      typename HBOOST_MPL_AUX_NA_PARAM(Seq1)                             \
    , typename HBOOST_MPL_AUX_NA_PARAM(Seq2OrOperation)                  \
    , typename HBOOST_MPL_AUX_NA_PARAM(OperationOrInserter)              \
    , typename HBOOST_MPL_AUX_NA_PARAM(Inserter)                         \
    >                                                                   \
struct name                                                             \
{                                                                       \
...
#endif // HBOOST_MPL_TRANSFORM_HPP_INCLUDED
