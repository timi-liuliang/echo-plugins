...
#ifndef HBOOST_FILESYSTEM_PATH_TRAITS_HPP
#define HBOOST_FILESYSTEM_PATH_TRAITS_HPP
...
namespace hboost { namespace filesystem {

  HBOOST_FILESYSTEM_DECL const system::error_category& codecvt_error_category();
...
namespace path_traits {
  ...
  template <class Container> inline
    ...
    typename hboost::disable_if<hboost::is_array<Container>, bool>::type
  ...
  template <class Container, class U> inline
    ...
    typename hboost::disable_if<hboost::is_array<Container>, void>::type
...
}}} // namespace hboost::filesystem::path_traits

#include <hboost/config/abi_suffix.hpp> // pops abi_prefix.hpp pragmas

#endif  // HBOOST_FILESYSTEM_PATH_TRAITS_HPP
