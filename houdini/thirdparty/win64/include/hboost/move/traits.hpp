...
#ifndef HBOOST_MOVE_TRAITS_HPP
#define HBOOST_MOVE_TRAITS_HPP
...
struct has_trivial_destructor_after_move
   : ::hboost::move_detail::is_trivially_destructible<T>
{};

//! By default this traits returns
//! <pre>hboost::is_nothrow_move_constructible<T>::value && hboost::is_nothrow_move_assignable<T>::value </pre>.
//! Classes with non-throwing move constructor
//! and assignment can specialize this trait to obtain some performance improvements.
template <class T>
struct has_nothrow_move
{
   static const bool value = hboost::move_detail::is_nothrow_move_constructible<T>::value &&
                             hboost::move_detail::is_nothrow_move_assignable<T>::value;
};
...
#endif //#ifndef HBOOST_MOVE_TRAITS_HPP
