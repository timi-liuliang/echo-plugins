...
#ifndef HBOOST_BIMAP_CONTAINER_ADAPTOR_DETAIL_COMPARISON_ADAPTOR_HPP
#define HBOOST_BIMAP_CONTAINER_ADAPTOR_DETAIL_COMPARISON_ADAPTOR_HPP
...
struct comparison_adaptor : std::binary_function<NewType,NewType,bool>
{
    ...
    bool operator()( HBOOST_DEDUCED_TYPENAME call_traits<NewType>::param_type x,
                     HBOOST_DEDUCED_TYPENAME call_traits<NewType>::param_type y) const
    {
...
struct unary_check_adaptor : std::unary_function<NewType,bool>
{
    ...
    bool operator()( HBOOST_DEDUCED_TYPENAME call_traits<NewType>::param_type x) const
    {
...
#endif // HBOOST_BIMAP_CONTAINER_ADAPTOR_DETAIL_COMPARISON_ADAPTOR_HPP
