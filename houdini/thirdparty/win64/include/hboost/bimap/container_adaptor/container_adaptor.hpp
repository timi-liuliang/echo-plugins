...
#ifndef HBOOST_BIMAP_CONTAINER_ADAPTOR_CONTAINER_ADAPTOR_HPP
#define HBOOST_BIMAP_CONTAINER_ADAPTOR_CONTAINER_ADAPTOR_HPP
...
#include <hboost/bimap/container_adaptor/detail/identity_converters.hpp>
#include <hboost/iterator/iterator_traits.hpp>

#include <hboost/bimap/container_adaptor/detail/functor_bag.hpp>
#include <hboost/mpl/vector.hpp>
#include <hboost/mpl/copy.hpp>
...
class container_adaptor
{
    ...
    typedef HBOOST_DEDUCED_TYPENAME iterator_value    <       iterator >::type value_type;
    typedef HBOOST_DEDUCED_TYPENAME iterator_pointer  <       iterator >::type pointer;
    typedef HBOOST_DEDUCED_TYPENAME iterator_reference<       iterator >::type reference;
    typedef HBOOST_DEDUCED_TYPENAME iterator_reference< const_iterator >::type const_reference;

    typedef HBOOST_DEDUCED_TYPENAME Base::size_type size_type;
    typedef HBOOST_DEDUCED_TYPENAME Base::difference_type difference_type;

    typedef HBOOST_DEDUCED_TYPENAME mpl::if_< ::hboost::mpl::is_na<IteratorToBaseConverter>,
        // {
                ::hboost::bimaps::container_adaptor::detail::
                    iterator_to_base_identity
                <
                    HBOOST_DEDUCED_TYPENAME Base::iterator                , iterator,
                    HBOOST_DEDUCED_TYPENAME Base::const_iterator          , const_iterator
                >,
        // }
        // else
        // {
    ...
    typedef HBOOST_DEDUCED_TYPENAME mpl::if_< ::hboost::mpl::is_na<IteratorFromBaseConverter>,
        // {
                ::hboost::bimaps::container_adaptor::detail::
    ...
    typedef HBOOST_DEDUCED_TYPENAME mpl::if_< ::hboost::mpl::is_na<ValueToBaseConverter>,
        // {
                ::hboost::bimaps::container_adaptor::detail::
                    value_to_base_identity
                <
                    HBOOST_DEDUCED_TYPENAME Base::value_type,
                    value_type
                >,
        // }
        // else
    ...
    typedef HBOOST_DEDUCED_TYPENAME mpl::if_< ::hboost::mpl::is_na<ValueFromBaseConverter>,
        // {
                ::hboost::bimaps::container_adaptor::detail::
    ...
    std::pair<iterator, bool> insert(
        HBOOST_DEDUCED_TYPENAME ::hboost::call_traits< value_type >::param_type x)
    {
        std::pair< HBOOST_DEDUCED_TYPENAME Base::iterator, bool > r(
    ...
    ::hboost::bimaps::container_adaptor::detail::data_with_functor_bag
    <
        Base &,

        HBOOST_DEDUCED_TYPENAME mpl::copy
        <
            mpl::vector
            <
                iterator_to_base,
...
#endif // HBOOST_BIMAP_CONTAINER_ADAPTOR_CONTAINER_ADAPTOR_HPP
