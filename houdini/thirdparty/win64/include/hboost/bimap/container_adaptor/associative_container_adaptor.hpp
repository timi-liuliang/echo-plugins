...
#ifndef HBOOST_BIMAP_CONTAINER_ADAPTOR_ASSOCIATIVE_CONTAINER_ADAPTOR_HPP
#define HBOOST_BIMAP_CONTAINER_ADAPTOR_ASSOCIATIVE_CONTAINER_ADAPTOR_HPP
...
#include <hboost/bimap/container_adaptor/container_adaptor.hpp>
...
struct associative_container_adaptor_base
{
    ...
    <
        ...
        HBOOST_DEDUCED_TYPENAME mpl::push_front<
            ...
            HBOOST_DEDUCED_TYPENAME mpl::if_< ::hboost::mpl::is_na<KeyToBaseConverter>,
            // {
                    detail::key_to_base_identity
                    <
                        HBOOST_DEDUCED_TYPENAME Base::key_type, KeyType
                    >,
            // }
            // else
            // {
    ...
    >::type
{
    ...
    typedef HBOOST_DEDUCED_TYPENAME mpl::if_< ::hboost::mpl::is_na<KeyToBaseConverter>,
    // {
            detail::key_to_base_identity
            <
                HBOOST_DEDUCED_TYPENAME Base::key_type, KeyType
    ...
    HBOOST_DEDUCED_TYPENAME base_::size_type erase(const CompatibleKey & k)
    {
    ...
    HBOOST_DEDUCED_TYPENAME base_::iterator erase(
        HBOOST_DEDUCED_TYPENAME base_::iterator pos)
    {
        return base_::container_adaptor_::erase(pos);
    }

    HBOOST_DEDUCED_TYPENAME base_::iterator erase(
        HBOOST_DEDUCED_TYPENAME base_::iterator first,
        HBOOST_DEDUCED_TYPENAME base_::iterator last)
    {
        return base_::container_adaptor_::erase(first,last);
    }

    template< class CompatibleKey >
    HBOOST_DEDUCED_TYPENAME base_::size_type count(const CompatibleKey & k) const
    {
    ...
    template< class CompatibleKey >
    HBOOST_DEDUCED_TYPENAME base_::iterator find(const CompatibleKey & k)
    {
        ...
        equal_range(const CompatibleKey & k) const
    {
        std::pair<
            ...
            HBOOST_DEDUCED_TYPENAME Base::const_iterator,
            HBOOST_DEDUCED_TYPENAME Base::const_iterator
...
#endif // HBOOST_BIMAP_CONTAINER_ADAPTOR_ASSOCIATIVE_CONTAINER_ADAPTOR_HPP
