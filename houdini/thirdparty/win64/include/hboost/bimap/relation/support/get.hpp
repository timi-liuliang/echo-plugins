...
#ifndef HBOOST_BIMAP_RELATION_SUPPORT_GET_HPP
#define HBOOST_BIMAP_RELATION_SUPPORT_GET_HPP
...
#include <hboost/bimap/relation/support/value_type_of.hpp>

#include <hboost/bimap/relation/detail/access_builder.hpp>

#include <hboost/mpl/if.hpp>
#include <hboost/type_traits/is_same.hpp>
#include <hboost/type_traits/is_const.hpp>

#ifdef HBOOST_BIMAP_ONLY_DOXYGEN_WILL_PROCESS_THE_FOLLOWING_LINES
...
HBOOST_DEDUCED_TYPENAME result_of::get<Tag,SymmetricType>::type
    get( SymmetricType & );
...
#endif // HBOOST_BIMAP_ONLY_DOXYGEN_WILL_PROCESS_THE_FOLLOWING_LINES
...
HBOOST_BIMAP_SYMMETRIC_ACCESS_RESULT_OF_BUILDER
(
    get,
    value_type_of
)
...
HBOOST_BIMAP_SYMMETRIC_ACCESS_IMPLEMENTATION_BUILDER
(
    get,
    SymmetricType,
    st,
...
HBOOST_DEDUCED_TYPENAME result_of::get<
    ::hboost::bimaps::relation::member_at::info, SymmetricType >::type
get(::hboost::bimaps::relation::member_at::info, SymmetricType & rel)
{
    return rel.info;
}
...
HBOOST_BIMAP_SYMMETRIC_ACCESS_INTERFACE_BUILDER
(
    get
)
...
#endif // HBOOST_BIMAP_RELATION_SUPPORT_GET_HPP
