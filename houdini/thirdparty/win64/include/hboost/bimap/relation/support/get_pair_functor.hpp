...
#ifndef HBOOST_BIMAP_RELATION_SUPPORT_GET_PAIR_FUNCTOR_HPP
#define HBOOST_BIMAP_RELATION_SUPPORT_GET_PAIR_FUNCTOR_HPP
...
struct get_pair_functor
{
    ...
    HBOOST_DEDUCED_TYPENAME result_of::pair_by<Tag,const Relation>::type
...
{
    HBOOST_DEDUCED_TYPENAME Relation::above_view &
    operator()( Relation & r ) const
    {
        return r.get_view();
    }

    const HBOOST_DEDUCED_TYPENAME Relation::above_view &
    operator()( const Relation & r ) const
    {
        return r.get_view();
    }
...
#endif // HBOOST_BIMAP_RELATION_SUPPORT_GET_PAIR_FUNCTOR_HPP
