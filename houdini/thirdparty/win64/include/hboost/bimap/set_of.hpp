...
#ifndef HBOOST_BIMAP_SET_OF_HPP
#define HBOOST_BIMAP_SET_OF_HPP
...
#include <hboost/bimap/views/map_view.hpp>
#include <hboost/bimap/views/set_view.hpp>
...
HBOOST_STATIC_ASSERT( is_set_type_of< set_of<Type> >::value )
...
<
    class KeyType,
    class KeyCompare = std::less< HBOOST_DEDUCED_TYPENAME 
        ::hboost::bimaps::tags::support::value_type_of<KeyType>::type >
>
struct set_of : public ::hboost::bimaps::detail::set_type_of_tag
{
    ...
    struct lazy_concept_checked
    {
        ...
        HBOOST_CLASS_REQUIRE4( key_compare, bool, value_type, value_type,
                              hboost, BinaryFunctionConcept );

        typedef set_of type;
    };

    HBOOST_BIMAP_GENERATE_INDEX_BINDER_1CP(
...
struct set_of_relation : public ::hboost::bimaps::detail::set_type_of_relation_tag
{
    /// Functor that compare two keys
    typedef KeyCompare key_compare;

    HBOOST_BIMAP_GENERATE_RELATION_BINDER_1CP(
