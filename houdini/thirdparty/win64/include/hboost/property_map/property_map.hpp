...
#ifndef HBOOST_PROPERTY_MAP_HPP
#define HBOOST_PROPERTY_MAP_HPP
...
namespace hboost {
  ...
  HBOOST_MPL_HAS_XXX_TRAIT_DEF(key_type)
  HBOOST_MPL_HAS_XXX_TRAIT_DEF(value_type)
  HBOOST_MPL_HAS_XXX_TRAIT_DEF(reference)
  HBOOST_MPL_HAS_XXX_TRAIT_DEF(category)
  ...
  struct property_traits :
    hboost::mpl::if_<is_property_map<PA>,
  ...
  struct property_traits<T*> {
    // HBOOST_STATIC_ASSERT(hboost::is_same<T, T*>::value && !"Using pointers as property maps is deprecated");
  ...
  // do hboost::get() anyways, and the using clause
...
namespace hboost {
  ...
  struct ReadablePropertyMapConcept
  {
    ...
    typedef hboost::readable_property_map_tag ReadableTag;
    void constraints() {
  ...
  struct WritablePropertyMapConcept
  {
    typedef typename property_traits<PMap>::key_type key_type;
    typedef typename property_traits<PMap>::category Category;
    typedef hboost::writable_property_map_tag WritableTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef hboost::read_write_property_map_tag ReadWriteTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef hboost::lvalue_property_map_tag LvalueTag;
    typedef typename property_traits<PMap>::reference reference;
    ...
    void constraints() {
      ...
      HBOOST_MPL_ASSERT((hboost::mpl::or_<
                          hboost::is_same<const value_type&, reference>,
                          hboost::is_same<value_type&, reference> >));
  ...
  struct Mutable_LvaluePropertyMapConcept
  {
    ...
    typedef typename property_traits<PMap>::reference reference;
    void constraints() { 
      hboost::function_requires< ReadWritePropertyMapConcept<PMap, Key> >();
      hboost::function_requires<ConvertibleConcept<Category, LvalueTag> >();
      
      typedef typename property_traits<PMap>::value_type value_type;
      HBOOST_MPL_ASSERT((hboost::is_same<value_type&, reference>));
  ...
  class iterator_property_map
    : public hboost::put_get_helper< R, 
  ...
  inline safe_iterator_property_map<
    RAIter, ID,
    typename hboost::detail::iterator_traits<RAIter>::value_type,
    typename hboost::detail::iterator_traits<RAIter>::reference>
  make_safe_iterator_property_map(RAIter iter, std::size_t n, ID id) {
    function_requires< RandomAccessIteratorConcept<RAIter> >();
    typedef safe_iterator_property_map<
      RAIter, ID,
      typename hboost::detail::iterator_traits<RAIter>::value_type,
      typename hboost::detail::iterator_traits<RAIter>::reference> PA;
    return PA(iter, n, id);
  }
  template <class RAIter, class Value, class ID>
  ...
  class static_property_map :
      public
  hboost::put_get_helper<ValueType,static_property_map<ValueType> >
  { 
    ValueType value;
  public:
  ...
  class ref_property_map :
    public
      hboost::put_get_helper<ValueType&,ref_property_map<KeyType,ValueType> >
  { 
    ValueType* value;
  public:
    typedef KeyType key_type;
  ...
  template <typename T>
  struct typed_identity_property_map
    : public hboost::put_get_helper<T, typed_identity_property_map<T> >
  {
    typedef T key_type;
    typedef T value_type;
    typedef T reference;
...
//=========================================================================
  ...
  class dummy_property_map 
    : public hboost::put_get_helper<detail::dummy_pmap_reference,
        dummy_property_map  > 
  {
  public:
    ...
    typedef hboost::read_write_property_map_tag category;
...
#include <hboost/property_map/parallel/parallel_property_maps.hpp>
#endif

#include <hboost/property_map/vector_property_map.hpp>

#endif /* HBOOST_PROPERTY_MAP_HPP */
