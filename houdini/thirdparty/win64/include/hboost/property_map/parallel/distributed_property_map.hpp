...
#ifndef HBOOST_PARALLEL_DISTRIBUTED_PROPERTY_MAP_HPP
#define HBOOST_PARALLEL_DISTRIBUTED_PROPERTY_MAP_HPP
...
#include <vector>
#include <set>
#include <hboost/property_map/parallel/basic_reduce.hpp>
#include <hboost/property_map/parallel/detail/untracked_pair.hpp>
#include <hboost/type_traits/is_same.hpp>
#include <hboost/property_map/parallel/local_property_map.hpp>
#include <map>
#include <hboost/version.hpp>
#include <hboost/property_map/parallel/unsafe_serialize.hpp>
...
namespace hboost { namespace parallel {
 ...
 public:
  ...
  request_put(process_id_type p, const key_type& k, const value_type& v) const
  {
    send(data->process_group, p, property_map_put,
         hboost::parallel::detail::make_untracked_pair(k, v));
  }
 ...
 private:
  ...
  struct handle_message
  {
    ...
    handle_put(int source, int tag,
               const hboost::parallel::detail::untracked_pair<key_type, value_type>& data,
    ...
    handle_multiget_reply
      (int source, int tag,
       const std::vector<hboost::parallel::detail::untracked_pair<key_type, value_type> >& msg,
       trigger_receive_context);
...
} } // end namespace hboost::parallel

#include <hboost/property_map/parallel/impl/distributed_property_map.ipp>

#undef PBGL_DISTRIB_PMAP

#endif // HBOOST_PARALLEL_DISTRIBUTED_PROPERTY_MAP_HPP
