...
//           Andrew Lumsdaine
#ifndef HBOOST_PROPERTY_MAP_PARALLEL_PROCESS_GROUP_HPP
#define HBOOST_PROPERTY_MAP_PARALLEL_PROCESS_GROUP_HPP
...
namespace hboost { namespace graph { namespace distributed {
  ...
  using hboost::parallel::trc_early_receive;
  using hboost::parallel::trc_out_of_band;
  using hboost::parallel::trc_irecv_out_of_band;
  using hboost::parallel::trc_in_synchronization;
  using hboost::parallel::trc_none;
  using hboost::parallel::attach_distributed_object;
} } } // end namespace hboost::graph::distributed

#endif // HBOOST_PROPERTY_MAP_PARALLEL_PROCESS_GROUP_HPP
