...
#ifndef HBOOST_PROPERTY_MAP_PARALLEL_SIMPLE_TRIGGER_HPP
#define HBOOST_PROPERTY_MAP_PARALLEL_SIMPLE_TRIGGER_HPP
...
namespace hboost { namespace graph { namespace parallel { using hboost::parallel::simple_trigger; } } }

#endif // HBOOST_PROPERTY_MAP_PARALLEL_SIMPLE_TRIGGER_HPP
