...
#ifndef HBOOST_NUMERIC_FUNCTIONAL_VALARRAY_HPP_EAN_12_12_2005
#define HBOOST_NUMERIC_FUNCTIONAL_VALARRAY_HPP_EAN_12_12_2005
...
#include <hboost/typeof/std/valarray.hpp>
...
namespace hboost { namespace numeric
{
    ...
    #define HBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(Name, Op)                   \
        template<typename Left, typename Right>                                         \
        ...
        HBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(plus, +)
        HBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(minus, -)
        HBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(multiplies, *)
        HBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(divides, /)
        HBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(modulus, %)

    #undef HBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP
          ...
          : std::binary_function<Left, Right, void>
        {
            ...
            {
                HBOOST_ASSERT(left.size() == right.size());
          ...
          : std::unary_function<From, bool>
        {
            ...
            {
                HBOOST_MPL_ASSERT((is_same<bool, typename From::value_type>));
                for(std::size_t i = 0, size = arr.size(); i != size; ++i)
                {
                    if(!arr[i])
                    {
