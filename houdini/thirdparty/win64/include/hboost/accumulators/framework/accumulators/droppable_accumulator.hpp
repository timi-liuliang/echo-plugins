...
#ifndef HBOOST_ACCUMULATORS_FRAMEWORK_ACCUMULATORS_DROPPABLE_ACCUMULATOR_HPP_EAN_13_12_2005
#define HBOOST_ACCUMULATORS_FRAMEWORK_ACCUMULATORS_DROPPABLE_ACCUMULATOR_HPP_EAN_13_12_2005

#include <new>
#include <hboost/assert.hpp>
#include <hboost/mpl/apply.hpp>
#include <hboost/aligned_storage.hpp>
#include <hboost/accumulators/framework/depends_on.hpp> // for feature_of
#include <hboost/accumulators/framework/parameters/accumulator.hpp> // for accumulator
...
namespace hboost { namespace accumulators
{
      ...
      : Accumulator
    {
        ...
        {
            HBOOST_ASSERT(0 < this->ref_count_);
