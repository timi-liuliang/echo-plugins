...
#ifndef HBOOST_ACCUMULATORS_FRAMEWORK_ACCUMULATOR_SET_HPP_EAN_28_10_2005
#define HBOOST_ACCUMULATORS_FRAMEWORK_ACCUMULATOR_SET_HPP_EAN_28_10_2005
...
#include <hboost/accumulators/framework/accumulators/droppable_accumulator.hpp>
#include <hboost/fusion/include/any.hpp>
#include <hboost/fusion/include/find_if.hpp>
#include <hboost/fusion/include/for_each.hpp>
#include <hboost/fusion/include/filter_view.hpp>
...
namespace detail
{
    ///////////////////////////////////////////////////////////////////////////////
    // accumulator_visitor
    //   wrap a hboost::parameter argument pack in a Fusion extractor object
  ...
  : detail::accumulator_set_base
{
    ...
    /// INTERNAL ONLY
    ///
    //HBOOST_MPL_ASSERT((mpl::is_sequence<accumulators_type>));
    ...
    /// INTERNAL ONLY
    ///
#define HBOOST_ACCUMULATORS_ACCUMULATOR_SET_CTOR(z, n, _)                                \
    template<HBOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>                                  \
    accumulator_set(HBOOST_PP_ENUM_BINARY_PARAMS_Z(z, n, A, const &a))                   \
      : accumulators(                                                                   \
            detail::make_acc_list(                                                      \
                accumulators_mpl_vector()                                               \
              , detail::accumulator_params()(                                           \
                    *this HBOOST_PP_ENUM_TRAILING_PARAMS_Z(z, n, a)                      \
                )                                                                       \
            )                                                                           \
        )                                                                               \
    {                                                                                   \
    ...
    HBOOST_PP_REPEAT_FROM_TO(
      ...
      , HBOOST_ACCUMULATORS_ACCUMULATOR_SET_CTOR
      , _
    )
    ...
    /// INTERNAL ONLY
    ///
#define HBOOST_ACCUMULATORS_ACCUMULATOR_SET_FUN_OP(z, n, _)                              \
    template<HBOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>                                  \
    void operator ()(HBOOST_PP_ENUM_BINARY_PARAMS_Z(z, n, A, const &a))                  \
    {                                                                                   \
        this->visit(                                                                    \
            detail::make_accumulator_visitor(                                           \
                detail::accumulator_params()(                                           \
    ...
    HBOOST_PP_REPEAT_FROM_TO(
        2
      , HBOOST_PP_INC(HBOOST_ACCUMULATORS_MAX_ARGS)
      , HBOOST_ACCUMULATORS_ACCUMULATOR_SET_FUN_OP
      , _
    )
    ...
    void drop()
    {
        ...
        HBOOST_MPL_ASSERT((detail::contains_feature_of<Features, the_accumulator>));
...
find_accumulator(AccumulatorSet &acc HBOOST_ACCUMULATORS_PROTO_DISABLE_IF_IS_CONST(AccumulatorSet))
{
...
/// INTERNAL ONLY
///
#define HBOOST_ACCUMULATORS_EXTRACT_RESULT_FUN(z, n, _)                      \
    template<                                                               \
        typename Feature                                                    \
...
HBOOST_PP_REPEAT(
    HBOOST_PP_INC(HBOOST_ACCUMULATORS_MAX_ARGS)
  , HBOOST_ACCUMULATORS_EXTRACT_RESULT_FUN
  , _
)
