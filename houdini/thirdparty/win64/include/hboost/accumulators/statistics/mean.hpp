...
#ifndef HBOOST_ACCUMULATORS_STATISTICS_MEAN_HPP_EAN_28_10_2005
#define HBOOST_ACCUMULATORS_STATISTICS_MEAN_HPP_EAN_28_10_2005
...
#include <hboost/accumulators/statistics/sum.hpp>
...
namespace extract
{
    ...
    HBOOST_ACCUMULATORS_DEFINE_EXTRACTOR(tag, mean_of_variates, (typename)(typename))

    HBOOST_ACCUMULATORS_IGNORE_GLOBAL(mean)
    HBOOST_ACCUMULATORS_IGNORE_GLOBAL(mean_of_weights)
}
