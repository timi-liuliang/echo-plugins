#ifndef HBOOST_RANGE_ATL_HPP
#define HBOOST_RANGE_ATL_HPP
...
#if !defined(HBOOST_RANGE_ATL_NO_COLLECTIONS)
    #if (_ATL_VER < 0x0700)
        #define HBOOST_RANGE_ATL_NO_COLLECTIONS
    #endif
#endif


#if !defined(HBOOST_RANGE_ATL_HAS_OLD_CSIMPLE_XXX)
    #if (_ATL_VER < 0x0700) // dubious
        #define HBOOST_RANGE_ATL_HAS_OLD_CSIMPLE_XXX
    #endif
#endif
...
namespace ATL {
    ...
    // strings
    //
#if !defined(HBOOST_RANGE_ATL_HAS_OLD_CSIMPLESTRING)
...
#endif // !defined(HBOOST_RANGE_ATL_NO_COLLECTIONS)
...
#endif // !defined(HBOOST_RANGE_ATL_HAS_OLD_CSIMPLE_XXX)
...
#include <hboost/iterator/indirect_iterator.hpp>
...
namespace hboost { namespace range_detail_microsoft {
...
#endif
    {
        ...
        Iterator begin(X& x)
        {
            return Iterator(hboost::make_tuple(x.m_aKey, x.m_aVal));
        }

        template< class Iterator, class X >
        Iterator end(X& x)
        {
            return Iterator(hboost::make_tuple(x.m_aKey + x.GetSize(), x.m_aVal + x.GetSize()));
        }
    };
...
//
    ...
    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        ...
        (ATL, HBOOST_PP_NIL), CAtlArray, 2
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CAutoPtrArray, 1
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CInterfaceArray, (class)(const IID *)
    )
    ...
    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CAtlList, 2
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CAutoPtrList, 1
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CHeapPtrList, 2
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CInterfaceList, (class)(const IID *)
    )
    ...
    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CAtlMap, 4
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::atl_rb_tree_tag,
        (ATL, HBOOST_PP_NIL), CRBTree, 4
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::atl_rb_tree_tag,
        (ATL, HBOOST_PP_NIL), CRBMap, 4
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::atl_rb_tree_tag,
        (ATL, HBOOST_PP_NIL), CRBMultiMap, 4
    )
    ...
    #if !defined(HBOOST_RANGE_ATL_HAS_OLD_CSIMPLESTRING)
        HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
            hboost::range_detail_microsoft::atl_string_tag,
            (ATL, HBOOST_PP_NIL), CSimpleStringT, (class)(bool)
        )
    #else
        HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
            hboost::range_detail_microsoft::atl_string_tag,
            (ATL, HBOOST_PP_NIL), CSimpleStringT, 1
        )
    #endif

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::atl_string_tag,
        (ATL, HBOOST_PP_NIL), CStringT, 2
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::atl_string_tag,
        (ATL, HBOOST_PP_NIL), CFixedStringT, (class)(int)
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CStaticString, (class)(const int)
    )
...
//
    ...
    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CSimpleArray, 2
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CSimpleMap, 3
    )
    ...
    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CSimpleArray, 1
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CSimpleMap, 2
    )

    HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        hboost::range_detail_microsoft::using_type_as_tag,
        (ATL, HBOOST_PP_NIL), CSimpleValArray, 1
    )
