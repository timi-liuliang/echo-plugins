...
//
#ifndef HBOOST_RANGE_ANY_RANGE_HPP_INCLUDED
#define HBOOST_RANGE_ANY_RANGE_HPP_INCLUDED
...
#include <hboost/range/detail/any_iterator.hpp>
...
namespace hboost
{
    namespace range_detail
    {
        ...
        // values when the user specified hboost::use_default as a template
        // parameter.
        template<
            class T,
            class Default
...
# endif
        ...
        public:
            ...
            : base_type(hboost::begin(wrapped_range),
                        hboost::end(wrapped_range))
            {
            }
            ...
            any_range(const any_range<
                              ...
                              , Buffer
                            >& other)
            : base_type(hboost::begin(other), hboost::end(other))
            {
            }
        ...
        {
            HBOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<WrappedRange> ));
            typedef any_range<
