...
#ifndef HBOOST_RANGE_DETAIL_EMPTY_HPP
#define HBOOST_RANGE_DETAIL_EMPTY_HPP
...
namespace hboost 
{
    namespace range_detail
    {
        ...
        struct range_empty<array_>
        {
            ...
            static bool fun( T HBOOST_ARRAY_REF[sz] )
            {
                if( hboost_range_array == 0 )
                    return true;
                return false;
            }
        };
    ...
    empty( const C& c )
    {
        return range_detail::range_empty<  HBOOST_RANGE_DEDUCED_TYPENAME range_detail::range<C>::type >::fun( c );
    }
