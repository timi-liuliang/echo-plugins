...
//
#ifndef HBOOST_RANGE_DETAIL_JOIN_ITERATOR_HPP_INCLUDED
#define HBOOST_RANGE_DETAIL_JOIN_ITERATOR_HPP_INCLUDED
...
#include <hboost/range/detail/demote_iterator_traversal_tag.hpp>
...
public:
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_begin_tag)
        : m_section(hboost::empty(r1) ? 1u : 0u)
        , m_it(hboost::empty(r1) ? 1u : 0u, hboost::begin(r1), hboost::begin(r2))
        , m_link(link_t(hboost::end(r1), hboost::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_begin_tag)
        : m_section(hboost::empty(r1) ? 1u : 0u)
        , m_it(hboost::empty(r1) ? 1u : 0u, hboost::const_begin(r1), hboost::const_begin(r2))
        , m_link(link_t(hboost::const_end(r1), hboost::const_begin(r2)))
    {
    }
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, hboost::end(r1), hboost::end(r2))
        , m_link(link_t(hboost::end(r1), hboost::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, hboost::const_end(r1), hboost::const_end(r2))
        , m_link(link_t(hboost::const_end(r1), hboost::const_begin(r2)))
    {
    }
...
private:
    ...
    void decrement()
    {
        if (m_section)
        {
            ...
            {
                m_it.it1() = hboost::prior(m_link.last1);
                m_section = 0u;
            }
            else
                --m_it.it2();
