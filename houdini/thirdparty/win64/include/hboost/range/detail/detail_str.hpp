...
#ifndef HBOOST_RANGE_DETAIL_DETAIL_STR_HPP
#define HBOOST_RANGE_DETAIL_DETAIL_STR_HPP
...
namespace hboost 
{
    ...
    namespace range_detail
    {
        ...
        { 
            ...
            struct pts
            {
                 typedef HBOOST_RANGE_DEDUCED_TYPENAME 
        ...
        { 
            ...
            struct pts
            {
                typedef const HBOOST_RANGE_DEDUCED_TYPENAME 
                    remove_extent<T>::type* type;
            };
        };
...
#include <hboost/range/detail/size_type.hpp>
#include <hboost/range/detail/value_type.hpp>
...
namespace hboost 
{
    ...
    namespace range_detail
    {
        ...
        str_begin( C& c )
        {
            return range_detail::range_begin< HBOOST_RANGE_DEDUCED_TYPENAME 
        ...
        struct range_end<char_array_>
        {
            ...
            static T* fun( T HBOOST_RANGE_ARRAY_REF()[sz] )
            {
                return hboost::range_detail::array_end( hboost_range_array );
            }
        };
        ...
        struct range_end<char_ptr_>
        {
            static char* fun( char* s )
            {
                return hboost::range_detail::str_end( s );
            }
        };
        ...
        str_end( C& c )
        {
            return range_detail::range_end< HBOOST_RANGE_DEDUCED_TYPENAME 
                range_detail::range<C>::type >::fun( c );
        }
