...
#ifndef HBOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP
#define HBOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP

#include <hboost/config.hpp>  // MSVC, NO_INTRINSIC_WCHAR_T, put size_t in std.
#include <cstddef>
...
namespace hboost 
{
    namespace range_detail
    {
        ...
        struct remove_extent {
            static T* ar;
            HBOOST_STATIC_CONSTANT(std::size_t, size = sizeof(*ar) / sizeof((*ar)[0]));
