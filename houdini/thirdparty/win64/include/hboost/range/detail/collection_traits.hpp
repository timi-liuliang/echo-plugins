...
#ifndef HBOOST_RANGE_STRING_COLLECTION_TRAITS_HPP
#define HBOOST_RANGE_STRING_COLLECTION_TRAITS_HPP
...
// Implementation
#include <hboost/range/detail/collection_traits_detail.hpp>
...
//  collection_traits template class -----------------------------------------//
        ...
        */
        ...
        {
        private:
            typedef typename ::hboost::mpl::eval_if<
                    ::hboost::algorithm::detail::is_pair<T>, 
                        detail::pair_container_traits_selector<T>,
                        typename ::hboost::mpl::eval_if<
                        ::hboost::is_array<T>, 
...
#endif // HBOOST_STRING_COLLECTION_TRAITS_HPP
