...
//
#ifndef HBOOST_RANGE_DETAIL_RANGE_RETURN_HPP_INCLUDED
#define HBOOST_RANGE_DETAIL_RANGE_RETURN_HPP_INCLUDED
...
namespace hboost
{
    ...
    struct range_return
    {
        typedef hboost::iterator_range<
            HBOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type > type;

        static type pack(HBOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type found,
                         SinglePassRange& rng)
        {
            return type(found, hboost::end(rng));
        }
    };
    ...
    {
        typedef HBOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type type;
    ...
    {
        typedef HBOOST_DEDUCED_TYPENAME range_iterator<BidirectionalRange>::type type;

        static type pack(type found, BidirectionalRange& rng)
        {
            return found == hboost::begin(rng)
                ? found
                : hboost::prior(found);
        }
    };
    ...
    struct range_return< SinglePassRange, return_begin_found >
    {
        ...
        static type pack(HBOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type found,
                         SinglePassRange& rng)
        {
            return type(hboost::begin(rng), found);
        }
    };
    ...
    struct range_return< SinglePassRange, return_begin_next >
    {
        ...
        static type pack(HBOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type found,
                         SinglePassRange& rng)
        {
            return type( hboost::begin(rng), 
                         found == hboost::end(rng) ? found : hboost::next(found) );
        }
    };
    ...
    {
        typedef hboost::iterator_range<
            HBOOST_DEDUCED_TYPENAME range_iterator<BidirectionalRange>::type > type;

        static type pack(HBOOST_DEDUCED_TYPENAME range_iterator<BidirectionalRange>::type found,
                         BidirectionalRange& rng)
        {
            return type( hboost::begin(rng),
                         found == hboost::begin(rng) ? found : hboost::prior(found) );
        }
    };
    ...
    struct range_return< SinglePassRange, return_next_end >
    {
        ...
        static type pack(HBOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type found,
                         SinglePassRange& rng)
        {
            return type( found == hboost::end(rng) ? found : hboost::next(found),
                         hboost::end(rng) );
        }
    };
    ...
    struct range_return< BidirectionalRange, return_prior_end >
    {
        ...
        static type pack(HBOOST_DEDUCED_TYPENAME range_iterator<BidirectionalRange>::type found,
                         BidirectionalRange& rng)
        {
            return type( found == hboost::begin(rng) ? found : hboost::prior(found),
                         hboost::end(rng) );
        }
    };
    ...
    struct range_return< SinglePassRange, return_begin_end >
    {
        ...
        static type pack(HBOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type,
                         SinglePassRange& rng)
        {
            return type(hboost::begin(rng), hboost::end(rng));
        }
    };
