...
// <hboost/smart_ptr/operator_bool.hpp>
#ifndef HBOOST_RANGE_SAFE_BOOL_INCLUDED_HPP
#define HBOOST_RANGE_SAFE_BOOL_INCLUDED_HPP
...
#if (defined(__SUNPRO_CC) && HBOOST_WORKAROUND(__SUNPRO_CC, < 0x570)) || defined(__CINT_)
