...
#ifndef HBOOST_RANGE_STRING_DETAIL_COLLECTION_TRAITS_HPP
#define HBOOST_RANGE_STRING_DETAIL_COLLECTION_TRAITS_HPP
...
// Default collection traits -----------------------------------------------------------------
            ...
            */
            ...
            struct default_container_traits
            {
                ...
                typedef typename
                    ::hboost::mpl::if_< ::hboost::is_const<ContainerT>,
                        const_iterator,
                        iterator 
...
// Pair container traits ---------------------------------------------------------------------
            ...
            struct pair_container_traits
            {
                ...
                typedef typename ::hboost::detail::
...
// Array container traits ---------------------------------------------------------------
            ...
            struct array_traits<T[sz]>
            {
                ...
                HBOOST_STATIC_CONSTANT( size_type, array_size = sz );
            };
            ...
            */
            ...
            public:
                ...
                typedef typename
                    ::hboost::mpl::if_< ::hboost::is_const<T>,
                        const_iterator,
                        iterator 
                    >::type result_iterator;
            ...
            private:
                // resolve array size
                typedef typename
                    ::hboost::remove_cv<value_type>::type char_type;
                typedef typename
                    array_length_selector<char_type>::
                        HBOOST_NESTED_TEMPLATE array_length<traits_type> array_length_type;

            public:
                HBOOST_STATIC_CONSTANT( size_type, array_size = traits_type::array_size );
...
// Pointer container traits ---------------------------------------------------------------
            ...
            {
                typedef typename
                    ::hboost::remove_pointer<T>::type value_type;
...
#endif  // HBOOST_STRING_DETAIL_COLLECTION_HPP
