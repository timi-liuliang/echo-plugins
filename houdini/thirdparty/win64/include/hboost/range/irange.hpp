...
//
#ifndef HBOOST_RANGE_IRANGE_HPP_INCLUDED
#define HBOOST_RANGE_IRANGE_HPP_INCLUDED
...
namespace hboost
{
    namespace range_detail
    {
        ...
        class integer_iterator
            : public hboost::iterator_facade<
                    ...
                    >
        {
            typedef hboost::iterator_facade<
                        integer_iterator<Integer>,
                        Integer,
                        hboost::random_access_traversal_tag,
                        Integer,
    ...
    {
        HBOOST_ASSERT( step_size != 0 );
        HBOOST_ASSERT( (step_size > 0) ? (last >= first) : (last <= first) );
