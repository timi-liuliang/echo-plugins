...
//
#ifndef HBOOST_RANGE_ALGORITHM_REPLACE_COPY_IF_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_REPLACE_COPY_IF_HPP_INCLUDED
        ...
        const Value& with_what)
{
    ...
    return std::replace_copy_if(hboost::begin(rng), hboost::end(rng), out_it,
        pred, with_what);
}
