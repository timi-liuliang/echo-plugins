...
//
#ifndef HBOOST_RANGE_ALGORITHM_REPLACE_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_REPLACE_HPP_INCLUDED
        ...
        const Value& with_what)
{
    ...
    std::replace(hboost::begin(rng), hboost::end(rng), what, with_what);
    return rng;
}
