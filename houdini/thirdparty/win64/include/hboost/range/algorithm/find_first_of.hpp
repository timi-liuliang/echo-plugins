...
//
#ifndef HBOOST_RANGE_ALGORITHM_FIND_FIRST_OF_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_FIND_FIRST_OF_HPP_INCLUDED
...
find_first_of(SinglePassRange1 & rng1, ForwardRange2 const & rng2)
{
    ...
    return std::find_first_of(hboost::begin(rng1),hboost::end(rng1),
                              hboost::begin(rng2),hboost::end(rng2));
}

/// \overload
template< class SinglePassRange1, class ForwardRange2 >
inline HBOOST_DEDUCED_TYPENAME range_iterator<const SinglePassRange1>::type
...
inline HBOOST_DEDUCED_TYPENAME disable_if<
    is_const<SinglePassRange1>,
    HBOOST_DEDUCED_TYPENAME range_return<SinglePassRange1,re>::type
>::type
find_first_of(SinglePassRange1& rng1, const ForwardRange2& rng2)
{
    ...
    return range_return<SinglePassRange1,re>::
        pack(std::find_first_of(hboost::begin(rng1), hboost::end(rng1),
                                hboost::begin(rng2), hboost::end(rng2)),
             rng1);
}
...
/// \overload
template< range_return_value re, class SinglePassRange1, class ForwardRange2 >
inline HBOOST_DEDUCED_TYPENAME range_return<const SinglePassRange1,re>::type
find_first_of(const SinglePassRange1& rng1, const ForwardRange2& rng2)
{
    HBOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    HBOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<const ForwardRange2> ));
