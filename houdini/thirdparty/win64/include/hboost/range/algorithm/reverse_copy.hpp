...
//
#ifndef HBOOST_RANGE_ALGORITHM_REVERSE_COPY_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_REVERSE_COPY_HPP_INCLUDED
...
inline OutputIterator reverse_copy(const BidirectionalRange& rng, OutputIterator out)
{
    ...
    return std::reverse_copy(hboost::begin(rng), hboost::end(rng), out);
}
