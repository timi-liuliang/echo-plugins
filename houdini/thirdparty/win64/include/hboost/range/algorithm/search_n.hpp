...
//
#ifndef HBOOST_RANGE_ALGORITHM_SEARCH_N_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_SEARCH_N_HPP_INCLUDED
...
namespace range_detail
{
    ...
    search_n_impl(ForwardIterator first, ForwardIterator last,
                  Integer count, const Value& value)
    {
        HBOOST_RANGE_CONCEPT_ASSERT((ForwardIteratorConcept<ForwardIterator>));
        HBOOST_RANGE_CONCEPT_ASSERT((EqualityComparableConcept<Value>));
        HBOOST_RANGE_CONCEPT_ASSERT((EqualityComparableConcept<typename std::iterator_traits<ForwardIterator>::value_type>));
        //HBOOST_RANGE_CONCEPT_ASSERT((EqualityComparableConcept2<typename std::iterator_traits<ForwardIterator>::value_type, Value>));
...
search_n(ForwardRange& rng, Integer count, const Value& value)
{
    ...
    return range_detail::search_n_impl(hboost::begin(rng),hboost::end(rng), count, value);
}
         ...
         BinaryPredicate binary_pred)
{
    ...
    HBOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        HBOOST_DEDUCED_TYPENAME range_value<ForwardRange>::type, const Value&>));
    return range_detail::search_n_pred_impl(hboost::begin(rng), hboost::end(rng),
         ...
         BinaryPredicate binary_pred)
{
    HBOOST_RANGE_CONCEPT_ASSERT((ForwardRangeConcept<const ForwardRange>));
    HBOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        HBOOST_DEDUCED_TYPENAME range_value<const ForwardRange>::type, const Value&>));
    return range_detail::search_n_pred_impl(hboost::begin(rng), hboost::end(rng),
        count, value, binary_pred);
}
...
search_n(ForwardRange& rng, Integer count, const Value& value)
{
    ...
    return range_return<ForwardRange,re>::
        pack(range_detail::search_n_impl(hboost::begin(rng),hboost::end(rng),
                           count, value),
             rng);
}
         ...
         BinaryPredicate pred)
{
    HBOOST_RANGE_CONCEPT_ASSERT((ForwardRangeConcept<ForwardRange>));
    HBOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        HBOOST_DEDUCED_TYPENAME range_value<ForwardRange>::type,
        const Value&>));
    return range_return<ForwardRange,re>::
        pack(range_detail::search_n_pred_impl(hboost::begin(rng),
                                              hboost::end(rng),
                           count, value, pred),
             rng);
}
         ...
         BinaryPredicate pred)
{
    HBOOST_RANGE_CONCEPT_ASSERT((ForwardRangeConcept<const ForwardRange>));
    HBOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        HBOOST_DEDUCED_TYPENAME range_value<const ForwardRange>::type,
        const Value&>));
    return range_return<const ForwardRange,re>::
        pack(range_detail::search_n_pred_impl(hboost::begin(rng),
                                              hboost::end(rng),
