...
//
#ifndef HBOOST_RANGE_ALGORITHM_FIND_IF_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_FIND_IF_HPP_INCLUDED
...
find_if( SinglePassRange& rng, UnaryPredicate pred )
{
    ...
    return std::find_if(hboost::begin(rng), hboost::end(rng), pred);
}
...
find_if( SinglePassRange& rng, UnaryPredicate pred )
{
    ...
    return range_return<SinglePassRange,re>::
        pack(std::find_if(hboost::begin(rng), hboost::end(rng), pred),
             rng);
}
