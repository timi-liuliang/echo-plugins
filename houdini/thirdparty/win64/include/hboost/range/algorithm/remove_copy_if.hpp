...
//
#ifndef HBOOST_RANGE_ALGORITHM_REMOVE_COPY_IF_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_REMOVE_COPY_IF_HPP_INCLUDED
...
namespace hboost
{
    ...
    remove_copy_if(const SinglePassRange& rng, OutputIterator out_it, Predicate pred)
    {
        ...
        return std::remove_copy_if(hboost::begin(rng), hboost::end(rng), out_it, pred);
    }
}
