...
//
#ifndef HBOOST_RANGE_ALGORITHM_FIND_END_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_FIND_END_HPP_INCLUDED
...
inline HBOOST_DEDUCED_TYPENAME disable_if<
    ...
    HBOOST_DEDUCED_TYPENAME range_iterator< ForwardRange1 >::type
>::type
find_end(ForwardRange1 & rng1, const ForwardRange2& rng2)
{
    ...
    return std::find_end(hboost::begin(rng1),hboost::end(rng1),
...
inline HBOOST_DEDUCED_TYPENAME disable_if<
    is_const<ForwardRange1>,
    HBOOST_DEDUCED_TYPENAME range_return<ForwardRange1,re>::type
>::type
find_end(ForwardRange1& rng1, const ForwardRange2& rng2)
{
    HBOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange1> ));
    ...
    return range_return<ForwardRange1,re>::
        pack(std::find_end(hboost::begin(rng1), hboost::end(rng1),
                           hboost::begin(rng2), hboost::end(rng2)),
             rng1);
}
