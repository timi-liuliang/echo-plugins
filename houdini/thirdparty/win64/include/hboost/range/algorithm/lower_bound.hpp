...
//
#ifndef HBOOST_RANGE_ALGORITHM_LOWER_BOUND_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_LOWER_BOUND_HPP_INCLUDED
...
lower_bound( ForwardRange& rng, Value val )
{
    ...
    return std::lower_bound(hboost::begin(rng), hboost::end(rng), val);
}
...
{
    HBOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return std::lower_bound(hboost::begin(rng), hboost::end(rng), val, pred);
}
...
lower_bound( ForwardRange& rng, Value val )
{
    ...
    return range_return<ForwardRange,re>::
        pack(std::lower_bound(hboost::begin(rng), hboost::end(rng), val),
             rng);
}
...
lower_bound( ForwardRange& rng, Value val, SortPredicate pred )
{
    HBOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return range_return<ForwardRange,re>::
        pack(std::lower_bound(hboost::begin(rng), hboost::end(rng), val, pred),
             rng);
}
