...
//
#ifndef HBOOST_RANGE_ALGORITHM_REPLACE_IF_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_REPLACE_IF_HPP_INCLUDED
               ...
               const Value& val)
{
    ...
    std::replace_if(hboost::begin(rng), hboost::end(rng), pred, val);
    return rng;
}
