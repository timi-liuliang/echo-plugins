...
//
#ifndef HBOOST_RANGE_ALGORITHM_SWAP_RANGES_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_SWAP_RANGES_HPP_INCLUDED
...
namespace hboost
{
    namespace range_detail
    {
        ...
        {
            ignore_unused_variable_warning(last2);
            HBOOST_ASSERT( last2 - it2 >= last1 - it1 );
                              ...
                              Iterator2 first2, Iterator2 last2)
        {
            swap_ranges_impl(first1, last1, first2, last2,
                HBOOST_DEDUCED_TYPENAME iterator_traversal<Iterator1>::type(),
                HBOOST_DEDUCED_TYPENAME iterator_traversal<Iterator2>::type());
        }
    } // namespace range_detail
...
swap_ranges(SinglePassRange1& range1, SinglePassRange2& range2)
{
    ...
    hboost::range_detail::swap_ranges_impl(
        hboost::begin(range1), hboost::end(range1),
        hboost::begin(range2), hboost::end(range2));
