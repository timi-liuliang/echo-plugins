...
//
#ifndef HBOOST_RANGE_ALGORITHM_HEAP_ALGORITHM_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_HEAP_ALGORITHM_HPP_INCLUDED
...
inline RandomAccessRange& push_heap(RandomAccessRange& rng)
{
    ...
    std::push_heap(hboost::begin(rng), hboost::end(rng));
    return rng;
}
...
{
    HBOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::push_heap(hboost::begin(rng), hboost::end(rng), comp_pred);
    return rng;
}
...
{
    HBOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::pop_heap(hboost::begin(rng), hboost::end(rng));
    return rng;
}
...
{
    HBOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::pop_heap(hboost::begin(rng), hboost::end(rng), comp_pred);
    return rng;
}
...
{
    HBOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::make_heap(hboost::begin(rng), hboost::end(rng));
    return rng;
}
...
{
    HBOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::make_heap(hboost::begin(rng), hboost::end(rng), comp_pred);
    return rng;
}
...
{
    HBOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::sort_heap(hboost::begin(rng), hboost::end(rng));
    return rng;
}
...
{
    HBOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::sort_heap(hboost::begin(rng), hboost::end(rng), comp_pred);
    return rng;
}
