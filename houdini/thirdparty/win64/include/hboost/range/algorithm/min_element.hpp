...
//
#ifndef HBOOST_RANGE_ALGORITHM_MIN_ELEMENT_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_MIN_ELEMENT_HPP_INCLUDED
...
min_element(ForwardRange& rng)
{
    ...
    return std::min_element(hboost::begin(rng), hboost::end(rng));
}
...
{
    HBOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return std::min_element(hboost::begin(rng), hboost::end(rng), pred);
}
...
min_element(ForwardRange& rng)
{
    ...
    return range_return<ForwardRange,re>::pack(
        std::min_element(hboost::begin(rng), hboost::end(rng)),
        rng);
}
...
min_element(ForwardRange& rng, BinaryPredicate pred)
{
    HBOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return range_return<ForwardRange,re>::pack(
        std::min_element(hboost::begin(rng), hboost::end(rng), pred),
        rng);
}
