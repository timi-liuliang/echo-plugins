...
//
#ifndef HBOOST_RANGE_ALGORITHM_ROTATE_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_ROTATE_HPP_INCLUDED
...
inline ForwardRange& rotate(ForwardRange& rng,
    HBOOST_DEDUCED_TYPENAME range_iterator<ForwardRange>::type middle)
{
    HBOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    std::rotate(hboost::begin(rng), middle, hboost::end(rng));
    return rng;
}
