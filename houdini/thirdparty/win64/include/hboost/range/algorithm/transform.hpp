...
//
#ifndef HBOOST_RANGE_ALGORITHM_TRANSFORM_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_TRANSFORM_HPP_INCLUDED
...
namespace hboost
{
    namespace range
    {
                  ...
                  UnaryOperation          fun)
        {
            ...
            return std::transform(hboost::begin(rng),hboost::end(rng),out,fun);
        }
    ...
    namespace range
    {
                  ...
                  BinaryOperation         fun)
        {
            ...
            return hboost::range_detail::transform_impl(
