...
#ifndef HBOOST_RANGE_AS_LITERAL_HPP
#define HBOOST_RANGE_AS_LITERAL_HPP
...
#include <hboost/range/detail/as_literal.hpp>
#else
...
namespace hboost
{
    namespace range_detail
    {
        ...
        template< class T >
        inline iterator_range<HBOOST_DEDUCED_TYPENAME range_iterator<T>::type>
        make_range( T& r, long )
        {
