...
//
#ifndef HBOOST_RANGE_ADAPTOR_STRIDED_HPP_INCLUDED
#define HBOOST_RANGE_ADAPTOR_STRIDED_HPP_INCLUDED
...
namespace hboost
{
    namespace range_detail
    {
        ...
        public:
            ...
            typedef typename super_t::reference reference;
            typedef BaseIterator base_iterator;
            typedef typename hboost::make_unsigned<difference_type>::type
                        size_type;
        ...
        private:
            ...
            {
                HBOOST_ASSERT((other.m_index - m_index) % m_stride == difference_type());
            ...
            forward_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                forward_traversal_tag
            >(hboost::begin(rng), hboost::end(rng), stride);
        }
            ...
            forward_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                forward_traversal_tag
            >(hboost::end(rng), hboost::end(rng), stride);
        }
            ...
            bidirectional_traversal_tag)
        {
            ...
            return strided_iterator<
                typename range_iterator<Rng>::type,
                bidirectional_traversal_tag
            >(hboost::begin(rng), difference_type(), stride);
        }
            ...
            bidirectional_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                bidirectional_traversal_tag
            >(hboost::end(rng), hboost::size(rng), stride);
        }
            ...
            random_access_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                random_access_traversal_tag
            >(hboost::begin(rng), hboost::begin(rng), stride);
        }
