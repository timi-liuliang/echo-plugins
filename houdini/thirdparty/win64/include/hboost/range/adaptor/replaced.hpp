...
#ifndef HBOOST_RANGE_ADAPTOR_REPLACED_IMPL_HPP_INCLUDED
#define HBOOST_RANGE_ADAPTOR_REPLACED_IMPL_HPP_INCLUDED
...
namespace hboost
{
    namespace range_detail
    {
        ...
        class replaced_range :
            public hboost::iterator_range<
                hboost::transform_iterator<
                    replace_value< HBOOST_DEDUCED_TYPENAME range_value<R>::type >,
                    HBOOST_DEDUCED_TYPENAME range_iterator<R>::type > >
        {
        private:
            typedef replace_value< HBOOST_DEDUCED_TYPENAME range_value<R>::type > Fn;
        ...
        public:
            ...
            replaced_range( R& r, value_type from, value_type to )
                : base_t( make_transform_iterator( hboost::begin(r), Fn(from, to) ),
                          make_transform_iterator( hboost::end(r), Fn(from, to) ) )
            { }
        };
    ...
    namespace adaptors
    {
        ...
        replace(SinglePassRange& rng,
                HBOOST_DEDUCED_TYPENAME range_value<SinglePassRange>::type from,
