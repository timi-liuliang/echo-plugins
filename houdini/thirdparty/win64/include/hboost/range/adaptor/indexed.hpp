...
//
#ifndef HBOOST_RANGE_ADAPTOR_INDEXED_HPP_INCLUDED
#define HBOOST_RANGE_ADAPTOR_INDEXED_HPP_INCLUDED

#include <hboost/range/config.hpp>
#include <hboost/range/adaptor/argument_fwd.hpp>
#include <hboost/range/iterator_range.hpp>
#include <hboost/range/traversal.hpp>
...
// useful in HBOOST_FOREACH() expressions that have pitfalls with commas
...
public:
    ...
    index_type index()
    {
        return hboost::tuples::get<0>(*this);
    }
    ...
    value_type value()
    {
        return hboost::tuples::get<1>(*this);
    }
...
{
    typedef ::hboost::range::index_value<
...
public:
 ...
 private:
    ...
    void decrement()
    {
        HBOOST_ASSERT_MSG(m_index > 0, "indexed Iterator out of bounds");
        --m_index;
        --m_it;
    }
    ...
    >
{
    ...
    HBOOST_RANGE_CONCEPT_ASSERT((
        hboost::SinglePassRangeConcept<SinglePassRange>));
public:
    ...
    indexed_range(
        ...
        : base_t(iterator(hboost::begin(r), i),
                 iterator(hboost::end(r), i))
    {
    }
    ...
    indexed_range(
        ...
        : base_t(iterator(hboost::begin(r), i),
                 iterator(hboost::end(r), i + hboost::size(r)))
    {
    }
};
...
{
    HBOOST_RANGE_CONCEPT_ASSERT((
        hboost::SinglePassRangeConcept<const SinglePassRange>
    ));
