...
#ifndef HBOOST_RANGE_ADAPTOR_TRANSFORMED_HPP
#define HBOOST_RANGE_ADAPTOR_TRANSFORMED_HPP

#include <hboost/range/adaptor/argument_fwd.hpp>
#include <hboost/range/detail/default_constructible_unary_fn.hpp>
...
namespace hboost
{
    namespace range_detail
    {
        ...
        private:
            ...
            typedef hboost::iterator_range<transform_iter_t> base;
        ...
        public:
            ...
            transformed_range(transform_fn_type f, R& r)
                : base(transform_iter_t(hboost::begin(r), f),
                       transform_iter_t(hboost::end(r), f))
            {
            }
        };
