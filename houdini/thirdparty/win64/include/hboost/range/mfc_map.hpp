...
#ifndef HBOOST_RANGE_ADAPTOR_MFC_MAP_HPP
#define HBOOST_RANGE_ADAPTOR_MFC_MAP_HPP

#if !defined(HBOOST_RANGE_MFC_NO_CPAIR)

#include <hboost/range/mfc.hpp>
#include <hboost/range/adaptor/map.hpp>
...
namespace hboost
{
    namespace range_detail
    {
        ...
        {
            typedef HBOOST_DEDUCED_TYPENAME CMap<KEY, ARG_KEY, VALUE, ARG_VALUE> map_type;
            typedef HBOOST_DEDUCED_TYPENAME range_reference<const map_type>::type argument_type;
            typedef HBOOST_DEDUCED_TYPENAME const KEY& result_type;
        ...
        {
            typedef HBOOST_DEDUCED_TYPENAME CMap<KEY, ARG_KEY, VALUE, ARG_VALUE> map_type;
            typedef HBOOST_DEDUCED_TYPENAME range_reference<map_type>::type argument_type;
            typedef HBOOST_DEDUCED_TYPENAME VALUE& result_type;
        ...
        struct select_second_const< CMap<KEY, ARG_KEY, VALUE, ARG_VALUE> >
        {
            typedef HBOOST_DEDUCED_TYPENAME CMap<KEY, ARG_KEY, VALUE, ARG_VALUE> map_type;
            typedef HBOOST_DEDUCED_TYPENAME range_reference<const map_type>::type argument_type;
            typedef HBOOST_DEDUCED_TYPENAME const VALUE& result_type;
