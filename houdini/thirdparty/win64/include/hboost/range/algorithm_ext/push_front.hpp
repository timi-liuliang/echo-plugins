...
//
#ifndef HBOOST_RANGE_ALGORITHM_EXT_PUSH_FRONT_HPP_INCLUDED
#define HBOOST_RANGE_ALGORITHM_EXT_PUSH_FRONT_HPP_INCLUDED
...
inline Container& push_front( Container& on, const Range& from )
{
    ...
    on.insert( on.begin(), hboost::begin(from), hboost::end(from) );
    return on;
}
