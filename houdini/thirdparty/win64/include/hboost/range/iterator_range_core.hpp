...
// to function types.
//
#ifndef HBOOST_RANGE_ITERATOR_RANGE_CORE_HPP_INCLUDED
#define HBOOST_RANGE_ITERATOR_RANGE_CORE_HPP_INCLUDED

#include <hboost/config.hpp> // Define __STL_CONFIG_H, if appropriate.
...
#include <hboost/range/detail/safe_bool.hpp>
...
namespace hboost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( hboost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( hboost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( hboost::begin(l),
                                                 hboost::end(l),
                                                 hboost::begin(r),
                                                 hboost::end(r) );
        }
...
incrementable_t test_traversal_tag(hboost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(hboost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(hboost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef hboost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef hboost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef hboost::random_access_traversal_tag type;
};
...
{
    typedef
        HBOOST_DEDUCED_TYPENAME iterator_traversal<IteratorT>::type
    traversal_t;
    ...
    typedef
        HBOOST_DEDUCED_TYPENAME pure_iterator_traversal_impl<traversal_i>::type
    type;
};
...
public:
   ...
   {
       HBOOST_ASSERT(n >= difference_type());
...
public:
    typedef HBOOST_DEDUCED_TYPENAME base_type::difference_type difference_type;
    typedef HBOOST_DEDUCED_TYPENAME base_type::reference reference;

    reference back() const
    {
        HBOOST_ASSERT(!this->empty());
        return *hboost::prior(this->m_End);
    }
...
public:
    typedef HBOOST_DEDUCED_TYPENAME
        hboost::mpl::if_<
            hboost::mpl::or_<
                hboost::is_abstract<
                    HBOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                hboost::is_array<
                    HBOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                ...
                >
            >,
            HBOOST_DEDUCED_TYPENAME base_type::reference,
            HBOOST_DEDUCED_TYPENAME base_type::value_type
...
public:
    ...
    {
        HBOOST_ASSERT(at >= 0);
        HBOOST_ASSERT(static_cast<typename base_type::size_type>(at) < size());
    ...
    HBOOST_DEDUCED_TYPENAME base_type::size_type size() const
    {
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                hboost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        class iterator_range
            : public iterator_range_detail::iterator_range_base<
                    IteratorT,
                    HBOOST_DEDUCED_TYPENAME iterator_range_detail::pure_iterator_traversal<IteratorT>::type
                >
        {
            ...
            struct is_compatible_range_
              : is_convertible<
                    HBOOST_DEDUCED_TYPENAME mpl::eval_if<
                        ...
                        mpl::identity<void>
                    >::type,
                    HBOOST_DEDUCED_TYPENAME base_type::iterator
                >
            {
            };
        ...
        public:
            ...
            iterator_range& advance_begin(
                HBOOST_DEDUCED_TYPENAME base_type::difference_type n)
            {
                std::advance(this->m_Begin, n);
                return *this;
            }
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline HBOOST_DEDUCED_TYPENAME hboost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline HBOOST_DEDUCED_TYPENAME hboost::enable_if<
            mpl::not_<hboost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, hboost::next(first, n));
        }
        ...
        {
            return iterator_range< HBOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( hboost::begin( r ), hboost::end( r ) );
        }
        ...
        */
        template< class ForwardRange >
        inline iterator_range< HBOOST_DEDUCED_TYPENAME range_iterator<ForwardRange>::type >
        make_iterator_range( ForwardRange& r )
        {
           return iterator_range< HBOOST_DEDUCED_TYPENAME range_iterator<ForwardRange>::type >
                ( r, iterator_range_detail::range_tag() );
        }

        template< class ForwardRange >
        inline iterator_range< HBOOST_DEDUCED_TYPENAME range_iterator<const ForwardRange>::type >
        make_iterator_range( const ForwardRange& r )
        {
           return iterator_range< HBOOST_DEDUCED_TYPENAME range_iterator<const ForwardRange>::type >
        ...
        namespace iterator_range_detail
        {
            ...
            make_range_impl( Range& r,
                             HBOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_begin,
                             HBOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                //
                ...
                HBOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = hboost::begin( r ),
                    new_end   = hboost::end( r );
        ...
        template< class Range >
        inline iterator_range< HBOOST_DEDUCED_TYPENAME range_iterator<const Range>::type >
        ...
        */
        ...
        {
            return SeqT( hboost::begin( r ), hboost::end( r ) );
        }
