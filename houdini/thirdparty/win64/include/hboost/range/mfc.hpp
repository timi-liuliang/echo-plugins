#ifndef HBOOST_RANGE_MFC_HPP
#define HBOOST_RANGE_MFC_HPP
...
#if !defined(HBOOST_RANGE_MFC_NO_CPAIR)
    #if (_MFC_VER < 0x0700) // dubious
        #define HBOOST_RANGE_MFC_NO_CPAIR
    #endif
#endif


#if !defined(HBOOST_RANGE_MFC_HAS_LEGACY_STRING)
    #if (_MFC_VER < 0x0700) // dubious
        #define HBOOST_RANGE_MFC_HAS_LEGACY_STRING
    #endif
#endif
...
//
#if !defined(HBOOST_RANGE_MFC_CONST_COL_RETURNS_NON_REF)
    #if (_MFC_VER < 0x0700) // dubious
        #define HBOOST_RANGE_MFC_CONST_COL_RETURNS_NON_REF
    #endif
#endif
...
#include <hboost/range/atl.hpp>
#include <hboost/range/begin.hpp>
#include <hboost/range/const_iterator.hpp>
#include <hboost/range/detail/microsoft.hpp>
...
namespace hboost { namespace range_detail_microsoft {
    ...
    public:
        ...
        explicit mfc_ptr_array_iterator(ArrayT& arr, INT_PTR index) :
            super_t(index), m_parr(hboost::addressof(arr))
        { }
    ...
    friend class iterator_core_access;
        ...
        {
            HBOOST_ASSERT(0 <= this->base() && this->base() < m_parr->GetSize() && "out of range");
            return *( m_parr->GetData() + this->base() );
        }

        bool equal(self_t const& other) const
        {
            HBOOST_ASSERT(m_parr == other.m_parr && "iterators incompatible");
    ...
    public:
        ...
        explicit mfc_map_iterator(MapT const& map, POSITION pos) :
            m_pmap(hboost::addressof(map)), m_posNext(pos)
        {
            increment();
        }
    ...
    friend class iterator_core_access;
        ...
        bool equal(self_t const& other) const
        {
            HBOOST_ASSERT(m_pmap == other.m_pmap && "iterators incompatible");
    ...
    public:
        ...
        explicit mfc_cpair_map_iterator(MapT& map, PairT *pp) :
            m_pmap(hboost::addressof(map)), m_pp(pp)
        { }
    ...
    friend class iterator_core_access;
        ref_t dereference() const
        {
            HBOOST_ASSERT(m_pp != 0 && "out of range");
            return *m_pp;
        }
...
#endif // !defined(HBOOST_RANGE_MFC_NO_CPAIR)
    ...
    struct customization< ::CTypedPtrArray<BaseClass, PtrType> >
    {
        ...
        Iterator begin(X& x)
        {
            return Iterator(hboost::begin<BaseClass>(x), fun<X>());
        }

        template< class Iterator, class X >
        Iterator end(X& x)
        {
            return Iterator(hboost::end<BaseClass>(x), fun<X>());
        }
    };
...
#endif // defined(HBOOST_RANGE_MFC_HAS_LEGACY_STRING)
...
// arrays
//
HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CByteArray
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CDWordArray
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CStringArray
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CUIntArray
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CWordArray
)
...
HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CObList
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CPtrList
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CStringList
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CObArray
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CPtrArray
)
...
HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CMapPtrToWord
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CMapPtrToPtr
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CMapStringToOb
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CMapStringToPtr
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CMapStringToString
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CMapWordToOb
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CMapWordToPtr
)


// templates
//
HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CArray, 2
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CList, 2
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CMap, 4
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CTypedPtrArray, 2
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CTypedPtrList, 2
)

HBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    hboost::range_detail_microsoft::using_type_as_tag,
    HBOOST_PP_NIL, CTypedPtrMap, 3
)
