...
#ifndef HBOOST_NEXT_PRIOR_HPP_INCLUDED
#define HBOOST_NEXT_PRIOR_HPP_INCLUDED
...
//    const std::list<T>::iterator prev = hboost::prior(p);
//    const std::list<T>::iterator next = hboost::next(prev, 2);
...
#endif  // HBOOST_NEXT_PRIOR_HPP_INCLUDED
