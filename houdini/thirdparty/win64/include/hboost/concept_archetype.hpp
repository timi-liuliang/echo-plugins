...
#ifndef HBOOST_CONCEPT_ARCHETYPES_HPP
#define HBOOST_CONCEPT_ARCHETYPES_HPP
...
#define HBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(OP, NAME)                       \
  ...
  HBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(==, equal_op)
  HBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(!=, not_equal_op)
  HBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(<, less_than_op)
  HBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(<=, less_equal_op)
  HBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(>, greater_than_op)
  HBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(>=, greater_equal_op)

#define HBOOST_DEFINE_OPERATOR_ARCHETYPE(OP, NAME) \
  template <class Base = null_archetype<> > \
  ...
  HBOOST_DEFINE_OPERATOR_ARCHETYPE(+, addable)
  HBOOST_DEFINE_OPERATOR_ARCHETYPE(-, subtractable)
  HBOOST_DEFINE_OPERATOR_ARCHETYPE(*, multipliable)
  HBOOST_DEFINE_OPERATOR_ARCHETYPE(/, dividable)
  HBOOST_DEFINE_OPERATOR_ARCHETYPE(%, modable)

  // As is, these are useless because of the return type.
  // Need to invent a better way...
#define HBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(OP, NAME) \
  ...
  HBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(+, plus_op)
  HBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(*, time_op)
  HBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(/, divide_op)
  HBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(-, subtract_op)
  HBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(%, mod_op)
...
#endif // HBOOST_CONCEPT_ARCHETYPES_H
