...
#ifndef HBOOST_TT_ALIGNMENT_OF_HPP_INCLUDED
#define HBOOST_TT_ALIGNMENT_OF_HPP_INCLUDED
...
{
    HBOOST_STATIC_CONSTANT(std::size_t, value = A < S ? A : S);
};
...
struct alignment_of_impl
{
    ...
    HBOOST_STATIC_CONSTANT(std::size_t, value =
        (::hboost::detail::alignment_logic<
            sizeof(::hboost::detail::alignment_of_hack<T>) - sizeof(T),
            __alignof(T)
        >::value));
#elif !defined(HBOOST_ALIGNMENT_OF)
    HBOOST_STATIC_CONSTANT(std::size_t, value =
        (::hboost::detail::alignment_logic<
            sizeof(::hboost::detail::alignment_of_hack<T>) - sizeof(T),
            sizeof(T)
   ...
   //
   HBOOST_STATIC_CONSTANT(std::size_t, value = HBOOST_ALIGNMENT_OF(T));
#endif
};

} // namespace detail

template <class T> struct alignment_of : public integral_constant<std::size_t, ::hboost::detail::alignment_of_impl<T>::value>{};
...
#endif // HBOOST_TT_ALIGNMENT_OF_HPP_INCLUDED
