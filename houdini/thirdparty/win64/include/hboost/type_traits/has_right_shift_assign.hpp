...
#ifndef HBOOST_TT_HAS_RIGHT_SHIFT_ASSIGN_HPP_INCLUDED
#define HBOOST_TT_HAS_RIGHT_SHIFT_ASSIGN_HPP_INCLUDED

#define HBOOST_TT_TRAIT_NAME has_right_shift_assign
