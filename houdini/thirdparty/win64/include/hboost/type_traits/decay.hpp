...
#ifndef HBOOST_TT_DECAY_HPP_INCLUDED
#define HBOOST_TT_DECAY_HPP_INCLUDED
...
namespace hboost 
{
   ...
   namespace detail
   {
    ...
    public:
       typedef typename hboost::detail::decay_imp<Ty, hboost::is_array<Ty>::value, hboost::is_function<Ty>::value>::type type;
    };
    
} // namespace hboost


#endif // HBOOST_TT_DECAY_HPP_INCLUDED
