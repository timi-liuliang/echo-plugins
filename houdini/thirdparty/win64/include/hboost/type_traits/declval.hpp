...
#ifndef HBOOST_TYPE_TRAITS_DECLVAL_HPP_INCLUDED
#define HBOOST_TYPE_TRAITS_DECLVAL_HPP_INCLUDED
...
namespace hboost {
    ...
    template <typename T>
    typename add_rvalue_reference<T>::type declval() HBOOST_NOEXCEPT; // as unevaluated operand

}  // namespace hboost

#endif  // HBOOST_TYPE_TRAITS_DECLVAL_HPP_INCLUDED
