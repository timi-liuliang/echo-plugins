...
#ifndef HBOOST_TT_IS_INTEGRAL_HPP_INCLUDED
#define HBOOST_TT_IS_INTEGRAL_HPP_INCLUDED
...
// Same set of integral types as in hboost/type_traits/integral_promotion.hpp.
...
template<> struct is_integral< ::hboost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::hboost::long_long_type> : public true_type{};
...
template<> struct is_integral<hboost::int128_type> : public true_type{};
template<> struct is_integral<hboost::uint128_type> : public true_type{};
#endif
...
#endif // HBOOST_TT_IS_INTEGRAL_HPP_INCLUDED
