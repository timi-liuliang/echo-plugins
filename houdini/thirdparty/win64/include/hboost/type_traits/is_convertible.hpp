...
#ifndef HBOOST_TT_IS_CONVERTIBLE_HPP_INCLUDED
#define HBOOST_TT_IS_CONVERTIBLE_HPP_INCLUDED

#include <hboost/type_traits/intrinsics.hpp>
#include <hboost/type_traits/integral_constant.hpp>
#ifndef HBOOST_IS_CONVERTIBLE
...
#if !defined(HBOOST_NO_IS_ABSTRACT)
...
#endif
#if !defined(HBOOST_NO_SFINAE_EXPR) && !defined(HBOOST_NO_CXX11_RVALUE_REFERENCES)
#  include <hboost/type_traits/declval.hpp>
#endif
#elif defined(HBOOST_MSVC) || defined(HBOOST_INTEL)
#include <hboost/type_traits/is_function.hpp>
#include <hboost/type_traits/is_same.hpp>
#endif // HBOOST_IS_CONVERTIBLE
...
#if !defined(HBOOST_NO_SFINAE_EXPR) && !defined(HBOOST_NO_CXX11_RVALUE_REFERENCES) && !(defined(HBOOST_GCC) && (HBOOST_GCC < 40700))

   // This is a C++11 conforming version, place this first and use it wherever possible:

#  define HBOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<hboost::is_void<From>, hboost::is_function<To>, hboost::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(hboost::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::hboost::type_traits::no_type HBOOST_TT_DECL _m_check(...);
        static ::hboost::type_traits::yes_type HBOOST_TT_DECL _m_check(T);
    };
...
template <typename T> struct checker
{
    static hboost::type_traits::no_type _m_check(any_conversion ...);
    static hboost::type_traits::yes_type _m_check(T, int);
};
...
#if !defined(HBOOST_NO_CXX11_RVALUE_REFERENCES) && ((__GNUC__ > 4) || ((__GNUC__ == 4) && (__GNUC_MINOR__ > 6)))
    static bool const value =
        sizeof( hboost::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::hboost::type_traits::yes_type);
#else
    static bool const value =
        sizeof( hboost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::hboost::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::hboost::type_traits::no_type HBOOST_TT_DECL _m_check(any_conversion ...);
    static ::hboost::type_traits::yes_type HBOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    HBOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::hboost::type_traits::yes_type)
        );
#else
    HBOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::hboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::hboost::type_traits::no_type HBOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::hboost::type_traits::yes_type HBOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef HBOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::hboost::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::hboost::type_traits::yes_type)
        };
#endif
};
...
{
    static ::hboost::type_traits::no_type HBOOST_TT_DECL _m_check(...);
    static ::hboost::type_traits::yes_type HBOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef HBOOST_NO_CXX11_RVALUE_REFERENCES
    HBOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::hboost::type_traits::yes_type)
        );
#else
    HBOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::hboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::hboost::is_function<typename ::hboost::remove_reference<From>::type>::value
  >
{};
...
{
    enum { 
       value = ( ::hboost::detail::is_convertible_basic_impl<From,To>::value && ! ::hboost::is_array<To>::value && ! ::hboost::is_function<To>::value) 
    };
};
...
struct is_convertible_impl
{
   HBOOST_STATIC_CONSTANT(bool, value = ( ::hboost::detail::is_convertible_basic_impl<From, To>::value && !::hboost::is_array<To>::value && !::hboost::is_function<To>::value));
};
#endif
...
{
#if !HBOOST_WORKAROUND(__HP_aCC, < 60700)
   typedef is_convertible_impl_select< 
      ::hboost::is_arithmetic<From>::value, 
      ::hboost::is_arithmetic<To>::value,
#if !defined(HBOOST_NO_IS_ABSTRACT) && !defined(HBOOST_TT_CXX11_IS_CONVERTIBLE)
      // We need to filter out abstract types, only if we don't have a strictly conforming C++11 version:
      ::hboost::is_abstract<To>::value
#else
      false
#endif
   > selector;
...
#else
template <> struct is_convertible_impl_dispatch<void, void> : public true_type{};
#endif // HBOOST_NO_CV_VOID_SPECIALIZATIONS
...
template <class From, class To> 
struct is_convertible : public integral_constant<bool, ::hboost::detail::is_convertible_impl_dispatch<From, To>::value> {};

#else

template <class From, class To>
struct is_convertible : public integral_constant<bool, HBOOST_IS_CONVERTIBLE(From, To)> {};

#endif

} // namespace hboost

#endif // HBOOST_TT_IS_CONVERTIBLE_HPP_INCLUDED
