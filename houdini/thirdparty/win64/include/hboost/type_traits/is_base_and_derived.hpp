...
#ifndef HBOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED
#define HBOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED

#include <hboost/type_traits/intrinsics.hpp>
#include <hboost/type_traits/integral_constant.hpp>
#ifndef HBOOST_IS_BASE_OF
...
namespace detail {
 ...
 && !HBOOST_WORKAROUND(__SUNPRO_CC , <= 0x540) \
...
#pragma warning(disable:6334)
    ...
    //
    HBOOST_STATIC_ASSERT(sizeof(B) != 0);
    HBOOST_STATIC_ASSERT(sizeof(D) != 0);
...
{
    HBOOST_STATIC_CONSTANT(bool, value =
        (::hboost::is_convertible<D*,B*>::value));
};

#define HBOOST_BROKEN_IS_BASE_AND_DERIVED
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::hboost::is_class<B>::value,
       ::hboost::is_class<D>::value,
       ::hboost::is_same<ncvB,ncvD>::value> selector;
    typedef typename selector::template rebind<ncvB,ncvD> binder;
    typedef typename binder::type bound_type;

    HBOOST_STATIC_CONSTANT(bool, value = bound_type::value);
};
#else
template <typename B, typename D>
struct is_base_and_derived_impl
{
    ...
    HBOOST_STATIC_CONSTANT(bool, value = (HBOOST_IS_BASE_OF(B,D) && ! ::hboost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail

template <class Base, class Derived> struct is_base_and_derived
   : public integral_constant<bool, (::hboost::detail::is_base_and_derived_impl<Base, Derived>::value)> {};
...
#endif // HBOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED
