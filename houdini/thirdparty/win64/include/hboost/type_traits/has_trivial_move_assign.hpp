...
#ifndef HBOOST_TT_HAS_TRIVIAL_MOVE_ASSIGN_HPP_INCLUDED
#define HBOOST_TT_HAS_TRIVIAL_MOVE_ASSIGN_HPP_INCLUDED

#include <hboost/type_traits/intrinsics.hpp>
#include <hboost/type_traits/integral_constant.hpp>

#if !defined(HBOOST_HAS_TRIVIAL_MOVE_ASSIGN) || defined(HBOOST_MSVC) || defined(HBOOST_INTEL)
...
#ifdef HBOOST_HAS_TRIVIAL_MOVE_ASSIGN
   HBOOST_HAS_TRIVIAL_MOVE_ASSIGN(T)
#else
   ::hboost::is_pod<T>::value && !::hboost::is_const<T>::value && !::hboost::is_volatile<T>::value SOLARIS_EXTRA_CHECK
#endif
   > {};
...
#endif // HBOOST_TT_HAS_TRIVIAL_MOVE_ASSIGN_HPP_INCLUDED
