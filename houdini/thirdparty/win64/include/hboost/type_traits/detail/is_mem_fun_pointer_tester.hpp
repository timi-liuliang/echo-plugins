...
#ifndef HBOOST_TT_DETAIL_IS_MEM_FUN_POINTER_TESTER_HPP_INCLUDED
#define HBOOST_TT_DETAIL_IS_MEM_FUN_POINTER_TESTER_HPP_INCLUDED
...
#include PPI
#undef PPI
#define <hboost/preprocessor/comma_if.hpp>
#include PPI
#undef
#endif
...
no_type HBOOST_TT_DECL is_mem_fun_pointer_tester(...);
...
template <class R, class T >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)( ...) const volatile);
#ifdef HBOOST_TT_TEST_MS_FUNC_SIGS
template <class R, class T >
...
#define HBOOST_PP_ITERATION_PARAMS_1 \
    (3, (0, 25, "hboost/type_traits/detail/is_mem_fun_pointer_tester.hpp"))
...
#endif // HBOOST_TT_DETAIL_IS_MEM_FUN_POINTER_TESTER_HPP_INCLUDED
...
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)));

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) const);

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) volatile);

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) const volatile);
...
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T) ...) const volatile);
@#endif
@#ifdef HBOOST_TT_TEST_MS_FUNC_SIGS // Other calling conventions used by MS compatible compilers:
template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)));

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) const);

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) volatile);

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) const volatile);

@#ifndef _MANAGED
template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)));

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) const);

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) volatile);

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) const volatile);

@#endif

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)));

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) const);

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) volatile);

template <class R, class T HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)) const volatile);
