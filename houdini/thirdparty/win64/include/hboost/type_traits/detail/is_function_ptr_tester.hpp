...
#ifndef HBOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
#define HBOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
...
#define PP2 <hboost/preprocessor/enum_params.hpp>
#define PP3 <hboost/preprocessor/comma_if.hpp>
#include PP1
#include PP2
#include PP3
#undef PP1
...
no_type HBOOST_TT_DECL is_function_ptr_tester(...);
...
#define HBOOST_PP_ITERATION_PARAMS_1 \
    (3, (0, 25, "hboost/type_traits/detail/is_function_ptr_tester.hpp"))
...
#endif // HBOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
...
yes_type is_function_ptr_tester(R (*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)));
...
@#ifdef HBOOST_TT_TEST_MS_FUNC_SIGS
template <class R HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__stdcall*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)));
@#ifndef _MANAGED
template <class R HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__fastcall*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)));
@#endif
template <class R HBOOST_PP_COMMA_IF(HBOOST_PP_COUNTER) HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__cdecl*)(HBOOST_PP_ENUM_PARAMS(HBOOST_PP_COUNTER,T)));
@#endif
