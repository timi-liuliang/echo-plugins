...
#ifndef HBOOST_TT_HAS_LOGICAL_AND_HPP_INCLUDED
#define HBOOST_TT_HAS_LOGICAL_AND_HPP_INCLUDED

#define HBOOST_TT_TRAIT_NAME has_logical_and
   ...
   (\
      (\
         ...
         ( \
            ...
            (!  ::hboost::is_convertible< Rhs_nocv, bool >::value )\
          )\
      )||\
      (\
         ...
         ( \
            ...
            (!  ::hboost::is_convertible< Lhs_nocv, bool >::value )\
         )\
      )\
      )
