...
#ifndef HBOOST_TYPE_TRAITS_IS_FLOATING_HPP_INCLUDED
#define HBOOST_TYPE_TRAITS_IS_FLOATING_HPP_INCLUDED
...
#if defined(HBOOST_HAS_FLOAT128)
   template<> struct is_floating_point<__float128> : public true_type{};
#endif

} // namespace hboost

#endif // HBOOST_TYPE_TRAITS_IS_FLOAT_HPP_INCLUDED
