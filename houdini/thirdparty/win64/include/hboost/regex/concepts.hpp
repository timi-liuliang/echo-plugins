...
#ifndef HBOOST_REGEX_CONCEPTS_HPP_INCLUDED
#define HBOOST_REGEX_CONCEPTS_HPP_INCLUDED
...
//
template <class T>
class hboost_allocator_architype
{
public:
   typedef T* pointer;
   ...
   struct rebind
   {
      typedef hboost_allocator_architype<U> other;
   };
   ...
   hboost_allocator_architype();
   hboost_allocator_architype(const hboost_allocator_architype&);

   template <class Other>
   hboost_allocator_architype(const hboost_allocator_architype<Other>&);
...
template <class T>
bool operator == (const hboost_allocator_architype<T>&, const hboost_allocator_architype<T>&);
template <class T>
bool operator != (const hboost_allocator_architype<T>&, const hboost_allocator_architype<T>&);
...
//
#ifndef HBOOST_TEST_TR1_REGEX
namespace global_regex_namespace = ::hboost;
#else
...
struct BaseRegexConcept
{
   ...
   typedef global_regex_namespace::match_results<BidiIterator, hboost_allocator_architype<sub_match_type> > match_results_type;
   ...
   void global_constraints()
   {
      ...
      HBOOST_STATIC_ASSERT((::hboost::is_enum<global_regex_namespace::regex_constants::error_type>::value));
      ...
      HBOOST_STATIC_ASSERT((::hboost::is_base_and_derived<std::runtime_error, global_regex_namespace::regex_error>::value  ));
   ...
   void constraints() 
   {
      ...
      HBOOST_STATIC_ASSERT((::hboost::is_same< flag_type, global_regex_namespace::regex_constants::syntax_option_type>::value));
      flag_type opts
         = Regex::icase
         | Regex::nosubs
         | Regex::optimize
      ...
      // sub_match:
      HBOOST_STATIC_ASSERT((::hboost::is_base_and_derived<std::pair<BidiIterator, BidiIterator>, sub_match_type>::value));
      ...
      HBOOST_STATIC_ASSERT((::hboost::is_same<sub_value_type, value_type>::value));
      HBOOST_STATIC_ASSERT((::hboost::is_same<sub_iter_type, BidiIterator>::value));
      ...
      HBOOST_STATIC_ASSERT((::hboost::is_same<rit_regex_type, Regex>::value));
      HBOOST_STATIC_ASSERT((::hboost::is_same<rit_value_type, match_results_default_type>::value));
      HBOOST_STATIC_ASSERT((::hboost::is_same<rit_difference_type, std::ptrdiff_t>::value));
      HBOOST_STATIC_ASSERT((::hboost::is_same<rit_pointer, const match_results_default_type*>::value));
      HBOOST_STATIC_ASSERT((::hboost::is_same<rit_reference, const match_results_default_type&>::value));
      HBOOST_STATIC_ASSERT((::hboost::is_convertible<rit_iterator_category*, std::forward_iterator_tag*>::value));
      ...
      HBOOST_STATIC_ASSERT((::hboost::is_same<rtit_regex_type, Regex>::value));
      HBOOST_STATIC_ASSERT((::hboost::is_same<rtit_value_type, sub_match_type>::value));
      HBOOST_STATIC_ASSERT((::hboost::is_same<rtit_difference_type, std::ptrdiff_t>::value));
      HBOOST_STATIC_ASSERT((::hboost::is_same<rtit_pointer, const sub_match_type*>::value));
      HBOOST_STATIC_ASSERT((::hboost::is_same<rtit_reference, const sub_match_type&>::value));
      HBOOST_STATIC_ASSERT((::hboost::is_convertible<rtit_iterator_category*, std::forward_iterator_tag*>::value));
      // this takes care of most of the checks needed:
   ...
   global_regex_namespace::match_results<
      pointer_type, 
      hboost_allocator_architype<global_regex_namespace::sub_match<pointer_type> > > 
      m_pmatch;
...
struct RegexConcept
{
   ...
   typedef hboost::bidirectional_iterator_archetype<value_type> BidiIterator;
   typedef global_regex_namespace::sub_match<BidiIterator> sub_match_type;
   typedef global_regex_namespace::match_results<BidiIterator, hboost_allocator_architype<sub_match_type> > match_results_type;
   typedef output_iterator_archetype<value_type> OutIterator;
   ...
   BidiIterator m_in;
   global_regex_namespace::regex_constants::match_flag_type m_mft;
   global_regex_namespace::match_results<typename string_type::const_iterator, hboost_allocator_architype<global_regex_namespace::sub_match<typename string_type::const_iterator> > > m_smatch;
...
struct BoostRegexConcept
{
   ...
   void constraints() 
   {
      ...
      out = regex_format(out, m_cresults, hboost::ref(func3b), f);
      out = regex_format(out, m_cresults, hboost::ref(func3b));
      out = regex_format(out, m_cresults, hboost::ref(func2b), f);
      out = regex_format(out, m_cresults, hboost::ref(func2b));
      out = regex_format(out, m_cresults, hboost::ref(func1b), f);
      out = regex_format(out, m_cresults, hboost::ref(func1b));
      out = regex_format(out, m_cresults, hboost::cref(func3b), f);
      out = regex_format(out, m_cresults, hboost::cref(func3b));
      out = regex_format(out, m_cresults, hboost::cref(func2b), f);
      out = regex_format(out, m_cresults, hboost::cref(func2b));
      out = regex_format(out, m_cresults, hboost::cref(func1b), f);
      out = regex_format(out, m_cresults, hboost::cref(func1b));
      ...
      m_string += regex_format(m_cresults, hboost::ref(func3b), f);
      m_string += regex_format(m_cresults, hboost::ref(func3b));
      m_string += regex_format(m_cresults, hboost::ref(func2b), f);
      m_string += regex_format(m_cresults, hboost::ref(func2b));
      m_string += regex_format(m_cresults, hboost::ref(func1b), f);
      m_string += regex_format(m_cresults, hboost::ref(func1b));
      m_string += regex_format(m_cresults, hboost::cref(func3b), f);
      m_string += regex_format(m_cresults, hboost::cref(func3b));
      m_string += regex_format(m_cresults, hboost::cref(func2b), f);
      m_string += regex_format(m_cresults, hboost::cref(func2b));
      m_string += regex_format(m_cresults, hboost::cref(func1b), f);
      m_string += regex_format(m_cresults, hboost::cref(func1b));
      ...
      out = m_cresults.format(out, hboost::ref(func3b), f);
      out = m_cresults.format(out, hboost::ref(func3b));
      out = m_cresults.format(out, hboost::ref(func2b), f);
      out = m_cresults.format(out, hboost::ref(func2b));
      out = m_cresults.format(out, hboost::ref(func1b), f);
      out = m_cresults.format(out, hboost::ref(func1b));
      out = m_cresults.format(out, hboost::cref(func3b), f);
      out = m_cresults.format(out, hboost::cref(func3b));
      out = m_cresults.format(out, hboost::cref(func2b), f);
      out = m_cresults.format(out, hboost::cref(func2b));
      out = m_cresults.format(out, hboost::cref(func1b), f);
      out = m_cresults.format(out, hboost::cref(func1b));
      ...
      m_string += m_cresults.format(hboost::ref(func3b), f);
      m_string += m_cresults.format(hboost::ref(func3b));
      m_string += m_cresults.format(hboost::ref(func2b), f);
      m_string += m_cresults.format(hboost::ref(func2b));
      m_string += m_cresults.format(hboost::ref(func1b), f);
      m_string += m_cresults.format(hboost::ref(func1b));
      m_string += m_cresults.format(hboost::cref(func3b), f);
      m_string += m_cresults.format(hboost::cref(func3b));
      m_string += m_cresults.format(hboost::cref(func2b), f);
      m_string += m_cresults.format(hboost::cref(func2b));
      m_string += m_cresults.format(hboost::cref(func1b), f);
      m_string += m_cresults.format(hboost::cref(func1b));
      ...
      out = regex_replace(out, m_in, m_in, ce, hboost::ref(func3), f);
      out = regex_replace(out, m_in, m_in, ce, hboost::ref(func3));
      out = regex_replace(out, m_in, m_in, ce, hboost::ref(func2), f);
      out = regex_replace(out, m_in, m_in, ce, hboost::ref(func2));
      out = regex_replace(out, m_in, m_in, ce, hboost::ref(func1), f);
      out = regex_replace(out, m_in, m_in, ce, hboost::ref(func1));
      out = regex_replace(out, m_in, m_in, ce, hboost::cref(func3), f);
      out = regex_replace(out, m_in, m_in, ce, hboost::cref(func3));
      out = regex_replace(out, m_in, m_in, ce, hboost::cref(func2), f);
      out = regex_replace(out, m_in, m_in, ce, hboost::cref(func2));
      out = regex_replace(out, m_in, m_in, ce, hboost::cref(func1), f);
      out = regex_replace(out, m_in, m_in, ce, hboost::cref(func1));
      ...
      m_string += regex_replace(m_string, ce, hboost::ref(func3s), f);
      m_string += regex_replace(m_string, ce, hboost::ref(func3s));
      m_string += regex_replace(m_string, ce, hboost::ref(func2s), f);
      m_string += regex_replace(m_string, ce, hboost::ref(func2s));
      m_string += regex_replace(m_string, ce, hboost::ref(func1s), f);
      m_string += regex_replace(m_string, ce, hboost::ref(func1s));
      m_string += regex_replace(m_string, ce, hboost::cref(func3s), f);
      m_string += regex_replace(m_string, ce, hboost::cref(func3s));
      m_string += regex_replace(m_string, ce, hboost::cref(func2s), f);
      m_string += regex_replace(m_string, ce, hboost::cref(func2s));
      m_string += regex_replace(m_string, ce, hboost::cref(func1s), f);
      m_string += regex_replace(m_string, ce, hboost::cref(func1s));
   }
