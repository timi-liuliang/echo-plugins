...
#ifndef HBOOST_REGEX_MFC_HPP
#define HBOOST_REGEX_MFC_HPP
...
make_regex(const ATL::CSimpleStringT<B, b>& s, ::hboost::regex_constants::syntax_option_type f = hboost::regex_constants::normal)
{
...
inline bool regex_match(const ATL::CSimpleStringT<B, b>& s,
                 ...
                 hboost::regex_constants::match_flag_type f = hboost::regex_constants::match_default)
{
   return ::hboost::regex_match(s.GetString(),
...
inline bool regex_search(const ATL::CSimpleStringT<B, b>& s,
                 ...
                 hboost::regex_constants::match_flag_type f = hboost::regex_constants::match_default)
{
   return ::hboost::regex_search(s.GetString(),
                               s.GetString() + s.GetLength(),
                               what,
                               e,
                               f);
...
make_regex_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, ::hboost::regex_constants::match_flag_type f = hboost::regex_constants::match_default)
{
...
inline regex_token_iterator<B const*> 
   make_regex_token_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, int sub = 0, ::hboost::regex_constants::match_flag_type f = hboost::regex_constants::match_default)
{
...
template <class B, bool b>
inline regex_token_iterator<B const*> 
make_regex_token_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, const std::vector<int>& subs, ::hboost::regex_constants::match_flag_type f = hboost::regex_constants::match_default)
{
...
inline regex_token_iterator<B const*> 
make_regex_token_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, const int (& subs)[N], ::hboost::regex_constants::match_flag_type f = hboost::regex_constants::match_default)
{
   regex_token_iterator<B const*> result(s.GetString(), s.GetString() + s.GetLength(), e, subs, f);
   return result;
}
...
{
   return ::hboost::regex_replace(out, first, last, e, fmt.GetString(), flags);
}
                            ...
                            match_flag_type flags = match_default)
{
   ...
   HBOOST_REGEX_DETAIL_NS::mfc_string_out_iterator<B, b> i(result);
