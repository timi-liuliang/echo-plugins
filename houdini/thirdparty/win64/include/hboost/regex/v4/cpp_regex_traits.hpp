...
#define HBOOST_CPP_REGEX_TRAITS_HPP_INCLUDED
...
{
   typedef typename hboost::int_t<sizeof(way) * CHAR_BIT>::least cast_type;
...
std::locale cpp_regex_traits_base<charT>::imbue(const std::locale& l)
{
   ...
   m_locale = l;
   m_pctype = &HBOOST_USE_FACET(std::ctype<charT>, l);
#ifndef HBOOST_NO_STD_MESSAGES
   m_pmessages = HBOOST_HAS_FACET(std::messages<charT>, l) ? &HBOOST_USE_FACET(std::messages<charT>, l) : 0;
#endif
   m_pcollate = &HBOOST_USE_FACET(std::collate<charT>, l);
   return result;
}
...
//
template <>
class HBOOST_REGEX_DECL cpp_regex_traits_char_layer<char> : public cpp_regex_traits_base<char>
{
...
public:
   ...
   typedef typename hboost::make_unsigned<native_mask_type>::type  unsigned_native_mask_type;
#ifndef HBOOST_REGEX_BUGGY_CTYPE_FACET
   HBOOST_STATIC_CONSTANT(char_class_type, mask_blank = 1u << 24);
   HBOOST_STATIC_CONSTANT(char_class_type, mask_word = 1u << 25);
   HBOOST_STATIC_CONSTANT(char_class_type, mask_unicode = 1u << 26);
   HBOOST_STATIC_CONSTANT(char_class_type, mask_horizontal = 1u << 27);
   HBOOST_STATIC_CONSTANT(char_class_type, mask_vertical = 1u << 28);
#endif
...
#ifndef HBOOST_REGEX_BUGGY_CTYPE_FACET
#if !defined(HBOOST_NO_INCLASS_MEMBER_INITIALIZATION)
   ...
   cpp_regex_traits_implementation<charT>::transform(const charT* p1, const charT* p2) const
{
   ...
   try{
...
#if HBOOST_WORKAROUND(__BORLANDC__, < 0x580)
      ...
      HBOOST_ASSERT(std::find(result2.begin(), result2.end(), charT(0)) == result2.end());
#ifndef HBOOST_NO_EXCEPTIONS
   }
   catch(...)
   {
...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      static const char_class_type masks[16] = 
      {
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_alnum,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_alpha,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_cntrl,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_digit,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_graph,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_horizontal_space,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_lower,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_print,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_punct,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_space,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_upper,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_vertical_space,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_xdigit,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_blank,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_word,
         ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_upper,
      ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_vertical_space,
      ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_alnum | ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_word, 
      ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_alnum | ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_word, 
      ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_xdigit,
   };
#endif
   ...
   HBOOST_ASSERT(state_id < sizeof(masks) / sizeof(masks[0]));
...
{
   return
      ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_space) && (this->m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_print) && (this->m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_cntrl) && (this->m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_upper) && (this->m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_lower) && (this->m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_alpha) && (this->m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_digit) && (this->m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_punct) && (this->m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_xdigit) && (this->m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_blank) && (this->m_pctype->is(std::ctype<charT>::space, c)) && !::hboost::HBOOST_REGEX_DETAIL_NS::is_separator(c))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_word) && (c == '_'))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_unicode) && ::hboost::HBOOST_REGEX_DETAIL_NS::is_extended(c))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::hboost::HBOOST_REGEX_DETAIL_NS::char_class_horizontal_space) && this->m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline hboost::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l)
{
   cpp_regex_traits_base<charT> key(l);
   return ::hboost::object_cache<cpp_regex_traits_base<charT>, cpp_regex_traits_implementation<charT> >::get(key, 5);
}
...
public:
   ...
   cpp_regex_traits()
      : m_pimpl(HBOOST_REGEX_DETAIL_NS::create_cpp_regex_traits<charT>(std::locale()))
   { }
   ...
   bool isctype(charT c, char_class_type f) const
   {
      ...
      if((f & mask_base) 
         ...
         return true;
      else if((f & HBOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT>::mask_unicode) && HBOOST_REGEX_DETAIL_NS::is_extended(c))
         return true;
      else if((f & HBOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT>::mask_word) && (c == '_'))
         return true;
      else if((f & HBOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT>::mask_blank) 
         && m_pimpl->m_pctype->is(std::ctype<charT>::space, c)
         && !HBOOST_REGEX_DETAIL_NS::is_separator(c))
         return true;
      else if((f & HBOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT>::mask_vertical) 
         && (::hboost::HBOOST_REGEX_DETAIL_NS::is_separator(c) || (c == '\v')))
         return true;
      else if((f & HBOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT>::mask_horizontal) 
         && this->isctype(c, std::ctype<charT>::space) && !this->isctype(c, HBOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT>::mask_vertical))
         return true;
#ifdef __CYGWIN__
      //
   ...
   locale_type imbue(locale_type l)
   {
      ...
      m_pimpl = HBOOST_REGEX_DETAIL_NS::create_cpp_regex_traits<charT>(l);
      return result;
   }
...
private:
   hboost::shared_ptr<const HBOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
...
{
   HBOOST_REGEX_DETAIL_NS::parser_buf<charT>   sbuf;            // buffer for parsing numbers.
   std::basic_istream<charT>      is(&sbuf);       // stream for parsing numbers.

   // we do NOT want to parse any thousands separators inside the stream:
   last = std::find(first, last, HBOOST_USE_FACET(std::numpunct<charT>, is.getloc()).thousands_sep());
