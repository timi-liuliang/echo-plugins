...
#define HBOOST_REGEX_TRAITS_DEFAULTS_HPP_INCLUDED
...
HBOOST_REGEX_DECL const char* HBOOST_REGEX_CALL get_default_syntax(regex_constants::syntax_type n);
HBOOST_REGEX_DECL const char* HBOOST_REGEX_CALL get_default_error_string(regex_constants::error_type n);
HBOOST_REGEX_DECL regex_constants::syntax_type HBOOST_REGEX_CALL get_default_syntax_type(char c);
HBOOST_REGEX_DECL regex_constants::escape_syntax_type HBOOST_REGEX_CALL get_default_escape_syntax_type(char c);

// is charT c a combining character?
HBOOST_REGEX_DECL bool HBOOST_REGEX_CALL is_combining_implementation(uint_least16_t s);
...
#elif !defined(__DECCXX) && !defined(__osf__) && !defined(__OSF__) && defined(WCHAR_MIN) && (WCHAR_MIN == 0) && !defined(HBOOST_NO_INTRINSIC_WCHAR_T)
...
{
   return HBOOST_REGEX_MAKE_BOOL(
      (c == static_cast<charT>('\n'))
      || (c == static_cast<charT>('\r'))
      || (c == static_cast<charT>('\f'))
      || (static_cast<hboost::uint16_t>(c) == 0x2028u)
      || (static_cast<hboost::uint16_t>(c) == 0x2029u)
      || (static_cast<hboost::uint16_t>(c) == 0x85u));
}
template <>
inline bool is_separator<char>(char c)
{
   return HBOOST_REGEX_MAKE_BOOL((c == '\n') || (c == '\r') || (c == '\f'));
}

//
// get a default collating element:
//
HBOOST_REGEX_DECL std::string HBOOST_REGEX_CALL lookup_default_collate_name(const std::string& name);
...
struct character_pointer_range
{
   ...
   bool operator == (const character_pointer_range& r)const
   {
      ...
      // in the MS case.
      return ((p2 - p1) == (r.p2 - r.p1)) && HBOOST_REGEX_DETAIL_NS::equal(p1, p2, r.p1);
   }
};
template <class charT>
...
#endif
template <class charT>
inline charT HBOOST_REGEX_CALL global_lower(charT c)
{
   return c;
}
template <class charT>
inline charT HBOOST_REGEX_CALL global_upper(charT c)
{
   return c;
}

HBOOST_REGEX_DECL char HBOOST_REGEX_CALL do_global_lower(char c);
HBOOST_REGEX_DECL char HBOOST_REGEX_CALL do_global_upper(char c);
#ifndef HBOOST_NO_WREGEX
HBOOST_REGEX_DECL wchar_t HBOOST_REGEX_CALL do_global_lower(wchar_t c);
HBOOST_REGEX_DECL wchar_t HBOOST_REGEX_CALL do_global_upper(wchar_t c);
#endif
#ifdef HBOOST_REGEX_HAS_OTHER_WCHAR_T
HBOOST_REGEX_DECL unsigned short HBOOST_REGEX_CALL do_global_lower(unsigned short c);
HBOOST_REGEX_DECL unsigned short HBOOST_REGEX_CALL do_global_upper(unsigned short c);
#endif
//
...
//
template<> inline char HBOOST_REGEX_CALL global_lower<char>(char c){ return do_global_lower(c); }
template<> inline char HBOOST_REGEX_CALL global_upper<char>(char c){ return do_global_upper(c); }
#ifndef HBOOST_NO_WREGEX
template<> inline wchar_t HBOOST_REGEX_CALL global_lower<wchar_t>(wchar_t c){ return do_global_lower(c); }
template<> inline wchar_t HBOOST_REGEX_CALL global_upper<wchar_t>(wchar_t c){ return do_global_upper(c); }
#endif
#ifdef HBOOST_REGEX_HAS_OTHER_WCHAR_T
template<> inline unsigned short HBOOST_REGEX_CALL global_lower<unsigned short>(unsigned short c){ return do_global_lower(c); }
template<> inline unsigned short HBOOST_REGEX_CALL global_upper<unsigned short>(unsigned short c){ return do_global_upper(c); }
#endif
