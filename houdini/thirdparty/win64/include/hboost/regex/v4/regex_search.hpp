...
#define HBOOST_REGEX_V4_REGEX_SEARCH_HPP
                  ...
                  BidiIterator base)
{
   ...
   HBOOST_REGEX_DETAIL_NS::perl_matcher<BidiIterator, Allocator, traits> matcher(first, last, m, e, flags, base);
   return matcher.find();
}
                  ...
                  match_flag_type flags = match_default)
{
   ...
   HBOOST_REGEX_DETAIL_NS::perl_matcher<BidiIterator, match_alloc_type, traits> matcher(first, last, m, e, flags | regex_constants::match_any, first);
   return matcher.find();
}
...
#endif  // HBOOST_REGEX_V4_REGEX_SEARCH_HPP
