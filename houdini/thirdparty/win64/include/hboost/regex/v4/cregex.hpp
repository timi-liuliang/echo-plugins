 ...
 */
  ...
  *                + hboost::RegEx high level wrapper.
  */

#ifndef HBOOST_RE_CREGEX_HPP_INCLUDED
#define HBOOST_RE_CREGEX_HPP_INCLUDED
...
#if defined(__cplusplus) && !defined(HBOOST_NO_STDC_NAMESPACE)
...
HBOOST_REGEX_DECL int HBOOST_REGEX_CCALL regcompA(regex_tA*, const char*, int);
HBOOST_REGEX_DECL regsize_t HBOOST_REGEX_CCALL regerrorA(int, const regex_tA*, char*, regsize_t);
HBOOST_REGEX_DECL int HBOOST_REGEX_CCALL regexecA(const regex_tA*, const char*, regsize_t, regmatch_t*, int);
HBOOST_REGEX_DECL void HBOOST_REGEX_CCALL regfreeA(regex_tA*);

#ifndef HBOOST_NO_WREGEX
HBOOST_REGEX_DECL int HBOOST_REGEX_CCALL regcompW(regex_tW*, const wchar_t*, int);
HBOOST_REGEX_DECL regsize_t HBOOST_REGEX_CCALL regerrorW(int, const regex_tW*, wchar_t*, regsize_t);
HBOOST_REGEX_DECL int HBOOST_REGEX_CCALL regexecW(const regex_tW*, const wchar_t*, regsize_t, regmatch_t*, int);
HBOOST_REGEX_DECL void HBOOST_REGEX_CCALL regfreeW(regex_tW*);
#endif
...
class HBOOST_REGEX_DECL RegEx
{
private:
   HBOOST_REGEX_DETAIL_NS::RegExData* pdata;
public:
   RegEx();
   RegEx(const RegEx& o);
   ~RegEx();
   ...
   friend struct HBOOST_REGEX_DETAIL_NS::pred1;
   friend struct HBOOST_REGEX_DETAIL_NS::pred2;
   friend struct HBOOST_REGEX_DETAIL_NS::pred3;
   friend struct HBOOST_REGEX_DETAIL_NS::pred4;
};
