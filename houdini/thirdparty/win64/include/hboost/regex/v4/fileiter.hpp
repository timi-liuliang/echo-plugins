...
#ifndef HBOOST_RE_FILEITER_HPP_INCLUDED
#define HBOOST_RE_FILEITER_HPP_INCLUDED
...
#ifndef HBOOST_REGEX_NO_FILEITER

#if (defined(__CYGWIN__) || defined(__CYGWIN32__)) && !defined(HBOOST_REGEX_NO_W32)
#error "Sorry, can't mix <windows.h> with STL code and gcc compiler: if you ran configure, try again with configure --disable-ms-windows"
#define HBOOST_REGEX_FI_WIN32_MAP
#define HBOOST_REGEX_FI_POSIX_DIR
#elif (defined(__WIN32__) || defined(_WIN32) || defined(WIN32)) && !defined(HBOOST_REGEX_NO_W32)
#define HBOOST_REGEX_FI_WIN32_MAP
#define HBOOST_REGEX_FI_WIN32_DIR
#else
#define HBOOST_REGEX_FI_POSIX_MAP
#define HBOOST_REGEX_FI_POSIX_DIR
#endif

#if defined(HBOOST_REGEX_FI_WIN32_MAP)||defined(HBOOST_REGEX_FI_WIN32_DIR)
#include <windows.h>
#endif

#if defined(HBOOST_REGEX_FI_WIN32_DIR)
...
#elif defined(HBOOST_REGEX_FI_POSIX_DIR)
...
#ifdef HBOOST_REGEX_FI_WIN32_MAP // win32 mapfile

class HBOOST_REGEX_DECL mapfile
{
   HANDLE hfile;
   HANDLE hmap;
   const char* _first;
...
class HBOOST_REGEX_DECL mapfile_iterator;
...
class HBOOST_REGEX_DECL mapfile_iterator
#if !defined(HBOOST_NO_STD_ITERATOR) || defined(HBOOST_MSVC_STD_ITERATOR)
...
public:
   ...
   char operator* ()const
   {
      HBOOST_ASSERT(node >= file->_first);
      HBOOST_ASSERT(node < file->_last);
...
HBOOST_REGEX_DECL extern const char* _fi_sep;
...
class HBOOST_REGEX_DECL file_iterator 
{
   char* _root;
   char* _path;
   char* ptr;
...
class HBOOST_REGEX_DECL directory_iterator
{
   char* _root;
   char* _path;
   char* ptr;
...
using hboost::HBOOST_REGEX_DETAIL_NS::directory_iterator;
using hboost::HBOOST_REGEX_DETAIL_NS::file_iterator;
using hboost::HBOOST_REGEX_DETAIL_NS::mapfile;
} // namespace hboost

#endif     // HBOOST_REGEX_NO_FILEITER
#endif     // HBOOST_RE_FILEITER_HPP
