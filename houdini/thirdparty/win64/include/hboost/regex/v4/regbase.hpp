...
#define HBOOST_REGEX_V4_REGBASE_HPP
...
//
class HBOOST_REGEX_DECL regbase
{
public:
   enum flag_type_
   {
...
namespace regex_constants{
   ...
   enum flag_type_
   {
      ...
      no_except = ::hboost::regbase::no_except,
      failbit = ::hboost::regbase::failbit,
      literal = ::hboost::regbase::literal,
      icase = ::hboost::regbase::icase,
      nocollate = ::hboost::regbase::nocollate,
      collate = ::hboost::regbase::collate,
      nosubs = ::hboost::regbase::nosubs,
      optimize = ::hboost::regbase::optimize,
      bk_plus_qm = ::hboost::regbase::bk_plus_qm,
      bk_vbar = ::hboost::regbase::bk_vbar,
      no_intervals = ::hboost::regbase::no_intervals,
      no_char_classes = ::hboost::regbase::no_char_classes,
      no_escape_in_lists = ::hboost::regbase::no_escape_in_lists,
      no_mod_m = ::hboost::regbase::no_mod_m,
      mod_x = ::hboost::regbase::mod_x,
      mod_s = ::hboost::regbase::mod_s,
      no_mod_s = ::hboost::regbase::no_mod_s,
      save_subexpression_location = ::hboost::regbase::save_subexpression_location,
      no_empty_expressions = ::hboost::regbase::no_empty_expressions,

      basic = ::hboost::regbase::basic,
      extended = ::hboost::regbase::extended,
      normal = ::hboost::regbase::normal,
      emacs = ::hboost::regbase::emacs,
      awk = ::hboost::regbase::awk,
      grep = ::hboost::regbase::grep,
      egrep = ::hboost::regbase::egrep,
      sed = basic,
      perl = normal,
      ECMAScript = normal,
      JavaScript = normal,
   ...
   typedef ::hboost::regbase::flag_type syntax_option_type;
