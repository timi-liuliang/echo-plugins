...
#ifndef HBOOST_REGEX_V4_REGEX_TOKEN_ITERATOR_HPP
#define HBOOST_REGEX_V4_REGEX_TOKEN_ITERATOR_HPP

#include <hboost/shared_ptr.hpp>
#include <hboost/detail/workaround.hpp>
#if (HBOOST_WORKAROUND(__BORLANDC__, >= 0x560) && HBOOST_WORKAROUND(__BORLANDC__, HBOOST_TESTED_AT(0x570)))\
      || HBOOST_WORKAROUND(__MWERKS__, HBOOST_TESTED_AT(0x3003))
//
...
public:
      ...
      : end(last), re(*p), flags(f)
   {
      ...
      HBOOST_STATIC_ASSERT(::hboost::is_array<T>::value);
...
template <class BidirectionalIterator, 
          class charT = HBOOST_DEDUCED_TYPENAME HBOOST_REGEX_DETAIL_NS::regex_iterator_traits<BidirectionalIterator>::value_type,
...
class regex_token_iterator 
   ...
   : public std::iterator<
         ...
         typename HBOOST_REGEX_DETAIL_NS::regex_iterator_traits<BidirectionalIterator>::difference_type,
...
public:
   typedef          basic_regex<charT, traits>                   regex_type;
   typedef          sub_match<BidirectionalIterator>                        value_type;
   typedef typename HBOOST_REGEX_DETAIL_NS::regex_iterator_traits<BidirectionalIterator>::difference_type 
                                                                            difference_type;
...
#endif // HBOOST_REGEX_V4_REGEX_TOKEN_ITERATOR_HPP
