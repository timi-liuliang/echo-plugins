 ...
 */
  ...
  *   FILE         hboost/regex/config/cwchar.hpp
  *   VERSION      see <hboost/version.hpp>
  *   DESCRIPTION: regex wide character string fixes.
  */

#ifndef HBOOST_REGEX_CONFIG_CWCHAR_HPP
#define HBOOST_REGEX_CONFIG_CWCHAR_HPP
...
#undef wcscoll
#elif defined(HBOOST_NO_STDC_NAMESPACE) && !defined(UNDER_CE)
using ::wcscoll;
#endif
