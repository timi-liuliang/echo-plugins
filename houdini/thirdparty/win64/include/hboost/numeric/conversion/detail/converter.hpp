...
//
#ifndef HBOOST_NUMERIC_CONVERSION_DETAIL_CONVERTER_FLC_12NOV2002_HPP
#define HBOOST_NUMERIC_CONVERSION_DETAIL_CONVERTER_FLC_12NOV2002_HPP

#include <functional>

#include "hboost/numeric/conversion/detail/meta.hpp"
#include "hboost/numeric/conversion/detail/conversion_traits.hpp"
#include "hboost/numeric/conversion/bounds.hpp"

#include "hboost/type_traits/is_same.hpp"

#include "hboost/mpl/integral_c.hpp"

namespace hboost { namespace numeric { namespace convdetail
{
...
//--------------------------------------------------------------------------
  ...
  //
  template<class Traits>
  struct trivial_converter_impl : public std::unary_function<  HBOOST_DEDUCED_TYPENAME Traits::argument_type
                                                              ,HBOOST_DEDUCED_TYPENAME Traits::result_type
                                                            >
  ...
  struct rounding_converter : public std::unary_function<  HBOOST_DEDUCED_TYPENAME Traits::argument_type
                                                          ,HBOOST_DEDUCED_TYPENAME Traits::result_type
                                                        >
                             ,public RangeChecker
  ...
  struct non_rounding_converter : public std::unary_function< HBOOST_DEDUCED_TYPENAME Traits::argument_type
                                                             ,HBOOST_DEDUCED_TYPENAME Traits::result_type
                                                           >
                                 ,public RangeChecker
                                 ,public RawConverter
...
//--------------------------------------------------------------------------
  ...
  {
#if HBOOST_WORKAROUND(__BORLANDC__, HBOOST_TESTED_AT( 0x0561 ) )
...
} } } // namespace hboost::numeric::convdetail
