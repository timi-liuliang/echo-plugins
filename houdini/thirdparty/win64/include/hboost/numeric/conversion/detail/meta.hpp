...
// 
#ifndef HBOOST_NUMERIC_CONVERSION_DETAIL_META_FLC_12NOV2002_HPP
#define HBOOST_NUMERIC_CONVERSION_DETAIL_META_FLC_12NOV2002_HPP
...
namespace hboost { namespace numeric { namespace convdetail
{
   ...
   struct equal_to
   {
       ...
       enum { x = ( HBOOST_MPL_AUX_VALUE_WKND(T1)::value == HBOOST_MPL_AUX_VALUE_WKND(T2)::value ) };
           
       HBOOST_STATIC_CONSTANT(bool, value = x);
       ...
       HBOOST_STATIC_CONSTANT(bool, value = (
             HBOOST_MPL_AUX_VALUE_WKND(T1)::value 
               == HBOOST_MPL_AUX_VALUE_WKND(T2)::value
           ));
