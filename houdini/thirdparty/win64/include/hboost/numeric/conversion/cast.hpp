...
//
#ifndef HBOOST_NUMERIC_CONVERSION_CAST_25OCT2001_HPP
#define HBOOST_NUMERIC_CONVERSION_CAST_25OCT2001_HPP

#include <hboost/detail/workaround.hpp>

#if HBOOST_WORKAROUND(HBOOST_MSVC, < 1300) || HBOOST_WORKAROUND(__BORLANDC__, HBOOST_TESTED_AT(0x582))

#  include<hboost/numeric/conversion/detail/old_numeric_cast.hpp>

#else

#include <hboost/type.hpp>
#include <hboost/numeric/conversion/converter.hpp>
#include <hboost/numeric/conversion/numeric_cast_traits.hpp>
    ...
    inline Target numeric_cast( Source arg )
    {
        ...
        typedef hboost::numeric::converter
            <
                ...
                hboost::numeric::raw_converter< conv_traits >,
