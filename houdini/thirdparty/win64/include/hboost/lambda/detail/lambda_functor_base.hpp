...
#ifndef HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_HPP
#define HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_HPP
...
public:
  ...
  // stay as they are.
  typedef typename hboost::add_reference<
    typename hboost::add_const<T>::type
  >::type par_t;

  explicit identity(par_t t) : elem(t) {}

  template <typename SigArgs> 
  struct sig { typedef typename hboost::remove_const<element_t>::type type; };
...
template<class Tuple> struct has_null_type {
  HBOOST_STATIC_CONSTANT(bool, value = (is_null_type<typename Tuple::head_type>::value || has_null_type<typename Tuple::tail_type>::value));
};
...
//    typedef typename hboost::remove_reference<T>::type t;
//    typedef typename detail::IF<hboost::is_function<t>::value, T, t>::RET type;
//  };
...
public:
  ...
  //      typename detail::remove_reference_except_from_functions<el_t>::type, 
      typename hboost::remove_reference<el_t>::type, 
...
struct nth_return_type_sig {
  typedef typename 
          as_lambda_functor<
            typename hboost::tuples::element<N, Args>::type 
...
template<int N, class Tuple> struct element_or_null {
  typedef typename hboost::tuples::element<N, Tuple>::type type;
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const 
  {
    return detail::constify_rvals<RET>::go(
     detail::r_select<RET>::go(hboost::tuples::get<0>(args), CALL_ACTUAL_ARGS));
  }
};
...
public:
  ...
  {
     CALL_USE_ARGS;
     return hboost::tuples::get<0>(args);
  }

  template<class SigArgs> struct sig { 
    //    typedef typename detail::tuple_element_as_reference<0, SigArgs>::type type;
    typedef typename hboost::tuples::element<0, Args>::type type;
  };
};
...
#if defined HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART  
#error "Multiple defines of HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART"  
#endif  
  
  
#define HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART(ARITY)             \
template<class Act, class Args>                                        \
...
HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART(2)
...
HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART(3)
...
HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART(4)
  typedef typename 
    deduce_argument_types<Args, tuple<CALL_REFERENCE_TYPES> >::type rets_t;
  typedef typename element_or_null<0, rets_t>::type rt0;
  typedef typename element_or_null<1, rets_t>::type rt1;
...
HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART(5)
  typedef typename 
    deduce_argument_types<Args, tuple<CALL_REFERENCE_TYPES> >::type rets_t;
  typedef typename element_or_null<0, rets_t>::type rt0;
  typedef typename element_or_null<1, rets_t>::type rt1;
...
HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART(6)
...
HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART(7)
  typedef typename 
    deduce_argument_types<Args, tuple<CALL_REFERENCE_TYPES> >::type rets_t;
  typedef typename element_or_null<0, rets_t>::type rt0;
  typedef typename element_or_null<1, rets_t>::type rt1;
...
HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART(8)
  typedef typename 
    deduce_argument_types<Args, tuple<CALL_REFERENCE_TYPES> >::type rets_t;
  typedef typename element_or_null<0, rets_t>::type rt0;
  typedef typename element_or_null<1, rets_t>::type rt1;
...
HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART(9)
  typedef typename 
    deduce_argument_types<Args, tuple<CALL_REFERENCE_TYPES> >::type rets_t;
  typedef typename element_or_null<0, rets_t>::type rt0;
  typedef typename element_or_null<1, rets_t>::type rt1;
...
HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART(10) 
  typedef typename 
    deduce_argument_types<Args, tuple<CALL_REFERENCE_TYPES> >::type rets_t;
  typedef typename element_or_null<0, rets_t>::type rt0;
  typedef typename element_or_null<1, rets_t>::type rt1;
...
#undef HBOOST_LAMBDA_LAMBDA_FUNCTOR_BASE_FIRST_PART
