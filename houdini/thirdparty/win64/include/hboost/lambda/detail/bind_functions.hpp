...
#ifndef HBOOST_LAMBDA_BIND_FUNCTIONS_HPP
#define HBOOST_LAMBDA_BIND_FUNCTIONS_HPP


namespace hboost { 
namespace lambda {

#ifdef HBOOST_LAMBDA_INCORRECT_BIND_OVERLOADING
...
template<class T> struct constify_non_funcs {
  typedef typename 
  detail::IF_type<hboost::is_function<T>::value,
    hboost::add_reference<T>,
    hboost::add_const<T>
  >::type type;
};
...
#ifndef HBOOST_REF_TO_FUNC_CONFLICTS_WITH_REF_TO_T
...
bind(Result(& a1)()) {
 ...
 #ifndef HBOOST_LAMBDA_INCORRECT_BIND_OVERLOADING 
template <class Arg1>
inline const
lambda_functor<
  lambda_functor_base<
