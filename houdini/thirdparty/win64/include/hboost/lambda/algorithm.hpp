...
#ifndef HBOOST_LAMBDA_ALGORITHM_HPP
#define HBOOST_LAMBDA_ALGORITHM_HPP
...
struct for_each {
  ...
  struct sig { 
    typedef typename hboost::remove_const<
        typename hboost::tuples::element<3, Args>::type 
     >::type type; 
  };
...
struct transform {
  ...
  struct sig { 
    typedef typename hboost::remove_const<
        typename hboost::tuples::element<
          hboost::tuples::length<Args>::value - 2, 
          Args
      >::type
     >::type type; 
  };
...
struct merge {
  ...
  struct sig { 
    typedef typename hboost::remove_const<
        typename hboost::tuples::element<5, Args>::type 
     >::type type; 
  };
