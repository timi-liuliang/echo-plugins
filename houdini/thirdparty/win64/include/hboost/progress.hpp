...
#ifndef HBOOST_PROGRESS_HPP
#define HBOOST_PROGRESS_HPP

#include <hboost/timer.hpp>
#include <hboost/noncopyable.hpp>
#include <hboost/cstdint.hpp>  // for uintmax_t
...
// NOTE: (Jan 12, 2001) Tried to change unsigned long to hboost::uintmax_t, but
