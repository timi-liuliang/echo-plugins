...
#ifndef HBOOST_DEFAULT_050329_HPP
# define HBOOST_DEFAULT_050329_HPP
...
//    given keyword
//
# if HBOOST_WORKAROUND(__EDG_VERSION__, <= 300)
...
#  define HBOOST_PARAMETER_lazy_default_fallback lazy_default_base
# else 
template <class KW, class DefaultComputer>
struct lazy_default
{
...
#  define HBOOST_PARAMETER_lazy_default_fallback lazy_default
# endif 

}}} // namespace hboost::parameter::aux

#endif // HBOOST_DEFAULT_050329_HPP
