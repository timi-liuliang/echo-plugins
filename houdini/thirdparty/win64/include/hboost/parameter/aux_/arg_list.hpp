...
#ifndef HBOOST_ARG_LIST_050329_HPP
#define HBOOST_ARG_LIST_050329_HPP
...
#include <hboost/parameter/aux_/parameter_requirements.hpp>
#include <hboost/parameter/aux_/yesno.hpp>
#include <hboost/parameter/aux_/is_maybe.hpp>
...
struct empty_arg_list
{
    ...
    // Constructor taking HBOOST_PARAMETER_MAX_ARITY empty_arg_list
    // arguments; this makes initialization
    empty_arg_list(
        HBOOST_PP_ENUM_PARAMS(
            HBOOST_PARAMETER_MAX_ARITY, void_ HBOOST_PP_INTERCEPT
        ))
    {}
    ...
    typename result_of0<F>::type
    operator[](
        HBOOST_PARAMETER_lazy_default_fallback<K,F> x) const
    {
        return x.compute_default();
    }
...
struct arg_list : Next
{
    ...
    arg_list( // A0& a0, A1& a1, ...
        HBOOST_PP_ENUM_BINARY_PARAMS(HBOOST_PARAMETER_MAX_ARITY, A, & a)
    )
      : Next( // a1, a2, ...
            HBOOST_PP_ENUM_SHIFTED_PARAMS(HBOOST_PARAMETER_MAX_ARITY, a)
          , void_reference()
        )
      , arg(a0)
    {}
    ...
    {
        HBOOST_MPL_ASSERT_NOT((holds_maybe));
        return arg.value;
    }
...
#endif // HBOOST_ARG_LIST_050329_HPP
