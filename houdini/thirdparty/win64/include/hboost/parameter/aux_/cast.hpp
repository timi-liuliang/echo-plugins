...
#ifndef HBOOST_PARAMETER_CAST_060902_HPP
# define HBOOST_PARAMETER_CAST_060902_HPP
...
#  define HBOOST_PARAMETER_FUNCTION_CAST(value, predicate) value
...
struct cast<void(T), Args>
{
    ...
    typedef typename hboost::add_reference<
        typename hboost::remove_const<type0>::type 
    >::type reference;
...
#  define HBOOST_PARAMETER_FUNCTION_CAST(value, predicate, args) \
    hboost::parameter::aux::cast<void predicate, args>::remove_const( \
        hboost::parameter::aux::cast<void predicate, args>::execute(value) \
    )
...
#endif // HBOOST_PARAMETER_CAST_060902_HPP
