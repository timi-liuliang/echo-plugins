...
#ifndef HBOOST_PARAMETERS_031014_HPP
#define HBOOST_PARAMETERS_031014_HPP

#include <hboost/detail/is_xxx.hpp>
...
#include <hboost/parameter/aux_/arg_list.hpp>
#include <hboost/parameter/aux_/yesno.hpp>
#include <hboost/parameter/aux_/void.hpp>
#include <hboost/parameter/aux_/default.hpp>
#include <hboost/parameter/aux_/unwrap_cv_reference.hpp>
#include <hboost/parameter/aux_/tagged_argument.hpp>
#include <hboost/parameter/aux_/tag.hpp>
#include <hboost/parameter/aux_/template_keyword.hpp>
#include <hboost/parameter/aux_/set.hpp>
#include <hboost/parameter/config.hpp>

namespace hboost_parameter_
{
  template <class T>
  struct unmatched_argument
  {
      HBOOST_MPL_ASSERT((hboost::is_same<T,void>));
      typedef int type;
  }; 
} // namespace hboost_parameter_
...
namespace aux
{
  ...
  HBOOST_DETAIL_IS_XXX_DEF(required, required, 2)
  HBOOST_DETAIL_IS_XXX_DEF(optional, optional, 2)
  HBOOST_DETAIL_IS_XXX_DEF(deduced_aux, deduced, 1)
...
#endif
  {
      ...
      typedef typename mpl::if_<
          ...
          >
        , hboost_parameter_::unmatched_argument<argument>
        , void_
      >::type error;
  ...
  //    ...>
  //   >
#define HBOOST_PARAMETER_make_arg_list(z, n, names)      \
      HBOOST_PP_SEQ_ELEM(0,names)<                       \
          HBOOST_PP_CAT(HBOOST_PP_SEQ_ELEM(1,names), n),  \
          HBOOST_PP_CAT(HBOOST_PP_SEQ_ELEM(2,names), n), 

#define HBOOST_PARAMETER_right_angle(z, n, text) >

#define HBOOST_PARAMETER_build_arg_list(n, make, parameter_spec, argument_type)      \
  HBOOST_PP_REPEAT(                                                                  \
      n, HBOOST_PARAMETER_make_arg_list, (make)(parameter_spec)(argument_type))      \
      mpl::identity<void_>                                                          \
  HBOOST_PP_REPEAT(n, HBOOST_PARAMETER_right_angle, _)

#define HBOOST_PARAMETER_make_deduced_list(z, n, names)  \
      HBOOST_PP_SEQ_ELEM(0,names)<                       \
          HBOOST_PP_CAT(HBOOST_PP_SEQ_ELEM(1,names), n),

#define HBOOST_PARAMETER_build_deduced_list(n, make, parameter_spec)                 \
  HBOOST_PP_REPEAT(                                                                  \
      n, HBOOST_PARAMETER_make_deduced_list, (make)(parameter_spec))                 \
  mpl::identity<void_>                                                              \
  HBOOST_PP_REPEAT(n, HBOOST_PARAMETER_right_angle, _)
...
#define HBOOST_PARAMETER_FORWARD_TYPEDEF(z, i, names) \
    typedef HBOOST_PP_CAT(HBOOST_PP_SEQ_ELEM(0,names),i) HBOOST_PP_CAT(HBOOST_PP_SEQ_ELEM(1,names),i);

#define HBOOST_PARAMETER_FORWARD_TYPEDEFS(n, src, dest) \
    HBOOST_PP_REPEAT(n, HBOOST_PARAMETER_FORWARD_TYPEDEF, (src)(dest))


#define HBOOST_PARAMETER_TEMPLATE_ARGS(z, n, text) class HBOOST_PP_CAT(PS, n) = void_

template<
     class PS0
   , HBOOST_PP_ENUM_SHIFTED(HBOOST_PARAMETER_MAX_ARITY, HBOOST_PARAMETER_TEMPLATE_ARGS, _)
>
struct parameters
{
#undef HBOOST_PARAMETER_TEMPLATE_ARGS

    typedef typename HBOOST_PARAMETER_build_deduced_list(
        HBOOST_PARAMETER_MAX_ARITY, aux::make_deduced_items, PS
    )::type deduced_list;
...
# define HBOOST_PARAMETER_satisfies(z, n, text)                                      \
            mpl::and_<                                                              \
            ...
            mpl::and_<
              ...
              , HBOOST_PP_REPEAT(HBOOST_PARAMETER_MAX_ARITY, HBOOST_PARAMETER_satisfies, _)
                mpl::true_
                HBOOST_PP_REPEAT(HBOOST_PARAMETER_MAX_ARITY, HBOOST_PARAMETER_right_angle, _)
            >

# undef HBOOST_PARAMETER_satisfies
    ...
    template<
        ...
        // explicitly specify HBOOST_PARAMETER_MAX_ARITY arguments
        HBOOST_PP_ENUM_PARAMS(HBOOST_PARAMETER_MAX_ARITY, class A)
#else 
        HBOOST_PP_ENUM_BINARY_PARAMS(
            HBOOST_PARAMETER_MAX_ARITY, class A, = void_ HBOOST_PP_INTERCEPT
        )
#endif
    >
    struct match
      ...
      : match_base<
            typename aux::make_arg_list<
                typename HBOOST_PARAMETER_build_arg_list(
                    HBOOST_PARAMETER_MAX_ARITY, aux::make_items, PS, A
                )::type
              , deduced_list
              , aux::tag_keyword_arg
...
# else
    { 
        typedef parameters<
            HBOOST_PP_ENUM_PARAMS(HBOOST_PARAMETER_MAX_ARITY, PS)
        > type; 
    };
# endif
    ...
    HBOOST_PARAMETER_FORWARD_TYPEDEFS(HBOOST_PARAMETER_MAX_ARITY, PS, parameter_spec)
    ...
    operator()(A0& a0) const
    {
        ...
        return result_type(
            ...
            HBOOST_PP_ENUM_TRAILING_PARAMS(
                HBOOST_PP_SUB(HBOOST_PARAMETER_MAX_ARITY, 1)
    ...
    operator()(A0& a0, A1& a1) const
    {
        ...
        return result_type(
            ...
            // , void_(), void_() ...
            HBOOST_PP_ENUM_TRAILING_PARAMS(
                HBOOST_PP_SUB(HBOOST_PARAMETER_MAX_ARITY, 2)
              , aux::void_reference() HBOOST_PP_INTERCEPT)
        );
    }

    // Higher arities are handled by the preprocessor
#define HBOOST_PP_ITERATION_PARAMS_1 (3,( \
        3,HBOOST_PARAMETER_MAX_ARITY,<hboost/parameter/aux_/overloads.hpp> \
    ))
...
#endif // HBOOST_PARAMETERS_031014_HPP
