...
//! manipulators are intended to be used with HBOOST_TEST.
// ***************************************************************************

#ifndef HBOOST_TEST_TOOLS_DETAIL_TOLERANCE_MANIP_HPP_012705GER
#define HBOOST_TEST_TOOLS_DETAIL_TOLERANCE_MANIP_HPP_012705GER

// Boost Test
#include <hboost/test/tools/detail/fwd.hpp>
#include <hboost/test/tools/detail/indirections.hpp>

#include <hboost/test/tools/fpc_tolerance.hpp>
...
{
    HBOOST_STATIC_ASSERT_MSG( (fpc::tolerance_based<FPT>::value), 
 ...
 *
 * These functions return a manipulator that can be used in conjunction with HBOOST_TEST
...
#endif // HBOOST_TEST_TOOLS_DETAIL_TOLERANCE_MANIP_HPP_012705GER
