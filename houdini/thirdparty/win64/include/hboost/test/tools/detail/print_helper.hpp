...
#ifndef HBOOST_TEST_TOOLS_IMPL_COMMON_HPP_012705GER
#define HBOOST_TEST_TOOLS_IMPL_COMMON_HPP_012705GER
...
struct print_log_value {
    HBOOST_STATIC_ASSERT_MSG( (hboost::has_left_shift<std::ostream,T>::value),
...
#ifdef HBOOST_NO_CXX11_NUMERIC_LIMITS
            // (was HBOOST_NO_NUMERIC_LIMITS_LOWEST but now deprecated).
...
template<>
struct HBOOST_TEST_DECL print_log_value<bool> {
...
template<>
struct HBOOST_TEST_DECL print_log_value<char> {
...
template<>
struct HBOOST_TEST_DECL print_log_value<unsigned char> {
...
template<>
struct HBOOST_TEST_DECL print_log_value<char const*> {
...
template<>
struct HBOOST_TEST_DECL print_log_value<wchar_t const*> {
...
// ************************************************************************** //
// **************       HBOOST_TEST_DONT_PRINT_LOG_VALUE        ************** //
// ************************************************************************** //

#define HBOOST_TEST_DONT_PRINT_LOG_VALUE( the_type )         \
namespace hboost{ namespace test_tools{ namespace tt_detail{ \
template<>                                                  \
...
#endif // HBOOST_TEST_TOOLS_IMPL_COMMON_HPP_012705GER
