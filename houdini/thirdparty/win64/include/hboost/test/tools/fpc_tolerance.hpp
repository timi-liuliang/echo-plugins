...
#ifndef HBOOST_TEST_TOOLS_FPC_TOLERANCE_HPP_121612GER
#define HBOOST_TEST_TOOLS_FPC_TOLERANCE_HPP_121612GER
...
{
    return fixture_t( test_unit_fixture_ptr(
        new unit_test::class_based_fixture<test_tools::local_fpc_tolerance<FPT>,FPT>( hboost::math::fpc::fpc_detail::fraction_tolerance<FPT>( v ) ) ) );
}
...
#endif // HBOOST_TEST_TOOLS_FPC_TOLERANCE_HPP_121612GER
