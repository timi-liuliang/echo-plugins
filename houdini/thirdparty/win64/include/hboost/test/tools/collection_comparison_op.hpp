...
#ifndef HBOOST_TEST_TOOLS_COLLECTION_COMPARISON_OP_HPP_050815GER
#define HBOOST_TEST_TOOLS_COLLECTION_COMPARISON_OP_HPP_050815GER

// Boost.Test
#include <hboost/test/tools/assertion.hpp>

#include <hboost/test/utils/is_forward_iterable.hpp>
...
#define HBOOST_TEST_SPECIALIZED_COLLECTION_COMPARE(Col)          \
namespace hboost { namespace test_tools { namespace assertion {  \
template<>                                                      \
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, hboost::type<op::EQ<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, hboost::type<op::EQ<L, R> >*, mpl::false_ )
{
    return lhs == rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, hboost::type<op::NE<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, hboost::type<op::NE<L, R> >*, mpl::false_ )
{
    return lhs != rhs;
}
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, hboost::type<OP>*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, hboost::type<op::LT<L, R> >*, mpl::false_ )
{
    return lhs < rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, hboost::type<op::LE<L, R> >*, mpl::false_ )
{
    return lhs <= rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, hboost::type<op::GT<L, R> >*, mpl::false_ )
{
    return lhs > rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, hboost::type<op::GE<L, R> >*, mpl::false_ )
{
    return lhs >= rhs;
}
...
HBOOST_TEST_FOR_EACH_COMP_OP( DEFINE_COLLECTION_COMPARISON )
...
#endif // HBOOST_TEST_TOOLS_COLLECTION_COMPARISON_OP_HPP_050815GER
