...
//
/// @file
/// Defines @ref hboost::unit_test::test_unit "test_unit", @ref hboost::unit_test::test_case "test_case",
/// @ref hboost::unit_test::test_suite "test_suite" and @ref hboost::unit_test::master_test_suite_t "master_test_suite_t"
// ***************************************************************************

#ifndef HBOOST_TEST_TREE_TEST_UNIT_HPP_100211GER
#define HBOOST_TEST_TREE_TEST_UNIT_HPP_100211GER
...
class HBOOST_TEST_DECL test_unit {
public:
    enum { type = TUT_ANY };
    ...
    typedef HBOOST_READONLY_PROPERTY(test_unit_id,(framework::state))        id_t;
    typedef HBOOST_READONLY_PROPERTY(test_unit_id,(test_suite))              parent_id_t;
    typedef HBOOST_READONLY_PROPERTY(id_list,(test_unit))                    id_list_t;
    typedef std::vector<decorator::base_ptr>                                decor_list_t;
    typedef HBOOST_READONLY_PROPERTY(std::vector<std::string>,(test_unit))   label_list_t;

    typedef hboost::function<test_tools::assertion_result (test_unit_id)>    precondition_t;
    typedef HBOOST_READONLY_PROPERTY(std::vector<precondition_t>,(test_unit)) precond_list_t;
...
class HBOOST_TEST_DECL test_unit_generator {
public:
    virtual test_unit*  next() const = 0;

protected:
    HBOOST_TEST_PROTECTED_VIRTUAL ~test_unit_generator() {}
};
...
class HBOOST_TEST_DECL test_case : public test_unit {
public:
    enum { type = TUT_CASE };

    // Constructor
    test_case( const_string tc_name, hboost::function<void ()> const& test_func );
    test_case( const_string tc_name, const_string tc_file, std::size_t tc_line, hboost::function<void ()> const& test_func );

    // Public property
    typedef HBOOST_READONLY_PROPERTY(hboost::function<void ()>,(test_case))  test_func;
...
class HBOOST_TEST_DECL test_suite : public test_unit {
public:
    enum { type = TUT_SUITE };
...
class HBOOST_TEST_DECL master_test_suite_t : public test_suite {
public:
    master_test_suite_t();
...
HBOOST_TEST_DECL std::string normalize_test_case_name( const_string tu_name );
...
inline test_case*
make_test_case( hboost::function<void ()> const& test_func, const_string tc_name, const_string tc_file, std::size_t tc_line )
{
...
make_test_case( void (UserTestCase::*           test_method )(),
                ...
                std::size_t                     tc_line,
                hboost::shared_ptr<InstanceType> user_test_case )
{
...
#endif // HBOOST_TEST_TREE_TEST_UNIT_HPP_100211GER
