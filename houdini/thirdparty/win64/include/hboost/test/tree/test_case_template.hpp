...
#ifndef HBOOST_TEST_TREE_TEST_CASE_TEMPLATE_HPP_091911GER
#define HBOOST_TEST_TREE_TEST_CASE_TEMPLATE_HPP_091911GER
...
public:
    void    operator()()    { TestCaseTemplate::run( (hboost::type<TestType>*)0 ); }
};
...
#else
        full_name += HBOOST_CURRENT_FUNCTION;
#endif
        if( hboost::is_const<TestType>::value )
            full_name += "_const";
        full_name += '>';
...
#endif // HBOOST_TEST_TREE_TEST_CASE_TEMPLATE_HPP_091911GER
