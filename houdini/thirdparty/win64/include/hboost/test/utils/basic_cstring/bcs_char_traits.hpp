...
#ifndef HBOOST_TEST_UTILS_BCS_CHAR_TRAITS_HPP
#define HBOOST_TEST_UTILS_BCS_CHAR_TRAITS_HPP
...
#else
    typedef typename hboost::add_const<CharT>::type const_char;
#endif
...
#endif // HBOOST_TEST_UTILS_BCS_CHAR_TRAITS_HPP
