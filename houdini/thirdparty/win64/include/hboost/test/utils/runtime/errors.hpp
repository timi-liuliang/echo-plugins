...
#ifndef HBOOST_TEST_UTILS_RUNTIME_INIT_ERROR_HPP
#define HBOOST_TEST_UTILS_RUNTIME_INIT_ERROR_HPP
...
public:
    ~param_error() HBOOST_NOEXCEPT_OR_NOTHROW {}
...
protected:
    ...
    ~specific_param_error() HBOOST_NOEXCEPT_OR_NOTHROW {}
};
...
#endif
    ~ambiguous_param() HBOOST_NOEXCEPT_OR_NOTHROW {}
...
#endif
    ~unrecognized_param() HBOOST_NOEXCEPT_OR_NOTHROW {}
...
#endif // HBOOST_TEST_UTILS_RUNTIME_INIT_ERROR_HPP
