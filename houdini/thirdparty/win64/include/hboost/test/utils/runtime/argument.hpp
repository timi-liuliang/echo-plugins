...
#ifndef HBOOST_TEST_UTILS_RUNTIME_ARGUMENT_HPP
#define HBOOST_TEST_UTILS_RUNTIME_ARGUMENT_HPP
...
#include <hboost/test/utils/rtti.hpp>
...
public:
    ...
    T&          get( cstring parameter_name ) {
        ...
        HBOOST_TEST_I_ASSRT( found != m_arguments.end(),
        ...
        HBOOST_TEST_I_ASSRT( arg->p_value_type == rtti::type_id<T>(),
                            arg_type_mismatch()
...
#endif // HBOOST_TEST_UTILS_RUNTIME_ARGUMENT_HPP
