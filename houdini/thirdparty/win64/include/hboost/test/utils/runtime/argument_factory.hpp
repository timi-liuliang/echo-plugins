...
#ifndef HBOOST_TEST_UTILS_RUNTIME_ARGUMENT_FACTORY_HPP
#define HBOOST_TEST_UTILS_RUNTIME_ARGUMENT_FACTORY_HPP

// Boost.Test Runtime parameters
#include <hboost/test/utils/runtime/errors.hpp>
...
#include <hboost/test/utils/string_cast.hpp>
...
struct value_interpreter<ValueType, false> {
    ...
    ValueType interpret( cstring param_name, cstring source ) const
    {
        ...
        if( !unit_test::utils::string_as<ValueType>( source, res ) )
            HBOOST_TEST_I_THROW( format_error( param_name ) << source <<
...
struct value_interpreter<bool, false> {
    ...
    bool    interpret( cstring param_name, cstring source ) const
    {
        ...
        HBOOST_TEST_I_THROW( format_error( param_name ) << source << " can't be interpreted as bool value." );
    }
};
...
struct value_interpreter<EnumType, true> {
    ...
    EnumType        interpret( cstring param_name, cstring source ) const
    {
        ...
        HBOOST_TEST_I_ASSRT( found != m_name_to_value.end(),
...
#endif // HBOOST_TEST_UTILS_RUNTIME_ARGUMENT_FACTORY_HPP
