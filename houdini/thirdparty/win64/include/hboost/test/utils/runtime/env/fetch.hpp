...
#ifndef HBOOST_TEST_UTILS_RUNTIME_ENV_FETCH_HPP
#define HBOOST_TEST_UTILS_RUNTIME_ENV_FETCH_HPP
...
fetch_absent( parameters_store const& params, runtime::arguments_store& args, ReadFunc read_func )
{
    HBOOST_TEST_FOREACH( parameters_store::storage_type::value_type const&, v, params.all() ) {
        ...
        HBOOST_TEST_I_ASSRT( !value.first.is_empty() || param->p_has_optional_value,
...
#endif // HBOOST_TEST_UTILS_RUNTIME_ENV_FETCH_HPP
