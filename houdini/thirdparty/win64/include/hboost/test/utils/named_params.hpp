...
#ifndef HBOOST_TEST_UTILS_NAMED_PARAM
#define HBOOST_TEST_UTILS_NAMED_PARAM
...
#include <hboost/test/utils/assign_op.hpp>
...
{
    HBOOST_TEST_I_ASSRT( !v, access_to_invalid_parameter() );
}
...
#endif // HBOOST_TEST_UTILS_NAMED_PARAM
