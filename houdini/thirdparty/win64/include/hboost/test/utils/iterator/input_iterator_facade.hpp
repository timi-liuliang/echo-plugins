...
#ifndef HBOOST_TEST_UTILS_INPUT_ITERATOR_FACADE_HPP
#define HBOOST_TEST_UTILS_INPUT_ITERATOR_FACADE_HPP
...
{
#if defined(HBOOST_NO_MEMBER_TEMPLATE_FRIENDS) || HBOOST_WORKAROUND(__BORLANDC__, HBOOST_TESTED_AT(0x551))
public:
#else
...
#endif // HBOOST_TEST_UTILS_INPUT_ITERATOR_FACADE_HPP
