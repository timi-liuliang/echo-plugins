...
#ifndef HBOOST_TEST_UTILS_TOKEN_ITERATOR_HPP
#define HBOOST_TEST_UTILS_TOKEN_ITERATOR_HPP
...
#include <hboost/test/utils/iterator/input_iterator_facade.hpp>
#include <hboost/test/utils/basic_cstring/basic_cstring.hpp>
#include <hboost/test/utils/named_params.hpp>
...
public:
    ...
    bool        operator()( CharT c )
    {
        switch( m_type ) {
        case dt_char: {
            HBOOST_TEST_FOREACH( CharT, delim, m_delimeters )
...
#if HBOOST_WORKAROUND( HBOOST_DINKUMWARE_STDLIB, < 306 )
...
protected:
    ...
    {
        typedef ut_detail::token_assigner<HBOOST_DEDUCED_TYPENAME iterator_traversal<Iter>::type> Assigner;
        Iter check_point;
...
template<typename Iter,
         typename CharCompare = ut_detail::default_char_compare<HBOOST_DEDUCED_TYPENAME iterator_value<Iter>::type>,
         typename ValueType   = std::basic_string<HBOOST_DEDUCED_TYPENAME iterator_value<Iter>::type>,
...
#endif // HBOOST_TEST_UTILS_TOKEN_ITERATOR_HPP
