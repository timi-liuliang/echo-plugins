...
#ifndef HBOOST_TEST_UTILS_LAZY_OSTREAM_HPP
#define HBOOST_TEST_UTILS_LAZY_OSTREAM_HPP
...
inline lazy_ostream_impl<lazy_ostream,R& (HBOOST_TEST_CALL_DECL *)(S&),R& (HBOOST_TEST_CALL_DECL *)(S&)>
operator<<( lazy_ostream const& prev, R& (HBOOST_TEST_CALL_DECL *man)(S&) )
{
    typedef R& (HBOOST_TEST_CALL_DECL * ManipType)(S&);
...
inline lazy_ostream_impl<lazy_ostream_impl<PrevPrevType,TPrev>,R& (HBOOST_TEST_CALL_DECL *)(S&),R& (HBOOST_TEST_CALL_DECL *)(S&)>
operator<<( lazy_ostream_impl<PrevPrevType,TPrev> const& prev, R& (HBOOST_TEST_CALL_DECL *man)(S&) )
{
    typedef R& (HBOOST_TEST_CALL_DECL * ManipType)(S&);
...
#define HBOOST_TEST_LAZY_MSG( M ) (::hboost::unit_test::lazy_ostream::instance() << M)
...
#endif // HBOOST_TEST_UTILS_LAZY_OSTREAM_HPP
