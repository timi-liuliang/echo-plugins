...
#ifndef HBOOST_TEST_UTILS_SETCOLOR_HPP
#define HBOOST_TEST_UTILS_SETCOLOR_HPP
...
#define HBOOST_TEST_SCOPE_SETCOLOR( is_color_output, os, attr, color )   \
...
#endif // HBOOST_TEST_UTILS_SETCOLOR_HPP
