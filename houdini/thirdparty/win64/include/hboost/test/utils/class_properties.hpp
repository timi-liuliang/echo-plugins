...
#ifndef HBOOST_TEST_UTILS_CLASS_PROPERTIES_HPP
#define HBOOST_TEST_UTILS_CLASS_PROPERTIES_HPP
...
public:
    ...
    // Data members
#ifndef HBOOST_TEST_NO_PROTECTED_USING
protected:
#endif
    PropertyType        value;
};
...
#ifdef HBOOST_CLASSIC_IOSTREAMS
...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return hboost::addressof( base_prop::value ); }
};
...
#define HBOOST_READONLY_PROPERTY( property_type, friends ) hboost::unit_test::readwrite_property<property_type >

#else

#define HBOOST_READONLY_PROPERTY_DECLARE_FRIEND(r, data, elem) friend class elem;

#define HBOOST_READONLY_PROPERTY( property_type, friends )                           \
class HBOOST_JOIN( readonly_property, __LINE__ )                                     \
: public hboost::unit_test::readonly_property<property_type > {                      \
    typedef hboost::unit_test::readonly_property<property_type > base_prop;          \
    HBOOST_PP_SEQ_FOR_EACH( HBOOST_READONLY_PROPERTY_DECLARE_FRIEND, ' ', friends )   \
    typedef base_prop::write_param_t  write_param_t;                                \
public:                                                                             \
                HBOOST_JOIN( readonly_property, __LINE__ )() {}                      \
    explicit    HBOOST_JOIN( readonly_property, __LINE__ )( write_param_t init_v  )  \
    : base_prop( init_v ) {}                                                        \
}                                                                                   \
/**/
...
public:
    ...
    arrow_res_t     operator->()            { return hboost::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return hboost::addressof( base_prop::value ); }
...
#undef HBOOST_TEST_NO_PROTECTED_USING

#endif // HBOOST_TEST_UTILS_CLASS_PROPERTIES_HPP
