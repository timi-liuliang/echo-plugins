...
/// HBOOST_TEST_NO_MAIN before incuding this header. To initiate your main program body execution you
/// would use statement like this:
/// @code ::hboost::prg_exec_monitor_main( &my_main, argc, argv ); @endcode
/// Also this header facilitate auto linking with the Program Execution Monitor library if this feature
/// is supported
// ***************************************************************************

#ifndef HBOOST_PRG_EXEC_MONITOR_HPP_071894GER
#define HBOOST_PRG_EXEC_MONITOR_HPP_071894GER
...
#  define HBOOST_LIB_NAME hboost_prg_exec_monitor
...
/// functionality. THe monitor behavior is configurable by using the environment variable HBOOST_TEST_CATCH_SYSTEM_ERRORS.
...
int HBOOST_TEST_DECL prg_exec_monitor_main( int (*cpp_main)( int argc, char* argv[] ), int argc, char* argv[] );
...
#endif // HBOOST_PRG_EXEC_MONITOR_HPP_071894GER
