...
#ifndef HBOOST_TEST_UNIT_TEST_SUITE_IPP_012205GER
#define HBOOST_TEST_UNIT_TEST_SUITE_IPP_012205GER
...
{
    HBOOST_TEST_SETUP_ASSERT( p_id != framework::master_test_suite().p_id, 
...
{
    HBOOST_TEST_FOREACH( test_unit_id, dep_id, p_dependencies.get() ) {
    ...
    HBOOST_TEST_FOREACH( precondition_t, precondition, p_preconditions.get() ) {
...
test_case::test_case( const_string name, hboost::function<void ()> const& test_func )
...
test_case::test_case( const_string name, const_string file_name, std::size_t line_num, hboost::function<void ()> const& test_func )
...
{
    HBOOST_TEST_FOREACH( test_unit_id, id, m_children ) {
...
auto_test_unit_registrar::auto_test_unit_registrar( const_string ts_name, const_string ts_file, std::size_t ts_line, decorator::collector& decorators )
{
    ...
    if( id != INV_TEST_UNIT_ID ) {
        ...
        HBOOST_ASSERT( ts->p_parent_id == framework::current_auto_test_suite().p_id );
    }
    else {
...
#endif // HBOOST_TEST_UNIT_TEST_SUITE_IPP_012205GER
