...
#ifndef HBOOST_TEST_UNIT_TEST_LOG_IPP_012205GER
#define HBOOST_TEST_UNIT_TEST_LOG_IPP_012205GER
...
typedef ::hboost::io::ios_base_all_saver io_saver_type;
...
{
    HBOOST_TEST_LOG_ENTRY( log_messages ) << "Test is aborted";
}
...
unit_test_log_t::log_entry_start()
{
    ...
    case log_successful_tests:
        s_log_impl().m_log_formatter->log_entry_start( s_log_impl().stream(), s_log_impl().m_entry_data,
                                                       unit_test_log_formatter::HBOOST_UTL_ET_INFO );
        break;
    case log_messages:
        s_log_impl().m_log_formatter->log_entry_start( s_log_impl().stream(), s_log_impl().m_entry_data,
                                                       unit_test_log_formatter::HBOOST_UTL_ET_MESSAGE );
        break;
    case log_warnings:
        s_log_impl().m_log_formatter->log_entry_start( s_log_impl().stream(), s_log_impl().m_entry_data,
                                                       unit_test_log_formatter::HBOOST_UTL_ET_WARNING );
        break;
    case log_all_errors:
    case log_cpp_exception_errors:
    case log_system_errors:
        s_log_impl().m_log_formatter->log_entry_start( s_log_impl().stream(), s_log_impl().m_entry_data,
                                                       unit_test_log_formatter::HBOOST_UTL_ET_ERROR );
        break;
    case log_fatal_errors:
        s_log_impl().m_log_formatter->log_entry_start( s_log_impl().stream(), s_log_impl().m_entry_data,
                                                       unit_test_log_formatter::HBOOST_UTL_ET_FATAL_ERROR );
        break;
    case log_nothing:
    case log_test_units:
...
#endif // HBOOST_TEST_UNIT_TEST_LOG_IPP_012205GER
