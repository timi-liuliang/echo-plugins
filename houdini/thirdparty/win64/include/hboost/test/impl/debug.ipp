...
#ifndef HBOOST_TEST_DEBUG_API_IPP_112006GER
#define HBOOST_TEST_DEBUG_API_IPP_112006GER
...
#include <hboost/test/debug_config.hpp>

// Implementation on Windows
#if defined(_WIN32) && !defined(UNDER_CE) && !defined(HBOOST_DISABLE_WIN32) // ******* WIN32

#  define HBOOST_WIN32_BASED_DEBUG
...
#    define HBOOST_MS_CRT_BASED_DEBUG
#    include <crtdbg.h>
#  endif
...
#  define HBOOST_UNIX_BASED_DEBUG
...
#    define HBOOST_SUN_BASED_DEBUG

#    ifndef HBOOST_TEST_DBG_LIST
#      define HBOOST_TEST_DBG_LIST dbx;gdb
#    endif

#    define HBOOST_TEST_CNL_DBG  dbx
#    define HBOOST_TEST_GUI_DBG  dbx-ddd

#    include <procfs.h>

#  elif defined(linux) || defined(__linux)

#    define HBOOST_LINUX_BASED_DEBUG

#    include <sys/ptrace.h>

#    ifndef HBOOST_TEST_STAT_LINE_MAX
#      define HBOOST_TEST_STAT_LINE_MAX 500
#    endif

#    ifndef HBOOST_TEST_DBG_LIST
#      define HBOOST_TEST_DBG_LIST gdb
#    endif

#    define HBOOST_TEST_CNL_DBG  gdb
#    define HBOOST_TEST_GUI_DBG  gdb-xterm
...
#if defined(HBOOST_WIN32_BASED_DEBUG) // *********************** WIN32
...
#elif defined(HBOOST_UNIX_BASED_DEBUG)
...
#if defined(HBOOST_SUN_BASED_DEBUG)
    struct psinfo   m_psi;
    char            m_binary_path_buff[500+1]; // !! ??
#elif defined(HBOOST_LINUX_BASED_DEBUG)
    char            m_stat_line[HBOOST_TEST_STAT_LINE_MAX+1];
    char            m_binary_path_buff[500+1]; // !! ??
#endif
};
...
info_t::info_t()
{
    p_dbg.value = ::getenv( "DISPLAY" )
        ? std::string( HBOOST_STRINGIZE( HBOOST_TEST_GUI_DBG ) )
        : std::string( HBOOST_STRINGIZE( HBOOST_TEST_CNL_DBG ) );
...
#elif defined(HBOOST_UNIX_BASED_DEBUG) // ********************** UNIX

    // !! ?? could/should we cache the result somehow?
    const_string    dbg_list = HBOOST_TEST_STRINGIZE( HBOOST_TEST_DBG_LIST );
...
#   define HBOOST_DEBUG_BREAK    __debugbreak
#else
#   define HBOOST_DEBUG_BREAK    DebugBreak
#endif
    ...
    if( !under_debugger() ) {
        ...
        __except (EXCEPTION_EXECUTE_HANDLER)
        {
            ...
            // continue to let the another HBOOST_DEBUG_BREAK to be called.
        }
    }
#endif
...
#if defined(HBOOST_UNIX_BASED_DEBUG) // ************************ UNIX
...
#if defined(HBOOST_WIN32_BASED_DEBUG)
...
#ifdef HBOOST_MS_CRT_BASED_DEBUG
...
#endif // HBOOST_MS_CRT_BASED_DEBUG
}
...
#endif // HBOOST_TEST_DEBUG_API_IPP_112006GER
