...
#ifndef HBOOST_TEST_UNIT_TEST_PARAMETERS_IPP_012205GER
#define HBOOST_TEST_UNIT_TEST_PARAMETERS_IPP_012205GER
...
#include <hboost/test/utils/runtime/finalize.hpp>
#include <hboost/test/utils/runtime/cla/parser.hpp>
#include <hboost/test/utils/runtime/env/fetch.hpp>
...
register_parameters( rt::parameters_store& store )
{
    rt::option auto_start_dbg( AUTO_START_DBG, (
        ...
        rt::env_var = "HBOOST_TEST_AUTO_START_DBG",
        ...
        rt::help = "Option " + AUTO_START_DBG + " specifies whether Boost.Test should attempt "
                   ...
                   "Boost.Test debug API, specifically the function hboost::debug::set_debugger."
    ));
    ...
    rt::parameter<std::string> break_exec_path( BREAK_EXEC_PATH, (
        ...
        rt::env_var = "HBOOST_TEST_BREAK_EXEC_PATH"
#ifndef HBOOST_NO_CXX11_LAMBDAS
        ,
        rt::callback = [](rt::cstring) {
            HBOOST_TEST_SETUP_ASSERT( false, "parameter break_exec_path is disabled in this release" );
        }
#endif
    ));
    ...
    rt::option build_info( BUILD_INFO, (
        ...
        rt::env_var = "HBOOST_TEST_BUILD_INFO",
    ...
    rt::option catch_sys_errors( CATCH_SYS_ERRORS, (
        ...
        rt::env_var = "HBOOST_TEST_CATCH_SYSTEM_ERRORS",
        rt::default_value =
#ifdef HBOOST_TEST_DEFAULTS_TO_CORE_DUMP
            false,
#else
            true,
#endif
    ...
    rt::option color_output( COLOR_OUTPUT, (
        ...
        rt::env_var = "HBOOST_TEST_COLOR_OUTPUT",
    ...
    rt::option detect_fp_except( DETECT_FP_EXCEPT, (
        ...
        rt::env_var = "HBOOST_TEST_DETECT_FP_EXCEPTIONS",
    ...
    rt::parameter<unsigned long> detect_mem_leaks( DETECT_MEM_LEAKS, (
        ...
        rt::env_var = "HBOOST_TEST_DETECT_MEMORY_LEAK",
        rt::default_value = 1L,
    ...
    rt::enum_parameter<unit_test::output_format> list_content( LIST_CONTENT, (
        ...
        rt::env_var = "HBOOST_TEST_LIST_CONTENT",
        rt::default_value = OF_INVALID,
        rt::optional_value = OF_CLF,
        rt::enum_values<unit_test::output_format>::value = 
#if !defined(HBOOST_NO_CXX11_HDR_INITIALIZER_LIST) && !defined(HBOOST_NO_CXX11_UNIFIED_INITIALIZATION_SYNTAX)
        {
            { "HRF", OF_CLF },
            { "DOT", OF_DOT }
        },
    ...
    rt::option list_labels( LIST_LABELS, (
        ...
        rt::env_var = "HBOOST_TEST_LIST_LABELS",
    ...
    rt::enum_parameter<unit_test::output_format> log_format( LOG_FORMAT, (
        ...
        rt::env_var = "HBOOST_TEST_LOG_FORMAT",
    ...
    rt::enum_parameter<unit_test::log_level> log_level( LOG_LEVEL, (
        ...
        rt::env_var = "HBOOST_TEST_LOG_LEVEL",
    ...
    rt::parameter<std::string> log_sink( LOG_SINK, (
        ...
        rt::env_var = "HBOOST_TEST_LOG_SINK",
    ...
    rt::enum_parameter<unit_test::output_format> output_format( OUTPUT_FORMAT, (
        ...
        rt::env_var = "HBOOST_TEST_OUTPUT_FORMAT",
        rt::enum_values<unit_test::output_format>::value =
#if !defined(HBOOST_NO_CXX11_HDR_INITIALIZER_LIST) && !defined(HBOOST_NO_CXX11_UNIFIED_INITIALIZATION_SYNTAX)
        {
            { "HRF", OF_CLF },
    ...
    rt::enum_parameter<unit_test::output_format> report_format( REPORT_FORMAT, (
        ...
        rt::env_var = "HBOOST_TEST_REPORT_FORMAT",
        rt::default_value = OF_CLF,
        rt::enum_values<unit_test::output_format>::value =
#if !defined(HBOOST_NO_CXX11_HDR_INITIALIZER_LIST) && !defined(HBOOST_NO_CXX11_UNIFIED_INITIALIZATION_SYNTAX)
        {
    ...
    rt::enum_parameter<unit_test::report_level> report_level( REPORT_LEVEL, (
        ...
        rt::env_var = "HBOOST_TEST_REPORT_LEVEL",
    ...
    rt::parameter<std::string> report_mem_leaks( REPORT_MEM_LEAKS, (
        ...
        rt::env_var = "HBOOST_TEST_REPORT_MEMORY_LEAKS_TO",
    ...
    rt::parameter<std::string> report_sink( REPORT_SINK, (
        ...
        rt::env_var = "HBOOST_TEST_REPORT_SINK",
        rt::value_hint = "<stderr|stdout|file name>",
    ...
    rt::option result_code( RESULT_CODE, (
        ...
        rt::env_var = "HBOOST_TEST_RESULT_CODE",
    ...
    rt::parameter<std::string,rt::REPEATABLE_PARAM> tests_to_run( RUN_FILTERS, (
        ...
        rt::env_var = "HBOOST_TEST_RUN_FILTERS",
    ...
    rt::option save_test_pattern( SAVE_TEST_PATTERN, (
        ...
        rt::env_var = "HBOOST_TEST_SAVE_PATTERN",
    ...
    rt::option show_progress( SHOW_PROGRESS, (
        ...
        rt::env_var = "HBOOST_TEST_SHOW_PROGRESS",
    ...
    rt::option use_alt_stack( USE_ALT_STACK, (
        ...
        rt::env_var = "HBOOST_TEST_USE_ALT_STACK",
        rt::default_value = true,
    ...
    rt::option wait_for_debugger( WAIT_FOR_DEBUGGER, (
        ...
        rt::env_var = "HBOOST_TEST_WAIT_FOR_DEBUGGER",
...
init( int& argc, char** argv )
{
    ...
    HBOOST_TEST_I_TRY {
        ...
        if( runtime_config::get<bool>( USAGE ) ) {
            ...
            HBOOST_TEST_I_THROW( framework::nothing_to_test( hboost::exit_success ) );
        }
    ...
    HBOOST_TEST_I_CATCH( rt::init_error, ex ) {
        HBOOST_TEST_SETUP_ASSERT( false, ex.msg );
    }
    HBOOST_TEST_I_CATCH( rt::ambiguous_param, ex ) {
        std::cerr << ex.msg << "\n Did you mean one of these?\n";

        HBOOST_TEST_FOREACH( rt::cstring, name, ex.m_amb_candidates )
            std::cerr << "   " << name << "\n";

        HBOOST_TEST_I_THROW( framework::nothing_to_test( hboost::exit_exception_failure ) );
    }
    HBOOST_TEST_I_CATCH( rt::unrecognized_param, ex ) {
        std::cerr << ex.msg << "\n";

        if( !ex.m_typo_candidates.empty() ) {
            std::cerr << " Did you mean one of these?\n";

            HBOOST_TEST_FOREACH( rt::cstring, name, ex.m_typo_candidates )
                std::cerr << "   " << name << "\n";
        }
        else if( parser ) {
            std::cerr << "\n";
    ...
    HBOOST_TEST_I_CATCH( rt::input_error, ex ) {
        std::cerr << ex.msg << "\n\n";
...
#endif // HBOOST_TEST_UNIT_TEST_PARAMETERS_IPP_012205GER
