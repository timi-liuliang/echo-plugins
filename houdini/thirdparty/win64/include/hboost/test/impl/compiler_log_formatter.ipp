...
#ifndef HBOOST_TEST_COMPILER_LOG_FORMATTER_IPP_020105GER
#define HBOOST_TEST_COMPILER_LOG_FORMATTER_IPP_020105GER

// Boost.Test
#include <hboost/test/output/compiler_log_formatter.hpp>
...
#include <hboost/test/utils/setcolor.hpp>
...
{
    output  << "Platform: " << HBOOST_PLATFORM            << '\n'
            << "Compiler: " << HBOOST_COMPILER            << '\n'
            << "STL     : " << HBOOST_STDLIB              << '\n'
            << "Boost   : " << HBOOST_VERSION/100000      << "."
                            << HBOOST_VERSION/100 % 1000  << "."
                            << HBOOST_VERSION % 100       << std::endl;
}
...
{
    HBOOST_TEST_SCOPE_SETCOLOR( m_color_output, output, term_attr::BRIGHT, term_color::BLUE );
...
{
    HBOOST_TEST_SCOPE_SETCOLOR( m_color_output, output, term_attr::BRIGHT, term_color::YELLOW );
...
compiler_log_formatter::log_exception_start( std::ostream& output, log_checkpoint_data const& checkpoint_data, execution_exception const& ex )
{
    ...
    {
        HBOOST_TEST_SCOPE_SETCOLOR( m_color_output, output, term_attr::BLINK, term_color::RED );
    ...
    if( !checkpoint_data.m_file_name.is_empty() ) {
        ...
        HBOOST_TEST_SCOPE_SETCOLOR( m_color_output, output, term_attr::BRIGHT, term_color::CYAN );
...
#endif // HBOOST_TEST_COMPILER_LOG_FORMATTER_IPP_020105GER
