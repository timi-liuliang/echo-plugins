...
#ifndef HBOOST_TEST_PROGRESS_MONITOR_IPP_020105GER
#define HBOOST_TEST_PROGRESS_MONITOR_IPP_020105GER
...
private:
    HBOOST_DELETED_FUNCTION(progress_display(progress_display const&))
    HBOOST_DELETED_FUNCTION(progress_display& operator=(progress_display const&))
...
#define PM_SCOPED_COLOR() \
    HBOOST_TEST_SCOPE_SETCOLOR( s_pm_impl().m_color_output, *s_pm_impl().m_stream, term_attr::BRIGHT, term_color::MAGENTA )
...
#endif // HBOOST_TEST_PROGRESS_MONITOR_IPP_020105GER
