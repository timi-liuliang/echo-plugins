...
#ifndef HBOOST_TEST_PLAIN_REPORT_FORMATTER_IPP_020105GER
#define HBOOST_TEST_PLAIN_REPORT_FORMATTER_IPP_020105GER

// Boost.Test
#include <hboost/test/output/plain_report_formatter.hpp>
#include <hboost/test/utils/custom_manip.hpp>
...
plain_report_formatter::do_confirmation_report( test_unit const& tu, std::ostream& ostr )
{
    ...
    if( tr.passed() ) {
        HBOOST_TEST_SCOPE_SETCOLOR( m_color_output, ostr, term_attr::BRIGHT, term_color::GREEN );

        ostr << "*** No errors detected\n";
        return;
    }

    HBOOST_TEST_SCOPE_SETCOLOR( m_color_output, ostr, term_attr::BRIGHT, term_color::RED );
...
#endif // HBOOST_TEST_PLAIN_REPORT_FORMATTER_IPP_020105GER
