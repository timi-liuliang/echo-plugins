...
#ifndef HBOOST_TEST_DEBUG_API_HPP_112006GER
#define HBOOST_TEST_DEBUG_API_HPP_112006GER
...
///
/// All these interfaces are defined in namespace hboost::debug
...
// ************************************************************************** //
bool HBOOST_TEST_DECL under_debugger();

// ************************************************************************** //
/// Cause program to break execution in debugger at call point
// ************************************************************************** //

void HBOOST_TEST_DECL debugger_break();
...
typedef hboost::function<void (dbg_startup_info const&)> dbg_starter;
...
std::string HBOOST_TEST_DECL set_debugger( unit_test::const_string dbg_id, dbg_starter s = dbg_starter() );
...
bool HBOOST_TEST_DECL attach_debugger( bool break_or_continue = true );
...
void HBOOST_TEST_DECL detect_memory_leaks( bool on_off, unit_test::const_string report_file = unit_test::const_string() );
...
void HBOOST_TEST_DECL break_memory_alloc( long mem_alloc_order_num );
