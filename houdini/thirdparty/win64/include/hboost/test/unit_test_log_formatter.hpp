...
#ifndef HBOOST_TEST_UNIT_TEST_LOG_FORMATTER_HPP_071894GER
#define HBOOST_TEST_UNIT_TEST_LOG_FORMATTER_HPP_071894GER
...
struct HBOOST_TEST_DECL log_entry_data {
    log_entry_data()
    {
...
struct HBOOST_TEST_DECL log_checkpoint_data
{
...
class HBOOST_TEST_DECL unit_test_log_formatter {
public:
    /// Types of log entries (messages written into a log)
    enum log_entry_types { HBOOST_UTL_ET_INFO,       ///< Information message from the framework
                           HBOOST_UTL_ET_MESSAGE,    ///< Information message from the user
                           HBOOST_UTL_ET_WARNING,    ///< Warning (non error) condition notification message
                           HBOOST_UTL_ET_ERROR,      ///< Non fatal error notification message
                           HBOOST_UTL_ET_FATAL_ERROR ///< Fatal error notification message
    };
    ...
    /// HBOOST_TEST_INFO/HBOOST_TEST_CONTEXT statements.
    /// @param[in] os   output stream to write a messages into
...
#endif // HBOOST_TEST_UNIT_TEST_LOG_FORMATTER_HPP_071894GER
