...
#ifndef HBOOST_UUID_8D22C4CA9CC811DCAA9133D256D89593
#define HBOOST_UUID_8D22C4CA9CC811DCAA9133D256D89593
...
#include <hboost/exception/to_string_stub.hpp>
#include <hboost/exception/detail/error_info_impl.hpp>
...
hboost
    ...
    exception_detail
        ...
        error_info_container_impl:
            ...
            get( type_info_ const & ti ) const
                ...
                if( info_.end()!=i )
                    ...
                    HBOOST_ASSERT( *HBOOST_EXCEPTION_DYNAMIC_TYPEID(*p).type_==*ti.type_ );
#endif
                    return p;
                    }
        ...
        set_info( E const & x, error_info<Tag,T> const & v )
            ...
            c->set(p,HBOOST_EXCEPTION_STATIC_TYPEID(error_info_tag_t));
            return x;
            }

        template <class T>
        struct
        derives_hboost_exception
            {
            enum e { value = (sizeof(dispatch_hboost_exception((T*)0))==sizeof(large_size)) };
            };
        }

    template <class E,class Tag,class T>
    inline
    typename enable_if<exception_detail::derives_hboost_exception<E>,E const &>::type
