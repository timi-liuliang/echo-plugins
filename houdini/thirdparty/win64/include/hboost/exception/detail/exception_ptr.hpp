...
#ifndef HBOOST_UUID_618474C2DE1511DEB74A388C56D89593
#define HBOOST_UUID_618474C2DE1511DEB74A388C56D89593
...
#include <hboost/exception/diagnostic_information.hpp>
#include <hboost/exception/detail/type_info.hpp>
#include <hboost/exception/detail/clone_current_exception.hpp>
...
hboost
    {
    class exception_ptr;
    HBOOST_NORETURN void rethrow_exception( exception_ptr const & );
    exception_ptr current_exception();

    class
    exception_ptr
        {
        typedef hboost::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
    ...
    exception_detail
        ...
        get_static_exception_object()
            ...
            c <<
                throw_function(HBOOST_CURRENT_FUNCTION) <<
                throw_file(__FILE__) <<
                throw_line(__LINE__);
#endif
...
# endif
    ...
    unknown_exception:
        ...
        explicit
        unknown_exception( hboost::exception const & e ):
            hboost::exception(e)
            {
            add_original_type(e);
            }
...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception_wrapper:
            ...
            current_exception_std_exception_wrapper( T const & e1, hboost::exception const & e2 ):
                T(e1),
                hboost::exception(e2)
                {
                add_original_type(e1);
        ...
        template <class T>
        hboost::exception const *
        get_hboost_exception( T const * )
            {
            try
                {
                throw;
        ...
        template <class T>
        hboost::exception const *
        get_hboost_exception( T const * x )
            {
            return dynamic_cast<hboost::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( hboost::exception const * e2 = get_hboost_exception(&e1) )
                return hboost::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return hboost::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
        ...
        current_exception_unknown_exception()
            {
            return hboost::copy_exception(unknown_exception());
            }

        inline
        exception_ptr
        current_exception_unknown_hboost_exception( hboost::exception const & e )
            {
            return hboost::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( hboost::exception const * be = get_hboost_exception(&e) )
                return current_exception_unknown_hboost_exception(*be);
            else
                return hboost::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_impl()
            ...
            exception_detail::clone_current_exception(e) )
                ...
                not_supported:
                    ...
                    hboost::exception & e )
                        {
                        return exception_detail::current_exception_unknown_hboost_exception(e);
                        }
                    catch(
                    ... )
                        {
