...
#ifndef HBOOST_FORMAT_EXCEPTIONS_HPP
#define HBOOST_FORMAT_EXCEPTIONS_HPP
...
// **** exceptions -----------------------------------------------
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "hboost::bad_format_string: format-string is ill-formed";
            }
        };
...
#endif // HBOOST_FORMAT_EXCEPTIONS_HPP
