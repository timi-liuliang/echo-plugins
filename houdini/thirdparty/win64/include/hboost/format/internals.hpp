...
#ifndef HBOOST_FORMAT_INTERNALS_HPP
#define HBOOST_FORMAT_INTERNALS_HPP
...
#include <hboost/format/alt_sstream.hpp> // used as a dummy stream
...
//   set of params that define the format state of a stream
    ...
    {
        typedef HBOOST_IO_STD basic_ios<Ch, Tr>   basic_ios;
...
//        stream_format_state(const basic_ios& os)     { set_by_stream(os); }
        ...
        void apply_on(basic_ios & os,            //- applies format_state to the stream
                      hboost::io::detail::locale_t * loc_default = 0) const;
        template<class T> 
        ...
        hboost::optional<hboost::io::detail::locale_t>  loc_;
    };  
...
// -   stream_format_state:: -------------------------------------------------
    ...
    void stream_format_state<Ch,Tr>:: apply_on (basic_ios & os,
                      hboost::io::detail::locale_t * loc_default) const {
    ...
    compute_states() {
        ...
        if(pad_scheme_ & zeropad) {
            ...
            if(fmtstate_.flags_ & std::ios_base::left) {
              HBOOST_ASSERT(!(fmtstate_.flags_ &(std::ios_base::adjustfield ^std::ios_base::left)));
...
} } } // namespaces hboost :: io :: detail


#endif // HBOOST_FORMAT_INTERNALS_HPP
