...
#ifndef HBOOST_FORMAT_CLASS_HPP
#define HBOOST_FORMAT_CLASS_HPP


#include <vector>
#include <string>

#include <hboost/optional.hpp> // to store locale when needed

#include <hboost/format/format_fwd.hpp>
#include <hboost/format/internals_fwd.hpp>
#include <hboost/format/internals.hpp>
#include <hboost/format/alt_sstream.hpp>
...
namespace hboost {
    ...
    private:
        ...
        hboost::optional<io::detail::locale_t>     loc_;
    }; // class basic_format

} // namespace hboost


#endif // HBOOST_FORMAT_CLASS_HPP
