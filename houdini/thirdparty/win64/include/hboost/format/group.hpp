...
#ifndef HBOOST_FORMAT_GROUP_HPP
#define HBOOST_FORMAT_GROUP_HPP
...
inline
HBOOST_IO_STD basic_ostream<Ch, Tr>&
operator << ( HBOOST_IO_STD basic_ostream<Ch, Tr>& os,
             const group0& )
{ 
   return os; 
}
...
#endif  // - HBOOST_NO_OVERLOAD_FOR_NON_CONST
