...
#ifndef HBOOST_FORMAT_COMPAT_WORKAROUNDS_HPP
#define HBOOST_FORMAT_COMPAT_WORKAROUNDS_HPP
...
#include <hboost/format/detail/config_macros.hpp>
   // sets-up macros and load compiler-specific workarounds headers.

#if !defined(HBOOST_FORMAT_STREAMBUF_DEFINED)
// workarounds-gcc-2.95 might have defined own streambuf
#include <streambuf>
#endif

#if !defined(HBOOST_FORMAT_OSTREAM_DEFINED)
