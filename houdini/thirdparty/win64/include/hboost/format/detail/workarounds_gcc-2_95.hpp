...
#if  HBOOST_WORKAROUND(__GNUC__, < 3) && !defined(__SGI_STL_PORT) && !defined(_STLPORT_VERSION)
   // only for gcc-2.95's native stdlib

#ifndef HBOOST_FORMAT_WORKAROUNDS_GCC295_H
#define HBOOST_FORMAT_WORKAROUNDS_GCC295_H

// SGI STL doesnt have <ostream> and others, so we need iostream.
#include <iostream> 
#define HBOOST_FORMAT_OSTREAM_DEFINED

#include <streambuf.h>
#define HBOOST_FORMAT_STREAMBUF_DEFINED

#define HBOOST_NO_TEMPLATE_STD_STREAM
