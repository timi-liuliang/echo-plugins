...
#ifndef HBOOST_STRING_FIND_FORMAT_HPP
#define HBOOST_STRING_FIND_FORMAT_HPP
...
#include <hboost/algorithm/string/detail/find_format.hpp>
#include <hboost/algorithm/string/detail/find_format_all.hpp>
        ...
        */
            ...
            FormatterT Formatter )
        {
            ...
            HBOOST_CONCEPT_ASSERT((
                FinderConcept<
                    FinderT,
                    HBOOST_STRING_TYPENAME range_const_iterator<RangeT>::type>
                ));
            HBOOST_CONCEPT_ASSERT((
                FormatterConcept<
                    FormatterT,
                    FinderT,HBOOST_STRING_TYPENAME range_const_iterator<RangeT>::type>
                ));
            ...
            return detail::find_format_copy_impl(
                ...
                lit_input,
                Formatter,
                Finder( ::hboost::begin(lit_input), ::hboost::end(lit_input) ) );
        }
        ...
        */
            ...
            FormatterT Formatter )
        {
            ...
            HBOOST_CONCEPT_ASSERT((
                FinderConcept<
                    FinderT,
                    HBOOST_STRING_TYPENAME range_const_iterator<SequenceT>::type>
                ));
            HBOOST_CONCEPT_ASSERT((
                FormatterConcept<
                    FormatterT,
                    FinderT,HBOOST_STRING_TYPENAME range_const_iterator<SequenceT>::type>
                ));

            return detail::find_format_copy_impl(
                Input,
                Formatter,
                Finder(::hboost::begin(Input), ::hboost::end(Input)));
        }
...
#endif  // HBOOST_STRING_FIND_FORMAT_HPP
