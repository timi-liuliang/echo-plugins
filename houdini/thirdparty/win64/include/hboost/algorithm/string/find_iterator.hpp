...
#ifndef HBOOST_STRING_FIND_ITERATOR_HPP
#define HBOOST_STRING_FIND_ITERATOR_HPP
...
#include <hboost/algorithm/string/detail/find_iterator.hpp>
...
//  find_iterator -----------------------------------------------//
        ...
        */
        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<HBOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::hboost::as_literal(Col));
                m_Match=::hboost::make_iterator_range(::hboost::begin(lit_col), ::hboost::begin(lit_col));
                m_End=::hboost::end(lit_col);
        ...
        make_find_iterator(
            ...
            FinderT Finder)
        {
            return find_iterator<HBOOST_STRING_TYPENAME range_iterator<RangeT>::type>(
                Collection, Finder);
        }
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<HBOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::hboost::as_literal(Col));
                m_Match=make_iterator_range(::hboost::begin(lit_col), ::hboost::begin(lit_col));
                m_Next=::hboost::begin(lit_col);
                m_End=::hboost::end(lit_col);
        ...
        make_split_iterator(
            ...
            FinderT Finder)
        {
            return split_iterator<HBOOST_STRING_TYPENAME range_iterator<RangeT>::type>(
                Collection, Finder);
        }
...
#endif  // HBOOST_STRING_FIND_ITERATOR_HPP
