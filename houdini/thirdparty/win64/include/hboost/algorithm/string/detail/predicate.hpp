...
#ifndef HBOOST_STRING_PREDICATE_DETAIL_HPP
#define HBOOST_STRING_PREDICATE_DETAIL_HPP
...
//  ends_with predicate implementation ----------------------------------//
                ...
                std::forward_iterator_tag)
            {
                ...
                iterator_range<ForwardIterator1T> Result
                    =last_finder( 
                        ::hboost::make_iterator_range(SubBegin, SubEnd),
                        Comp)(Begin, End);
...
#endif  // HBOOST_STRING_PREDICATE_DETAIL_HPP
