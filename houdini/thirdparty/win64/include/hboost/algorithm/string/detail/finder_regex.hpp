...
#ifndef HBOOST_STRING_FINDER_REGEX_DETAIL_HPP
#define HBOOST_STRING_FINDER_REGEX_DETAIL_HPP
...
//  regex find functor -----------------------------------------------//
                ...
                public iterator_range<IteratorT>
            {
                ...
                typedef HBOOST_STRING_TYPENAME base_type::value_type value_type;
                typedef HBOOST_STRING_TYPENAME base_type::difference_type difference_type;
                typedef HBOOST_STRING_TYPENAME base_type::const_iterator const_iterator;
                typedef HBOOST_STRING_TYPENAME base_type::iterator iterator;
                typedef hboost::match_results<iterator> match_results_type;
            ...
            */
            ...
            struct find_regexF
            {
                    ...
                    ForwardIteratorT End ) const
                {
                    ...
                    // search for a match
                    if ( ::hboost::regex_search( Begin, End, result, m_Rx, m_MatchFlags ) )
                    {
                        // construct a result
...
#endif  // HBOOST_STRING_FIND_DETAIL_HPP
