...
#ifndef HBOOST_STRING_REPLACE_STORAGE_DETAIL_HPP
#define HBOOST_STRING_REPLACE_STORAGE_DETAIL_HPP

#include <hboost/algorithm/string/config.hpp>
#include <algorithm>
#include <hboost/mpl/bool.hpp>
#include <hboost/algorithm/string/sequence_traits.hpp>
#include <hboost/algorithm/string/detail/sequence.hpp>
...
//  storage handling routines -----------------------------------------------//
            ...
            inline void copy_to_storage(
                ...
                const WhatT& What )
            {
                Storage.insert( Storage.end(), ::hboost::begin(What), ::hboost::end(What) );
            }
...
//  process segment routine -----------------------------------------------//
            ...
            struct process_segment_helper
            {
                    ...
                    ForwardIteratorT SegmentEnd )
                {
                    ...
                    ForwardIteratorT It=::hboost::algorithm::detail::move_from_storage( Storage, InsertIt, SegmentBegin );
            ...
            struct process_segment_helper< true >
            {
...

                {
                    ...
                    ::hboost::algorithm::detail::replace( Input, InsertIt, SegmentBegin, Storage );
                    // Empty the storage
                    Storage.clear();
...
#endif  // HBOOST_STRING_REPLACE_STORAGE_DETAIL_HPP
