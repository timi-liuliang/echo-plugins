...
#ifndef HBOOST_STRING_FORMATTER_REGEX_DETAIL_HPP
#define HBOOST_STRING_FORMATTER_REGEX_DETAIL_HPP

#include <hboost/algorithm/string/config.hpp>
#include <string>
#include <hboost/regex.hpp>
#include <hboost/algorithm/string/detail/finder_regex.hpp>
...
//  regex format functor -----------------------------------------//
            ...
            private:
                ...
                typedef HBOOST_STRING_TYPENAME StringT::value_type char_type;
