...
#ifndef HBOOST_STRING_REGEX_HPP
#define HBOOST_STRING_REGEX_HPP
...
#include <hboost/algorithm/string/regex_find_format.hpp>
#include <hboost/algorithm/string/formatter.hpp>
#include <hboost/algorithm/string/iter_find.hpp>
...
//  find_regex  -----------------------------------------------//
        ...
        */
            ...
            match_flag_type Flags=match_default )
        {
            ...
            return ::hboost::algorithm::regex_finder(Rx,Flags)(
                ::hboost::begin(lit_input), ::hboost::end(lit_input) );
        }
...
//  replace_regex --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::hboost::algorithm::find_format_copy( 
                Output,
                Input,
                ::hboost::algorithm::regex_finder( Rx, Flags ),
                ::hboost::algorithm::regex_formatter( Format, Flags ) );
        }
...
//  replace_all_regex --------------------------------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT replace_all_regex_copy(
            ...
            match_flag_type Flags=match_default | format_default )
        {
            return ::hboost::algorithm::find_format_all_copy( 
                Output,
                Input,
                ::hboost::algorithm::regex_finder( Rx, Flags ),
                ::hboost::algorithm::regex_formatter( Format, Flags ) );
        ...
        */
        ...
        inline void replace_all_regex( 
            ...
            match_flag_type Flags=match_default | format_default )
        {
            ::hboost::algorithm::find_format_all( 
                Input,
                ::hboost::algorithm::regex_finder( Rx, Flags ),
                ::hboost::algorithm::regex_formatter( Format, Flags ) );
        }
       ...
       */
            ...
            match_flag_type Flags=match_default )
        {
            return ::hboost::algorithm::find_format_copy(
                ...
                Input,
                ::hboost::algorithm::regex_finder( Rx, Flags ),
                ::hboost::algorithm::empty_formatter( Input ) );
        }
...
//  find_all_regex ------------------------------------------------------------------//
        ...
        /*!
            ...
            or \c std::list<hboost::iterator_range<std::string::iterator>>
        ...
        */
        ...
        inline SequenceSequenceT& find_all_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::hboost::algorithm::iter_find(
                Result,
                Input,
                ::hboost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  split_regex ------------------------------------------------------------------//
        ...
        */
        ...
        inline SequenceSequenceT& split_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::hboost::algorithm::iter_split(
                Result,
                Input,
                ::hboost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  join_if ------------------------------------------------------------------//
        ...
        */
            ...
            match_flag_type Flags=match_default )
        {
            ...
            // Parse input
            InputIteratorT itBegin=::hboost::begin(Input);
            InputIteratorT itEnd=::hboost::end(Input);
            ...
            while(
                itBegin!=itEnd && 
                !::hboost::regex_match(::hboost::begin(*itBegin), ::hboost::end(*itBegin), Rx, Flags)) ++itBegin;

            // Add this element
            if(itBegin!=itEnd)
            {
                detail::insert(Result, ::hboost::end(Result), *itBegin);
                ++itBegin;
            }

            for(;itBegin!=itEnd; ++itBegin)
            {
                if(::hboost::regex_match(::hboost::begin(*itBegin), ::hboost::end(*itBegin), Rx, Flags))
                {
                    // Add separator
                    detail::insert(Result, ::hboost::end(Result), ::hboost::as_literal(Separator));
                    // Add element
                    detail::insert(Result, ::hboost::end(Result), *itBegin);
                }
            }
...
#else  // HBOOST_NO_FUNCTION_TEMPLATE_ORDERING
