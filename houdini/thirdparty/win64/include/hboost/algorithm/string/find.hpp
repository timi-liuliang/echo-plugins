...
#ifndef HBOOST_STRING_FIND_HPP
#define HBOOST_STRING_FIND_HPP
...
#include <hboost/algorithm/string/constants.hpp>
...
//  Generic find -----------------------------------------------//
        ...
        */
            ...
            const FinderT& Finder)
        {
            ...
            return Finder(::hboost::begin(lit_input),::hboost::end(lit_input));
        }
...
//  find_first  -----------------------------------------------//
        ...
        */
        ...
        inline iterator_range< 
            HBOOST_STRING_TYPENAME range_iterator<Range1T>::type>
        find_first( 
            Range1T& Input, 
            const Range2T& Search)
        {
            return ::hboost::algorithm::find(Input, ::hboost::algorithm::first_finder(Search));
        }
        ...
        */
        ...
        {
            return ::hboost::algorithm::find(Input, ::hboost::algorithm::first_finder(Search,is_iequal(Loc)));
        }
...
//  find_last  -----------------------------------------------//
        ...
        */
        ...
        find_last( 
            ...
            const Range2T& Search)
        {
            return ::hboost::algorithm::find(Input, ::hboost::algorithm::last_finder(Search));
        }
        ...
        */
        ...
        ifind_last( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::hboost::algorithm::find(Input, ::hboost::algorithm::last_finder(Search, is_iequal(Loc)));
        }
...
//  find_nth ----------------------------------------------------------------------//
        ...
        */
        ...
        find_nth( 
            ...
            int Nth)
        {
            return ::hboost::algorithm::find(Input, ::hboost::algorithm::nth_finder(Search,Nth));
        }
        ...
        */
        ...
        ifind_nth( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::hboost::algorithm::find(Input, ::hboost::algorithm::nth_finder(Search,Nth,is_iequal(Loc)));
        }
...
//  find_head ----------------------------------------------------------------------//
        ...
        */
        ...
        find_head( 
            ...
            int N)
        {
            return ::hboost::algorithm::find(Input, ::hboost::algorithm::head_finder(N));
        }
...
//  find_tail ----------------------------------------------------------------------//
        ...
        */
        ...
        find_tail( 
            ...
            int N)
        {
            return ::hboost::algorithm::find(Input, ::hboost::algorithm::tail_finder(N));
        }
...
//  find_token --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::hboost::algorithm::find(Input, ::hboost::algorithm::token_finder(Pred, eCompress));
        }
