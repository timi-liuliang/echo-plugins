...
#ifndef HBOOST_STRING_REPLACE_HPP
#define HBOOST_STRING_REPLACE_HPP
        ...
        */
            ...
            const Range2T& Format)
        {
            return ::hboost::algorithm::find_format_copy(
                Output,
                Input,
                ::hboost::algorithm::range_finder(SearchRange),
                ::hboost::algorithm::const_formatter(Format));
        }
        ...
        */
            ...
            const Range3T& Format)
        {
            return ::hboost::algorithm::find_format_copy(
                Output,
                Input,
                ::hboost::algorithm::first_finder(Search),
                ::hboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::hboost::algorithm::find_format_copy(
                Output,
                Input,
                ::hboost::algorithm::first_finder(Search, is_iequal(Loc)),
                ::hboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::hboost::algorithm::find_format_copy(
                Output,
                Input,
                ::hboost::algorithm::last_finder(Search),
                ::hboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::hboost::algorithm::find_format_copy(
                Output,
                Input,
                ::hboost::algorithm::last_finder(Search, is_iequal(Loc)),
                ::hboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::hboost::algorithm::find_format_copy(
                Output,
                Input,
                ::hboost::algorithm::nth_finder(Search, Nth),
                ::hboost::algorithm::const_formatter(Format) );
        }
       ...
       */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::hboost::algorithm::find_format_copy(
                Output,
                Input,
                ::hboost::algorithm::nth_finder(Search, Nth, is_iequal(Loc) ),
                ::hboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::hboost::algorithm::find_format_copy(
                Output,
                Input,
                ::hboost::algorithm::head_finder(N),
                ::hboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::hboost::algorithm::find_format_copy(
                Output,
                Input,
                ::hboost::algorithm::tail_finder(N),
                ::hboost::algorithm::const_formatter(Format) );
        }
