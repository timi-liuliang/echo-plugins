...
#ifndef HBOOST_STRING_FORMATTER_HPP
#define HBOOST_STRING_FORMATTER_HPP
...
#include <hboost/algorithm/string/detail/formatter.hpp>
        ...
        */
        ...
        const_formatter(const RangeT& Format)
        {
            return detail::const_formatF<
                iterator_range<
                    HBOOST_STRING_TYPENAME range_const_iterator<RangeT>::type> >(::hboost::as_literal(Format));
        }
