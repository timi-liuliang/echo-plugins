...
#ifndef HBOOST_ALGORITHM_MINMAX_HPP
#define HBOOST_ALGORITHM_MINMAX_HPP
...
#include <hboost/tuple/tuple.hpp> // for using pairs with hboost::cref
...
#endif // HBOOST_ALGORITHM_MINMAX_HPP
