...
#ifndef HBOOST_ASSIGN_PTR_LIST_OF_HPP
#define HBOOST_ASSIGN_PTR_LIST_OF_HPP

#if defined(_MSC_VER)
# pragma once
#endif

#include <hboost/assign/list_of.hpp>
...
namespace assign_detail
{
    ...
    class generic_ptr_list : 
        public converter< generic_ptr_list<T>,
                          HBOOST_DEDUCED_TYPENAME hboost::ptr_vector<T>::iterator >      
    {
    protected:
        typedef hboost::ptr_vector<T>       impl_type;
...
#define HBOOST_PP_LOCAL_MACRO(n) \
    ...
    generic_ptr_list& operator()(U const& u, HBOOST_ASSIGN_PARAMS2(n) ) \
    { \
        this->push_back( new T(u, HBOOST_ASSIGN_PARAMS3(n))); \
        return *this; \
    } \
    /**/
...
#define HBOOST_PP_LOCAL_MACRO(n) \
    ...
    inline assign_detail::generic_ptr_list<T> \
    ptr_list_of(U const& u, HBOOST_ASSIGN_PARAMS2(n) ) \
    { \
        return assign_detail::generic_ptr_list<T>()(u, HBOOST_ASSIGN_PARAMS3(n)); \
    } \
    /**/
