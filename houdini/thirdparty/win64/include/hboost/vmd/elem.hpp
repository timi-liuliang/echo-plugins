...
#if !defined(HBOOST_VMD_ELEM_HPP)
#define HBOOST_VMD_ELEM_HPP
...
/** \def HBOOST_VMD_ELEM(elem,...)
    ...
    Matching Identifiers: If the filter is specified as the identifier type, HBOOST_VMD_TYPE_IDENTIFIER,
             ...
             they cannot be any of the specific HBOOST_VMD_ optional parameters in order to be
    ...
    Splitting: Splitting allows the macro to return the rest of the sequence
             ...
             If HBOOST_VMD_RETURN_AFTER is specified the return is a tuple
             ...
             If HBOOST_VMD_RETURN_ONLY_AFTER
             ...
             If HBOOST_VMD_RETURN_NO_AFTER, the default, is specified no splitting
             occurs. 
     ...
     Return Type: The element accessed can be changed to return both the type
             ...
             If HBOOST_VMD_RETURN_NO_TYPE, the default, is specified no type is returned 
             as part of the element accessed. 
             
             If HBOOST_VMD_RETURN_TYPE is specified the specific type of the element
             ...
             the default HBOOST_VMD_RETURN_NO_TYPE is in effect.
             
     Index:  If the filter is specified as the identifier type, HBOOST_VMD_TYPE_IDENTIFIER,
             ...
             If HBOOST_VMD_RETURN_INDEX is specified an index is returned
             as part of the result. 
             
             If HBOOST_VMD_RETURN_NO_INDEX, the default, is specified
             ...
             If element access fails the index is empty. If there is no HBOOST_VMD_TYPE_IDENTIFIER 
             filter or if there are no matching identifiers the HBOOST_VMD_RETURN_INDEX is ignored 
    ...
    returns   = With no optional parameters the element accessed is returned, or emptiness if
                ...
                and not a tuple. Splitting with HBOOST_VMD_RETURN_AFTER returns a tuple where the element accessed
                is the first tuple element and the rest of the sequence is the second tuple element.
                Splitting with HBOOST_VMD_RETURN_ONLY_AFTER returns the rest of the sequence after
                ...
                HBOOST_VMD_TYPE_IDENTIFIER is specified and matching identifiers are specified.
                When the index is returned with HBOOST_VMD_RETURN_AFTER it is the third element
...
#define HBOOST_VMD_ELEM(elem,...) \
    HBOOST_VMD_DETAIL_SEQUENCE_ELEM(HBOOST_VMD_ALLOW_ALL,elem,__VA_ARGS__) \
/**/

/** \def HBOOST_VMD_ELEM_D(d,elem,...)
...
#define HBOOST_VMD_ELEM_D(d,elem,...) \
    HBOOST_VMD_DETAIL_SEQUENCE_ELEM_D(d,HBOOST_VMD_ALLOW_ALL,elem,__VA_ARGS__) \
/**/

#endif /* HBOOST_PP_VARIADICS */
#endif /* HBOOST_VMD_ELEM_HPP */
