...
#if !defined(HBOOST_VMD_TO_LIST_HPP)
#define HBOOST_VMD_TO_LIST_HPP

#include <hboost/vmd/detail/setup.hpp>

#if HBOOST_PP_VARIADICS

#include <hboost/vmd/detail/sequence_to_list.hpp>
...
#define HBOOST_VMD_TO_LIST(...) \
    HBOOST_VMD_DETAIL_SEQUENCE_TO_LIST(__VA_ARGS__) \
/**/

/** \def HBOOST_VMD_TO_LIST_D(d,...)
...
#define HBOOST_VMD_TO_LIST_D(d,...) \
    HBOOST_VMD_DETAIL_SEQUENCE_TO_LIST_D(d,__VA_ARGS__) \
/**/

#endif /* HBOOST_PP_VARIADICS */
#endif /* HBOOST_VMD_TO_LIST_HPP */
