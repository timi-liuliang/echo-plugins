...
#if !defined(HBOOST_VMD_IS_IDENTIFIER_HPP)
#define HBOOST_VMD_IS_IDENTIFIER_HPP
...
#define HBOOST_VMD_IS_IDENTIFIER(...) \
    HBOOST_VMD_DETAIL_IS_IDENTIFIER(__VA_ARGS__) \
/**/

/** \def HBOOST_VMD_IS_IDENTIFIER_D(d,...)
...
#define HBOOST_VMD_IS_IDENTIFIER_D(d,...) \
    HBOOST_VMD_DETAIL_IS_IDENTIFIER_D(d,__VA_ARGS__) \
/**/

#endif /* HBOOST_PP_VARIADICS */
#endif /* HBOOST_VMD_IS_IDENTIFIER_HPP */
