...
#if !defined(HBOOST_VMD_TUPLE_POP_BACK_HPP)
#define HBOOST_VMD_TUPLE_POP_BACK_HPP
...
/** \def HBOOST_VMD_TUPLE_POP_BACK(tuple)
...
#define HBOOST_VMD_TUPLE_POP_BACK(tuple) \
    HBOOST_PP_IIF \
        ( \
...
/** \def HBOOST_VMD_TUPLE_POP_BACK_Z(z,tuple)

    \brief pops an element from the end of a tuple. It reenters HBOOST_PP_REPEAT with maximum efficiency.
...
#define HBOOST_VMD_TUPLE_POP_BACK_Z(z,tuple) \
    HBOOST_PP_IIF \
        ( \
        HBOOST_PP_EQUAL(HBOOST_PP_TUPLE_SIZE(tuple),1), \
        HBOOST_VMD_EMPTY, \
...
#endif /* HBOOST_VMD_TUPLE_POP_BACK_HPP */
