...
#if !defined(HBOOST_VMD_ASSERT_HPP)
#define HBOOST_VMD_ASSERT_HPP

#include <hboost/vmd/detail/setup.hpp>

#if HBOOST_PP_VARIADICS

#include <hboost/vmd/detail/assert.hpp>
...
/** \def HBOOST_VMD_ASSERT(...)
    ...
    cond = A condition that determines whether an assertion occurs.  Valid values range from 0 to HBOOST_PP_LIMIT_MAG.
       ...
       errstr = An error string for generating a compiler error when using the VC++ compiler.
                ...
                The errstr defaults to HBOOST_VMD_ASSERT_ERROR if not supplied.
...
*/
# define HBOOST_VMD_ASSERT(...) \
    HBOOST_VMD_DETAIL_ASSERT(__VA_ARGS__) \
/**/

#endif /* HBOOST_PP_VARIADICS */
#endif /* HBOOST_VMD_ASSERT_HPP */
