...
#if !defined(HBOOST_VMD_TO_SEQ_HPP)
#define HBOOST_VMD_TO_SEQ_HPP

#include <hboost/vmd/detail/setup.hpp>

#if HBOOST_PP_VARIADICS

#include <hboost/vmd/detail/sequence_to_seq.hpp>
...
#define HBOOST_VMD_TO_SEQ(...) \
    HBOOST_VMD_DETAIL_SEQUENCE_TO_SEQ(__VA_ARGS__) \
/**/

/** \def HBOOST_VMD_TO_SEQ_D(d,...)
...
#define HBOOST_VMD_TO_SEQ_D(d,...) \
    HBOOST_VMD_DETAIL_SEQUENCE_TO_SEQ_D(d,__VA_ARGS__) \
/**/

#endif /* HBOOST_PP_VARIADICS */
#endif /* HBOOST_VMD_TO_SEQ_HPP */
