...
#if !defined(HBOOST_VMD_EQUAL_HPP)
#define HBOOST_VMD_EQUAL_HPP

#include <hboost/vmd/detail/setup.hpp>

#if HBOOST_PP_VARIADICS

#include <hboost/vmd/detail/equal.hpp>
...
#define HBOOST_VMD_EQUAL(sequence,...) \
    HBOOST_VMD_DETAIL_EQUAL(sequence,__VA_ARGS__) \
/**/

/** \def HBOOST_VMD_EQUAL_D(d,sequence,...)
...
#define HBOOST_VMD_EQUAL_D(d,sequence,...) \
    HBOOST_VMD_DETAIL_EQUAL_D(d,sequence,__VA_ARGS__) \
/**/

#endif /* HBOOST_PP_VARIADICS */
#endif /* HBOOST_VMD_EQUAL_HPP */
