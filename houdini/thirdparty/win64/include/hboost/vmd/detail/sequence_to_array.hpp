...
#if !defined(HBOOST_VMD_DETAIL_SEQUENCE_TO_ARRAY_HPP)
#define HBOOST_VMD_DETAIL_SEQUENCE_TO_ARRAY_HPP
...
#define HBOOST_VMD_DETAIL_SEQUENCE_TO_ARRAY(...) \
    HBOOST_PP_IIF \
        ( \
...
#define HBOOST_VMD_DETAIL_SEQUENCE_TO_ARRAY_D(d,...) \
    HBOOST_PP_IIF \
        ( \
        HBOOST_VMD_DETAIL_NOT_EMPTY(HBOOST_VMD_DETAIL_SEQUENCE_ELEM_GET_VSEQ(__VA_ARGS__)), \
...
#endif /* HBOOST_VMD_DETAIL_SEQUENCE_TO_ARRAY_HPP */
