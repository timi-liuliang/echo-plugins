...
#if !defined(HBOOST_VMD_DETAIL_SEQUENCE_TO_SEQ_HPP)
#define HBOOST_VMD_DETAIL_SEQUENCE_TO_SEQ_HPP
...
#define HBOOST_VMD_DETAIL_SEQUENCE_TO_SEQ(...) \
    HBOOST_PP_EXPR_IIF \
        ( \
...
#define HBOOST_VMD_DETAIL_SEQUENCE_TO_SEQ_D(d,...) \
    HBOOST_PP_EXPR_IIF \
        ( \
        HBOOST_VMD_DETAIL_NOT_EMPTY(HBOOST_VMD_DETAIL_SEQUENCE_ELEM_GET_VSEQ(__VA_ARGS__)), \
...
#endif /* HBOOST_VMD_DETAIL_SEQUENCE_TO_SEQ_HPP */
