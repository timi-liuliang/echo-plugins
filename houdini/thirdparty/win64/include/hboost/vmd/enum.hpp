...
#if !defined(HBOOST_VMD_ENUM_HPP)
#define HBOOST_VMD_ENUM_HPP

#include <hboost/vmd/detail/setup.hpp>

#if HBOOST_PP_VARIADICS

#include <hboost/vmd/detail/sequence_enum.hpp>
...
/** \def HBOOST_VMD_ENUM(...)
    ...
    returns   = Comma-separated data, otherwise known as variadic data.
                ...
                optional return type other than HBOOST_VMD_RETURN_NO_TYPE
...
#define HBOOST_VMD_ENUM(...) \
    HBOOST_VMD_DETAIL_SEQUENCE_ENUM(__VA_ARGS__) \
/**/

/** \def HBOOST_VMD_ENUM_D(d,...)
...
#define HBOOST_VMD_ENUM_D(d,...) \
    HBOOST_VMD_DETAIL_SEQUENCE_ENUM_D(d,__VA_ARGS__) \
/**/

#endif /* HBOOST_PP_VARIADICS */
#endif /* HBOOST_VMD_ENUM_HPP */
