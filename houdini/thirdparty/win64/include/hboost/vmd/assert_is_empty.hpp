...
#if !defined(HBOOST_VMD_ASSERT_IS_EMPTY_HPP)
#define HBOOST_VMD_ASSERT_IS_EMPTY_HPP
...
/** \def HBOOST_VMD_ASSERT_IS_EMPTY(...)
...
#define HBOOST_VMD_ASSERT_IS_EMPTY(input)
...
#define HBOOST_VMD_ASSERT_IS_EMPTY(input) \
    HBOOST_VMD_ASSERT \
          ( \
          HBOOST_VMD_IS_EMPTY(input), \
          HBOOST_VMD_IS_EMPTY_ASSERT_ERROR \
          ) \
/**/
...
#define HBOOST_VMD_ASSERT_IS_EMPTY(...)
...
#define HBOOST_VMD_ASSERT_IS_EMPTY(...) \
    HBOOST_VMD_ASSERT \
          ( \
          HBOOST_VMD_IS_EMPTY(__VA_ARGS__), \
          HBOOST_VMD_IS_EMPTY_ASSERT_ERROR \
          ) \
/**/
...
#endif /* HBOOST_VMD_ASSERT_IS_EMPTY_HPP */
