...
#if !defined(HBOOST_VMD_SEQ_POP_FRONT_HPP)
#define HBOOST_VMD_SEQ_POP_FRONT_HPP
...
#include <hboost/preprocessor/seq/pop_front.hpp>
...
/** \def HBOOST_VMD_SEQ_POP_FRONT(seq)
...
#define HBOOST_VMD_SEQ_POP_FRONT(seq) \
    HBOOST_PP_IIF \
        ( \
...
#endif /* HBOOST_VMD_SEQ_POP_FRONT_HPP */
