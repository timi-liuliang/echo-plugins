...
#if !defined(HBOOST_VMD_IS_ARRAY_HPP)
#define HBOOST_VMD_IS_ARRAY_HPP

#include <hboost/vmd/detail/setup.hpp>

#if HBOOST_PP_VARIADICS

#include <hboost/vmd/detail/is_array.hpp>
...
/** \def HBOOST_VMD_IS_ARRAY(sequence)
...
#define HBOOST_VMD_IS_ARRAY(sequence) \
    HBOOST_VMD_DETAIL_IS_ARRAY(sequence) \
/**/

/** \def HBOOST_VMD_IS_ARRAY_D(d,sequence)
...
#define HBOOST_VMD_IS_ARRAY_D(d,sequence) \
    HBOOST_VMD_DETAIL_IS_ARRAY_D(d,sequence) \
/**/

#endif /* HBOOST_PP_VARIADICS */
#endif /* HBOOST_VMD_IS_ARRAY_HPP */
