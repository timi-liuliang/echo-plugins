 ...
 *  process topology.
 */
#ifndef HBOOST_MPI_GRAPH_COMMUNICATOR_HPP
#define HBOOST_MPI_GRAPH_COMMUNICATOR_HPP
 ...
 */
class HBOOST_MPI_DECL graph_communicator : public communicator
{
  ...
  {
#ifndef HBOOST_DISABLE_ASSERTS
    int status;
    HBOOST_MPI_CHECK_RESULT(MPI_Topo_test, ((MPI_Comm)*this, &status));
    HBOOST_ASSERT(status == MPI_GRAPH);
#endif
                                ...
                                RankMap rank, bool reorder)
{
  ...
  MPI_Comm newcomm;
  HBOOST_MPI_CHECK_RESULT(MPI_Graph_create,
                         ((MPI_Comm)comm, 
                          nvertices,
                          &indices[0],
...
#endif // HBOOST_MPI_GRAPH_COMMUNICATOR_HPP
