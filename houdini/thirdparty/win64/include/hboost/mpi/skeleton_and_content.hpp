 ...
 *  the content).
 */
#ifndef HBOOST_MPI_SKELETON_AND_CONTENT_HPP
#define HBOOST_MPI_SKELETON_AND_CONTENT_HPP
...
#include <hboost/mpi/detail/forward_skeleton_iarchive.hpp>
#include <hboost/mpi/detail/forward_skeleton_oarchive.hpp>
#include <hboost/mpi/detail/ignore_iprimitive.hpp>
 ...
 */
template <class T>
struct HBOOST_MPI_DECL skeleton_proxy
{
  /**
...
namespace detail {
  ...
  class HBOOST_MPI_DECL mpi_datatype_holder : public hboost::noncopyable
  {
  public:
    mpi_datatype_holder()
     : is_committed(false)
    ...
    void commit()
    {
      HBOOST_MPI_CHECK_RESULT(MPI_Type_commit,(&d));
      is_committed=true;
    }
    ...
    {
      int finalized=0;
      HBOOST_MPI_CHECK_RESULT(MPI_Finalized,(&finalized));
      if (!finalized && is_committed)
        HBOOST_MPI_CHECK_RESULT(MPI_Type_free,(&d));
    }
...
private:
  hboost::shared_ptr<detail::mpi_datatype_holder> holder;
};
 ...
 */
class HBOOST_MPI_DECL packed_skeleton_iarchive
...
public:
  ...
  packed_skeleton_iarchive(MPI_Comm const & comm,
                           unsigned int flags =  hboost::archive::no_header)
  ...
  explicit packed_skeleton_iarchive(packed_iarchive & archive)
         ...
         , skeleton_archive_(MPI_COMM_WORLD, hboost::archive::no_header)
        {}
 ...
 *  directly. Instead, use @c skeleton or @c get_skeleton.
 */
class HBOOST_MPI_DECL packed_skeleton_oarchive
...
namespace detail {
  typedef hboost::mpi::detail::forward_skeleton_oarchive<hboost::mpi::packed_skeleton_oarchive,hboost::mpi::packed_oarchive> type1;
  typedef hboost::mpi::detail::forward_skeleton_iarchive<hboost::mpi::packed_skeleton_iarchive,hboost::mpi::packed_iarchive> type2;
}


} } // end namespace hboost::mpi

#include <hboost/mpi/detail/content_oarchive.hpp>
...
#ifdef HBOOST_MPI_BROADCAST_HPP
#  include <hboost/mpi/detail/broadcast_sc.hpp>
#endif

#ifdef HBOOST_MPI_COMMUNICATOR_HPP
#  include <hboost/mpi/detail/communicator_sc.hpp>
#endif

// required by export
HBOOST_SERIALIZATION_REGISTER_ARCHIVE(hboost::mpi::packed_skeleton_oarchive)
HBOOST_SERIALIZATION_REGISTER_ARCHIVE(hboost::mpi::packed_skeleton_iarchive)
HBOOST_SERIALIZATION_REGISTER_ARCHIVE(hboost::mpi::detail::type1)
HBOOST_SERIALIZATION_REGISTER_ARCHIVE(hboost::mpi::detail::type2)

HBOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(hboost::mpi::packed_skeleton_oarchive)
HBOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(hboost::mpi::packed_skeleton_iarchive)

#endif // HBOOST_MPI_SKELETON_AND_CONTENT_HPP
