 ...
 *  hboost/mpi/collectives/algorithm_name.hpp.
 */
#ifndef HBOOST_MPI_COLLECTIVES_HPP
#define HBOOST_MPI_COLLECTIVES_HPP

#include <hboost/mpi/communicator.hpp>
#include <hboost/mpi/inplace.hpp>
#include <vector>
...
/**
 *  @brief Similar to hboost::mpi::gather with the difference that the number
...
/**
 *  @brief Similar to hboost::mpi::scatter with the difference that the number
...
#endif // HBOOST_MPI_COLLECTIVES_HPP

#ifndef HBOOST_MPI_COLLECTIVES_FORWARD_ONLY
// Include implementations of each of the collectives
#  include <hboost/mpi/collectives/all_gather.hpp>
#  include <hboost/mpi/collectives/all_reduce.hpp>
#  include <hboost/mpi/collectives/all_to_all.hpp>
#  include <hboost/mpi/collectives/broadcast.hpp>
#  include <hboost/mpi/collectives/gather.hpp>
#  include <hboost/mpi/collectives/gatherv.hpp>
#  include <hboost/mpi/collectives/scatter.hpp>
#  include <hboost/mpi/collectives/scatterv.hpp>
#  include <hboost/mpi/collectives/reduce.hpp>
#  include <hboost/mpi/collectives/scan.hpp>
#endif
