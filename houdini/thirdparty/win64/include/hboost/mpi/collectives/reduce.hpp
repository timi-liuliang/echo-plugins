...
#ifndef HBOOST_MPI_REDUCE_HPP
#define HBOOST_MPI_REDUCE_HPP
...
#include <hboost/mpi/detail/computation_tree.hpp>
...
namespace detail {
  ...
  {
    HBOOST_MPI_CHECK_RESULT(MPI_Reduce,
