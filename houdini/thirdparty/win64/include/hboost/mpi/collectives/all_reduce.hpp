...
#ifndef HBOOST_MPI_ALL_REDUCE_HPP
#define HBOOST_MPI_ALL_REDUCE_HPP
...
namespace detail {
  ...
  {
    HBOOST_MPI_CHECK_RESULT(MPI_Allreduce,
                           (const_cast<T*>(in_values), out_values, n,
                            hboost::mpi::get_mpi_datatype<T>(*in_values),
...
{
  T result;
  ::hboost::mpi::all_reduce(comm, in_value, result, op);
  return result;
}

} } // end namespace hboost::mpi

#endif // HBOOST_MPI_ALL_REDUCE_HPP
