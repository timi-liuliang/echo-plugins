 ...
 */
#ifndef HBOOST_MPI_DATATYPE_HPP
#define HBOOST_MPI_DATATYPE_HPP
...
#include <hboost/mpi/detail/mpi_datatype_cache.hpp>
...
struct is_mpi_builtin_datatype
  : hboost::mpl::or_<is_mpi_integer_datatype<T>,
...
#ifndef HBOOST_MPI_DOXYGEN

/// INTERNAL ONLY
#define HBOOST_MPI_DATATYPE(CppType, MPIType, Kind)                      \
template<>                                                              \
inline MPI_Datatype                                                     \
get_mpi_datatype< CppType >(const CppType&) { return MPIType; }         \
                                                                        \
template<>                                                              \
 struct HBOOST_JOIN(is_mpi_,HBOOST_JOIN(Kind,_datatype))< CppType >       \
: hboost::mpl::true_                                                     \
{}

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(packed, MPI_PACKED, builtin);

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(char, MPI_CHAR, builtin);

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(short, MPI_SHORT, integer);

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(int, MPI_INT, integer);

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(long, MPI_LONG, integer);

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(float, MPI_FLOAT, floating_point);

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(double, MPI_DOUBLE, floating_point);

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(long double, MPI_LONG_DOUBLE, floating_point);

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(unsigned char, MPI_UNSIGNED_CHAR, builtin);

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(unsigned short, MPI_UNSIGNED_SHORT, integer);

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(unsigned, MPI_UNSIGNED, integer);

/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(unsigned long, MPI_UNSIGNED_LONG, integer);

/// INTERNAL ONLY
#define HBOOST_MPI_LIST2(A, B) A, B
/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(std::pair<HBOOST_MPI_LIST2(float, int)>, MPI_FLOAT_INT, 
                   builtin);
/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(std::pair<HBOOST_MPI_LIST2(double, int)>, MPI_DOUBLE_INT, 
                   builtin);
/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(std::pair<HBOOST_MPI_LIST2(long double, int)>,
                   MPI_LONG_DOUBLE_INT, builtin);
/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(std::pair<HBOOST_MPI_LIST2(long, int>), MPI_LONG_INT, 
                   builtin);
/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(std::pair<HBOOST_MPI_LIST2(short, int>), MPI_SHORT_INT, 
                   builtin);
/// INTERNAL ONLY
HBOOST_MPI_DATATYPE(std::pair<HBOOST_MPI_LIST2(int, int>), MPI_2INT, builtin);
#undef HBOOST_MPI_LIST2
...
HBOOST_MPI_DATATYPE(wchar_t, MPI_WCHAR, builtin);
#endif
...
HBOOST_MPI_DATATYPE(long long, MPI_LONG_LONG_INT, builtin);
#elif defined(HBOOST_HAS_MS_INT64) && \
  (defined(MPI_LONG_LONG_INT) || (defined(MPI_VERSION) && MPI_VERSION >= 2))
HBOOST_MPI_DATATYPE(__int64, MPI_LONG_LONG_INT, builtin); 
#endif
...
HBOOST_MPI_DATATYPE(unsigned long long, MPI_UNSIGNED_LONG_LONG, builtin);
#elif defined(HBOOST_HAS_MS_INT64) && \
  (defined(MPI_UNSIGNED_LONG_LONG) \
   || (defined(MPI_VERSION) && MPI_VERSION >= 2))
HBOOST_MPI_DATATYPE(unsigned __int64, MPI_UNSIGNED_LONG_LONG, builtin); 
#endif
...
HBOOST_MPI_DATATYPE(signed char, MPI_SIGNED_CHAR, builtin);
#endif
...
struct is_mpi_datatype<bool>
  : hboost::mpl::bool_<true>
{};


#ifndef HBOOST_MPI_DOXYGEN
// direct support for special primitive data types of the serialization library
HBOOST_MPI_DATATYPE(hboost::archive::library_version_type, get_mpi_datatype(uint_least16_t()), integer);
HBOOST_MPI_DATATYPE(hboost::archive::version_type, get_mpi_datatype(uint_least8_t()), integer);
HBOOST_MPI_DATATYPE(hboost::archive::class_id_type, get_mpi_datatype(int_least16_t()), integer);
HBOOST_MPI_DATATYPE(hboost::archive::class_id_reference_type, get_mpi_datatype(int_least16_t()), integer);
HBOOST_MPI_DATATYPE(hboost::archive::class_id_optional_type, get_mpi_datatype(int_least16_t()), integer);
HBOOST_MPI_DATATYPE(hboost::archive::object_id_type, get_mpi_datatype(uint_least32_t()), integer);
HBOOST_MPI_DATATYPE(hboost::archive::object_reference_type, get_mpi_datatype(uint_least32_t()), integer);
HBOOST_MPI_DATATYPE(hboost::archive::tracking_type, get_mpi_datatype(bool()), builtin);
HBOOST_MPI_DATATYPE(hboost::serialization::collection_size_type, get_mpi_datatype(std::size_t()), integer);
HBOOST_MPI_DATATYPE(hboost::serialization::item_version_type, get_mpi_datatype(uint_least8_t()), integer);
#endif // Doxygen
...
#define HBOOST_IS_MPI_DATATYPE(T)              \
namespace hboost {                             \
namespace mpi {                               \
template<>                                    \
...
#endif // HBOOST_MPI_MPI_DATATYPE_HPP
