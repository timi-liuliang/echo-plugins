 ...
 */
#ifndef HBOOST_MPI_IS_MPI_OP_HPP
#define HBOOST_MPI_IS_MPI_OP_HPP
 ...
 *  hboost/mpi/operations.hpp headers whenever possible. For
...
struct is_mpi_op<maximum<T>, T>
  : public hboost::mpl::or_<is_mpi_integer_datatype<T>,
...
namespace detail {
  ...
  public:
    ...
    {
      HBOOST_MPI_CHECK_RESULT(MPI_Op_create,
    ...
    ~user_op()
    {
      if (std::uncaught_exception()) {
        ...
        HBOOST_MPI_CHECK_RESULT(MPI_Op_free, (&mpi_op));
      }
    }
  ...
  private:
    ...
    static void HBOOST_MPI_CALLING_CONVENTION perform(void* vinvec, void* voutvec, int* plen, MPI_Datatype*)
    {
...
#endif // HBOOST_MPI_GET_MPI_OP_HPP
