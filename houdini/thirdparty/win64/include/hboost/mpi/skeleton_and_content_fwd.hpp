 ...
 *  include the header @c hboost/mpi/skeleton_and_content.hpp.
 */

#ifndef HBOOST_MPI_SKELETON_AND_CONTENT_FWD_HPP
#define HBOOST_MPI_SKELETON_AND_CONTENT_FWD_HPP
...
#endif // HBOOST_MPI_SKELETON_AND_CONTENT_FWD_HPP
