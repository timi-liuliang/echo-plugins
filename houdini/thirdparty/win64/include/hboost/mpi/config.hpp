 ...
 */
#ifndef HBOOST_MPI_CONFIG_HPP
#define HBOOST_MPI_CONFIG_HPP
 ...
 */
#  define HBOOST_MPI_HAS_MEMORY_ALLOCATION
...
#  define HBOOST_MPI_HAS_NOARG_INITIALIZATION
#else
...
#if defined(MPIAPI)
#  define HBOOST_MPI_CALLING_CONVENTION MPIAPI
#else
 ...
 */
#  define HBOOST_MPI_CALLING_CONVENTION
#endif
 ...
 * detect that.
 */
#define HBOOST_MPI_BCAST_BOTTOM_WORKS_FINE

#if defined(LAM_MPI)
// Configuration for LAM/MPI
#  define HBOOST_MPI_HAS_MEMORY_ALLOCATION
#  define HBOOST_MPI_HAS_NOARG_INITIALIZATION
#  undef  HBOOST_MPI_BCAST_BOTTOM_WORKS_FINE
...
#if (defined(HBOOST_MPI_DYN_LINK) || defined(HBOOST_ALL_DYN_LINK)) && !defined(HBOOST_MPI_STATIC_LINK)
#  if defined(HBOOST_MPI_SOURCE)
#     define HBOOST_MPI_DECL HBOOST_SYMBOL_EXPORT
#     define HBOOST_MPI_BUILD_DLL
#  else
#     define HBOOST_MPI_DECL HBOOST_SYMBOL_IMPORT
#  endif
#endif

#ifndef HBOOST_MPI_DECL
#  define HBOOST_MPI_DECL
#endif

#if !defined(HBOOST_MPI_NO_LIB) && !defined(HBOOST_MPI_SOURCE) && !defined(HBOOST_ALL_NO_LIB) && defined(__cplusplus)
#  define HBOOST_LIB_NAME hboost_mpi
#  if defined(HBOOST_MPI_DYN_LINK) || defined(HBOOST_ALL_DYN_LINK)
#     define HBOOST_DYN_LINK
#  endif
#  ifdef HBOOST_MPI_DIAG
#     define HBOOST_LIB_DIAGNOSTIC
#  endif
#  include <hboost/config/auto_link.hpp>
#endif

#endif // HBOOST_MPI_CONFIG_HPP
