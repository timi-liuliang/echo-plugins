...
#ifndef HBOOST_MPI_PYTHON_SKELETON_AND_CONTENT_HPP
#define HBOOST_MPI_PYTHON_SKELETON_AND_CONTENT_HPP
...
#include <hboost/mpi/python/serialize.hpp>
 ...
 */
class content : public hboost::mpi::content
{
  typedef hboost::mpi::content inherited;

 public:
  content(const inherited& base, hboost::python::object object) 
    : inherited(base), object(object) { }

  inherited&       base()       { return *this; }
  const inherited& base() const { return *this; }

  hboost::python::object object;
};
...
{
public:
  skeleton_proxy_base(const hboost::python::object& object) : object(object) { }
...
{
 public:
  skeleton_proxy(const hboost::python::object& object) 
    : skeleton_proxy_base(object) { }
};

namespace detail {
  using hboost::python::object;
  using hboost::python::extract;
   
  extern HBOOST_MPI_DECL hboost::python::object skeleton_proxy_base_type;
  ...
  struct do_get_content
  {
    content operator()(object value_obj) {
      ...
      return content(hboost::mpi::get_content(value), value_obj);
    }
  };
...
{
  using hboost::python::detail::direct_serialization_table;
  using hboost::python::detail::get_direct_serialization_table;
  ...
  {
    hboost::python::scope proxy_scope(detail::skeleton_proxy_base_type);
...
#endif // HBOOST_MPI_PYTHON_SKELETON_AND_CONTENT_HPP
