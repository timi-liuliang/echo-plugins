 ...
 */
#ifndef HBOOST_MPI_ALLOCATOR_HPP
#define HBOOST_MPI_ALLOCATOR_HPP
...
#if defined(HBOOST_MPI_HAS_MEMORY_ALLOCATION)
 ...
 */
template<> 
class HBOOST_MPI_DECL allocator<void> 
{ 
public: 
 ...
 *  throughout. The macro @c HBOOST_MPI_HAS_MEMORY_ALLOCATION will be
 *  defined when the MPI-2 memory allocation facilities are available.
 */
template<typename T> 
class HBOOST_MPI_DECL allocator 
{
public:
  ...
  {
    pointer result;
    HBOOST_MPI_CHECK_RESULT(MPI_Alloc_mem,
  ...
  {
    HBOOST_MPI_CHECK_RESULT(MPI_Free_mem, (p));
  }
...
#endif // HBOOST_MPI_ALLOCATOR_HPP
