 ...
 */
#ifndef HBOOST_MPI_ENVIRONMENT_HPP
#define HBOOST_MPI_ENVIRONMENT_HPP
 ...
 */
class HBOOST_MPI_DECL environment : noncopyable {
public:
#ifdef HBOOST_MPI_HAS_NOARG_INITIALIZATION
   ...
   *  HBOOST_MPI_HAS_NOARG_INITIALIZATION.
   *
...
#endif // HBOOST_MPI_ENVIRONMENT_HPP
