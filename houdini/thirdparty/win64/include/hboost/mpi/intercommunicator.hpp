 ...
 */
#ifndef HBOOST_MPI_INTERCOMMUNICATOR_HPP
#define HBOOST_MPI_INTERCOMMUNICATOR_HPP
 ...
 * 
 */   
class HBOOST_MPI_DECL intercommunicator : public communicator
{
private:
...
public:
   ...
   */
  hboost::mpi::group local_group() const;
   ...
   */
  hboost::mpi::group remote_group() const;
...
#endif // HBOOST_MPI_INTERCOMMUNICATOR_HPP
