 ...
 *  exceptions.
 */
#ifndef HBOOST_MPI_EXCEPTION_HPP
#define HBOOST_MPI_EXCEPTION_HPP
 ...
 */
class HBOOST_MPI_DECL exception : public std::exception
{
 public:
  /**
 ...
 * hboost::throw_exception to throw an exception or abort, depending on
 * HBOOST_NO_EXCEPTIONS.
 */
#define HBOOST_MPI_CHECK_RESULT( MPIFunc, Args )                         \
 {                                                                      \
   int _check_result = MPIFunc Args;                                    \
   if (_check_result != MPI_SUCCESS)                                    \
     hboost::throw_exception(hboost::mpi::exception(#MPIFunc,   \
                                                             _check_result)); \
 }

} } // end namespace hboost::mpi

#endif // HBOOST_MPI_EXCEPTION_HPP
