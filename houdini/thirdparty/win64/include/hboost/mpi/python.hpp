...
#ifndef HBOOST_MPI_PYTHON_HPP
#define HBOOST_MPI_PYTHON_HPP
...
#ifndef HBOOST_MPI_PYTHON_FORWARD_ONLY
#  include <hboost/mpi/python/serialize.hpp>
#  include <hboost/mpi/python/skeleton_and_content.hpp>
#else
#  undef HBOOST_MPI_PYTHON_FORWARD_ONLY
#endif

#endif // HBOOST_MPI_PYTHON_HPP
