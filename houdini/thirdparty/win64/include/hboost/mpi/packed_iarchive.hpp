 ...
 */
#ifndef HBOOST_MPI_PACKED_IARCHIVE_HPP
#define HBOOST_MPI_PACKED_IARCHIVE_HPP
...
#include <hboost/mpi/detail/packed_iprimitive.hpp>
#include <hboost/mpi/detail/binary_buffer_iprimitive.hpp>
...
class HBOOST_MPI_DECL packed_iarchive
  : public iprimitive
...
public:
  ...
  packed_iarchive(MPI_Comm const & comm, buffer_type & b, unsigned int flags = hboost::archive::no_header, int position = 0)
...
HBOOST_SERIALIZATION_REGISTER_ARCHIVE(hboost::mpi::packed_iarchive)
HBOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(hboost::mpi::packed_iarchive)

#endif // HBOOST_MPI_PACKED_IARCHIVE_HPP
