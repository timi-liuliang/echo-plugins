...
#ifndef HBOOST_CHRONO_IO_V1_CHRONO_IO_HPP
#define HBOOST_CHRONO_IO_V1_CHRONO_IO_HPP
...
#include <hboost/integer/common_factor_rt.hpp>
#include <hboost/chrono/detail/scan_keyword.hpp>
#include <hboost/utility/enable_if.hpp>
#include <hboost/chrono/detail/no_warning/signed_unsigned_cmp.hpp>
...
private:
    ...
    template <class Period>
        string_type short_name(Period) const
            {return ::hboost::ratio_string<Period, CharT>::short_name() + short_seconds_;}
    ...
    template <class Period>
        string_type long_name(Period) const
            {return ::hboost::ratio_string<Period, CharT>::long_name() + long_seconds_;}
