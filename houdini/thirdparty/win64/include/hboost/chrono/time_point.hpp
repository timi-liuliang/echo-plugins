...
#ifndef HBOOST_CHRONO_TIME_POINT_HPP
#define HBOOST_CHRONO_TIME_POINT_HPP
...
//----------------------------------------------------------------------------//
    ...
    class time_point
    {
        HBOOST_CHRONO_STATIC_ASSERT(hboost::chrono::detail::is_duration<Duration>::value,
                HBOOST_CHRONO_SECOND_TEMPLATE_PARAMETER_OF_TIME_POINT_MUST_BE_A_HBOOST_CHRONO_DURATION, (Duration));
    public:
        typedef Clock                     clock;
    ...
    public:
        ...
        time_point(const time_point<clock, Duration2>& t
                ...
                <
                    hboost::is_convertible<Duration2, duration>
                >::type* = 0
        )
        ...
        static HBOOST_CHRONO_LIB_CONSTEXPR time_point
        min HBOOST_PREVENT_MACRO_SUBSTITUTION ()
        {
            return time_point((duration::min)());
        }
        static HBOOST_CHRONO_LIB_CONSTEXPR time_point
        max HBOOST_PREVENT_MACRO_SUBSTITUTION ()
        {
...
#endif // HBOOST_CHRONO_TIME_POINT_HPP
