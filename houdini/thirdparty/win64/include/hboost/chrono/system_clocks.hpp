//  hboost/chrono/system_clocks.hpp  --------------------------------------------------------------//
...
#ifndef HBOOST_CHRONO_SYSTEM_CLOCKS_HPP
#define HBOOST_CHRONO_SYSTEM_CLOCKS_HPP
...
#ifdef HBOOST_CHRONO_WINDOWS_API
// The system_clock tick is 100 nanoseconds
# define HBOOST_SYSTEM_CLOCK_DURATION hboost::chrono::duration<hboost::int_least64_t, ratio<HBOOST_RATIO_INTMAX_C(1), HBOOST_RATIO_INTMAX_C(10000000)> >
#else
# define HBOOST_SYSTEM_CLOCK_DURATION hboost::chrono::nanoseconds
#endif
...
namespace chrono {
  ...
  // Clocks
  class HBOOST_CHRONO_DECL system_clock;
#ifdef HBOOST_CHRONO_HAS_CLOCK_STEADY
  class HBOOST_CHRONO_DECL steady_clock;
#endif
...
//----------------------------------------------------------------------------//
  ...
  {
  public:
      typedef HBOOST_SYSTEM_CLOCK_DURATION          duration;
      typedef duration::rep                        rep;
      typedef duration::period                     period;
      typedef chrono::time_point<system_clock>     time_point;
      HBOOST_STATIC_CONSTEXPR bool is_steady =             false;
      ...
      static HBOOST_CHRONO_INLINE std::time_t to_time_t(const time_point& t) HBOOST_NOEXCEPT;
      static HBOOST_CHRONO_INLINE time_point  from_time_t(std::time_t t) HBOOST_NOEXCEPT;
  };
...
// The class steady_clock is conditionally supported.
  ...
  public:
      ...
      HBOOST_STATIC_CONSTEXPR bool is_steady =             true;
...
#else
#include <hboost/chrono/detail/inlined/chrono.hpp>
#endif

#endif // HBOOST_CHRONO_SYSTEM_CLOCKS_HPP
