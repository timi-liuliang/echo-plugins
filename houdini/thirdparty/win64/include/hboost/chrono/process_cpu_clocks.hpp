//  hboost/chrono/process_cpu_clocks.hpp  -----------------------------------------------------------//
...
#ifndef HBOOST_CHRONO_PROCESS_CPU_CLOCKS_HPP
#define HBOOST_CHRONO_PROCESS_CPU_CLOCKS_HPP
...
namespace hboost { namespace chrono {
    ...
    class HBOOST_CHRONO_DECL process_real_cpu_clock {
    public:
...
#if ! HBOOST_OS_WINDOWS || HBOOST_PLAT_WINDOWS_DESKTOP
    class HBOOST_CHRONO_DECL process_user_cpu_clock {
    public:
        typedef nanoseconds                          duration;
        typedef duration::rep                        rep;
        typedef duration::period                     period;
    ...
    class HBOOST_CHRONO_DECL process_system_cpu_clock {
    public:
        typedef nanoseconds                          duration;
        typedef duration::rep                        rep;
        typedef duration::period                     period;
...
namespace chrono
{
  ...
  typedef process_times<nanoseconds::rep> process_cpu_clock_times;
#if ! HBOOST_OS_WINDOWS || HBOOST_PLAT_WINDOWS_DESKTOP
    class HBOOST_CHRONO_DECL process_cpu_clock
    {
    public:

        typedef process_cpu_clock_times times;
        typedef hboost::chrono::duration<times,  nano>                duration;
        typedef duration::rep                       rep;
        typedef duration::period                    period;
    ...
    public:
        ...
        static Res max HBOOST_PREVENT_MACRO_SUBSTITUTION ()
        {
          return Res((std::numeric_limits<Rep>::max)(),
                      (std::numeric_limits<Rep>::max)(),
                      (std::numeric_limits<Rep>::max)());
        }
        static Res min HBOOST_PREVENT_MACRO_SUBSTITUTION ()
        {
...
namespace std {
    ...
    template <typename Rep>
    struct numeric_limits<hboost::chrono::process_times<Rep> >
    {
        typedef hboost::chrono::process_times<Rep> Res;
...
#else
#include <hboost/chrono/detail/inlined/process_cpu_clocks.hpp>
#endif
#endif

#endif  // HBOOST_CHRONO_PROCESS_CPU_CLOCKS_HPP
