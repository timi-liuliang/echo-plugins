...
#ifndef HBOOST_CHRONO_DETAIL_SCAN_KEYWORD_HPP
#define HBOOST_CHRONO_DETAIL_SCAN_KEYWORD_HPP
               ...
               )
{
    ...
    // Error: Could not find a match for hboost::interprocess::unique_ptr<unsigned char, void(*)(void*)>::unique_ptr(int, extern "C" void(void*))
...
#endif // HBOOST_CHRONO_DETAIL_SCAN_KEYWORD_HPP
