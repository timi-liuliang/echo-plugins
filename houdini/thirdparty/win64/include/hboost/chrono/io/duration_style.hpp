...
#ifndef HBOOST_CHRONO_IO_DURATION_STYLE_HPP
#define HBOOST_CHRONO_IO_DURATION_STYLE_HPP
...
namespace hboost
{
  namespace chrono
  {
     ...
     */
    HBOOST_SCOPED_ENUM_DECLARE_BEGIN(duration_style)
          {
            prefix, symbol
          }
    HBOOST_SCOPED_ENUM_DECLARE_END(duration_style)
