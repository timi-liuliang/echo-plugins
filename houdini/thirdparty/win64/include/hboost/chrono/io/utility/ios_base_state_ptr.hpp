//  hboost/chrono/utility/ios_base_pword_ptr.hpp  ------------------------------------------------------------//
...
#ifndef HBOOST_CHRONO_UTILITY_IOS_BASE_STATE_PTR_HPP
#define HBOOST_CHRONO_UTILITY_IOS_BASE_STATE_PTR_HPP
...
namespace hboost
{
  namespace chrono
  {
    ...
    public:
       ...
       */
      T const* get() const HBOOST_NOEXCEPT
      {
       ...
       * @return the retrieved pointer.
       */
      T const * operator->() const HBOOST_NOEXCEPT
      {
        return get();
      }
       ...
       */
      void reset(T* new_ptr = 0)HBOOST_NOEXCEPT
      {
        register_once(index(), ios_);
        void*& pw = ios_.pword(index());
      ...
      std::ios_base& getios()HBOOST_NOEXCEPT
      {
        return ios_;
      }
      std::ios_base& getios() const HBOOST_NOEXCEPT
      {
        return ios_;
      }
      /**
       ...
       */
      operator std::ios_base&() HBOOST_NOEXCEPT
      {
        return ios_;
      }
      /**
       ...
       */
      operator std::ios_base&() const HBOOST_NOEXCEPT
      {
        return ios_;
      }
    private:
    ...
    public:
      ...
      void reset(T* new_value) HBOOST_NOEXCEPT
      {
        HBOOST_ASSERT(new_value!=0);
    ...
    public:
       ...
       */
      long flags() const HBOOST_NOEXCEPT
      {
        return value();
      }
       ...
       */
      long flags(long v)HBOOST_NOEXCEPT
      {
        long tmp = flags();
        ref() = v;
        return tmp;
       ...
       */
      operator std::ios_base const&() const HBOOST_NOEXCEPT
      {
        return ios_;
      }
    private:
      long value() const HBOOST_NOEXCEPT
      {
        return ios_.iword(index());
      }
      long& ref()HBOOST_NOEXCEPT
      {
        return ios_.iword(index());
      }
      static inline int index()
