...
#ifndef HBOOST_CHRONO_IO_DURATION_UNITS_HPP
#define HBOOST_CHRONO_IO_DURATION_UNITS_HPP
  ...
  namespace chrono
  {
    ...
    protected:
      ...
      bool do_is_named_unit(rt_ratio rt) const
      {
        if (rt.num==1) {
          switch (rt.den)
          {
          case HBOOST_RATIO_INTMAX_C(1):
          case HBOOST_RATIO_INTMAX_C(10):
          case HBOOST_RATIO_INTMAX_C(100):
          case HBOOST_RATIO_INTMAX_C(1000):
          case HBOOST_RATIO_INTMAX_C(1000000):
          case HBOOST_RATIO_INTMAX_C(1000000000):
          case HBOOST_RATIO_INTMAX_C(1000000000000):
          case HBOOST_RATIO_INTMAX_C(1000000000000000):
          case HBOOST_RATIO_INTMAX_C(1000000000000000000):
            return true;
          default:
            return false;
          }
          ...
          {
          case HBOOST_RATIO_INTMAX_C(10):
          case HBOOST_RATIO_INTMAX_C(60):
          case HBOOST_RATIO_INTMAX_C(100):
          case HBOOST_RATIO_INTMAX_C(1000):
          case HBOOST_RATIO_INTMAX_C(3600):
          case HBOOST_RATIO_INTMAX_C(1000000):
          case HBOOST_RATIO_INTMAX_C(1000000000):
          case HBOOST_RATIO_INTMAX_C(1000000000000):
          case HBOOST_RATIO_INTMAX_C(1000000000000000):
      ...
      string_type do_get_unit(duration_style style, rt_ratio rt, intmax_t v) const
      {
        ...
        HBOOST_ASSERT(false&&"ratio parameter can not be translated");
        //throw "exception";
        return string_type();
      }
    ...
    protected:
      ...
      static string_type static_get_unit(duration_style style, ratio<1> , std::size_t pf)
      {
        ...
        HBOOST_ASSERT(false&&"style/pf parameters not valid");
        //throw "exception";
        return string_type();
      }
