 ...
 */
#ifndef HBOOST_CHRONO_IO_DURATION_PUT_HPP
#define HBOOST_CHRONO_IO_DURATION_PUT_HPP

#include <hboost/chrono/config.hpp>
#include <hboost/chrono/io/duration_units.hpp>
...
namespace hboost
{
  namespace chrono
  {
    ...
    namespace detail
    {
      ...
      template <>
      struct propagate<hboost::int_least32_t> {
        typedef hboost::int_least64_t type;
      };
    }
    /**
