#ifndef HBOOST_ARCHIVE_BASIC_XML_GRAMMAR_HPP
#define HBOOST_ARCHIVE_BASIC_XML_GRAMMAR_HPP
...
#include <hboost/spirit/include/classic_rule.hpp>
#include <hboost/spirit/include/classic_chset.hpp>
...
private:
    ...
    typedef typename hboost::spirit::classic::chset<CharType> chset_t;
    typedef typename hboost::spirit::classic::chlit<CharType> chlit_t;
    typedef typename hboost::spirit::classic::scanner<
        typename  std::basic_string<CharType>::iterator
    > scanner_t;
    typedef typename hboost::spirit::classic::rule<scanner_t> rule_t;
...
#endif // HBOOST_ARCHIVE_BASIC_XML_GRAMMAR_HPP
