...
#include <hboost/archive/xml_woarchive.hpp>
#include <hboost/archive/detail/utf8_codecvt_facet.hpp>

#include <hboost/serialization/throw_exception.hpp>

#include <hboost/archive/iterators/xml_escape.hpp>
#include <hboost/archive/iterators/wchar_from_mb.hpp>
...
void save_iterator(std::wostream &os, InputIterator begin, InputIterator end){
    ...
    std::copy(
        xmbtows(begin),
        xmbtows(end),
        hboost::archive::iterators::ostream_iterator<wchar_t>(os)
    );
}
