...
#include <hboost/archive/iterators/base64_from_binary.hpp>
#include <hboost/archive/iterators/insert_linebreaks.hpp>
#include <hboost/archive/iterators/transform_width.hpp>
#include <hboost/archive/iterators/ostream_iterator.hpp>
...
basic_text_oprimitive<OStream>::save_binary(
    ...
    typedef 
        hboost::archive::iterators::insert_linebreaks<
            hboost::archive::iterators::base64_from_binary<
                hboost::archive::iterators::transform_width<
                    const char *,
                    6,
                    8
                >
    ...
    hboost::archive::iterators::ostream_iterator<CharType> oi(os);
    std::copy(
