#ifndef HBOOST_ARCHIVE_WCSLEN_HPP
#define HBOOST_ARCHIVE_WCSLEN_HPP
...
#if defined(HBOOST_DINKUMWARE_STDLIB) && HBOOST_DINKUMWARE_STDLIB < 306 \
|| defined(__LIBCOMO__) 
...
#endif //HBOOST_ARCHIVE_WCSLEN_HPP
