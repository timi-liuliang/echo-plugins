#ifndef HBOOST_ARCHIVE_BASIC_TEXT_OARCHIVE_HPP
#define HBOOST_ARCHIVE_BASIC_TEXT_OARCHIVE_HPP
...
class HBOOST_SYMBOL_VISIBLE basic_text_oarchive : 
...
#endif // HBOOST_ARCHIVE_BASIC_TEXT_OARCHIVE_HPP
