#ifndef HBOOST_ARCHIVE_CODECVT_NULL_HPP
#define HBOOST_ARCHIVE_CODECVT_NULL_HPP
...
namespace std {
// For STLport on WinCE, HBOOST_NO_STDC_NAMESPACE can get defined if STLport is putting symbols in its own namespace.
...
template<>
class HBOOST_SYMBOL_VISIBLE codecvt_null<wchar_t> : public std::codecvt<wchar_t, char, std::mbstate_t>
{
    virtual HBOOST_WARCHIVE_DECL std::codecvt_base::result
    do_out(
        std::mbstate_t & state,
...
#endif //HBOOST_ARCHIVE_CODECVT_NULL_HPP
