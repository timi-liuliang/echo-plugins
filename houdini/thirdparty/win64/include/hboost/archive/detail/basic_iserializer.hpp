#ifndef HBOOST_ARCHIVE_DETAIL_BASIC_ISERIALIZER_HPP
#define HBOOST_ARCHIVE_DETAIL_BASIC_ISERIALIZER_HPP
...
class HBOOST_SYMBOL_VISIBLE basic_iserializer : 
    public basic_serializer
{
private:
    basic_pointer_iserializer *m_bpis;
protected:
    explicit HBOOST_ARCHIVE_DECL basic_iserializer(
        const hboost::serialization::extended_type_info & type
    );
    virtual HBOOST_ARCHIVE_DECL ~basic_iserializer();
public:
...
#endif // HBOOST_ARCHIVE_DETAIL_BASIC_ISERIALIZER_HPP
