#ifndef HBOOST_ARCHIVE_DETAIL_COMMON_OARCHIVE_HPP
#define HBOOST_ARCHIVE_DETAIL_COMMON_OARCHIVE_HPP
...
class HBOOST_SYMBOL_VISIBLE common_oarchive :
...
#endif // HBOOST_ARCHIVE_DETAIL_COMMON_OARCHIVE_HPP
