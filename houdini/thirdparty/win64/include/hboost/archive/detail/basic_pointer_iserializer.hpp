#ifndef HBOOST_ARCHIVE_BASIC_POINTER_ISERIALIZER_HPP
#define HBOOST_ARCHIVE_BASIC_POINTER_ISERIALIZER_HPP
...
class HBOOST_SYMBOL_VISIBLE basic_pointer_iserializer
    : public basic_serializer {
protected:
    explicit HBOOST_ARCHIVE_DECL basic_pointer_iserializer(
        const hboost::serialization::extended_type_info & type_
    );
    virtual HBOOST_ARCHIVE_DECL ~basic_pointer_iserializer();
public:
...
#endif // HBOOST_ARCHIVE_BASIC_POINTER_ISERIALIZER_HPP
