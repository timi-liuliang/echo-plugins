#ifndef HBOOST_ARCHIVE_BASIC_POINTER_OSERIALIZER_HPP
#define HBOOST_ARCHIVE_BASIC_POINTER_OSERIALIZER_HPP
...
class HBOOST_SYMBOL_VISIBLE basic_pointer_oserializer : 
    public basic_serializer
{
protected:
    explicit HBOOST_ARCHIVE_DECL basic_pointer_oserializer(
        const hboost::serialization::extended_type_info & type_
    );
public:
    virtual HBOOST_ARCHIVE_DECL ~basic_pointer_oserializer();
...
#endif // HBOOST_ARCHIVE_BASIC_POINTER_OSERIALIZER_HPP
