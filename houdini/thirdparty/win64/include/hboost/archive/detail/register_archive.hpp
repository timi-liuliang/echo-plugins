...
#ifndef HBOOST_ARCHIVE_DETAIL_REGISTER_ARCHIVE_DWA2006521_HPP
# define HBOOST_ARCHIVE_DETAIL_REGISTER_ARCHIVE_DWA2006521_HPP

namespace hboost { namespace archive { namespace detail { 

// No instantiate_ptr_serialization overloads generated by
// HBOOST_SERIALIZATION_REGISTER_ARCHIVE that lexically follow the call
...
#define HBOOST_SERIALIZATION_REGISTER_ARCHIVE(Archive)                     \
namespace hboost { namespace archive { namespace detail {                  \
...
// HBOOST_SERIALIZATION_REGISTER_ARCHIVE, below.
template <class Serializable>
...
// hboost/serialization/export.hpp
# define HBOOST_SERIALIZATION_REGISTER_ARCHIVE(Archive)                  \
namespace hboost { namespace archive { namespace detail {                \
                                                                        \
template <class Serializable>                                           \
...
#endif
}}} // namespace hboost::archive::detail

#endif // HBOOST_ARCHIVE_DETAIL_INSTANTIATE_SERIALIZE_DWA2006521_HPP
