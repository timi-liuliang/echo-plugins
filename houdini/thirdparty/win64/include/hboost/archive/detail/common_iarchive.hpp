#ifndef HBOOST_ARCHIVE_DETAIL_COMMON_IARCHIVE_HPP
#define HBOOST_ARCHIVE_DETAIL_COMMON_IARCHIVE_HPP
...
class HBOOST_SYMBOL_VISIBLE common_iarchive : 
...
#endif // HBOOST_ARCHIVE_DETAIL_COMMON_IARCHIVE_HPP
