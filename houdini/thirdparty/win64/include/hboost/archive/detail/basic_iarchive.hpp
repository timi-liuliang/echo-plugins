#ifndef HBOOST_ARCHIVE_DETAIL_BASIC_IARCHIVE_HPP
#define HBOOST_ARCHIVE_DETAIL_BASIC_IARCHIVE_HPP
...
protected:
    HBOOST_ARCHIVE_DECL basic_iarchive(unsigned int flags);
    hboost::archive::detail::helper_collection &
...
public:
    ...
    virtual HBOOST_ARCHIVE_DECL ~basic_iarchive();
    // note: NOT part of the public API.
    HBOOST_ARCHIVE_DECL void next_object_pointer(void *t);
    HBOOST_ARCHIVE_DECL void register_basic_serializer(
        const basic_iserializer & bis
    );
    HBOOST_ARCHIVE_DECL void load_object(
        void *t, 
        const basic_iserializer & bis
    );
    HBOOST_ARCHIVE_DECL const basic_pointer_iserializer * 
    load_pointer(
        void * & t, 
    ...
    HBOOST_ARCHIVE_DECL unsigned int
    get_flags() const;
    HBOOST_ARCHIVE_DECL void 
...
#endif //HBOOST_ARCHIVE_DETAIL_BASIC_IARCHIVE_HPP
