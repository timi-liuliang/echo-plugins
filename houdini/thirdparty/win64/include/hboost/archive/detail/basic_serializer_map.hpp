#ifndef  HBOOST_SERIALIZER_MAP_HPP
#define HBOOST_SERIALIZER_MAP_HPP
    ...
    hboost::noncopyable
{
    ...
    map_type m_map;
public:
    HBOOST_ARCHIVE_DECL bool insert(const basic_serializer * bs);
    HBOOST_ARCHIVE_DECL void erase(const basic_serializer * bs);
    HBOOST_ARCHIVE_DECL const basic_serializer * find(
...
#endif // HBOOST_SERIALIZER_MAP_HPP
