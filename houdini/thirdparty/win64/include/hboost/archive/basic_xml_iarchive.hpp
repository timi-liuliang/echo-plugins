#ifndef HBOOST_ARCHIVE_BASIC_XML_IARCHIVE_HPP
#define HBOOST_ARCHIVE_BASIC_XML_IARCHIVE_HPP
...
class HBOOST_SYMBOL_VISIBLE basic_xml_iarchive :
...
#endif // HBOOST_ARCHIVE_BASIC_XML_IARCHIVE_HPP
