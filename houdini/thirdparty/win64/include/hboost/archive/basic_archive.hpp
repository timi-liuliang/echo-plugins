#ifndef HBOOST_ARCHIVE_BASIC_ARCHIVE_HPP
#define HBOOST_ARCHIVE_BASIC_ARCHIVE_HPP
...
#include <hboost/cstdint.hpp> // size_t
...
HBOOST_ARCHIVE_DECL library_version_type
HBOOST_ARCHIVE_VERSION();
...
private:
    ...
    base_type t;
public:
    // should be private - but then can't use HBOOST_STRONG_TYPE below
    class_id_type() : t(0) {};
...
#define NULL_POINTER_TAG hboost::archive::class_id_type(-1)
...
#define HBOOST_ARCHIVE_STRONG_TYPEDEF(T, D)         \
    class D : public T {                           \
    public:                                        \
...
HBOOST_ARCHIVE_STRONG_TYPEDEF(class_id_type, class_id_reference_type)
HBOOST_ARCHIVE_STRONG_TYPEDEF(class_id_type, class_id_optional_type)
HBOOST_ARCHIVE_STRONG_TYPEDEF(object_id_type, object_reference_type)
...
HBOOST_CLASS_IMPLEMENTATION(hboost::archive::library_version_type, primitive_type)
HBOOST_CLASS_IMPLEMENTATION(hboost::archive::version_type, primitive_type)
HBOOST_CLASS_IMPLEMENTATION(hboost::archive::class_id_type, primitive_type)
HBOOST_CLASS_IMPLEMENTATION(hboost::archive::class_id_reference_type, primitive_type)
HBOOST_CLASS_IMPLEMENTATION(hboost::archive::class_id_optional_type, primitive_type)
HBOOST_CLASS_IMPLEMENTATION(hboost::archive::class_name_type, primitive_type)
HBOOST_CLASS_IMPLEMENTATION(hboost::archive::object_id_type, primitive_type)
HBOOST_CLASS_IMPLEMENTATION(hboost::archive::object_reference_type, primitive_type)
HBOOST_CLASS_IMPLEMENTATION(hboost::archive::tracking_type, primitive_type)
...
HBOOST_IS_BITWISE_SERIALIZABLE(hboost::archive::library_version_type)
HBOOST_IS_BITWISE_SERIALIZABLE(hboost::archive::version_type)
HBOOST_IS_BITWISE_SERIALIZABLE(hboost::archive::class_id_type)
HBOOST_IS_BITWISE_SERIALIZABLE(hboost::archive::class_id_reference_type)
HBOOST_IS_BITWISE_SERIALIZABLE(hboost::archive::class_id_optional_type)
HBOOST_IS_BITWISE_SERIALIZABLE(hboost::archive::class_name_type)
HBOOST_IS_BITWISE_SERIALIZABLE(hboost::archive::object_id_type)
HBOOST_IS_BITWISE_SERIALIZABLE(hboost::archive::object_reference_type)
HBOOST_IS_BITWISE_SERIALIZABLE(hboost::archive::tracking_type)

#endif //HBOOST_ARCHIVE_BASIC_ARCHIVE_HPP
