#ifndef HBOOST_ARCHIVE_ITERATORS_XML_UNESCAPE_HPP
#define HBOOST_ARCHIVE_ITERATORS_XML_UNESCAPE_HPP
...
#include <hboost/archive/iterators/unescape.hpp>
    ...
    : public unescape<xml_unescape<Base>, Base>
{
    ...
    typedef typename hboost::iterator_reference<this_t> reference_type;
...
#endif // HBOOST_ARCHIVE_ITERATORS_XML_UNESCAPE_HPP
