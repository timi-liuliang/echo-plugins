#ifndef HBOOST_ARCHIVE_ITERATORS_ISTREAM_ITERATOR_HPP
#define HBOOST_ARCHIVE_ITERATORS_ISTREAM_ITERATOR_HPP
    ...
    >
{
    ...
    typedef typename hboost::iterator_facade<
        istream_iterator<Elem>,
        Elem,
        std::input_iterator_tag,
        Elem
...
#endif // HBOOST_ARCHIVE_ITERATORS_ISTREAM_ITERATOR_HPP
