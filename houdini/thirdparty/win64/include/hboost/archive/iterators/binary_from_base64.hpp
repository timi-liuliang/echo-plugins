#ifndef HBOOST_ARCHIVE_ITERATORS_BINARY_FROM_BASE64_HPP
#define HBOOST_ARCHIVE_ITERATORS_BINARY_FROM_BASE64_HPP
...
struct to_6_bit {
    ...
    CharType operator()(CharType t) const{
        ...
        HBOOST_STATIC_ASSERT(128 == sizeof(lookup_table));
        #endif
        signed char value = -1;
        if((unsigned)t <= 127)
...
template<
    class Base, 
    class CharType = typename hboost::iterator_value<Base>::type
>
...
#endif // HBOOST_ARCHIVE_ITERATORS_BINARY_FROM_BASE64_HPP
