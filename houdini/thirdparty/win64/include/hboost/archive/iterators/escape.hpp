#ifndef HBOOST_ARCHIVE_ITERATORS_ESCAPE_HPP
#define HBOOST_ARCHIVE_ITERATORS_ESCAPE_HPP
...
class escape : 
    public hboost::iterator_adaptor<
        Derived, 
        Base, 
        typename hboost::iterator_value<Base>::type,
        single_pass_traversal_tag,
        typename hboost::iterator_value<Base>::type
    >
{
    typedef typename hboost::iterator_value<Base>::type base_value_type;
    typedef typename hboost::iterator_reference<Base>::type reference_type;
...
#endif // HBOOST_ARCHIVE_ITERATORS_ESCAPE_HPP
