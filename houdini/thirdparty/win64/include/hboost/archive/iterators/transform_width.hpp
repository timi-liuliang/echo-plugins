#ifndef HBOOST_ARCHIVE_ITERATORS_TRANSFORM_WIDTH_HPP
#define HBOOST_ARCHIVE_ITERATORS_TRANSFORM_WIDTH_HPP
...
template<
    ...
    int BitsOut, 
    int BitsIn, 
    class CharType = typename hboost::iterator_value<Base>::type // output character
>
...
#endif // HBOOST_ARCHIVE_ITERATORS_TRANSFORM_WIDTH_HPP
