#ifndef HBOOST_ARCHIVE_ARCHIVE_EXCEPTION_HPP
#define HBOOST_ARCHIVE_ARCHIVE_EXCEPTION_HPP
...
//
class HBOOST_SYMBOL_VISIBLE archive_exception : 
...
protected:
    ...
    HBOOST_ARCHIVE_DECL
    archive_exception() HBOOST_NOEXCEPT;
public:
    typedef enum {
    ...
    HBOOST_ARCHIVE_DECL archive_exception(
        exception_code c, 
        const char * e1 = NULL,
        const char * e2 = NULL
    ) HBOOST_NOEXCEPT;
    HBOOST_ARCHIVE_DECL archive_exception(archive_exception const &) HBOOST_NOEXCEPT ;
    virtual HBOOST_ARCHIVE_DECL ~archive_exception() HBOOST_NOEXCEPT_OR_NOTHROW ;
    virtual HBOOST_ARCHIVE_DECL const char * what() const HBOOST_NOEXCEPT_OR_NOTHROW ;
};
...
#endif //HBOOST_ARCHIVE_ARCHIVE_EXCEPTION_HPP
