#ifndef HBOOST_ARCHIVE_BASIC_TEXT_IARCHIVE_HPP
#define HBOOST_ARCHIVE_BASIC_TEXT_IARCHIVE_HPP
...
class HBOOST_SYMBOL_VISIBLE basic_text_iarchive : 
...
#endif // HBOOST_ARCHIVE_BASIC_TEXT_IARCHIVE_HPP
