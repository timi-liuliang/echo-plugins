...
==============================================================================*/
#ifndef HBOOST_PHOENIX_SCOPE_SCOPED_ENVIRONMENT_HPP
#define HBOOST_PHOENIX_SCOPE_SCOPED_ENVIRONMENT_HPP

#include <hboost/phoenix/core/limits.hpp>
#include <hboost/mpl/int.hpp>
#include <hboost/fusion/sequence/sequence_facade.hpp>
...
#include <hboost/fusion/include/pop_front.hpp>
...
namespace hboost { namespace hboostphoenix
{
        ...
        >
    {
        ...
        #define HBOOST_PHOENIX_ADAPT_SCOPED_ENVIRONMENT(INTRINSIC)               \
        ...
        /**/
        HBOOST_PHOENIX_ADAPT_SCOPED_ENVIRONMENT(begin);
        HBOOST_PHOENIX_ADAPT_SCOPED_ENVIRONMENT(end);
        HBOOST_PHOENIX_ADAPT_SCOPED_ENVIRONMENT(size);
        #undef HBOOST_PHOENIX_ADAPT_SCOPED_ENVIRONMENT
