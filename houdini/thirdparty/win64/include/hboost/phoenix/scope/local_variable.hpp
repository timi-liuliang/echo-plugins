...
==============================================================================*/
#ifndef HBOOST_PHOENIX_SCOPE_LOCAL_VARIABLE_HPP
#define HBOOST_PHOENIX_SCOPE_LOCAL_VARIABLE_HPP

#include <hboost/phoenix/core/limits.hpp>
#include <hboost/phoenix/core/call.hpp>
#include <hboost/phoenix/core/expression.hpp>
#include <hboost/phoenix/core/reference.hpp>
#include <hboost/phoenix/core/value.hpp>
#include <hboost/phoenix/scope/scoped_environment.hpp>
#include <hboost/phoenix/scope/detail/local_variable.hpp>
#include <hboost/phoenix/statement/sequence.hpp>
...
namespace hboost { namespace hboostphoenix
{
    ...
    namespace detail
    {
        struct scope_is_nullary_actions
        {
            ...
            struct when
                : hboost::hboostphoenix::is_nullary::when<Rule, Dummy>
            {};
        };

        template <typename Dummy>
        struct scope_is_nullary_actions::when<hboost::hboostphoenix::rule::custom_terminal, Dummy>
            : proto::or_<
                proto::when<hboost::hboostphoenix::rule::local_variable, mpl::true_()>
              , proto::otherwise<
                    is_nullary::when<hboost::hboostphoenix::rule::custom_terminal, Dummy>
                >
            >
        {};
