...
==============================================================================*/
#ifndef HBOOST_PHOENIX_CORE_TERMINAL_HPP
#define HBOOST_PHOENIX_CORE_TERMINAL_HPP
...
#include <hboost/proto/functional/fusion/at.hpp>
#include <hboost/type_traits/remove_pointer.hpp>

#define HBOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(Template, Terminal, IsNullary, EvalFun)\
...
namespace hboost { namespace hboostphoenix
{
    ...
    {
        struct argument
            : proto::if_<hboost::is_placeholder<proto::_value>()>
        {};

        struct custom_terminal
            : proto::if_<hboost::hboostphoenix::is_custom_terminal<proto::_value>()>
        {};
            ...
            proto::functional::at(
              ...
              , proto::make<
                    detail::placeholder_idx<
                        proto::make<
                            hboost::is_placeholder<proto::_value>()
                        >
                    >()
                >
            )
