...
==============================================================================*/
#ifndef HBOOST_PHOENIX_CORE_VALUE_HPP
#define HBOOST_PHOENIX_CORE_VALUE_HPP
...
#include <hboost/phoenix/core/is_value.hpp>
  ...
  // In which case why is it here?
    ...
    struct custom_terminal<actor<Expr> >
    {
        ...
        operator()(actor<Expr> const & expr, Context & ctx) const
        {
          ...
          result_type r = hboost::hboostphoenix::eval(expr, ctx);
