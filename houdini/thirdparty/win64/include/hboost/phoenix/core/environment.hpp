...
==============================================================================*/
#ifndef HBOOST_PHOENIX_CORE_ENVIRONMENT_HPP
#define HBOOST_PHOENIX_CORE_ENVIRONMENT_HPP
...
namespace hboost { namespace hboostphoenix 
{
        ...
        struct env
        {
            typedef
                typename fusion::result_of::at_c<
                    typename hboost::remove_reference<Context>::type
                  , 0
                >::type
                type;
        };
        ...
        : proto::transform_impl<Expr, State, proto::empty_env>
    {
            typedef
                typename fusion::result_of::at_c<
                    typename hboost::remove_reference<State>::type
                  , 0
                >::type
                result_type;
    ...
    #define M0(Z, N, D)                                                         \
        ...
        struct make_env<HBOOST_PHOENIX_A(N)>                                     \
        {                                                                       \
            typedef HBOOST_PP_CAT(vector, N)<HBOOST_PHOENIX_A(N)> type;           \
        };                                                                      \
    /**/
...
#define M0(Z, N, D)                                                             \
    template <HBOOST_PHOENIX_typename_A(N)>                                      \
    inline                                                                      \
    typename result_of::make_env<HBOOST_PHOENIX_A_ref(N)>::type                  \
    make_env(HBOOST_PHOENIX_A_ref_a(N))                                          \
    {                                                                           \
        typename result_of::make_env<HBOOST_PHOENIX_A_ref(N)>::type              \
            env =                                                               \
            {                                                                   \
    ...
    template <HBOOST_PHOENIX_typename_A(N)>                                      \
    inline                                                                      \
    typename result_of::make_env<HBOOST_PHOENIX_A_const_ref(N)>::type            \
    make_env(HBOOST_PHOENIX_A_const_ref_a(N))                                    \
    {                                                                           \
        typename result_of::make_env<HBOOST_PHOENIX_A_const_ref(N)>::type        \
            env =                                                               \
            {                                                                   \
