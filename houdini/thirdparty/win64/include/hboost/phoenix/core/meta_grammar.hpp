...
==============================================================================*/
#ifndef HBOOST_PHOENIX_CORE_META_GRAMMAR_HPP
#define HBOOST_PHOENIX_CORE_META_GRAMMAR_HPP
...
#include <hboost/proto/transform/default.hpp>
...
namespace hboost { namespace hboostphoenix
{
    ...
    struct evaluator
    {
        HBOOST_PROTO_TRANSFORM(evaluator)
            ...
            : proto::transform_impl<Expr, State, proto::empty_env>
        {
            ...
            {
                return what()(e, hboostphoenix::env(s), actions(s));
            }
        };
    ...
    namespace result_of
    {
        ...
        struct eval
            : hboost::result_of< ::hboost::hboostphoenix::evaluator(Expr, Context)>
        {};
    }
