...
#ifndef HBOOST_CONFIG_FILE_VP_2003_01_02
#define HBOOST_CONFIG_FILE_VP_2003_01_02
...
#include <hboost/program_options/eof_iterator.hpp>

#include <hboost/detail/workaround.hpp>
#include <hboost/program_options/detail/convert.hpp>
...
namespace hboost { namespace program_options { namespace detail {
    ...
    /** Standalone parser for config files in ini-line format.
        ...
        - Section names are given in brackets. 
         ...
         class.
     */    
    class HBOOST_PROGRAM_OPTIONS_DECL common_config_file_iterator
...
#if HBOOST_WORKAROUND(_MSC_VER, <= 1900)
        void decrement() {}
...
#if HBOOST_WORKAROUND(__COMO_VERSION__, HBOOST_TESTED_AT(4303)) || \
        (defined(__sgi) && HBOOST_WORKAROUND(_COMPILER_VERSION, HBOOST_TESTED_AT(741)))
    template<>
    bool
