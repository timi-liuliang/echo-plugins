...
#ifndef HBOOST_CMDLINE_VP_2003_05_19
#define HBOOST_CMDLINE_VP_2003_05_19

#include <hboost/program_options/config.hpp>
#include <hboost/program_options/errors.hpp>
#include <hboost/program_options/cmdline.hpp>
#include <hboost/program_options/option.hpp>
#include <hboost/program_options/options_description.hpp>
#include <hboost/program_options/positional_options.hpp>
...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class 'hboost::program_options::positional_options_description'
#endif
...
namespace hboost { namespace program_options { namespace detail {
    ...
    */
    class HBOOST_PROGRAM_OPTIONS_DECL cmdline {
    public:

        typedef ::hboost::program_options::command_line_style::style_t style_t;
