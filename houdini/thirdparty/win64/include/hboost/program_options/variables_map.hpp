...
#ifndef HBOOST_VARIABLES_MAP_VP_2003_05_19
#define HBOOST_VARIABLES_MAP_VP_2003_05_19
...
#   pragma warning (push)
#   pragma warning (disable:4251) // 'hboost::program_options::variable_value::v' : class 'hboost::any' needs to have dll-interface to be used by clients of class 'hboost::program_options::variable_value
#endif
...
namespace hboost { namespace program_options {
    ...
    */
    ...
    HBOOST_PROGRAM_OPTIONS_DECL void notify(variables_map& m);

    /** Class holding value of option. Contains details about how the
        value is set and allows to conveniently obtain the value.
    */
    class HBOOST_PROGRAM_OPTIONS_DECL variable_value {
    public:
        variable_value() : m_defaulted(false) {}
        variable_value(const hboost::any& xv, bool xdefaulted)
        : v(xv), m_defaulted(xdefaulted)
        {}

        /** If stored value if of type T, returns that value. Otherwise,
            throws hboost::bad_any_cast exception. */
       template<class T>
       const T& as() const {
           return hboost::any_cast<const T&>(v);
       }
       /** @overload */
       template<class T>
       T& as() {
           return hboost::any_cast<T&>(v);
       }
    ...
    private:
        ...
        friend HBOOST_PROGRAM_OPTIONS_DECL
        void store(const basic_parsed_options<char>& options,
              variables_map& m, bool);

        friend class HBOOST_PROGRAM_OPTIONS_DECL variables_map;
    };

    /** Implements string->string mapping with convenient value casting
        facilities. */
    class HBOOST_PROGRAM_OPTIONS_DECL abstract_variables_map {
    public:
    ...
    */
    class HBOOST_PROGRAM_OPTIONS_DECL variables_map : public abstract_variables_map,
