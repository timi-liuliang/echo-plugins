...
#ifndef HBOOST_VALUE_SEMANTIC_HPP_VP_2004_02_24
#define HBOOST_VALUE_SEMANTIC_HPP_VP_2004_02_24

#include <hboost/program_options/config.hpp>
#include <hboost/program_options/errors.hpp>
...
namespace hboost { namespace program_options {
    ...
    */
    class HBOOST_PROGRAM_OPTIONS_DECL value_semantic {
    public:
        ...
        */
        virtual void parse(hboost::any& value_store, 
        ...
        /** Called to assign default value to 'value_store'. Returns
            ...
            value exists. */
        virtual bool apply_default(hboost::any& value_store) const = 0;
                                   
        /** Called when final value of an option is determined. 
        */
        virtual void notify(const hboost::any& value_store) const = 0;
    ...
    */
    template<>
    class HBOOST_PROGRAM_OPTIONS_DECL 
    value_semantic_codecvt_helper<char> : public value_semantic {
    private: // base overrides
        void parse(hboost::any& value_store, 
                   const std::vector<std::string>& new_tokens,
                   bool utf8) const;
    protected: // interface for derived classes.
        virtual void xparse(hboost::any& value_store, 
                            const std::vector<std::string>& new_tokens) 
            const = 0;
    };
    ...
    */
    ...
    public:
        ...
        /** If 'value_store' is already initialized, or new_tokens
            ...
            any modifications.
         */
        void xparse(hboost::any& value_store,
                    const std::vector<std::string>& new_tokens) const;

        /** Does nothing. */
        bool apply_default(hboost::any&) const { return false; }

        /** Does nothing. */
        void notify(const hboost::any&) const {}        
    private:
        bool m_zero_tokens;
    };
    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            m_default_value = hboost::any(v);
            m_default_value_as_text = hboost::lexical_cast<std::string>(v);
            return this;
        }
        ...
        */
        ...
        {
            m_implicit_value = hboost::any(v);
            m_implicit_value_as_text =
                hboost::lexical_cast<std::string>(v);
            return this;
        }
    ...
    public: // value semantic overrides
        ...
        unsigned max_tokens() const {
            if (m_multitoken) {
                return std::numeric_limits<unsigned>::max HBOOST_PREVENT_MACRO_SUBSTITUTION();
        ...
        */
        virtual bool apply_default(hboost::any& value_store) const
        {
        ...
        /** If an address of variable to store value was specified
            ...
            does nothing. */
        void notify(const hboost::any& value_store) const;
    ...
    private:
        ...
        // Default value is stored as hboost::any and not
        // as hboost::optional to avoid unnecessary instantiations.
        std::string m_value_name;
        hboost::any m_default_value;
        std::string m_default_value_as_text;
        hboost::any m_implicit_value;
        std::string m_implicit_value_as_text;
        bool m_composing, m_implicit, m_multitoken, m_zero_tokens, m_required;
        hboost::function1<void, const T&> m_notifier;
    };
    ...
    */
    HBOOST_PROGRAM_OPTIONS_DECL typed_value<bool>*
    bool_switch();
...
#include "hboost/program_options/detail/value_semantic.hpp"
