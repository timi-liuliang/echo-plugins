...
#ifndef HBOOST_PARSERS_VP_2003_05_19
#define HBOOST_PARSERS_VP_2003_05_19

#include <hboost/program_options/config.hpp>
#include <hboost/program_options/option.hpp>
#include <hboost/program_options/detail/cmdline.hpp>
...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class 'hboost::program_options::basic_parsed_options<wchar_t>'
#endif
...
namespace hboost { namespace program_options {
    ...
    */
    template<>
    class HBOOST_PROGRAM_OPTIONS_DECL basic_parsed_options<wchar_t> {
    public:
    ...
    */
    template<class charT>
#if ! HBOOST_WORKAROUND(__ICL, HBOOST_TESTED_AT(700))
    ...
    */
    HBOOST_PROGRAM_OPTIONS_DECL parsed_options
    ...
    */
    HBOOST_PROGRAM_OPTIONS_DECL std::vector<std::string>
    split_unix(const std::string& cmdline, const std::string& seperator = " \t",
         const std::string& quote = "'\"", const std::string& escape = "\\");

#ifndef HBOOST_NO_STD_WSTRING
    /** @overload */
    HBOOST_PROGRAM_OPTIONS_DECL std::vector<std::wstring>
...
#include "hboost/program_options/detail/parsers.hpp"
