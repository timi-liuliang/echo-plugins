...
#ifndef HBOOST_OPTION_DESCRIPTION_VP_2003_05_19
#define HBOOST_OPTION_DESCRIPTION_VP_2003_05_19

#include <hboost/program_options/config.hpp>
#include <hboost/program_options/errors.hpp>
#include <hboost/program_options/value_semantic.hpp>
...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'hboost::shared_ptr<T>' needs to have dll-interface to be used by clients of class 'hboost::program_options::option_description'
#endif
...
namespace program_options {
    ...
    */
    class HBOOST_PROGRAM_OPTIONS_DECL option_description {
    public:
     ...
     */        
    class HBOOST_PROGRAM_OPTIONS_DECL options_description_easy_init {
    public:
    ...
    */
    class HBOOST_PROGRAM_OPTIONS_DECL options_description {
    public:
    ...
    public:
        ...
        */
        ...
        friend HBOOST_PROGRAM_OPTIONS_DECL std::ostream& operator<<(std::ostream& os, 
...
#if HBOOST_WORKAROUND(HBOOST_DINKUMWARE_STDLIB, HBOOST_TESTED_AT(313))
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL duplicate_option_error : public error {
    public:
