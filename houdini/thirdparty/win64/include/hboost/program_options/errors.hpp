...
#ifndef HBOOST_ERRORS_VP_2003_01_02
#define HBOOST_ERRORS_VP_2003_01_02
...
#   pragma warning (push)
#   pragma warning (disable:4275) // non dll-interface class 'std::logic_error' used as base for dll-interface class 'hboost::program_options::error'
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class 'hboost::program_options::ambiguous_option'
#endif

namespace hboost { namespace program_options {
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL error : public std::logic_error {
    public:
    ...
    */
    class HBOOST_PROGRAM_OPTIONS_DECL too_many_positional_options_error : public error {
    public:
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL invalid_command_line_style : public error {
    public:
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL reading_file : public error {
    public:
     ...
     *      Poor man's version of hboost::format
     *  
     ...
     *  
     *   */
    class HBOOST_PROGRAM_OPTIONS_DECL error_with_option_name : public error {
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL multiple_values : public error_with_option_name {
    public:
        multiple_values() 
    ...
    /** Class thrown when there are several occurrences of an
        ...
        them all. */
    class HBOOST_PROGRAM_OPTIONS_DECL multiple_occurrences : public error_with_option_name {
    public:
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL required_option : public error_with_option_name {
    public:
     ...
     *  
     *   */
    class HBOOST_PROGRAM_OPTIONS_DECL error_with_no_option_name : public error_with_option_name {
    public:
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL unknown_option : public error_with_no_option_name {
    public:
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL ambiguous_option : public error_with_no_option_name {
    public:
     ...
     *  concrete classes. */
    class HBOOST_PROGRAM_OPTIONS_DECL invalid_syntax : public error_with_option_name {
    public:
        enum kind_t {
            long_not_allowed = 30,
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL invalid_config_file_syntax : public invalid_syntax {
    public:
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL invalid_command_line_syntax : public invalid_syntax {
    public:
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL validation_error : public error_with_option_name {
    public:
        enum kind_t {
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL invalid_option_value 
    ...
    class HBOOST_PROGRAM_OPTIONS_DECL invalid_bool_value 
        : public validation_error
    {
    public:
