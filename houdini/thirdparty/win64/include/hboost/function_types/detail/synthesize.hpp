...
#ifndef HBOOST_FT_DETAIL_SYNTHESIZE_HPP_INCLUDED
#define HBOOST_FT_DETAIL_SYNTHESIZE_HPP_INCLUDED
...
#include <hboost/function_types/detail/cv_traits.hpp>
...
struct synthesize_impl
  : detail::synthesize_impl_o
    < ::hboost::function_types::detail::decode_bits<Bits>::flags
    , ::hboost::function_types::detail::decode_bits<Bits>::cc_id
    , ::hboost::mpl::size<Seq>::value
    >
...
struct synthesize_func
  : detail::synthesize_impl
    < Seq
    , ::hboost::function_types::detail::bits
...
#define HBOOST_FT_variations HBOOST_FT_function|HBOOST_FT_member_pointer
#define HBOOST_FT_al_path hboost/function_types/detail/synthesize_impl
