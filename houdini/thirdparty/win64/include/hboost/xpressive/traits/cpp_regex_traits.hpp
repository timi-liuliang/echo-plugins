...
#ifndef HBOOST_XPRESSIVE_TRAITS_CPP_REGEX_TRAITS_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_TRAITS_CPP_REGEX_TRAITS_HPP_EAN_10_04_2005
...
#if HBOOST_WORKAROUND(__GLIBCPP__, != 0)
# define HBOOST_XPRESSIVE_BUGGY_CTYPE_FACET
#endif
...
namespace detail
{
    ...
    typedef hboost::uint_t<sizeof(std::ctype_base::mask) * CHAR_BIT>::least umask_t;
    HBOOST_MPL_ASSERT_RELATION(sizeof(std::ctype_base::mask), ==, sizeof(umask_t));
    ...
    typedef hboost::uint_t<umaskex_bits>::fast umaskex_t;
    HBOOST_MPL_ASSERT_RELATION(sizeof(umask_t), <=, sizeof(umaskex_t));

    // cast a ctype mask to a umaskex_t
    template<std::ctype_base::mask Mask>
    struct mask_cast
    {
        HBOOST_STATIC_CONSTANT(umaskex_t, value = static_cast<umask_t>(Mask));
    };
    ...
    {
        HBOOST_MPL_ASSERT_RELATION('\227', ==, std::ctype_base::print);
        HBOOST_STATIC_CONSTANT(umaskex_t, value = 0227);
    };
    #endif
    ...
    #ifndef HBOOST_XPRESSIVE_BUGGY_CTYPE_FACET
    ...
    struct unused_mask
    {
        HBOOST_STATIC_ASSERT(1 != Out);
        HBOOST_STATIC_CONSTANT(umaskex_t, value = (unused_mask<In, (Out >> 1)>::value));
    };

    template<umaskex_t In, umaskex_t Out>
    struct unused_mask<In, Out, true>
    {
        HBOOST_STATIC_CONSTANT(umaskex_t, value = Out);
    };
    ...
    #elif defined(_CPPLIB_VER) && defined(HBOOST_WINDOWS)
    ...
    private:
        ...
        {
            HBOOST_MPL_ASSERT_RELATION('_', ==, L'_');
            return L'_' == ch;
        }

        static bool is_newline(Char ch)
        {
            HBOOST_MPL_ASSERT_RELATION('\r', ==, L'\r');
            HBOOST_MPL_ASSERT_RELATION('\n', ==, L'\n');
            HBOOST_MPL_ASSERT_RELATION('\f', ==, L'\f');
            return L'\r' == ch || L'\n' == ch || L'\f' == ch
  ...
  : detail::cpp_regex_traits_base<Char>
{
    ...
    {
        HBOOST_MPL_ASSERT((is_same<char_type, char>));
        char_type ntcs[] = {
    ...
    {
        HBOOST_ASSERT(false); // TODO implement me
        return string_type();
    }
    ...
    {
        HBOOST_ASSERT(8 == radix || 10 == radix || 16 == radix);
        int val = -1;
    ...
    locale_type imbue(locale_type loc)
    {
        ...
        this->loc_ = loc;
        this->ctype_ = &HBOOST_USE_FACET(std::ctype<char_type>, this->loc_);
        //this->collate_ = &HBOOST_USE_FACET(std::collate<char_type>, this->loc_);
...
private:
    ...
    {
        static HBOOST_CONSTEXPR_OR_CONST char_class_pair s_char_class_map[] =
        {
            { HBOOST_XPR_CSTR_(char_type, "alnum"),  detail::std_ctype_alnum }
          , { HBOOST_XPR_CSTR_(char_type, "alpha"),  detail::std_ctype_alpha }
          , { HBOOST_XPR_CSTR_(char_type, "blank"),  detail::non_std_ctype_blank }
          , { HBOOST_XPR_CSTR_(char_type, "cntrl"),  detail::std_ctype_cntrl }
          , { HBOOST_XPR_CSTR_(char_type, "d"),      detail::std_ctype_digit }
          , { HBOOST_XPR_CSTR_(char_type, "digit"),  detail::std_ctype_digit }
          , { HBOOST_XPR_CSTR_(char_type, "graph"),  detail::std_ctype_graph }
          , { HBOOST_XPR_CSTR_(char_type, "lower"),  detail::std_ctype_lower }
          , { HBOOST_XPR_CSTR_(char_type, "newline"),detail::non_std_ctype_newline }
          , { HBOOST_XPR_CSTR_(char_type, "print"),  detail::std_ctype_print }
          , { HBOOST_XPR_CSTR_(char_type, "punct"),  detail::std_ctype_punct }
          , { HBOOST_XPR_CSTR_(char_type, "s"),      detail::std_ctype_space }
          , { HBOOST_XPR_CSTR_(char_type, "space"),  detail::std_ctype_space }
          , { HBOOST_XPR_CSTR_(char_type, "upper"),  detail::std_ctype_upper }
          , { HBOOST_XPR_CSTR_(char_type, "w"),      detail::std_ctype_alnum | detail::non_std_ctype_underscore }
          , { HBOOST_XPR_CSTR_(char_type, "xdigit"), detail::std_ctype_xdigit }
          , { 0, 0 }
        };
