...
#ifndef HBOOST_XPRESSIVE_TRAITS_DETAIL_C_CTYPE_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_TRAITS_DETAIL_C_CTYPE_HPP_EAN_10_04_2005
...
struct char_class_impl<char>
{
    ...
    HBOOST_MPL_ASSERT_RELATION(0x07FF, ==, (_XB|_XA|_XS|_BB|_CN|_DI|_LO|_PU|_SP|_UP|_XD));
    HBOOST_STATIC_CONSTANT(short, char_class_underscore = 0x1000);
    HBOOST_STATIC_CONSTANT(short, char_class_newline = 0x2000);
...
struct char_class_impl<wchar_t>
{
    ...
    //HBOOST_STATIC_CONSTANT(int, char_class_alnum         = 0x0001);
    HBOOST_STATIC_CONSTANT(int, char_class_alpha         = 0x0002);
    HBOOST_STATIC_CONSTANT(int, char_class_blank         = 0x0004);
    HBOOST_STATIC_CONSTANT(int, char_class_cntrl         = 0x0008);
    HBOOST_STATIC_CONSTANT(int, char_class_digit         = 0x0010);
    //HBOOST_STATIC_CONSTANT(int, char_class_graph         = 0x0020);
    HBOOST_STATIC_CONSTANT(int, char_class_lower         = 0x0040);
    //HBOOST_STATIC_CONSTANT(int, char_class_print         = 0x0080);
    HBOOST_STATIC_CONSTANT(int, char_class_punct         = 0x0100);
    HBOOST_STATIC_CONSTANT(int, char_class_space         = 0x0200);
    HBOOST_STATIC_CONSTANT(int, char_class_upper         = 0x0400);
    HBOOST_STATIC_CONSTANT(int, char_class_underscore    = 0x0800);
    HBOOST_STATIC_CONSTANT(int, char_class_xdigit        = 0x1000);
    HBOOST_STATIC_CONSTANT(int, char_class_newline       = 0x2000);
...
{
    typedef int char_class_type;
    HBOOST_MPL_ASSERT_RELATION(0x81FF, ==, (_ALPHA|_UPPER|_LOWER|_DIGIT|_SPACE|_PUNCT|_CONTROL|_BLANK|_HEX|_LEADBYTE));
    HBOOST_STATIC_CONSTANT(int, char_class_underscore = 0x1000);
    HBOOST_STATIC_CONSTANT(int, char_class_newline = 0x2000);
...
{
    typedef int char_class_type;
    HBOOST_MPL_ASSERT_RELATION(0377, ==, (_U|_L|_N|_S|_P|_C|_B|_X));
    HBOOST_STATIC_CONSTANT(int, char_class_underscore = 0400);
    HBOOST_STATIC_CONSTANT(int, char_class_newline = 01000);
...
{
    typedef int char_class_type;
    HBOOST_MPL_ASSERT_RELATION(0xffff, ==, (_ISalnum|_ISalpha|_ISblank|_IScntrl|_ISdigit|_ISgraph|
                                           _ISlower|_ISprint|_ISpunct|_ISspace|_ISupper|_ISxdigit|0xffff));
    HBOOST_STATIC_CONSTANT(int, char_class_underscore = 0x00010000);
    HBOOST_STATIC_CONSTANT(int, char_class_newline = 0x00020000);
