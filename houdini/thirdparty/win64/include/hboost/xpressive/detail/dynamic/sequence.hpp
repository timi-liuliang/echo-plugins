...
#ifndef HBOOST_XPRESSIVE_DETAIL_DYNAMIC_SEQUENCE_HPP_EAN_04_10_2006
#define HBOOST_XPRESSIVE_DETAIL_DYNAMIC_SEQUENCE_HPP_EAN_04_10_2006
...
struct sequence
{
    ...
    sequence<BidiIter> &operator |=(sequence<BidiIter> that)
    {
        ...
        HBOOST_ASSERT(0 != this->alternates_);
