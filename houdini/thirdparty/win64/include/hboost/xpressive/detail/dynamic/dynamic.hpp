...
#ifndef HBOOST_XPRESSIVE_DETAIL_DYNAMIC_DYNAMIC_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_DYNAMIC_DYNAMIC_HPP_EAN_10_04_2005
...
#include <hboost/xpressive/detail/dynamic/sequence.hpp>
...
{
    HBOOST_STATIC_CONSTANT(std::size_t, width = unknown_width::value);
    HBOOST_STATIC_CONSTANT(bool, pure = false);
};
...
{
    HBOOST_ASSERT(spec.max_); // we should never get here if max is 0
