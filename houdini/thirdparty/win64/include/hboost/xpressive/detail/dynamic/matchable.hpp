...
#ifndef HBOOST_XPRESSIVE_DETAIL_DYNAMIC_MATCHABLE_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_DYNAMIC_MATCHABLE_HPP_EAN_10_04_2005
  ...
  , counted_base<matchable_ex<BidiIter> >
{
    ...
    {
        HBOOST_MPL_ASSERT((is_same<Top, matchable_ex<BidiIter> >));
