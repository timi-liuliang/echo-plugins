...
#ifndef HBOOST_XPRESSIVE_DETAIL_DETAIL_FWD_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_DETAIL_FWD_HPP_EAN_10_04_2005
...
namespace hboost { namespace xpressive { namespace op
{
    struct push;
    struct push_back;
    struct pop;
