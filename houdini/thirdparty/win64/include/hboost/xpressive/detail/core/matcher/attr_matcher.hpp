...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ATTR_MATCHER_HPP_EAN_06_09_2007
#define HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ATTR_MATCHER_HPP_EAN_06_09_2007
...
#include <hboost/xpressive/detail/utility/symbols.hpp>
...
namespace hboost { namespace xpressive { namespace detail
{
      ...
      : quant_style<quant_none, 0, false>
    {
        ...
        int slot_;
        hboost::xpressive::detail::symbols<Matcher> sym_;
    };
