...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_RESULTS_CACHE_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_CORE_RESULTS_CACHE_HPP_EAN_10_04_2005
...
#include <hboost/xpressive/detail/core/list.hpp>
...
namespace hboost { namespace xpressive { namespace detail
{
    ...
    struct results_cache
    {
        ...
        match_results<BidiIter> &append_new(nested_results<BidiIter> &out)
        {
            ...
            {
                HBOOST_ASSERT(access::get_nested_results(this->cache_.back()).empty());
