...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ALTERNATE_MATCHER_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ALTERNATE_MATCHER_HPP_EAN_10_04_2005
...
#include <hboost/xpressive/detail/utility/hash_peek_bitset.hpp>
#include <hboost/xpressive/detail/utility/algorithm.hpp>
#include <hboost/xpressive/detail/utility/any.hpp>
...
namespace hboost { namespace xpressive { namespace detail
{
    ...
    struct alt_match_pred
    {
        ...
        {
            return xpr.HBOOST_NESTED_TEMPLATE push_match<Next>(*this->state_);
        }
        ...
        >
    {
        ...
        detail::width get_width() const
        {
            ...
            HBOOST_MPL_ASSERT_RELATION(unknown_width::value, !=, Alternates::width);
