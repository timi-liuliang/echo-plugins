...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_STRING_MATCHER_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_STRING_MATCHER_HPP_EAN_10_04_2005
...
namespace hboost { namespace xpressive { namespace detail
{
      ...
      : quant_style_fixed_unknown_width
    {
        ...
        string_matcher(string_type const &str, Traits const &tr)
          ...
          , end_()
        {
            typename range_iterator<string_type>::type cur = hboost::begin(this->str_);
            typename range_iterator<string_type>::type end = hboost::end(this->str_);
            for(; cur != end; ++cur)
            {
