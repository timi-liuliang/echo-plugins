...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_LINKER_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_CORE_LINKER_HPP_EAN_10_04_2005
...
#else
# include <hboost/spirit/fusion/algorithm/for_each.hpp>
#endif
...
#include <hboost/xpressive/detail/utility/never_true.hpp>
...
private:
    ...
    {
        HBOOST_ASSERT(*this->traits_type_ == typeid(Traits));
