...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_LIST_HPP_EAN_10_26_2009
#define HBOOST_XPRESSIVE_DETAIL_CORE_LIST_HPP_EAN_10_26_2009
...
namespace hboost { namespace xpressive { namespace detail
{
    ...
    private:
        ...
        struct list_iterator
          : hboost::iterator_facade<list_iterator<Ref>, T, std::bidirectional_iterator_tag, Ref>
        {
