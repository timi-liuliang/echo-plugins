...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_MARK_MATCHER_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_MARK_MATCHER_HPP_EAN_10_04_2005
...
namespace hboost { namespace xpressive { namespace detail
{
      ...
      : quant_style_variable_width
    {
        ...
        {
            HBOOST_ASSERT(this->mark_number_ < static_cast<int>(state.mark_count_));
