...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ASSERT_EOL_MATCHER_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ASSERT_EOL_MATCHER_HPP_EAN_10_04_2005
...
#include <hboost/xpressive/detail/core/matcher/assert_line_base.hpp>
      ...
      : assert_line_base<Traits>
    {
        ...
        bool match(match_state<BidiIter> &state, Next const &next) const
        {
            ...
            else
            {
                ...
                else if(ch == this->nl_ && (!state.bos() || state.flags_.match_prev_avail_) && *hboost::prior(state.cur_) == this->cr_)
                {
                    return false;
                }
            }
