...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_PEEKER_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_CORE_PEEKER_HPP_EAN_10_04_2005
...
struct xpression_peeker
{
    ...
    {
        HBOOST_ASSERT(0 != xpr.bset_.count());
    ...
    {
        HBOOST_ASSERT(0 != xpr.charset_.base().count());
