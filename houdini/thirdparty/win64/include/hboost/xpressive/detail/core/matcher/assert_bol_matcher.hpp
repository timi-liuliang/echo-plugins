...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ASSERT_BOL_MATCHER_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ASSERT_BOL_MATCHER_HPP_EAN_10_04_2005
...
namespace hboost { namespace xpressive { namespace detail
{
      ...
      : assert_line_base<Traits>
    {
        ...
        bool match(match_state<BidiIter> &state, Next const &next) const
        {
            ...
            {
                char_type ch = *hboost::prior(state.cur_);
