...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_ADAPTOR_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_CORE_ADAPTOR_HPP_EAN_10_04_2005
  ...
  : Base // either matchable or matchable_ex
{
    ...
    {
        typedef typename hboost::unwrap_reference<Xpr const>::type xpr_type;
