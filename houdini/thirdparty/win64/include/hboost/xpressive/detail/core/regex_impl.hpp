...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_REGEX_IMPL_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_CORE_REGEX_IMPL_HPP_EAN_10_04_2005
...
#include <hboost/xpressive/detail/utility/tracking_ptr.hpp>
  ...
  : enable_reference_tracking<regex_impl<BidiIter> >
{
    ...
    {
        #ifdef HBOOST_XPRESSIVE_DEBUG_CYCLE_TEST
        ++instances;
        #endif
    }
