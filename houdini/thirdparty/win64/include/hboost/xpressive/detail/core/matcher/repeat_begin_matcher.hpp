...
#ifndef HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_REPEAT_BEGIN_MATCHER_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_CORE_MATCHER_REPEAT_BEGIN_MATCHER_HPP_EAN_10_04_2005
...
namespace hboost { namespace xpressive { namespace detail
{
      ...
      : quant_style<quant_variable_width, unknown_width::value, false>
    {
        ...
        bool match(match_state<BidiIter> &state, Next const &next) const
        {
            ...
            if(next.HBOOST_NESTED_TEMPLATE push_match<Next>(state))
            {
                return true;
            }
