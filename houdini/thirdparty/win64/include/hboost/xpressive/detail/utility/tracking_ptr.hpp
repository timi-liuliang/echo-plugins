...
#ifndef HBOOST_XPRESSIVE_DETAIL_UTILITY_TRACKING_PTR_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_UTILITY_TRACKING_PTR_HPP_EAN_10_04_2005
...
#ifdef HBOOST_XPRESSIVE_DEBUG_TRACKING_POINTER
# include <iostream>
#endif
#include <set>
#include <functional>
...
private:
    ...
    hboost::detail::atomic_count cnt_;
};
...
struct tracking_ptr
{
    HBOOST_MPL_ASSERT((is_base_and_derived<enable_reference_tracking<Type>, Type>));
    ...
    #if defined(__SUNPRO_CC) && HBOOST_WORKAROUND(__SUNPRO_CC, <= 0x530)
