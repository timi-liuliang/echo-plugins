...
=============================================================================*/
#ifndef HBOOST_XPRESSIVE_SPIRIT_RANGE_RUN_IPP
#define HBOOST_XPRESSIVE_SPIRIT_RANGE_RUN_IPP

///////////////////////////////////////////////////////////////////////////////
#include <algorithm> // for std::lower_bound
#include <hboost/limits.hpp>
#include <hboost/assert.hpp>
#include <hboost/xpressive/detail/utility/chset/range_run.hpp>
...
{
    HBOOST_ASSERT(iter != this->run_.end());
    iter->merge(r);
