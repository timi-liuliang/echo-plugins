...
#ifndef HBOOST_XPRESSIVE_DETAIL_UTILITY_COUNTED_BASE_HPP_EAN_04_16_2006
#define HBOOST_XPRESSIVE_DETAIL_UTILITY_COUNTED_BASE_HPP_EAN_04_16_2006
...
namespace hboost { namespace xpressive { namespace detail
{
    ...
    private:
        ...
        mutable hboost::detail::atomic_count count_;
    };
    ...
    struct counted_base_access
    {
        ...
        {
            HBOOST_ASSERT(0 < that->count_);
            if(0 == --that->count_)
            {
                hboost::checked_delete(static_cast<Derived const *>(that));
            }
        }
    };
