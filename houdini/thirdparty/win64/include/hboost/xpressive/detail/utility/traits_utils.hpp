...
#ifndef HBOOST_XPRESSIVE_DETAIL_UTILITY_TRAITS_UTILS_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_UTILITY_TRAITS_UTILS_HPP_EAN_10_04_2005
...
namespace hboost { namespace xpressive { namespace detail
{
    ...
    {
        HBOOST_MPL_ASSERT((is_same<FromChar, char>));
    ...
    struct string_cast_
    {
        ...
        result_type operator()(From const &from, Traits const &tr) const
        {
            ...
            To to(
                hboost::make_transform_iterator(detail::data_begin(from), widen)
              , hboost::make_transform_iterator(detail::data_end(from), widen)
            );
            return to;
        }
    };
