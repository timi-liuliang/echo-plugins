...
#ifndef HBOOST_XPRESSIVE_DETAIL_STATIC_TRANSFORMS_AS_ALTERNATE_HPP_EAN_04_01_2007
#define HBOOST_XPRESSIVE_DETAIL_STATIC_TRANSFORMS_AS_ALTERNATE_HPP_EAN_04_01_2007
...
#include <hboost/xpressive/detail/utility/cons.hpp>
...
namespace hboost { namespace xpressive
{
    namespace detail
    {
        ...
        {
            HBOOST_STATIC_CONSTANT(std::size_t, width = Head::width == Tail::width ? Head::width : detail::unknown_width::value);
            HBOOST_STATIC_CONSTANT(bool, pure = Head::pure && Tail::pure);
        ...
        {
            HBOOST_STATIC_CONSTANT(std::size_t, width = Head::width);
            HBOOST_STATIC_CONSTANT(bool, pure = Head::pure);
