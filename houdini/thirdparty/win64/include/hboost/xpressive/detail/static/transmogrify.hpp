...
#ifndef HBOOST_XPRESSIVE_DETAIL_STATIC_TRANSMOGRIFY_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_STATIC_TRANSMOGRIFY_HPP_EAN_10_04_2005
...
#include <hboost/xpressive/detail/utility/dont_care.hpp>
#include <hboost/xpressive/detail/utility/traits_utils.hpp>
...
namespace hboost { namespace xpressive { namespace detail
{
    ...
    struct default_transmogrify<BidiIter, ICase, Traits, Matcher, typename Matcher::is_hboost_xpressive_xpression_>
    {
    ...
    struct transmogrify<BidiIter, ICase, Traits, range_placeholder<Char> >
    {
        ...
        HBOOST_MPL_ASSERT((is_same<Char, char_type>));
