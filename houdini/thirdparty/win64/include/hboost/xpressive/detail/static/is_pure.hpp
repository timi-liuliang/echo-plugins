...
#ifndef HBOOST_XPRESSIVE_DETAIL_STATIC_IS_PURE_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_DETAIL_STATIC_IS_PURE_HPP_EAN_10_04_2005
...
#include <hboost/mpl/not_equal_to.hpp>
#include <hboost/xpressive/detail/detail_fwd.hpp>
#include <hboost/xpressive/detail/static/width_of.hpp>
...
namespace hboost { namespace xpressive { namespace detail
{
      ...
      : use_simple_repeat_<Expr, Char>
    {
        ...
        HBOOST_MPL_ASSERT_RELATION(0, !=, (width_of<Expr, Char>::value));
    };
