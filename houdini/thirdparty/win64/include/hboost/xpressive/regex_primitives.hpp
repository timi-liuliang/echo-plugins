...
#ifndef HBOOST_XPRESSIVE_REGEX_PRIMITIVES_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_REGEX_PRIMITIVES_HPP_EAN_10_04_2005
...
#include <hboost/xpressive/detail/core/matchers.hpp>
...
# include <hboost/proto/core.hpp>
# include <hboost/proto/transform/arg.hpp>
# include <hboost/proto/transform/when.hpp>
# include <hboost/xpressive/detail/core/icase.hpp>
# include <hboost/xpressive/detail/static/compile.hpp>
# include <hboost/xpressive/detail/static/modifier.hpp>
#endif
...
//#define HBOOST_XPRESSIVE_GLOBAL(type, name, init)                                        \
//    namespace detail                                                                    \
//    {                                                                                   \
//        template<int Dummy>                                                             \
//        struct HBOOST_PP_CAT(global_pod_, name)                                          \
//        {                                                                               \
...
//        };                                                                              \
//        template<int Dummy>                                                             \
//        type const HBOOST_PP_CAT(global_pod_, name)<Dummy>::value = init;                \
//    }                                                                                   \
//    type const &name = detail::HBOOST_PP_CAT(global_pod_, name)<0>::value
*/
...
public:
    ...
    HBOOST_PROTO_EXTENDS_USING_ASSIGN_NON_DEPENDENT(mark_tag)
};
...
// would be preferable.
/// INTERNAL ONLY
#define HBOOST_XPRESSIVE_GLOBAL_MARK_TAG(NAME, VALUE)                            \
    hboost::xpressive::mark_tag::proto_base_expr const NAME = {{VALUE}}          \
    /**/

///////////////////////////////////////////////////////////////////////////////
/// \brief Sub-match placeholder, like $& in Perl
HBOOST_XPRESSIVE_GLOBAL_MARK_TAG(s0, 0);
...
/// sub-match.
HBOOST_XPRESSIVE_GLOBAL_MARK_TAG(s1, 1);
HBOOST_XPRESSIVE_GLOBAL_MARK_TAG(s2, 2);
HBOOST_XPRESSIVE_GLOBAL_MARK_TAG(s3, 3);
HBOOST_XPRESSIVE_GLOBAL_MARK_TAG(s4, 4);
HBOOST_XPRESSIVE_GLOBAL_MARK_TAG(s5, 5);
HBOOST_XPRESSIVE_GLOBAL_MARK_TAG(s6, 6);
HBOOST_XPRESSIVE_GLOBAL_MARK_TAG(s7, 7);
HBOOST_XPRESSIVE_GLOBAL_MARK_TAG(s8, 8);
HBOOST_XPRESSIVE_GLOBAL_MARK_TAG(s9, 9);
