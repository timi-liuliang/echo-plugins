...
#ifndef HBOOST_XPRESSIVE_BASIC_REGEX_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_BASIC_REGEX_HPP_EAN_10_04_2005
...
#include <hboost/xpressive/detail/core/regex_domain.hpp>

// Doxygen can't handle proto :-(
#ifndef HBOOST_XPRESSIVE_DOXYGEN_INVOKED
# include <hboost/xpressive/detail/static/grammar.hpp>
# include <hboost/proto/extends.hpp>
#endif

#if HBOOST_XPRESSIVE_HAS_MS_STACK_GUARD
...
namespace detail
{
    ...
    {
        HBOOST_XPR_ENSURE_(!stack_error, regex_constants::error_stack, "Regex stack space exhausted");
    }
}
...
public:
    ...
    HBOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, ECMAScript         = regex_constants::ECMAScript);
    HBOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, icase              = regex_constants::icase_);
    HBOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, nosubs             = regex_constants::nosubs);
    HBOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, optimize           = regex_constants::optimize);
    HBOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, collate            = regex_constants::collate);
    HBOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, single_line        = regex_constants::single_line);
    HBOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, not_dot_null       = regex_constants::not_dot_null);
    HBOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, not_dot_newline    = regex_constants::not_dot_newline);
    HBOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, ignore_white_space = regex_constants::ignore_white_space);
    ...
    basic_regex(Expr const &expr)
      : base_type()
    {
        HBOOST_XPRESSIVE_CHECK_REGEX(Expr, char_type);
...
#endif // HBOOST_XPRESSIVE_BASIC_REGEX_HPP_EAN_10_04_2005
