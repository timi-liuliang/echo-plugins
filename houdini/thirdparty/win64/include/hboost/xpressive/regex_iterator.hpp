...
#ifndef HBOOST_XPRESSIVE_REGEX_ITERATOR_HPP_EAN_10_04_2005
#define HBOOST_XPRESSIVE_REGEX_ITERATOR_HPP_EAN_10_04_2005
...
private:
    ...
    void next_()
    {
        HBOOST_ASSERT(this->impl_ && 1 == this->impl_->use_count());
        if(!this->impl_->next())
        {
            this->impl_ = 0;
        }
