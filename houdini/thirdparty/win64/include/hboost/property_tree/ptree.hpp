...
#ifndef HBOOST_PROPERTY_TREE_PTREE_HPP_INCLUDED
#define HBOOST_PROPERTY_TREE_PTREE_HPP_INCLUDED

#include <hboost/property_tree/ptree_fwd.hpp>
#include <hboost/property_tree/string_path.hpp>
#include <hboost/property_tree/stream_translator.hpp>
#include <hboost/property_tree/exceptions.hpp>
#include <hboost/property_tree/detail/ptree_utils.hpp>

#include <hboost/multi_index_container.hpp>
#include <hboost/multi_index/indexed_by.hpp>
#include <hboost/multi_index/sequenced_index.hpp>
...
namespace hboost { namespace property_tree
{
    ...
    class basic_ptree
    {
#if defined(HBOOST_PROPERTY_TREE_DOXYGEN_INVOKED)
    public:
#endif
        // Internal types
        /**
    ...
    public:
        ...
        /** Equivalent to erase(hboost::prior(end())). */
        void pop_back();
        ...
        /** Get the child at the given path, or return hboost::null. */
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the supplied translator. Return hboost::null if
         * this fails.
         */
        template<class Type, class Translator>
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the default translator. Return hboost::null if
         * this fails.
         */
        template<class Type>
...
#include <hboost/property_tree/detail/ptree_implementation.hpp>
