...
// ----------------------------------------------------------------------------
#ifndef HBOOST_PROPERTY_TREE_PTREE_FWD_HPP_INCLUDED
#define HBOOST_PROPERTY_TREE_PTREE_FWD_HPP_INCLUDED
...
namespace hboost { namespace property_tree
{
    ...
    concept PropertyTreeTranslator<class Tr> {
        ...
        hboost::optional<external_type> Tr::get_value(internal_type);
        hboost::optional<internal_type> Tr::put_value(external_type);
    }
#endif
...
#   define HBOOST_PROPERTY_TREE_THROW(e) HBOOST_THROW_EXCEPTION(e)
#endif
