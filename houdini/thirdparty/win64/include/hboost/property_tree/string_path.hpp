...
#ifndef HBOOST_PROPERTY_TREE_STRING_PATH_HPP_INCLUDED
#define HBOOST_PROPERTY_TREE_STRING_PATH_HPP_INCLUDED

#include <hboost/property_tree/ptree_fwd.hpp>
#include <hboost/property_tree/id_translator.hpp>
...
namespace hboost { namespace property_tree
{
    ...
    class string_path
    {
        HBOOST_STATIC_ASSERT((is_same<String,
    ...
    public:
        ...
        string_path& operator /=(const string_path &o) {
            ...
            HBOOST_ASSERT((m_separator == o.m_separator
                          || o.empty()
                          || o.single())
                         && "Incompatible paths.");
            if(!o.empty()) {
    ...
    {
        HBOOST_ASSERT(!empty() && "Reducing empty path");
        ...
        HBOOST_PROPERTY_TREE_THROW(ptree_bad_path("Path syntax error", *this));
    }
