...
// ----------------------------------------------------------------------------
#ifndef HBOOST_PROPERTY_TREE_XML_PARSER_HPP_INCLUDED
#define HBOOST_PROPERTY_TREE_XML_PARSER_HPP_INCLUDED

#include <hboost/property_tree/ptree.hpp>
#include <hboost/property_tree/detail/xml_parser_write.hpp>
#include <hboost/property_tree/detail/xml_parser_error.hpp>
#include <hboost/property_tree/detail/xml_parser_writer_settings.hpp>
#include <hboost/property_tree/detail/xml_parser_flags.hpp>
#include <hboost/property_tree/detail/xml_parser_read_rapidxml.hpp>
...
namespace hboost { namespace property_tree { namespace xml_parser
{
    ...
    {
        HBOOST_ASSERT(validate_flags(flags));
        std::basic_ifstream<typename Ptree::key_type::value_type>
            stream(filename.c_str());
        if (!stream)
            HBOOST_PROPERTY_TREE_THROW(xml_parser_error(
