...
#ifndef HBOOST_PROPERTY_TREE_ID_TRANSLATOR_HPP_INCLUDED
#define HBOOST_PROPERTY_TREE_ID_TRANSLATOR_HPP_INCLUDED
...
namespace hboost { namespace property_tree
{
    ...
    struct id_translator
    {
        ...
        hboost::optional<T> get_value(const T &v) { return v; }
        hboost::optional<T> put_value(const T &v) { return v; }
    };
