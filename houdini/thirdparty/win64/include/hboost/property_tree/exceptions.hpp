...
#ifndef HBOOST_PROPERTY_TREE_EXCEPTIONS_HPP_INCLUDED
#define HBOOST_PROPERTY_TREE_EXCEPTIONS_HPP_INCLUDED
...
#include <hboost/property_tree/detail/exception_implementation.hpp>
