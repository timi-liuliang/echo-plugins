...
// ----------------------------------------------------------------------------
#ifndef HBOOST_PROPERTY_TREE_DETAIL_XML_PARSER_WRITE_HPP_INCLUDED
#define HBOOST_PROPERTY_TREE_DETAIL_XML_PARSER_WRITE_HPP_INCLUDED
...
namespace hboost { namespace property_tree { namespace xml_parser
{
                            ...
                            const xml_writer_settings<typename Ptree::key_type> & settings)
    {
        ...
        if (!stream)
            HBOOST_PROPERTY_TREE_THROW(xml_parser_error("write error", filename, 0));
    }
