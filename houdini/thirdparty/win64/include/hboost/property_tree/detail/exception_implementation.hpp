...
// ----------------------------------------------------------------------------
#ifndef HBOOST_PROPERTY_TREE_DETAIL_EXCEPTIONS_IMPLEMENTATION_HPP_INCLUDED
#define HBOOST_PROPERTY_TREE_DETAIL_EXCEPTIONS_IMPLEMENTATION_HPP_INCLUDED
...
namespace hboost { namespace property_tree
{
    ...
    {
        return hboost::any_cast<D>(m_data);
    }
    ...
    {
        return hboost::any_cast<P>(m_path);
    }
