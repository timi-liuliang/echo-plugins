...
#ifndef HBOOST_RATIO_RATIO_IO_HPP
#define HBOOST_RATIO_RATIO_IO_HPP
...
#ifdef HBOOST_RATIO_PROVIDES_DEPRECATED_FEATURES_SINCE_V2_0_0
#include <hboost/ratio/detail/ratio_io.hpp>
#else
...
#if defined(HBOOST_NO_CXX11_UNICODE_LITERALS) || defined(HBOOST_NO_CXX11_CHAR16_T) || defined(HBOOST_NO_CXX11_CHAR32_T) || defined(HBOOST_NO_CXX11_U16STRING) || defined(HBOOST_NO_CXX11_U32STRING)
#if defined HBOOST_RATIO_HAS_UNICODE_SUPPORT
#undef HBOOST_RATIO_HAS_UNICODE_SUPPORT
#endif
#else
#define HBOOST_RATIO_HAS_UNICODE_SUPPORT 1
#endif
...
#ifdef HBOOST_RATIO_HAS_STATIC_STRING
...
#if HBOOST_RATIO_HAS_UNICODE_SUPPORT
...
#endif  // HBOOST_RATIO_PROVIDES_DEPRECATED_FEATURES_SINCE_V2_0_0
#endif  // HBOOST_RATIO_RATIO_IO_HPP
