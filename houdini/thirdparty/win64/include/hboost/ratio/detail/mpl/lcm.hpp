...
//
////////////////////////////////////////////////////////////////////
#ifndef HBOOST_MPL_LCM_HPP_INCLUDED
#define HBOOST_MPL_LCM_HPP_INCLUDED
...
#include <hboost/mpl/aux_/config/dependent_nttp.hpp>
#include <hboost/cstdint.hpp>

#if    !defined(HBOOST_MPL_CFG_NO_NESTED_VALUE_ARITHMETIC_2) \
...
#   define HBOOST_MPL_CFG_NO_NESTED_VALUE_ARITHMETIC_2
...
{
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(2, lcm, (N1, N2))
};

HBOOST_MPL_AUX_NA_SPEC(2, lcm)
...
namespace aux {
  ...
  template< typename T1, hboost::intmax_t n1, bool n1_is_0
                          , typename T2, hboost::intmax_t n2, bool n2_is_0 >
      struct lcm_aux
      ...
      template <typename T1, hboost::intmax_t n1, typename T2, hboost::intmax_t n2>
      struct lcm_aux<T1, n1, false, T2, n2, true> : integral_c<T2, 0>
      {};

      template <typename T1, hboost::intmax_t n1, typename T2, hboost::intmax_t n2, bool C>
      struct lcm_aux<T1, n1, true, T2, n2, C> : integral_c<T1, 0>
      {};


#else // defined(HBOOST_MPL_CFG_NO_DEPENDENT_NONTYPE_PARAMETER_IN_PARTIAL_SPEC)
    ...
    struct lcm_aux<T1, n1, true, T2, n2, C> : integral_c<T1, 0>
    {};
#endif // defined(HBOOST_MPL_CFG_NO_DEPENDENT_NONTYPE_PARAMETER_IN_PARTIAL_SPEC)
}
...
#endif // HBOOST_MPL_LCM_HPP_INCLUDED
