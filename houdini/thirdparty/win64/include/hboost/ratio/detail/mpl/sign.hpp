...
//
////////////////////////////////////////////////////////////////////
#ifndef HBOOST_MPL_SIGN_HPP_INCLUDED
#define HBOOST_MPL_SIGN_HPP_INCLUDED
...
{
    HBOOST_MPL_AUX_LAMBDA_SUPPORT(1, sign, (N))
};

HBOOST_MPL_AUX_NA_SPEC(1, sign)
...
{
    HBOOST_STATIC_CONSTANT(T, value = (n == 0 ? 0 : (n < 0 ? -1 : 1)));
...
#endif // HBOOST_MPL_SIGN_HPP_INCLUDED
