...
#ifndef HBOOST_ATOMIC_DETAIL_OPS_GCC_ATOMIC_HPP_INCLUDED_
#define HBOOST_ATOMIC_DETAIL_OPS_GCC_ATOMIC_HPP_INCLUDED_
...
#if defined(__clang__) && (defined(HBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B) || defined(HBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG16B))
#include <hboost/atomic/detail/ops_gcc_x86_dcas.hpp>
#include <hboost/atomic/detail/ops_cas_based.hpp>
#endif

#if __GCC_ATOMIC_LLONG_LOCK_FREE != HBOOST_ATOMIC_LLONG_LOCK_FREE || __GCC_ATOMIC_LONG_LOCK_FREE != HBOOST_ATOMIC_LONG_LOCK_FREE ||\
    __GCC_ATOMIC_INT_LOCK_FREE != HBOOST_ATOMIC_INT_LOCK_FREE || __GCC_ATOMIC_SHORT_LOCK_FREE != HBOOST_ATOMIC_SHORT_LOCK_FREE ||\
    __GCC_ATOMIC_CHAR_LOCK_FREE != HBOOST_ATOMIC_CHAR_LOCK_FREE || __GCC_ATOMIC_BOOL_LOCK_FREE != HBOOST_ATOMIC_BOOL_LOCK_FREE ||\
    __GCC_ATOMIC_WCHAR_T_LOCK_FREE != HBOOST_ATOMIC_WCHAR_T_LOCK_FREE
// There are platforms where we need to use larger storage types
#include <hboost/atomic/detail/int_sizes.hpp>
#include <hboost/atomic/detail/ops_extending_cas_based.hpp>
#endif
...
/*!
 * The function converts \c hboost::memory_order values to the compiler-specific constants.
 *
 ...
 *       declared with HBOOST_FORCEINLINE. In this case the compilers are able to see that
 ...
 *       inline functions even when marked with HBOOST_FORCEINLINE. In this case all atomic
 *       operaions will be executed with seq_cst semantics.
 */
HBOOST_FORCEINLINE HBOOST_CONSTEXPR int convert_memory_order_to_gcc(memory_order order) HBOOST_NOEXCEPT
{
...
struct gcc_atomic_operations
{
    ...
    static HBOOST_FORCEINLINE bool is_lock_free(storage_type const volatile& storage) HBOOST_NOEXCEPT
    {
        return __atomic_is_lock_free(sizeof(storage_type), &storage);
    }
};

#if HBOOST_ATOMIC_INT128_LOCK_FREE > 0
#if defined(__clang__) && defined(HBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG16B)
...
#if HBOOST_ATOMIC_INT64_LOCK_FREE > 0
#if defined(__clang__) && defined(HBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B)
...
#elif (HBOOST_ATOMIC_DETAIL_SIZEOF_LLONG == 8 && __GCC_ATOMIC_LLONG_LOCK_FREE != HBOOST_ATOMIC_LLONG_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_LONG == 8 && __GCC_ATOMIC_LONG_LOCK_FREE != HBOOST_ATOMIC_LONG_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_INT == 8 && __GCC_ATOMIC_INT_LOCK_FREE != HBOOST_ATOMIC_INT_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_SHORT == 8 && __GCC_ATOMIC_SHORT_LOCK_FREE != HBOOST_ATOMIC_SHORT_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_WCHAR_T == 8 && __GCC_ATOMIC_WCHAR_T_LOCK_FREE != HBOOST_ATOMIC_WCHAR_T_LOCK_FREE)

#define HBOOST_ATOMIC_DETAIL_INT64_EXTENDED
...
#if HBOOST_ATOMIC_INT32_LOCK_FREE > 0
#if (HBOOST_ATOMIC_DETAIL_SIZEOF_LLONG == 4 && __GCC_ATOMIC_LLONG_LOCK_FREE != HBOOST_ATOMIC_LLONG_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_LONG == 4 && __GCC_ATOMIC_LONG_LOCK_FREE != HBOOST_ATOMIC_LONG_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_INT == 4 && __GCC_ATOMIC_INT_LOCK_FREE != HBOOST_ATOMIC_INT_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_SHORT == 4 && __GCC_ATOMIC_SHORT_LOCK_FREE != HBOOST_ATOMIC_SHORT_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_WCHAR_T == 4 && __GCC_ATOMIC_WCHAR_T_LOCK_FREE != HBOOST_ATOMIC_WCHAR_T_LOCK_FREE)

#define HBOOST_ATOMIC_DETAIL_INT32_EXTENDED

#if !defined(HBOOST_ATOMIC_DETAIL_INT64_EXTENDED)
...
#else // !defined(HBOOST_ATOMIC_DETAIL_INT64_EXTENDED)
...
#endif // !defined(HBOOST_ATOMIC_DETAIL_INT64_EXTENDED)
...
#if HBOOST_ATOMIC_INT16_LOCK_FREE > 0
#if (HBOOST_ATOMIC_DETAIL_SIZEOF_LLONG == 2 && __GCC_ATOMIC_LLONG_LOCK_FREE != HBOOST_ATOMIC_LLONG_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_LONG == 2 && __GCC_ATOMIC_LONG_LOCK_FREE != HBOOST_ATOMIC_LONG_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_INT == 2 && __GCC_ATOMIC_INT_LOCK_FREE != HBOOST_ATOMIC_INT_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_SHORT == 2 && __GCC_ATOMIC_SHORT_LOCK_FREE != HBOOST_ATOMIC_SHORT_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_WCHAR_T == 2 && __GCC_ATOMIC_WCHAR_T_LOCK_FREE != HBOOST_ATOMIC_WCHAR_T_LOCK_FREE)

#define HBOOST_ATOMIC_DETAIL_INT16_EXTENDED

#if !defined(HBOOST_ATOMIC_DETAIL_INT32_EXTENDED)
...
#elif !defined(HBOOST_ATOMIC_DETAIL_INT64_EXTENDED)
...
#if HBOOST_ATOMIC_INT8_LOCK_FREE > 0
#if (HBOOST_ATOMIC_DETAIL_SIZEOF_LLONG == 1 && __GCC_ATOMIC_LLONG_LOCK_FREE != HBOOST_ATOMIC_LLONG_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_LONG == 1 && __GCC_ATOMIC_LONG_LOCK_FREE != HBOOST_ATOMIC_LONG_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_INT == 1 && __GCC_ATOMIC_INT_LOCK_FREE != HBOOST_ATOMIC_INT_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_SHORT == 1 && __GCC_ATOMIC_SHORT_LOCK_FREE != HBOOST_ATOMIC_SHORT_LOCK_FREE) ||\
    (HBOOST_ATOMIC_DETAIL_SIZEOF_WCHAR_T == 1 && __GCC_ATOMIC_WCHAR_T_LOCK_FREE != HBOOST_ATOMIC_WCHAR_T_LOCK_FREE) ||\
    (__GCC_ATOMIC_CHAR_LOCK_FREE != HBOOST_ATOMIC_CHAR_LOCK_FREE) ||\
    (__GCC_ATOMIC_BOOL_LOCK_FREE != HBOOST_ATOMIC_BOOL_LOCK_FREE)

#if !defined(HBOOST_ATOMIC_DETAIL_INT16_EXTENDED)
...
#elif !defined(HBOOST_ATOMIC_DETAIL_INT32_EXTENDED)
...
#undef HBOOST_ATOMIC_DETAIL_INT16_EXTENDED
#undef HBOOST_ATOMIC_DETAIL_INT32_EXTENDED
#undef HBOOST_ATOMIC_DETAIL_INT64_EXTENDED
...
#endif // HBOOST_ATOMIC_DETAIL_OPS_GCC_ATOMIC_HPP_INCLUDED_
