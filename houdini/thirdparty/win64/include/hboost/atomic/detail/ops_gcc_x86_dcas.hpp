...
#ifndef HBOOST_ATOMIC_DETAIL_OPS_GCC_X86_DCAS_HPP_INCLUDED_
#define HBOOST_ATOMIC_DETAIL_OPS_GCC_X86_DCAS_HPP_INCLUDED_
...
struct gcc_dcas_x86
{
    ...
    static HBOOST_FORCEINLINE void store(storage_type volatile& storage, storage_type v, memory_order) HBOOST_NOEXCEPT
    {
        ...
        {
#if !defined(HBOOST_ATOMIC_DETAIL_NO_ASM_IMPLIED_ZERO_DISPLACEMENTS)
#if defined(__PIC__)
            uint32_t scratch;
            __asm__ __volatile__
            (
                ...
                : HBOOST_ATOMIC_DETAIL_ASM_CLOBBER_CC_COMMA "edx", "memory"
            );
            ...
            (
                ...
                : HBOOST_ATOMIC_DETAIL_ASM_CLOBBER_CC_COMMA "eax", "edx", "memory"
            );
#endif // defined(__PIC__)
#else // !defined(HBOOST_ATOMIC_DETAIL_NO_ASM_IMPLIED_ZERO_DISPLACEMENTS)
#if defined(__PIC__)
            uint32_t scratch;
            __asm__ __volatile__
            (
                ...
                "jne 1b\n\t"
                "movl %[scratch], %%ebx\n\t"
#if !defined(HBOOST_ATOMIC_DETAIL_NO_ASM_CONSTRAINT_ALTERNATIVES)
                : [scratch] "=m,m" (scratch)
...
#endif // defined(__PIC__)
#endif // !defined(HBOOST_ATOMIC_DETAIL_NO_ASM_IMPLIED_ZERO_DISPLACEMENTS)
        }
    }
...
#elif !defined(HBOOST_ATOMIC_DETAIL_NO_ASM_IMPLIED_ZERO_DISPLACEMENTS)
#if defined(__PIC__)
        uint32_t scratch;
        __asm__ __volatile__
        (
            ...
            :
            : HBOOST_ATOMIC_DETAIL_ASM_CLOBBER_CC_COMMA "ecx", "memory"
        );
        return v;
#else // defined(__PIC__)
        __asm__ __volatile__
...
#endif // defined(HBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B)
...
struct gcc_dcas_x86_64
{
    ...
    static HBOOST_FORCEINLINE void store(storage_type volatile& storage, storage_type v, memory_order) HBOOST_NOEXCEPT
    {
        ...
        (
            ...
            : HBOOST_ATOMIC_DETAIL_ASM_CLOBBER_CC_COMMA "rax", "rdx", "memory"
        );
#else // !defined(HBOOST_ATOMIC_DETAIL_NO_ASM_IMPLIED_ZERO_DISPLACEMENTS)
        __asm__ __volatile__
        (
    ...
    static HBOOST_FORCEINLINE storage_type load(storage_type const volatile& storage, memory_order) HBOOST_NOEXCEPT
    {
...
#elif defined(HBOOST_ATOMIC_DETAIL_NO_ASM_RAX_RDX_PAIRS)
        ...
        (
            ...
            : [value] "=o" (value)
            : [storage] "m" (storage)
            : HBOOST_ATOMIC_DETAIL_ASM_CLOBBER_CC_COMMA "memory", "rax", "rdx"
        );
#else // !defined(HBOOST_ATOMIC_DETAIL_NO_ASM_IMPLIED_ZERO_DISPLACEMENTS)
        __asm__ __volatile__
        (
        ...
        return value;
#else // defined(HBOOST_ATOMIC_DETAIL_NO_ASM_RAX_RDX_PAIRS)
        storage_type value;
...
#endif // HBOOST_ATOMIC_DETAIL_OPS_GCC_X86_DCAS_HPP_INCLUDED_
