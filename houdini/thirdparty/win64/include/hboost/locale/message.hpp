...
//
#ifndef HBOOST_LOCALE_MESSAGE_HPP_INCLUDED
#define HBOOST_LOCALE_MESSAGE_HPP_INCLUDED
...
#include <set>
#include <memory>
#include <hboost/locale/formatting.hpp>
...
namespace hboost {
    namespace locale {
        ...
        template<>
        struct HBOOST_LOCALE_DECL base_message_format<char> : public std::locale::facet 
        {
        ...
        template<>
        struct HBOOST_LOCALE_DECL base_message_format<wchar_t> : public std::locale::facet 
        {
            base_message_format(size_t refs = 0) : std::locale::facet(refs)
            {
            }
        ...
        template<>
        struct HBOOST_LOCALE_DECL base_message_format<char16_t> : public std::locale::facet 
        {
            base_message_format(size_t refs = 0) : std::locale::facet(refs)
            {
            }
        ...
        template<>
        struct HBOOST_LOCALE_DECL base_message_format<char32_t> : public std::locale::facet 
        {
            base_message_format(size_t refs = 0) : std::locale::facet(refs)
            {
            }
