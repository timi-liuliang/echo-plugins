...
//
#ifndef HBOOST_LOCALE_ENCODING_ERRORS_HPP_INCLUDED
#define HBOOST_LOCALE_ENCODING_ERRORS_HPP_INCLUDED
...
namespace hboost {
    namespace locale {
        namespace conv {
            ...
            ///
            class HBOOST_SYMBOL_VISIBLE conversion_error : public std::runtime_error {
            public:
            ...
            ///
            class HBOOST_SYMBOL_VISIBLE invalid_charset_error : public std::runtime_error {
            public:
