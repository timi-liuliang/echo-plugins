...
//
#ifndef HBOOST_LOCALE_BOUNDARY_FACETS_HPP_INCLUDED
#define HBOOST_LOCALE_BOUNDARY_FACETS_HPP_INCLUDED

#include <hboost/locale/config.hpp>
#include <hboost/locale/boundary/types.hpp>
#ifdef HBOOST_MSVC
#  pragma warning(push)
...
namespace hboost {
    ...
    namespace locale {
        ...
        namespace boundary {
            ...
            class HBOOST_LOCALE_DECL boundary_indexing : public std::locale::facet {
            public:
                ///
            ...
            template<>
            class HBOOST_LOCALE_DECL boundary_indexing<char> : public std::locale::facet {
            public:
                boundary_indexing(size_t refs=0) : std::locale::facet(refs)
                {
                }
            ...
            template<>
            class HBOOST_LOCALE_DECL boundary_indexing<wchar_t> : public std::locale::facet {
            public:
                boundary_indexing(size_t refs=0) : std::locale::facet(refs)
                {
                }
            ...
            template<>
            class HBOOST_LOCALE_DECL boundary_indexing<char16_t> : public std::locale::facet {
            public:
                boundary_indexing(size_t refs=0) : std::locale::facet(refs)
                {
                }
            ...
            template<>
            class HBOOST_LOCALE_DECL boundary_indexing<char32_t> : public std::locale::facet {
            public:
                boundary_indexing(size_t refs=0) : std::locale::facet(refs)
                {
                }
