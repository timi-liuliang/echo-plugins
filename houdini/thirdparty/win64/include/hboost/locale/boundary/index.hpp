...
//
#ifndef HBOOST_LOCALE_BOUNDARY_INDEX_HPP_INCLUDED
#define HBOOST_LOCALE_BOUNDARY_INDEX_HPP_INCLUDED

#include <hboost/locale/config.hpp>
#include <hboost/locale/boundary/types.hpp>
#include <hboost/locale/boundary/facets.hpp>
#include <hboost/locale/boundary/segment.hpp>
#include <hboost/locale/boundary/boundary_point.hpp>
    ...
    namespace locale {
        ...
        namespace boundary {
            ...
            namespace details {
                ...
                private:
                    hboost::shared_ptr<index_type> index_;
