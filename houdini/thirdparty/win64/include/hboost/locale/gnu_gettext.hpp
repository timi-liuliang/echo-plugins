...
//
#ifndef HBOOST_LOCLAE_GNU_GETTEXT_HPP
#define HBOOST_LOCLAE_GNU_GETTEXT_HPP

#include <hboost/locale/message.hpp>
...
namespace gnu_gettext {
    ...
    template<>
    HBOOST_LOCALE_DECL message_format<char> *create_messages_facet(messages_info const &info);
    
    template<>
    HBOOST_LOCALE_DECL message_format<wchar_t> *create_messages_facet(messages_info const &info);

    #ifdef HBOOST_LOCALE_ENABLE_CHAR16_T
    template<>
    HBOOST_LOCALE_DECL message_format<char16_t> *create_messages_facet(messages_info const &info);
    #endif
    
    #ifdef HBOOST_LOCALE_ENABLE_CHAR32_T
    template<>
    HBOOST_LOCALE_DECL message_format<char32_t> *create_messages_facet(messages_info const &info);
    #endif
