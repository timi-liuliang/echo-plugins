...
//
#ifndef HBOOST_LOCALE_FORMAT_HPP_INCLUDED
#define HBOOST_LOCALE_FORMAT_HPP_INCLUDED
...
namespace hboost {
    namespace locale {
        ...
        namespace details {
            ...
            class HBOOST_LOCALE_DECL format_parser  {
            public:
        ...
        ///
        /// This class creates a formatted message similar to printf or hboost::format and receives
