...
//
#ifndef HBOOST_LOCALE_UTIL_HPP
#define HBOOST_LOCALE_UTIL_HPP
#include <locale>
#include <typeinfo>
#include <hboost/cstdint.hpp>
#include <hboost/locale/utf.hpp>
#include <hboost/locale/generator.hpp>
...
namespace util {
    ...
    ///
    /// This function installs hboost::locale::info facet into the locale \a in and returns
    ...
    public:
        ...
        {
            HBOOST_ASSERT(typeid(*this)==typeid(base_converter));
    ...
    /// unicode code points
    ///
    HBOOST_LOCALE_DECL std::auto_ptr<base_converter> create_utf8_converter();
    ///
    ...
    ///
    HBOOST_LOCALE_DECL std::auto_ptr<base_converter> create_simple_converter(std::string const &encoding);
    ...
    /// character encodings like ISO-8859-1, koi8-r, windows-1255 and Unicode code points,
    /// 
    /// Throws hboost::locale::conv::invalid_charset_error if the chacater set is not supported or isn't single byte character
    /// set
    HBOOST_LOCALE_DECL
