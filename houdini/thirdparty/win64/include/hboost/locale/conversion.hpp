...
//
#ifndef HBOOST_LOCALE_CONVERTER_HPP_INCLUDED
#define HBOOST_LOCALE_CONVERTER_HPP_INCLUDED
...
namespace hboost {
    namespace locale {
        ...
        class HBOOST_LOCALE_DECL converter: public converter_base, public std::locale::facet {
        public:
        ...
        template<>
        class HBOOST_LOCALE_DECL converter<char> : public converter_base, public std::locale::facet {
        public:
            static std::locale::id id;
        ...
        template<>
        class HBOOST_LOCALE_DECL converter<wchar_t> : public converter_base, public std::locale::facet {
        public:
            static std::locale::id id;
            converter(size_t refs = 0) : std::locale::facet(refs)
            {
        ...
        template<>
        class HBOOST_LOCALE_DECL converter<char16_t> : public converter_base, public std::locale::facet {
        public:
            static std::locale::id id;
            converter(size_t refs = 0) : std::locale::facet(refs)
            {
        ...
        template<>
        class HBOOST_LOCALE_DECL converter<char32_t> : public converter_base, public std::locale::facet {
        public:
            static std::locale::id id;
            converter(size_t refs = 0) : std::locale::facet(refs)
            {
