...
//
#ifndef HBOOST_LOCALE_TIME_ZONE_HPP_INCLUDED
#define HBOOST_LOCALE_TIME_ZONE_HPP_INCLUDED
...
namespace hboost {
    namespace locale {
        ...
        namespace time_zone {
            ...
            ///
            HBOOST_LOCALE_DECL std::string global();
            ///
            /// Set global time zone identifier returning previous one. If empty, system time zone is used
            ///
            HBOOST_LOCALE_DECL std::string global(std::string const &new_tz);
        }
