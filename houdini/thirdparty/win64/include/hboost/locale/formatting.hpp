...
//
#ifndef HBOOST_LOCALE_FORMATTING_HPP_INCLUDED
#define HBOOST_LOCALE_FORMATTING_HPP_INCLUDED
...
namespace hboost {
    namespace locale {
        ...
        ///
        class HBOOST_LOCALE_DECL ios_info {
        public:
        ...
        private:
            ...
            class HBOOST_LOCALE_DECL string_set {
            public:
                string_set(); 
                ~string_set();
