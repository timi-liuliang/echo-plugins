...
//
#ifndef HBOOST_LOCALE_ENCODING_HPP_INCLUDED
#define HBOOST_LOCALE_ENCODING_HPP_INCLUDED

#include <hboost/locale/config.hpp>
#ifdef HBOOST_MSVC
#  pragma warning(push)
#  pragma warning(disable : 4275 4251 4231 4660)
#endif
#include <hboost/locale/info.hpp>
#include <hboost/locale/encoding_errors.hpp>
#include <hboost/locale/encoding_utf.hpp>
    ...
    namespace locale {
        ...
        namespace conv {
                                ...
                                method_type how=default_method)
            {
                ...
                return hboost::locale::conv::between(text,end,to_encoding,from_encoding,how);
            }
            ...
            std::string between(std::string const &text,
                                ...
                                method_type how=default_method)
            {
                return hboost::locale::conv::between(text.c_str(),text.c_str()+text.size(),to_encoding,from_encoding,how);
            }
          
            /// \cond INTERNAL

            template<>
            HBOOST_LOCALE_DECL std::basic_string<char> to_utf(char const *begin,char const *end,std::string const &charset,method_type how);

            template<>
            HBOOST_LOCALE_DECL std::string from_utf(char const *begin,char const *end,std::string const &charset,method_type how);

            template<>
            HBOOST_LOCALE_DECL std::basic_string<wchar_t> to_utf(char const *begin,char const *end,std::string const &charset,method_type how);

            template<>
            HBOOST_LOCALE_DECL std::string from_utf(wchar_t const *begin,wchar_t const *end,std::string const &charset,method_type how);

            #ifdef HBOOST_LOCALE_ENABLE_CHAR16_T
            template<>
            HBOOST_LOCALE_DECL std::basic_string<char16_t> to_utf(char const *begin,char const *end,std::string const &charset,method_type how);

            template<>
            HBOOST_LOCALE_DECL std::string from_utf(char16_t const *begin,char16_t const *end,std::string const &charset,method_type how);
            #endif

            #ifdef HBOOST_LOCALE_ENABLE_CHAR32_T
            template<>
            HBOOST_LOCALE_DECL std::basic_string<char32_t> to_utf(char const *begin,char const *end,std::string const &charset,method_type how);

            template<>
            HBOOST_LOCALE_DECL std::string from_utf(char32_t const *begin,char32_t const *end,std::string const &charset,method_type how);
            #endif
