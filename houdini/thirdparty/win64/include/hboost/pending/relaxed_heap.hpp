...
//           Andrew Lumsdaine
#ifndef HBOOST_RELAXED_HEAP_HEADER
#define HBOOST_RELAXED_HEAP_HEADER
...
#ifdef HBOOST_RELAXED_HEAP_DEBUG
#  include <iostream>
#endif // HBOOST_RELAXED_HEAP_DEBUG
...
private:
  ...
  struct group {
     ...
     *  element). Note that the use of hboost::optional increases the
     ...
     */
    ::hboost::optional<value_type> value;
...
private:
  ...
  {
#if defined(HBOOST_RELAXED_HEAP_DEBUG) && HBOOST_RELAXED_HEAP_DEBUG > 1
   ...
   *  smaller.
   */
  std::vector< ::hboost::optional<value_type> > groups;
...
#endif // HBOOST_RELAXED_HEAP_HEADER
