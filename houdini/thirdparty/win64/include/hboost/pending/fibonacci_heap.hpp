...
#ifndef HBOOST_FIBONACCI_HEAP_HPP
#define HBOOST_FIBONACCI_HEAP_HPP
...
{
  typedef typename hboost::property_traits<ID>::value_type size_type;
...
#if defined(HBOOST_MSVC) || defined(__ICL) // need a new macro?
...
#endif // HBOOST_FIBONACCI_HEAP_HPP
