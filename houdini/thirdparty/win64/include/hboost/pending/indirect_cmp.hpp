...
#ifndef HBOOST_INDIRECT_CMP_HPP
#define HBOOST_INDIRECT_CMP_HPP
...
namespace hboost {
  ...
  class indirect_cmp {
  public:
    typedef typename hboost::property_traits<ReadablePropertyMap>::value_type T;
    typedef typename hboost::property_traits<ReadablePropertyMap>::key_type K;
