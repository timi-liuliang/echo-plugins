...
#  endif
#  if !(defined(_HAS_MEMBER_TEMPLATES_REBIND) && (_HAS_MEMBER_TEMPLATES_REBIND+0 > 0)) && !(defined(_MSC_VER) && (_MSC_VER > 1300)) && defined(HBOOST_MSVC)
...
// and no <slist> at all
#else
#  define HBOOST_MSVC_STD_ITERATOR 1
...
#  define HBOOST_STD_EXTENSION_NAMESPACE stdext
#endif
...
#if !_HAS_EXCEPTIONS && ((defined(HBOOST_MSVC) && HBOOST_MSVC >= 1400) || (defined(__clang__) && defined(_MSC_VER)))
#include <exception>
#endif
#include <typeinfo>
...
#if ((!defined(_HAS_TR1_IMPORTS) || (_HAS_TR1_IMPORTS+0 == 0)) && !defined(HBOOST_NO_CXX11_HDR_TUPLE)) \
...
#if defined(HBOOST_INTEL) && (HBOOST_INTEL <= 1400)
...
#ifdef _CPPLIB_VER
#  define HBOOST_DINKUMWARE_STDLIB _CPPLIB_VER
#else
#  define HBOOST_DINKUMWARE_STDLIB 1
#endif

#ifdef _CPPLIB_VER
#  define HBOOST_STDLIB "Dinkumware standard library version " HBOOST_STRINGIZE(_CPPLIB_VER)
#else
#  define HBOOST_STDLIB "Dinkumware standard library version 1.x"
#endif
