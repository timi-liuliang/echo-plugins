...
//
#ifndef _RWSTD_VER
#  define HBOOST_RWSTD_VER 0x010000
#elif _RWSTD_VER < 0x010000
#  define HBOOST_RWSTD_VER (_RWSTD_VER << 8)
#else
#  define HBOOST_RWSTD_VER _RWSTD_VER
#endif

#ifndef _RWSTD_VER
#  define HBOOST_STDLIB "Rogue Wave standard library version (Unknown version)"
#elif _RWSTD_VER < 0x04010200
 #  define HBOOST_STDLIB "Rogue Wave standard library version " HBOOST_STRINGIZE(_RWSTD_VER)
#else
#  ifdef _RWSTD_VER_STR
#    define HBOOST_STDLIB "Apache STDCXX standard library version " _RWSTD_VER_STR
#  else
#    define HBOOST_STDLIB "Apache STDCXX standard library version " HBOOST_STRINGIZE(_RWSTD_VER)
#  endif
#endif
...
// template do:
//
#if HBOOST_RWSTD_VER < 0x020200
#  define HBOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
#endif

// Sun CC 5.5 patch 113817-07 adds long long specialization, but does not change the
// library version number (http://sunsolve6.sun.com/search/document.do?assetkey=1-21-113817):
#if HBOOST_RWSTD_VER <= 0x020101 && (!defined(__SUNPRO_CC) || (__SUNPRO_CC < 0x550))
...
//
#if defined(_RWSTD_NO_SIMPLE_DEFAULT_TEMPLATES) || defined(RWSTD_NO_SIMPLE_DEFAULT_TEMPLATES) || (HBOOST_RWSTD_VER < 0x020000)
#  define HBOOST_NO_STD_ITERATOR
#endif
...
//
#if (HBOOST_RWSTD_VER < 0x020000)
#  define HBOOST_NO_AUTO_PTR
...
//
#if defined(_RWSTD_NO_TEMPLATE_ON_RETURN_TYPE) && !defined(HBOOST_NO_STD_LOCALE)
...
//
#if (HBOOST_RWSTD_VER < 0x020000) || defined(_RWSTD_NO_CLASS_PARTIAL_SPEC)
    #define HBOOST_NO_STD_DISTANCE
#endif
...
// OutputIterators:
//
#if HBOOST_RWSTD_VER < 0x020100
#  define HBOOST_NO_STD_OUTPUT_ITERATOR_ASSIGN
#endif

//
// Disable HBOOST_HAS_LONG_LONG when the library has no support for it.
//
#if !defined(_RWSTD_LONG_LONG) && defined(HBOOST_HAS_LONG_LONG)
...
//
#if defined(__HP_aCC) && (HBOOST_RWSTD_VER == 0x02020100)
