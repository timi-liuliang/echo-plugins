...
#     define HBOOST_NO_LIMITS
// Note: <hboost/limits.hpp> will provide compile-time constants
#     undef HBOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#define HBOOST_STDLIB "SGI standard library"