...
#  elif !defined(HBOOST_DISABLE_THREADS)
      // threads supported from gcc-3.3 onwards:
#     define HBOOST_HAS_THREADS
#     define HBOOST_HAS_PTHREADS
#  endif
#elif defined(__HP_aCC) && !defined(HBOOST_DISABLE_THREADS)
#  define HBOOST_HAS_PTHREADS
#endif
