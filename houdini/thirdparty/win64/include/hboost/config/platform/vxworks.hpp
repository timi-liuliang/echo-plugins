...
// --------------------------------
#define HBOOST_PLATFORM "vxWorks"
...
//#define HBOOST_NO_DEDUCED_TYPENAME // Commented this out, boost's test gives an errorneous result!
