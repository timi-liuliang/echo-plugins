...
#define HBOOST_PLATFORM "Symbian"
#define HBOOST_SYMBIAN 1


#if defined(__S60_3X__)
// Open C / C++ plugin was introdused in this SDK, earlier versions don't have CRT / STL
#  define HBOOST_S60_3rd_EDITION_FP2_OR_LATER_SDK
...
#  endif
#  ifndef HBOOST_POSIX_API
#    define HBOOST_POSIX_API
#  endif
// endianess support
...
#  endif
// Known limitations
#  define HBOOST_ASIO_DISABLE_SERIAL_PORT
...
#if defined(__WINSCW__) && !defined(HBOOST_DISABLE_WIN32)
#  define HBOOST_DISABLE_WIN32 // winscw defines WIN32 macro
#endif
