...
#ifdef __FreeBSD__
#define HBOOST_PLATFORM "FreeBSD " HBOOST_STRINGIZE(__FreeBSD__)
#elif defined(__NetBSD__)
#define HBOOST_PLATFORM "NetBSD " HBOOST_STRINGIZE(__NetBSD__)
#elif defined(__OpenBSD__)
#define HBOOST_PLATFORM "OpenBSD " HBOOST_STRINGIZE(__OpenBSD__)
#elif defined(__DragonFly__)
#define HBOOST_PLATFORM "DragonFly " HBOOST_STRINGIZE(__DragonFly__)
#endif
...
#  define HBOOST_NO_CTYPE_FUNCTIONS
#endif
