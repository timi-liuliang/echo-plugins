...
//
// Define HBOOST_GCC so we know this is "real" GCC and not some pretender:
//
#define HBOOST_GCC_VERSION (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#if !defined(__CUDACC__)
#define HBOOST_GCC HBOOST_GCC_VERSION
#endif

#if defined(__GXX_EXPERIMENTAL_CXX0X__) || (__cplusplus >= 201103L)
#  define HBOOST_GCC_CXX11
#endif
...
#if HBOOST_GCC_VERSION >= 30400
#define HBOOST_HAS_PRAGMA_ONCE
#endif

#if HBOOST_GCC_VERSION < 40400
...
#if !defined(__EXCEPTIONS) && !defined(HBOOST_NO_EXCEPTIONS)
...
#    define HBOOST_SYMBOL_EXPORT __attribute__((__dllexport__))
#    define HBOOST_SYMBOL_IMPORT __attribute__((__dllimport__))
#  else
#    define HBOOST_SYMBOL_EXPORT __attribute__((__visibility__("default")))
#    define HBOOST_SYMBOL_IMPORT
#  endif
#  define HBOOST_SYMBOL_VISIBLE __attribute__((__visibility__("default")))
#else
...
// See https://svn.boost.org/trac/hboost/ticket/8048
//     https://svn.boost.org/trac/hboost/ticket/11852
...
#if defined(__SIZEOF_INT128__) && !defined(HBOOST_NVCC_CXX03)
...
// See https://svn.boost.org/trac/hboost/ticket/11852
//
#ifdef __cplusplus
#include <cstddef>
#else
#include <stddef.h>
#endif
#if defined(_GLIBCXX_USE_FLOAT128) && !defined(__STRICT_ANSI__) && !defined(HBOOST_NVCC_CXX03)
# define HBOOST_HAS_FLOAT128
#endif

// C++0x features in 4.3.n and later
//
#if (HBOOST_GCC_VERSION >= 40300) && defined(HBOOST_GCC_CXX11)
...
//
#if (HBOOST_GCC_VERSION < 40400) || !defined(HBOOST_GCC_CXX11)
...
#if HBOOST_GCC_VERSION < 40500
#  define HBOOST_NO_SFINAE_EXPR
#endif

// GCC 4.5 forbids declaration of defaulted functions in private or protected sections
#if __GNUC__ < 4 || (__GNUC__ == 4 && __GNUC_MINOR__ == 5) || !defined(HBOOST_GCC_CXX11)
#  define HBOOST_NO_CXX11_NON_PUBLIC_DEFAULTED_FUNCTIONS
#endif

// C++0x features in 4.5.0 and later
//
#if (HBOOST_GCC_VERSION < 40500) || !defined(HBOOST_GCC_CXX11)
...
//
#if (HBOOST_GCC_VERSION < 40501) || !defined(HBOOST_GCC_CXX11)
// scoped enums have a serious bug in 4.4.0, so define HBOOST_NO_CXX11_SCOPED_ENUMS before 4.5.1
...
//
#if (HBOOST_GCC_VERSION < 40600) || !defined(HBOOST_GCC_CXX11)
...
//
#if (HBOOST_GCC_VERSION < 40700) || !defined(HBOOST_GCC_CXX11)
...
//
#if (HBOOST_GCC_VERSION < 40800) || !defined(HBOOST_GCC_CXX11)
#  define HBOOST_NO_CXX11_ALIGNAS
#endif

// C++0x features in 4.8.1 and later
//
#if (HBOOST_GCC_VERSION < 40801) || !defined(HBOOST_GCC_CXX11)
...
//
#if (HBOOST_GCC_VERSION < 40900) || (__cplusplus < 201300)
...
#  if !((HBOOST_GCC_VERSION >= 40801) && (HBOOST_GCC_VERSION < 40900) && defined(HBOOST_GCC_CXX11))
...
// Unused attribute:
#if __GNUC__ >= 4
#  define HBOOST_ATTRIBUTE_UNUSED __attribute__((__unused__))
#endif
//
// __builtin_unreachable:
#if HBOOST_GCC_VERSION >= 40800
#define HBOOST_UNREACHABLE_RETURN(x) __builtin_unreachable();
#endif

#ifndef HBOOST_COMPILER
#  define HBOOST_COMPILER "GNU C++ version " __VERSION__
#endif

// ConceptGCC compiler:
//   http://www.generic-programming.org/software/ConceptGCC/
#ifdef __GXX_CONCEPTS__
#  define HBOOST_HAS_CONCEPTS
#  define HBOOST_COMPILER "ConceptGCC version " __VERSION__
#endif

// versions check:
// we don't know gcc prior to version 3.30:
#if (HBOOST_GCC_VERSION< 30300)
#  error "Compiler not configured - please reconfigure"
#endif
//
// last known and checked version is 4.9:
#if (HBOOST_GCC_VERSION > 40900)
