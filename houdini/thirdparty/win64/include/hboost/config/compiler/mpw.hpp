...
#   if    defined(__SC__)
#     define HBOOST_COMPILER "MPW SCpp version " HBOOST_STRINGIZE(__SC__)
#   elif defined(__MRC__)
#     define HBOOST_COMPILER "MPW MrCpp version " HBOOST_STRINGIZE(__MRC__)
#   else
...
// MPW 8.90:
//
#if (MPW_CPLUS <= 0x890) || !defined(HBOOST_STRICT_CONFIG)
...
#  define HBOOST_NO_STD_ALLOCATOR /* actually a bug with const reference overloading */
