...
#if (__EDG_VERSION__ <= 241) && !defined(HBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP)
#   define HBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP
#endif

#if (__EDG_VERSION__ <= 244) && !defined(HBOOST_NO_TEMPLATE_TEMPLATES)
#   define HBOOST_NO_TEMPLATE_TEMPLATES
#endif

#if (__EDG_VERSION__ < 300) && !defined(HBOOST_NO_IS_ABSTRACT)
#   define HBOOST_NO_IS_ABSTRACT
#endif

#if (__EDG_VERSION__ <= 303) && !defined(HBOOST_FUNCTION_SCOPE_USING_DECLARATION_BREAKS_ADL)
#   define HBOOST_FUNCTION_SCOPE_USING_DECLARATION_BREAKS_ADL
#endif

// See also kai.hpp which checks a Kai-specific symbol for EH
# if !defined(__KCC) && !defined(__EXCEPTIONS) && !defined(HBOOST_NO_EXCEPTIONS)
