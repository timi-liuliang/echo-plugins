...
#if !__has_feature(cxx_exceptions) && !defined(HBOOST_NO_EXCEPTIONS)
#  define HBOOST_NO_EXCEPTIONS
#endif

#if !__has_feature(cxx_rtti) && !defined(HBOOST_NO_RTTI)
#  define HBOOST_NO_RTTI
#endif

#if !__has_feature(cxx_rtti) && !defined(HBOOST_NO_TYPEID)
...
// See https://svn.boost.org/trac/hboost/ticket/10418
...
#if defined(__SIZEOF_INT128__) && !defined(HBOOST_NVCC_CXX03) && !defined(_MSC_VER)
...
//
// The HBOOST_FALLTHROUGH macro can be used to annotate implicit fall-through
// between switch labels.
//
#if __cplusplus >= 201103L && defined(__has_warning)
#  if __has_feature(cxx_attributes) && __has_warning("-Wimplicit-fallthrough")
#    define HBOOST_FALLTHROUGH [[clang::fallthrough]]
#  endif
#endif
...
#  define HBOOST_COMPILER "Clang version " __clang_version__
#endif

// Macro used to identify the Clang compiler.
#define HBOOST_CLANG 1
