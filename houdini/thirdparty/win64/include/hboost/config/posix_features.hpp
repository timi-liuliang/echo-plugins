...
#  if defined(HBOOST_HAS_UNISTD_H)
#     include <unistd.h>
...
#     if defined(_POSIX_THREADS) && (_POSIX_THREADS+0 >= 0) && !defined(HBOOST_HAS_WINTHREADS) && !defined(HBOOST_HAS_MPTASKS)
#        define HBOOST_HAS_PTHREADS
#     endif

      // HBOOST_HAS_NANOSLEEP:
...
#     endif
      ...
      // HBOOST_HAS_GETTIMEOFDAY:
      // HBOOST_HAS_PTHREAD_MUTEXATTR_SETTYPE:
