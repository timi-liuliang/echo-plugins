 ...
 *
 * \brief  This header contains optimized SSE implementation of \c hboost::uuid operations.
 */

#ifndef HBOOST_UUID_DETAIL_UUID_X86_HPP_INCLUDED_
#define HBOOST_UUID_DETAIL_UUID_X86_HPP_INCLUDED_
...
#include <smmintrin.h>
#elif defined(HBOOST_UUID_USE_SSE3)
#include <pmmintrin.h>
#else
#include <emmintrin.h>
#endif

#if defined(HBOOST_MSVC) && defined(_M_X64) && !defined(HBOOST_UUID_USE_SSE3) && (HBOOST_MSVC < 1900 /* Fixed in Visual Studio 2015 */ )
...
//
// https://svn.boost.org/trac/hboost/ticket/8509#comment:3
// https://connect.microsoft.com/VisualStudio/feedbackdetail/view/981648#tabs
#define HBOOST_UUID_DETAIL_MSVC_BUG981648
#if HBOOST_MSVC >= 1600
...
HBOOST_FORCEINLINE __m128i load_unaligned_si128(const uint8_t* p) HBOOST_NOEXCEPT
{
#if defined(HBOOST_UUID_USE_SSE3)
    return _mm_lddqu_si128(reinterpret_cast< const __m128i* >(p));
#elif !defined(HBOOST_UUID_DETAIL_MSVC_BUG981648)
    return _mm_loadu_si128(reinterpret_cast< const __m128i* >(p));
#elif HBOOST_MSVC >= 1600
...
inline bool uuid::is_nil() const HBOOST_NOEXCEPT
{
...
inline void uuid::swap(uuid& rhs) HBOOST_NOEXCEPT
{
...
#endif // HBOOST_UUID_DETAIL_UUID_X86_HPP_INCLUDED_
