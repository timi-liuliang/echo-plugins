...
#ifndef HBOOST_UUID_STRING_GENERATOR_HPP
#define HBOOST_UUID_STRING_GENERATOR_HPP
...
private:
    ...
    void throw_invalid() const {
        HBOOST_THROW_EXCEPTION(std::runtime_error("invalid uuid string"));
    }
};

}} // namespace hboost::uuids

#endif //HBOOST_UUID_STRING_GENERATOR_HPP
