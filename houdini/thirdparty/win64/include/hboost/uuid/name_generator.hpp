...
#ifndef HBOOST_UUID_NAME_GENERATOR_HPP
#define HBOOST_UUID_NAME_GENERATOR_HPP
...
private:
    ...
    void process_characters(char_type const*const characters, size_t count) {
        HBOOST_ASSERT(sizeof(uint32_t) >= sizeof(char_type));
...
#endif // HBOOST_UUID_NAME_GENERATOR_HPP
