...
#ifndef HBOOST_UUID_RANDOM_GENERATOR_HPP
#define HBOOST_UUID_RANDOM_GENERATOR_HPP

#include <hboost/uuid/uuid.hpp>
#include <hboost/uuid/seed_rng.hpp>
...
public:
    ...
    uuid operator()()
    {
        ...
        for (uuid::iterator it=u.begin(); it!=u.end(); ++it, ++i) {
			...
			// static_cast gets rid of warnings of converting unsigned long to hboost::uint8_t
...
#endif //HBOOST_UUID_RANDOM_GENERATOR_HPP
