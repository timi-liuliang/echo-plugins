...
#ifndef HBOOST_MP_EXPLICIT_CONVERTIBLE_HPP
#define HBOOST_MP_EXPLICIT_CONVERTIBLE_HPP
...
struct is_explicitly_convertible_imp
{
   ...
   typedef hboost::integral_constant<bool,value> type;
#else
   typedef typename has_generic_interconversion<S, T>::type gen_type;
   typedef mpl::bool_<hboost::is_convertible<S, T>::value || gen_type::value> type;
#endif
};
