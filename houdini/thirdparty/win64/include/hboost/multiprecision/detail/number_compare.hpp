...
#ifndef HBOOST_MP_COMPARE_HPP
#define HBOOST_MP_COMPARE_HPP
...
{
   typename hboost::multiprecision::detail::number_from_backend<T, U>::type t(b);
   return eval_eq(a, t.backend());
}
template <class T, class U>
inline bool eval_eq_imp(const T& a, const U& b, const mpl::false_&)
{
   typename hboost::multiprecision::detail::number_from_backend<U, T>::type t(a);
   return eval_eq(t.backend(), b);
}
template <class T, class U>
inline bool eval_eq(const T& a, const U& b)
{
   typedef mpl::bool_<hboost::multiprecision::detail::is_first_backend<T, U>::value> tag_type;
...
inline HBOOST_CONSTEXPR typename hboost::enable_if_c<number_category<Backend>::value != number_kind_floating_point, bool>::type is_unordered_value(const number<Backend, ExpressionTemplates>&)
{
   return false;
}
template <class Backend, expression_template_option ExpressionTemplates>
...
HBOOST_CONSTEXPR
#endif
 typename hboost::enable_if_c<number_category<Backend>::value == number_kind_floating_point, bool>::type is_unordered_value(const number<Backend, ExpressionTemplates>& a)
{
...
inline HBOOST_CONSTEXPR typename hboost::enable_if_c<number_category<Arithmetic>::value != number_kind_floating_point, bool>::type is_unordered_value(const Arithmetic&)
{
   return false;
}
template <class Arithmetic>
inline HBOOST_CONSTEXPR typename hboost::enable_if_c<number_category<Arithmetic>::value == number_kind_floating_point, bool>::type is_unordered_value(const Arithmetic& a)
{
   return (hboost::math::isnan)(a);
}

template <class T, class U>
inline HBOOST_CONSTEXPR bool is_unordered_comparison(const T& a, const U& b)
{
