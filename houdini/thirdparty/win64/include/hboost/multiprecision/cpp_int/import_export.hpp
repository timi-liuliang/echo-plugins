...
#ifndef HBOOST_MP_CPP_INT_IMPORT_EXPORT_HPP
#define HBOOST_MP_CPP_INT_IMPORT_EXPORT_HPP
   ...
   namespace multiprecision {
      ...
      namespace detail {
               ...
               number<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>, ExpressionTemplates>& val, Iterator i, Iterator j, unsigned chunk_size = 0, bool msv_first = true)
         {
            ...
            typedef typename hboost::make_unsigned<value_type>::type           unsigned_value_type;
            typedef typename std::iterator_traits<Iterator>::difference_type  difference_type;
            typedef typename hboost::make_unsigned<difference_type>::type      size_type;
         ...
         inline typename hboost::disable_if_c<hboost::multiprecision::backends::is_trivial_cpp_int<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator> >::value, number<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>, ExpressionTemplates>&>::type
            import_bits_fast(
         ...
         template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType, cpp_int_check_type Checked, class Allocator, expression_template_option ExpressionTemplates, class T>
         inline typename hboost::enable_if_c<hboost::multiprecision::backends::is_trivial_cpp_int<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator> >::value, number<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>, ExpressionTemplates>&>::type
            import_bits_fast(
               number<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>, ExpressionTemplates>& val, T* i, T* j, unsigned chunk_size = 0)
         {
            cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>& result = val.backend();
      ...
      namespace detail {
         ...
         hboost::uintmax_t extract_bits(const Backend& val, unsigned location, unsigned count, const mpl::false_& tag)
         {
            unsigned limb = location / (sizeof(limb_type) * CHAR_BIT);
            unsigned shift = location % (sizeof(limb_type) * CHAR_BIT);
            hboost::uintmax_t result = 0;
            hboost::uintmax_t mask = count == std::numeric_limits<hboost::uintmax_t>::digits ? ~static_cast<hboost::uintmax_t>(0) : (static_cast<hboost::uintmax_t>(1u) << count) - 1;
         ...
         template <class Backend>
         inline hboost::uintmax_t extract_bits(const Backend& val, unsigned location, unsigned count, const mpl::true_&)
         {
            hboost::uintmax_t result = *val.limbs();
            hboost::uintmax_t mask = count == std::numeric_limits<hboost::uintmax_t>::digits ? ~static_cast<hboost::uintmax_t>(0) : (static_cast<hboost::uintmax_t>(1u) << count) - 1;
...
#endif // HBOOST_MP_CPP_INT_IMPORT_EXPORT_HPP
