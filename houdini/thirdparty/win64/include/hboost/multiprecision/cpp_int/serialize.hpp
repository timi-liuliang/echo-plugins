...
#ifndef HBOOST_MP_CPP_INT_SERIALIZE_HPP
#define HBOOST_MP_CPP_INT_SERIALIZE_HPP
...
namespace mp = hboost::multiprecision;

namespace cpp_int_detail{

using namespace hboost::multiprecision;
using namespace hboost::multiprecision::backends;

template <class T>
struct is_binary_archive : public mpl::false_ {};
template <>
struct is_binary_archive<hboost::archive::binary_oarchive> : public mpl::true_ {};
template <>
struct is_binary_archive<hboost::archive::binary_iarchive> : public mpl::true_ {};
...
#endif // HBOOST_MP_CPP_INT_SERIALIZE_HPP
