...
#ifndef HBOOST_RANDOM_LOGNORMAL_DISTRIBUTION_HPP
#define HBOOST_RANDOM_LOGNORMAL_DISTRIBUTION_HPP

#include <hboost/config/no_tr1/cmath.hpp>      // std::exp, std::sqrt
#include <cassert>
#include <iosfwd>
#include <istream>
 ...
 * hboost::lognormal_distribution.  A backwards compatible
 * version is provided in namespace hboost.
 * @endxmlwarning
 */
...
public:
    ...
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, lognormal_distribution, ld)
    {
        os << ld._normal;
        return os;
    }
    ...
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, lognormal_distribution, ld)
    {
        is >> ld._normal;
        return is;
    }
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(lognormal_distribution, lhs, rhs)
     ...
     * sequences of values given equal generators.
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(lognormal_distribution)
...
#endif // HBOOST_RANDOM_LOGNORMAL_DISTRIBUTION_HPP
