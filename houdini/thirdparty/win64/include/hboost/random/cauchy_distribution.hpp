...
#ifndef HBOOST_RANDOM_CAUCHY_DISTRIBUTION_HPP
#define HBOOST_RANDOM_CAUCHY_DISTRIBUTION_HPP
...
public:
    ...
    {
        // Can we have a hboost::mathconst please?
     ...
     */
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, cauchy_distribution, cd)
    {
     ...
     */
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, cauchy_distribution, cd)
    {
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(cauchy_distribution, lhs, rhs)
    { return lhs._median == rhs._median && lhs._sigma == rhs._sigma; }
     ...
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(cauchy_distribution)
...
#endif // HBOOST_RANDOM_CAUCHY_DISTRIBUTION_HPP
