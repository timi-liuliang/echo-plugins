...
#ifndef HBOOST_RANDOM_BINOMIAL_DISTRIBUTION_HPP_INCLUDED
#define HBOOST_RANDOM_BINOMIAL_DISTRIBUTION_HPP_INCLUDED
...
public:
    ...
    IntType max HBOOST_PREVENT_MACRO_SUBSTITUTION() const { return _t; }
