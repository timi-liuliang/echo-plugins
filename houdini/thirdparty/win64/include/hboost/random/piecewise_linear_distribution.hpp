...
#ifndef HBOOST_RANDOM_PIECEWISE_LINEAR_DISTRIBUTION_HPP_INCLUDED
#define HBOOST_RANDOM_PIECEWISE_LINEAR_DISTRIBUTION_HPP_INCLUDED
...
public:
     ...
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(piecewise_linear_distribution)
