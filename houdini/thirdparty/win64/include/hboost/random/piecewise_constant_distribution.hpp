...
#ifndef HBOOST_RANDOM_PIECEWISE_CONSTANT_DISTRIBUTION_HPP_INCLUDED
#define HBOOST_RANDOM_PIECEWISE_CONSTANT_DISTRIBUTION_HPP_INCLUDED
...
public:
    ...
    public:
        ...
        param_type(const IntervalRange& intervals_arg,
          ...
          : _intervals(hboost::begin(intervals_arg), hboost::end(intervals_arg)),
            _weights(hboost::begin(weights_arg), hboost::end(weights_arg))
        {
            if(_intervals.size() < 2) {
                _intervals.clear();
                _intervals.push_back(RealType(0));
    ...
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(
    ...
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(
     ...
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(piecewise_constant_distribution)
