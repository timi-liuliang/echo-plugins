...
#ifndef HBOOST_RANDOM_GAMMA_DISTRIBUTION_HPP
#define HBOOST_RANDOM_GAMMA_DISTRIBUTION_HPP
...
public:
    ...
    {
        HBOOST_ASSERT(_alpha > result_type(0));
        HBOOST_ASSERT(_beta > result_type(0));
        init();
    }
...
#endif // HBOOST_RANDOM_GAMMA_DISTRIBUTION_HPP
