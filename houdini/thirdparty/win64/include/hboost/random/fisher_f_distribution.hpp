...
#ifndef HBOOST_RANDOM_FISHER_F_DISTRIBUTION_HPP
#define HBOOST_RANDOM_FISHER_F_DISTRIBUTION_HPP
...
public:
    ...
    RealType min HBOOST_PREVENT_MACRO_SUBSTITUTION () const { return 0; }
    ...
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, fisher_f_distribution, fd)
    {
        os << fd.param();
        return os;
    }
    ...
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, fisher_f_distribution, fd)
    {
        param_type parm;
        if(is >> parm) {
            fd.param(parm);
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(fisher_f_distribution, lhs, rhs)
     ...
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(fisher_f_distribution)
