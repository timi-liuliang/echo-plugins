...
#ifndef HBOOST_RANDOM_LAPLACE_DISTRIBUTION_HPP
#define HBOOST_RANDOM_LAPLACE_DISTRIBUTION_HPP
...
public:
    ...
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, laplace_distribution, wd)
    {
        os << wd.param();
        return os;
    }
    ...
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, laplace_distribution, wd)
    {
        param_type parm;
        if(is >> parm) {
            wd.param(parm);
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(laplace_distribution, lhs, rhs)
    { return lhs._mean == rhs._mean && lhs._beta == rhs._beta; }
     ...
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(laplace_distribution)
...
#endif // HBOOST_RANDOM_LAPLACE_DISTRIBUTION_HPP
