...
#ifndef HBOOST_RANDOM_TRIANGLE_DISTRIBUTION_HPP
#define HBOOST_RANDOM_TRIANGLE_DISTRIBUTION_HPP
...
public:
    ...
    RealType min HBOOST_PREVENT_MACRO_SUBSTITUTION () const { return _a; }
    /** Returns the largest value that the distribution can produce. */
    RealType max HBOOST_PREVENT_MACRO_SUBSTITUTION () const { return _c; }
    ...
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, triangle_distribution, td)
    {
        os << td.param();
        return os;
    }
    ...
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, triangle_distribution, td)
    {
        param_type parm;
        if(is >> parm) {
            td.param(parm);
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(triangle_distribution, lhs, rhs)
    { return lhs._a == rhs._a && lhs._b == rhs._b && lhs._c == rhs._c; }
     ...
     * sequences of values given equal generators.
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(triangle_distribution)
...
#endif // HBOOST_RANDOM_TRIANGLE_DISTRIBUTION_HPP
