...
#ifndef HBOOST_RANDOM_EXPONENTIAL_DISTRIBUTION_HPP
#define HBOOST_RANDOM_EXPONENTIAL_DISTRIBUTION_HPP
...
public:
    ...
    public:
        ...
        param_type(RealType lambda_arg = RealType(1.0))
          : _lambda(lambda_arg) { HBOOST_ASSERT(_lambda > RealType(0)); }
    ...
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, exponential_distribution, ed)
    {
        os << ed._lambda;
        return os;
    }
    ...
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, exponential_distribution, ed)
    {
        is >> ed._lambda;
        return is;
    }
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(exponential_distribution, lhs, rhs)
    { return lhs._lambda == rhs._lambda; }
     ...
     * sequences of values given equal generators.
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(exponential_distribution)
...
#endif // HBOOST_RANDOM_EXPONENTIAL_DISTRIBUTION_HPP
