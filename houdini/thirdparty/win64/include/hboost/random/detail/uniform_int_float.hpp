...
#ifndef HBOOST_RANDOM_DETAIL_UNIFORM_INT_FLOAT_HPP
#define HBOOST_RANDOM_DETAIL_UNIFORM_INT_FLOAT_HPP
...
public:
    ...
    typedef typename hboost::uint_t<
        (std::numeric_limits<hboost::uintmax_t>::digits <
...
#endif // HBOOST_RANDOM_DETAIL_UNIFORM_INT_FLOAT_HPP
