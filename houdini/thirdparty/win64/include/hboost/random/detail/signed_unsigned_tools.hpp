...
#ifndef HBOOST_RANDOM_DETAIL_SIGNED_UNSIGNED_TOOLS
#define HBOOST_RANDOM_DETAIL_SIGNED_UNSIGNED_TOOLS
...
{
  typedef typename hboost::random::traits::make_unsigned_or_unbounded<T>::type result_type;
...
#endif // HBOOST_RANDOM_DETAIL_SIGNED_UNSIGNED_TOOLS
