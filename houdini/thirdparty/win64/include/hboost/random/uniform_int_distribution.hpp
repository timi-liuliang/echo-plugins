...
#ifndef HBOOST_RANDOM_UNIFORM_INT_DISTRIBUTION_HPP
#define HBOOST_RANDOM_UNIFORM_INT_DISTRIBUTION_HPP
...
#include <hboost/random/detail/uniform_int_float.hpp>
#include <hboost/random/detail/signed_unsigned_tools.hpp>
#include <hboost/random/traits.hpp>
#include <hboost/mpl/bool.hpp>
#ifdef HBOOST_NO_CXX11_EXPLICIT_CONVERSION_OPERATORS
...
T generate_uniform_int(
    ...
    hboost::mpl::true_ /** is_integral<Engine::result_type> */)
{
    typedef T result_type;
    typedef typename hboost::random::traits::make_unsigned_or_unbounded<T>::type range_type;
    typedef typename Engine::result_type base_result;
    // ranges are always unsigned or unbounded
    typedef typename hboost::random::traits::make_unsigned_or_unbounded<base_result>::type base_unsigned;
...
inline T generate_uniform_int(
    Engine& eng, T min_value, T max_value,
    hboost::mpl::false_ /** is_integral<Engine::result_type> */)
{
    uniform_int_float<Engine> wrapper(eng);
    return generate_uniform_int(wrapper, min_value, max_value, hboost::mpl::true_());
}
...
inline T generate_uniform_int(Engine& eng, T min_value, T max_value)
{
    ...
    return generate_uniform_int(eng, min_value, max_value,
        hboost::random::traits::is_integral<base_result>());
}
...
public:
    ...
    public:
        ...
        HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, param_type, parm)
        {
        ...
        HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, param_type, parm)
        {
        ...
        HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(param_type, lhs, rhs)
        { return lhs._min == rhs._min && lhs._max == rhs._max; }

        /** Returns true if the two sets of parameters are different. */
        HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(param_type)
    ...
    /**  Returns the minimum value of the distribution */
    IntType min HBOOST_PREVENT_MACRO_SUBSTITUTION () const { return _min; }
    /**  Returns the maximum value of the distribution */
    IntType max HBOOST_PREVENT_MACRO_SUBSTITUTION () const { return _max; }
    ...
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, uniform_int_distribution, ud)
    {
        os << ud.param();
        return os;
    }
    ...
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, uniform_int_distribution, ud)
    {
        param_type parm;
        if(is >> parm) {
            ud.param(parm);
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(uniform_int_distribution, lhs, rhs)
    { return lhs._min == rhs._min && lhs._max == rhs._max; }
     ...
     * of values given equal generators.
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(uniform_int_distribution)
...
#endif // HBOOST_RANDOM_UNIFORM_INT_HPP
