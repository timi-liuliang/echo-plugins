...
#ifndef HBOOST_RANDOM_STUDENT_T_DISTRIBUTION_HPP
#define HBOOST_RANDOM_STUDENT_T_DISTRIBUTION_HPP
...
public:
    ...
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, student_t_distribution, td)
    {
        os << td.param();
        return os;
    }
    ...
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, student_t_distribution, td)
    {
        param_type parm;
        if(is >> parm) {
            td.param(parm);
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(student_t_distribution, lhs, rhs)
     ...
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(student_t_distribution)
...
#endif // HBOOST_RANDOM_STUDENT_T_DISTRIBUTION_HPP
