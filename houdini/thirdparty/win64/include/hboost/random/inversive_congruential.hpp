...
#ifndef HBOOST_RANDOM_INVERSIVE_CONGRUENTIAL_HPP
#define HBOOST_RANDOM_INVERSIVE_CONGRUENTIAL_HPP
...
public:
    ...
    HBOOST_STATIC_CONSTANT(result_type, multiplier = a);
    HBOOST_STATIC_CONSTANT(result_type, increment = b);
    HBOOST_STATIC_CONSTANT(result_type, modulus = p);
    HBOOST_STATIC_CONSTANT(IntType, default_seed = 1);

    static result_type min HBOOST_PREVENT_MACRO_SUBSTITUTION () { return b == 0 ? 1 : 0; }
    static result_type max HBOOST_PREVENT_MACRO_SUBSTITUTION () { return p-1; }
     ...
     */
    HBOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(inversive_congruential_engine,
                                               IntType, x0)
    { seed(x0); }
     ...
     */
    HBOOST_RANDOM_DETAIL_SEED_SEQ_CONSTRUCTOR(inversive_congruential_engine,
                                             SeedSeq, seq)
    { seed(seq); }
     ...
     */
    HBOOST_RANDOM_DETAIL_ARITHMETIC_SEED(inversive_congruential_engine, IntType, x0)
    {
        ...
        HBOOST_ASSERT(_value >= (min)());
        HBOOST_ASSERT(_value <= (max)());
    }

    /**
     * Seeds an @c inversive_congruential_engine using values from a SeedSeq.
     */
    HBOOST_RANDOM_DETAIL_SEED_SEQ_SEED(inversive_congruential_engine, SeedSeq, seq)
     ...
     */
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, inversive_congruential_engine, x)
    {
        os << x._value;
        return os;
    }
     ...
     */
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, inversive_congruential_engine, x)
    {
        is >> x._value;
        return is;
    }
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(inversive_congruential_engine, x, y)
     ...
     * sequences of outputs.
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(inversive_congruential_engine)
...
#endif // HBOOST_RANDOM_INVERSIVE_CONGRUENTIAL_HPP
