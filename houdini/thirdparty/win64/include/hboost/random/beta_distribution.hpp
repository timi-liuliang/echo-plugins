...
#ifndef HBOOST_RANDOM_BETA_DISTRIBUTION_HPP
#define HBOOST_RANDOM_BETA_DISTRIBUTION_HPP
...
public:
    ...
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, beta_distribution, wd)
    {
        os << wd.param();
        return os;
    }
    ...
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, beta_distribution, wd)
    {
        param_type parm;
        if(is >> parm) {
            wd.param(parm);
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(beta_distribution, lhs, rhs)
    { return lhs._alpha == rhs._alpha && lhs._beta == rhs._beta; }
     ...
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(beta_distribution)
...
#endif // HBOOST_RANDOM_BETA_DISTRIBUTION_HPP
