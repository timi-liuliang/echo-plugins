...
#ifndef HBOOST_RANDOM_NORMAL_DISTRIBUTION_HPP
#define HBOOST_RANDOM_NORMAL_DISTRIBUTION_HPP
...
inline typename hboost::make_unsigned<typename Engine::result_type>::type
generate_one_digit(Engine& eng, std::size_t bits)
{
    typedef typename Engine::result_type base_result;
    typedef typename hboost::make_unsigned<base_result>::type base_unsigned;
...
std::pair<RealType, int> generate_int_float_pair(Engine& eng, hboost::mpl::true_)
{
    typedef typename Engine::result_type base_result;
    typedef typename hboost::make_unsigned<base_result>::type base_unsigned;
...
template<class RealType, std::size_t w, class Engine>
inline std::pair<RealType, int> generate_int_float_pair(Engine& eng, hboost::mpl::false_)
{
...
inline std::pair<RealType, int> generate_int_float_pair(Engine& eng)
{
    ...
    return generate_int_float_pair<RealType, w>(eng,
        hboost::is_integral<base_result>());
}
...
struct unit_normal_distribution
{
    ...
    RealType generate_tail(Engine& eng) {
        hboost::random::exponential_distribution<RealType> exponential;
...
public:
    ...
    {
        HBOOST_ASSERT(_sigma >= RealType(0));
    }
    ...
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, normal_distribution, nd)
    {
    ...
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, normal_distribution, nd)
    {
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(normal_distribution, lhs, rhs)
    {
        return lhs._mean == rhs._mean && lhs._sigma == rhs._sigma;
    }
     ...
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(normal_distribution)
...
#endif // HBOOST_RANDOM_NORMAL_DISTRIBUTION_HPP
