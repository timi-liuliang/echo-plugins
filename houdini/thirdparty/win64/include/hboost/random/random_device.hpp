...
#ifndef HBOOST_RANDOM_RANDOM_DEVICE_HPP
#define HBOOST_RANDOM_RANDOM_DEVICE_HPP

#include <string>
#include <hboost/config.hpp>
#include <hboost/noncopyable.hpp>
#include <hboost/random/detail/auto_link.hpp>
#include <hboost/system/config.hpp> // force autolink to find Boost.System
 ...
 * <b>Performance</b>
 *
 * The test program <a href="\hboost/libs/random/performance/nondet_random_speed.cpp">
...
public:
    ...
    static result_type max HBOOST_PREVENT_MACRO_SUBSTITUTION () { return ~0u; }

    /** Constructs a @c random_device, optionally using the default device. */
    HBOOST_RANDOM_DECL random_device();
    /** 
     ...
     */
    HBOOST_RANDOM_DECL explicit random_device(const std::string& token);
     ...
     * Throws: Nothing.
     */
    HBOOST_RANDOM_DECL double entropy() const;
    /** Returns a random value in the range [min, max]. */
    HBOOST_RANDOM_DECL unsigned int operator()();
...
#endif /* HBOOST_RANDOM_RANDOM_DEVICE_HPP */
