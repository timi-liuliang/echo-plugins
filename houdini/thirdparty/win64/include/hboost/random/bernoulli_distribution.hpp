...
#ifndef HBOOST_RANDOM_BERNOULLI_DISTRIBUTION_HPP
#define HBOOST_RANDOM_BERNOULLI_DISTRIBUTION_HPP
...
public:
    ...
    bool min HBOOST_PREVENT_MACRO_SUBSTITUTION () const
    { return false; }
    /** Returns the largest value that the distribution can produce. */
    bool max HBOOST_PREVENT_MACRO_SUBSTITUTION () const
    { return true; }
     ...
     */
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, bernoulli_distribution, bd)
    {
        os << bd._p;
        return os;
    }
     ...
     */
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, bernoulli_distribution, bd)
    {
        is >> bd._p;
        return is;
    }
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(bernoulli_distribution, lhs, rhs)
    { return lhs._p == rhs._p; }
     ...
     * sequences of values given equal generators.
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(bernoulli_distribution)
...
#endif // HBOOST_RANDOM_BERNOULLI_DISTRIBUTION_HPP
