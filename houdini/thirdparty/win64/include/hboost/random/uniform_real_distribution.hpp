...
#ifndef HBOOST_RANDOM_UNIFORM_REAL_DISTRIBUTION_HPP
#define HBOOST_RANDOM_UNIFORM_REAL_DISTRIBUTION_HPP
    ...
    hboost::mpl::false_  /** is_integral<Engine::result_type> */)
{
    for(;;) {
        ...
        HBOOST_ASSERT(divisor > 0);
        HBOOST_ASSERT(numerator >= 0 && numerator <= divisor);
...
public:
    ...
    /**  Returns the minimum value of the distribution */
    RealType min HBOOST_PREVENT_MACRO_SUBSTITUTION () const { return _min; }
    /**  Returns the maximum value of the distribution */
    RealType max HBOOST_PREVENT_MACRO_SUBSTITUTION () const { return _max; }
    ...
    HBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, uniform_real_distribution, ud)
    {
        os << ud.param();
        return os;
    }
    ...
    HBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, uniform_real_distribution, ud)
    {
        param_type parm;
        if(is >> parm) {
            ud.param(parm);
     ...
     */
    HBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(uniform_real_distribution, lhs, rhs)
    { return lhs._min == rhs._min && lhs._max == rhs._max; }
     ...
     * of values given equal generators.
     */
    HBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(uniform_real_distribution)
