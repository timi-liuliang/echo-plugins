...
#ifndef HBOOST_RANDOM_MERSENNE_TWISTER_HPP
#define HBOOST_RANDOM_MERSENNE_TWISTER_HPP
...
#include <hboost/random/detail/ptr_helper.hpp>
#include <hboost/random/detail/seed.hpp>
#include <hboost/random/detail/seed_impl.hpp>
#include <hboost/random/detail/generator_seed_seq.hpp>
#include <hboost/random/detail/polynomial.hpp>
...
public:
    ...
    HBOOST_STATIC_CONSTANT(std::size_t, word_size = w);
    HBOOST_STATIC_CONSTANT(std::size_t, state_size = n);
    HBOOST_STATIC_CONSTANT(std::size_t, shift_size = m);
    HBOOST_STATIC_CONSTANT(std::size_t, mask_bits = r);
    HBOOST_STATIC_CONSTANT(UIntType, xor_mask = a);
    HBOOST_STATIC_CONSTANT(std::size_t, tempering_u = u);
    HBOOST_STATIC_CONSTANT(UIntType, tempering_d = d);
    HBOOST_STATIC_CONSTANT(std::size_t, tempering_s = s);
    HBOOST_STATIC_CONSTANT(UIntType, tempering_b = b);
    HBOOST_STATIC_CONSTANT(std::size_t, tempering_t = t);
    HBOOST_STATIC_CONSTANT(UIntType, tempering_c = c);
    HBOOST_STATIC_CONSTANT(std::size_t, tempering_l = l);
    HBOOST_STATIC_CONSTANT(UIntType, initialization_multiplier = f);
    HBOOST_STATIC_CONSTANT(UIntType, default_seed = 5489u);

    // backwards compatibility
    HBOOST_STATIC_CONSTANT(UIntType, parameter_a = a);
    HBOOST_STATIC_CONSTANT(std::size_t, output_u = u);
    HBOOST_STATIC_CONSTANT(std::size_t, output_s = s);
    HBOOST_STATIC_CONSTANT(UIntType, output_b = b);
    HBOOST_STATIC_CONSTANT(std::size_t, output_t = t);
    HBOOST_STATIC_CONSTANT(UIntType, output_c = c);
    HBOOST_STATIC_CONSTANT(std::size_t, output_l = l);
     ...
     */
    HBOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(mersenne_twister_engine,
                                               UIntType, value)
    { seed(value); }
     ...
     * @endxmlnote
     */
    HBOOST_RANDOM_DETAIL_SEED_SEQ_CONSTRUCTOR(mersenne_twister_engine,
                                             SeedSeq, seq)
    { seed(seq); }
     ...
     */
    HBOOST_RANDOM_DETAIL_ARITHMETIC_SEED(mersenne_twister_engine, UIntType, value)
    {
     ...
     */
    HBOOST_RANDOM_DETAIL_SEED_SEQ_SEED(mersenne_twister_engine, SeeqSeq, seq)
    {
    ...
    {
#ifndef HBOOST_RANDOM_MERSENNE_TWISTER_DISCARD_THRESHOLD
#define HBOOST_RANDOM_MERSENNE_TWISTER_DISCARD_THRESHOLD 10000000
#endif
        if(z > HBOOST_RANDOM_MERSENNE_TWISTER_DISCARD_THRESHOLD) {
            discard_many(z);
        } else {
            for(hboost::uintmax_t j = 0; j < z; ++j) {
                (*this)();
            }
        }
    }

#ifndef HBOOST_RANDOM_NO_STREAM_OPERATORS
...
private:
     ...
     */
    void discard_many(hboost::uintmax_t z)
    {
...
#define HBOOST_RANDOM_MT_DEFINE_CONSTANT(type, name)                         \
...
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, word_size);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, state_size);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, shift_size);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, mask_bits);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(UIntType, xor_mask);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, tempering_u);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(UIntType, tempering_d);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, tempering_s);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(UIntType, tempering_b);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, tempering_t);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(UIntType, tempering_c);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, tempering_l);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(UIntType, initialization_multiplier);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(UIntType, default_seed);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(UIntType, parameter_a);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, output_u );
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, output_s);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(UIntType, output_b);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, output_t);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(UIntType, output_c);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(std::size_t, output_l);
HBOOST_RANDOM_MT_DEFINE_CONSTANT(bool, has_fixed_range);
#undef HBOOST_RANDOM_MT_DEFINE_CONSTANT
#endif
...
#if !defined(HBOOST_NO_INT64_T) && !defined(HBOOST_NO_INTEGRAL_INT64_T)
...
public:
    mersenne_twister() {}
    HBOOST_RANDOM_DETAIL_GENERATOR_CONSTRUCTOR(mersenne_twister, Gen, gen)
    { seed(gen); }
    HBOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(mersenne_twister, UIntType, val)
    { seed(val); }
    template<class It>
    mersenne_twister(It& first, It last) : base_type(first, last) {}
    void seed() { base_type::seed(); }
    HBOOST_RANDOM_DETAIL_GENERATOR_SEED(mersenne_twister, Gen, gen)
    {
        detail::generator_seed_seq<Gen> seq(gen);
        base_type::seed(seq);
    }
    HBOOST_RANDOM_DETAIL_ARITHMETIC_SEED(mersenne_twister, UIntType, val)
    { base_type::seed(val); }
    template<class It>
...
HBOOST_RANDOM_PTR_HELPER_SPEC(hboost::mt11213b)
HBOOST_RANDOM_PTR_HELPER_SPEC(hboost::mt19937)
HBOOST_RANDOM_PTR_HELPER_SPEC(hboost::mt19937_64)

#include <hboost/random/detail/enable_warnings.hpp>

#endif // HBOOST_RANDOM_MERSENNE_TWISTER_HPP
