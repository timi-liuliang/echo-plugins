#ifndef HBOOST_SERIALIZATION_SMART_CAST_HPP
#define HBOOST_SERIALIZATION_SMART_CAST_HPP
...
T smart_cast(U u) {
    typedef
        typename mpl::eval_if<
            typename mpl::or_<
                hboost::is_same<void *, U>,
                hboost::is_same<void *, T>,
                hboost::is_same<const void *, U>,
                hboost::is_same<const void *, T>
            >,
            mpl::identity<smart_cast_impl::void_pointer< T > >,
        // else
        typename mpl::eval_if<hboost::is_pointer<U>,
            mpl::identity<smart_cast_impl::pointer< T > >,
        // else
        typename mpl::eval_if<hboost::is_reference<U>,
...
#endif // HBOOST_SERIALIZATION_SMART_CAST_HPP
