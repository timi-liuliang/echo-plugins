#ifndef  HBOOST_SERIALIZATION_UTILITY_HPP
#define HBOOST_SERIALIZATION_UTILITY_HPP
...
inline void serialize(
    ...
    typedef typename hboost::remove_const<F>::type typef;
    ar & hboost::serialization::make_nvp("first", const_cast<typef &>(p.first));
...
#endif // HBOOST_SERIALIZATION_UTILITY_HPP
