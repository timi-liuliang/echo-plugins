#ifndef  HBOOST_SERIALIZATION_DETAIL_STACH_CONSTRUCTOR_HPP
#define HBOOST_SERIALIZATION_DETAIL_STACH_CONSTRUCTOR_HPP
...
struct stack_construct : public stack_allocate<T>
{
    stack_construct(Archive & ar, const unsigned int version){
        ...
        hboost::serialization::load_construct_data_adl(
            ar, 
            this->address(), 
            version
        );
...
#endif //  HBOOST_SERIALIZATION_DETAIL_STACH_CONSTRUCTOR_HPP
