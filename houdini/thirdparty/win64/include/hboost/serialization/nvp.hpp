#ifndef HBOOST_SERIALIZATION_NVP_HPP
#define HBOOST_SERIALIZATION_NVP_HPP
...
struct implementation_level<nvp< T > >
{
    ...
    HBOOST_STATIC_CONSTANT(int, value = implementation_level::type::value);
};
...
#define HBOOST_SERIALIZATION_NVP(name)                              \
    hboost::serialization::make_nvp(HBOOST_PP_STRINGIZE(name), name)
/**/

#define HBOOST_SERIALIZATION_BASE_OBJECT_NVP(name)                  \
    hboost::serialization::make_nvp(                                \
        HBOOST_PP_STRINGIZE(name),                                  \
        hboost::serialization::base_object<name >(*this)            \
    )
/**/

#endif // HBOOST_SERIALIZATION_NVP_HPP
