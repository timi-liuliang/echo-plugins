#ifndef HBOOST_SERIALIZATION_STATIC_WARNING_HPP
#define HBOOST_SERIALIZATION_STATIC_WARNING_HPP
...
//  4. VC6: class previously seen as struct (as in 'hboost/mpl/print.hpp')
...
// Enable the warnings relied on by HBOOST_STATIC_WARNING, where possible.
...
template<int L> 
struct HBOOST_SERIALIZATION_STATIC_WARNING_LINE{};

template<bool B, int L>
struct static_warning_test{
    typename hboost::mpl::eval_if_c<
        B,
        hboost::mpl::true_,
        typename hboost::mpl::identity<
            hboost::mpl::print<
                HBOOST_SERIALIZATION_STATIC_WARNING_LINE<L>
            >
        >
    >::type type;
};
...
template<int i>
struct HBOOST_SERIALIZATION_SS {};

} // serialization
} // boost

#define HBOOST_SERIALIZATION_BSW(B, L) \
    typedef hboost::serialization::HBOOST_SERIALIZATION_SS< \
        sizeof( hboost::serialization::static_warning_test< B, L > ) \
    > HBOOST_JOIN(STATIC_WARNING_LINE, L) HBOOST_ATTRIBUTE_UNUSED; 
#define HBOOST_STATIC_WARNING(B) HBOOST_SERIALIZATION_BSW(B, __LINE__)

#endif // HBOOST_SERIALIZATION_STATIC_WARNING_HPP
