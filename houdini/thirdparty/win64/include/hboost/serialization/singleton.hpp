#ifndef HBOOST_SERIALIZATION_SINGLETON_HPP
#define HBOOST_SERIALIZATION_SINGLETON_HPP
...
// http://lists.boost.org/Archives/hboost/2006/05/105286.php for
// details.
//
...
class HBOOST_SYMBOL_VISIBLE singleton_module :
    public hboost::noncopyable
{
private:
    static bool & get_lock();
public:
    HBOOST_SERIALIZATION_DECL static void lock();
    HBOOST_SERIALIZATION_DECL static void unlock();
    HBOOST_SERIALIZATION_DECL static bool is_locked();
};
...
{
private:
    HBOOST_DLLEXPORT static T & instance;
    // include this to provoke instantiation at pre-execution time
    static void use(T const *) {}
    HBOOST_DLLEXPORT static T & get_instance() {
        static detail::singleton_wrapper< T > t;
        // refer to instance, causing it to be instantiated (and
        // initialized at startup on working compilers)
        HBOOST_ASSERT(! detail::singleton_wrapper< T >::m_is_destroyed);
        use(& instance);
        return static_cast<T &>(t);
    }
public:
    HBOOST_DLLEXPORT static T & get_mutable_instance(){
        HBOOST_ASSERT(! is_locked());
        return get_instance();
    }
    HBOOST_DLLEXPORT static const T & get_const_instance(){
        return get_instance();
    }
    HBOOST_DLLEXPORT static bool is_destroyed(){
        return detail::singleton_wrapper< T >::m_is_destroyed;
    }
};

template<class T>
HBOOST_DLLEXPORT T & singleton< T >::instance = singleton< T >::get_instance();
...
#endif // HBOOST_SERIALIZATION_SINGLETON_HPP
