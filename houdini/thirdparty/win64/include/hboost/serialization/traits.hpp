#ifndef HBOOST_SERIALIZATION_TRAITS_HPP
#define HBOOST_SERIALIZATION_TRAITS_HPP
...
#include <hboost/serialization/level_enum.hpp>
...
struct traits : public basic_traits {
    HBOOST_STATIC_ASSERT(Version == 0 || Level >= object_class_info);
    HBOOST_STATIC_ASSERT(Tracking == track_never || Level >= object_serializable);
...
#endif // HBOOST_SERIALIZATION_TRAITS_HPP
