#ifndef  HBOOST_SERIALIZATION_VOID_CAST_HPP
#define HBOOST_SERIALIZATION_VOID_CAST_HPP
...
HBOOST_SERIALIZATION_DECL void const *
void_upcast(
...
class HBOOST_SYMBOL_VISIBLE void_caster :
    private hboost::noncopyable
{
    ...
    friend 
    HBOOST_SERIALIZATION_DECL void const *
    hboost::serialization::void_downcast(
        extended_type_info const & derived,
        extended_type_info const & base,
        void const * const
    );
protected:
    HBOOST_SERIALIZATION_DECL void recursive_register(bool includes_virtual_base = false) const;
    HBOOST_SERIALIZATION_DECL void recursive_unregister() const;
...
class HBOOST_SYMBOL_VISIBLE void_caster_primitive :
    public void_caster
{
    virtual void const * downcast(void const * const t) const {
        const Derived * d = 
            hboost::serialization::smart_cast<const Derived *, const Base *>(
    ...
    virtual void const * upcast(void const * const t) const {
        const Base * b = 
            hboost::serialization::smart_cast<const Base *, const Derived *>(
...
template <class Derived, class Base>
class HBOOST_SYMBOL_VISIBLE void_caster_virtual_base :
    public void_caster
{
    virtual bool has_virtual_base() const {
        return true;
...
template <class Derived, class Base>
struct HBOOST_SYMBOL_VISIBLE void_caster_base :
    public void_caster
{
    typedef
        typename mpl::eval_if<hboost::is_virtual_base_of<Base,Derived>,
            mpl::identity<
...
#endif // HBOOST_SERIALIZATION_VOID_CAST_HPP
