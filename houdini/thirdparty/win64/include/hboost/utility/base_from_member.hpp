...
#ifndef HBOOST_UTILITY_BASE_FROM_MEMBER_HPP
#define HBOOST_UTILITY_BASE_FROM_MEMBER_HPP
...
#ifndef HBOOST_BASE_FROM_MEMBER_MAX_ARITY
#define HBOOST_BASE_FROM_MEMBER_MAX_ARITY  10
#endif
...
#define HBOOST_PRIVATE_CTR_DEF( z, n, data )                            \
    template < HBOOST_PP_ENUM_PARAMS(n, typename T) >                   \
    explicit base_from_member( HBOOST_PP_ENUM_BINARY_PARAMS(n, T, x) )  \
        : member( HBOOST_PP_ENUM_PARAMS(n, x) )                         \
        {}                                                             \
    /**/
...
{
    typedef typename ::hboost::remove_cv<typename
     ::hboost::remove_reference<T>::type>::type  type;

};  // hboost::detail::remove_cv_ref
...
struct is_related
    : public ::hboost::is_same<
     typename ::hboost::detail::remove_cv_ref<T>::type,
     typename ::hboost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::hboost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::hboost::disable_if< ::hboost::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::hboost::detail::enable_if_unrelated<base_from_member, T...>::type>
    explicit HBOOST_CONSTEXPR base_from_member( T&& ...x )
        HBOOST_NOEXCEPT_IF( HBOOST_NOEXCEPT_EXPR(::new ((void*) 0) MemberType(
    ...
    HBOOST_PP_REPEAT_FROM_TO( 1, HBOOST_PP_INC(HBOOST_BASE_FROM_MEMBER_MAX_ARITY),
     HBOOST_PRIVATE_CTR_DEF, _ )
#endif

};  // hboost::base_from_member
...
protected:
    ...
    explicit HBOOST_CONSTEXPR base_from_member( MemberType& x )
        HBOOST_NOEXCEPT
        : member( x )
        {}
...
#undef HBOOST_PRIVATE_CTR_DEF


#endif  // HBOOST_UTILITY_BASE_FROM_MEMBER_HPP
