...
#ifndef HBOOST_UNORDERED_DETAIL_ALL_HPP_INCLUDED
#define HBOOST_UNORDERED_DETAIL_ALL_HPP_INCLUDED
...
#include <hboost/unordered/detail/buckets.hpp>
...
#if defined(HBOOST_UNORDERED_DEPRECATED_EQUALITY)

#if defined(__EDG__)
#elif defined(_MSC_VER) || defined(__BORLANDC__) || defined(__DMC__)
#pragma message("Warning: HBOOST_UNORDERED_DEPRECATED_EQUALITY is no longer supported.")
#elif defined(__GNUC__) || defined(__HP_aCC) || \
    defined(__SUNPRO_CC) || defined(__IBMCPP__)
#warning "HBOOST_UNORDERED_DEPRECATED_EQUALITY is no longer supported."
#endif
...
namespace hboost { namespace unordered { namespace detail {
    ...
    struct value_base
    {
        ...
        typename hboost::aligned_storage<
            sizeof(value_type),
            hboost::alignment_of<value_type>::value>::type data_;
    ...
    struct move_nodes
    {
        ...
        {
            constructor.construct_with_value2(hboost::move(v));
            return constructor.release();
        }
    };
    ...
    struct table :
        hboost::unordered::detail::functions<
    ...
    public:
        ...
        typedef hboost::unordered::detail::functions<
            typename Types::hasher,
        ...
        typedef hboost::unordered::detail::allocator_traits<node_allocator>
            node_allocator_traits;
        typedef hboost::unordered::detail::allocator_traits<bucket_allocator>
        ...
        typedef typename bucket_allocator_traits::pointer
            bucket_pointer;
        typedef hboost::unordered::detail::node_constructor<node_allocator>
            node_constructor;

        typedef hboost::unordered::iterator_detail::
        ...
        hboost::unordered::detail::compressed<bucket_allocator, node_allocator>
            allocators_;
        ...
        std::size_t max_size() const
        {
            ...
            // size < mlf_ * count
            return hboost::unordered::detail::double_to_size(ceil(
        ...
        void recalculate_max_load()
        {
            ...
            max_load_ = buckets_ ? hboost::unordered::detail::double_to_size(ceil(
                    static_cast<double>(mlf_) *
        ...
        {
            HBOOST_ASSERT(mlf_ >= minimum_max_load_factor);
            ...
            return policy::new_bucket_count(
                hboost::unordered::detail::double_to_size(floor(
        ...
        table(table& x, hboost::unordered::detail::move_tag m) :
            functions(x, m),
        ...
        {
            hboost::unordered::detail::array_constructor<bucket_allocator>
        ...
        {
            hboost::unordered::detail::func::ignore_unused_variable_warning(other);

            // According to 23.2.1.8, if propagate_on_container_swap is
            // false the behaviour is undefined unless the allocators
            // are equal.
            HBOOST_ASSERT(node_alloc() == other.node_alloc());
        }
        ...
        void swap(table& x)
        {
            ...
            hboost::swap(buckets_, x.buckets_);
            hboost::swap(bucket_count_, x.bucket_count_);
            hboost::swap(size_, x.size_);
        ...
        void delete_node(link_pointer prev)
        {
            ...
            hboost::unordered::detail::func::destroy_value_impl(node_alloc(),
                n->value_ptr());
            hboost::unordered::detail::func::destroy(hboost::addressof(*n));
