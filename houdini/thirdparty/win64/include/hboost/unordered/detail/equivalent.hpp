...
#ifndef HBOOST_UNORDERED_DETAIL_EQUIVALENT_HPP_INCLUDED
#define HBOOST_UNORDERED_DETAIL_EQUIVALENT_HPP_INCLUDED
...
namespace hboost { namespace unordered { namespace detail {
    ...
    {
        typedef hboost::unordered::detail::grouped_node<A, T> node;
    ...
    struct pick_grouped_node2<A, T,
        hboost::unordered::detail::grouped_ptr_node<T>*,
        hboost::unordered::detail::ptr_bucket*>
    {
        typedef hboost::unordered::detail::grouped_ptr_node<T> node;
    ...
    struct pick_grouped_node
    {
        typedef hboost::unordered::detail::allocator_traits<
            typename hboost::unordered::detail::rebind_wrap<A,
                hboost::unordered::detail::grouped_ptr_node<T> >::type
    ...
    struct multiset
    {
        ...
        typedef hboost::unordered::detail::pick_grouped_node<allocator,
            value_type> pick;
        typedef typename pick::node node;
        typedef typename pick::bucket bucket;
        typedef typename pick::link_pointer link_pointer;

        typedef hboost::unordered::detail::grouped_table_impl<types> table;
    ...
    struct multimap
    {
        typedef hboost::unordered::detail::multimap<A, K, M, H, P> types;
    ...
    struct grouped_table_impl : hboost::unordered::detail::table<Types>
    {
...
#   if defined(HBOOST_NO_CXX11_VARIADIC_TEMPLATES)
        iterator emplace(hboost::unordered::detail::emplace_args1<
...
#   endif
        ...
        iterator emplace(HBOOST_UNORDERED_EMPLACE_ARGS)
        {
        ...
        template <class I>
        typename hboost::unordered::detail::enable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            if(i == j) return;

            std::size_t distance = hboost::unordered::detail::distance(i, j);
            if(distance == 1) {
                node_constructor a(this->node_alloc());
        ...
        template <class I>
        typename hboost::unordered::detail::disable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            node_constructor a(this->node_alloc());
            for (; i != j; ++i) {
        ...
        static link_pointer split_groups(node_pointer i, node_pointer j)
        {
            ...
            if (j) {
                ...
                hboost::swap(first->group_prev_, j->group_prev_);
            ...
            if (prev) {
                ...
                hboost::swap(first->group_prev_, i->group_prev_);
            }
