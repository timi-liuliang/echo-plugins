...
#ifndef HBOOST_UNORDERED_UNORDERED_MAP_HPP_INCLUDED
#define HBOOST_UNORDERED_UNORDERED_MAP_HPP_INCLUDED
...
#include <hboost/unordered/unordered_map_fwd.hpp>
...
namespace unordered
{
    ...
    class unordered_map
    {
        ...
        HBOOST_COPYABLE_AND_MOVABLE(unordered_map)
#endif       
    ...
    private:
        ...
        typedef hboost::unordered::detail::map<A, K, T, H, P> types;
    ...
    public:
...
#if defined(HBOOST_UNORDERED_USE_MOVE)
        unordered_map(HBOOST_RV_REF(unordered_map) other)
        ...
        ~unordered_map() HBOOST_NOEXCEPT;

        // Assign

#if defined(HBOOST_UNORDERED_USE_MOVE)
        unordered_map& operator=(HBOOST_COPY_ASSIGN_REF(unordered_map) x)
        {
            table_.assign(x.table_);
            return *this;
        }

        unordered_map& operator=(HBOOST_RV_REF(unordered_map) x)
        {
...
#undef HBOOST_UNORDERED_EMPLACE
        ...
        iterator insert(const_iterator hint, HBOOST_RV_REF(value_type) x)
        {
    ...
    {
#if defined(HBOOST_UNORDERED_USE_MOVE)
        HBOOST_COPYABLE_AND_MOVABLE(unordered_multimap)
#endif
    public:
    ...
    private:
        ...
        typedef hboost::unordered::detail::multimap<A, K, T, H, P> types;
        typedef typename types::traits allocator_traits;
        typedef typename types::table table;
    ...
    public:
...
#if defined(HBOOST_UNORDERED_USE_MOVE)
        unordered_multimap(HBOOST_RV_REF(unordered_multimap) other)
                HBOOST_NOEXCEPT_IF(table::nothrow_move_constructible)
            : table_(other.table_, hboost::unordered::detail::move_tag())
        {
        }
        ...
        ~unordered_multimap() HBOOST_NOEXCEPT;

        // Assign

#if defined(HBOOST_UNORDERED_USE_MOVE)
        unordered_multimap& operator=(
                HBOOST_COPY_ASSIGN_REF(unordered_multimap) x)
        {
            table_.assign(x.table_);
            return *this;
        }

        unordered_multimap& operator=(HBOOST_RV_REF(unordered_multimap) x)
        {
            table_.move_assign(x.table_);
            return *this;
        }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    template <class K, class T, class H, class P, class A>
    unordered_map<K,T,H,P,A>::~unordered_map() HBOOST_NOEXCEPT {}
    ...
    template <class K, class T, class H, class P, class A>
    std::size_t unordered_map<K,T,H,P,A>::max_size() const HBOOST_NOEXCEPT
    {
    ...
    template <class K, class T, class H, class P, class A>
    float unordered_map<K,T,H,P,A>::load_factor() const HBOOST_NOEXCEPT
    {
        return table_.load_factor();
    }

    template <class K, class T, class H, class P, class A>
    void unordered_map<K,T,H,P,A>::max_load_factor(float m) HBOOST_NOEXCEPT
    {
...
////////////////////////////////////////////////////////////////////////////////
    ...
    template <class K, class T, class H, class P, class A>
    unordered_multimap<K,T,H,P,A>::~unordered_multimap() HBOOST_NOEXCEPT {}
    ...
    template <class K, class T, class H, class P, class A>
    std::size_t unordered_multimap<K,T,H,P,A>::max_size() const HBOOST_NOEXCEPT
    {
        return table_.max_size();
    }
    ...
    template <class K, class T, class H, class P, class A>
    float unordered_multimap<K,T,H,P,A>::load_factor() const HBOOST_NOEXCEPT
    {
        return table_.load_factor();
    }

    template <class K, class T, class H, class P, class A>
    void unordered_multimap<K,T,H,P,A>::max_load_factor(float m) HBOOST_NOEXCEPT
    {
        table_.max_load_factor(m);
    }
...
#endif // HBOOST_UNORDERED_UNORDERED_MAP_HPP_INCLUDED
