...
private:
    ...
    typedef hboost::variant<PreOverlayDataEntry<int>, 
    ...
    // Visitor for the hboost variant to call the store at time function.
    struct StoreAtTime : public hboost::static_visitor<>
    {
    ...
    struct ClearData : public hboost::static_visitor<>
    {
        template <typename T>
        void operator()(T t) const { 
