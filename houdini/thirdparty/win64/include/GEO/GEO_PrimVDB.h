...
#ifndef __GEO_PrimVDB__
#define __GEO_PrimVDB__

#include "GEO_API.h"

#include "GEO_Primitive.h"

// NOTE: Not using SYS_Version for now.
...
class GEO_API GEO_PrimVDB : public GEO_Primitive
{
public:
