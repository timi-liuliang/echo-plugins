 ...
 *
 * NAME:	SOP_BlendShapes-2.0.h (C++)
 *
 * COMMENTS:	dynamic blend SOP version 2
 *
 */


#ifndef __SOP_BlendShapes2_h__
#define __SOP_BlendShapes2_h__

#include "SOP_API.h"
#include "SOP_Node.h"

class SOP_API SOP_BlendShapes2 : public SOP_Node
{
public:
    SOP_BlendShapes2(OP_Network *net, const char *name, OP_Operator *entry);
    virtual ~SOP_BlendShapes2();
