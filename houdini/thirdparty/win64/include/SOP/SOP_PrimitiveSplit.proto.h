...
class SOP_API SOP_PrimitiveSplitParms  : public SOP_NodeParms
{
public:
    ...
    explicit SOP_PrimitiveSplitParms(const SOP_PrimitiveSplitParms &) = default;
    ...
    {
        *this = *((const SOP_PrimitiveSplitParms *)src);
    }
