...
public:
    ...
    virtual ~SOP_VolumeAnalysisParms() {}
    ...
    void        buildFromOp(const OP_Node *node, fpreal time, DEP_MicroNode *depnode)
    {
        ...
        if (true)
            OP_Utils::evalOpParm(myAnalysis, node, "analysis", time, 0);
        else myAnalysis = 0;
        if (true && ( (!(((int64(getAnalysis())!=3)))) ) )
            OP_Utils::evalOpParm(myEdgedetectmode, node, "edgedetectmode", time, 0);
        else myEdgedetectmode = 0;
    ...
    doSetParmValue(exint idx, const T &value) 
    {
        switch (idx)
        {
            case 0:
                ...
                break;
            case 1:
                coerceValue(myAnalysis, value);
                break;
            case 2:
                coerceValue(myEdgedetectmode, value);
                break;
