...
class SOP_API SOP_ConvertTetsParms  : public SOP_NodeParms
{
public:
    ...
    explicit SOP_ConvertTetsParms(const SOP_ConvertTetsParms &) = default;

    virtual ~SOP_ConvertTetsParms() {}

    bool operator==(const SOP_ConvertTetsParms &src) const
    {
    ...
    {
        *this = *((const SOP_ConvertTetsParms *)src);
    }
