...
class DEP_MicroNode;
namespace SOP_UVFlatten_2_0Enums
{
    enum class Method
    {
        SCP = 0,
...
class SOP_API SOP_UVFlatten_2_0Parms  : public SOP_NodeParms
{
public:
    ...
    explicit SOP_UVFlatten_2_0Parms(const SOP_UVFlatten_2_0Parms &) = default;

    virtual ~SOP_UVFlatten_2_0Parms() {}
    ...
    using Method = SOP_UVFlatten_2_0Enums::Method;
    using Align_axis = SOP_UVFlatten_2_0Enums::Align_axis;
    using Lalign_axis = SOP_UVFlatten_2_0Enums::Lalign_axis;
    ...
    {
        *this = *((const SOP_UVFlatten_2_0Parms *)src);
    }
